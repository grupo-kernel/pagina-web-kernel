...
export function newsHero(featuredNews = null) {
    const hasFeatured = Boolean(featuredNews);

    const imgClass =
        featuredNews?.imageFit === "cover"
            ? "object-cover"
            : "object-contain";
                                    ...
                                    featuredNews.image
                                        ? `
                                            <img
                                                ...
                                                class="w-full h-full max-h-[500px] ${imgClass} rounded-2xl"
                                                loading="lazy"
                                            >
                                          `
                                        : `
