(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const R=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function G(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function J(){return`<div class="lg:hidden  border-b-zinc-500 border-b  pb-2.5  w-full  flex px-2.5  justify-between items-center  mb-7">
              <span class="text-4xl font-medium ">El Kernel</span>
                ...
                <ul class="flex w-full text-black flex-col lg:flex-row p-4 gap-4 xl:gap-9">
                  ...
                  <li data-action="open-subMenu" class="gap-1 text-nowrap lg:relative  2xl:text-3xl  hover:cursor-pointer 
                    ...
                    </ul>`}function H(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
        ...
        `}function D(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(a=>{const i=a.querySelector("ul"),o=a.querySelector("i");let s=!i.classList.contains("hidden");a.addEventListener("click",n=>{n.preventDefault(),s?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),s=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),s=!0)})})}function V(e,t){e.addEventListener("click",()=>{t.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function Q(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function Y(){return`<div class =" flex justify-center 
            ...
            <!-- Fin tarjeta principal  -->  `}function U(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function K(e){U(e,E)}const P=""+new URL("apec-ConmXkrT.png",import.meta.url).href,W=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Z=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,k=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${P}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${W}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function X(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=k.length,s=1500;let n=0,l=null;function c(v){return(v%o+o)%o}function r(){i.innerHTML=k[n].content}function m(v){n=c(n+v),r()}function u(){p(),l=setInterval(()=>m(1),s)}function p(){l&&(clearInterval(l),l=null)}function S(){u()}r(),u(),t.addEventListener("click",()=>{m(1),S()}),a.addEventListener("click",()=>{m(-1),S()})}function _(){const e=`
    <div class="absolute bottom-0 col-span-4
            ...
            </div>`,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return X(a.querySelector("#containerFather")),K(a.querySelector("#btnsGroup")),a}function ee(){const e=document.createElement("section");e.classList.add("relative","w-full","flex","flex-col","m-auto","tabletBig:flex-row","md:mb-50","tabletBig:w-7xl","tabletBig:px-20","xl:mb-0","xl:pb-0","xl:w-full","xl:px-0","2xl:w-450","2xl:h-187.5"),e.innerHTML=`${Y()}`;const t=document.createElement("div");return t.appendChild(_()),e.appendChild(t.firstElementChild),e}function te(){return ee()}const ae=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function ie(){return`
    <section role="banner" class="relative w-full min-h-screen overflow-hidden">
     
    <!-- Imagen del banner -->
      <img src="${ae}" alt="QuienesSomos" class="absolute inset-0 w-full h-full object-cover" loading="lazy"/>
  ...
  `}const ne="data:image/png;base64,",se="data:image/png;base64,",re="data:image/png;base64,",le="data:image/png;base64,",ce="data:image/png;base64,",de=[{icon:ne,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:se,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:re,title:"Objetivos",content:`
      ...
      </ul>`},{icon:le,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function ue({icon:e,title:t,content:a}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${ce}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `,e}function xe(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),s=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(n=>{n.classList.remove("max-h-[1000px]"),n.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(n=>{n.classList.remove("rotate-180")}),s||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function ge(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function fe(){const e=pe();return xe(e),ge(e),e}function be(e){const t=document.createElement("div");t.className="flex bg-white border rounded-xl shadow-2xl border-black w-89.5 h-139 flex-col items-center text-center justify-between p-4 gap-4 transition-all hover:scale-[1.02]";const a=e.redes.map(i=>`
    ...
    `,t}const y=""+new URL("sep-BCMURSaM.png",import.meta.url).href,A=""+new URL("nat-CaDYa76I.png",import.meta.url).href,B=""+new URL("rad-B3ff1btG.png",import.meta.url).href,C=""+new URL("ant-D2J2W27b.png",import.meta.url).href,N=""+new URL("mar-Cru0HERG.png",import.meta.url).href,b=""+new URL("marc-D-jKwb4F.png",import.meta.url).href,h=""+new URL("jos-BToFZdIf.png",import.meta.url).href,w=[{img:y,title:"Miguel A. Miguel A. Leonardo Sepúlveda, Ph.D",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente.",afilaciones:" ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&amp;hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con enfoque en métodos numéricos avanzados. Asesor de tesis de posgrado y pregrado. Diseñador y rediseñador de programas curriculares universitarios. Investigador en métodos libres de Jacobiano, análisis numérico y formación de docentes."},{img:A,title:"Natanael Ureña Castillo, M.Sc",subtitle:"Optimización, entrenamiento de redes neuronales, formación docente",areas:"Métodos iterativos, optimización, redes neuronales, ciencias actuariales, matemática computacional, formación docente.",afilaciones:" ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Especialista en métodos iterativos, optimización y redes neuronales aplicadas a problemas complejos y riesgos. Docente universitario y asesor en proyectos de investigación matemática."},{img:B,title:"Randy Leonardo, M.Sc",subtitle:"Álgebra Lineal, Matrices combinadas, Educación Matemática",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa..",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador en álgebra y docencia, co-investigador de proyectos de matrices combinadas. Ponente en congresos nacionales."},{img:C,title:"Antmel Rodríguez Cabral, Ph.D",subtitle:"Especialista en dinámica compleja y dinámica real de métodos iterativos para sistemas no lineales",rec:"Recientemente defendió su tesis doctoral (Doctor en Matemática).",areas:" EDPs, sistemas no lineales, planos/dinámicas compleja y real, análisis complejo, educación matemática.",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Profesor universitario e investigador en métodos numéricos, EDPs y planos dinámicos; ponente en congresos internacionales."},{img:N,title:"Marino Brito Guillén, M.Sc",subtitle:"Gestión universitaria, Matemática Educativa, Educación",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente.",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Ex-vicerrector académico, profesor universitario y consultor educativo. Experto en desarrollo curricular y formación docente."},{img:b,title:"Marc-Kelly Jean Philippe Jean, Ph.D",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",areas:"Álgebra, matemática pura, educación matemática, recursos educativos.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?hl=es&amp;user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Profesor adjunto, asesor y conferencista en álgebra, con experiencia en investigación y divulgación científica internacional."},{img:h,title:"José Alberto Reyes Reyes, M.Sc",subtitle:"Métodos Iterativos, Educación Matemática",areas:"Matemática pura, métodos iterativos, análisis de estabilidad, innovación educativa.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Docente universitario y de postgrado. Investigador en métodos numéricos y asesor de tesis en análisis de estabilidad y convergencia."}];function he(){let e=0,t;const a=document.createElement("div");a.className="relative flex flex-col gap-7 w-full items-center";const i=()=>window.innerWidth>=1024?3:window.innerWidth>=768?2:1,o=()=>{const r=i();e+r>=w.length?e=0:e++,c()},s=()=>{const r=i();e<=0?e=w.length-r:e--,c()},n=()=>{l(),t=setInterval(o,3500)},l=()=>{t&&clearInterval(t)},c=()=>{const r=i();a.innerHTML=`
        ...
        `;const m=a.querySelector("#cards-wrapper");w.slice(e,e+r).forEach(p=>{m.appendChild(be(p))}),a.querySelector("#prev-btn").onclick=()=>{s(),n()},a.querySelector("#next-btn").onclick=()=>{o(),n()}};return document.addEventListener("visibilitychange",()=>{document.hidden?l():n()}),window.addEventListener("resize",()=>{e=0,c()}),c(),n(),a}function ve(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-route]");if(!a)return;const i=window.location.hash.replace("#/","")||"equipment";a.dataset.route!==i&&E(a.dataset.route)})}function T(){const e=window.location.hash.replace("#/","")||"equipment",t=document.createElement("div"),a="bg-sky-800 text-white border-b-sky-800",i="bg-transparent text-black hover:bg-gray-50";return t.innerHTML=`
    ...
    </nav>`,ve(t.firstElementChild),t.firstElementChild}function we(){const e=document.createElement("section");e.classList.add("flex","flex-col","gap-5","m-auto","p-4","max-w-7xl","tabletBig:w-7xl","xl:w-full"),e.appendChild(T());const t=he();return e.appendChild(t),e}function ye(){return we()}function Ae(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function Ce(e,t=!1){return`
        <div data-id="${e.id}" 
    ...
    `}function Me(e){const t=e.formacion.map(i=>`
        <div class="mb-4">
    ...
    `}function je({id:e,title:t,date:a,image:i,excerpt:o}){return`
  ...
  `}function Ue(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ...
    `,e}function Pe({title:e,content:t,articleURL:a}){const i=t.paragraphs.map(n=>`<p>${n}<p>`).join(""),o=t.list.length?` 
    ...
    `}function Be(e){e&&(e.addEventListener("click",Ne),document.addEventListener("click",Te),document.addEventListener("keydown",ze))}function Ne(e){const t=e.target.closest("[data-news-btn]");if(!t)return;const a=t.dataset.newsBtn,i=z.find(o=>o.id===a);i&&qe(i)}function Te(e){const t=e.target.closest("[data-close-modal]"),a=e.target.id==="newsModal";(t||a)&&M()}function ze(e){e.key==="Escape"&&M()}function qe(e){M(),document.body.insertAdjacentHTML("beforeend",Pe(e)),document.body.classList.add("overflow-hidden")}function M(){const e=document.getElementById("newsModal");e&&(e.remove(),document.body.classList.remove("overflow-hidden"))}function Fe(){const e=Ue();return Be(e),e}const I=[{id:1,img:y,name:"Miguel Antonio Leonardo Sepúlveda, Ph.D",area:"Métodos iterativos, sistemas no lineales, análisis numérico y EDPs",publicaciones:[{year:2026,title:"Mathematics",q:"Q1",contenido:"First Optimal Eighth-Order Families with Multivariable Scalar Weight Functions for Nonlinear Systems and Applications to Fredholm Integral and Semilinear Elliptic Problems",autores:"Alicia Cordero, Miguel A. Leonardo Sepúlveda, Juan R. Torregrosa, Antmel Rodríguez Cabral, Natanael Ureña Castillo",DOI:"10.3390/math14122114"},{year:2026,title:"Mathematics",q:"Q1",contenido:"A Weight Function Generalization of Singh–Sharma Fifth-Order Method for Systems of Nonlinear Equations, with Application to a Discretized Stationary Viscous Burgers Problem",autores:"Javier G. Maimó, Miguel A. Leonardo Sepúlveda, Antmel Rodríguez Cabral, Natanael Ureña Castillo",DOI:"10.3390/math14111944"},{year:2026,title:"Mathematics",q:"Q1",contenido:"Generalized Traub Family for Solving Nonlinear Systems: Fourth-Order Optimal Method and Dynamical Analysis",autores:"Alicia Cordero, Miguel A. Leonardo Sepúlveda, Juan R. Torregrosa, Antmel Rodríguez Cabral, María P. Vassileva",DOI:"10.3390/math14071161"},{year:2024,title:"Mathematics and Computers in Simulation",q:"Q1",contenido:"Increasing in Three Units the Order of Convergence of Iterative Methods for Solving Nonlinear Systems",autores:"Alicia Cordero, Miguel A. Leonardo-Sepúlveda, Juan R. Torregrosa, María P. Vassileva",DOI:"10.1016/j.matcom.2024.05.001"},{year:2023,title:"Mathematics",q:"Q1",contenido:"Enhancing the Convergence Order from p to p+3 in Iterative Methods for Solving Nonlinear Systems of Equations without the Use of Jacobian Matrices",autores:"Alicia Cordero, Miguel A. Leonardo-Sepúlveda, Juan R. Torregrosa, María P. Vassileva",DOI:"10.3390/math11204238"},{year:2022,title:"Algorithms",q:"Q2",contenido:"Dynamics and Stability on a Family of Optimal Fourth-Order Iterative Methods",autores:"Alicia Cordero, Miguel A. Leonardo Sepúlveda, Juan R. Torregrosa",DOI:"10.3390/a15100387"}]},{id:2,img:C,name:"Antmel Rodríguez Cabral, Ph.D",area:"Métodos iterativos, estabilidad dinámica y métodos libres de Jacobiano",publicaciones:[{year:2026,title:"Mathematics",q:"Q1",contenido:"First Optimal Eighth-Order Families with Multivariable Scalar Weight Functions for Nonlinear Systems and Applications to Fredholm Integral and Semilinear Elliptic Problems",autores:"Alicia Cordero, Miguel A. Leonardo Sepúlveda, Juan R. Torregrosa, Antmel Rodríguez Cabral, Natanael Ureña Castillo",DOI:"10.3390/math14122114"},{year:2026,title:"Mathematics",q:"Q1",contenido:"A Weight Function Generalization of Singh–Sharma Fifth-Order Method for Systems of Nonlinear Equations, with Application to a Discretized Stationary Viscous Burgers Problem",autores:"Javier G. Maimó, Miguel A. Leonardo Sepúlveda, Antmel Rodríguez Cabral, Natanael Ureña Castillo",DOI:"10.3390/math14111944"},{year:2026,title:"Mathematics",q:"Q1",contenido:"Generalized Traub Family for Solving Nonlinear Systems: Fourth-Order Optimal Method and Dynamical Analysis",autores:"Alicia Cordero, Miguel A. Leonardo Sepúlveda, Juan R. Torregrosa, Antmel Rodríguez Cabral, María P. Vassileva",DOI:"10.3390/math14071161"},{year:2025,title:"Journal of Computational Methods in Sciences and Engineering",q:"Q4",contenido:"About the Stability of Self-Accelerating Parameters in Vectorial Iterative Methods without Memory",autores:"Alicia Cordero, Javier G. Maimó, Antmel Rodríguez Cabral, Juan R. Torregrosa",DOI:"10.1177/14727978251361407"},{year:2024,title:"Mathematics",q:"Q1",contenido:"Two-Step Fifth-Order Efficient Jacobian-Free Iterative Method for Solving Nonlinear Systems",autores:"Alicia Cordero, Javier García Maimó, Antmel Rodríguez Cabral, Juan R. Torregrosa",DOI:"10.3390/math12213341"},{year:2023,title:"Algorithms",q:"Q2",contenido:"Convergence and Stability of a New Parametric Class of Iterative Processes for Nonlinear Systems",autores:"Alicia Cordero, Javier G. Maimó, Antmel Rodríguez Cabral, Juan R. Torregrosa",DOI:"10.3390/a16030163"}]},{id:3,img:A,name:"Natanael Ureña Castillo",area:"Optimización numérica, métodos híbridos y aplicaciones computacionales",publicaciones:[{year:2026,title:"Mathematics",q:"Q1",contenido:"First Optimal Eighth-Order Families with Multivariable Scalar Weight Functions for Nonlinear Systems and Applications to Fredholm Integral and Semilinear Elliptic Problems",autores:"Alicia Cordero, Miguel A. Leonardo Sepúlveda, Juan R. Torregrosa, Antmel Rodríguez Cabral, Natanael Ureña Castillo",DOI:"10.3390/math14122114"},{year:2026,title:"Mathematics",q:"Q1",contenido:"A Weight Function Generalization of Singh–Sharma Fifth-Order Method for Systems of Nonlinear Equations, with Application to a Discretized Stationary Viscous Burgers Problem",autores:"Javier G. Maimó, Miguel A. Leonardo Sepúlveda, Antmel Rodríguez Cabral, Natanael Ureña Castillo",DOI:"10.3390/math14111944"},{year:2026,title:"Mathematics",q:"Q1",contenido:"Efficiency and Stability of a New Hybrid Unconstrained Optimization Algorithm with Quasi-Newton Updates and Higher-Order Methods",autores:"Alicia Cordero, Javier G. Maimó, Juan R. Torregrosa, Natanael Ureña Castillo",DOI:"10.3390/math14101746"}]},{id:4,img:b,name:"Marc-Kelly Jean Philippe Jean, Ph.D",area:"Teoría de grupos, caracteres y estructuras algebraicas",publicaciones:[{year:2025,title:"Mathematische Nachrichten",q:"Q2",contenido:"Groups with Triangle-Free Graphs on p-Regular Classes",autores:"M. J. Felipe, M. K. Jean-Philippe, V. Sotomayor",DOI:"10.1002/mana.202400554"},{year:2025,title:"Mediterranean Journal of Mathematics",q:"Q2",contenido:"Groups Whose Common Divisor Graph on p-Regular Classes Has Diameter Three",autores:"M. J. Felipe, M. K. Jean-Philippe, V. Sotomayor",DOI:"10.1007/s00009-024-02782-2"},{year:2024,title:"Bulletin of the Malaysian Mathematical Sciences Society",q:"Q2",contenido:"Some Properties of Normal Subgroups Determined from Character Tables",autores:"Z. Akhlaghi, M. J. Felipe, M. K. Jean-Philippe",DOI:"10.1007/s40840-024-01684-6"}]},{id:5,img:h,name:"José Alberto Reyes Reyes, M.Sc",area:"Métodos iterativos libres de derivadas, estabilidad y convergencia local",publicaciones:[{year:2025,title:"Computation",q:"Q2",contenido:"Stability Analysis and Local Convergence of a New Fourth-Order Optimal Jarratt-Type Iterative Scheme",autores:"Eulalia Martínez, José A. Reyes, Alicia Cordero, Juan R. Torregrosa",DOI:"10.3390/computation13060142"},{year:2024,title:"Axioms",q:"Q2",contenido:"Stability Analysis of a New Fourth-Order Optimal Iterative Scheme for Nonlinear Equations",autores:"Alicia Cordero, José A. Reyes, Juan R. Torregrosa, María P. Vassileva",DOI:"10.3390/axioms13010034"}]}];function d(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function q(e){return e.name||e.title||"Investigador"}function $e(e){return e.title||e.tile||"Revista no especificada"}function Ge(e){return String(e.DOI||e.doi||"").trim()}function Je(e){return e?e.startsWith("http")?e:`https://doi.org/${e}`:"#"}function He(e,t=!1){const a=q(e),i=e.publicaciones?.length||0,o=e.publicaciones?.map(n=>Number(n.year)).filter(Boolean)||[],s=o.length?Math.max(...o):"";return`
        <button data-id="${e.id}" 
    ...
    `}function Ve(e){const t=q(e),a=[...e.publicaciones||[]].sort((r,m)=>Number(m.year||0)-Number(r.year||0)),i=a.length,o=a.map(r=>Number(r.year)).filter(Boolean),s=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",l=[...new Set(a.map(r=>r.q).filter(Boolean))],c=a.map(r=>{const m=$e(r),u=Ge(r),p=Je(u);return`
                    ...
                    ${u?`
                            <a href="${d(p)}" 
                               ...
                               class="inline-flex items-center gap-2 text-sky-500 hover:text-sky-700 transition-colors text-sm md:text-base font-mono font-bold">
                                ...
                                <span class="break-all">DOI: ${d(u)}</span>
                            </a>
                          `:`
        ...
        <div class="flex flex-col h-full text-white">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-5">
                ...
                <div class="bg-white/10 rounded-2xl p-4 border border-white/10">
                    ...
                    <p class="text-2xl font-bold">${s&&n?`${s}–${n}`:"—"}</p>
                </div>

                <div class="bg-white/10 rounded-2xl p-4 border border-white/10">
                    <p class="text-sky-300 text-xs font-bold uppercase">Cuartiles</p>
                    <p class="text-2xl font-bold">${l.length?l.join(" · "):"—"}</p>
                </div>
            </div>
    ...
    `}function Qe(){let e=1,t=!1;const a=document.createElement("div");a.className="relative flex flex-col md:shadow-2xl md:rounded-2xl md:flex-row gap-6 w-full max-w-6xl mx-auto p-4 h-[600px] tabletBig:w-7xl tabletBig:px-20 xl:w-full xl:px-0";const i=()=>{const o=I.find(n=>n.id===e);a.innerHTML=`
    ...
    `}function Ze(){return Ke()}const g=[{id:1,title:"Plataforma de Simulación para Ecuaciones Diferenciales Parciales No Lineales",contenido:"Diseño e implementación de un software web para la simulación y visualización de soluciones aproximadas a EDPs no lineales utilizando métodos numéricos avanzados. El objetivo es crear una herramienta didáctica y de investigación abierta a estudiantes y científicos."},{id:2,title:"Entrenamiento de Redes Neuronales para la Solución de Problemas Matemáticos",contenido:"Proyecto orientado al desarrollo y entrenamiento de arquitecturas de redes neuronales profundas para el aprendizaje y la resolución automatizada de ecuaciones diferenciales y problemas complejos en optimización matemática."},{id:3,title:"Métodos Cuasi-Newton de Memoria Limitada Aplicados a Grandes Sistemas",contenido:"Investigación sobre el diseño y análisis de métodos cuasi-Newton híbridos de memoria limitada, dirigidos a la resolución eficiente de sistemas de ecuaciones de gran escala, con énfasis en aplicaciones de ingeniería y finanzas."},{id:4,title:"Modelización Matemática de Riesgo Actuarial y Financiero",contenido:"Elaboración de modelos para la evaluación y gestión del riesgo en problemas actuariales y financieros, combinando técnicas de optimización y simulación para ofrecer soluciones robustas a la toma de decisiones en estos campos."},{id:5,title:"Innovación en la Enseñanza y Evaluación de la Matemática",contenido:"Diseño de estrategias y recursos innovadores para la enseñanza de las matemáticas en distintos niveles educativos, incorporando metodologías activas, plataformas tecnológicas y evaluación por competencias."},{id:6,title:"Desarrollo de Métodos Metaheurísticos Híbridos",contenido:"Propuesta de integración de algoritmos metaheurísticos con métodos iterativos clásicos y cuasi-Newton para abordar problemas no lineales de alta complejidad en diferentes áreas de la ciencia y la ingeniería."}];function Xe(){let e=0;const t=g.length,a=document.createElement("section");a.className="w-full max-w-6xl mx-auto p-4 mt-10 mb-20 font-sans tabletBig:w-7xl tabletBig:px-20 xl:w-full xl:px-0";const i=()=>{const o=(e+1)%t,s=(e+2)%t,n=g[e],l=g[o],c=g[s];a.innerHTML=`
        ...
        `,a.querySelector("#next-btn").onclick=()=>{e=o,i()}};return i(),a}function O(e,t){return`
    ...
    `}function et(){return Xe()}function tt(){return`
    ...
    `}function it(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${at()}
    `,e}function ot(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",nt)}async function nt(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=st(i);if(o.length>0){lt(o);return}await ct(t,i)}function st(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?rt(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function rt(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function lt(e){f(e[0],"error")}function f(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function ct(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(f("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):f("Hubo un problema al enviar el mensaje.","error")}catch{f("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function dt(){const e=it();return setTimeout(()=>{ot()},0),e}const mt={home:{page:te,layout:"default"},quienesSomos:{page:fe,layout:"full"},equipment:{page:ye,layout:"default"},FormacionAcademica:{page:Se,layout:"default"},noticias:{page:Fe,layout:"full"},publicaciones:{page:Ye,layout:"default"},proyectos:{page:et,layout:"default"},lineas:{page:Ze,layout:"default"},contacto:{page:dt,layout:"default"}};function E(e){window.location.hash=`/${e}`}function ut(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";pt(t)};window.addEventListener("hashchange",e),e()}function pt(e){const t=document.querySelector("main"),a=mt[e];t&&(t.innerHTML="",a&&(Ae(a.layout),t.appendChild(a.page())))}function xt(e,t){U(e,E),ut();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(D(e),i=!0)}a.addEventListener("change",o),o(a),D(e);const s=t.querySelector('[data-action ="open-menu"]');V(s,e),Q(e)}const F=document.querySelector("#header");F.innerHTML=G();const $=document.querySelector("#navBar");$.innerHTML=J();const gt=document.querySelector("#footer");gt.innerHTML=H();xt($,F);
