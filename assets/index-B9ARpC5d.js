(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const F=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function me(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function ue(){return`<div class="lg:hidden border-b-zinc-500 border-b pb-2.5 w-full flex px-2.5 justify-between items-center mb-7">
        ...
        </ul>`}function xe(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    ...
    `}function _(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function ye(e){_(e,J)}const ee=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Ae=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,ke=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,W=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${ee}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${Ae}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        <img src="${ke}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function Ce(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=W.length,s=1500;let n=0,m=null;function b(r){return(r%o+o)%o}function u(){i.innerHTML=W[n].content}function l(r){n=b(n+r),u()}function h(){d(),m=setInterval(()=>l(1),s)}function d(){m&&(clearInterval(m),m=null)}function c(){h()}u(),h(),a.addEventListener("click",()=>{l(1),c()}),t.addEventListener("click",()=>{l(-1),c()})}function Ee(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return Ce(t.querySelector("#containerFather")),ye(t.querySelector("#btnsGroup")),t}function Se(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=`${we()}`;const a=Ee();return e.appendChild(a),e}function Me(){return Se()}const De=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Ie(){return`
        <section 
            role="banner" 
    ...
    `}const Ue="data:image/png;base64,",Te="data:image/png;base64,",Oe="data:image/png;base64,",Be="data:image/png;base64,",Ne="data:image/png;base64,",qe=[{icon:Ue,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:Te,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:Oe,title:"Objetivos",content:`
      ...
      </ul>`},{icon:Be,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Fe({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${Ne}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function Ge(){const e=document.createElement("section");return e.className=`
    ...
    `).join("")}function Qe(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function Ye(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=Ve(e.redes||[]),i=Qe(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
                ...
                <div class="flex flex-wrap gap-2">
                    ${i||`
                                <p class="text-sm text-slate-500 leading-relaxed">
                                    ${C(e.areas||"Área no especificada")}
                                </p>
                              `}
                </div>
            </div>
    ...
    `,a}const ae=""+new URL("rad-B3ff1btG.png",import.meta.url).href,te=""+new URL("mar-Cru0HERG.png",import.meta.url).href,j=[{img:O,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:N,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:ae,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:G,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:te,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:B,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:U,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function We(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,s=()=>{const c=o();return Math.max(j.length-c,0)},n=()=>{const c=s();e>c&&(e=0),e<0&&(e=c)},m=()=>{const c=s();e>=c?e=0:e++,d()},b=()=>{const c=s();e<=0?e=c:e--,d()},u=()=>{l(),j.length>o()&&(a=setInterval(m,4500))},l=()=>{a&&(clearInterval(a),a=null)},h=()=>{const c=o(),r=Math.max(j.length-c+1,1);return Array.from({length:r}).map((x,p)=>`
        ...
        `).join("")},d=()=>{if(!j||j.length===0){i.innerHTML=`
            ...
            `;return}n();const c=o(),r=j.slice(e,e+c);i.innerHTML=`
        ...
        `;const x=i.querySelector("#cards-wrapper");r.forEach(f=>{x.appendChild(Ye(f))});const p=i.querySelector("#prev-btn"),g=i.querySelector("#next-btn");p&&(p.onclick=()=>{b(),u()}),g&&(g.onclick=()=>{m(),u()}),i.querySelectorAll("[data-dot-index]").forEach(f=>{f.onclick=()=>{e=parseInt(f.dataset.dotIndex),d(),u()}})};return i.addEventListener("mouseenter",l),i.addEventListener("mouseleave",u),document.addEventListener("visibilitychange",()=>{document.hidden?l():u()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,d(),u()},150)}),d(),u(),i}function Xe(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&J(t.dataset.route)})}function ie(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Xe(a),a}function Ze(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(ie());const t=We();return e.appendChild(a),e.appendChild(t),e}function _e(){return Ze()}function ea(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function k(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function oe(e){return e.formacion?.length||0}function se(e){return e.experiencia?.length||0}function aa(e,a=!1){const t=oe(e),i=se(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function ta(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(m=>`
    ...
    `}function S(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function pa({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:s,category:n="Noticia",imageFit:m="contain"}){const b=m==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${S(e)}"
            class="
    ...
    `}function ua(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function xa(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function ga(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const a=xa(ne),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ${da(t)}
        ${ma(a)}
        ${ua()}
    `,e}function ba({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(n=>`<p>${n}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function fa(e){e&&e.addEventListener("click",a=>{const t=a.target.closest("[data-news-btn], [data-news-card]");if(!t||!e.contains(t))return;const i=t.dataset.newsBtn||t.dataset.newsCard,o=ne.find(s=>String(s.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}va(o)})}function va(e){const a=document.querySelector("#newsModal");a&&a.remove();const t=document.createElement("div");t.innerHTML=ba(e);const i=t.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",s)}function s(n){n.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(n=>{n.addEventListener("click",o)}),i.addEventListener("click",n=>{n.target===i&&o()}),document.addEventListener("keydown",s)}function ha(){const e=ga();return fa(e),e}function w(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function re(e){return e?.name||e?.title||"Investigador"}function X(e){return e?.title||e?.tile||"Revista no especificada"}function le(e){return String(e?.DOI||e?.doi||"").trim()}function wa(e){const a=le(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function ya(e){return[...e?.publicaciones||[]].sort((a,t)=>{const i=Number(a.year||0),o=Number(t.year||0);return i!==o?o-i:String(a.contenido||"").localeCompare(String(t.contenido||""))})}function Aa(e,a=!1){const t=re(e),i=e.publicaciones||[],o=i.length,s=i.map(m=>Number(m.year)).filter(Boolean),n=s.length?Math.max(...s):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${a?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function ka(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const a=re(e),t=ya(e),i=t.length,o=t.map(l=>Number(l.year)).filter(Boolean),s=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",m=[...new Set(t.map(l=>l.q).filter(Boolean))],b=[...new Set(t.map(l=>X(l)).filter(Boolean))],u=t.map(l=>{const h=X(l),d=le(l),c=wa(l);return`
    ...
    `}function Ca(){let e=E[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(r){return String(r?.DOI||r?.doi||"").trim().toLowerCase()}function s(r){return String(r?.journal||r?.title||r?.tile||"").trim()}function n(r){return String(r?.articleTitle||r?.contenido||"").trim()}function m(r){return String(r?.q||r?.quartile||"").trim().toUpperCase()}function b(r){const x=o(r);return x||[r?.year||"",s(r),n(r)].join("-").trim().toLowerCase()}function u(){const r=new Map;return E.forEach(x=>{(x.publicaciones||[]).forEach(p=>{const g=b(p);g&&!r.has(g)&&r.set(g,p)})}),Array.from(r.values())}function l(){const r=u(),x=r.map(A=>Number(A.year)).filter(Boolean),p=x.length?Math.max(...x):"—",g=x.length?Math.min(...x):"—",f=r.filter(A=>m(A)==="Q1").length;return{totalPublicaciones:r.length,investigadores:E.length,q1:f,primerYear:g,ultimoYear:p}}function h(){return E.find(r=>Number(r.id)===Number(e))||E[0]}const d=()=>{const r=h(),x=l(),p=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${E.map(f=>Aa(f,Number(f.id)===Number(e))).join("")}
                </aside>
    ...
    `}function La(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function ja(){const e=new Set(I.map(i=>i.categoria)),a=I.filter(i=>i.proyectosAsociados?.length>0).length,t=I.filter(i=>i.publicacionesClave?.length>0).length;return{total:I.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function $a(){let e=I[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Sa(e),o=ja();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${v(e.institucion)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Tipo</p>
                        <p class="text-slate-800 font-bold mt-1">${v(e.tipo)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Duración estimada</p>
                        <p class="text-slate-800 font-bold mt-1">${v(e.duracion)}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        ...
                        <p class="text-slate-700 font-semibold mt-1">${v(e.fechaInicio)}</p>
                    </div>

                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Fecha final prevista</p>
                        <p class="text-slate-700 font-semibold mt-1">${v(e.fechaFinalizacion)}</p>
                    </div>
                </div>
    ...
    `}function Na(){let e=z[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=za(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function qa(){return Na()}function Ra(){return`
    ...
    `}function Ga(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Fa()}
    `,e}function Ja(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Ka)}async function Ka(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=Ha(i);if(o.length>0){Qa(o);return}await Ya(a,i)}function Ha(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?Va(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function Va(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Qa(e){T(e[0],"error")}function T(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Ya(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(T("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):T("Hubo un problema al enviar el mensaje.","error")}catch{T("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Wa(){const e=Ga();return setTimeout(()=>{Ja()},0),e}function Xa(){const e=document.createElement("section");return e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div>
    ...
    `,e}function Za(){const e=document.createElement("section");return e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div>
            <p class="mb-2 text-sm font-black uppercase tracking-wide text-[#5580C1]">
                Segundo período
            </p>
    ...
    `,e}function _a(){const e=document.createElement("section");return e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div>
            <p class="mb-2 text-sm font-black uppercase tracking-wide text-[#5580C1]">
                Calificación final
            </p>
    ...
    `,e}function et(){const e=document.createElement("section");return e.className="w-full max-w-7xl mx-auto px-4 py-10",e.innerHTML=`
    ...
    `,e.querySelector("#banner-primer-periodo").appendChild(Xa()),e.querySelector("#banner-segundo-periodo").appendChild(Za()),e.querySelector("#banner-calificacion-final").appendChild(_a()),e}function at(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
        <div class="mb-8 text-center">
...
20252000     0"
    ...
    `;const a=e.querySelector("#xmera-input"),t=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),s=e.querySelector("#xmera-clear"),n=e.querySelector("#xmera-message"),m=e.querySelector("#tab-xmera"),b=e.querySelector("#tab-banner"),u=e.querySelector("#panel-xmera"),l=e.querySelector("#panel-banner");function h(){t.textContent=`var data_todo = {
};`,o.disabled=!0}function d(p,g="success"){n.textContent=p,n.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),n.classList.add("border"),g==="error"?n.classList.add("border-red-200","bg-red-50","text-red-800"):n.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function c(p){const g=p.split(/\r?\n/).map(q=>q.trim()).filter(Boolean),f=[],A=[],K=new Set;return g.forEach((q,pe)=>{const H=q.split(/[\t,; ]+/).map(P=>P.trim()).filter(Boolean),$=pe+1,L=H[0],V=H.slice(1);if(!L){A.push(`Línea ${$}: falta la matrícula.`);return}if(!/^\d+$/.test(L)){A.push(`Línea ${$}: la matrícula "${L}" no es válida.`);return}if(K.has(L)){A.push(`Línea ${$}: la matrícula ${L} está repetida.`);return}if(V.length===0){A.push(`Línea ${$}: falta al menos una calificación.`);return}const Q=V.map(P=>Number(P));if(Q.some(P=>!Number.isFinite(P))){A.push(`Línea ${$}: existe una calificación no numérica.`);return}K.add(L),f.push({matricula:L,grades:Q})}),{records:f,errors:A}}function r(p){return`var data_todo = {
${p.map(({matricula:f,grades:A})=>`  "${f}":[${A.join(",")}]`).join(`,
`)}
};
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function x(p){const g=p==="xmera";u.classList.toggle("hidden",!g),l.classList.toggle("hidden",g),m.className=g?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",b.className=g?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const p=a.value.trim();if(!p){h(),d("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:g,errors:f}=c(p);if(f.length>0){h(),d(f.join(" "),"error");return}t.textContent=r(g),o.disabled=!1,d(`Código generado correctamente para ${g.length} estudiante${g.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),d("El código fue copiado al portapapeles.")}catch(p){console.error("No fue posible copiar el código:",p),d("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),s.addEventListener("click",()=>{a.value="",h(),n.textContent="",n.classList.add("hidden"),a.focus()});try{const p=et();if(p instanceof HTMLElement)l.appendChild(p);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(p){console.error("No fue posible cargar el módulo Banner:",p),l.innerHTML=`
        ...
        `}return m.addEventListener("click",()=>{x("xmera")}),b.addEventListener("click",()=>{x("banner")}),x("xmera"),e}function tt(){return at()}const it={home:{page:Me,layout:"default"},quienesSomos:{page:He,layout:"full"},equipment:{page:_e,layout:"default"},FormacionAcademica:{page:oa,layout:"default"},noticias:{page:ha,layout:"full"},publicaciones:{page:Ea,layout:"default"},proyectos:{page:qa,layout:"default"},lineas:{page:Pa,layout:"default"},contacto:{page:Wa,layout:"default"},herramientas:{page:tt,layout:"default"}};function J(e){window.location.hash=`/${e}`}function ot(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";st(a)};window.addEventListener("hashchange",e),e()}function st(e){const a=document.querySelector("main"),t=it[e];a&&(a.innerHTML="",t&&(ea(t.layout),a.appendChild(t.page())))}function nt(e,a){_(e,J),ot();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(Y(e),i=!0)}t.addEventListener("change",o),o(t),Y(e);const s=a.querySelector('[data-action ="open-menu"]');ge(s,e),be(e)}const ce=document.querySelector("#header");ce.innerHTML=me();const de=document.querySelector("#navBar");de.innerHTML=ue();const rt=document.querySelector("#footer");rt.innerHTML=xe();nt(de,ce);
