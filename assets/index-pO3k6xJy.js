(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const R=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function re(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function le(){return`<div class="lg:hidden border-b-zinc-500 border-b pb-2.5 w-full flex px-2.5 justify-between items-center mb-7">
        ...
        </ul>`}function ce(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    ...
    `}function Y(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function be(e){Y(e,F)}const W=""+new URL("apec-ConmXkrT.png",import.meta.url).href,fe=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,ve=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,H=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${W}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${fe}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        <img src="${ve}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function he(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=H.length,s=1500;let n=0,m=null;function g(r){return(r%o+o)%o}function u(){i.innerHTML=H[n].content}function d(r){n=g(n+r),u()}function p(){c(),m=setInterval(()=>d(1),s)}function c(){m&&(clearInterval(m),m=null)}function l(){p()}u(),p(),a.addEventListener("click",()=>{d(1),l()}),t.addEventListener("click",()=>{d(-1),l()})}function we(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return he(t.querySelector("#containerFather")),be(t.querySelector("#btnsGroup")),t}function ye(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=`${ge()}`;const a=we();return e.appendChild(a),e}function Ae(){return ye()}const ke=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Ce(){return`
        <section 
            role="banner" 
  ...
  `}function Te({icon:e,title:a,content:t}){return`
  ...
  `}function Be(){const e=document.createElement("section");return e.className=`
    ...
    `).join("")}function Ge(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `;const t=Fe(e.redes||[]),i=Ge(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}const X=""+new URL("rad-B3ff1btG.png",import.meta.url).href,Z=""+new URL("mar-Cru0HERG.png",import.meta.url).href,j=[{img:O,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:B,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:X,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:q,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:Z,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:T,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:z,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function Ke(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,s=()=>{const l=o();return Math.max(j.length-l,0)},n=()=>{const l=s();e>l&&(e=0),e<0&&(e=l)},m=()=>{const l=s();e>=l?e=0:e++,c()},g=()=>{const l=s();e<=0?e=l:e--,c()},u=()=>{d(),j.length>o()&&(a=setInterval(m,4500))},d=()=>{a&&(clearInterval(a),a=null)},p=()=>{const l=o(),r=Math.max(j.length-l+1,1);return Array.from({length:r}).map((x,f)=>`
        ...
        `).join("")},c=()=>{if(!j||j.length===0){i.innerHTML=`
            ...
            `;return}n();const l=o(),r=j.slice(e,e+l);i.innerHTML=`
        ...
        `;const x=i.querySelector("#cards-wrapper");r.forEach(v=>{x.appendChild(Je(v))});const f=i.querySelector("#prev-btn"),w=i.querySelector("#next-btn");f&&(f.onclick=()=>{g(),u()}),w&&(w.onclick=()=>{m(),u()}),i.querySelectorAll("[data-dot-index]").forEach(v=>{v.onclick=()=>{e=parseInt(v.dataset.dotIndex),c(),u()}})};return i.addEventListener("mouseenter",d),i.addEventListener("mouseleave",u),document.addEventListener("visibilitychange",()=>{document.hidden?d():u()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,c(),u()},150)}),c(),u(),i}function He(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&F(t.dataset.route)})}function _(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,He(a),a}function Ve(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(_());const t=Ke();return e.appendChild(a),e.appendChild(t),e}function Qe(){return Ve()}function Ye(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function A(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ee(e){return e.formacion?.length||0}function ae(e){return e.experiencia?.length||0}function We(e,a=!1){const t=ee(e),i=ae(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function Xe(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(m=>`
    ...
    `}function S(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function na({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:s,category:n="Noticia",imageFit:m="contain"}){const g=m==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${S(e)}"
            class="
    ...
    `}function la(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function ca(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function da(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const a=ca(te),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ${sa(t)}
        ${ra(a)}
        ${la()}
    `,e}function pa({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(n=>`<p>${n}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function ma(e){e&&e.addEventListener("click",a=>{const t=a.target.closest("[data-news-btn], [data-news-card]");if(!t||!e.contains(t))return;const i=t.dataset.newsBtn||t.dataset.newsCard,o=te.find(s=>String(s.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}ua(o)})}function ua(e){const a=document.querySelector("#newsModal");a&&a.remove();const t=document.createElement("div");t.innerHTML=pa(e);const i=t.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",s)}function s(n){n.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(n=>{n.addEventListener("click",o)}),i.addEventListener("click",n=>{n.target===i&&o()}),document.addEventListener("keydown",s)}function xa(){const e=da();return ma(e),e}function h(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ie(e){return e?.name||e?.title||"Investigador"}function V(e){return e?.title||e?.tile||"Revista no especificada"}function oe(e){return String(e?.DOI||e?.doi||"").trim()}function ga(e){const a=oe(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function ba(e){return[...e?.publicaciones||[]].sort((a,t)=>{const i=Number(a.year||0),o=Number(t.year||0);return i!==o?o-i:String(a.contenido||"").localeCompare(String(t.contenido||""))})}function fa(e,a=!1){const t=ie(e),i=e.publicaciones||[],o=i.length,s=i.map(m=>Number(m.year)).filter(Boolean),n=s.length?Math.max(...s):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${a?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function va(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const a=ie(e),t=ba(e),i=t.length,o=t.map(d=>Number(d.year)).filter(Boolean),s=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",m=[...new Set(t.map(d=>d.q).filter(Boolean))],g=[...new Set(t.map(d=>V(d)).filter(Boolean))],u=t.map(d=>{const p=V(d),c=oe(d),l=ga(d);return`
    ...
    `}function ha(){let e=C[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(r){return String(r?.DOI||r?.doi||"").trim().toLowerCase()}function s(r){return String(r?.journal||r?.title||r?.tile||"").trim()}function n(r){return String(r?.articleTitle||r?.contenido||"").trim()}function m(r){return String(r?.q||r?.quartile||"").trim().toUpperCase()}function g(r){const x=o(r);return x||[r?.year||"",s(r),n(r)].join("-").trim().toLowerCase()}function u(){const r=new Map;return C.forEach(x=>{(x.publicaciones||[]).forEach(f=>{const w=g(f);w&&!r.has(w)&&r.set(w,f)})}),Array.from(r.values())}function d(){const r=u(),x=r.map(E=>Number(E.year)).filter(Boolean),f=x.length?Math.max(...x):"—",w=x.length?Math.min(...x):"—",v=r.filter(E=>m(E)==="Q1").length;return{totalPublicaciones:r.length,investigadores:C.length,q1:v,primerYear:w,ultimoYear:f}}function p(){return C.find(r=>Number(r.id)===Number(e))||C[0]}const c=()=>{const r=p(),x=d(),f=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${C.map(v=>fa(v,Number(v.id)===Number(e))).join("")}
                </aside>
    ...
    `).join("")}function ka(e=[]){return e.map(a=>`
    ...
    `}function Ea(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function Sa(){const e=new Set(I.map(i=>i.categoria)),a=I.filter(i=>i.proyectosAsociados?.length>0).length,t=I.filter(i=>i.publicacionesClave?.length>0).length;return{total:I.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function Ma(){let e=I[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=ya(e),o=Sa();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `).join("")}function ja(e=[]){return e.map(a=>`
        <span class="inline-flex items-center bg-white/10 text-white border border-white/10 px-3 py-1 rounded-full text-xs font-semibold">
            ${b(a)}
        </span>
    `).join("")}function $a(e,a=!1){return`
        <button 
            type="button"
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${b(e.institucion)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Tipo</p>
                        <p class="text-slate-800 font-bold mt-1">${b(e.tipo)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Duración estimada</p>
                        <p class="text-slate-800 font-bold mt-1">${b(e.duracion)}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        ...
                        <p class="text-slate-700 font-semibold mt-1">${b(e.fechaInicio)}</p>
                    </div>

                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Fecha final prevista</p>
                        <p class="text-slate-700 font-semibold mt-1">${b(e.fechaFinalizacion)}</p>
                    </div>
                </div>
    ...
    `}function za(){let e=P[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Ia(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function Ua(){return za()}function Oa(){return`
    ...
    ${Ta()}
    `,e}function Na(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Ra)}async function Ra(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=qa(i);if(o.length>0){Ga(o);return}await Ja(a,i)}function qa(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?Fa(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function Fa(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Ga(e){U(e[0],"error")}function U(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Ja(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(U("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):U("Hubo un problema al enviar el mensaje.","error")}catch{U("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Ka(){const e=Ba();return setTimeout(()=>{Na()},0),e}function Ha(){const e=document.createElement("section");return e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div>
    ...
    `,e}function Va(){const e=document.createElement("section");return e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div>
            <p class="mb-2 text-sm font-black uppercase tracking-wide text-[#5580C1]">
                Segundo período
            </p>
    ...
    `,e}function Qa(){const e=document.createElement("section");return e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div>
            <p class="mb-2 text-sm font-black uppercase tracking-wide text-[#5580C1]">
                Calificación final
            </p>
    ...
    `,e}function Ya(){const e=document.createElement("section");return e.className="w-full max-w-7xl mx-auto px-4 py-10",e.innerHTML=`
    ...
    `,e.querySelector("#banner-primer-periodo").appendChild(Ha()),e.querySelector("#banner-segundo-periodo").appendChild(Va()),e.querySelector("#banner-calificacion-final").appendChild(Qa()),e}function Wa(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
        <div class="mb-8 text-center">
...
20252000     0"
    ...
    `;const a=e.querySelector("#xmera-input"),t=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),s=e.querySelector("#xmera-clear"),n=e.querySelector("#xmera-message");function m(){t.textContent=`var data_todo = {
};`,o.disabled=!0}function g(p,c="success"){n.textContent=p,n.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),n.classList.add("border"),c==="error"?n.classList.add("border-red-200","bg-red-50","text-red-800"):n.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function u(p){const c=p.split(/\r?\n/).map(f=>f.trim()).filter(Boolean),l=[],r=[],x=new Set;return c.forEach((f,w)=>{const v=f.split(/[\t,; ]+/).map($=>$.trim()).filter(Boolean),E=w+1,L=v[0],G=v.slice(1);if(!L){r.push(`Línea ${E}: falta la matrícula.`);return}if(!/^\d+$/.test(L)){r.push(`Línea ${E}: la matrícula "${L}" no es válida.`);return}if(x.has(L)){r.push(`Línea ${E}: la matrícula ${L} está repetida.`);return}if(G.length===0){r.push(`Línea ${E}: falta al menos una calificación.`);return}const J=G.map($=>Number($));if(J.some($=>!Number.isFinite($))){r.push(`Línea ${E}: existe una calificación no numérica.`);return}x.add(L),l.push({matricula:L,grades:J})}),{records:l,errors:r}}function d(p){return`var data_todo = {
${p.map(({matricula:l,grades:r})=>`  "${l}":[${r.join(",")}]`).join(`,
`)}
};
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}i.addEventListener("click",()=>{const p=a.value.trim();if(!p){m(),g("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:c,errors:l}=u(p);if(l.length>0){m(),g(l.join(" "),"error");return}t.textContent=d(c),o.disabled=!1,g(`Código generado correctamente para ${c.length} estudiante${c.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),g("El código fue copiado al portapapeles.")}catch(p){console.error("No fue posible copiar el código:",p),g("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),s.addEventListener("click",()=>{a.value="",m(),n.textContent="",n.classList.add("hidden"),a.focus()});try{const p=Ya();p instanceof HTMLElement?(p.classList.add("mt-14"),e.appendChild(p)):console.error("bannerComponent() no devolvió un elemento HTML válido.")}catch(p){console.error("No fue posible cargar el módulo Banner:",p);const c=document.createElement("div");c.className="mt-14 rounded-2xl border border-red-200 bg-red-50 p-5 text-red-800",c.innerHTML=`
            <p class="font-black">
        ...
        `,e.appendChild(c)}return e}function Xa(){return Wa()}const Za={home:{page:Ae,layout:"default"},quienesSomos:{page:qe,layout:"full"},equipment:{page:Qe,layout:"default"},FormacionAcademica:{page:_e,layout:"default"},noticias:{page:xa,layout:"full"},publicaciones:{page:wa,layout:"default"},proyectos:{page:Ua,layout:"default"},lineas:{page:Da,layout:"default"},contacto:{page:Ka,layout:"default"},herramientas:{page:Xa,layout:"default"}};function F(e){window.location.hash=`/${e}`}function _a(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";et(a)};window.addEventListener("hashchange",e),e()}function et(e){const a=document.querySelector("main"),t=Za[e];a&&(a.innerHTML="",t&&(Ye(t.layout),a.appendChild(t.page())))}function at(e,a){Y(e,F),_a();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(K(e),i=!0)}t.addEventListener("change",o),o(t),K(e);const s=a.querySelector('[data-action ="open-menu"]');de(s,e),pe(e)}const se=document.querySelector("#header");se.innerHTML=re();const ne=document.querySelector("#navBar");ne.innerHTML=le();const tt=document.querySelector("#footer");tt.innerHTML=ce();at(ne,se);
