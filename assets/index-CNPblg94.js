...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
    ...
    `}const si={home:{page:ma,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:Da,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Ta,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Ga,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:rt,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:pt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:St,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:ht,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Nt,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Ut,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Vt,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Wt,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"}};let Ie=document.referrer||"";function ce(e){window.location.hash=`/${e}`}function ni(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";ci(a)};window.addEventListener("hashchange",e),e()}function li(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:Ie}),Ie=t}function ci(e){const a=document.querySelector("main"),t=si[e];if(a){if(a.innerHTML="",!t){ce("home");return}Ba(t.layout),document.title=t.title,a.appendChild(t.page()),window.scrollTo({top:0,behavior:"auto"}),li(e,t.title)}}function di(e,a){Re(e,ce),ni();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(ke(e),i=!0)}t.addEventListener("change",o),o(t),ke(e);const n=a.querySelector('[data-action ="open-menu"]');Xe(n,e),_e(e)}const Ke=document.querySelector("#header");Ke.innerHTML=Qe();const Je=document.querySelector("#navBar");Je.innerHTML=We();const pi=document.querySelector("#footer");pi.innerHTML=Ye();di(Je,Ke);
