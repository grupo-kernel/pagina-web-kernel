(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const Y=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function be(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function ge(){return`<div class="lg:hidden border-b-zinc-500 border-b pb-2.5 w-full flex px-2.5 justify-between items-center mb-7">
        ...
        </ul>`}function fe(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${Y}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function te(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function Ce(e){te(e,X)}const ie=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Ee=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Se=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,_=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${ie}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${Ee}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        <img src="${Se}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function Me(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=_.length,s=1500;let n=0,m=null;function b(r){return(r%o+o)%o}function d(){i.innerHTML=_[n].content}function l(r){n=b(n+r),d()}function v(){u(),m=setInterval(()=>l(1),s)}function u(){m&&(clearInterval(m),m=null)}function p(){v()}d(),v(),a.addEventListener("click",()=>{l(1),p()}),t.addEventListener("click",()=>{l(-1),p()})}function De(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return Me(t.querySelector("#containerFather")),Ce(t.querySelector("#btnsGroup")),t}function Le(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=`${ke()}`;const a=De();return e.appendChild(a),e}function Pe(){return Le()}const Ie=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function je(){return`
        <section 
            role="banner" 
    ...
    `}const qe="data:image/png;base64,",Ne="data:image/png;base64,",Oe="data:image/png;base64,",Re="data:image/png;base64,",Fe="data:image/png;base64,",Ge=[{icon:qe,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:Ne,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:Oe,title:"Objetivos",content:`
      ...
      </ul>`},{icon:Re,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Ve({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${Fe}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function He(){const e=document.createElement("section");return e.className=`
    ...
    `,e}function Ke(e){e.querySelectorAll("[data-accordion-header]").forEach(t=>{t.addEventListener("click",()=>{const i=t.nextElementSibling,o=t.querySelector("[data-accordion-icon]"),s=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(n=>{n.classList.remove("max-h-[1000px]"),n.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(n=>{n.classList.remove("rotate-180")}),s||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function Qe(e){const a=e.querySelector("[data-description-text]"),t=e.querySelector("[data-description-btn]");if(!a||!t)return;let i=!1;t.addEventListener("click",()=>{i=!i,a.classList.toggle("line-clamp-4",!i),t.textContent=i?"Leer menos":"Leer más"})}function Ye(){const e=He();return Ke(e),Qe(e),e}function L(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function We(e=[]){return!e||e.length===0?`
        ...
        <a href="${L(a.url)}" 
           ...
           title="${L(a.name)}">
            <i class="${L(a.icon)} text-xl"></i>
        </a>
    `).join("")}function Xe(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function Ze(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=We(e.redes||[]),i=Xe(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
        ...
        <div class="w-full flex flex-col gap-4 text-left flex-1">
                ...
                <div class="flex flex-wrap gap-2">
                    ${i||`
                                <p class="text-sm text-slate-500 leading-relaxed">
                                    ${L(e.areas||"Área no especificada")}
                                </p>
                              `}
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-sm text-slate-600 leading-relaxed">
                    ${L(e.afilaciones||e.afiliaciones||"No especificadas")}
                </p>
            </div>
    ...
    `,a}const oe=""+new URL("rad-B3ff1btG.png",import.meta.url).href,se=""+new URL("mar-Cru0HERG.png",import.meta.url).href,N=[{img:V,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:K,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:oe,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:W,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:se,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:H,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:G,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function _e(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,s=()=>{const p=o();return Math.max(N.length-p,0)},n=()=>{const p=s();e>p&&(e=0),e<0&&(e=p)},m=()=>{const p=s();e>=p?e=0:e++,u()},b=()=>{const p=s();e<=0?e=p:e--,u()},d=()=>{l(),N.length>o()&&(a=setInterval(m,4500))},l=()=>{a&&(clearInterval(a),a=null)},v=()=>{const p=o(),r=Math.max(N.length-p+1,1);return Array.from({length:r}).map((g,x)=>`
        ...
        `).join("")},u=()=>{if(!N||N.length===0){i.innerHTML=`
            ...
            `;return}n();const p=o(),r=N.slice(e,e+p);i.innerHTML=`
        ...
        `;const g=i.querySelector("#cards-wrapper");r.forEach(h=>{g.appendChild(Ze(h))});const x=i.querySelector("#prev-btn"),f=i.querySelector("#next-btn");x&&(x.onclick=()=>{b(),d()}),f&&(f.onclick=()=>{m(),d()}),i.querySelectorAll("[data-dot-index]").forEach(h=>{h.onclick=()=>{e=parseInt(h.dataset.dotIndex),u(),d()}})};return i.addEventListener("mouseenter",l),i.addEventListener("mouseleave",d),document.addEventListener("visibilitychange",()=>{document.hidden?l():d()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,u(),d()},150)}),u(),d(),i}function ea(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&X(t.dataset.route)})}function ne(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,ea(a),a}function aa(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(ne());const t=_e();return e.appendChild(a),e.appendChild(t),e}function ta(){return aa()}function ia(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function D(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function re(e){return e.formacion?.length||0}function le(e){return e.experiencia?.length||0}function oa(e,a=!1){const t=re(e),i=le(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function sa(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(m=>`
                        ...
                        ">
                            ...
                            ">
                                ...
                                <div class="flex flex-wrap items-center gap-3 mb-5">
                                    ...
                                    ">
                                        ${B(e.category||"Noticia destacada")}
                                    </span>
    ...
    `}function z(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function xa({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:s,category:n="Noticia",imageFit:m="contain"}){const b=m==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${z(e)}"
            class="
        ...
        >
            ...
            <div class="p-4 space-y-3 flex flex-col flex-1">
                ...
                <button
                    type="button"
                    data-news-btn="${z(e)}"
                    aria-label="Ver detalles de la noticia ${z(a)}"
                    class="
    ...
    `}function ga(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function fa(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function va(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const a=fa(ce),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ${ua(t)}
        ${ba(a)}
        ${ga()}
    `,e}function ha({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(n=>`<p>${n}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function wa(e){e&&e.addEventListener("click",a=>{const t=a.target.closest("[data-news-btn], [data-news-card]");if(!t||!e.contains(t))return;const i=t.dataset.newsBtn||t.dataset.newsCard,o=ce.find(s=>String(s.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}ya(o)})}function ya(e){const a=document.querySelector("#newsModal");a&&a.remove();const t=document.createElement("div");t.innerHTML=ha(e);const i=t.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",s)}function s(n){n.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(n=>{n.addEventListener("click",o)}),i.addEventListener("click",n=>{n.target===i&&o()}),document.addEventListener("keydown",s)}function Aa(){const e=va();return wa(e),e}function k(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function de(e){return e?.name||e?.title||"Investigador"}function ee(e){return e?.title||e?.tile||"Revista no especificada"}function pe(e){return String(e?.DOI||e?.doi||"").trim()}function ka(e){const a=pe(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function Ca(e){return[...e?.publicaciones||[]].sort((a,t)=>{const i=Number(a.year||0),o=Number(t.year||0);return i!==o?o-i:String(a.contenido||"").localeCompare(String(t.contenido||""))})}function Ea(e,a=!1){const t=de(e),i=e.publicaciones||[],o=i.length,s=i.map(m=>Number(m.year)).filter(Boolean),n=s.length?Math.max(...s):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${a?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function Sa(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const a=de(e),t=Ca(e),i=t.length,o=t.map(l=>Number(l.year)).filter(Boolean),s=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",m=[...new Set(t.map(l=>l.q).filter(Boolean))],b=[...new Set(t.map(l=>ee(l)).filter(Boolean))],d=t.map(l=>{const v=ee(l),u=pe(l),p=ka(l);return`
    ...
    `}function Ma(){let e=I[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(r){return String(r?.DOI||r?.doi||"").trim().toLowerCase()}function s(r){return String(r?.journal||r?.title||r?.tile||"").trim()}function n(r){return String(r?.articleTitle||r?.contenido||"").trim()}function m(r){return String(r?.q||r?.quartile||"").trim().toUpperCase()}function b(r){const g=o(r);return g||[r?.year||"",s(r),n(r)].join("-").trim().toLowerCase()}function d(){const r=new Map;return I.forEach(g=>{(g.publicaciones||[]).forEach(x=>{const f=b(x);f&&!r.has(f)&&r.set(f,x)})}),Array.from(r.values())}function l(){const r=d(),g=r.map(c=>Number(c.year)).filter(Boolean),x=g.length?Math.max(...g):"—",f=g.length?Math.min(...g):"—",h=r.filter(c=>m(c)==="Q1").length;return{totalPublicaciones:r.length,investigadores:I.length,q1:h,primerYear:f,ultimoYear:x}}function v(){return I.find(r=>Number(r.id)===Number(e))||I[0]}const u=()=>{const r=v(),g=l(),x=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${I.map(h=>Ea(h,Number(h.id)===Number(e))).join("")}
                </aside>
    ...
    `).join("")}function ja(e,a=!1){return`
        <button 
            ...
            <p class="text-sm leading-relaxed ${a?"text-white/90":"text-slate-500"}">
                ${S(e.desarrollo).slice(0,185)}${String(e.desarrollo).length>185?"...":""}
            </p>
        </button>
    `}function $a(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${S(e.categoria)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Prioridad</p>
                        <p class="text-slate-800 font-bold mt-1">${S(e.prioridad)}</p>
                    </div>
    ...
    `}function za(){const e=new Set(U.map(i=>i.categoria)),a=U.filter(i=>i.proyectosAsociados?.length>0).length,t=U.filter(i=>i.publicacionesClave?.length>0).length;return{total:U.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function Ta(){let e=U[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=La(e),o=za();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${y(e.institucion)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Tipo</p>
                        <p class="text-slate-800 font-bold mt-1">${y(e.tipo)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Duración estimada</p>
                        <p class="text-slate-800 font-bold mt-1">${y(e.duracion)}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        ...
                        <p class="text-slate-700 font-semibold mt-1">${y(e.fechaInicio)}</p>
                    </div>

                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Fecha final prevista</p>
                        <p class="text-slate-700 font-semibold mt-1">${y(e.fechaFinalizacion)}</p>
                    </div>
                </div>
    ...
    `}function Fa(){let e=F[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Ua(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function Ga(){return Fa()}function Ja(){return`
    ...
    `}function Ha(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Va()}
    `,e}function Ka(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Qa)}async function Qa(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=Ya(i);if(o.length>0){Xa(o);return}await Za(a,i)}function Ya(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?Wa(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function Wa(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Xa(e){J(e[0],"error")}function J(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Za(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(J("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):J("Hubo un problema al enviar el mensaje.","error")}catch{J("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function _a(){const e=Ha();return setTimeout(()=>{Ka()},0),e}function et(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
202010828   15    20"
    ...
    `;const a=e.querySelector("#banner-primer-input"),t=e.querySelector("#banner-primer-process"),i=e.querySelector("#banner-primer-clear"),o=e.querySelector("#banner-primer-message"),s=e.querySelector("#banner-primer-preview"),n=e.querySelector("#banner-primer-count"),m=e.querySelector("#banner-primer-download-1ac"),b=e.querySelector("#banner-primer-download-2pp");let d=[];function l(c,A="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),A==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function v(){o.textContent="",o.classList.add("hidden")}function u(c){return c.replace(",",".")}function p(c){const A=c.split(/\r?\n/).map(w=>w.trim()).filter(Boolean),C=[],E=[],j=new Set;return A.forEach((w,$)=>{const P=$+1,q=w.split(/\t|;|,(?=\s)|\s{2,}/).map(xe=>xe.trim()).filter(Boolean);if(q.length!==3){E.push(`Línea ${P}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const M=q[0],O=Number(u(q[1])),R=Number(u(q[2]));if(!/^\d+$/.test(M)){E.push(`Línea ${P}: la matrícula "${M}" no es válida.`);return}if(j.has(M)){E.push(`Línea ${P}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(O)){E.push(`Línea ${P}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(R)){E.push(`Línea ${P}: la calificación 2PP no es numérica.`);return}if(O<0||O>15){E.push(`Línea ${P}: 1AC debe estar entre 0 y 15.`);return}if(R<0||R>20){E.push(`Línea ${P}: 2PP debe estar entre 0 y 20.`);return}j.add(M),C.push({matricula:M,grade1AC:O,grade2PP:R,total:O+R})}),{records:C,errors:E}}function r(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function g(c){if(c.length===0){s.innerHTML=`
                <tr>
                    <td
                        colspan="5"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,n.textContent="0 estudiantes";return}s.innerHTML=c.map((A,C)=>`
                ...
                `).join(""),n.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function x(c,A,C){return[["MATRICULA",C],...c.map(w=>[w.matricula,r(w[A])])].map(w=>w.join(";")).join(`\r
`)}function f(c,A){const E=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),j=URL.createObjectURL(E),w=document.createElement("a");w.href=j,w.download=A,document.body.appendChild(w),w.click(),w.remove(),URL.revokeObjectURL(j)}function h(){d=[],a.value="",g([]),m.disabled=!0,b.disabled=!0,v(),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){d=[],g([]),m.disabled=!0,b.disabled=!0,l("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:A,errors:C}=p(c);if(C.length>0){d=[],g([]),m.disabled=!0,b.disabled=!0,l(C.join(" "),"error");return}d=A,g(d),m.disabled=!1,b.disabled=!1,l(`Los datos de ${A.length} estudiante${A.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",h),m.addEventListener("click",()=>{if(d.length===0)return;const c=x(d,"grade1AC","1AC");f(c,"Banner_APEC_Primer_Periodo_1AC.csv")}),b.addEventListener("click",()=>{if(d.length===0)return;const c=x(d,"grade2PP","2PP");f(c,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function at(){const e=document.createElement("section");return e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div>
            <p class="mb-2 text-sm font-black uppercase tracking-wide text-[#5580C1]">
                Segundo período
            </p>
            ...
            <p class="mt-3 max-w-3xl leading-relaxed text-slate-500">
                ...
                3SP correspondiente al segundo período.
            </p>
        </div>
    `,e}function tt(){const e=document.createElement("section");return e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div>
            <p class="mb-2 text-sm font-black uppercase tracking-wide text-[#5580C1]">
                Calificación final
            </p>
    ...
    `,e}function it(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),s=e.querySelector("#open-segundo-periodo"),n=e.querySelector("#open-calificacion-final"),m=e.querySelector("#banner-back");function b(l){i.innerHTML="";try{const v=l();if(!(v instanceof HTMLElement))throw new Error("El componente seleccionado no devolvió un elemento HTML válido.");i.appendChild(v),a.classList.add("hidden"),t.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"start"})}catch(v){console.error("No fue posible abrir la herramienta de Banner:",v),i.innerHTML=`
            ...
            `,a.classList.add("hidden"),t.classList.remove("hidden")}}function d(){i.innerHTML="",t.classList.add("hidden"),a.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"start"})}return o.addEventListener("click",()=>{b(et)}),s.addEventListener("click",()=>{b(at)}),n.addEventListener("click",()=>{b(tt)}),m.addEventListener("click",d),e}function ot(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
        <div class="mb-8 text-center">
...
20252000     0"
    ...
    `;const a=e.querySelector("#xmera-input"),t=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),s=e.querySelector("#xmera-clear"),n=e.querySelector("#xmera-message"),m=e.querySelector("#tab-xmera"),b=e.querySelector("#tab-banner"),d=e.querySelector("#panel-xmera"),l=e.querySelector("#panel-banner");function v(){t.textContent=`var data_todo = {
};`,o.disabled=!0}function u(x,f="success"){n.textContent=x,n.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),n.classList.add("border"),f==="error"?n.classList.add("border-red-200","bg-red-50","text-red-800"):n.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function p(x){const f=x.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),h=[],c=[],A=new Set;return f.forEach((C,E)=>{const j=C.split(/[\t,; ]+/).map(M=>M.trim()).filter(Boolean),w=E+1,$=j[0],P=j.slice(1);if(!$){c.push(`Línea ${w}: falta la matrícula.`);return}if(!/^\d+$/.test($)){c.push(`Línea ${w}: la matrícula "${$}" no es válida.`);return}if(A.has($)){c.push(`Línea ${w}: la matrícula ${$} está repetida.`);return}if(P.length===0){c.push(`Línea ${w}: falta al menos una calificación.`);return}const q=P.map(M=>Number(M));if(q.some(M=>!Number.isFinite(M))){c.push(`Línea ${w}: existe una calificación no numérica.`);return}A.add($),h.push({matricula:$,grades:q})}),{records:h,errors:c}}function r(x){return`var data_todo = {
${x.map(({matricula:h,grades:c})=>`  "${h}":[${c.join(",")}]`).join(`,
`)}
};
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function g(x){const f=x==="xmera";d.classList.toggle("hidden",!f),l.classList.toggle("hidden",f),m.className=f?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",b.className=f?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const x=a.value.trim();if(!x){v(),u("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:f,errors:h}=p(x);if(h.length>0){v(),u(h.join(" "),"error");return}t.textContent=r(f),o.disabled=!1,u(`Código generado correctamente para ${f.length} estudiante${f.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),u("El código fue copiado al portapapeles.")}catch(x){console.error("No fue posible copiar el código:",x),u("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),s.addEventListener("click",()=>{a.value="",v(),n.textContent="",n.classList.add("hidden"),a.focus()});try{const x=it();if(x instanceof HTMLElement)l.appendChild(x);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(x){console.error("No fue posible cargar el módulo Banner:",x),l.innerHTML=`
            <div class="rounded-2xl border border-red-200 bg-red-50 p-5 text-red-800">
                <p class="font-black">
        ...
        `}return m.addEventListener("click",()=>{g("xmera")}),b.addEventListener("click",()=>{g("banner")}),g("xmera"),e}function st(){return ot()}const nt={home:{page:Pe,layout:"default"},quienesSomos:{page:Ye,layout:"full"},equipment:{page:ta,layout:"default"},FormacionAcademica:{page:ra,layout:"default"},noticias:{page:Aa,layout:"full"},publicaciones:{page:Da,layout:"default"},proyectos:{page:Ga,layout:"default"},lineas:{page:Ba,layout:"default"},contacto:{page:_a,layout:"default"},herramientas:{page:st,layout:"default"}};function X(e){window.location.hash=`/${e}`}function rt(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";lt(a)};window.addEventListener("hashchange",e),e()}function lt(e){const a=document.querySelector("main"),t=nt[e];a&&(a.innerHTML="",t&&(ia(t.layout),a.appendChild(t.page())))}function ct(e,a){te(e,X),rt();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(Z(e),i=!0)}t.addEventListener("change",o),o(t),Z(e);const s=a.querySelector('[data-action ="open-menu"]');ve(s,e),he(e)}const me=document.querySelector("#header");me.innerHTML=be();const ue=document.querySelector("#navBar");ue.innerHTML=ge();const dt=document.querySelector("#footer");dt.innerHTML=fe();ct(ue,me);
