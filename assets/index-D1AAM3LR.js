(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const ge=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Qe(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function Re(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function ia(e){Re(e,ce)}const Ne=""+new URL("apec-ConmXkrT.png",import.meta.url).href,oa=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,ra=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,Ae=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        </div>`}];function sa(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=Ae.length,n=1500;let r=0,d=null;function x(p){return(p%o+o)%o}function v(){i.innerHTML=Ae[r].content}function l(p){r=x(r+p),v()}function w(){u(),d=setInterval(()=>l(1),n)}function u(){d&&(clearInterval(d),d=null)}function m(){w()}v(),w(),a.addEventListener("click",()=>{l(1),m()}),t.addEventListener("click",()=>{l(-1),m()})}function na(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return sa(t.querySelector("#containerFather")),ia(t.querySelector("#btnsGroup")),t}const la="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function ca(){try{const e=await fetch(la,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function Z(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function da(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function pa(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const r=await ca();a.textContent=Z(r.total),t.textContent=Z(r.hoy),i.textContent=Z(r.ultimos7Dias),o.textContent=Z(r.ultimos30Dias);const d=da(r.actualizadoEn);n.textContent=d?`Actualizado: ${d}`:"Estadísticas temporalmente no disponibles"}catch(r){console.error("Error al mostrar las estadísticas en la portada:",r),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function ua(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=ta();const a=na();return e.appendChild(a),pa(e),e}function ma(){return ua()}const xa=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function ba(){return`
        <section 
            role="banner" 
  ...
  `}function ja(){const e=document.createElement("section");return e.className=`
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Xa({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:n,category:r="Noticia",imageFit:d="contain"}){const x=d==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
...
Gracias.`);return`
    ...
    `}function ct(e){if(!e)return`
        ...
        `;const a=Ve(e),t=nt(e),i=t.length,o=t.map(l=>Number(l.year)).filter(Boolean),n=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",d=[...new Set(t.map(l=>l.q).filter(Boolean))],x=[...new Set(t.map(l=>Ce(l)).filter(Boolean))],v=t.map(l=>{const w=Ce(l),u=Ge(l),m=st(l);return`
    ...
    `}function dt(){let e=T[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(p){return String(p?.DOI||p?.doi||"").trim().toLowerCase()}function n(p){return String(p?.journal||p?.title||p?.tile||"").trim()}function r(p){return String(p?.articleTitle||p?.contenido||"").trim()}function d(p){return String(p?.q||p?.quartile||"").trim().toUpperCase()}function x(p){const y=o(p);return y||[p?.year||"",n(p),r(p)].join("-").trim().toLowerCase()}function v(){const p=new Map;return T.forEach(y=>{(y.publicaciones||[]).forEach(g=>{const k=x(g);k&&!p.has(k)&&p.set(k,g)})}),Array.from(p.values())}function l(){const p=v(),y=p.map(j=>Number(j.year)).filter(Boolean),g=y.length?Math.max(...y):"—",k=y.length?Math.min(...y):"—",A=p.filter(j=>d(j)==="Q1").length;return{totalPublicaciones:p.length,investigadores:T.length,q1:A,primerYear:k,ultimoYear:g}}function w(){return T.find(p=>Number(p.id)===Number(e))||T[0]}const u=()=>{const p=w(),y=l(),g=window.innerWidth<768&&!a;i.innerHTML=`
    ...
    `}function Et(){let e=X[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=wt(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
...
`)}function c(s,h){const E=new Blob(["\uFEFF"+s],{type:"text/csv;charset=utf-8;"}),I=URL.createObjectURL(E),C=document.createElement("a");C.href=I,C.download=h,document.body.appendChild(C),C.click(),C.remove(),window.setTimeout(()=>{URL.revokeObjectURL(I)},1e3)}function b(){v=[],a.value="",A([]),d.disabled=!0,x.disabled=!0,w(),a.focus()}return t.addEventListener("click",()=>{const s=a.value.trim();if(!s){v=[],A([]),d.disabled=!0,x.disabled=!0,l("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:h,errors:f}=y(s);if(f.length>0){v=[],A([]),d.disabled=!0,x.disabled=!0,l(f.join(" "),"error");return}v=h,A(v),d.disabled=!1,x.disabled=!1,l(`Los datos de ${h.length} estudiante${h.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",b),d.addEventListener("click",()=>{if(v.length===0)return;const s=j(v,"grade1AC","1AC");c(s,"Banner_APEC_Primer_Periodo_1AC.csv")}),x.addEventListener("click",()=>{if(v.length===0)return;const s=j(v,"grade2PP","2PP");c(s,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function qt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    25"
    ...
    `;const a=e.querySelector("#banner-segundo-input"),t=e.querySelector("#banner-segundo-process"),i=e.querySelector("#banner-segundo-clear"),o=e.querySelector("#banner-segundo-message"),n=e.querySelector("#banner-segundo-preview"),r=e.querySelector("#banner-segundo-count"),d=e.querySelector("#banner-segundo-download");let x=[];function v(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function l(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function w(c){const b=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return b.includes("	")?b.split("	").map(s=>s.trim()).filter(s=>s!==""):b.includes(";")?b.split(";").map(s=>s.trim()).filter(s=>s!==""):b.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function u(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function m(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function p(c,b="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),b==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(c){const b=c.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),s=[],h=[],f=new Set;return b.forEach((E,I)=>{const C=I+1,L=w(E);if(L.length!==2){h.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const M=v(L[0]),D=Number(l(L[1]));if(!/^A[0-9]{8}$/.test(M)){h.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(f.has(M)){h.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(D)){h.push(`Línea ${C}: la calificación 3SP no es numérica.`);return}if(D<0||D>35){h.push(`Línea ${C}: 3SP debe estar entre 0 y 35.`);return}f.add(M),s.push({matricula:M,grade3SP:D})}),{records:s,errors:h}}function g(c){if(c.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
...
`)}function A(c,b){const s=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(s),f=document.createElement("a");f.href=h,f.download=b,document.body.appendChild(f),f.click(),f.remove(),window.setTimeout(()=>{URL.revokeObjectURL(h)},1e3)}function j(){x=[],a.value="",g([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){x=[],g([]),d.disabled=!0,p("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:b,errors:s}=y(c);if(s.length>0){x=[],g([]),d.disabled=!0,p(s.join(" "),"error");return}x=b,g(b),d.disabled=!1,p(`Los datos de ${b.length} estudiante${b.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",j),d.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function Tt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
`)}function A(c,b){const s=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(s),f=document.createElement("a");f.href=h,f.download=b,document.body.appendChild(f),f.click(),f.remove(),window.setTimeout(()=>{URL.revokeObjectURL(h)},1e3)}function j(){x=[],a.value="",g([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){x=[],g([]),d.disabled=!0,p("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:b,errors:s}=y(c);if(s.length>0){x=[],g([]),d.disabled=!0,p(s.join(" "),"error");return}x=b,g(b),d.disabled=!1,p(`Los datos de ${b.length} estudiante${b.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",j),d.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Examen_Final_4EF.csv")}),e}function Bt(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),n=e.querySelector("#open-segundo-periodo"),r=e.querySelector("#open-calificacion-final"),d=e.querySelector("#banner-back");function x(){a.classList.add("hidden"),t.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}function v(u){console.error("No fue posible abrir la herramienta de Banner:",u),i.innerHTML=`
            <div
        ...
        `,x()}function l(u){i.innerHTML="";try{if(typeof u!="function")throw new TypeError("El componente seleccionado no es una función válida.");const m=u();if(!(m instanceof HTMLElement))throw new TypeError("El componente seleccionado no devolvió un elemento HTML válido.");i.appendChild(m),x()}catch(m){v(m)}}function w(){i.replaceChildren(),t.classList.add("hidden"),a.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}return o.addEventListener("click",()=>{l(Ft)}),n.addEventListener("click",()=>{l(qt)}),r.addEventListener("click",()=>{l(Tt)}),d.addEventListener("click",w),e}function Ot(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
        <div class="mb-8 text-center">
...
20252000     0"
    ...
    `;const a=e.querySelector("#xmera-input"),t=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),n=e.querySelector("#xmera-clear"),r=e.querySelector("#xmera-message"),d=e.querySelector("#tab-xmera"),x=e.querySelector("#tab-banner"),v=e.querySelector("#panel-xmera"),l=e.querySelector("#panel-banner");function w(){t.textContent=`var data_todo = {
};`,o.disabled=!0}function u(g,k="success"){r.textContent=g,r.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),r.classList.add("border"),k==="error"?r.classList.add("border-red-200","bg-red-50","text-red-800"):r.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function m(g){const k=g.split(/\r?\n/).map(b=>b.trim()).filter(Boolean),A=[],j=[],c=new Set;return k.forEach((b,s)=>{const h=b.split(/[\t,; ]+/).map(L=>L.trim()).filter(Boolean),f=s+1,E=h[0],I=h.slice(1);if(!E){j.push(`Línea ${f}: falta la matrícula.`);return}if(!/^\d+$/.test(E)){j.push(`Línea ${f}: la matrícula "${E}" no es válida.`);return}if(c.has(E)){j.push(`Línea ${f}: la matrícula ${E} está repetida.`);return}if(I.length===0){j.push(`Línea ${f}: falta al menos una calificación.`);return}const C=I.map(L=>Number(L));if(C.some(L=>!Number.isFinite(L))){j.push(`Línea ${f}: existe una calificación no numérica.`);return}c.add(E),A.push({matricula:E,grades:C})}),{records:A,errors:j}}function p(g){return`var data_todo = {
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function y(g){const k=g==="xmera";v.classList.toggle("hidden",!k),l.classList.toggle("hidden",k),d.className=k?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",x.className=k?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const g=a.value.trim();if(!g){w(),u("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:k,errors:A}=m(g);if(A.length>0){w(),u(A.join(" "),"error");return}t.textContent=p(k),o.disabled=!1,u(`Código generado correctamente para ${k.length} estudiante${k.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),u("El código fue copiado al portapapeles.")}catch(g){console.error("No fue posible copiar el código:",g),u("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),n.addEventListener("click",()=>{a.value="",w(),r.textContent="",r.classList.add("hidden"),a.focus()});try{const g=Bt();if(g instanceof HTMLElement)l.appendChild(g);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(g){console.error("No fue posible cargar el módulo Banner:",g),l.innerHTML=`
        ...
        `}return d.addEventListener("click",()=>{y("xmera")}),x.addEventListener("click",()=>{y("banner")}),y("xmera"),e}function Ut(){return Ot()}function Vt(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
    ...
    `;const t=e.querySelector("#asistente-pruebas"),i=l=>{t.innerHTML=l,window.scrollTo({top:0,behavior:"auto"})},o=()=>{Object.assign(a,{pantalla:"inicio",objetivo:"",tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:"",tipoResultado:"",numeroPredictores:"",sobredispersion:""})},n=()=>{a.pantalla="resultado-comparacion",i(Zt(a))},r=()=>{a.pantalla="resultado-relacion",i(ei(a))},d=()=>{a.pantalla="resultado-asociacion",i(ai(a))},x=l=>{if(a.pantalla==="objetivo"){if(Object.assign(a,{objetivo:l,tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:"",tipoResultado:"",numeroPredictores:"",sobredispersion:""}),l==="comparar"){a.pantalla="tipo-variable",i(Me());return}if(l==="relacionar"){a.pantalla="tipo-relacion",i(te());return}if(l==="asociar"){a.pantalla="tipo-asociacion",i(je());return}if(l==="predecir"){a.pantalla="tipo-resultado",i(Le());return}i(ri(l)),a.pantalla="desarrollo";return}if(a.pantalla==="tipo-variable"){Object.assign(a,{tipoVariable:l,numeroGrupos:"",relacion:"",normalidad:"",varianzas:""}),a.pantalla="numero-grupos",i(ee());return}if(a.pantalla==="numero-grupos"){if(Object.assign(a,{numeroGrupos:l,relacion:"",normalidad:"",varianzas:""}),l==="uno"){if(a.relacion="una-muestra",a.tipoVariable==="categorica"){n();return}a.pantalla="normalidad",i(ae());return}a.pantalla="relacion-muestras",i(ue(a));return}if(a.pantalla==="relacion-muestras"){if(Object.assign(a,{relacion:l,normalidad:"",varianzas:""}),a.tipoVariable==="categorica"){n();return}a.pantalla="normalidad",i(ae());return}if(a.pantalla==="normalidad"){if(a.normalidad=l,a.varianzas="",a.tipoVariable==="cuantitativa"&&l==="si"&&a.relacion==="independientes"&&a.numeroGrupos!=="uno"){a.pantalla="varianzas",i(Pe());return}n();return}if(a.pantalla==="varianzas"){a.varianzas=l,n();return}if(a.pantalla==="tipo-relacion"){if(Object.assign(a,{tipoRelacion:l,normalidad:"",linealidad:"",empates:""}),l==="dicotomica-cuantitativa"){r();return}if(l==="ordinales"){a.pantalla="empates",i(ze());return}a.pantalla="normalidad-relacion",i(me());return}if(a.pantalla==="normalidad-relacion"){if(a.normalidad=l,a.linealidad="",l!=="si"){r();return}a.pantalla="linealidad",i(De());return}if(a.pantalla==="linealidad"){a.linealidad=l,r();return}if(a.pantalla==="empates"){a.empates=l,r();return}if(a.pantalla==="tipo-asociacion"){Object.assign(a,{tipoAsociacion:l,frecuenciasEsperadas:""}),a.pantalla="frecuencias-esperadas",i($e());return}if(a.pantalla==="frecuencias-esperadas"&&(a.frecuenciasEsperadas=l,d()),a.pantalla==="tipo-resultado"){Object.assign(a,{tipoResultado:l,numeroPredictores:"",sobredispersion:""}),a.pantalla="numero-predictores",i(Yt());return}},v=()=>{const w={"tipo-variable":()=>["objetivo",J()],"numero-grupos":()=>["tipo-variable",Me()],"relacion-muestras":()=>["numero-grupos",ee()],normalidad:()=>a.numeroGrupos==="uno"?["numero-grupos",ee()]:["relacion-muestras",ue(a)],varianzas:()=>["normalidad",ae()],"tipo-relacion":()=>["objetivo",J()],"normalidad-relacion":()=>["tipo-relacion",te()],linealidad:()=>["normalidad-relacion",me()],empates:()=>["tipo-relacion",te()],"tipo-asociacion":()=>["objetivo",J()],"tipo-resultado":()=>["objetivo",J()],"numero-predictores":()=>["tipo-resultado",Le()],"frecuencias-esperadas":()=>["tipo-asociacion",je()],"resultado-asociacion":()=>["frecuencias-esperadas",$e()],"resultado-comparacion":()=>a.varianzas?["varianzas",Pe()]:a.tipoVariable==="categorica"?a.numeroGrupos==="uno"?["numero-grupos",ee()]:["relacion-muestras",ue(a)]:["normalidad",ae()],"resultado-relacion":()=>a.tipoRelacion==="ordinales"?["empates",ze()]:a.tipoRelacion==="dicotomica-cuantitativa"?["tipo-relacion",te()]:a.linealidad?["linealidad",De()]:["normalidad-relacion",me()]}[a.pantalla];if(!w){a.pantalla="objetivo",i(J());return}const[u,m]=w();a.pantalla=u,i(m)};return t.addEventListener("click",l=>{const w=l.target.closest("[data-action], [data-value]");if(!w)return;const u=w.dataset.action,m=w.dataset.value;if(m){x(m);return}if(u==="ver-ficha"){const p=w.dataset.fichaId,y=He(p);if(!y)return;a.pantallaAnterior=a.pantalla,a.fichaActual=p,a.pantalla="ficha-metodologica",i(ti(y,p));return}if(u==="volver-resultado"){if(a.objetivo==="comparar"){n();return}if(a.objetivo==="relacionar"){r();return}a.objetivo==="asociar"&&d();return}u==="iniciar"&&(a.pantalla="objetivo",i(J())),u==="volver"&&v(),(u==="volver-inicio"||u==="reiniciar")&&(o(),i(Se())),u==="volver-laboratorio"&&(window.location.hash="/laboratorioKernel")}),e}function Se(){return`
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-5 mt-8">
            ${be("Comparación de grupos","Pruebas t, Welch, ANOVA, Mann–Whitney, Wilcoxon, Kruskal–Wallis y Friedman.")}

            ${be("Relación entre variables","Pearson, Spearman, Kendall y correlación punto-biserial.")}

            ${be("Asociación entre variables categóricas","Chi-cuadrado, Fisher exacta, Fisher–Freeman–Halton, Phi y V de Cramer.")}
        </section>
        ...
        `:""}
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    ${xe("Tamaño del efecto",e.efecto)}

                    ${xe("Reporte recomendado","Informe el estadístico, el valor p, el intervalo de confianza y el tamaño del efecto. Incluya gráficos y una interpretación sustantiva.")}
                </div>
