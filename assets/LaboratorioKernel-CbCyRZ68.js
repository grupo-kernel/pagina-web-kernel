import{c as x}from"./authService-CgfoSPdf.js";import{M as o,i as t}from"./index-cpxShg-p.js";import"./firebase-BzP43VG7.js";function r(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function i({titulo:e,descripcion:s,iconoNombre:a,fondo:l,color:d,borde:c}){return`
