...
export function bannerComponent() {
    ...
    container.className = "w-full max-w-7xl mx-auto px-4 py-8 md:py-10";
    ...
    const primerButton = container.querySelector(
        "#open-primer-periodo"
    );
    const segundoButton = container.querySelector(
        "#open-segundo-periodo"
    );
    const finalButton = container.querySelector(
        "#open-calificacion-final"
    );
    ...
    function openTool(componentFactory) {
        ...
        try {
            if (typeof componentFactory !== "function") {
                throw new TypeError(
                    "El componente seleccionado no es una función válida."
                );
            }
