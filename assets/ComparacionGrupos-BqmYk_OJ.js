function d(){const a=document.createElement("section");return a.className=`
    ...
    `,a.addEventListener("click",i=>{const t=i.target.closest("[data-route], [data-action]");if(!t)return;if(t.dataset.action==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}const o=t.dataset.route;o&&(window.location.hash=`/${o}`)}),a}function s({etiqueta:a,titulo:i,descripcion:t,pruebas:o,ruta:n,textoBoton:r,clases:e}){return`
