...
40, 50, 3`};a.querySelector("textarea").value=r[e]}function Fg(e){const a=e.resumen;return`
    ...
    `,e}function qi(){if(!g0()||document.querySelector("[data-creditos-calculadoras='true']"))return;const e=document.querySelector("main, #app, [data-router-view]");e&&e.appendChild(h0())}function v0(){new MutationObserver(qi).observe(document.body,{childList:!0,subtree:!0}),qi()}const ks=document.querySelector("#header");ks.innerHTML=Cs();const Es=document.querySelector("#navBar");Es.innerHTML=As();const x0=document.querySelector("#footer");x0.innerHTML=$s();Zg(Es,ks);s0();f0();v0();
