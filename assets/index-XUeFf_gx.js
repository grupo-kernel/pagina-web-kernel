(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const ge=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Qe(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function Ye(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${ge}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function Re(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function ia(e){Re(e,ce)}const Ne=""+new URL("apec-ConmXkrT.png",import.meta.url).href,oa=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,ra=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,Ae=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${Ne}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${oa}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        <img src="${ra}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function sa(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=Ae.length,n=1500;let r=0,d=null;function b(p){return(p%o+o)%o}function v(){i.innerHTML=Ae[r].content}function l(p){r=b(r+p),v()}function y(){u(),d=setInterval(()=>l(1),n)}function u(){d&&(clearInterval(d),d=null)}function m(){y()}v(),y(),a.addEventListener("click",()=>{l(1),m()}),t.addEventListener("click",()=>{l(-1),m()})}function na(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return sa(t.querySelector("#containerFather")),ia(t.querySelector("#btnsGroup")),t}const la="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function ca(){try{const e=await fetch(la,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function Z(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function da(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function pa(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const r=await ca();a.textContent=Z(r.total),t.textContent=Z(r.hoy),i.textContent=Z(r.ultimos7Dias),o.textContent=Z(r.ultimos30Dias);const d=da(r.actualizadoEn);n.textContent=d?`Actualizado: ${d}`:"Estadísticas temporalmente no disponibles"}catch(r){console.error("Error al mostrar las estadísticas en la portada:",r),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function ua(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=ta();const a=na();return e.appendChild(a),pa(e),e}function ma(){return ua()}const ba=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function xa(){return`
        <section 
            role="banner" 
    ...
    `}const wa="data:image/png;base64,",ka="data:image/png;base64,",Aa="data:image/png;base64,",Ca="data:image/png;base64,",Ea="data:image/png;base64,",Sa=[{icon:wa,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:ka,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:Aa,title:"Objetivos",content:`
      ...
      </ul>`},{icon:Ca,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Pa({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${Ea}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function ja(){const e=document.createElement("section");return e.className=`
    ...
    `).join("")}function Ia(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function Ra(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=za(e.redes||[]),i=Ia(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}const Fe=""+new URL("rad-B3ff1btG.png",import.meta.url).href,qe=""+new URL("mar-Cru0HERG.png",import.meta.url).href,K=[{img:se,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:le,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:Fe,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:fe,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:qe,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:ne,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:_,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function Na(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const m=o();return Math.max(K.length-m,0)},r=()=>{const m=n();e>m&&(e=0),e<0&&(e=m)},d=()=>{const m=n();e>=m?e=0:e++,u()},b=()=>{const m=n();e<=0?e=m:e--,u()},v=()=>{l(),K.length>o()&&(a=setInterval(d,4500))},l=()=>{a&&(clearInterval(a),a=null)},y=()=>{const m=o(),p=Math.max(K.length-m+1,1);return Array.from({length:p}).map((w,g)=>`
        ...
        `).join("")},u=()=>{if(!K||K.length===0){i.innerHTML=`
            ...
            `;return}r();const m=o(),p=K.slice(e,e+m);i.innerHTML=`
        ...
        `;const w=i.querySelector("#cards-wrapper");p.forEach(A=>{w.appendChild(Ra(A))});const g=i.querySelector("#prev-btn"),k=i.querySelector("#next-btn");g&&(g.onclick=()=>{b(),v()}),k&&(k.onclick=()=>{d(),v()}),i.querySelectorAll("[data-dot-index]").forEach(A=>{A.onclick=()=>{e=parseInt(A.dataset.dotIndex),u(),v()}})};return i.addEventListener("mouseenter",l),i.addEventListener("mouseleave",v),document.addEventListener("visibilitychange",()=>{document.hidden?l():v()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,u(),v()},150)}),u(),v(),i}function Fa(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&ce(t.dataset.route)})}function Te(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Fa(a),a}function qa(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(Te());const t=Na();return e.appendChild(a),e.appendChild(t),e}function Ta(){return qa()}function Ba(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function N(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Be(e){return e.formacion?.length||0}function Oe(e){return e.experiencia?.length||0}function Oa(e,a=!1){const t=Be(e),i=Oe(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function Ua(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(d=>`
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Xa({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:n,category:r="Noticia",imageFit:d="contain"}){const b=d==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
    ...
    `}function Za(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function et(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function at(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const a=et(Ue),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ${Ya(t)}
        ${_a(a)}
        ${Za()}
    `,e}function tt({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(r=>`<p>${r}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function it(e){e&&e.addEventListener("click",a=>{const t=a.target.closest("[data-news-btn], [data-news-card]");if(!t||!e.contains(t))return;const i=t.dataset.newsBtn||t.dataset.newsCard,o=Ue.find(n=>String(n.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}ot(o)})}function ot(e){const a=document.querySelector("#newsModal");a&&a.remove();const t=document.createElement("div");t.innerHTML=tt(e);const i=t.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",n)}function n(r){r.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(r=>{r.addEventListener("click",o)}),i.addEventListener("click",r=>{r.target===i&&o()}),document.addEventListener("keydown",n)}function rt(){const e=at();return it(e),e}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ve(e){return e?.name||e?.title||"Investigador"}function Ce(e){return e?.title||e?.tile||"Revista no especificada"}function Ge(e){return String(e?.DOI||e?.doi||"").trim()}function st(e){const a=Ge(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function nt(e){return[...e?.publicaciones||[]].sort((a,t)=>{const i=Number(a.year||0),o=Number(t.year||0);return i!==o?o-i:String(a.contenido||"").localeCompare(String(t.contenido||""))})}function lt(e,a=!1){const t=Ve(e),i=e.publicaciones||[],o=i.length,n=i.map(d=>Number(d.year)).filter(Boolean),r=n.length?Math.max(...n):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${a?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function ct(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const a=Ve(e),t=nt(e),i=t.length,o=t.map(l=>Number(l.year)).filter(Boolean),n=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",d=[...new Set(t.map(l=>l.q).filter(Boolean))],b=[...new Set(t.map(l=>Ce(l)).filter(Boolean))],v=t.map(l=>{const y=Ce(l),u=Ge(l),m=st(l);return`
    ...
    `}function dt(){let e=T[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(p){return String(p?.DOI||p?.doi||"").trim().toLowerCase()}function n(p){return String(p?.journal||p?.title||p?.tile||"").trim()}function r(p){return String(p?.articleTitle||p?.contenido||"").trim()}function d(p){return String(p?.q||p?.quartile||"").trim().toUpperCase()}function b(p){const w=o(p);return w||[p?.year||"",n(p),r(p)].join("-").trim().toLowerCase()}function v(){const p=new Map;return T.forEach(w=>{(w.publicaciones||[]).forEach(g=>{const k=b(g);k&&!p.has(k)&&p.set(k,g)})}),Array.from(p.values())}function l(){const p=v(),w=p.map(j=>Number(j.year)).filter(Boolean),g=w.length?Math.max(...w):"—",k=w.length?Math.min(...w):"—",A=p.filter(j=>d(j)==="Q1").length;return{totalPublicaciones:p.length,investigadores:T.length,q1:A,primerYear:k,ultimoYear:g}}function y(){return T.find(p=>Number(p.id)===Number(e))||T[0]}const u=()=>{const p=y(),w=l(),g=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${T.map(A=>lt(A,Number(A.id)===Number(e))).join("")}
                </aside>
    ...
    `}function gt(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function ft(){const e=new Set(G.map(i=>i.categoria)),a=G.filter(i=>i.proyectosAsociados?.length>0).length,t=G.filter(i=>i.publicacionesClave?.length>0).length;return{total:G.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function vt(){let e=G[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=ut(e),o=ft();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function Et(){let e=X[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=yt(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function St(){return Et()}function Mt(){return`
    ...
    `}function jt(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Pt()}
    `,e}function Lt(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",$t)}async function $t(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=Dt(i);if(o.length>0){It(o);return}await Rt(a,i)}function Dt(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?zt(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function zt(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function It(e){re(e[0],"error")}function re(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Rt(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(re("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):re("Hubo un problema al enviar el mensaje.","error")}catch{re("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Nt(){const e=jt();return setTimeout(()=>{Lt()},0),e}function Ft(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
A00116736    13    7"
    ...
    `;const a=e.querySelector("#banner-primer-input"),t=e.querySelector("#banner-primer-process"),i=e.querySelector("#banner-primer-clear"),o=e.querySelector("#banner-primer-message"),n=e.querySelector("#banner-primer-preview"),r=e.querySelector("#banner-primer-count"),d=e.querySelector("#banner-primer-download-1ac"),b=e.querySelector("#banner-primer-download-2pp");let v=[];function l(s,h="success"){o.textContent=s,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),h==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(){o.textContent="",o.classList.add("hidden")}function u(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function m(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function p(s){const h=String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return h.includes("	")?h.split("	").map(f=>f.trim()).filter(f=>f!==""):h.includes(";")?h.split(";").map(f=>f.trim()).filter(f=>f!==""):h.split(/\s+/).map(f=>f.trim()).filter(f=>f!=="")}function w(s){const h=s.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),f=[],E=[],I=new Set;return h.forEach((C,L)=>{const M=L+1,D=p(C);if(D.length!==3){E.push(`Línea ${M}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const H=u(D[0]),W=Number(m(D[1])),Y=Number(m(D[2]));if(!/^A[0-9]{8}$/.test(H)){E.push(`Línea ${M}: la matrícula "${H}" no es válida. Debe tener el formato A00108671.`);return}if(I.has(H)){E.push(`Línea ${M}: la matrícula ${H} está repetida.`);return}if(!Number.isFinite(W)){E.push(`Línea ${M}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(Y)){E.push(`Línea ${M}: la calificación 2PP no es numérica.`);return}if(W<0||W>15){E.push(`Línea ${M}: 1AC debe estar entre 0 y 15.`);return}if(Y<0||Y>20){E.push(`Línea ${M}: 2PP debe estar entre 0 y 20.`);return}const we=W+Y;if(we>35){E.push(`Línea ${M}: la suma de 1AC y 2PP no puede superar 35 puntos.`);return}I.add(H),f.push({matricula:H,grade1AC:W,grade2PP:Y,total:we})}),{records:f,errors:E}}function g(s){return Number.isInteger(s)?String(s):s.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function k(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function A(s){if(s.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="5"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=s.map((h,f)=>`
                ...
                `).join(""),r.textContent=`${s.length} estudiante${s.length===1?"":"s"}`}function j(s,h,f){return[["MATRICULA",f],...s.map(C=>[C.matricula,g(C[h])])].map(C=>C.join(";")).join(`\r
`)}function c(s,h){const E=new Blob(["\uFEFF"+s],{type:"text/csv;charset=utf-8;"}),I=URL.createObjectURL(E),C=document.createElement("a");C.href=I,C.download=h,document.body.appendChild(C),C.click(),C.remove(),window.setTimeout(()=>{URL.revokeObjectURL(I)},1e3)}function x(){v=[],a.value="",A([]),d.disabled=!0,b.disabled=!0,y(),a.focus()}return t.addEventListener("click",()=>{const s=a.value.trim();if(!s){v=[],A([]),d.disabled=!0,b.disabled=!0,l("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:h,errors:f}=w(s);if(f.length>0){v=[],A([]),d.disabled=!0,b.disabled=!0,l(f.join(" "),"error");return}v=h,A(v),d.disabled=!1,b.disabled=!1,l(`Los datos de ${h.length} estudiante${h.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",x),d.addEventListener("click",()=>{if(v.length===0)return;const s=j(v,"grade1AC","1AC");c(s,"Banner_APEC_Primer_Periodo_1AC.csv")}),b.addEventListener("click",()=>{if(v.length===0)return;const s=j(v,"grade2PP","2PP");c(s,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function qt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    25"
    ...
    `;const a=e.querySelector("#banner-segundo-input"),t=e.querySelector("#banner-segundo-process"),i=e.querySelector("#banner-segundo-clear"),o=e.querySelector("#banner-segundo-message"),n=e.querySelector("#banner-segundo-preview"),r=e.querySelector("#banner-segundo-count"),d=e.querySelector("#banner-segundo-download");let b=[];function v(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function l(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function y(c){const x=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return x.includes("	")?x.split("	").map(s=>s.trim()).filter(s=>s!==""):x.includes(";")?x.split(";").map(s=>s.trim()).filter(s=>s!==""):x.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function u(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function m(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function p(c,x="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),x==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(c){const x=c.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),s=[],h=[],f=new Set;return x.forEach((E,I)=>{const C=I+1,L=y(E);if(L.length!==2){h.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const M=v(L[0]),D=Number(l(L[1]));if(!/^A[0-9]{8}$/.test(M)){h.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(f.has(M)){h.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(D)){h.push(`Línea ${C}: la calificación 3SP no es numérica.`);return}if(D<0||D>35){h.push(`Línea ${C}: 3SP debe estar entre 0 y 35.`);return}f.add(M),s.push({matricula:M,grade3SP:D})}),{records:s,errors:h}}function g(c){if(c.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=c.map((x,s)=>`
                    <tr class="border-b border-slate-100 last:border-b-0">
                        <td class="px-4 py-3 text-slate-500">
                            ${s+1}
                        </td>
                ...
                `).join(""),r.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function k(c){return[["MATRICULA","3SP"],...c.map(s=>[s.matricula,u(s.grade3SP)])].map(s=>s.join(";")).join(`\r
`)}function A(c,x){const s=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(s),f=document.createElement("a");f.href=h,f.download=x,document.body.appendChild(f),f.click(),f.remove(),window.setTimeout(()=>{URL.revokeObjectURL(h)},1e3)}function j(){b=[],a.value="",g([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){b=[],g([]),d.disabled=!0,p("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:x,errors:s}=w(c);if(s.length>0){b=[],g([]),d.disabled=!0,p(s.join(" "),"error");return}b=x,g(x),d.disabled=!1,p(`Los datos de ${x.length} estudiante${x.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",j),d.addEventListener("click",()=>{b.length!==0&&A(k(b),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function Tt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    20"
    ...
    `;const a=e.querySelector("#banner-final-input"),t=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),n=e.querySelector("#banner-final-preview"),r=e.querySelector("#banner-final-count"),d=e.querySelector("#banner-final-download");let b=[];function v(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function l(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function y(c){const x=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return x.includes("	")?x.split("	").map(s=>s.trim()).filter(s=>s!==""):x.includes(";")?x.split(";").map(s=>s.trim()).filter(s=>s!==""):x.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function u(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function m(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function p(c,x="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),x==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(c){const x=c.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),s=[],h=[],f=new Set;return x.forEach((E,I)=>{const C=I+1,L=y(E);if(L.length!==2){h.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const M=v(L[0]),D=Number(l(L[1]));if(!/^A[0-9]{8}$/.test(M)){h.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(f.has(M)){h.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(D)){h.push(`Línea ${C}: la calificación 4EF no es numérica.`);return}if(D<0||D>30){h.push(`Línea ${C}: 4EF debe estar entre 0 y 30.`);return}f.add(M),s.push({matricula:M,grade4EF:D})}),{records:s,errors:h}}function g(c){if(c.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=c.map((x,s)=>`
                ...
                `).join(""),r.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function k(c){return[["MATRICULA","4EF"],...c.map(s=>[s.matricula,u(s.grade4EF)])].map(s=>s.join(";")).join(`\r
`)}function A(c,x){const s=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(s),f=document.createElement("a");f.href=h,f.download=x,document.body.appendChild(f),f.click(),f.remove(),window.setTimeout(()=>{URL.revokeObjectURL(h)},1e3)}function j(){b=[],a.value="",g([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){b=[],g([]),d.disabled=!0,p("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:x,errors:s}=w(c);if(s.length>0){b=[],g([]),d.disabled=!0,p(s.join(" "),"error");return}b=x,g(x),d.disabled=!1,p(`Los datos de ${x.length} estudiante${x.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",j),d.addEventListener("click",()=>{b.length!==0&&A(k(b),"Banner_APEC_Examen_Final_4EF.csv")}),e}function Bt(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),n=e.querySelector("#open-segundo-periodo"),r=e.querySelector("#open-calificacion-final"),d=e.querySelector("#banner-back");function b(){a.classList.add("hidden"),t.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}function v(u){console.error("No fue posible abrir la herramienta de Banner:",u),i.innerHTML=`
            <div
        ...
        `,b()}function l(u){i.innerHTML="";try{if(typeof u!="function")throw new TypeError("El componente seleccionado no es una función válida.");const m=u();if(!(m instanceof HTMLElement))throw new TypeError("El componente seleccionado no devolvió un elemento HTML válido.");i.appendChild(m),b()}catch(m){v(m)}}function y(){i.replaceChildren(),t.classList.add("hidden"),a.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}return o.addEventListener("click",()=>{l(Ft)}),n.addEventListener("click",()=>{l(qt)}),r.addEventListener("click",()=>{l(Tt)}),d.addEventListener("click",y),e}function Ot(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
        <div class="mb-8 text-center">
...
20252000     0"
    ...
    `;const a=e.querySelector("#xmera-input"),t=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),n=e.querySelector("#xmera-clear"),r=e.querySelector("#xmera-message"),d=e.querySelector("#tab-xmera"),b=e.querySelector("#tab-banner"),v=e.querySelector("#panel-xmera"),l=e.querySelector("#panel-banner");function y(){t.textContent=`var data_todo = {
};`,o.disabled=!0}function u(g,k="success"){r.textContent=g,r.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),r.classList.add("border"),k==="error"?r.classList.add("border-red-200","bg-red-50","text-red-800"):r.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function m(g){const k=g.split(/\r?\n/).map(x=>x.trim()).filter(Boolean),A=[],j=[],c=new Set;return k.forEach((x,s)=>{const h=x.split(/[\t,; ]+/).map(L=>L.trim()).filter(Boolean),f=s+1,E=h[0],I=h.slice(1);if(!E){j.push(`Línea ${f}: falta la matrícula.`);return}if(!/^\d+$/.test(E)){j.push(`Línea ${f}: la matrícula "${E}" no es válida.`);return}if(c.has(E)){j.push(`Línea ${f}: la matrícula ${E} está repetida.`);return}if(I.length===0){j.push(`Línea ${f}: falta al menos una calificación.`);return}const C=I.map(L=>Number(L));if(C.some(L=>!Number.isFinite(L))){j.push(`Línea ${f}: existe una calificación no numérica.`);return}c.add(E),A.push({matricula:E,grades:C})}),{records:A,errors:j}}function p(g){return`var data_todo = {
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function w(g){const k=g==="xmera";v.classList.toggle("hidden",!k),l.classList.toggle("hidden",k),d.className=k?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",b.className=k?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const g=a.value.trim();if(!g){y(),u("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:k,errors:A}=m(g);if(A.length>0){y(),u(A.join(" "),"error");return}t.textContent=p(k),o.disabled=!1,u(`Código generado correctamente para ${k.length} estudiante${k.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),u("El código fue copiado al portapapeles.")}catch(g){console.error("No fue posible copiar el código:",g),u("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),n.addEventListener("click",()=>{a.value="",y(),r.textContent="",r.classList.add("hidden"),a.focus()});try{const g=Bt();if(g instanceof HTMLElement)l.appendChild(g);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(g){console.error("No fue posible cargar el módulo Banner:",g),l.innerHTML=`
        ...
        `}return d.addEventListener("click",()=>{w("xmera")}),b.addEventListener("click",()=>{w("banner")}),w("xmera"),e}function Ut(){return Ot()}function Vt(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
        ...
        <section class="
            ...
            gap-6 mt-10
        ">
            ${pe("Aprender","Comprenda qué mide cada estadístico, cuándo debe utilizarse, cuáles son sus supuestos y cómo se interpreta correctamente.","libro","bg-sky-100","text-sky-700","border-sky-200")}

            ${pe("Decidir","Identifique la prueba adecuada según el objetivo, el tipo de variable, el número de grupos y el diseño de su investigación.","decision","bg-amber-100","text-amber-700","border-amber-200")}

            ${pe("Analizar","Introduzca sus datos, ejecute el análisis, interprete los resultados y genere reportes metodológicamente adecuados.","analisis","bg-emerald-100","text-emerald-700","border-emerald-200")}
        </section>
    ...
    `,e}function pe(e,a,t,i,o,n){return`
        <article class="
            h-full bg-white
            border border-slate-200
            rounded-3xl p-7
    ...
    `;const t=e.querySelector("#asistente-pruebas"),i=l=>{t.innerHTML=l,window.scrollTo({top:0,behavior:"auto"})},o=()=>{Object.assign(a,{pantalla:"inicio",objetivo:"",tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:"",tipoResultado:"",numeroPredictores:"",sobredispersion:""})},n=()=>{a.pantalla="resultado-comparacion",i(Zt(a))},r=()=>{a.pantalla="resultado-relacion",i(ei(a))},d=()=>{a.pantalla="resultado-asociacion",i(ai(a))},b=l=>{if(a.pantalla==="objetivo"){if(Object.assign(a,{objetivo:l,tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:"",tipoResultado:"",numeroPredictores:"",sobredispersion:""}),l==="comparar"){a.pantalla="tipo-variable",i(Me());return}if(l==="relacionar"){a.pantalla="tipo-relacion",i(te());return}if(l==="asociar"){a.pantalla="tipo-asociacion",i(je());return}if(l==="predecir"){a.pantalla="tipo-resultado",i(Le());return}i(ri(l)),a.pantalla="desarrollo";return}if(a.pantalla==="tipo-variable"){Object.assign(a,{tipoVariable:l,numeroGrupos:"",relacion:"",normalidad:"",varianzas:""}),a.pantalla="numero-grupos",i(ee());return}if(a.pantalla==="numero-grupos"){if(Object.assign(a,{numeroGrupos:l,relacion:"",normalidad:"",varianzas:""}),l==="uno"){if(a.relacion="una-muestra",a.tipoVariable==="categorica"){n();return}a.pantalla="normalidad",i(ae());return}a.pantalla="relacion-muestras",i(ue(a));return}if(a.pantalla==="relacion-muestras"){if(Object.assign(a,{relacion:l,normalidad:"",varianzas:""}),a.tipoVariable==="categorica"){n();return}a.pantalla="normalidad",i(ae());return}if(a.pantalla==="normalidad"){if(a.normalidad=l,a.varianzas="",a.tipoVariable==="cuantitativa"&&l==="si"&&a.relacion==="independientes"&&a.numeroGrupos!=="uno"){a.pantalla="varianzas",i(Pe());return}n();return}if(a.pantalla==="varianzas"){a.varianzas=l,n();return}if(a.pantalla==="tipo-relacion"){if(Object.assign(a,{tipoRelacion:l,normalidad:"",linealidad:"",empates:""}),l==="dicotomica-cuantitativa"){r();return}if(l==="ordinales"){a.pantalla="empates",i(ze());return}a.pantalla="normalidad-relacion",i(me());return}if(a.pantalla==="normalidad-relacion"){if(a.normalidad=l,a.linealidad="",l!=="si"){r();return}a.pantalla="linealidad",i(De());return}if(a.pantalla==="linealidad"){a.linealidad=l,r();return}if(a.pantalla==="empates"){a.empates=l,r();return}if(a.pantalla==="tipo-asociacion"){Object.assign(a,{tipoAsociacion:l,frecuenciasEsperadas:""}),a.pantalla="frecuencias-esperadas",i($e());return}if(a.pantalla==="frecuencias-esperadas"&&(a.frecuenciasEsperadas=l,d()),a.pantalla==="tipo-resultado"){Object.assign(a,{tipoResultado:l,numeroPredictores:"",sobredispersion:""}),a.pantalla="numero-predictores",i(Yt());return}},v=()=>{const y={"tipo-variable":()=>["objetivo",J()],"numero-grupos":()=>["tipo-variable",Me()],"relacion-muestras":()=>["numero-grupos",ee()],normalidad:()=>a.numeroGrupos==="uno"?["numero-grupos",ee()]:["relacion-muestras",ue(a)],varianzas:()=>["normalidad",ae()],"tipo-relacion":()=>["objetivo",J()],"normalidad-relacion":()=>["tipo-relacion",te()],linealidad:()=>["normalidad-relacion",me()],empates:()=>["tipo-relacion",te()],"tipo-asociacion":()=>["objetivo",J()],"tipo-resultado":()=>["objetivo",J()],"numero-predictores":()=>["tipo-resultado",Le()],"frecuencias-esperadas":()=>["tipo-asociacion",je()],"resultado-asociacion":()=>["frecuencias-esperadas",$e()],"resultado-comparacion":()=>a.varianzas?["varianzas",Pe()]:a.tipoVariable==="categorica"?a.numeroGrupos==="uno"?["numero-grupos",ee()]:["relacion-muestras",ue(a)]:["normalidad",ae()],"resultado-relacion":()=>a.tipoRelacion==="ordinales"?["empates",ze()]:a.tipoRelacion==="dicotomica-cuantitativa"?["tipo-relacion",te()]:a.linealidad?["linealidad",De()]:["normalidad-relacion",me()]}[a.pantalla];if(!y){a.pantalla="objetivo",i(J());return}const[u,m]=y();a.pantalla=u,i(m)};return t.addEventListener("click",l=>{const y=l.target.closest("[data-action], [data-value]");if(!y)return;const u=y.dataset.action,m=y.dataset.value;if(m){b(m);return}if(u==="ver-ficha"){const p=y.dataset.fichaId,w=He(p);if(!w)return;a.pantallaAnterior=a.pantalla,a.fichaActual=p,a.pantalla="ficha-metodologica",i(ti(w,p));return}if(u==="volver-resultado"){if(a.objetivo==="comparar"){n();return}if(a.objetivo==="relacionar"){r();return}a.objetivo==="asociar"&&d();return}u==="iniciar"&&(a.pantalla="objetivo",i(J())),u==="volver"&&v(),(u==="volver-inicio"||u==="reiniciar")&&(o(),i(Se())),u==="volver-laboratorio"&&(window.location.hash="/laboratorioKernel")}),e}function Se(){return`
        ...
        `:""}
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    ${be("Tamaño del efecto",e.efecto)}

                    ${be("Reporte recomendado","Informe el estadístico, el valor p, el intervalo de confianza y el tamaño del efecto. Incluya gráficos y una interpretación sustantiva.")}
                </div>
    ...
    `}const ni={home:{page:ma,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:Da,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Ta,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Ga,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:rt,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:pt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:St,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:ht,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Nt,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Ut,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Vt,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Wt,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"}};let Ie=document.referrer||"";function ce(e){window.location.hash=`/${e}`}function li(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";di(a)};window.addEventListener("hashchange",e),e()}function ci(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:Ie}),Ie=t}function di(e){const a=document.querySelector("main"),t=ni[e];if(a){if(a.innerHTML="",!t){ce("home");return}Ba(t.layout),document.title=t.title,a.appendChild(t.page()),window.scrollTo({top:0,behavior:"auto"}),ci(e,t.title)}}function pi(e,a){Re(e,ce),li();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(ke(e),i=!0)}t.addEventListener("change",o),o(t),ke(e);const n=a.querySelector('[data-action ="open-menu"]');Xe(n,e),_e(e)}const Ke=document.querySelector("#header");Ke.innerHTML=Qe();const Je=document.querySelector("#navBar");Je.innerHTML=We();const ui=document.querySelector("#footer");ui.innerHTML=Ye();pi(Je,Ke);
