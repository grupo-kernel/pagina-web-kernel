...
14.5`,r(),la(n),a.classList.add("hidden");return}c==="limpiar"&&(e.reset(),d.value="",g.value="",r(),la(n),a.innerHTML="",a.classList.add("hidden"))}),t}function In(t,e){const n=t.trim();if(!n)throw new Error(`${e} no contiene datos.`);const a=n.split(/[\s;]+/).filter(Boolean),i=a.map(d=>Number(d.replace(",","."))),u=i.findIndex(d=>!Number.isFinite(d));if(u!==-1)throw new Error(`${e} contiene un valor no válido: "${a[u]}".`);if(i.length<2)throw new Error(`${e} debe contener al menos dos observaciones.`);return i}function Pn(t){return t.trim()?t.trim().split(/[\s;]+/).filter(Boolean).length:0}function _n(t){return t===1?"1 valor":`${t} valores`}function Ru(t,e){t.textContent=e,t.classList.remove("hidden")}function la(t){t.textContent="",t.classList.add("hidden")}function S(t,e=4){return Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):"—"}function Lu(t){return Number.isFinite(t)?t<.001?"< 0.001":S(t,4):"—"}function Du(t,e=.95){const n=1-e,a=t.valorP<n,i=n.toFixed(2),u=Math.round(e*100),d=a?`Se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %.`:`No se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %.`;return`
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${vt("p",Lu(t.valorP),"Valor bilateral")}
    ...
    `}function Nu(t){if(t.id==="mann-whitney")return`
    ...
    `}const Gt=Na.jStat??Vr?.jStat;if(!Gt)throw new Error("No fue posible cargar el motor estadístico jStat.");function $a(t){return Math.min(1,Math.max(0,t))}function Jr(t){if(!Number.isFinite(t)||t<=0||t>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function $u(t){return typeof t=="string"&&t.trim()===""?Number.NaN:Number(typeof t=="string"?t.trim().replace(",","."):t)}function Rn(t,e){if(!Array.isArray(t))throw new TypeError(`${e} debe ser un arreglo de valores.`);const n=t.map($u),a=n.findIndex(i=>!Number.isFinite(i));if(a!==-1)throw new TypeError(`${e} contiene un valor no numérico en la posición ${a+1}.`);if(n.length<2)throw new RangeError(`${e} debe contener al menos dos observaciones.`);return n}function Qr(t,e){const n=Rn(t,"La medición 1"),a=Rn(e,"La medición 2");if(n.length!==a.length)throw new RangeError("Las dos mediciones deben contener el mismo número de observaciones y conservar el mismo orden de participantes o pares.");return{medicion1:n,medicion2:a}}function xa(t){return t.reduce((e,n)=>e+n,0)/t.length}function Ou(t){const e=[...t].sort((a,i)=>a-i),n=Math.floor(e.length/2);return e.length%2!==0?e[n]:(e[n-1]+e[n])/2}function Su(t,e){return t.length<2?0:t.reduce((a,i)=>a+(i-e)**2,0)/(t.length-1)}function Be(t){const e=xa(t),n=Su(t,e);return{n:t.length,media:e,mediana:Ou(t),varianza:n,desviacionEstandar:Math.sqrt(n),minimo:Math.min(...t),maximo:Math.max(...t)}}function Ln(t,e){const n=xa(t),a=xa(e);let i=0,u=0,d=0;for(let f=0;f<t.length;f+=1){const l=t[f]-n,r=e[f]-a;i+=l*r,u+=l**2,d+=r**2}const g=Math.sqrt(u*d);return g===0?Number.NaN:i/g}function zu(t,e){return $a(2*(1-Gt.studentt.cdf(Math.abs(t),e)))}function Mu(t,e,n,a){Jr(a);const i=1-a,u=Gt.studentt.inv(1-i/2,n),d=u*e;return{nivel:a,valorCritico:u,margen:d,inferior:t-d,superior:t+d}}function Yr(t,e){return t.map((n,a)=>n-e[a])}function Uu(t,e,n={}){const{nivelConfianza:a=.95}=n;Jr(a);const i=Qr(t,e),u=Yr(i.medicion1,i.medicion2),d=Be(i.medicion1),g=Be(i.medicion2),f=Be(u),l=u.length,r=l-1,o=f.desviacionEstandar/Math.sqrt(l);if(o===0){if(f.media===0)return{id:"t-student-relacionadas",nombre:"t de Student para muestras relacionadas",metodo:"Todas las diferencias pareadas son iguales a cero",medicion1:d,medicion2:g,diferencias:{...f,valores:u},nParejas:l,diferenciaMedia:0,errorEstandar:0,estadistico:{simbolo:"t",valor:0},gradosLibertad:r,valorP:1,intervaloConfianza:{nivel:a,valorCritico:Number.NaN,margen:0,inferior:0,superior:0},tamanioEfecto:{dZ:0,gZ:0,correlacionPareada:Ln(i.medicion1,i.medicion2)}};throw new Error("Las diferencias pareadas son constantes y no permiten estimar el error estándar de la prueba t.")}const s=f.media/o,c=zu(s,r),p=f.media/f.desviacionEstandar,m=r>1?1-3/(4*r-1):1;return{id:"t-student-relacionadas",nombre:"t de Student para muestras relacionadas",metodo:"Prueba bilateral aplicada a la media de las diferencias pareadas",medicion1:d,medicion2:g,diferencias:{...f,valores:u},nParejas:l,diferenciaMedia:f.media,errorEstandar:o,estadistico:{simbolo:"t",valor:s},gradosLibertad:r,valorP:c,intervaloConfianza:Mu(f.media,o,r,a),tamanioEfecto:{dZ:p,gZ:m*p,correccionHedges:m,correlacionPareada:Ln(i.medicion1,i.medicion2)}}}function Fu(t){const e=t.map((u,d)=>({indice:d,diferencia:u,absoluto:Math.abs(u),signo:Math.sign(u),rango:0})).sort((u,d)=>u.absoluto-d.absoluto);let n=0,a=0,i=0;for(;n<e.length;){let u=n+1;for(;u<e.length&&e[u].absoluto===e[n].absoluto;)u+=1;const d=u-n,g=(n+1+u)/2;for(let f=n;f<u;f+=1)e[f].rango=g;d>1&&(i+=1,a+=d**3-d),n=u}return{observaciones:e,correccionEmpates:a,cantidadGruposEmpatados:i}}function qu(t,e){const n=t*(t+1)/2,a=new Array(n+1).fill(0);a[0]=1;let i=0;for(let f=1;f<=t;f+=1){for(let l=i;l>=0;l-=1)a[l]>0&&(a[l+f]+=a[l]);i+=f}const u=Math.floor(e+1e-12),d=a.slice(0,u+1).reduce((f,l)=>f+l,0),g=2**t;return $a(2*d/g)}function Bu(t,e){const n=Qr(t,e),a=Yr(n.medicion1,n.medicion2),i=Be(n.medicion1),u=Be(n.medicion2),d=a.filter(A=>A!==0),g=a.length-d.length;if(d.length===0)return{id:"wilcoxon-relacionadas",nombre:"Prueba de rangos con signo de Wilcoxon",metodoValorP:"Todas las diferencias pareadas son iguales a cero",medicion1:i,medicion2:u,diferencias:{n:a.length,media:0,mediana:0,varianza:0,desviacionEstandar:0,minimo:0,maximo:0,valores:a},nParejas:a.length,nEfectivo:0,cantidadCeros:g,sumaRangosPositivos:0,sumaRangosNegativos:0,estadistico:{simbolo:"W",valor:0,wPositivo:0,wNegativo:0},estadisticoZ:0,valorP:1,correccionEmpates:0,cantidadGruposEmpatados:0,tamanioEfecto:{correlacionBiserialRangos:0,r:0}};const{observaciones:f,correccionEmpates:l,cantidadGruposEmpatados:r}=Fu(d),o=f.filter(({signo:A})=>A>0).reduce((A,I)=>A+I.rango,0),s=f.filter(({signo:A})=>A<0).reduce((A,I)=>A+I.rango,0),c=d.length,p=c*(c+1)/2,m=Math.min(o,s),h=c*(c+1)/4,x=c*(c+1)*(2*c+1)/24-l/48;if(x<=0)throw new Error("No fue posible calcular la varianza del estadístico de Wilcoxon.");const w=Math.sqrt(x),b=o-h,v=b===0?0:Math.sign(b)*.5,y=(b-v)/w,E=l===0&&c<=25,k=E?qu(c,m):$a(2*(1-Gt.normal.cdf(Math.abs(y),0,1))),C=(o-s)/p;return{id:"wilcoxon-relacionadas",nombre:"Prueba de rangos con signo de Wilcoxon",metodoValorP:E?"Valor p bilateral exacto; las diferencias iguales a cero se excluyen":"Aproximación normal bilateral con corrección por continuidad y empates; las diferencias iguales a cero se excluyen",medicion1:i,medicion2:u,diferencias:{...Be(a),valores:a},nParejas:a.length,nEfectivo:c,cantidadCeros:g,sumaRangosPositivos:o,sumaRangosNegativos:s,estadistico:{simbolo:"W",valor:m,wPositivo:o,wNegativo:s},estadisticoZ:y,valorP:k,correccionEmpates:l,cantidadGruposEmpatados:r,tamanioEfecto:{correlacionBiserialRangos:C,r:y/Math.sqrt(c)}}}function Vu({medicion1:t,medicion2:e,prueba:n,nivelConfianza:a=.95}){switch(n){case"student-pareada":return Uu(t,e,{nivelConfianza:a});case"wilcoxon":return Bu(t,e);default:throw new Error("La prueba solicitada no está disponible.")}}function Hu(){const t=document.createElement("section");t.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,t.innerHTML=`
...
17`,l(),da(n),a.classList.add("hidden");return}s==="limpiar"&&(e.reset(),i.value="",u.value="",l(),da(n),a.innerHTML="",a.classList.add("hidden"))}),t}function ca(t,e){return`
        ...
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${xt("p",Wu(t.valorP),"Valor bilateral")}
    ...
    `}function Yu(t){if(t.id==="wilcoxon-relacionadas")return`
    ...
    `}const ju={home:{page:vi,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:zi,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Hi,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Qi,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:uo,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:bo,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:Do,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:Ao,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Bo,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Jo,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:jd,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:nu,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},calculadoraDosGrupos:{page:Tu,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:Hu,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"}};let zn=document.referrer||"";function Wt(t){window.location.hash=`/${t}`}function Zu(){const t=()=>{const e=window.location.hash.replace("#/","")||"home";ep(e)};window.addEventListener("hashchange",t),t()}function Xu(t,e){const n=`${window.location.origin}${window.location.pathname}#/${t}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:e,page_location:n,page_referrer:zn}),zn=n}async function ep(t){const e=document.querySelector("main"),n=ju[t];if(!e)return;if(e.innerHTML="",!n){Wt("home");return}Gi(n.layout),document.title=n.title;const a=await n.page();e.appendChild(a),window.scrollTo({top:0,behavior:"auto"}),Xu(t,n.title)}function tp(t,e){Mn(t,Wt),Zu();const n=window.matchMedia("(max-width: 768px)");let a=!1;function i(d){d.matches&&!a&&(Oa(t),a=!0)}n.addEventListener("change",i),i(n),Oa(t);const u=e.querySelector('[data-action ="open-menu"]');ai(u,t),ni(t)}const jr=document.querySelector("#header");jr.innerHTML=Xr();const Zr=document.querySelector("#navBar");Zr.innerHTML=ei();const ap=document.querySelector("#footer");ap.innerHTML=ti();tp(Zr,jr);
