(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const xe=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Ve(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function He(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    ...
    `}function De(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function Ze(e){De(e,ne)}const ze=""+new URL("apec-ConmXkrT.png",import.meta.url).href,ea=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,aa=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,ye=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${ze}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${ea}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        <img src="${aa}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function ta(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=ye.length,n=1500;let r=0,d=null;function x(m){return(m%o+o)%o}function v(){i.innerHTML=ye[r].content}function l(m){r=x(r+m),v()}function w(){p(),d=setInterval(()=>l(1),n)}function p(){d&&(clearInterval(d),d=null)}function u(){w()}v(),w(),a.addEventListener("click",()=>{l(1),u()}),t.addEventListener("click",()=>{l(-1),u()})}function ia(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return ta(t.querySelector("#containerFather")),Ze(t.querySelector("#btnsGroup")),t}const oa="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function ra(){try{const e=await fetch(oa,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function _(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function sa(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function na(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const r=await ra();a.textContent=_(r.total),t.textContent=_(r.hoy),i.textContent=_(r.ultimos7Dias),o.textContent=_(r.ultimos30Dias);const d=sa(r.actualizadoEn);n.textContent=d?`Actualizado: ${d}`:"Estadísticas temporalmente no disponibles"}catch(r){console.error("Error al mostrar las estadísticas en la portada:",r),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function la(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=_e();const a=ia();return e.appendChild(a),na(e),e}function ca(){return la()}const da=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function pa(){return`
        <section 
            role="banner" 
    ...
    `}const fa="data:image/png;base64,",va="data:image/png;base64,",ha="data:image/png;base64,",wa="data:image/png;base64,",ya="data:image/png;base64,",ka=[{icon:fa,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:va,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:ha,title:"Objetivos",content:`
      ...
      </ul>`},{icon:wa,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Ca({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${ya}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function Ea(){const e=document.createElement("section");return e.className=`
    ...
    `).join("")}function La(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function $a(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=ja(e.redes||[]),i=La(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}const Ie=""+new URL("rad-B3ff1btG.png",import.meta.url).href,Re=""+new URL("mar-Cru0HERG.png",import.meta.url).href,H=[{img:oe,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:se,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:Ie,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:be,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:Re,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:re,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:X,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function Da(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const u=o();return Math.max(H.length-u,0)},r=()=>{const u=n();e>u&&(e=0),e<0&&(e=u)},d=()=>{const u=n();e>=u?e=0:e++,p()},x=()=>{const u=n();e<=0?e=u:e--,p()},v=()=>{l(),H.length>o()&&(a=setInterval(d,4500))},l=()=>{a&&(clearInterval(a),a=null)},w=()=>{const u=o(),m=Math.max(H.length-u+1,1);return Array.from({length:m}).map((y,g)=>`
        ...
        `).join("")},p=()=>{if(!H||H.length===0){i.innerHTML=`
            ...
            `;return}r();const u=o(),m=H.slice(e,e+u);i.innerHTML=`
        ...
        `;const y=i.querySelector("#cards-wrapper");m.forEach(A=>{y.appendChild($a(A))});const g=i.querySelector("#prev-btn"),k=i.querySelector("#next-btn");g&&(g.onclick=()=>{x(),v()}),k&&(k.onclick=()=>{d(),v()}),i.querySelectorAll("[data-dot-index]").forEach(A=>{A.onclick=()=>{e=parseInt(A.dataset.dotIndex),p(),v()}})};return i.addEventListener("mouseenter",l),i.addEventListener("mouseleave",v),document.addEventListener("visibilitychange",()=>{document.hidden?l():v()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,p(),v()},150)}),p(),v(),i}function za(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&ne(t.dataset.route)})}function Ne(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,za(a),a}function Ia(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(Ne());const t=Da();return e.appendChild(a),e.appendChild(t),e}function Ra(){return Ia()}function Na(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function N(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Te(e){return e.formacion?.length||0}function Fe(e){return e.experiencia?.length||0}function Ta(e,a=!1){const t=Te(e),i=Fe(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function Fa(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(d=>`
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ja({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:n,category:r="Noticia",imageFit:d="contain"}){const x=d==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
    ...
    `}function Wa(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function Ya(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function Xa(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const a=Ya(qe),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ${Ha(t)}
        ${Qa(a)}
        ${Wa()}
    `,e}function _a({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(r=>`<p>${r}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function Za(e){e&&e.addEventListener("click",a=>{const t=a.target.closest("[data-news-btn], [data-news-card]");if(!t||!e.contains(t))return;const i=t.dataset.newsBtn||t.dataset.newsCard,o=qe.find(n=>String(n.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}et(o)})}function et(e){const a=document.querySelector("#newsModal");a&&a.remove();const t=document.createElement("div");t.innerHTML=_a(e);const i=t.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",n)}function n(r){r.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(r=>{r.addEventListener("click",o)}),i.addEventListener("click",r=>{r.target===i&&o()}),document.addEventListener("keydown",n)}function at(){const e=Xa();return Za(e),e}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Be(e){return e?.name||e?.title||"Investigador"}function ke(e){return e?.title||e?.tile||"Revista no especificada"}function Oe(e){return String(e?.DOI||e?.doi||"").trim()}function tt(e){const a=Oe(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function it(e){return[...e?.publicaciones||[]].sort((a,t)=>{const i=Number(a.year||0),o=Number(t.year||0);return i!==o?o-i:String(a.contenido||"").localeCompare(String(t.contenido||""))})}function ot(e,a=!1){const t=Be(e),i=e.publicaciones||[],o=i.length,n=i.map(d=>Number(d.year)).filter(Boolean),r=n.length?Math.max(...n):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${a?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function rt(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const a=Be(e),t=it(e),i=t.length,o=t.map(l=>Number(l.year)).filter(Boolean),n=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",d=[...new Set(t.map(l=>l.q).filter(Boolean))],x=[...new Set(t.map(l=>ke(l)).filter(Boolean))],v=t.map(l=>{const w=ke(l),p=Oe(l),u=tt(l);return`
    ...
    `}function st(){let e=q[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(m){return String(m?.DOI||m?.doi||"").trim().toLowerCase()}function n(m){return String(m?.journal||m?.title||m?.tile||"").trim()}function r(m){return String(m?.articleTitle||m?.contenido||"").trim()}function d(m){return String(m?.q||m?.quartile||"").trim().toUpperCase()}function x(m){const y=o(m);return y||[m?.year||"",n(m),r(m)].join("-").trim().toLowerCase()}function v(){const m=new Map;return q.forEach(y=>{(y.publicaciones||[]).forEach(g=>{const k=x(g);k&&!m.has(k)&&m.set(k,g)})}),Array.from(m.values())}function l(){const m=v(),y=m.map(j=>Number(j.year)).filter(Boolean),g=y.length?Math.max(...y):"—",k=y.length?Math.min(...y):"—",A=m.filter(j=>d(j)==="Q1").length;return{totalPublicaciones:m.length,investigadores:q.length,q1:A,primerYear:k,ultimoYear:g}}function w(){return q.find(m=>Number(m.id)===Number(e))||q[0]}const p=()=>{const m=w(),y=l(),g=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${q.map(A=>ot(A,Number(A.id)===Number(e))).join("")}
                </aside>
    ...
    `}function ut(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function mt(){const e=new Set(V.map(i=>i.categoria)),a=V.filter(i=>i.proyectosAsociados?.length>0).length,t=V.filter(i=>i.publicacionesClave?.length>0).length;return{total:V.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function xt(){let e=V[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=lt(e),o=mt();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function yt(){let e=Y[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=gt(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function kt(){return yt()}function At(){return`
    ...
    `}function Et(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Ct()}
    `,e}function St(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Mt)}async function Mt(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=Pt(i);if(o.length>0){Lt(o);return}await $t(a,i)}function Pt(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?jt(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function jt(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Lt(e){ie(e[0],"error")}function ie(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function $t(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(ie("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):ie("Hubo un problema al enviar el mensaje.","error")}catch{ie("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Dt(){const e=Et();return setTimeout(()=>{St()},0),e}function zt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
A00116736    13    7"
    ...
    `;const a=e.querySelector("#banner-primer-input"),t=e.querySelector("#banner-primer-process"),i=e.querySelector("#banner-primer-clear"),o=e.querySelector("#banner-primer-message"),n=e.querySelector("#banner-primer-preview"),r=e.querySelector("#banner-primer-count"),d=e.querySelector("#banner-primer-download-1ac"),x=e.querySelector("#banner-primer-download-2pp");let v=[];function l(s,h="success"){o.textContent=s,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),h==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(){o.textContent="",o.classList.add("hidden")}function p(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function u(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function m(s){const h=String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return h.includes("	")?h.split("	").map(f=>f.trim()).filter(f=>f!==""):h.includes(";")?h.split(";").map(f=>f.trim()).filter(f=>f!==""):h.split(/\s+/).map(f=>f.trim()).filter(f=>f!=="")}function y(s){const h=s.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),f=[],E=[],z=new Set;return h.forEach((C,L)=>{const M=L+1,D=m(C);if(D.length!==3){E.push(`Línea ${M}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const K=p(D[0]),J=Number(u(D[1])),Q=Number(u(D[2]));if(!/^A[0-9]{8}$/.test(K)){E.push(`Línea ${M}: la matrícula "${K}" no es válida. Debe tener el formato A00108671.`);return}if(z.has(K)){E.push(`Línea ${M}: la matrícula ${K} está repetida.`);return}if(!Number.isFinite(J)){E.push(`Línea ${M}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(Q)){E.push(`Línea ${M}: la calificación 2PP no es numérica.`);return}if(J<0||J>15){E.push(`Línea ${M}: 1AC debe estar entre 0 y 15.`);return}if(Q<0||Q>20){E.push(`Línea ${M}: 2PP debe estar entre 0 y 20.`);return}const he=J+Q;if(he>35){E.push(`Línea ${M}: la suma de 1AC y 2PP no puede superar 35 puntos.`);return}z.add(K),f.push({matricula:K,grade1AC:J,grade2PP:Q,total:he})}),{records:f,errors:E}}function g(s){return Number.isInteger(s)?String(s):s.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function k(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function A(s){if(s.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="5"
                        class="px-4 py-10 text-center text-slate-400"
...
A00116736    25"
    ...
    `;const a=e.querySelector("#banner-segundo-input"),t=e.querySelector("#banner-segundo-process"),i=e.querySelector("#banner-segundo-clear"),o=e.querySelector("#banner-segundo-message"),n=e.querySelector("#banner-segundo-preview"),r=e.querySelector("#banner-segundo-count"),d=e.querySelector("#banner-segundo-download");let x=[];function v(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function l(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function w(c){const b=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return b.includes("	")?b.split("	").map(s=>s.trim()).filter(s=>s!==""):b.includes(";")?b.split(";").map(s=>s.trim()).filter(s=>s!==""):b.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function p(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function u(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function m(c,b="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),b==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(c){const b=c.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),s=[],h=[],f=new Set;return b.forEach((E,z)=>{const C=z+1,L=w(E);if(L.length!==2){h.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const M=v(L[0]),D=Number(l(L[1]));if(!/^A[0-9]{8}$/.test(M)){h.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(f.has(M)){h.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(D)){h.push(`Línea ${C}: la calificación 3SP no es numérica.`);return}if(D<0||D>35){h.push(`Línea ${C}: 3SP debe estar entre 0 y 35.`);return}f.add(M),s.push({matricula:M,grade3SP:D})}),{records:s,errors:h}}function g(c){if(c.length===0){n.innerHTML=`
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=c.map((b,s)=>`
                ...
                `).join(""),r.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function k(c){return[["MATRICULA","3SP"],...c.map(s=>[s.matricula,p(s.grade3SP)])].map(s=>s.join(";")).join(`\r
`)}function A(c,b){const s=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(s),f=document.createElement("a");f.href=h,f.download=b,document.body.appendChild(f),f.click(),f.remove(),window.setTimeout(()=>{URL.revokeObjectURL(h)},1e3)}function j(){x=[],a.value="",g([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){x=[],g([]),d.disabled=!0,m("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:b,errors:s}=y(c);if(s.length>0){x=[],g([]),d.disabled=!0,m(s.join(" "),"error");return}x=b,g(b),d.disabled=!1,m(`Los datos de ${b.length} estudiante${b.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",j),d.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function Rt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    20"
    ...
    `;const a=e.querySelector("#banner-final-input"),t=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),n=e.querySelector("#banner-final-preview"),r=e.querySelector("#banner-final-count"),d=e.querySelector("#banner-final-download");let x=[];function v(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function l(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function w(c){const b=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return b.includes("	")?b.split("	").map(s=>s.trim()).filter(s=>s!==""):b.includes(";")?b.split(";").map(s=>s.trim()).filter(s=>s!==""):b.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function p(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function u(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function m(c,b="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),b==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(c){const b=c.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),s=[],h=[],f=new Set;return b.forEach((E,z)=>{const C=z+1,L=w(E);if(L.length!==2){h.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const M=v(L[0]),D=Number(l(L[1]));if(!/^A[0-9]{8}$/.test(M)){h.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(f.has(M)){h.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(D)){h.push(`Línea ${C}: la calificación 4EF no es numérica.`);return}if(D<0||D>30){h.push(`Línea ${C}: 4EF debe estar entre 0 y 30.`);return}f.add(M),s.push({matricula:M,grade4EF:D})}),{records:s,errors:h}}function g(c){if(c.length===0){n.innerHTML=`
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=c.map((b,s)=>`
                ...
                `).join(""),r.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function k(c){return[["MATRICULA","4EF"],...c.map(s=>[s.matricula,p(s.grade4EF)])].map(s=>s.join(";")).join(`\r
`)}function A(c,b){const s=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(s),f=document.createElement("a");f.href=h,f.download=b,document.body.appendChild(f),f.click(),f.remove(),window.setTimeout(()=>{URL.revokeObjectURL(h)},1e3)}function j(){x=[],a.value="",g([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){x=[],g([]),d.disabled=!0,m("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:b,errors:s}=y(c);if(s.length>0){x=[],g([]),d.disabled=!0,m(s.join(" "),"error");return}x=b,g(b),d.disabled=!1,m(`Los datos de ${b.length} estudiante${b.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",j),d.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Examen_Final_4EF.csv")}),e}function Nt(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),n=e.querySelector("#open-segundo-periodo"),r=e.querySelector("#open-calificacion-final"),d=e.querySelector("#banner-back");function x(){a.classList.add("hidden"),t.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}function v(p){console.error("No fue posible abrir la herramienta de Banner:",p),i.innerHTML=`
        ...
        `,x()}function l(p){i.innerHTML="";try{if(typeof p!="function")throw new TypeError("El componente seleccionado no es una función válida.");const u=p();if(!(u instanceof HTMLElement))throw new TypeError("El componente seleccionado no devolvió un elemento HTML válido.");i.appendChild(u),x()}catch(u){v(u)}}function w(){i.replaceChildren(),t.classList.add("hidden"),a.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}return o.addEventListener("click",()=>{l(zt)}),n.addEventListener("click",()=>{l(It)}),r.addEventListener("click",()=>{l(Rt)}),d.addEventListener("click",w),e}function Tt(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
        <div class="mb-8 text-center">
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function y(g){const k=g==="xmera";v.classList.toggle("hidden",!k),l.classList.toggle("hidden",k),d.className=k?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",x.className=k?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const g=a.value.trim();if(!g){w(),p("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:k,errors:A}=u(g);if(A.length>0){w(),p(A.join(" "),"error");return}t.textContent=m(k),o.disabled=!1,p(`Código generado correctamente para ${k.length} estudiante${k.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),p("El código fue copiado al portapapeles.")}catch(g){console.error("No fue posible copiar el código:",g),p("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),n.addEventListener("click",()=>{a.value="",w(),r.textContent="",r.classList.add("hidden"),a.focus()});try{const g=Nt();if(g instanceof HTMLElement)l.appendChild(g);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(g){console.error("No fue posible cargar el módulo Banner:",g),l.innerHTML=`
        ...
        `}return d.addEventListener("click",()=>{y("xmera")}),x.addEventListener("click",()=>{y("banner")}),y("xmera"),e}function Ft(){return Tt()}function qt(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
    ...
    `;const t=e.querySelector("#asistente-pruebas"),i=l=>{t.innerHTML=l,window.scrollTo({top:0,behavior:"auto"})},o=()=>{Object.assign(a,{pantalla:"inicio",objetivo:"",tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:""})},n=()=>{a.pantalla="resultado-comparacion",i(Jt(a))},r=()=>{a.pantalla="resultado-relacion",i(Qt(a))},d=()=>{a.pantalla="resultado-asociacion",i(Wt(a))},x=l=>{if(a.pantalla==="objetivo"){if(Object.assign(a,{objetivo:l,tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:""}),l==="comparar"){a.pantalla="tipo-variable",i(Ee());return}if(l==="relacionar"){a.pantalla="tipo-relacion",i(ae());return}if(l==="asociar"){a.pantalla="tipo-asociacion",i(Me());return}i(Yt(l)),a.pantalla="desarrollo";return}if(a.pantalla==="tipo-variable"){Object.assign(a,{tipoVariable:l,numeroGrupos:"",relacion:"",normalidad:"",varianzas:""}),a.pantalla="numero-grupos",i(Z());return}if(a.pantalla==="numero-grupos"){if(Object.assign(a,{numeroGrupos:l,relacion:"",normalidad:"",varianzas:""}),l==="uno"){if(a.relacion="una-muestra",a.tipoVariable==="categorica"){n();return}a.pantalla="normalidad",i(ee());return}a.pantalla="relacion-muestras",i(de(a));return}if(a.pantalla==="relacion-muestras"){if(Object.assign(a,{relacion:l,normalidad:"",varianzas:""}),a.tipoVariable==="categorica"){n();return}a.pantalla="normalidad",i(ee());return}if(a.pantalla==="normalidad"){if(a.normalidad=l,a.varianzas="",a.tipoVariable==="cuantitativa"&&l==="si"&&a.relacion==="independientes"&&a.numeroGrupos!=="uno"){a.pantalla="varianzas",i(Se());return}n();return}if(a.pantalla==="varianzas"){a.varianzas=l,n();return}if(a.pantalla==="tipo-relacion"){if(Object.assign(a,{tipoRelacion:l,normalidad:"",linealidad:"",empates:""}),l==="dicotomica-cuantitativa"){r();return}if(l==="ordinales"){a.pantalla="empates",i(Le());return}a.pantalla="normalidad-relacion",i(pe());return}if(a.pantalla==="normalidad-relacion"){if(a.normalidad=l,a.linealidad="",l!=="si"){r();return}a.pantalla="linealidad",i(je());return}if(a.pantalla==="linealidad"){a.linealidad=l,r();return}if(a.pantalla==="empates"){a.empates=l,r();return}if(a.pantalla==="tipo-asociacion"){Object.assign(a,{tipoAsociacion:l,frecuenciasEsperadas:""}),a.pantalla="frecuencias-esperadas",i(Pe());return}a.pantalla==="frecuencias-esperadas"&&(a.frecuenciasEsperadas=l,d())},v=()=>{const w={"tipo-variable":()=>["objetivo",W()],"numero-grupos":()=>["tipo-variable",Ee()],"relacion-muestras":()=>["numero-grupos",Z()],normalidad:()=>a.numeroGrupos==="uno"?["numero-grupos",Z()]:["relacion-muestras",de(a)],varianzas:()=>["normalidad",ee()],"tipo-relacion":()=>["objetivo",W()],"normalidad-relacion":()=>["tipo-relacion",ae()],linealidad:()=>["normalidad-relacion",pe()],empates:()=>["tipo-relacion",ae()],"tipo-asociacion":()=>["objetivo",W()],"frecuencias-esperadas":()=>["tipo-asociacion",Me()],"resultado-asociacion":()=>["frecuencias-esperadas",Pe()],"resultado-comparacion":()=>a.varianzas?["varianzas",Se()]:a.tipoVariable==="categorica"?a.numeroGrupos==="uno"?["numero-grupos",Z()]:["relacion-muestras",de(a)]:["normalidad",ee()],"resultado-relacion":()=>a.tipoRelacion==="ordinales"?["empates",Le()]:a.tipoRelacion==="dicotomica-cuantitativa"?["tipo-relacion",ae()]:a.linealidad?["linealidad",je()]:["normalidad-relacion",pe()]}[a.pantalla];if(!w){a.pantalla="objetivo",i(W());return}const[p,u]=w();a.pantalla=p,i(u)};return t.addEventListener("click",l=>{const w=l.target.closest("[data-action], [data-value]");if(!w)return;const p=w.dataset.action,u=w.dataset.value;if(u){x(u);return}p==="iniciar"&&(a.pantalla="objetivo",i(W())),p==="volver"&&v(),(p==="volver-inicio"||p==="reiniciar")&&(o(),i(Ce())),p==="volver-laboratorio"&&(window.location.hash="/laboratorioKernel")}),e}function Ce(){return`
    ...
    `}const _t={home:{page:ca,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:Pa,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Ra,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Ba,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:at,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:nt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:kt,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:bt,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Dt,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Ft,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:qt,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Vt,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"}};let $e=document.referrer||"";function ne(e){window.location.hash=`/${e}`}function Zt(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";ai(a)};window.addEventListener("hashchange",e),e()}function ei(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:$e}),$e=t}function ai(e){const a=document.querySelector("main"),t=_t[e];if(a){if(a.innerHTML="",!t){ne("home");return}Na(t.layout),document.title=t.title,a.appendChild(t.page()),window.scrollTo({top:0,behavior:"auto"}),ei(e,t.title)}}function ti(e,a){De(e,ne),Zt();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(we(e),i=!0)}t.addEventListener("change",o),o(t),we(e);const n=a.querySelector('[data-action ="open-menu"]');Je(n,e),Qe(e)}const Ue=document.querySelector("#header");Ue.innerHTML=Ve();const Ge=document.querySelector("#navBar");Ge.innerHTML=Ke();const ii=document.querySelector("#footer");ii.innerHTML=He();ti(Ge,Ue);
