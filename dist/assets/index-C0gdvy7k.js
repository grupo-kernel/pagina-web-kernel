(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();function P(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function T(){return`<div class="lg:hidden  border-b-zinc-500 border-b  pb-2.5  w-full  flex px-2.5  justify-between items-center  mb-7">
    ...
    <div class=" flex items-center gap-4  text-white "> 
        ...
        `}function y(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(a=>{const i=a.querySelector("ul"),o=a.querySelector("i");let s=!i.classList.contains("hidden");a.addEventListener("click",n=>{n.preventDefault(),s?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),s=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),s=!0)})})}function O(e,t){e.addEventListener("click",()=>{t.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function z(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function N(){return`<div class =" flex justify-center 
            bg-white shadow-2xl p-2 
                ...
                <div class=" w-70.5 h-46.5 md:w-123  flex flex-col mt-4 mb-3  lg:w-118.75 lg:h-76.75   " >

                       <h3 class=" text-2xl font-bold w-55 mb-1.5 xsM:w-full   lg:w-96.75 lg:text-5xl  "> Grupo de investigación </h3>

                        <p class="text-xs mb-2 leading-4.5 md:mb-3.5 md:w-120.75 lg:w-116.75 lg:text-xl md:text-lg  md:leading-6 " >
                        Exploramos EDPs no lineales, Métodos iterativos,
                        Análisis Matricial, Diseño de algoritmos y Educación Matemática.</p>

                        <p class=" text-xs italic leading-4 lg:text-lg lg:mt-4 md:text-lg " >“Innovando en la frontera entre matemática y educación” </p>

                        <div class="flex items-center w-full justify-center gap-2 md:justify-between md:mt-3.5 md:w-171.5 lg:w-165.75 lg:mt-6    " >

                                <span class=" cursor-pointer flex flex-col items-center  transition transform  " >
                                    <p class=" text-family-size font-bold " >7 +</p>                
                                    <p class=" text-xs text-nowrap lg:text-lg md:text-lg  " >Miembros principales</p>
                                </span>
                                <span class=" cursor-pointer flex flex-col items-center   transition transform " >
                                    <p class=" text-family-size font-bold " >15 +</p>                
                                    <p class=" text-xs text-nowrap  lg:text-lg md:text-lg " >Publicaciones</p>
                                </span>
                                <span class=" cursor-pointer flex flex-col items-center  transition transform  " >
                                    <p class=" text-family-size font-bold " >0</p>                
                                    <p class=" text-xs text-nowrap  lg:text-lg md:text-lg " >Proyectos en curso</p>
                                </span>
                        </div> 
                </div>
                ...
                <div class="flex flex-col w-6.25 h-35.75 gap-2.5 lg:gap-5.5 lg:w-8 lg:h-59.5  " >

                       <span class="transform cursor-pointer  p-1 w-6.5 h-6.5  lg:w-8 lg:h-8 rounded-full bg-black items-center justify-center  lg:p-2 "  >
                    ...
                    <a href="https://wa.me/?text=Hola,%20mira%20este%20enlace:%20https://https://www.grupoelkernel.com" target="_blank" class="social-link">
                        ...
                        <span  class="transform  cursor-pointer w-6.5 h-6.5   lg:w-8 lg:h-8   rounded-full p-1 bg-black items-center justify-center lg:p-2  "  >
                        <a href="mailto:mleonardo@itla.edu.do" class="social-link">
            ...
            <!-- Fin tarjeta principal  -->  `}function A(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function U(e){A(e,h)}const M=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="/src/assets/apec.png" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="/src/assets/isfodosu.png" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        <img src="/src/assets/uasd.png" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function q(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=M.length,s=1500;let n=0,r=null;function l(f){return(f%o+o)%o}function c(){i.innerHTML=M[n].content}function d(f){n=l(n+f),c()}function g(){x(),r=setInterval(()=>d(1),s)}function x(){r&&(clearInterval(r),r=null)}function w(){g()}c(),g(),t.addEventListener("click",()=>{d(1),w()}),a.addEventListener("click",()=>{d(-1),w()})}function R(){const e=`
    <div class="absolute bottom-0 col-span-4
            ...
            </div>`,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return q(a.querySelector("#containerFather")),U(a.querySelector("#btnsGroup")),a}function B(){const e=document.createElement("section");e.classList.add("relative","w-full","flex","flex-col","m-auto","tabletBig:flex-row","md:mb-50","xl:mb-0","xl:pb-0","xl:w-full","xl:px-0","tabletBig:w-7xl","tabletBig:px-20"),e.innerHTML=`${N()}`;const t=document.createElement("div");return t.appendChild(R()),e.appendChild(t.firstElementChild),e}function F(){return B()}function H(e="¿Quiénes Somos?",t="/src/assets/QuienesSomos.png"){return`
    <section role="banner" class="relative w-full min-h-screen overflow-hidden">
     
    <!-- Imagen del banner -->
      <img src="${t}" alt="${e}" class="absolute inset-0 w-full h-full object-cover" loading="lazy"/>
  ...
  `}const G=[{icon:"/src/assets/mision.png",title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:"/src/assets/vision.png",title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:"/src/assets/objetivos.png",title:"Objetivos",content:`
      ...
      </ul>`},{icon:"/src/assets/valores.png",title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Q({icon:e,title:t,content:a}){return`
  ...
  `}function V(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${H()}
    ${J()}
    ${_()}
  `,e}function K(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),s=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(n=>{n.classList.remove("max-h-[1000px]"),n.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(n=>{n.classList.remove("rotate-180")}),s||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function W(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function Y(){const e=V();return K(e),W(e),e}function X(e){const t=document.createElement("div");t.className="flex bg-white border rounded-xl shadow-2xl border-black w-89.5 h-139 flex-col items-center text-center justify-between p-4 gap-4 transition-all hover:scale-[1.02]";const a=e.redes.map(i=>`
        <a href="${i.url}" 
           target="_blank" 
    ...
    `,t}const b=[{img:"./src/assets/sep.png",title:"Miguel A. Miguel A. Leonardo Sepúlveda, Ph.D",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente.",afilaciones:" ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&amp;hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con enfoque en métodos numéricos avanzados. Asesor de tesis de posgrado y pregrado. Diseñador y rediseñador de programas curriculares universitarios. Investigador en métodos libres de Jacobiano, análisis numérico y formación de docentes."},{img:"./src/assets/nat.png",title:"Natanael Ureña Castillo, M.Sc",subtitle:"Optimización, entrenamiento de redes neuronales, formación docente",areas:"Métodos iterativos, optimización, redes neuronales, ciencias actuariales, matemática computacional, formación docente.",afilaciones:" ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Especialista en métodos iterativos, optimización y redes neuronales aplicadas a problemas complejos y riesgos. Docente universitario y asesor en proyectos de investigación matemática."},{img:"./src/assets/rad.png",title:"Randy Leonardo, M.Sc",subtitle:"Álgebra Lineal, Matrices combinadas, Educación Matemática",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa..",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador en álgebra y docencia, co-investigador de proyectos de matrices combinadas. Ponente en congresos nacionales."},{img:"./src/assets/ant.png",title:"Antmel Rodríguez Cabral, Ph.D",subtitle:"Especialista en dinámica compleja y dinámica real de métodos iterativos para sistemas no lineales",rec:"Recientemente defendió su tesis doctoral (Doctor en Matemática).",areas:" EDPs, sistemas no lineales, planos/dinámicas compleja y real, análisis complejo, educación matemática.",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Profesor universitario e investigador en métodos numéricos, EDPs y planos dinámicos; ponente en congresos internacionales."},{img:"./src/assets/mar.png",title:"Marino Brito Guillén, M.Sc",subtitle:"Gestión universitaria, Matemática Educativa, Educación",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente.",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Ex-vicerrector académico, profesor universitario y consultor educativo. Experto en desarrollo curricular y formación docente."},{img:"./src/assets/marc.png",title:"Marc-Kelly Jean Philippe Jean, Ph.D",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",areas:"Álgebra, matemática pura, educación matemática, recursos educativos.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?hl=es&amp;user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Profesor adjunto, asesor y conferencista en álgebra, con experiencia en investigación y divulgación científica internacional."},{img:"./src/assets/jos.png",title:"José Alberto Reyes Reyes, M.Sc",subtitle:"Métodos Iterativos, Educación Matemática",areas:"Matemática pura, métodos iterativos, análisis de estabilidad, innovación educativa.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Docente universitario y de postgrado. Investigador en métodos numéricos y asesor de tesis en análisis de estabilidad y convergencia."}];function Z(){let e=0,t;const a=document.createElement("div");a.className="relative flex flex-col gap-7 w-full items-center";const i=()=>window.innerWidth>=1024?3:window.innerWidth>=768?2:1,o=()=>{const c=i();e+c>=b.length?e=0:e++,l()},s=()=>{const c=i();e<=0?e=b.length-c:e--,l()},n=()=>{r(),t=setInterval(o,3500)},r=()=>{t&&clearInterval(t)},l=()=>{const c=i();a.innerHTML=`
        ...
        `;const d=a.querySelector("#cards-wrapper");b.slice(e,e+c).forEach(x=>{d.appendChild(X(x))}),a.querySelector("#prev-btn").onclick=()=>{s(),n()},a.querySelector("#next-btn").onclick=()=>{o(),n()}};return document.addEventListener("visibilitychange",()=>{document.hidden?r():n()}),window.addEventListener("resize",()=>{e=0,l()}),l(),n(),a}function ee(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-route]");if(!a)return;const i=window.location.hash.replace("#/","")||"equipment";a.dataset.route!==i&&h(a.dataset.route)})}function j(){const e=window.location.hash.replace("#/","")||"equipment",t=document.createElement("div"),a="bg-sky-800 text-white border-b-sky-800",i="bg-transparent text-black hover:bg-gray-50";return t.innerHTML=`
    ...
    </nav>`,ee(t.firstElementChild),t.firstElementChild}function te(){const e=document.createElement("section");e.classList.add("flex","flex-col","gap-5","m-auto","p-4","max-w-7xl","tabletBig:w-7xl","xl:w-full"),e.appendChild(j());const t=Z();return e.appendChild(t),e}function ae(){return te()}function ie(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function oe(e,t=!1){return`
        <div data-id="${e.id}" 
    ...
    `}function ne(e){const t=e.formacion.map(i=>`
        <div class="mb-4">
    ...
    `}function ce({id:e,title:t,date:a,image:i,excerpt:o}){return`
  ...
  `}function ue(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ...
    `}function ge(e){e&&(e.addEventListener("click",xe),document.addEventListener("click",fe),document.addEventListener("keydown",be))}function xe(e){const t=e.target.closest("[data-news-btn]");if(!t)return;const a=t.dataset.newsBtn,i=k.find(o=>o.id===a);i&&ve(i)}function fe(e){const t=e.target.closest("[data-close-modal]"),a=e.target.id==="newsModal";(t||a)&&v()}function be(e){e.key==="Escape"&&v()}function ve(e){v(),document.body.insertAdjacentHTML("beforeend",pe(e)),document.body.classList.add("overflow-hidden")}function v(){const e=document.getElementById("newsModal");e&&(e.remove(),document.body.classList.remove("overflow-hidden"))}function he(){const e=ue();return ge(e),e}const C=[{id:1,img:"./src/assets/sep.png",title:"Miguel A. Miguel A. Leonardo Sepúlveda, Ph.D",publicaciones:[{year:2024,title:"Mathematics and Computers in Simulation",q:"Q1",contenido:"Increasing in three units the order of convergence of iterative methods for solving nonlinear systems",autores:"Alicia Cordero, Miguel A. Leonardo-Sepúlveda, Juan R. Torregrosa, María P. Vassileva",DOI:" 10.1016/j.matcom.2024.05.001"},{year:2023,tile:"Mathematics ",q:"Q1",contenido:"Enhancing the Convergence Order from p to p+3 in Iterative Methods for Solving Nonlinear Systems of Equations without the Use of Jacobian Matrices",autores:"Alicia Cordero, Miguel A. Leonardo-Sepúlveda, Juan R. Torregrosa, María P. Vassileva",DOI:"10.3390/math11204238"},{year:2022,tile:"Algorithms  ",q:"Q2",contenido:"Dynamics and Stability on a Family of Optimal Fourth-Order Iterative Methods",autores:" Alicia Cordero, Miguel A. Leonardo Sepúlveda, Juan R. Torregrosa",DOI:"10.3390/a15100387"}]},{id:2,img:"./src/assets/ant.png",name:"Antmel Rodríguez Cabral, Ph.D",publicaciones:[{year:2025,title:"Journal of Computational Methods in Sciences and Engineering",q:"Q4",contenido:"About the stability of self-accelerating parameters in vectorial iterative methods without memory",autores:"Alicia Cordero, Javier G. Maimó, Antmel Rodríguez Cabral, Juan R. Torregrosa",DOI:"10.1177/14727978251361407"},{year:2024,tile:"Mathematics ",q:"Q1",contenido:"Two-Step Fifth-Order Efficient Jacobian-Free Iterative Method for Solving Nonlinear Systems",autores:"Alicia Cordero, Javier García Maimó, Antmel Rodríguez Cabral, Juan R. Torregrosa",DOI:"10.3390/math12213341"},{year:2023,tile:"Algorithms",q:"Q2",contenido:"Convergence and Stability of a New Parametric Class of Iterative Processes for Nonlinear Systems",autores:" Alicia Cordero, Miguel A. Leonardo Sepúlveda, Juan R. Torregrosa",DOI:"10.3390/a16030163"}]},{id:3,img:"./src/assets/marc.png",name:"Marc-Kelly Jean Philippe Jean, Ph.D",publicaciones:[{year:2025,title:"Mathematische Nachrichten",q:"Q2",contenido:"Groups with triangle-free graphs on 𝒑-regular classes",autores:"Marc-Kelly Jean Philippe Jean",DOI:"10.1002/mana.202400554"},{year:2024,tile:"Mediterranean Journal of Mathematics  ",q:"Q2",contenido:"Groups whose common divisor graph on p-regular classes has diameter three",autores:"Marc-Kelly Jean Philippe Jean",DOI:" 10.1007/s00009-024-02782-2"},{year:2024,tile:"Bulletin of the Malaysian Mathematical Sciences Society",q:"Q2",contenido:"Some properties of Normal Subgroups Determined from Character Tables",autores:"Marc-Kelly Jean Philippe Jean",DOI:"10.1007/s40840-024-01684-6"}]},{id:4,img:"./src/assets/jos.png",name:"José Alberto Reyes Reyes, M.Sc",publicaciones:[{year:2024,title:"Axioms",q:"Q2",contenido:"A Robust Family of High-Order Derivative-Free Iterative Methods for Nonlinear Equations",autores:"José Alberto Reyes Reyes",DOI:"https://www.mdpi.com/2075-1680/13/1/34"},{year:2024,tile:"Computation",q:"Q2",contenido:"Convergence and Stability Analysis of High-Order Derivative-Free Methods for Nonlinear Equations",autores:" José Alberto Reyes Reyes",DOI:"  10.3390/computation13060142"}]}];function we(e,t=!1){return`
        <div data-id="${e.id}" 
    ...
    `}function ye(e){const t=e.publicaciones.map(a=>`
    ...
    `}function Me(){let e=1,t=!1;const a=document.createElement("div");a.className="relative flex flex-col md:shadow-2xl md:rounded-2xl md:flex-row gap-6 w-full max-w-6xl mx-auto p-4 h-[600px] tabletBig:w-7xl tabletBig:px-20 xl:w-full xl:px-0";const i=()=>{const o=C.find(n=>n.id===e);a.innerHTML=`
        ...
        `,a.querySelector("#next-btn").onclick=()=>{e=o,i()}};return i(),a}function S(e,t){return`
    ...
    `}function De(){return Ce()}const u=[{id:1,title:"Plataforma de Simulación para Ecuaciones Diferenciales Parciales No Lineales",contenido:"Diseño e implementación de un software web para la simulación y visualización de soluciones aproximadas a EDPs no lineales utilizando métodos numéricos avanzados. El objetivo es crear una herramienta didáctica y de investigación abierta a estudiantes y científicos."},{id:2,title:"Entrenamiento de Redes Neuronales para la Solución de Problemas Matemáticos",contenido:"Proyecto orientado al desarrollo y entrenamiento de arquitecturas de redes neuronales profundas para el aprendizaje y la resolución automatizada de ecuaciones diferenciales y problemas complejos en optimización matemática."},{id:3,title:"Métodos Cuasi-Newton de Memoria Limitada Aplicados a Grandes Sistemas",contenido:"Investigación sobre el diseño y análisis de métodos cuasi-Newton híbridos de memoria limitada, dirigidos a la resolución eficiente de sistemas de ecuaciones de gran escala, con énfasis en aplicaciones de ingeniería y finanzas."},{id:4,title:"Modelización Matemática de Riesgo Actuarial y Financiero",contenido:"Elaboración de modelos para la evaluación y gestión del riesgo en problemas actuariales y financieros, combinando técnicas de optimización y simulación para ofrecer soluciones robustas a la toma de decisiones en estos campos."},{id:5,title:"Innovación en la Enseñanza y Evaluación de la Matemática",contenido:"Diseño de estrategias y recursos innovadores para la enseñanza de las matemáticas en distintos niveles educativos, incorporando metodologías activas, plataformas tecnológicas y evaluación por competencias."},{id:6,title:"Desarrollo de Métodos Metaheurísticos Híbridos",contenido:"Propuesta de integración de algoritmos metaheurísticos con métodos iterativos clásicos y cuasi-Newton para abordar problemas no lineales de alta complejidad en diferentes áreas de la ciencia y la ingeniería."}];function Ae(){let e=0;const t=u.length,a=document.createElement("section");a.className="w-full max-w-6xl mx-auto p-4 mt-10 mb-20 font-sans tabletBig:w-7xl tabletBig:px-20 xl:w-full xl:px-0";const i=()=>{const o=(e+1)%t,s=(e+2)%t,n=u[e],r=u[o],l=u[s];a.innerHTML=`
        ...
        `,a.querySelector("#next-btn").onclick=()=>{e=o,i()}};return i(),a}function D(e,t){return`
    ...
    `}function ke(){return Ae()}function Le(){return`
    ...
    `}function Pe(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Ie()}
    `,e}function Te(){const e=document.getElementById("contactForm");e&&(e.addEventListener("submit",$e),console.log("Controller cargado"))}async function $e(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=Oe(i);if(o.length>0){Ne(o);return}await Ue(t,i),console.log("Submit interceptado")}function Oe(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?ze(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function ze(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Ne(e){p(e[0],"error")}function p(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Ue(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(p("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):p("Hubo un problema al enviar el mensaje.","error")}catch{p("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function qe(){const e=Pe();return setTimeout(()=>{Te()},0),e}const Re={home:{page:F,layout:"default"},quienesSomos:{page:Y,layout:"full"},equipment:{page:ae,layout:"default"},FormacionAcademica:{page:re,layout:"default"},noticias:{page:he,layout:"full"},publicaciones:{page:Ee,layout:"default"},proyectos:{page:ke,layout:"default"},lineas:{page:De,layout:"default"},contacto:{page:qe,layout:"default"}};function h(e){window.location.hash=`/${e}`}function Be(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";Fe(t)};window.addEventListener("hashchange",e),e()}function Fe(e){const t=document.querySelector("main"),a=Re[e];t&&(t.innerHTML="",a&&(ie(a.layout),t.appendChild(a.page())))}function He(e,t){A(e,h),Be();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(y(e),i=!0)}a.addEventListener("change",o),o(a),y(e);const s=t.querySelector('[data-action ="open-menu"]');O(s,e),z(e)}const L=document.querySelector("#header");L.innerHTML=P();const I=document.querySelector("#navBar");I.innerHTML=T();const Je=document.querySelector("#footer");Je.innerHTML=$();He(I,L);
