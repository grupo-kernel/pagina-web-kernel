(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();const ae=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function ke(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function Ce(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${ae}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function de(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function $e(e){de(e,Z)}const pe=""+new URL("apec-ConmXkrT.png",import.meta.url).href,je=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Ie=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,re=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        <img src="${je}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        <img src="${Ie}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function ze(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=re.length,r=1500;let n=0,c=null;function v(d){return(d%o+o)%o}function h(){i.innerHTML=re[n].content}function p(d){n=v(n+d),h()}function E(){f(),c=setInterval(()=>p(1),r)}function f(){c&&(clearInterval(c),c=null)}function u(){E()}h(),E(),t.addEventListener("click",()=>{p(1),u()}),a.addEventListener("click",()=>{p(-1),u()})}function Fe(){const e=`
        <section class="
    ...
    `,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return ze(a.querySelector("#containerFather")),$e(a.querySelector("#btnsGroup")),a}const Te="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function Be(){try{const e=await fetch(Te,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const t=await e.json();if(!t.ok||!t.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(t.visitantes.total)||0,hoy:Number(t.visitantes.hoy)||0,ultimos7Dias:Number(t.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(t.visitantes.ultimos30Dias)||0,actualizadoEn:t.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function Q(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function Ne(e){if(!e)return null;const t=new Date(e);return Number.isNaN(t.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(t)}async function qe(e){const t=e.querySelector("#analytics-total"),a=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),r=e.querySelector("#analytics-actualizado");if(!t||!a||!i||!o||!r){console.warn("No se encontraron los elementos de Analytics en la portada.");return}r.textContent="Cargando estadísticas…";try{const n=await Be();t.textContent=Q(n.total),a.textContent=Q(n.hoy),i.textContent=Q(n.ultimos7Dias),o.textContent=Q(n.ultimos30Dias);const c=Ne(n.actualizadoEn);r.textContent=c?`Actualizado: ${c}`:"Estadísticas temporalmente no disponibles"}catch(n){console.error("Error al mostrar las estadísticas en la portada:",n),t.textContent="—",a.textContent="—",i.textContent="—",o.textContent="—",r.textContent="No fue posible cargar las estadísticas"}}function Ue(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=Pe();const t=Fe();return e.appendChild(t),qe(e),e}function Re(){return Ue()}const Oe=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Ge(){return`
        <section 
            role="banner" 
    ...
    `}const Ye="data:image/png;base64,",We="data:image/png;base64,",Xe="data:image/png;base64,",_e="data:image/png;base64,",Ze="data:image/png;base64,",et=[{icon:Ye,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:We,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:Xe,title:"Objetivos",content:`
      ...
      </ul>`},{icon:_e,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function at({icon:e,title:t,content:a}){return`
  ...
  `}function it(){const e=document.createElement("section");return e.className=`
    ...
    `,e.innerHTML=`
        ...
        ${Qe()}
        ${tt()}
    `,e}function ot(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),r=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(n=>{n.classList.remove("max-h-[1000px]"),n.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(n=>{n.classList.remove("rotate-180")}),r||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function st(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function rt(){const e=it();return ot(e),st(e),e}function F(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function nt(e=[]){return!e||e.length===0?`
    ...
    `).join("")}function lt(e){return e?String(e).split(",").map(a=>a.trim()).filter(Boolean).slice(0,4).map(a=>`
    ...
    `).join(""):""}function ct(e){const t=document.createElement("article");t.className=`
    ...
    `;const a=nt(e.redes||[]),i=lt(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return t.innerHTML=`
    ...
    `,t}const ue=""+new URL("rad-B3ff1btG.png",import.meta.url).href,me=""+new URL("mar-Cru0HERG.png",import.meta.url).href,G=[{img:W,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:_,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:ue,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:ie,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:me,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:X,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:V,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function dt(){let e=0,t=null,a=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,r=()=>{const u=o();return Math.max(G.length-u,0)},n=()=>{const u=r();e>u&&(e=0),e<0&&(e=u)},c=()=>{const u=r();e>=u?e=0:e++,f()},v=()=>{const u=r();e<=0?e=u:e--,f()},h=()=>{p(),G.length>o()&&(t=setInterval(c,4500))},p=()=>{t&&(clearInterval(t),t=null)},E=()=>{const u=o(),d=Math.max(G.length-u+1,1);return Array.from({length:d}).map((w,x)=>`
        ...
        `).join("")},f=()=>{if(!G||G.length===0){i.innerHTML=`
            ...
            `;return}n();const u=o(),d=G.slice(e,e+u);i.innerHTML=`
        ...
        `;const w=i.querySelector("#cards-wrapper");d.forEach(k=>{w.appendChild(ct(k))});const x=i.querySelector("#prev-btn"),y=i.querySelector("#next-btn");x&&(x.onclick=()=>{v(),h()}),y&&(y.onclick=()=>{c(),h()}),i.querySelectorAll("[data-dot-index]").forEach(k=>{k.onclick=()=>{e=parseInt(k.dataset.dotIndex),f(),h()}})};return i.addEventListener("mouseenter",p),i.addEventListener("mouseleave",h),document.addEventListener("visibilitychange",()=>{document.hidden?p():h()}),window.addEventListener("resize",()=>{clearTimeout(a),a=setTimeout(()=>{e=0,f(),h()},150)}),f(),h(),i}function pt(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-route]");if(!a)return;const i=window.location.hash.replace("#/","")||"equipment";a.dataset.route!==i&&Z(a.dataset.route)})}function xe(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",t=document.createElement("nav"),a="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return t.className="w-full flex justify-center mb-6",t.innerHTML=`
    ...
    `,pt(t),t}function ut(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=document.createElement("div");t.className="mb-6",t.appendChild(xe());const a=dt();return e.appendChild(t),e.appendChild(a),e}function mt(){return ut()}function xt(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function z(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function be(e){return e.formacion?.length||0}function ge(e){return e.experiencia?.length||0}function bt(e,t=!1){const a=be(e),i=ge(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function gt(e){const t=e.formacion||[],a=e.experiencia||[],i=t.length?t.map(c=>`
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Et({id:e,title:t,date:a,image:i,imageAlt:o,excerpt:r,category:n="Noticia",imageFit:c="contain"}){const v=c==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
    ...
    `}function Mt(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),t=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function Lt(e=[]){return[...e].sort((t,a)=>t.featured&&!a.featured?-1:!t.featured&&a.featured?1:0)}function Dt(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const t=Lt(fe),a=t.find(i=>i.featured)||t[0];return e.innerHTML=`
        ${Ct(a)}
        ${St(t)}
        ${Mt()}
    ...
    `}function $t(e){e&&e.addEventListener("click",t=>{const a=t.target.closest("[data-news-btn], [data-news-card]");if(!a||!e.contains(a))return;const i=a.dataset.newsBtn||a.dataset.newsCard,o=fe.find(r=>String(r.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}jt(o)})}function jt(e){const t=document.querySelector("#newsModal");t&&t.remove();const a=document.createElement("div");a.innerHTML=Pt(e);const i=a.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",r)}function r(n){n.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(n=>{n.addEventListener("click",o)}),i.addEventListener("click",n=>{n.target===i&&o()}),document.addEventListener("keydown",r)}function It(){const e=Dt();return $t(e),e}function P(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ve(e){return e?.name||e?.title||"Investigador"}function ne(e){return e?.title||e?.tile||"Revista no especificada"}function he(e){return String(e?.DOI||e?.doi||"").trim()}function zt(e){const t=he(e);return e?.url?e.url:t?t.startsWith("http")?t:`https://doi.org/${t}`:"#"}function Ft(e){return[...e?.publicaciones||[]].sort((t,a)=>{const i=Number(t.year||0),o=Number(a.year||0);return i!==o?o-i:String(t.contenido||"").localeCompare(String(a.contenido||""))})}function Tt(e,t=!1){const a=ve(e),i=e.publicaciones||[],o=i.length,r=i.map(c=>Number(c.year)).filter(Boolean),n=r.length?Math.max(...r):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${t?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function Bt(e){if(!e)return`
        ...
        `;const t=ve(e),a=Ft(e),i=a.length,o=a.map(p=>Number(p.year)).filter(Boolean),r=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",c=[...new Set(a.map(p=>p.q).filter(Boolean))],v=[...new Set(a.map(p=>ne(p)).filter(Boolean))],h=a.map(p=>{const E=ne(p),f=he(p),u=zt(p);return`
    ...
    `}function Nt(){let e=T[0]?.id||1,t=!1,a=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(d){return String(d?.DOI||d?.doi||"").trim().toLowerCase()}function r(d){return String(d?.journal||d?.title||d?.tile||"").trim()}function n(d){return String(d?.articleTitle||d?.contenido||"").trim()}function c(d){return String(d?.q||d?.quartile||"").trim().toUpperCase()}function v(d){const w=o(d);return w||[d?.year||"",r(d),n(d)].join("-").trim().toLowerCase()}function h(){const d=new Map;return T.forEach(w=>{(w.publicaciones||[]).forEach(x=>{const y=v(x);y&&!d.has(y)&&d.set(y,x)})}),Array.from(d.values())}function p(){const d=h(),w=d.map(L=>Number(L.year)).filter(Boolean),x=w.length?Math.max(...w):"—",y=w.length?Math.min(...w):"—",k=d.filter(L=>c(L)==="Q1").length;return{totalPublicaciones:d.length,investigadores:T.length,q1:k,primerYear:y,ultimoYear:x}}function E(){return T.find(d=>Number(d.id)===Number(e))||T[0]}const f=()=>{const d=E(),w=p(),x=window.innerWidth<768&&!t;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${T.map(k=>Tt(k,Number(k.id)===Number(e))).join("")}
                </aside>
    ...
    `}function Kt(e){const t=e.proyectosAsociados&&e.proyectosAsociados.length>0,a=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function Ht(){const e=new Set(R.map(i=>i.categoria)),t=R.filter(i=>i.proyectosAsociados?.length>0).length,a=R.filter(i=>i.publicacionesClave?.length>0).length;return{total:R.length,categorias:e.size,conProyectos:t,conPublicaciones:a}}function Jt(){let e=R[0]?.id||1;const t=document.createElement("section");t.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=Ut(e),o=Ht();t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function Zt(){let e=J[0]?.id||1;const t=document.createElement("section");t.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=Qt(e);t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,t.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),a()}})};return a(),t}function ea(){return Zt()}function ta(){return`
    ...
    `}function ia(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${aa()}
    `,e}function oa(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",sa)}async function sa(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=ra(i);if(o.length>0){la(o);return}await ca(t,i)}function ra(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?na(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function na(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function la(e){Y(e[0],"error")}function Y(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function ca(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(Y("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):Y("Hubo un problema al enviar el mensaje.","error")}catch{Y("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function da(){const e=ia();return setTimeout(()=>{oa()},0),e}function pa(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
`)}function l(s,g){const C=new Blob(["\uFEFF"+s],{type:"text/csv;charset=utf-8;"}),j=URL.createObjectURL(C),A=document.createElement("a");A.href=j,A.download=g,document.body.appendChild(A),A.click(),A.remove(),window.setTimeout(()=>{URL.revokeObjectURL(j)},1e3)}function m(){h=[],t.value="",k([]),c.disabled=!0,v.disabled=!0,E(),t.focus()}return a.addEventListener("click",()=>{const s=t.value.trim();if(!s){h=[],k([]),c.disabled=!0,v.disabled=!0,p("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:g,errors:b}=w(s);if(b.length>0){h=[],k([]),c.disabled=!0,v.disabled=!0,p(b.join(" "),"error");return}h=g,k(h),c.disabled=!1,v.disabled=!1,p(`Los datos de ${g.length} estudiante${g.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",m),c.addEventListener("click",()=>{if(h.length===0)return;const s=L(h,"grade1AC","1AC");l(s,"Banner_APEC_Primer_Periodo_1AC.csv")}),v.addEventListener("click",()=>{if(h.length===0)return;const s=L(h,"grade2PP","2PP");l(s,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function ua(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
`)}function k(l,m){const s=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),g=URL.createObjectURL(s),b=document.createElement("a");b.href=g,b.download=m,document.body.appendChild(b),b.click(),b.remove(),window.setTimeout(()=>{URL.revokeObjectURL(g)},1e3)}function L(){v=[],t.value="",x([]),c.disabled=!0,o.textContent="",o.classList.add("hidden"),t.focus()}return a.addEventListener("click",()=>{const l=t.value.trim();if(!l){v=[],x([]),c.disabled=!0,d("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:m,errors:s}=w(l);if(s.length>0){v=[],x([]),c.disabled=!0,d(s.join(" "),"error");return}v=m,x(m),c.disabled=!1,d(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",L),c.addEventListener("click",()=>{v.length!==0&&k(y(v),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function ma(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    20"
    ...
    `;const t=e.querySelector("#banner-final-input"),a=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),r=e.querySelector("#banner-final-preview"),n=e.querySelector("#banner-final-count"),c=e.querySelector("#banner-final-download");let v=[];function h(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function p(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function E(l){const m=String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return m.includes("	")?m.split("	").map(s=>s.trim()).filter(s=>s!==""):m.includes(";")?m.split(";").map(s=>s.trim()).filter(s=>s!==""):m.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function f(l){return Number.isInteger(l)?String(l):l.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function u(l){return String(l).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function d(l,m="success"){o.textContent=l,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),m==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(l){const m=l.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),s=[],g=[],b=new Set;return m.forEach((C,j)=>{const A=j+1,D=E(C);if(D.length!==2){g.push(`Línea ${A}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const S=h(D[0]),$=Number(p(D[1]));if(!/^A[0-9]{8}$/.test(S)){g.push(`Línea ${A}: la matrícula "${S}" no es válida. Debe tener el formato A00108671.`);return}if(b.has(S)){g.push(`Línea ${A}: la matrícula ${S} está repetida.`);return}if(!Number.isFinite($)){g.push(`Línea ${A}: la calificación 4EF no es numérica.`);return}if($<0||$>30){g.push(`Línea ${A}: 4EF debe estar entre 0 y 30.`);return}b.add(S),s.push({matricula:S,grade4EF:$})}),{records:s,errors:g}}function x(l){if(l.length===0){r.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
...
`)}function k(l,m){const s=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),g=URL.createObjectURL(s),b=document.createElement("a");b.href=g,b.download=m,document.body.appendChild(b),b.click(),b.remove(),window.setTimeout(()=>{URL.revokeObjectURL(g)},1e3)}function L(){v=[],t.value="",x([]),c.disabled=!0,o.textContent="",o.classList.add("hidden"),t.focus()}return a.addEventListener("click",()=>{const l=t.value.trim();if(!l){v=[],x([]),c.disabled=!0,d("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:m,errors:s}=w(l);if(s.length>0){v=[],x([]),c.disabled=!0,d(s.join(" "),"error");return}v=m,x(m),c.disabled=!1,d(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",L),c.addEventListener("click",()=>{v.length!==0&&k(y(v),"Banner_APEC_Examen_Final_4EF.csv")}),e}function xa(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
        ...
        `}return c.addEventListener("click",()=>{w("xmera")}),v.addEventListener("click",()=>{w("banner")}),w("xmera"),e}function ga(){return ba()}function fa(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
        ...
        <section class="
            ...
            gap-6 mt-10
        ">
            ${te("Aprender","Comprenda qué mide cada estadístico, cuándo debe utilizarse, cuáles son sus supuestos y cómo se interpreta correctamente.","bx-book-open","bg-sky-100","text-sky-700","border-sky-200")}

            ${te("Decidir","Identifique la prueba adecuada según el objetivo, el tipo de variable, el número de grupos y el diseño de su investigación.","bx-brain","bg-amber-100","text-amber-700","border-amber-200")}

            ${te("Analizar","Introduzca sus datos, ejecute el análisis, interprete los resultados y genere reportes metodológicamente adecuados.","bx-bar-chart-square","bg-emerald-100","text-emerald-700","border-emerald-200")}
        </section>
        ...
        <section class="mt-14">
            ...
            ">
                ${N("Estadística descriptiva","Media, mediana, varianza, desviación estándar, cuartiles, asimetría y gráficos.","bx-stats","bg-sky-100","text-sky-700","border-sky-200")}

                ${N("Comparación de grupos","Pruebas t, Welch, Mann–Whitney, Wilcoxon, ANOVA y alternativas no paramétricas.","bx-group","bg-indigo-100","text-indigo-700","border-indigo-200")}

                ${N("Correlación y asociación","Pearson, Spearman, Kendall y medidas de asociación entre variables.","bx-line-chart","bg-violet-100","text-violet-700","border-violet-200")}

                ${N("Cuestionarios y fiabilidad","Alfa de Cronbach, omega de McDonald y análisis de ítems.","bx-list-check","bg-amber-100","text-amber-700","border-amber-200")}

                ${N("Evaluación educativa","Dificultad, discriminación, correlación punto-biserial y análisis de distractores.","bx-edit","bg-emerald-100","text-emerald-700","border-emerald-200")}

                ${N("Tamaño de muestra","Estimación del tamaño mínimo, potencia estadística y pérdidas previstas.","bx-ruler","bg-cyan-100","text-cyan-700","border-cyan-200")}

                ${N("Regresión","Regresión lineal, múltiple y logística con interpretación guiada.","bx-trending-up","bg-rose-100","text-rose-700","border-rose-200")}

                ${N("¿Qué prueba debo utilizar?","Asistente guiado para seleccionar la prueba más adecuada según su diseño.","bx-help-circle","bg-blue-100","text-blue-700","border-blue-200")}

                ${N("Biblioteca metodológica","Definiciones, supuestos, tamaños del efecto, intervalos de confianza y errores frecuentes.","bx-library","bg-slate-200","text-slate-700","border-slate-300")}
            </div>
        </section>
    `,e}function te(e,t,a,i,o,r){return`
        <article class="
            bg-white
            border border-slate-200
            rounded-3xl p-7
    ...
    `}const va={home:{page:Re,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:rt,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:mt,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:vt,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:It,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:qt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:ea,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:Vt,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:da,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:ga,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:fa,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"}};let ce=document.referrer||"";function Z(e){window.location.hash=`/${e}`}function ha(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";ya(t)};window.addEventListener("hashchange",e),e()}function wa(e,t){const a=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:t,page_location:a,page_referrer:ce}),ce=a}function ya(e){const t=document.querySelector("main"),a=va[e];if(t){if(t.innerHTML="",!a){Z("home");return}xt(a.layout),document.title=a.title,t.appendChild(a.page()),window.scrollTo({top:0,behavior:"auto"}),wa(e,a.title)}}function ka(e,t){de(e,Z),ha();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(se(e),i=!0)}a.addEventListener("change",o),o(a),se(e);const r=t.querySelector('[data-action ="open-menu"]');Ee(r,e),Se(e)}const we=document.querySelector("#header");we.innerHTML=ke();const ye=document.querySelector("#navBar");ye.innerHTML=Ae();const Aa=document.querySelector("#footer");Aa.innerHTML=Ce();ka(ye,we);
