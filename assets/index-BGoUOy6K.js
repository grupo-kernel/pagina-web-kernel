(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const B=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function K(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    <div class=" flex items-center gap-4  text-white "> 
        ...
        `}function j(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(t=>{const i=t.querySelector("ul"),o=t.querySelector("i");let n=!i.classList.contains("hidden");t.addEventListener("click",l=>{l.preventDefault(),n?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),n=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),n=!0)})})}function W(e,a){e.addEventListener("click",()=>{a.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function Z(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function X(){return`<div class =" flex justify-center 
            ...
            <!-- Fin tarjeta principal  -->  `}function U(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function _(e){U(e,I)}const $=""+new URL("apec-ConmXkrT.png",import.meta.url).href,ee=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,ae=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,z=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${$}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${ae}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function te(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=z.length,n=1500;let l=0,c=null;function x(h){return(h%o+o)%o}function r(){i.innerHTML=z[l].content}function s(h){l=x(l+h),r()}function f(){p(),c=setInterval(()=>s(1),n)}function p(){c&&(clearInterval(c),c=null)}function u(){f()}r(),f(),a.addEventListener("click",()=>{s(1),u()}),t.addEventListener("click",()=>{s(-1),u()})}function ie(){const e=`
    <div class="absolute bottom-0 col-span-4
            ...
            </div>`,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return te(t.querySelector("#containerFather")),_(t.querySelector("#btnsGroup")),t}function oe(){const e=document.createElement("section");e.classList.add("relative","w-full","flex","flex-col","m-auto","tabletBig:flex-row","md:mb-50","tabletBig:w-7xl","tabletBig:px-20","xl:mb-0","xl:pb-0","xl:w-full","xl:px-0","2xl:w-450","2xl:h-187.5"),e.innerHTML=`${X()}`;const a=document.createElement("div");return a.appendChild(ie()),e.appendChild(a.firstElementChild),e}function ne(){return oe()}const se=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function le(){return`
    <section role="banner" class="relative w-full min-h-screen overflow-hidden">
     
    <!-- Imagen del banner -->
      <img src="${se}" alt="QuienesSomos" class="absolute inset-0 w-full h-full object-cover" loading="lazy"/>
  ...
  `}const ce="data:image/png;base64,",de="data:image/png;base64,",me="data:image/png;base64,",pe="data:image/png;base64,",ue="data:image/png;base64,",xe=[{icon:ce,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:de,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:me,title:"Objetivos",content:`
      ...
      </ul>`},{icon:pe,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `,e}function he(e){e.querySelectorAll("[data-accordion-header]").forEach(t=>{t.addEventListener("click",()=>{const i=t.nextElementSibling,o=t.querySelector("[data-accordion-icon]"),n=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(l=>{l.classList.remove("max-h-[1000px]"),l.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(l=>{l.classList.remove("rotate-180")}),n||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function ve(e){const a=e.querySelector("[data-description-text]"),t=e.querySelector("[data-description-btn]");if(!a||!t)return;let i=!1;t.addEventListener("click",()=>{i=!i,a.classList.toggle("line-clamp-4",!i),t.textContent=i?"Leer menos":"Leer más"})}function we(){const e=be();return he(e),ve(e),e}function ye(e){const a=document.createElement("div");a.className="flex bg-white border rounded-xl shadow-2xl border-black w-89.5 h-139 flex-col items-center text-center justify-between p-4 gap-4 transition-all hover:scale-[1.02]";const t=e.redes.map(i=>`
    ...
    `,a}const C=""+new URL("sep-BCMURSaM.png",import.meta.url).href,E=""+new URL("nat-CaDYa76I.png",import.meta.url).href,N=""+new URL("rad-B3ff1btG.png",import.meta.url).href,D=""+new URL("ant-D2J2W27b.png",import.meta.url).href,T=""+new URL("mar-Cru0HERG.png",import.meta.url).href,M=""+new URL("marc-D-jKwb4F.png",import.meta.url).href,y=""+new URL("jos-BToFZdIf.png",import.meta.url).href,k=[{img:C,title:"Miguel A. Miguel A. Leonardo Sepúlveda, Ph.D",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente.",afilaciones:" ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&amp;hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con enfoque en métodos numéricos avanzados. Asesor de tesis de posgrado y pregrado. Diseñador y rediseñador de programas curriculares universitarios. Investigador en métodos libres de Jacobiano, análisis numérico y formación de docentes."},{img:E,title:"Natanael Ureña Castillo, M.Sc",subtitle:"Optimización, entrenamiento de redes neuronales, formación docente",areas:"Métodos iterativos, optimización, redes neuronales, ciencias actuariales, matemática computacional, formación docente.",afilaciones:" ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Especialista en métodos iterativos, optimización y redes neuronales aplicadas a problemas complejos y riesgos. Docente universitario y asesor en proyectos de investigación matemática."},{img:N,title:"Randy Leonardo, M.Sc",subtitle:"Álgebra Lineal, Matrices combinadas, Educación Matemática",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa..",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador en álgebra y docencia, co-investigador de proyectos de matrices combinadas. Ponente en congresos nacionales."},{img:D,title:"Antmel Rodríguez Cabral, Ph.D",subtitle:"Especialista en dinámica compleja y dinámica real de métodos iterativos para sistemas no lineales",rec:"Recientemente defendió su tesis doctoral (Doctor en Matemática).",areas:" EDPs, sistemas no lineales, planos/dinámicas compleja y real, análisis complejo, educación matemática.",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Profesor universitario e investigador en métodos numéricos, EDPs y planos dinámicos; ponente en congresos internacionales."},{img:T,title:"Marino Brito Guillén, M.Sc",subtitle:"Gestión universitaria, Matemática Educativa, Educación",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente.",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Ex-vicerrector académico, profesor universitario y consultor educativo. Experto en desarrollo curricular y formación docente."},{img:M,title:"Marc-Kelly Jean Philippe Jean, Ph.D",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",areas:"Álgebra, matemática pura, educación matemática, recursos educativos.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?hl=es&amp;user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Profesor adjunto, asesor y conferencista en álgebra, con experiencia en investigación y divulgación científica internacional."},{img:y,title:"José Alberto Reyes Reyes, M.Sc",subtitle:"Métodos Iterativos, Educación Matemática",areas:"Matemática pura, métodos iterativos, análisis de estabilidad, innovación educativa.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Docente universitario y de postgrado. Investigador en métodos numéricos y asesor de tesis en análisis de estabilidad y convergencia."}];function Ae(){let e=0,a;const t=document.createElement("div");t.className="relative flex flex-col gap-7 w-full items-center";const i=()=>window.innerWidth>=1024?3:window.innerWidth>=768?2:1,o=()=>{const r=i();e+r>=k.length?e=0:e++,x()},n=()=>{const r=i();e<=0?e=k.length-r:e--,x()},l=()=>{c(),a=setInterval(o,3500)},c=()=>{a&&clearInterval(a)},x=()=>{const r=i();t.innerHTML=`
        ...
        `;const s=t.querySelector("#cards-wrapper");k.slice(e,e+r).forEach(p=>{s.appendChild(ye(p))}),t.querySelector("#prev-btn").onclick=()=>{n(),l()},t.querySelector("#next-btn").onclick=()=>{o(),l()}};return document.addEventListener("visibilitychange",()=>{document.hidden?c():l()}),window.addEventListener("resize",()=>{e=0,x()}),x(),l(),t}function Ce(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&I(t.dataset.route)})}function q(){const e=window.location.hash.replace("#/","")||"equipment",a=document.createElement("div"),t="bg-sky-800 text-white border-b-sky-800",i="bg-transparent text-black hover:bg-gray-50";return a.innerHTML=`
    ...
    </nav>`,Ce(a.firstElementChild),a.firstElementChild}function Ee(){const e=document.createElement("section");e.classList.add("flex","flex-col","gap-5","m-auto","p-4","max-w-7xl","tabletBig:w-7xl","xl:w-full"),e.appendChild(q());const a=Ae();return e.appendChild(a),e}function Me(){return Ee()}function ke(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function Se(e,a=!1){return`
        <div data-id="${e.id}" 
             class="flex items-center gap-4 p-3 rounded-xl cursor-pointer transition-all 
             ${a?"bg-sky-500 text-white shadow-lg scale-105":"bg-white hover:bg-sky-100 border border-gray-200"}">
    ...
    `}function De(e){const a=e.formacion.map(i=>`
        <div class="mb-4">
    ...
    `).join(""),t=e.experiencia?e.experiencia.map(i=>`
    ...
    `}function Be({id:e,title:a,date:t,image:i,excerpt:o}){return`
  ...
  `}function Ne(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ${Pe()}
    ${Ue(F)}
    ${$e()}
    
    `,e}function Te({title:e,content:a,articleURL:t}){const i=a.paragraphs.map(l=>`<p>${l}<p>`).join(""),o=a.list.length?` 
    ...
    `}function We(e){if(!e)return`
        ...
        `;const a=G(e),t=Qe(e),i=t.length,o=t.map(s=>Number(s.year)).filter(Boolean),n=o.length?Math.min(...o):"",l=o.length?Math.max(...o):"",c=[...new Set(t.map(s=>s.q).filter(Boolean))],x=[...new Set(t.map(s=>O(s)).filter(Boolean))],r=t.map(s=>{const f=O(s),p=J(s),u=Ke(s);return`
    ...
    `}function Ze(){let e=v[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(r){const s=String(r.DOI||r.doi||"").trim().toLowerCase();return s||`${r.year||""}-${r.title||r.tile||""}-${r.contenido||""}`.trim().toLowerCase()}function n(){const r=new Map;return v.forEach(s=>{(s.publicaciones||[]).forEach(f=>{const p=o(f);r.has(p)||r.set(p,f)})}),Array.from(r.values())}function l(){const r=n(),s=r.map(h=>Number(h.year)).filter(Boolean),f=s.length?Math.max(...s):"—",p=s.length?Math.min(...s):"—",u=r.filter(h=>h.q==="Q1").length;return{totalPublicaciones:r.length,investigadores:v.length,q1:u,primerYear:p,ultimoYear:f}}const c=()=>{const r=v.find(u=>u.id===e)||v[0],s=l(),f=window.innerWidth<768&&!a;i.innerHTML=`
    ...
    `).join("")}function ea(e=[]){return e.map(a=>`
    ...
    `}function ia(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function oa(){const e=new Set(b.map(i=>i.categoria)),a=b.filter(i=>i.proyectosAsociados?.length>0).length,t=b.filter(i=>i.publicacionesClave?.length>0).length;return{total:b.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function na(){let e=b[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=_e(e),o=oa();a.innerHTML=`
            <div class="mb-8">
    ...
    `).join("")}function ca(e=[]){return e.map(a=>`
        <span class="inline-flex items-center bg-white/10 text-white border border-white/10 px-3 py-1 rounded-full text-xs font-semibold">
            ${d(a)}
        </span>
    ...
    `}function pa(){let e=w[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=la(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function ua(){return pa()}function xa(){return`
    ...
    `}function fa(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${ga()}
    `,e}function ba(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",ha)}async function ha(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=va(i);if(o.length>0){ya(o);return}await Aa(a,i)}function va(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?wa(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function wa(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function ya(e){A(e[0],"error")}function A(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Aa(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(A("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):A("Hubo un problema al enviar el mensaje.","error")}catch{A("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Ca(){const e=fa();return setTimeout(()=>{ba()},0),e}const Ea={home:{page:ne,layout:"default"},quienesSomos:{page:we,layout:"full"},equipment:{page:Me,layout:"default"},FormacionAcademica:{page:Ie,layout:"default"},noticias:{page:He,layout:"full"},publicaciones:{page:Xe,layout:"default"},proyectos:{page:ua,layout:"default"},lineas:{page:sa,layout:"default"},contacto:{page:Ca,layout:"default"}};function I(e){window.location.hash=`/${e}`}function Ma(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";ka(a)};window.addEventListener("hashchange",e),e()}function ka(e){const a=document.querySelector("main"),t=Ea[e];a&&(a.innerHTML="",t&&(ke(t.layout),a.appendChild(t.page())))}function Sa(e,a){U(e,I),Ma();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(l){l.matches&&!i&&(j(e),i=!0)}t.addEventListener("change",o),o(t),j(e);const n=a.querySelector('[data-action ="open-menu"]');W(n,e),Z(e)}const V=document.querySelector("#header");V.innerHTML=K();const H=document.querySelector("#navBar");H.innerHTML=Q();const Da=document.querySelector("#footer");Da.innerHTML=Y();Sa(H,V);
