import{j as Q,a as Z}from"./jstat-DiDocX-r.js";const M=Q.jStat??Z?.jStat;if(!M)throw new Error("No fue posible cargar el motor estadístico jStat.");const z=e=>Math.min(1,Math.max(0,e));function G(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function _(e){return typeof e=="string"?e.trim()===""?Number.NaN:Number(e.trim().replace(",",".")):Number(e)}const D=e=>e.reduce((t,a)=>t+a,0)/e.length;function U(e){const t=[...e].sort((o,r)=>o-r),a=Math.floor(t.length/2);return t.length%2?t[a]:(t[a-1]+t[a])/2}function J(e,t=D(e)){return e.reduce((a,o)=>a+(o-t)**2,0)/(e.length-1)}function X(e){const t=D(e),a=J(e,t);return{n:e.length,media:t,mediana:U(e),varianza:a,desviacionEstandar:Math.sqrt(a),minimo:Math.min(...e),maximo:Math.max(...e)}}function Y(e,t){const a=Array.isArray(e),o=a?e:e?.valores;if(!Array.isArray(o))throw new TypeError(`El grupo ${t+1} debe contener un arreglo llamado valores.`);const r=o.map(_),n=r.findIndex(l=>!Number.isFinite(l));if(n!==-1)throw new TypeError(`El grupo ${t+1} contiene un valor no numérico en la posición ${n+1}.`);if(r.length<2)throw new RangeError(`El grupo ${t+1} debe contener al menos dos observaciones.`);return{nombre:(a?"":String(e?.nombre??"").trim())||`Grupo ${t+1}`,valores:r,...X(r)}}function P(e){if(!Array.isArray(e))throw new TypeError("Los grupos deben proporcionarse mediante un arreglo.");if(e.length<3)throw new RangeError("El análisis requiere al menos tres grupos independientes.");const t=e.map(Y),a=t.map(({nombre:o})=>o);if(new Set(a).size!==a.length)throw new Error("Cada grupo debe tener un nombre diferente.");return t}function S(e){const t=e.reduce((o,r)=>o+r.n,0),a=e.reduce((o,r)=>o+r.valores.reduce((n,s)=>n+s,0),0);return{numeroGrupos:e.length,nTotal:t,mediaGeneral:a/t}}function H(e,t,a){return e===1/0?0:z(1-M.centralF.cdf(e,t,a))}function ee(e,t){return z(1-M.chisquare.cdf(e,t))}function F(){if(!M.tukey?.cdf||!M.tukey?.inv)throw new Error("La distribución de Tukey no está disponible en la versión instalada de jStat.")}function I(e,t,a){return F(),e===1/0?0:z(1-M.tukey.cdf(e,t,a))}function R(e,t,a){return F(),M.tukey.inv(e,t,a)}function q(e){const t=Math.abs(e);return t<.01?"Prácticamente nulo":t<.06?"Pequeño":t<.14?"Moderado":"Grande"}function V(e,t){const a=[];for(let o=0;o<e.length-1;o+=1)for(let r=o+1;r<e.length;r+=1)a.push(t(e[o],e[r],o,r));return a}function te(e,t,a,o){const r=1-o,n=e.length,s=R(o,n,a);return{id:"tukey-kramer",nombre:"Comparaciones de Tukey–Kramer",metodo:"Rango studentizado con control del error familiar.",recomendado:!1,comparaciones:V(e,(l,i)=>{const c=l.media-i.media,d=Math.sqrt(t/2*(1/l.n+1/i.n)),u=d===0?c===0?0:1/0:Math.abs(c)/d,m=I(u,n,a),b=s*d;return{grupo1:l.nombre,grupo2:i.nombre,diferenciaMedias:c,errorEstandar:d,estadisticoQ:u,gradosLibertad:a,valorP:m,valorPAjustado:m,intervaloConfianza:{nivel:o,inferior:c-b,superior:c+b,margen:b},significativo:m<r}})}}function ae(e,t){const a=1-t,o=e.length;return{id:"games-howell",nombre:"Comparaciones de Games–Howell",metodo:"Comparaciones pareadas robustas ante varianzas y tamaños desiguales.",recomendado:!1,comparaciones:V(e,(r,n)=>{const s=r.media-n.media,l=r.varianza/r.n,i=n.varianza/n.n,c=l+i,d=Math.sqrt(c/2),u=c**2/(l**2/(r.n-1)+i**2/(n.n-1)),m=d===0?s===0?0:1/0:Math.abs(s)/d,b=I(m,o,u),g=R(t,o,u)*d;return{grupo1:r.nombre,grupo2:n.nombre,diferenciaMedias:s,errorEstandar:d,estadisticoQ:m,gradosLibertad:u,valorP:b,valorPAjustado:b,intervaloConfianza:{nivel:t,inferior:s-g,superior:s+g,margen:g},significativo:b<a}})}}function oe(e){const t=e.map(n=>({...n,rango:0})).sort((n,s)=>n.valor-s.valor);let a=0,o=0,r=0;for(;a<t.length;){let n=a+1;for(;n<t.length&&t[n].valor===t[a].valor;)n+=1;const s=n-a,l=(a+1+n)/2;for(let i=a;i<n;i+=1)t[i].rango=l;s>1&&(r+=1,o+=s**3-s),a=n}return{observaciones:t,sumaCorreccionEmpates:o,cantidadGruposEmpatados:r}}function re(e){const t=e.map((o,r)=>({...o,indiceOriginal:r})).sort((o,r)=>o.valorP-r.valorP);let a=0;return t.forEach((o,r)=>{const n=Math.min(1,o.valorP*(t.length-r));o.valorPAjustado=Math.max(a,n),a=o.valorPAjustado}),t.sort((o,r)=>o.indiceOriginal-r.indiceOriginal).map(({indiceOriginal:o,...r})=>r)}function ne(e,t,a,o,r){const n=1-r,s=a*(a+1)/12-o/(12*(a-1)),l=V(e,(i,c,d,u)=>{const m=t[d]/i.n,b=t[u]/c.n,g=m-b,v=Math.sqrt(s*(1/i.n+1/c.n)),w=v===0?0:g/v,k=z(2*(1-M.normal.cdf(Math.abs(w),0,1)));return{grupo1:i.nombre,grupo2:c.nombre,rangoMedio1:m,rangoMedio2:b,diferenciaRangos:g,errorEstandar:v,estadisticoZ:w,valorP:k,tamanioEfectoR:w/Math.sqrt(a)}});return{id:"dunn-holm",nombre:"Comparaciones de Dunn con ajuste de Holm",metodo:"Comparaciones de rangos con corrección secuencial de Holm.",recomendado:!1,comparaciones:re(l).map(i=>({...i,significativo:i.valorPAjustado<n}))}}function se(e,t={}){const{nivelConfianza:a=.95}=t;G(a);const o=P(e),r=S(o),n=o.reduce(($,f)=>$+f.n*(f.media-r.mediaGeneral)**2,0),s=o.reduce(($,f)=>$+f.valores.reduce((y,B)=>y+(B-f.media)**2,0),0),l=n+s,i=o.length-1,c=r.nTotal-o.length,d=n/i,u=s/c,m=u===0?d===0?0:1/0:d/u,b=H(m,i,c),g=l===0?0:n/l,v=l+u===0?0:(n-i*u)/(l+u),w=Math.max(0,v),k=1-a,x=b<k,h=te(o,u,c,a);return h.recomendado=x,{id:"anova-un-factor",nombre:"ANOVA de un factor",metodo:"ANOVA clásico para tres o más grupos independientes con varianzas homogéneas.",grupos:o,...r,estadistico:{simbolo:"F",valor:m},gradosLibertad:{numerador:i,denominador:c},valorP:b,nivelConfianza:a,alfa:k,significativo:x,tablaAnova:{entreGrupos:{sumaCuadrados:n,gradosLibertad:i,cuadradoMedio:d},dentroGrupos:{sumaCuadrados:s,gradosLibertad:c,cuadradoMedio:u},total:{sumaCuadrados:l,gradosLibertad:r.nTotal-1}},tamanioEfecto:{etaCuadrado:g,omegaCuadrado:w,interpretacion:q(w)},postHoc:h}}function ie(e,t={}){const{nivelConfianza:a=.95}=t;G(a);const o=P(e),r=S(o),n=o.find(({varianza:f})=>f<=0);if(n)throw new Error(`El ANOVA de Welch requiere varianza positiva en cada grupo. Revise ${n.nombre}.`);const s=o.map(f=>({...f,peso:f.n/f.varianza})),l=s.reduce((f,y)=>f+y.peso,0),i=s.reduce((f,y)=>f+y.peso*y.media,0)/l,c=o.length,d=c-1,u=s.reduce((f,y)=>f+y.peso*(y.media-i)**2,0)/d,m=s.reduce((f,y)=>f+(1-y.peso/l)**2/(y.n-1),0),b=1+2*(c-2)/(c**2-1)*m,g=u/b,v=(c**2-1)/(3*m),w=H(g,d,v),k=Math.max(0,d*(g-1)/(d*g+v+1)),x=1-a,h=w<x,$=ae(o,a);return $.recomendado=h,{id:"anova-welch",nombre:"ANOVA de Welch",metodo:"ANOVA robusto para tres o más grupos independientes sin exigir igualdad de varianzas.",grupos:o,...r,mediaPonderada:i,sumaPesos:l,estadistico:{simbolo:"F_W",valor:g},gradosLibertad:{numerador:d,denominador:v},valorP:w,nivelConfianza:a,alfa:x,significativo:h,componentesWelch:{numeradorBase:u,terminoCorreccion:m,denominadorCorreccion:b},tamanioEfecto:{omegaCuadradoAproximado:k,interpretacion:q(k),nota:"Estimación aproximada basada en el estadístico F de Welch y sus grados de libertad."},postHoc:$}}function le(e,t={}){const{nivelConfianza:a=.95}=t;G(a);const o=P(e),r=S(o),n=o.flatMap((x,h)=>x.valores.map($=>({valor:$,indiceGrupo:h}))),s=oe(n),l=new Array(o.length).fill(0);s.observaciones.forEach(({indiceGrupo:x,rango:h})=>{l[x]+=h});const i=12/(r.nTotal*(r.nTotal+1))*o.reduce((x,h,$)=>x+l[$]**2/h.n,0)-3*(r.nTotal+1),c=1-s.sumaCorreccionEmpates/(r.nTotal**3-r.nTotal),d=c<=0?0:i/c,u=o.length-1,m=ee(d,u),b=Math.max(0,(d-o.length+1)/(r.nTotal-o.length)),g=1-a,v=m<g,w=o.map((x,h)=>({...x,sumaRangos:l[h],rangoMedio:l[h]/x.n})),k=ne(o,l,r.nTotal,s.sumaCorreccionEmpates,a);return k.recomendado=v,{id:"kruskal-wallis",nombre:"Prueba de Kruskal–Wallis",metodo:"Comparación no paramétrica de tres o más grupos independientes mediante rangos.",grupos:w,...r,estadistico:{simbolo:"H",valor:d,sinCorreccion:i},gradosLibertad:{valor:u},valorP:m,nivelConfianza:a,alfa:g,significativo:v,empates:{factorCorreccion:c,sumaCorreccion:s.sumaCorreccionEmpates,cantidadGruposEmpatados:s.cantidadGruposEmpatados},tamanioEfecto:{epsilonCuadrado:b,interpretacion:q(b)},postHoc:k}}function ce({grupos:e,prueba:t,nivelConfianza:a=.95}){switch(t){case"anova-un-factor":case"anova":return se(e,{nivelConfianza:a});case"anova-welch":case"welch":return ie(e,{nivelConfianza:a});case"kruskal-wallis":return le(e,{nivelConfianza:a});default:throw new Error("La prueba solicitada no está disponible.")}}function we(){const e=document.createElement("section");e.className=`
...
88`}];[...t.querySelectorAll("[data-grupo]")].forEach((o,r)=>{o.querySelector("[data-nombre-grupo]").value=a[r].nombre,o.querySelector("[data-valores-grupo]").value=a[r].valores,W(o)}),e.elements.prueba.value||(e.elements.prueba.value="anova-un-factor")}function O(e,t){e.textContent=t,e.classList.remove("hidden")}function j(e){e.textContent="",e.classList.add("hidden")}function C(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function p(e,t=4){return e===1/0?"∞":Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:t}).format(e):"—"}function K(e){return Number.isFinite(e)?e<.001?"< 0.001":p(e,4):"—"}function be(e){const t=e.alfa.toFixed(2),a=Math.round(e.nivelConfianza*100),o=e.significativo?`Se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${t}, correspondiente a un nivel de confianza del ${a} %.`:`No se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${t}, correspondiente a un nivel de confianza del ${a} %.`;return`
        <section class="rounded-3xl border border-indigo-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                    ${T(e.estadistico.simbolo,p(e.estadistico.valor),"Estadístico global")}
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ${e.grupos.map(a=>`
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-right">${p(a.media)}</td>
                                        <td class="px-4 py-4 text-right">${p(a.mediana)}</td>
                                        <td class="px-4 py-4 text-right">${p(a.desviacionEstandar)}</td>
                                        <td class="px-4 py-4 text-right">${p(a.varianza)}</td>
                                        <td class="px-4 py-4 text-right">${p(a.minimo)}</td>
                                        <td class="px-4 py-4 text-right">${p(a.maximo)}</td>
                                        ${t?`<td class="px-4 py-4 text-right">${p(a.rangoMedio)}</td>`:""}
                                    </tr>
                                `).join("")}
                    </tbody>
                </table>
        ...
        `}return e.id==="anova-welch"?`
            <article class="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-6">
                ...
                <dl class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ${E("gl del numerador",p(e.gradosLibertad.numerador))}
                    ${E("gl del denominador",p(e.gradosLibertad.denominador))}
                    ${E("Media ponderada",p(e.mediaPonderada))}
                    ${E("Factor de corrección",p(e.componentesWelch.denominadorCorreccion))}
                </dl>
            </article>
        `:`
        <article class="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-6">
            ...
            <dl class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ${E("Grados de libertad",p(e.gradosLibertad.valor))}
                ${E("H sin corrección",p(e.estadistico.sinCorreccion))}
                ${E("Factor por empates",p(e.empates.factorCorreccion))}
    ...
    `:""}function ve(e){const t=e.diferenciaMedias??e.diferenciaRangos,a=e.estadisticoQ??e.estadisticoZ,o=e.valorPAjustado??e.valorP,r=e.intervaloConfianza?`${p(e.intervaloConfianza.inferior)} a ${p(e.intervaloConfianza.superior)}`:"—";return`
        <tr>
            <th scope="row" class="px-5 py-4 text-left font-bold text-slate-900">
