export function CreateHome() {
        const wrapper  = `<section class="relative flex flex-col   " >
            ...
            <div class="absolute bottom-0 col-span-4 left-0 bg-footer-primary z-10 translate-y-1/2 w-89.5 h-47.5  rounded-2xl " >
                    <div class="justify-center flex flex-col items-center " >
                        ...
                        <div>
                            <div id="1" class="relative w-full h-full">
                                <img id="img1" src="./assets/ITLA.jpg" alt="Itla" title="Instituto Tecnológico de Las Américas ITLA" class="w-70.5 h-32.5 rounded-3xl object-cover">
                            </div>
                    </div>
 
                    </div>
                    <div class=" flex justify-center mt-8.5 items-center gap-10.75  " >
                        <span class=" bg-widgets-bg rounded-full flex justify-center items-center w-15 h-15 p-2  " >
