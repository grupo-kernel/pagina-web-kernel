(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const te=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function ye(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function Ae(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${te}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function ce(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function Pe(e){ce(e,Z)}const de=""+new URL("apec-ConmXkrT.png",import.meta.url).href,je=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,$e=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,se=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${de}" alt="UNAPEC" title="UNAPEC" 
        ...
        </div>`}];function Ie(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=se.length,n=1500;let r=0,c=null;function v(d){return(d%o+o)%o}function h(){i.innerHTML=se[r].content}function p(d){r=v(r+d),h()}function E(){f(),c=setInterval(()=>p(1),n)}function f(){c&&(clearInterval(c),c=null)}function u(){E()}h(),E(),t.addEventListener("click",()=>{p(1),u()}),a.addEventListener("click",()=>{p(-1),u()})}function ze(){const e=`
        <section class="
    ...
    `,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return Ie(a.querySelector("#containerFather")),Pe(a.querySelector("#btnsGroup")),a}const Fe="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function Te(){try{const e=await fetch(Fe,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const t=await e.json();if(!t.ok||!t.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(t.visitantes.total)||0,hoy:Number(t.visitantes.hoy)||0,ultimos7Dias:Number(t.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(t.visitantes.ultimos30Dias)||0,actualizadoEn:t.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function Q(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function Be(e){if(!e)return null;const t=new Date(e);return Number.isNaN(t.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(t)}async function Ne(e){const t=e.querySelector("#analytics-total"),a=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!t||!a||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const r=await Te();t.textContent=Q(r.total),a.textContent=Q(r.hoy),i.textContent=Q(r.ultimos7Dias),o.textContent=Q(r.ultimos30Dias);const c=Be(r.actualizadoEn);n.textContent=c?`Actualizado: ${c}`:"Estadísticas temporalmente no disponibles"}catch(r){console.error("Error al mostrar las estadísticas en la portada:",r),t.textContent="—",a.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function qe(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=De();const t=ze();return e.appendChild(t),Ne(e),e}function Ue(){return qe()}const Re=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Oe(){return`
        <section 
            role="banner" 
    ...
    `}const Qe="data:image/png;base64,",Ye="data:image/png;base64,",We="data:image/png;base64,",Xe="data:image/png;base64,",_e="data:image/png;base64,",Ze=[{icon:Qe,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:Ye,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:We,title:"Objetivos",content:`
      ...
      </ul>`},{icon:Xe,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function tt({icon:e,title:t,content:a}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${_e}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function at(){const e=document.createElement("section");return e.className=`
    ...
    `,e.innerHTML=`
        ...
        ${Ve()}
        ${et()}
    `,e}function it(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),n=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(r=>{r.classList.remove("max-h-[1000px]"),r.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(r=>{r.classList.remove("rotate-180")}),n||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function ot(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function st(){const e=at();return it(e),ot(e),e}function F(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function rt(e=[]){return!e||e.length===0?`
    ...
    `).join("")}function nt(e){return e?String(e).split(",").map(a=>a.trim()).filter(Boolean).slice(0,4).map(a=>`
    ...
    `).join(""):""}function lt(e){const t=document.createElement("article");t.className=`
    ...
    `;const a=rt(e.redes||[]),i=nt(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return t.innerHTML=`
    ...
    `,t}const pe=""+new URL("rad-B3ff1btG.png",import.meta.url).href,ue=""+new URL("mar-Cru0HERG.png",import.meta.url).href,G=[{img:W,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:_,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:pe,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:ae,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:ue,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:X,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:V,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function ct(){let e=0,t=null,a=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const u=o();return Math.max(G.length-u,0)},r=()=>{const u=n();e>u&&(e=0),e<0&&(e=u)},c=()=>{const u=n();e>=u?e=0:e++,f()},v=()=>{const u=n();e<=0?e=u:e--,f()},h=()=>{p(),G.length>o()&&(t=setInterval(c,4500))},p=()=>{t&&(clearInterval(t),t=null)},E=()=>{const u=o(),d=Math.max(G.length-u+1,1);return Array.from({length:d}).map((w,x)=>`
        ...
        `).join("")},f=()=>{if(!G||G.length===0){i.innerHTML=`
            ...
            `;return}r();const u=o(),d=G.slice(e,e+u);i.innerHTML=`
        ...
        `;const w=i.querySelector("#cards-wrapper");d.forEach(k=>{w.appendChild(lt(k))});const x=i.querySelector("#prev-btn"),y=i.querySelector("#next-btn");x&&(x.onclick=()=>{v(),h()}),y&&(y.onclick=()=>{c(),h()}),i.querySelectorAll("[data-dot-index]").forEach(k=>{k.onclick=()=>{e=parseInt(k.dataset.dotIndex),f(),h()}})};return i.addEventListener("mouseenter",p),i.addEventListener("mouseleave",h),document.addEventListener("visibilitychange",()=>{document.hidden?p():h()}),window.addEventListener("resize",()=>{clearTimeout(a),a=setTimeout(()=>{e=0,f(),h()},150)}),f(),h(),i}function dt(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-route]");if(!a)return;const i=window.location.hash.replace("#/","")||"equipment";a.dataset.route!==i&&Z(a.dataset.route)})}function me(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",t=document.createElement("nav"),a="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return t.className="w-full flex justify-center mb-6",t.innerHTML=`
    ...
    `,dt(t),t}function pt(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=document.createElement("div");t.className="mb-6",t.appendChild(me());const a=ct();return e.appendChild(t),e.appendChild(a),e}function ut(){return pt()}function mt(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function z(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function xe(e){return e.formacion?.length||0}function be(e){return e.experiencia?.length||0}function xt(e,t=!1){const a=xe(e),i=be(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function bt(e){const t=e.formacion||[],a=e.experiencia||[],i=t.length?t.map(c=>`
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ct({id:e,title:t,date:a,image:i,imageAlt:o,excerpt:n,category:r="Noticia",imageFit:c="contain"}){const v=c==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
    ...
    `}function St(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),t=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function Mt(e=[]){return[...e].sort((t,a)=>t.featured&&!a.featured?-1:!t.featured&&a.featured?1:0)}function Lt(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const t=Mt(ge),a=t.find(i=>i.featured)||t[0];return e.innerHTML=`
        ${At(a)}
        ${Et(t)}
        ${St()}
    `,e}function Dt({title:e,content:t={paragraphs:[],list:[]},articleURL:a}){const i=(t.paragraphs||[]).map(r=>`<p>${r}</p>`).join(""),o=(t.list||[]).length?`
    ...
    `}function Pt(e){e&&e.addEventListener("click",t=>{const a=t.target.closest("[data-news-btn], [data-news-card]");if(!a||!e.contains(a))return;const i=a.dataset.newsBtn||a.dataset.newsCard,o=ge.find(n=>String(n.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}jt(o)})}function jt(e){const t=document.querySelector("#newsModal");t&&t.remove();const a=document.createElement("div");a.innerHTML=Dt(e);const i=a.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",n)}function n(r){r.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(r=>{r.addEventListener("click",o)}),i.addEventListener("click",r=>{r.target===i&&o()}),document.addEventListener("keydown",n)}function $t(){const e=Lt();return Pt(e),e}function P(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function fe(e){return e?.name||e?.title||"Investigador"}function re(e){return e?.title||e?.tile||"Revista no especificada"}function ve(e){return String(e?.DOI||e?.doi||"").trim()}function It(e){const t=ve(e);return e?.url?e.url:t?t.startsWith("http")?t:`https://doi.org/${t}`:"#"}function zt(e){return[...e?.publicaciones||[]].sort((t,a)=>{const i=Number(t.year||0),o=Number(a.year||0);return i!==o?o-i:String(t.contenido||"").localeCompare(String(a.contenido||""))})}function Ft(e,t=!1){const a=fe(e),i=e.publicaciones||[],o=i.length,n=i.map(c=>Number(c.year)).filter(Boolean),r=n.length?Math.max(...n):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${t?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function Tt(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const t=fe(e),a=zt(e),i=a.length,o=a.map(p=>Number(p.year)).filter(Boolean),n=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",c=[...new Set(a.map(p=>p.q).filter(Boolean))],v=[...new Set(a.map(p=>re(p)).filter(Boolean))],h=a.map(p=>{const E=re(p),f=ve(p),u=It(p);return`
    ...
    `}function Bt(){let e=T[0]?.id||1,t=!1,a=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(d){return String(d?.DOI||d?.doi||"").trim().toLowerCase()}function n(d){return String(d?.journal||d?.title||d?.tile||"").trim()}function r(d){return String(d?.articleTitle||d?.contenido||"").trim()}function c(d){return String(d?.q||d?.quartile||"").trim().toUpperCase()}function v(d){const w=o(d);return w||[d?.year||"",n(d),r(d)].join("-").trim().toLowerCase()}function h(){const d=new Map;return T.forEach(w=>{(w.publicaciones||[]).forEach(x=>{const y=v(x);y&&!d.has(y)&&d.set(y,x)})}),Array.from(d.values())}function p(){const d=h(),w=d.map(L=>Number(L.year)).filter(Boolean),x=w.length?Math.max(...w):"—",y=w.length?Math.min(...w):"—",k=d.filter(L=>c(L)==="Q1").length;return{totalPublicaciones:d.length,investigadores:T.length,q1:k,primerYear:y,ultimoYear:x}}function E(){return T.find(d=>Number(d.id)===Number(e))||T[0]}const f=()=>{const d=E(),w=p(),x=window.innerWidth<768&&!t;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${T.map(k=>Ft(k,Number(k.id)===Number(e))).join("")}
                </aside>
    ...
    `}function Gt(e){const t=e.proyectosAsociados&&e.proyectosAsociados.length>0,a=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function Kt(){const e=new Set(R.map(i=>i.categoria)),t=R.filter(i=>i.proyectosAsociados?.length>0).length,a=R.filter(i=>i.publicacionesClave?.length>0).length;return{total:R.length,categorias:e.size,conProyectos:t,conPublicaciones:a}}function Ht(){let e=R[0]?.id||1;const t=document.createElement("section");t.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=qt(e),o=Kt();t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function _t(){let e=J[0]?.id||1;const t=document.createElement("section");t.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=Vt(e);t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,t.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),a()}})};return a(),t}function Zt(){return _t()}function ea(){return`
    ...
    `}function aa(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${ta()}
    `,e}function ia(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",oa)}async function oa(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=sa(i);if(o.length>0){na(o);return}await la(t,i)}function sa(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?ra(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function ra(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function na(e){Y(e[0],"error")}function Y(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function la(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(Y("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):Y("Hubo un problema al enviar el mensaje.","error")}catch{Y("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function ca(){const e=aa();return setTimeout(()=>{ia()},0),e}function da(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
`)}function k(l,m){const s=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),g=URL.createObjectURL(s),b=document.createElement("a");b.href=g,b.download=m,document.body.appendChild(b),b.click(),b.remove(),window.setTimeout(()=>{URL.revokeObjectURL(g)},1e3)}function L(){v=[],t.value="",x([]),c.disabled=!0,o.textContent="",o.classList.add("hidden"),t.focus()}return a.addEventListener("click",()=>{const l=t.value.trim();if(!l){v=[],x([]),c.disabled=!0,d("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:m,errors:s}=w(l);if(s.length>0){v=[],x([]),c.disabled=!0,d(s.join(" "),"error");return}v=m,x(m),c.disabled=!1,d(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",L),c.addEventListener("click",()=>{v.length!==0&&k(y(v),"Banner_APEC_Examen_Final_4EF.csv")}),e}function ma(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
        ...
        `}return c.addEventListener("click",()=>{w("xmera")}),v.addEventListener("click",()=>{w("banner")}),w("xmera"),e}function ba(){return xa()}function ga(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
        ...
        <section class="mt-14">
            ...
            ">
                ${N("Estadística descriptiva","Media, mediana, varianza, desviación estándar, cuartiles, asimetría y gráficos.","bx-data")}

                ${N("Comparación de grupos","Pruebas t, Welch, Mann–Whitney, Wilcoxon, ANOVA y alternativas no paramétricas.","bx-group")}

                ${N("Correlación y asociación","Pearson, Spearman, Kendall y medidas de asociación entre variables.","bx-scatter-chart")}

                ${N("Cuestionarios y fiabilidad","Alfa de Cronbach, omega de McDonald y análisis de ítems.","bx-list-check")}

                ${N("Evaluación educativa","Dificultad, discriminación, correlación punto-biserial y análisis de distractores.","bx-edit")}

                ${N("Tamaño de muestra","Estimación del tamaño mínimo, potencia estadística y pérdidas previstas.","bx-ruler")}

                ${N("Regresión","Regresión lineal, múltiple y logística con interpretación guiada.","bx-trending-up")}

                ${N("¿Qué prueba debo utilizar?","Asistente guiado para seleccionar la prueba más adecuada según su diseño.","bx-help-circle")}

                ${N("Biblioteca metodológica","Definiciones, supuestos, tamaños del efecto, intervalos de confianza y errores frecuentes.","bx-library")}
            </div>
        </section>
    `,e}function N(e,t,a){return`
        <article class="
            group bg-white
            border border-slate-200
            rounded-3xl p-6
    ...
    `}const fa={home:{page:Ue,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:st,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:ut,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:ft,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:$t,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Nt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:Zt,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:Jt,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:ca,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:ba,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:ga,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"}};let le=document.referrer||"";function Z(e){window.location.hash=`/${e}`}function va(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";wa(t)};window.addEventListener("hashchange",e),e()}function ha(e,t){const a=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:t,page_location:a,page_referrer:le}),le=a}function wa(e){const t=document.querySelector("main"),a=fa[e];if(t){if(t.innerHTML="",!a){Z("home");return}mt(a.layout),document.title=a.title,t.appendChild(a.page()),window.scrollTo({top:0,behavior:"auto"}),ha(e,a.title)}}function ya(e,t){ce(e,Z),va();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(oe(e),i=!0)}a.addEventListener("change",o),o(a),oe(e);const n=t.querySelector('[data-action ="open-menu"]');Ce(n,e),Ee(e)}const he=document.querySelector("#header");he.innerHTML=ye();const we=document.querySelector("#navBar");we.innerHTML=ke();const ka=document.querySelector("#footer");ka.innerHTML=Ae();ya(we,he);
