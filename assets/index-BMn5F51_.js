(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const xe=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Be(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function Me(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function We(e){Me(e,ne)}const Le=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Ye=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Xe=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,he=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        </div>`}];function _e(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=he.length,n=1500;let r=0,p=null;function x(u){return(u%o+o)%o}function l(){i.innerHTML=he[r].content}function d(u){r=x(r+u),l()}function w(){m(),p=setInterval(()=>d(1),n)}function m(){p&&(clearInterval(p),p=null)}function b(){w()}l(),w(),a.addEventListener("click",()=>{d(1),b()}),t.addEventListener("click",()=>{d(-1),b()})}function Ze(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return _e(t.querySelector("#containerFather")),We(t.querySelector("#btnsGroup")),t}const ea="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function aa(){try{const e=await fetch(ea,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function X(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function ta(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function ia(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const r=await aa();a.textContent=X(r.total),t.textContent=X(r.hoy),i.textContent=X(r.ultimos7Dias),o.textContent=X(r.ultimos30Dias);const p=ta(r.actualizadoEn);n.textContent=p?`Actualizado: ${p}`:"Estadísticas temporalmente no disponibles"}catch(r){console.error("Error al mostrar las estadísticas en la portada:",r),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function oa(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=Qe();const a=Ze();return e.appendChild(a),ia(e),e}function ra(){return oa()}const sa=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function na(){return`
        <section 
            role="banner" 
  ...
  `}function ya(){const e=document.createElement("section");return e.className=`
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ga({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:n,category:r="Noticia",imageFit:p="contain"}){const x=p==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
...
Gracias.`);return`
    ...
    `;const a=Ha(Ie),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ...
        ${Va(a)}
        ${Ka()}
    `,e}function Qa({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(r=>`<p>${r}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function at(e){if(!e)return`
        ...
        `;const a=Ne(e),t=Za(e),i=t.length,o=t.map(d=>Number(d.year)).filter(Boolean),n=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",p=[...new Set(t.map(d=>d.q).filter(Boolean))],x=[...new Set(t.map(d=>ve(d)).filter(Boolean))],l=t.map(d=>{const w=ve(d),m=Re(d),b=_a(d);return`
...
A00116736    13    7"
    ...
    `;const a=e.querySelector("#banner-primer-input"),t=e.querySelector("#banner-primer-process"),i=e.querySelector("#banner-primer-clear"),o=e.querySelector("#banner-primer-message"),n=e.querySelector("#banner-primer-preview"),r=e.querySelector("#banner-primer-count"),p=e.querySelector("#banner-primer-download-1ac"),x=e.querySelector("#banner-primer-download-2pp");let l=[];function d(s,v="success"){o.textContent=s,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),v==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(){o.textContent="",o.classList.add("hidden")}function m(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function b(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function u(s){const v=String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return v.includes("	")?v.split("	").map(h=>h.trim()).filter(h=>h!==""):v.includes(";")?v.split(";").map(h=>h.trim()).filter(h=>h!==""):v.split(/\s+/).map(h=>h.trim()).filter(h=>h!=="")}function y(s){const v=s.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),h=[],E=[],z=new Set;return v.forEach((C,P)=>{const M=P+1,j=u(C);if(j.length!==3){E.push(`Línea ${M}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const K=m(j[0]),J=Number(b(j[1])),Q=Number(b(j[2]));if(!/^A[0-9]{8}$/.test(K)){E.push(`Línea ${M}: la matrícula "${K}" no es válida. Debe tener el formato A00108671.`);return}if(z.has(K)){E.push(`Línea ${M}: la matrícula ${K} está repetida.`);return}if(!Number.isFinite(J)){E.push(`Línea ${M}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(Q)){E.push(`Línea ${M}: la calificación 2PP no es numérica.`);return}if(J<0||J>15){E.push(`Línea ${M}: 1AC debe estar entre 0 y 15.`);return}if(Q<0||Q>20){E.push(`Línea ${M}: 2PP debe estar entre 0 y 20.`);return}const ge=J+Q;if(ge>35){E.push(`Línea ${M}: la suma de 1AC y 2PP no puede superar 35 puntos.`);return}z.add(K),h.push({matricula:K,grade1AC:J,grade2PP:Q,total:ge})}),{records:h,errors:E}}function f(s){return Number.isInteger(s)?String(s):s.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function k(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function A(s){if(s.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="5"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=s.map((v,h)=>`
                ...
                `).join(""),r.textContent=`${s.length} estudiante${s.length===1?"":"s"}`}function $(s,v,h){return[["MATRICULA",h],...s.map(C=>[C.matricula,f(C[v])])].map(C=>C.join(";")).join(`\r
`)}function c(s,v){const E=new Blob(["\uFEFF"+s],{type:"text/csv;charset=utf-8;"}),z=URL.createObjectURL(E),C=document.createElement("a");C.href=z,C.download=v,document.body.appendChild(C),C.click(),C.remove(),window.setTimeout(()=>{URL.revokeObjectURL(z)},1e3)}function g(){l=[],a.value="",A([]),p.disabled=!0,x.disabled=!0,w(),a.focus()}return t.addEventListener("click",()=>{const s=a.value.trim();if(!s){l=[],A([]),p.disabled=!0,x.disabled=!0,d("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:v,errors:h}=y(s);if(h.length>0){l=[],A([]),p.disabled=!0,x.disabled=!0,d(h.join(" "),"error");return}l=v,A(l),p.disabled=!1,x.disabled=!1,d(`Los datos de ${v.length} estudiante${v.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",g),p.addEventListener("click",()=>{if(l.length===0)return;const s=$(l,"grade1AC","1AC");c(s,"Banner_APEC_Primer_Periodo_1AC.csv")}),x.addEventListener("click",()=>{if(l.length===0)return;const s=$(l,"grade2PP","2PP");c(s,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function Pt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    25"
    ...
    `;const a=e.querySelector("#banner-segundo-input"),t=e.querySelector("#banner-segundo-process"),i=e.querySelector("#banner-segundo-clear"),o=e.querySelector("#banner-segundo-message"),n=e.querySelector("#banner-segundo-preview"),r=e.querySelector("#banner-segundo-count"),p=e.querySelector("#banner-segundo-download");let x=[];function l(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function d(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function w(c){const g=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return g.includes("	")?g.split("	").map(s=>s.trim()).filter(s=>s!==""):g.includes(";")?g.split(";").map(s=>s.trim()).filter(s=>s!==""):g.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function m(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function b(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function u(c,g="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),g==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(c){const g=c.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),s=[],v=[],h=new Set;return g.forEach((E,z)=>{const C=z+1,P=w(E);if(P.length!==2){v.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const M=l(P[0]),j=Number(d(P[1]));if(!/^A[0-9]{8}$/.test(M)){v.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(h.has(M)){v.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(j)){v.push(`Línea ${C}: la calificación 3SP no es numérica.`);return}if(j<0||j>35){v.push(`Línea ${C}: 3SP debe estar entre 0 y 35.`);return}h.add(M),s.push({matricula:M,grade3SP:j})}),{records:s,errors:v}}function f(c){if(c.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=c.map((g,s)=>`
                    <tr class="border-b border-slate-100 last:border-b-0">
                        <td class="px-4 py-3 text-slate-500">
                            ${s+1}
                        </td>
                ...
                `).join(""),r.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function k(c){return[["MATRICULA","3SP"],...c.map(s=>[s.matricula,m(s.grade3SP)])].map(s=>s.join(";")).join(`\r
`)}function A(c,g){const s=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),v=URL.createObjectURL(s),h=document.createElement("a");h.href=v,h.download=g,document.body.appendChild(h),h.click(),h.remove(),window.setTimeout(()=>{URL.revokeObjectURL(v)},1e3)}function $(){x=[],a.value="",f([]),p.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){x=[],f([]),p.disabled=!0,u("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:g,errors:s}=y(c);if(s.length>0){x=[],f([]),p.disabled=!0,u(s.join(" "),"error");return}x=g,f(g),p.disabled=!1,u(`Los datos de ${g.length} estudiante${g.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",$),p.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function Dt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    20"
    ...
    `;const a=e.querySelector("#banner-final-input"),t=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),n=e.querySelector("#banner-final-preview"),r=e.querySelector("#banner-final-count"),p=e.querySelector("#banner-final-download");let x=[];function l(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function d(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function w(c){const g=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return g.includes("	")?g.split("	").map(s=>s.trim()).filter(s=>s!==""):g.includes(";")?g.split(";").map(s=>s.trim()).filter(s=>s!==""):g.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function m(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function b(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function u(c,g="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),g==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(c){const g=c.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),s=[],v=[],h=new Set;return g.forEach((E,z)=>{const C=z+1,P=w(E);if(P.length!==2){v.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const M=l(P[0]),j=Number(d(P[1]));if(!/^A[0-9]{8}$/.test(M)){v.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(h.has(M)){v.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(j)){v.push(`Línea ${C}: la calificación 4EF no es numérica.`);return}if(j<0||j>30){v.push(`Línea ${C}: 4EF debe estar entre 0 y 30.`);return}h.add(M),s.push({matricula:M,grade4EF:j})}),{records:s,errors:v}}function f(c){if(c.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=c.map((g,s)=>`
                ...
                `).join(""),r.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function k(c){return[["MATRICULA","4EF"],...c.map(s=>[s.matricula,m(s.grade4EF)])].map(s=>s.join(";")).join(`\r
`)}function A(c,g){const s=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),v=URL.createObjectURL(s),h=document.createElement("a");h.href=v,h.download=g,document.body.appendChild(h),h.click(),h.remove(),window.setTimeout(()=>{URL.revokeObjectURL(v)},1e3)}function $(){x=[],a.value="",f([]),p.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){x=[],f([]),p.disabled=!0,u("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:g,errors:s}=y(c);if(s.length>0){x=[],f([]),p.disabled=!0,u(s.join(" "),"error");return}x=g,f(g),p.disabled=!1,u(`Los datos de ${g.length} estudiante${g.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",$),p.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Examen_Final_4EF.csv")}),e}function jt(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),n=e.querySelector("#open-segundo-periodo"),r=e.querySelector("#open-calificacion-final"),p=e.querySelector("#banner-back");function x(){a.classList.add("hidden"),t.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}function l(m){console.error("No fue posible abrir la herramienta de Banner:",m),i.innerHTML=`
            <div
...
20252000     0"
    ...
    `;const a=e.querySelector("#xmera-input"),t=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),n=e.querySelector("#xmera-clear"),r=e.querySelector("#xmera-message"),p=e.querySelector("#tab-xmera"),x=e.querySelector("#tab-banner"),l=e.querySelector("#panel-xmera"),d=e.querySelector("#panel-banner");function w(){t.textContent=`var data_todo = {
};`,o.disabled=!0}function m(f,k="success"){r.textContent=f,r.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),r.classList.add("border"),k==="error"?r.classList.add("border-red-200","bg-red-50","text-red-800"):r.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function b(f){const k=f.split(/\r?\n/).map(g=>g.trim()).filter(Boolean),A=[],$=[],c=new Set;return k.forEach((g,s)=>{const v=g.split(/[\t,; ]+/).map(P=>P.trim()).filter(Boolean),h=s+1,E=v[0],z=v.slice(1);if(!E){$.push(`Línea ${h}: falta la matrícula.`);return}if(!/^\d+$/.test(E)){$.push(`Línea ${h}: la matrícula "${E}" no es válida.`);return}if(c.has(E)){$.push(`Línea ${h}: la matrícula ${E} está repetida.`);return}if(z.length===0){$.push(`Línea ${h}: falta al menos una calificación.`);return}const C=z.map(P=>Number(P));if(C.some(P=>!Number.isFinite(P))){$.push(`Línea ${h}: existe una calificación no numérica.`);return}c.add(E),A.push({matricula:E,grades:C})}),{records:A,errors:$}}function u(f){return`var data_todo = {
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
    ...
    `}function U(e,a,t,i,o,n,r=""){return`
        <article class="
