(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const B=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function W(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function Z(){return`<div class="lg:hidden  border-b-zinc-500 border-b  pb-2.5  w-full  flex px-2.5  justify-between items-center  mb-7">
              <span class="text-4xl font-medium ">El Kernel</span>
                ...
                <ul class="flex w-full text-black flex-col lg:flex-row p-4 gap-4 xl:gap-9">
                  ...
                  <li data-action="open-subMenu" class="gap-1 text-nowrap lg:relative  2xl:text-3xl  hover:cursor-pointer 
                    ...
                    </ul>`}function X(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
        ...
        `}function z(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(t=>{const i=t.querySelector("ul"),o=t.querySelector("i");let n=!i.classList.contains("hidden");t.addEventListener("click",l=>{l.preventDefault(),n?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),n=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),n=!0)})})}function _(e,a){e.addEventListener("click",()=>{a.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function ee(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function ae(){return`<div class =" flex justify-center 
            ...
            <!-- Fin tarjeta principal  -->  `}function U(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function te(e){U(e,j)}const N=""+new URL("apec-ConmXkrT.png",import.meta.url).href,ie=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,oe=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,$=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        <img src="${oe}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function ne(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=$.length,n=1500;let l=0,r=null;function x(v){return(v%o+o)%o}function c(){i.innerHTML=$[l].content}function s(v){l=x(l+v),c()}function b(){m(),r=setInterval(()=>s(1),n)}function m(){r&&(clearInterval(r),r=null)}function u(){b()}c(),b(),a.addEventListener("click",()=>{s(1),u()}),t.addEventListener("click",()=>{s(-1),u()})}function se(){const e=`
    <div class="absolute bottom-0 col-span-4
            ...
            </div>`,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return ne(t.querySelector("#containerFather")),te(t.querySelector("#btnsGroup")),t}function le(){const e=document.createElement("section");e.classList.add("relative","w-full","flex","flex-col","m-auto","tabletBig:flex-row","md:mb-50","tabletBig:w-7xl","tabletBig:px-20","xl:mb-0","xl:pb-0","xl:w-full","xl:px-0","2xl:w-450","2xl:h-187.5"),e.innerHTML=`${ae()}`;const a=document.createElement("div");return a.appendChild(se()),e.appendChild(a.firstElementChild),e}function re(){return le()}const ce=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function de(){return`
    <section role="banner" class="relative w-full min-h-screen overflow-hidden">
     
    <!-- Imagen del banner -->
      <img src="${ce}" alt="QuienesSomos" class="absolute inset-0 w-full h-full object-cover" loading="lazy"/>
  ...
  `}const me="data:image/png;base64,",ue="data:image/png;base64,",xe="data:image/png;base64,",ge="data:image/png;base64,",be="data:image/png;base64,",fe=[{icon:me,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:ue,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:xe,title:"Objetivos",content:`
      ...
      </ul>`},{icon:ge,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function ve({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${be}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `,e}function ye(e){e.querySelectorAll("[data-accordion-header]").forEach(t=>{t.addEventListener("click",()=>{const i=t.nextElementSibling,o=t.querySelector("[data-accordion-icon]"),n=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(l=>{l.classList.remove("max-h-[1000px]"),l.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(l=>{l.classList.remove("rotate-180")}),n||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function Ae(e){const a=e.querySelector("[data-description-text]"),t=e.querySelector("[data-description-btn]");if(!a||!t)return;let i=!1;t.addEventListener("click",()=>{i=!i,a.classList.toggle("line-clamp-4",!i),t.textContent=i?"Leer menos":"Leer más"})}function Ce(){const e=we();return ye(e),Ae(e),e}function Ee(e){const a=document.createElement("div");a.className="flex bg-white border rounded-xl shadow-2xl border-black w-89.5 h-139 flex-col items-center text-center justify-between p-4 gap-4 transition-all hover:scale-[1.02]";const t=e.redes.map(i=>`
    ...
    `,a}const E=""+new URL("sep-BCMURSaM.png",import.meta.url).href,k=""+new URL("nat-CaDYa76I.png",import.meta.url).href,T=""+new URL("rad-B3ff1btG.png",import.meta.url).href,L=""+new URL("ant-D2J2W27b.png",import.meta.url).href,q=""+new URL("mar-Cru0HERG.png",import.meta.url).href,M=""+new URL("marc-D-jKwb4F.png",import.meta.url).href,A=""+new URL("jos-BToFZdIf.png",import.meta.url).href,S=[{img:E,title:"Miguel A. Miguel A. Leonardo Sepúlveda, Ph.D",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente.",afilaciones:" ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&amp;hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con enfoque en métodos numéricos avanzados. Asesor de tesis de posgrado y pregrado. Diseñador y rediseñador de programas curriculares universitarios. Investigador en métodos libres de Jacobiano, análisis numérico y formación de docentes."},{img:k,title:"Natanael Ureña Castillo, M.Sc",subtitle:"Optimización, entrenamiento de redes neuronales, formación docente",areas:"Métodos iterativos, optimización, redes neuronales, ciencias actuariales, matemática computacional, formación docente.",afilaciones:" ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Especialista en métodos iterativos, optimización y redes neuronales aplicadas a problemas complejos y riesgos. Docente universitario y asesor en proyectos de investigación matemática."},{img:T,title:"Randy Leonardo, M.Sc",subtitle:"Álgebra Lineal, Matrices combinadas, Educación Matemática",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa..",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador en álgebra y docencia, co-investigador de proyectos de matrices combinadas. Ponente en congresos nacionales."},{img:L,title:"Antmel Rodríguez Cabral, Ph.D",subtitle:"Especialista en dinámica compleja y dinámica real de métodos iterativos para sistemas no lineales",rec:"Recientemente defendió su tesis doctoral (Doctor en Matemática).",areas:" EDPs, sistemas no lineales, planos/dinámicas compleja y real, análisis complejo, educación matemática.",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Profesor universitario e investigador en métodos numéricos, EDPs y planos dinámicos; ponente en congresos internacionales."},{img:q,title:"Marino Brito Guillén, M.Sc",subtitle:"Gestión universitaria, Matemática Educativa, Educación",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente.",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Ex-vicerrector académico, profesor universitario y consultor educativo. Experto en desarrollo curricular y formación docente."},{img:M,title:"Marc-Kelly Jean Philippe Jean, Ph.D",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",areas:"Álgebra, matemática pura, educación matemática, recursos educativos.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?hl=es&amp;user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Profesor adjunto, asesor y conferencista en álgebra, con experiencia en investigación y divulgación científica internacional."},{img:A,title:"José Alberto Reyes Reyes, M.Sc",subtitle:"Métodos Iterativos, Educación Matemática",areas:"Matemática pura, métodos iterativos, análisis de estabilidad, innovación educativa.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Docente universitario y de postgrado. Investigador en métodos numéricos y asesor de tesis en análisis de estabilidad y convergencia."}];function ke(){let e=0,a;const t=document.createElement("div");t.className="relative flex flex-col gap-7 w-full items-center";const i=()=>window.innerWidth>=1024?3:window.innerWidth>=768?2:1,o=()=>{const c=i();e+c>=S.length?e=0:e++,x()},n=()=>{const c=i();e<=0?e=S.length-c:e--,x()},l=()=>{r(),a=setInterval(o,3500)},r=()=>{a&&clearInterval(a)},x=()=>{const c=i();t.innerHTML=`
        ...
        `;const s=t.querySelector("#cards-wrapper");S.slice(e,e+c).forEach(m=>{s.appendChild(Ee(m))}),t.querySelector("#prev-btn").onclick=()=>{n(),l()},t.querySelector("#next-btn").onclick=()=>{o(),l()}};return document.addEventListener("visibilitychange",()=>{document.hidden?r():l()}),window.addEventListener("resize",()=>{e=0,x()}),x(),l(),t}function Me(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&j(t.dataset.route)})}function F(){const e=window.location.hash.replace("#/","")||"equipment",a=document.createElement("div"),t="bg-sky-800 text-white border-b-sky-800",i="bg-transparent text-black hover:bg-gray-50";return a.innerHTML=`
    ...
    </nav>`,Me(a.firstElementChild),a.firstElementChild}function Se(){const e=document.createElement("section");e.classList.add("flex","flex-col","gap-5","m-auto","p-4","max-w-7xl","tabletBig:w-7xl","xl:w-full"),e.appendChild(F());const a=ke();return e.appendChild(a),e}function De(){return Se()}function Le(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function f(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function G(e){return e.formacion?.length||0}function J(e){return e.experiencia?.length||0}function Ie(e,a=!1){const t=G(e),i=J(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function je(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(r=>`
  ...
  `}function Fe(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ${Ue()}
    ${Te(V)}
    ${qe()}
    
    `,e}function Ge({title:e,content:a,articleURL:t}){const i=a.paragraphs.map(l=>`<p>${l}<p>`).join(""),o=a.list.length?` 
    ...
    `}function _e(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const a=H(e),t=Ze(e),i=t.length,o=t.map(s=>Number(s.year)).filter(Boolean),n=o.length?Math.min(...o):"",l=o.length?Math.max(...o):"",r=[...new Set(t.map(s=>s.q).filter(Boolean))],x=[...new Set(t.map(s=>R(s)).filter(Boolean))],c=t.map(s=>{const b=R(s),m=K(s),u=We(s);return`
    ...
    `}function ea(){let e=w[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(c){const s=String(c.DOI||c.doi||"").trim().toLowerCase();return s||`${c.year||""}-${c.title||c.tile||""}-${c.contenido||""}`.trim().toLowerCase()}function n(){const c=new Map;return w.forEach(s=>{(s.publicaciones||[]).forEach(b=>{const m=o(b);c.has(m)||c.set(m,b)})}),Array.from(c.values())}function l(){const c=n(),s=c.map(v=>Number(v.year)).filter(Boolean),b=s.length?Math.max(...s):"—",m=s.length?Math.min(...s):"—",u=c.filter(v=>v.q==="Q1").length;return{totalPublicaciones:c.length,investigadores:w.length,q1:u,primerYear:m,ultimoYear:b}}const r=()=>{const c=w.find(u=>u.id===e)||w[0],s=l(),b=window.innerWidth<768&&!a;i.innerHTML=`
    ...
    `).join("")}function na(e,a=!1){return`
        <button 
            ...
            <p class="text-sm leading-relaxed ${a?"text-white/90":"text-slate-500"}">
                ${g(e.desarrollo).slice(0,185)}${String(e.desarrollo).length>185?"...":""}
            </p>
        </button>
    `}function sa(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${g(e.categoria)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Prioridad</p>
                        <p class="text-slate-800 font-bold mt-1">${g(e.prioridad)}</p>
                    </div>
    ...
    `}function la(){const e=new Set(h.map(i=>i.categoria)),a=h.filter(i=>i.proyectosAsociados?.length>0).length,t=h.filter(i=>i.publicacionesClave?.length>0).length;return{total:h.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function ra(){let e=h[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=ta(e),o=la();a.innerHTML=`
            <div class="mb-8">
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    ...
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${d(e.tipo)}</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        ...
                        <p class="text-slate-700 font-semibold mt-1">${d(e.fechaInicio)}</p>
                    </div>

                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Fecha final prevista</p>
                        <p class="text-slate-700 font-semibold mt-1">${d(e.fechaFinalizacion)}</p>
                    </div>
                </div>
    ...
    `}function ga(){let e=y[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=da(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function ba(){return ga()}function fa(){return`
    ...
    `}function va(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${ha()}
    `,e}function wa(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",ya)}async function ya(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=Aa(i);if(o.length>0){Ea(o);return}await ka(a,i)}function Aa(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?Ca(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function Ca(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Ea(e){C(e[0],"error")}function C(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function ka(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(C("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):C("Hubo un problema al enviar el mensaje.","error")}catch{C("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Ma(){const e=va();return setTimeout(()=>{wa()},0),e}const Sa={home:{page:re,layout:"default"},quienesSomos:{page:Ce,layout:"full"},equipment:{page:De,layout:"default"},FormacionAcademica:{page:$e,layout:"default"},noticias:{page:Ye,layout:"full"},publicaciones:{page:aa,layout:"default"},proyectos:{page:ba,layout:"default"},lineas:{page:ca,layout:"default"},contacto:{page:Ma,layout:"default"}};function j(e){window.location.hash=`/${e}`}function Da(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";La(a)};window.addEventListener("hashchange",e),e()}function La(e){const a=document.querySelector("main"),t=Sa[e];a&&(a.innerHTML="",t&&(Le(t.layout),a.appendChild(t.page())))}function Ia(e,a){U(e,j),Da();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(l){l.matches&&!i&&(z(e),i=!0)}t.addEventListener("change",o),o(t),z(e);const n=a.querySelector('[data-action ="open-menu"]');_(n,e),ee(e)}const Q=document.querySelector("#header");Q.innerHTML=W();const Y=document.querySelector("#navBar");Y.innerHTML=Z();const ja=document.querySelector("#footer");ja.innerHTML=X();Ia(Y,Q);
