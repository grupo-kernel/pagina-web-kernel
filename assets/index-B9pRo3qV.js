...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
    ...
    `}const ri={home:{page:ua,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:$a,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:qa,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Va,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:ot,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:dt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:Et,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:vt,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Rt,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Ot,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Ut,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Qt,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"}};let ze=document.referrer||"";function ce(e){window.location.hash=`/${e}`}function si(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";li(a)};window.addEventListener("hashchange",e),e()}function ni(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:ze}),ze=t}function li(e){const a=document.querySelector("main"),t=ri[e];if(a){if(a.innerHTML="",!t){ce("home");return}Ta(t.layout),document.title=t.title,a.appendChild(t.page()),window.scrollTo({top:0,behavior:"auto"}),ni(e,t.title)}}function ci(e,a){Ie(e,ce),si();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(ke(e),i=!0)}t.addEventListener("change",o),o(t),ke(e);const n=a.querySelector('[data-action ="open-menu"]');Ye(n,e),Xe(e)}const He=document.querySelector("#header");He.innerHTML=Je();const Ke=document.querySelector("#navBar");Ke.innerHTML=Qe();const di=document.querySelector("#footer");di.innerHTML=We();ci(Ke,He);
