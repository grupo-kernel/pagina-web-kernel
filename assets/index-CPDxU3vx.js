(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const U=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Z(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${U}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
        ...
        `}function P(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(t=>{const i=t.querySelector("ul"),o=t.querySelector("i");let s=!i.classList.contains("hidden");t.addEventListener("click",r=>{r.preventDefault(),s?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),s=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),s=!0)})})}function ee(e,a){e.addEventListener("click",()=>{a.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function ae(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function te(){return`<div class =" flex justify-center 
            ...
            <!-- Fin tarjeta principal  -->  `}function N(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function ie(e){N(e,z)}const T=""+new URL("apec-ConmXkrT.png",import.meta.url).href,oe=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,se=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,R=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        </div>`}];function ne(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=R.length,s=1500;let r=0,d=null;function u(h){return(h%o+o)%o}function l(){i.innerHTML=R[r].content}function n(h){r=u(r+h),l()}function x(){p(),d=setInterval(()=>n(1),s)}function p(){d&&(clearInterval(d),d=null)}function c(){x()}l(),x(),a.addEventListener("click",()=>{n(1),c()}),t.addEventListener("click",()=>{n(-1),c()})}function re(){const e=`
    <div class="absolute bottom-0 col-span-4
            ...
            </div>`,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return ne(t.querySelector("#containerFather")),ie(t.querySelector("#btnsGroup")),t}function le(){const e=document.createElement("section");e.classList.add("relative","w-full","flex","flex-col","m-auto","tabletBig:flex-row","md:mb-50","tabletBig:w-7xl","tabletBig:px-20","xl:mb-0","xl:pb-0","xl:w-full","xl:px-0","2xl:w-450","2xl:h-187.5"),e.innerHTML=`${te()}`;const a=document.createElement("div");return a.appendChild(re()),e.appendChild(a.firstElementChild),e}function ce(){return le()}const de=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function pe(){return`
  ...
  `,e}function Ae(e){e.querySelectorAll("[data-accordion-header]").forEach(t=>{t.addEventListener("click",()=>{const i=t.nextElementSibling,o=t.querySelector("[data-accordion-icon]"),s=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(r=>{r.classList.remove("max-h-[1000px]"),r.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(r=>{r.classList.remove("rotate-180")}),s||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function Ce(e){const a=e.querySelector("[data-description-text]"),t=e.querySelector("[data-description-btn]");if(!a||!t)return;let i=!1;t.addEventListener("click",()=>{i=!i,a.classList.toggle("line-clamp-4",!i),t.textContent=i?"Leer menos":"Leer más"})}function ke(){const e=ye();return Ae(e),Ce(e),e}function Ee(e){const a=document.createElement("div");a.className="flex bg-white border rounded-xl shadow-2xl border-black w-89.5 h-139 flex-col items-center text-center justify-between p-4 gap-4 transition-all hover:scale-[1.02]";const t=e.redes.map(i=>`
    ...
    `,a}const E=""+new URL("sep-BCMURSaM.png",import.meta.url).href,M=""+new URL("nat-CaDYa76I.png",import.meta.url).href,q=""+new URL("rad-B3ff1btG.png",import.meta.url).href,I=""+new URL("ant-D2J2W27b.png",import.meta.url).href,F=""+new URL("mar-Cru0HERG.png",import.meta.url).href,S=""+new URL("marc-D-jKwb4F.png",import.meta.url).href,C=""+new URL("jos-BToFZdIf.png",import.meta.url).href,D=[{img:E,title:"Miguel A. Miguel A. Leonardo Sepúlveda, Ph.D",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente.",afilaciones:" ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&amp;hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con enfoque en métodos numéricos avanzados. Asesor de tesis de posgrado y pregrado. Diseñador y rediseñador de programas curriculares universitarios. Investigador en métodos libres de Jacobiano, análisis numérico y formación de docentes."},{img:M,title:"Natanael Ureña Castillo, M.Sc",subtitle:"Optimización, entrenamiento de redes neuronales, formación docente",areas:"Métodos iterativos, optimización, redes neuronales, ciencias actuariales, matemática computacional, formación docente.",afilaciones:" ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Especialista en métodos iterativos, optimización y redes neuronales aplicadas a problemas complejos y riesgos. Docente universitario y asesor en proyectos de investigación matemática."},{img:q,title:"Randy Leonardo, M.Sc",subtitle:"Álgebra Lineal, Matrices combinadas, Educación Matemática",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa..",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador en álgebra y docencia, co-investigador de proyectos de matrices combinadas. Ponente en congresos nacionales."},{img:I,title:"Antmel Rodríguez Cabral, Ph.D",subtitle:"Especialista en dinámica compleja y dinámica real de métodos iterativos para sistemas no lineales",rec:"Recientemente defendió su tesis doctoral (Doctor en Matemática).",areas:" EDPs, sistemas no lineales, planos/dinámicas compleja y real, análisis complejo, educación matemática.",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Profesor universitario e investigador en métodos numéricos, EDPs y planos dinámicos; ponente en congresos internacionales."},{img:F,title:"Marino Brito Guillén, M.Sc",subtitle:"Gestión universitaria, Matemática Educativa, Educación",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente.",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Ex-vicerrector académico, profesor universitario y consultor educativo. Experto en desarrollo curricular y formación docente."},{img:S,title:"Marc-Kelly Jean Philippe Jean, Ph.D",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",areas:"Álgebra, matemática pura, educación matemática, recursos educativos.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?hl=es&amp;user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Profesor adjunto, asesor y conferencista en álgebra, con experiencia en investigación y divulgación científica internacional."},{img:C,title:"José Alberto Reyes Reyes, M.Sc",subtitle:"Métodos Iterativos, Educación Matemática",areas:"Matemática pura, métodos iterativos, análisis de estabilidad, innovación educativa.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Docente universitario y de postgrado. Investigador en métodos numéricos y asesor de tesis en análisis de estabilidad y convergencia."}];function Me(){let e=0,a;const t=document.createElement("div");t.className="relative flex flex-col gap-7 w-full items-center";const i=()=>window.innerWidth>=1024?3:window.innerWidth>=768?2:1,o=()=>{const l=i();e+l>=D.length?e=0:e++,u()},s=()=>{const l=i();e<=0?e=D.length-l:e--,u()},r=()=>{d(),a=setInterval(o,3500)},d=()=>{a&&clearInterval(a)},u=()=>{const l=i();t.innerHTML=`
        ...
        `;const n=t.querySelector("#cards-wrapper");D.slice(e,e+l).forEach(p=>{n.appendChild(Ee(p))}),t.querySelector("#prev-btn").onclick=()=>{s(),r()},t.querySelector("#next-btn").onclick=()=>{o(),r()}};return document.addEventListener("visibilitychange",()=>{document.hidden?d():r()}),window.addEventListener("resize",()=>{e=0,u()}),u(),r(),t}function Se(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&z(t.dataset.route)})}function G(){const e=window.location.hash.replace("#/","")||"equipment",a=document.createElement("div"),t="bg-sky-800 text-white border-b-sky-800",i="bg-transparent text-black hover:bg-gray-50";return a.innerHTML=`
    ...
    `}function Te({id:e,title:a,date:t,image:i,excerpt:o}){return`
  ...
  `}function Ge(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ...
    `}function ea(e){if(!e)return`
        ...
        `;const a=K(e),t=Xe(e),i=t.length,o=t.map(n=>Number(n.year)).filter(Boolean),s=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",d=[...new Set(t.map(n=>n.q).filter(Boolean))],u=[...new Set(t.map(n=>O(n)).filter(Boolean))],l=t.map(n=>{const x=O(n),p=Q(n),c=Ze(n);return`
    ...
    `}function aa(){let e=y[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(l){const n=String(l.DOI||l.doi||"").trim().toLowerCase();return n||`${l.year||""}-${l.title||l.tile||""}-${l.contenido||""}`.trim().toLowerCase()}function s(){const l=new Map;return y.forEach(n=>{(n.publicaciones||[]).forEach(x=>{const p=o(x);l.has(p)||l.set(p,x)})}),Array.from(l.values())}function r(){const l=s(),n=l.map(h=>Number(h.year)).filter(Boolean),x=n.length?Math.max(...n):"—",p=n.length?Math.min(...n):"—",c=l.filter(h=>h.q==="Q1").length;return{totalPublicaciones:l.length,investigadores:y.length,q1:c,primerYear:p,ultimoYear:x}}const d=()=>{const l=y.find(c=>c.id===e)||y[0],n=r(),x=window.innerWidth<768&&!a;i.innerHTML=`
    ...
    `}function ba(){let e=A[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=pa(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function fa(){return ba()}function ha(){return`
    ...
    ${va()}
    `,e}function ya(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Aa)}async function Aa(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=Ca(i);if(o.length>0){Ea(o);return}await Ma(a,i)}function Ca(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?ka(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function ka(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Ea(e){k(e[0],"error")}function k(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Ma(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(k("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):k("Hubo un problema al enviar el mensaje.","error")}catch{k("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Sa(){const e=wa();return setTimeout(()=>{ya()},0),e}const Da={home:{page:ce,layout:"default"},quienesSomos:{page:ke,layout:"full"},equipment:{page:Le,layout:"default"},FormacionAcademica:{page:Pe,layout:"default"},noticias:{page:We,layout:"full"},publicaciones:{page:ta,layout:"default"},proyectos:{page:fa,layout:"default"},lineas:{page:da,layout:"default"},contacto:{page:Sa,layout:"default"}};function z(e){window.location.hash=`/${e}`}function La(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";Ia(a)};window.addEventListener("hashchange",e),e()}function Ia(e){const a=document.querySelector("main"),t=Da[e];a&&(a.innerHTML="",t&&(Ie(t.layout),a.appendChild(t.page())))}function ja(e,a){N(e,z),La();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(P(e),i=!0)}t.addEventListener("change",o),o(t),P(e);const s=a.querySelector('[data-action ="open-menu"]');ee(s,e),ae(e)}const Y=document.querySelector("#header");Y.innerHTML=Z();const W=document.querySelector("#navBar");W.innerHTML=X();const za=document.querySelector("#footer");za.innerHTML=_();ja(W,Y);
