...
export async function LaboratorioKernel() {
    ...
    section.innerHTML = `
        ...
        <section class="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
            ${crearPilar({
                titulo: "Aprender",
                descripcion: "Comprenda qué mide cada estadístico, cuándo debe utilizarse, cuáles son sus supuestos y cómo se interpreta correctamente.",
                iconoNombre: "bx-book-open",
                fondo: "bg-sky-100",
                color: "text-sky-700",
            ...
            ${crearPilar({
                titulo: "Decidir",
                descripcion: "Identifique la prueba adecuada según el objetivo, el tipo de variable, el número de grupos y el diseño de su investigación.",
                iconoNombre: "bx-check-shield",
                fondo: "bg-amber-100",
            ...
            ${crearPilar({
                titulo: "Analizar",
                descripcion: "Introduzca sus datos, ejecute el análisis, interprete los resultados y genere reportes metodológicamente adecuados.",
                iconoNombre: "bx-calculator",
        ...
        <section class="mt-14">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
                ${MODULOS_LABORATORIO.map(crearTarjetaModulo).join("")}
            </div>
        </section>
    `;
