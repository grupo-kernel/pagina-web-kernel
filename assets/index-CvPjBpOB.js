(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const R=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function H(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    <div class=" flex items-center gap-4  text-white "> 
        ...
        `}function L(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(a=>{const i=a.querySelector("ul"),o=a.querySelector("i");let n=!i.classList.contains("hidden");a.addEventListener("click",r=>{r.preventDefault(),n?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),n=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),n=!0)})})}function K(e,t){e.addEventListener("click",()=>{t.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function W(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function Z(){return`<div class =" flex justify-center 
            ...
            <!-- Fin tarjeta principal  -->  `}function B(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function X(e){B(e,D)}const U=""+new URL("apec-ConmXkrT.png",import.meta.url).href,_=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,ee=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,I=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        </div>`}];function te(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=I.length,n=1500;let r=0,c=null;function m(f){return(f%o+o)%o}function l(){i.innerHTML=I[r].content}function s(f){r=m(r+f),l()}function g(){p(),c=setInterval(()=>s(1),n)}function p(){c&&(clearInterval(c),c=null)}function x(){g()}l(),g(),t.addEventListener("click",()=>{s(1),x()}),a.addEventListener("click",()=>{s(-1),x()})}function ae(){const e=`
  ...
  `,e}function be(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),n=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(r=>{r.classList.remove("max-h-[1000px]"),r.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(r=>{r.classList.remove("rotate-180")}),n||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function he(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function ve(){const e=fe();return be(e),he(e),e}function we(e){const t=document.createElement("div");t.className="flex bg-white border rounded-xl shadow-2xl border-black w-89.5 h-139 flex-col items-center text-center justify-between p-4 gap-4 transition-all hover:scale-[1.02]";const a=e.redes.map(i=>`
    ...
    </nav>`,Ae(t.firstElementChild),t.firstElementChild}function Ce(){const e=document.createElement("section");e.classList.add("flex","flex-col","gap-5","m-auto","p-4","max-w-7xl","tabletBig:w-7xl","xl:w-full"),e.appendChild(q());const t=ye();return e.appendChild(t),e}function Me(){return Ce()}function Ee(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function Se(e,t=!1){return`
        <div data-id="${e.id}" 
    ...
    `}function Pe({id:e,title:t,date:a,image:i,excerpt:o}){return`
  ...
  `}function Ue(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ...
    `}function Ye(e){if(!e)return`
        ...
        `;const t=F(e),a=He(e),i=a.length,o=a.map(s=>Number(s.year)).filter(Boolean),n=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",c=[...new Set(a.map(s=>s.q).filter(Boolean))],m=[...new Set(a.map(s=>O(s)).filter(Boolean))],l=a.map(s=>{const g=O(s),p=G(s),x=Ve(s);return`
    ...
    `}function Ke(){let e=b[0]?.id||1,t=!1,a=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(l){const s=String(l.DOI||l.doi||"").trim().toLowerCase();return s||`${l.year||""}-${l.title||l.tile||""}-${l.contenido||""}`.trim().toLowerCase()}function n(){const l=new Map;return b.forEach(s=>{(s.publicaciones||[]).forEach(g=>{const p=o(g);l.has(p)||l.set(p,g)})}),Array.from(l.values())}function r(){const l=n(),s=l.map(f=>Number(f.year)).filter(Boolean),g=s.length?Math.max(...s):"—",p=s.length?Math.min(...s):"—",x=l.filter(f=>f.q==="Q1").length;return{totalPublicaciones:l.length,investigadores:b.length,q1:x,primerYear:p,ultimoYear:g}}const c=()=>{const l=b.find(x=>x.id===e)||b[0],s=r(),g=window.innerWidth<768&&!t;i.innerHTML=`
        ...
        `,a.querySelector("#next-btn").onclick=()=>{e=o,i()}};return i(),a}function z(e,t){return`
    ...
    `).join("")}function tt(e=[]){return e.map(t=>`
    ...
    `}function nt(){let e=h[0]?.id||1;const t=document.createElement("section");t.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=et(e);t.innerHTML=`
            <div class="mb-8">
        ...
        `,t.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),a()}})};return a(),t}function st(){return nt()}function rt(){return`
    ...
    `}function ct(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${lt()}
    `,e}function dt(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",mt)}async function mt(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=ut(i);if(o.length>0){xt(o);return}await gt(t,i)}function ut(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?pt(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function pt(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function xt(e){w(e[0],"error")}function w(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function gt(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(w("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):w("Hubo un problema al enviar el mensaje.","error")}catch{w("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function ft(){const e=ct();return setTimeout(()=>{dt()},0),e}const bt={home:{page:oe,layout:"default"},quienesSomos:{page:ve,layout:"full"},equipment:{page:Me,layout:"default"},FormacionAcademica:{page:Le,layout:"default"},noticias:{page:Je,layout:"full"},publicaciones:{page:We,layout:"default"},proyectos:{page:st,layout:"default"},lineas:{page:_e,layout:"default"},contacto:{page:ft,layout:"default"}};function D(e){window.location.hash=`/${e}`}function ht(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";vt(t)};window.addEventListener("hashchange",e),e()}function vt(e){const t=document.querySelector("main"),a=bt[e];t&&(t.innerHTML="",a&&(Ee(a.layout),t.appendChild(a.page())))}function wt(e,t){B(e,D),ht();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(L(e),i=!0)}a.addEventListener("change",o),o(a),L(e);const n=t.querySelector('[data-action ="open-menu"]');K(n,e),W(e)}const J=document.querySelector("#header");J.innerHTML=H();const V=document.querySelector("#navBar");V.innerHTML=Q();const yt=document.querySelector("#footer");yt.innerHTML=Y();wt(V,J);
