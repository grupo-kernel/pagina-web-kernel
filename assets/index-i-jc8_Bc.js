(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const k of s)if(k.type==="childList")for(const f of k.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&t(f)}).observe(document,{childList:!0,subtree:!0});function b(s){const k={};return s.integrity&&(k.integrity=s.integrity),s.referrerPolicy&&(k.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?k.credentials="include":s.crossOrigin==="anonymous"?k.credentials="omit":k.credentials="same-origin",k}function t(s){if(s.ep)return;s.ep=!0;const k=b(s);fetch(s.href,k)}})();const Ue=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Aa(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function ia(i,l){i.addEventListener("click",b=>{const t=b.target.closest(["[data-route]"]);t&&(b.preventDefault(),l(t.dataset.route))})}function Ia(i){ia(i,Le)}const oa=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Ra=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Na=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,Ge=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        <img src="${Ra}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function Fa(i){const l=i.querySelector("#arrowR"),b=i.querySelector("#arrowL"),t=i.querySelector("#contenedorSlide");if(!l||!b||!t)return;const s=Ge.length,k=1500;let f=0,h=null;function v(c){return(c%s+s)%s}function o(){t.innerHTML=Ge[f].content}function e(c){f=v(f+c),o()}function a(){r(),h=setInterval(()=>e(1),k)}function r(){h&&(clearInterval(h),h=null)}function n(){a()}o(),a(),l.addEventListener("click",()=>{e(1),n()}),b.addEventListener("click",()=>{e(-1),n()})}function Ta(){const i=`
        <section class="
    ...
    `,l=document.createElement("div");l.innerHTML=i;const b=l.firstElementChild;return Fa(b.querySelector("#containerFather")),Ia(b.querySelector("#btnsGroup")),b}const Oa="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function Ua(){try{const i=await fetch(Oa,{method:"GET",cache:"no-store"});if(!i.ok)throw new Error(`La API de Analytics respondió con estado ${i.status}`);const l=await i.json();if(!l.ok||!l.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(l.visitantes.total)||0,hoy:Number(l.visitantes.hoy)||0,ultimos7Dias:Number(l.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(l.visitantes.ultimos30Dias)||0,actualizadoEn:l.actualizadoEn||null}}catch(i){return console.error("No fue posible obtener las estadísticas de Analytics:",i),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function pe(i){return new Intl.NumberFormat("es-DO").format(Number(i)||0)}function Ba(i){if(!i)return null;const l=new Date(i);return Number.isNaN(l.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(l)}async function Va(i){const l=i.querySelector("#analytics-total"),b=i.querySelector("#analytics-hoy"),t=i.querySelector("#analytics-semana"),s=i.querySelector("#analytics-mes"),k=i.querySelector("#analytics-actualizado");if(!l||!b||!t||!s||!k){console.warn("No se encontraron los elementos de Analytics en la portada.");return}k.textContent="Cargando estadísticas…";try{const f=await Ua();l.textContent=pe(f.total),b.textContent=pe(f.hoy),t.textContent=pe(f.ultimos7Dias),s.textContent=pe(f.ultimos30Dias);const h=Ba(f.actualizadoEn);k.textContent=h?`Actualizado: ${h}`:"Estadísticas temporalmente no disponibles"}catch(f){console.error("Error al mostrar las estadísticas en la portada:",f),l.textContent="—",b.textContent="—",t.textContent="—",s.textContent="—",k.textContent="No fue posible cargar las estadísticas"}}function Ga(){const i=document.createElement("section");i.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,i.innerHTML=Da();const l=Ta();return i.appendChild(l),Va(i),i}function Ma(){return Ga()}const Ha=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Ka(){return`
        <section 
            role="banner" 
  ...
  `}function rt({icon:i,title:l,content:b}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <div class="flex items-center gap-4">
          <img src="${i}" alt="" class="w-8 h-8 pointer-events-none" />
  ...
  `}function nt(){const i=document.createElement("section");return i.className=`
    ...
    `,i.innerHTML=`
        ...
        ${Ya()}
        ${tt()}
    `,i}function it(i){i.querySelectorAll("[data-accordion-header]").forEach(b=>{b.addEventListener("click",()=>{const t=b.nextElementSibling,s=b.querySelector("[data-accordion-icon]"),k=t.classList.contains("max-h-[1000px]");i.querySelectorAll("[data-accordion-content]").forEach(f=>{f.classList.remove("max-h-[1000px]"),f.classList.add("max-h-0")}),i.querySelectorAll("[data-accordion-icon]").forEach(f=>{f.classList.remove("rotate-180")}),k||(t.classList.remove("max-h-0"),t.classList.add("max-h-[1000px]"),s.classList.add("rotate-180"))})})}function ot(i){const l=i.querySelector("[data-description-text]"),b=i.querySelector("[data-description-btn]");if(!l||!b)return;let t=!1;b.addEventListener("click",()=>{t=!t,l.classList.toggle("line-clamp-4",!t),b.textContent=t?"Leer menos":"Leer más"})}function st(){const i=nt();return it(i),ot(i),i}function K(i){return String(i??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function lt(i=[]){return!i||i.length===0?`
    ...
    `).join("")}function ct(i){return i?String(i).split(",").map(b=>b.trim()).filter(Boolean).slice(0,4).map(b=>`
    ...
    `).join(""):""}function dt(i){const l=document.createElement("article");l.className=`
    ...
    `;const b=lt(i.redes||[]),t=ct(i.areas),s=i.estado||i.grado||i.subtitle||"Investigador";return l.innerHTML=`
        ...
        <div class="w-full flex flex-col gap-4 text-left flex-1">
                ...
                <div class="flex flex-wrap gap-2">
                    ${t||`
                                <p class="text-sm text-slate-500 leading-relaxed">
                                    ${K(i.areas||"Área no especificada")}
                                </p>
                              `}
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-sm text-slate-600 leading-relaxed">
                    ${K(i.afilaciones||i.afiliaciones||"No especificadas")}
                </p>
            </div>
    ...
    `,l}const sa=""+new URL("rad-B3ff1btG.png",import.meta.url).href,la=""+new URL("mar-Cru0HERG.png",import.meta.url).href,ie=[{img:ye,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:Ae,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:sa,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:Be,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:la,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:ke,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:ue,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function ut(){let i=0,l=null,b=null;const t=document.createElement("section");t.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const s=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,k=()=>{const n=s();return Math.max(ie.length-n,0)},f=()=>{const n=k();i>n&&(i=0),i<0&&(i=n)},h=()=>{const n=k();i>=n?i=0:i++,r()},v=()=>{const n=k();i<=0?i=n:i--,r()},o=()=>{e(),ie.length>s()&&(l=setInterval(h,4500))},e=()=>{l&&(clearInterval(l),l=null)},a=()=>{const n=s(),c=Math.max(ie.length-n+1,1);return Array.from({length:c}).map((d,u)=>`
        ...
        `).join("")},r=()=>{if(!ie||ie.length===0){t.innerHTML=`
            ...
            `;return}f();const n=s(),c=ie.slice(i,i+n);t.innerHTML=`
        ...
        `;const d=t.querySelector("#cards-wrapper");c.forEach(x=>{d.appendChild(dt(x))});const u=t.querySelector("#prev-btn"),g=t.querySelector("#next-btn");u&&(u.onclick=()=>{v(),o()}),g&&(g.onclick=()=>{h(),o()}),t.querySelectorAll("[data-dot-index]").forEach(x=>{x.onclick=()=>{i=parseInt(x.dataset.dotIndex),r(),o()}})};return t.addEventListener("mouseenter",e),t.addEventListener("mouseleave",o),document.addEventListener("visibilitychange",()=>{document.hidden?e():o()}),window.addEventListener("resize",()=>{clearTimeout(b),b=setTimeout(()=>{i=0,r(),o()},150)}),r(),o(),t}function pt(i){i.addEventListener("click",l=>{const b=l.target.closest("[data-route]");if(!b)return;const t=window.location.hash.replace("#/","")||"equipment";b.dataset.route!==t&&Le(b.dataset.route)})}function ca(){const i=window.location.hash.replace(/^#\/?/,"")||"equipment",l=document.createElement("nav"),b="bg-sky-800 text-white border-sky-800 shadow-md",t="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return l.className="w-full flex justify-center mb-6",l.innerHTML=`
    ...
    `,pt(l),l}function mt(){const i=document.createElement("section");i.id="equipo-investigacion",i.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const l=document.createElement("div");l.className="mb-6",l.appendChild(ca());const b=ut();return i.appendChild(l),i.appendChild(b),i}function ft(){return mt()}function bt(i="default"){const l=document.getElementById("main");l.classList.remove("p-2","mt-8","md:mt-12"),i=="full"?(l.classList.add("mt-0","pt-0"),l.classList.remove("max-w-7xl")):i=="left"?(l.classList.add("p-2","mt-8","md:mt-12"),l.classList.remove("m-auto")):(l.classList.add("p-2","mt-8","md:mt-12"),l.classList.add("m-auto"))}function M(i){return String(i??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function da(i){return i.formacion?.length||0}function ua(i){return i.experiencia?.length||0}function gt(i,l=!1){const b=da(i),t=ua(i);return`
        <button 
            type="button"
            data-id="${i.id}" 
    ...
    `}function xt(i){const l=i.formacion||[],b=i.experiencia||[],t=l.length?l.map(h=>`
                        ...
                        ">
                            ...
                            ">
                                ...
                                <div class="flex flex-wrap items-center gap-3 mb-5">
                                    ...
                                    ">
                                        ${ee(i.category||"Noticia destacada")}
                                    </span>
    ...
    `}function Z(i){return String(i??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Pt({id:i,title:l,date:b,image:t,imageAlt:s,excerpt:k,category:f="Noticia",imageFit:h="contain"}){const v=h==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${Z(i)}"
            class="
    ...
    `}function Lt(){const i=encodeURIComponent("Propuesta de noticia para El Kernel"),l=encodeURIComponent(`Saludos,
...
Gracias.`);return`
                ...
                ">
                    ...
                    <div class="relative z-10 max-w-3xl mx-auto">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                            ...
                            <a href="mailto:mleonardos@unapec.edu.do?subject=${i}&body=${l}"
                               class="
                                   inline-flex items-center justify-center gap-2
    ...
    `}function zt(i=[]){return[...i].sort((l,b)=>l.featured&&!b.featured?-1:!l.featured&&b.featured?1:0)}function qt(){const i=document.createElement("section");i.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const l=zt(pa),b=l.find(t=>t.featured)||l[0];return i.innerHTML=`
        ${Et(b)}
        ${$t(l)}
        ${Lt()}
    `,i}function Dt({title:i,content:l={paragraphs:[],list:[]},articleURL:b}){const t=(l.paragraphs||[]).map(f=>`<p>${f}</p>`).join(""),s=(l.list||[]).length?`
    ...
    `}function It(i){i&&i.addEventListener("click",l=>{const b=l.target.closest("[data-news-btn], [data-news-card]");if(!b||!i.contains(b))return;const t=b.dataset.newsBtn||b.dataset.newsCard,s=pa.find(k=>String(k.id)===String(t));if(!s){console.warn("No se encontró la noticia con id:",t);return}Rt(s)})}function Rt(i){const l=document.querySelector("#newsModal");l&&l.remove();const b=document.createElement("div");b.innerHTML=Dt(i);const t=b.firstElementChild;if(!t){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(t),document.body.style.overflow="hidden";function s(){t.remove(),document.body.style.overflow="",document.removeEventListener("keydown",k)}function k(f){f.key==="Escape"&&s()}t.querySelectorAll("[data-close-modal]").forEach(f=>{f.addEventListener("click",s)}),t.addEventListener("click",f=>{f.target===t&&s()}),document.addEventListener("keydown",k)}function Nt(){const i=qt();return It(i),i}function T(i){return String(i??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ma(i){return i?.name||i?.title||"Investigador"}function Me(i){return i?.title||i?.tile||"Revista no especificada"}function fa(i){return String(i?.DOI||i?.doi||"").trim()}function Ft(i){const l=fa(i);return i?.url?i.url:l?l.startsWith("http")?l:`https://doi.org/${l}`:"#"}function Tt(i){return[...i?.publicaciones||[]].sort((l,b)=>{const t=Number(l.year||0),s=Number(b.year||0);return t!==s?s-t:String(l.contenido||"").localeCompare(String(b.contenido||""))})}function Ot(i,l=!1){const b=ma(i),t=i.publicaciones||[],s=t.length,k=t.map(h=>Number(h.year)).filter(Boolean),f=k.length?Math.max(...k):"";return`
        <button data-id="${i.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${l?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function Ut(i){if(!i)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const l=ma(i),b=Tt(i),t=b.length,s=b.map(e=>Number(e.year)).filter(Boolean),k=s.length?Math.min(...s):"",f=s.length?Math.max(...s):"",h=[...new Set(b.map(e=>e.q).filter(Boolean))],v=[...new Set(b.map(e=>Me(e)).filter(Boolean))],o=b.map(e=>{const a=Me(e),r=fa(e),n=Ft(e);return`
    ...
    `}function Bt(){let i=Y[0]?.id||1,l=!1,b=null;const t=document.createElement("section");t.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function s(c){return String(c?.DOI||c?.doi||"").trim().toLowerCase()}function k(c){return String(c?.journal||c?.title||c?.tile||"").trim()}function f(c){return String(c?.articleTitle||c?.contenido||"").trim()}function h(c){return String(c?.q||c?.quartile||"").trim().toUpperCase()}function v(c){const d=s(c);return d||[c?.year||"",k(c),f(c)].join("-").trim().toLowerCase()}function o(){const c=new Map;return Y.forEach(d=>{(d.publicaciones||[]).forEach(u=>{const g=v(u);g&&!c.has(g)&&c.set(g,u)})}),Array.from(c.values())}function e(){const c=o(),d=c.map(p=>Number(p.year)).filter(Boolean),u=d.length?Math.max(...d):"—",g=d.length?Math.min(...d):"—",x=c.filter(p=>h(p)==="Q1").length;return{totalPublicaciones:c.length,investigadores:Y.length,q1:x,primerYear:g,ultimoYear:u}}function a(){return Y.find(c=>Number(c.id)===Number(i))||Y[0]}const r=()=>{const c=a(),d=e(),u=window.innerWidth<768&&!l;t.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${Y.map(x=>Ot(x,Number(x.id)===Number(i))).join("")}
                </aside>
    ...
    `).join("")}function Ht(i=[]){return i.map(l=>`
    ...
    `).join("")}function Kt(i,l=!1){return`
        <button 
            ...
            <p class="text-sm leading-relaxed ${l?"text-white/90":"text-slate-500"}">
                ${B(i.desarrollo).slice(0,185)}${String(i.desarrollo).length>185?"...":""}
            </p>
        </button>
    `}function _t(i){const l=i.proyectosAsociados&&i.proyectosAsociados.length>0,b=i.publicacionesClave&&i.publicacionesClave.length>0;return`
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${B(i.categoria)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Prioridad</p>
                        <p class="text-slate-800 font-bold mt-1">${B(i.prioridad)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Aplicaciones</p>
                        <p class="text-slate-800 font-bold mt-1">${i.aplicaciones?.length||0}</p>
                    </div>
                </div>
    ...
    `}function Jt(){const i=new Set(ae.map(t=>t.categoria)),l=ae.filter(t=>t.proyectosAsociados?.length>0).length,b=ae.filter(t=>t.publicacionesClave?.length>0).length;return{total:ae.length,categorias:i.size,conProyectos:l,conPublicaciones:b}}function Qt(){let i=ae[0]?.id||1;const l=document.createElement("section");l.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const b=()=>{const t=Gt(i),s=Jt();l.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${F(i.institucion)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Tipo</p>
                        <p class="text-slate-800 font-bold mt-1">${F(i.tipo)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Duración estimada</p>
                        <p class="text-slate-800 font-bold mt-1">${F(i.duracion)}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        ...
                        <p class="text-slate-700 font-semibold mt-1">${F(i.fechaInicio)}</p>
                    </div>

                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Fecha final prevista</p>
                        <p class="text-slate-700 font-semibold mt-1">${F(i.fechaFinalizacion)}</p>
                    </div>
                </div>
    ...
    `}function er(){let i=de[0]?.id||1;const l=document.createElement("section");l.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const b=()=>{const t=Yt(i);l.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,l.querySelectorAll("[data-proyecto-id]").forEach(s=>{s.onclick=()=>{i=parseInt(s.dataset.proyectoId),b()}})};return b(),l}function ar(){return er()}function tr(){return`
    ...
    `}function nr(){const i=document.createElement("section");return i.classList.add("w-full","tabletBig:w-7xl"),i.innerHTML=`
    ${rr()}
    `,i}function ir(){const i=document.getElementById("contactForm");i&&i.addEventListener("submit",or)}async function or(i){i.preventDefault();const l=i.target,b=new FormData(l),t=Object.fromEntries(b.entries()),s=sr(t);if(s.length>0){cr(s);return}await dr(l,t)}function sr(i){const l=[];return i.nombre?.trim()||l.push("El nombre es obligatorio."),i.asunto?.trim()||l.push("El asunto es obligatorio."),i.mensaje?.trim()||l.push("El mensaje es obligatorio."),i.correo?.trim()?lr(i.correo)||l.push("El formato del correo no es válido."):l.push("El correo es obligatorio."),l}function lr(i){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i)}function cr(i){he(i[0],"error")}function he(i,l="success"){const b=document.querySelector(".custom-toast");b&&b.remove();const t=document.createElement("div");t.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,l==="success"?t.classList.add("bg-green-600"):t.classList.add("bg-red-600"),t.textContent=i,document.body.appendChild(t),setTimeout(()=>{t.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{t.classList.add("translate-x-full","opacity-0"),setTimeout(()=>t.remove(),300)},3e3)}async function dr(i,l){const b=document.getElementById("submitBtn");b.disabled=!0,b.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(l)})).ok?(he("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),i.reset()):he("Hubo un problema al enviar el mensaje.","error")}catch{he("Error de conexión. Intenta nuevamente.","error")}b.disabled=!1,b.textContent="Enviar"}function ur(){const i=nr();return setTimeout(()=>{ir()},0),i}function pr(){const i=document.createElement("section");i.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",i.innerHTML=`
...
A00116736    13    7"
    ...
    `;const l=i.querySelector("#banner-primer-input"),b=i.querySelector("#banner-primer-process"),t=i.querySelector("#banner-primer-clear"),s=i.querySelector("#banner-primer-message"),k=i.querySelector("#banner-primer-preview"),f=i.querySelector("#banner-primer-count"),h=i.querySelector("#banner-primer-download-1ac"),v=i.querySelector("#banner-primer-download-2pp");let o=[];function e(y,A="success"){s.textContent=y,s.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),A==="error"?s.classList.add("border-red-200","bg-red-50","text-red-800"):s.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function a(){s.textContent="",s.classList.add("hidden")}function r(y){return String(y).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function n(y){return String(y).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function c(y){const A=String(y).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return A.includes("	")?A.split("	").map(C=>C.trim()).filter(C=>C!==""):A.includes(";")?A.split(";").map(C=>C.trim()).filter(C=>C!==""):A.split(/\s+/).map(C=>C.trim()).filter(C=>C!=="")}function d(y){const A=y.split(/\r?\n/).map(P=>P.trim()).filter(Boolean),C=[],E=[],$=new Set;return A.forEach((P,z)=>{const L=z+1,q=c(P);if(q.length!==3){E.push(`Línea ${L}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const V=r(q[0]),G=Number(n(q[1])),R=Number(n(q[2]));if(!/^A[0-9]{8}$/.test(V)){E.push(`Línea ${L}: la matrícula "${V}" no es válida. Debe tener el formato A00108671.`);return}if($.has(V)){E.push(`Línea ${L}: la matrícula ${V} está repetida.`);return}if(!Number.isFinite(G)){E.push(`Línea ${L}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(R)){E.push(`Línea ${L}: la calificación 2PP no es numérica.`);return}if(G<0||G>15){E.push(`Línea ${L}: 1AC debe estar entre 0 y 15.`);return}if(R<0||R>20){E.push(`Línea ${L}: 2PP debe estar entre 0 y 20.`);return}const _=G+R;if(_>35){E.push(`Línea ${L}: la suma de 1AC y 2PP no puede superar 35 puntos.`);return}$.add(V),C.push({matricula:V,grade1AC:G,grade2PP:R,total:_})}),{records:C,errors:E}}function u(y){return Number.isInteger(y)?String(y):y.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function g(y){return String(y).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function x(y){if(y.length===0){k.innerHTML=`
                <tr>
                    <td
                        colspan="5"
                        class="px-4 py-10 text-center text-slate-400"
...
A00116736    25"
    ...
    `;const l=i.querySelector("#banner-segundo-input"),b=i.querySelector("#banner-segundo-process"),t=i.querySelector("#banner-segundo-clear"),s=i.querySelector("#banner-segundo-message"),k=i.querySelector("#banner-segundo-preview"),f=i.querySelector("#banner-segundo-count"),h=i.querySelector("#banner-segundo-download");let v=[];function o(m){return String(m).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function e(m){return String(m).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function a(m){const w=String(m).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return w.includes("	")?w.split("	").map(y=>y.trim()).filter(y=>y!==""):w.includes(";")?w.split(";").map(y=>y.trim()).filter(y=>y!==""):w.split(/\s+/).map(y=>y.trim()).filter(y=>y!=="")}function r(m){return Number.isInteger(m)?String(m):m.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function n(m){return String(m).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function c(m,w="success"){s.textContent=m,s.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),w==="error"?s.classList.add("border-red-200","bg-red-50","text-red-800"):s.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function d(m){const w=m.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),y=[],A=[],C=new Set;return w.forEach((E,$)=>{const P=$+1,z=a(E);if(z.length!==2){A.push(`Línea ${P}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const L=o(z[0]),q=Number(e(z[1]));if(!/^A[0-9]{8}$/.test(L)){A.push(`Línea ${P}: la matrícula "${L}" no es válida. Debe tener el formato A00108671.`);return}if(C.has(L)){A.push(`Línea ${P}: la matrícula ${L} está repetida.`);return}if(!Number.isFinite(q)){A.push(`Línea ${P}: la calificación 3SP no es numérica.`);return}if(q<0||q>35){A.push(`Línea ${P}: 3SP debe estar entre 0 y 35.`);return}C.add(L),y.push({matricula:L,grade3SP:q})}),{records:y,errors:A}}function u(m){if(m.length===0){k.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
...
A00116736    20"
    ...
    `;const l=i.querySelector("#banner-final-input"),b=i.querySelector("#banner-final-process"),t=i.querySelector("#banner-final-clear"),s=i.querySelector("#banner-final-message"),k=i.querySelector("#banner-final-preview"),f=i.querySelector("#banner-final-count"),h=i.querySelector("#banner-final-download");let v=[];function o(m){return String(m).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function e(m){return String(m).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function a(m){const w=String(m).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return w.includes("	")?w.split("	").map(y=>y.trim()).filter(y=>y!==""):w.includes(";")?w.split(";").map(y=>y.trim()).filter(y=>y!==""):w.split(/\s+/).map(y=>y.trim()).filter(y=>y!=="")}function r(m){return Number.isInteger(m)?String(m):m.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function n(m){return String(m).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function c(m,w="success"){s.textContent=m,s.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),w==="error"?s.classList.add("border-red-200","bg-red-50","text-red-800"):s.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function d(m){const w=m.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),y=[],A=[],C=new Set;return w.forEach((E,$)=>{const P=$+1,z=a(E);if(z.length!==2){A.push(`Línea ${P}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const L=o(z[0]),q=Number(e(z[1]));if(!/^A[0-9]{8}$/.test(L)){A.push(`Línea ${P}: la matrícula "${L}" no es válida. Debe tener el formato A00108671.`);return}if(C.has(L)){A.push(`Línea ${P}: la matrícula ${L} está repetida.`);return}if(!Number.isFinite(q)){A.push(`Línea ${P}: la calificación 4EF no es numérica.`);return}if(q<0||q>30){A.push(`Línea ${P}: 4EF debe estar entre 0 y 30.`);return}C.add(L),y.push({matricula:L,grade4EF:q})}),{records:y,errors:A}}function u(m){if(m.length===0){k.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
...
`)}function x(m,w){const y=new Blob(["\uFEFF"+m],{type:"text/csv;charset=utf-8;"}),A=URL.createObjectURL(y),C=document.createElement("a");C.href=A,C.download=w,document.body.appendChild(C),C.click(),C.remove(),window.setTimeout(()=>{URL.revokeObjectURL(A)},1e3)}function p(){v=[],l.value="",u([]),h.disabled=!0,s.textContent="",s.classList.add("hidden"),l.focus()}return b.addEventListener("click",()=>{const m=l.value.trim();if(!m){v=[],u([]),h.disabled=!0,c("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:w,errors:y}=d(m);if(y.length>0){v=[],u([]),h.disabled=!0,c(y.join(" "),"error");return}v=w,u(w),h.disabled=!1,c(`Los datos de ${w.length} estudiante${w.length===1?"":"s"} fueron validados correctamente.`)}),t.addEventListener("click",p),h.addEventListener("click",()=>{v.length!==0&&x(g(v),"Banner_APEC_Examen_Final_4EF.csv")}),i}function br(){const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",i.innerHTML=`
        <div id="banner-menu">
    ...
    `;const l=i.querySelector("#banner-menu"),b=i.querySelector("#banner-tool-view"),t=i.querySelector("#banner-tool-content"),s=i.querySelector("#open-primer-periodo"),k=i.querySelector("#open-segundo-periodo"),f=i.querySelector("#open-calificacion-final"),h=i.querySelector("#banner-back");function v(){l.classList.add("hidden"),b.classList.remove("hidden"),window.requestAnimationFrame(()=>{i.scrollIntoView({behavior:"smooth",block:"start"})})}function o(r){console.error("No fue posible abrir la herramienta de Banner:",r),t.innerHTML=`
            <div
        ...
        `,v()}function e(r){t.innerHTML="";try{if(typeof r!="function")throw new TypeError("El componente seleccionado no es una función válida.");const n=r();if(!(n instanceof HTMLElement))throw new TypeError("El componente seleccionado no devolvió un elemento HTML válido.");t.appendChild(n),v()}catch(n){o(n)}}function a(){t.replaceChildren(),b.classList.add("hidden"),l.classList.remove("hidden"),window.requestAnimationFrame(()=>{i.scrollIntoView({behavior:"smooth",block:"start"})})}return s.addEventListener("click",()=>{e(pr)}),k.addEventListener("click",()=>{e(mr)}),f.addEventListener("click",()=>{e(fr)}),h.addEventListener("click",a),i}function gr(){const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-8",i.innerHTML=`
        <div class="mb-8 text-center">
...
20252000     0"
    ...
    `;const l=i.querySelector("#xmera-input"),b=i.querySelector("#xmera-output"),t=i.querySelector("#xmera-generate"),s=i.querySelector("#xmera-copy"),k=i.querySelector("#xmera-clear"),f=i.querySelector("#xmera-message"),h=i.querySelector("#tab-xmera"),v=i.querySelector("#tab-banner"),o=i.querySelector("#panel-xmera"),e=i.querySelector("#panel-banner");function a(){b.textContent=`var data_todo = {
};`,s.disabled=!0}function r(u,g="success"){f.textContent=u,f.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),f.classList.add("border"),g==="error"?f.classList.add("border-red-200","bg-red-50","text-red-800"):f.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function n(u){const g=u.split(/\r?\n/).map(w=>w.trim()).filter(Boolean),x=[],p=[],m=new Set;return g.forEach((w,y)=>{const A=w.split(/[\t,; ]+/).map(z=>z.trim()).filter(Boolean),C=y+1,E=A[0],$=A.slice(1);if(!E){p.push(`Línea ${C}: falta la matrícula.`);return}if(!/^\d+$/.test(E)){p.push(`Línea ${C}: la matrícula "${E}" no es válida.`);return}if(m.has(E)){p.push(`Línea ${C}: la matrícula ${E} está repetida.`);return}if($.length===0){p.push(`Línea ${C}: falta al menos una calificación.`);return}const P=$.map(z=>Number(z));if(P.some(z=>!Number.isFinite(z))){p.push(`Línea ${C}: existe una calificación no numérica.`);return}m.add(E),x.push({matricula:E,grades:P})}),{records:x,errors:p}}function c(u){return`var data_todo = {
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
        ...
        `}return h.addEventListener("click",()=>{d("xmera")}),v.addEventListener("click",()=>{d("banner")}),d("xmera"),i}function xr(){return gr()}function vr(){const i=document.createElement("section");return i.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,i.innerHTML=`
    ...
    `,i}function De(i,l,b,t,s,k){return`
        <article class="
            h-full bg-white
            border border-slate-200
            rounded-3xl p-7
    ...
    `}function X(i,l,b,t,s,k,f=""){return`
        <article class="
    ...
    `}function H(i,l="w-7 h-7"){const b=`
        class="${l}"
        viewBox="0 0 24 24"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
    ...
    `}function Er(i){const{tipoVariable:l,numeroGrupos:b,relacion:t,normalidad:s,varianzas:k}=i;if(l==="categorica")return b==="uno"?D("Prueba binomial o chi-cuadrado de bondad de ajuste","Contrasta frecuencias o proporciones observadas con valores teóricos.","w de Cohen o diferencia de proporciones."):t==="relacionadas"?b==="dos"?D("Prueba de McNemar","Compara proporciones dicotómicas en muestras relacionadas o mediciones antes-después.","Odds ratio pareada o diferencia de proporciones pareadas."):D("Prueba Q de Cochran","Compara una respuesta dicotómica en tres o más condiciones relacionadas.","Medida de concordancia o diferencias de proporciones."):D("Chi-cuadrado de independencia","Evalúa la asociación entre variables categóricas en grupos independientes. Considere Fisher si hay frecuencias esperadas pequeñas.","V de Cramér.");const f=l==="ordinal"||s==="no"||s==="no-se";return b==="uno"?f?D("Prueba de rangos con signo de Wilcoxon","Compara la mediana de una muestra con un valor de referencia sin asumir normalidad.","Correlación biserial por rangos o r."):D("t de Student para una muestra","Compara la media de una muestra con un valor teórico bajo normalidad aproximada.","d de Cohen para una muestra."):b==="dos"?t==="relacionadas"?f?D("Prueba de rangos con signo de Wilcoxon","Compara dos mediciones relacionadas con datos ordinales o no normales.","Correlación biserial por rangos o r."):D("t de Student para muestras relacionadas","Compara las medias de dos mediciones pareadas.","d de Cohen para datos pareados."):f?D("Prueba U de Mann–Whitney","Compara dos grupos independientes con datos ordinales o no normales.","Delta de Cliff o correlación biserial por rangos."):k==="si"?D("t de Student para muestras independientes","Compara dos medias independientes con normalidad y varianzas homogéneas.","d de Cohen o g de Hedges."):D("t de Welch para muestras independientes","Compara dos medias independientes sin exigir igualdad de varianzas.","g de Hedges con intervalo de confianza."):t==="relacionadas"?f?D("Prueba de Friedman","Compara tres o más mediciones relacionadas con datos ordinales o no normales.","W de Kendall."):D("ANOVA de medidas repetidas","Compara tres o más medias relacionadas. Debe evaluarse la esfericidad.","Eta cuadrado parcial."):f?D("Prueba de Kruskal–Wallis","Compara tres o más grupos independientes con datos ordinales o no normales.","Épsilon cuadrado."):k==="si"?D("ANOVA de un factor","Compara tres o más medias independientes con normalidad y homogeneidad de varianzas.","Eta cuadrado u omega cuadrado."):D("ANOVA de Welch","Compara tres o más medias independientes cuando las varianzas son desiguales o dudosas.","Omega cuadrado ajustado y Games–Howell.")}function Pr(i){return i.tipoRelacion==="dicotomica-cuantitativa"?D("Correlación punto-biserial","Relaciona una variable dicotómica genuina con una variable cuantitativa. Es algebraicamente equivalente a una t de Student para dos grupos.","Coeficiente r punto-biserial con intervalo de confianza."):i.tipoRelacion==="ordinales"?i.empates==="si"||i.empates==="no-se"?D("Tau-b de Kendall","Es adecuada para variables ordinales, muestras pequeñas y situaciones con numerosos empates.","Tau-b de Kendall con intervalo de confianza."):D("Rho de Spearman","Evalúa una relación monotónica entre variables ordinales o cuantitativas transformadas en rangos.","Rho de Spearman con intervalo de confianza."):i.normalidad!=="si"?D("Rho de Spearman","No exige normalidad y mide relaciones monotónicas mediante rangos.","Rho de Spearman con intervalo de confianza."):i.linealidad==="si"?D("Correlación de Pearson","Las variables son cuantitativas, aproximadamente normales y presentan una relación lineal.","r de Pearson y su intervalo de confianza."):i.linealidad==="monotonica"?D("Rho de Spearman","La relación es monotónica, pero no claramente lineal; Spearman resume adecuadamente asociaciones crecientes o decrecientes mediante rangos.","Rho de Spearman con intervalo de confianza."):i.linealidad==="no-monotonica"?D("No resumir la relación con un único coeficiente de correlación","Una relación no monotónica puede producir coeficientes cercanos a cero aunque exista una asociación importante. Conviene estudiar el diagrama de dispersión y considerar modelos no lineales, regresión segmentada o suavizadores.","Reporte gráfico, R² de un modelo adecuado y medidas de ajuste."):D("Revisión gráfica antes de elegir el coeficiente","Sin conocer la forma de la relación no es metodológicamente seguro escoger Pearson o Spearman. Examine primero el diagrama de dispersión.","Diagrama de dispersión y, después, el coeficiente acorde con la forma observada.")}function D(i,l,b){return{nombre:i,razon:l,efecto:b}}function Ee(i){return{id:i.id,nombre:i.prueba,razon:i.descripcion,categoria:i.categoria,tipo:i.tipo,efecto:i.efecto}}function $r(i){const l=Ce(i),b=l.id==="sin-regla"?Er(i):Ee(l);return Pe(b)}function Lr(i){const l=Ce(i),b=l.id==="sin-regla"?Pr(i):Ee(l);return Pe(b)}function zr(i){const l=Ce(i),b=l.id==="sin-regla"?{nombre:"Revisión metodológica requerida",razon:"Las respuestas no coinciden todavía con una regla de asociación disponible.",efecto:"El tamaño del efecto dependerá de la estructura final de la tabla."}:Ee(l);return Pe(b)}function qr(i){const l=Ce(i),b=l.id==="sin-regla"?{nombre:"Revisión metodológica requerida",razon:"Las respuestas seleccionadas todavía no coinciden con una regla de predicción disponible.",efecto:"Las medidas de ajuste dependerán del tipo de variable resultado y del modelo seleccionado."}:Ee(l);return Pe(b)}function Dr(i){return{"t-student-independientes":"student","t-welch-independientes":"welch","mann-whitney":"mann-whitney"}[i]||""}function Pe(i){const l=i.id&&ba(i.id),b=Dr(i.id);return`
    ...
    `}function Ir(i,l){return`
        <section class="rounded-3xl border border-blue-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                ${ge("¿Qué es?",i.definicion)}

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    ${se("¿Cuándo utilizarla?",i.cuandoUsar)}

                    ${se("Supuestos",i.supuestos)}
                </div>

                ${Rr(i.hipotesis)}

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    ${ge("Estadístico de prueba",i.estadistico)}

                    ${ge("Tamaño del efecto",i.efecto)}
                </div>

                ${Nr(i.reporteAPA)}

                ${i.posthoc?.length?se("Análisis posteriores",i.posthoc):""}

                ${i.alternativas?.length?se("Pruebas y procedimientos alternativos",i.alternativas):""}

                ${i.erroresFrecuentes?.length?se("Errores frecuentes",i.erroresFrecuentes,"advertencia"):""}

                ${ge("Ejemplo de investigación",i.ejemplo)}

                ${i.referencias?.length?se("Referencias recomendadas",i.referencias,"referencias"):""}
    ...
    `:""}function Fr(i){return`
        <section class="rounded-3xl border border-sky-200 bg-white shadow-xl p-8 md:p-12 text-center">
            ...
            <h1 class="text-3xl md:text-4xl font-black text-slate-900 mb-4">
                ${{predecir:"Predicción y modelización",instrumento:"Evaluación de instrumentos",otro:"Otros análisis"}[i]||"Módulo metodológico"}
            </h1>
    ...
    `}function Or(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var we={exports:{}},Ur=we.exports,je;function Br(){return je||(je=1,(function(i,l){(function(b,t){i.exports=t()})(Ur,function(){var b=(function(t,s){var k=Array.prototype.concat,f=Array.prototype.slice,h=Object.prototype.toString;function v(x,p){var m=x>p?x:p;return t.pow(10,17-~~(t.log(m>0?m:-m)*t.LOG10E))}var o=Array.isArray||function(p){return h.call(p)==="[object Array]"};function e(x){return h.call(x)==="[object Function]"}function a(x){return typeof x=="number"?x-x===0:!1}function r(x){return k.apply([],x)}function n(){return new n._init(arguments)}n.fn=n.prototype,n._init=function(p){if(o(p[0]))if(o(p[0][0])){e(p[1])&&(p[0]=n.map(p[0],p[1]));for(var m=0;m<p[0].length;m++)this[m]=p[0][m];this.length=p[0].length}else this[0]=e(p[1])?n.map(p[0],p[1]):p[0],this.length=1;else if(a(p[0]))this[0]=n.seq.apply(null,p),this.length=1;else{if(p[0]instanceof n)return n(p[0].toArray());this[0]=[],this.length=1}return this},n._init.prototype=n.prototype,n._init.constructor=n,n.utils={calcRdx:v,isArray:o,isFunction:e,isNumber:a,toVector:r},n._random_fn=t.random,n.setRandom=function(p){if(typeof p!="function")throw new TypeError("fn is not a function");n._random_fn=p},n.extend=function(p){var m,w;if(arguments.length===1){for(w in p)n[w]=p[w];return this}for(m=1;m<arguments.length;m++)for(w in arguments[m])p[w]=arguments[m][w];return p},n.rows=function(p){return p.length||1},n.cols=function(p){return p[0].length||1},n.dimensions=function(p){return{rows:n.rows(p),cols:n.cols(p)}},n.row=function(p,m){return o(m)?m.map(function(w){return n.row(p,w)}):p[m]},n.rowa=function(p,m){return n.row(p,m)},n.col=function(p,m){if(o(m)){var w=n.arange(p.length).map(function(){return new Array(m.length)});return m.forEach(function(C,E){n.arange(p.length).forEach(function($){w[$][E]=p[$][C]})}),w}for(var y=new Array(p.length),A=0;A<p.length;A++)y[A]=[p[A][m]];return y},n.cola=function(p,m){return n.col(p,m).map(function(w){return w[0]})},n.diag=function(p){for(var m=n.rows(p),w=new Array(m),y=0;y<m;y++)w[y]=[p[y][y]];return w},n.antidiag=function(p){for(var m=n.rows(p)-1,w=new Array(m),y=0;m>=0;m--,y++)w[y]=[p[y][m]];return w},n.transpose=function(p){var m=[],w,y,A,C,E;for(o(p[0])||(p=[p]),y=p.length,A=p[0].length,E=0;E<A;E++){for(w=new Array(y),C=0;C<y;C++)w[C]=p[C][E];m.push(w)}return m.length===1?m[0]:m},n.map=function(p,m,w){var y,A,C,E,$;for(o(p[0])||(p=[p]),A=p.length,C=p[0].length,E=w?p:new Array(A),y=0;y<A;y++)for(E[y]||(E[y]=new Array(C)),$=0;$<C;$++)E[y][$]=m(p[y][$],y,$);return E.length===1?E[0]:E},n.cumreduce=function(p,m,w){var y,A,C,E,$;for(o(p[0])||(p=[p]),A=p.length,C=p[0].length,E=w?p:new Array(A),y=0;y<A;y++)for(E[y]||(E[y]=new Array(C)),C>0&&(E[y][0]=p[y][0]),$=1;$<C;$++)E[y][$]=m(E[y][$-1],p[y][$]);return E.length===1?E[0]:E},n.alter=function(p,m){return n.map(p,m,!0)},n.create=function(p,m,w){var y=new Array(p),A,C;for(e(m)&&(w=m,m=p),A=0;A<p;A++)for(y[A]=new Array(m),C=0;C<m;C++)y[A][C]=w(A,C);return y};function c(){return 0}n.zeros=function(p,m){return a(m)||(m=p),n.create(p,m,c)};function d(){return 1}n.ones=function(p,m){return a(m)||(m=p),n.create(p,m,d)},n.rand=function(p,m){return a(m)||(m=p),n.create(p,m,n._random_fn)};function u(x,p){return x===p?1:0}n.identity=function(p,m){return a(m)||(m=p),n.create(p,m,u)},n.symmetric=function(p){var m=p.length,w,y;if(p.length!==p[0].length)return!1;for(w=0;w<m;w++)for(y=0;y<m;y++)if(p[y][w]!==p[w][y])return!1;return!0},n.clear=function(p){return n.alter(p,c)},n.seq=function(p,m,w,y){e(y)||(y=!1);var A=[],C=v(p,m),E=(m*C-p*C)/((w-1)*C),$=p,P;for(P=0;$<=m&&P<w;P++,$=(p*C+E*C*P)/C)A.push(y?y($,P):$);return A},n.arange=function(p,m,w){var y=[],A;if(w=w||1,m===s&&(m=p,p=0),p===m||w===0)return[];if(p<m&&w<0)return[];if(p>m&&w>0)return[];if(w>0)for(A=p;A<m;A+=w)y.push(A);else for(A=p;A>m;A+=w)y.push(A);return y},n.slice=(function(){function x(m,w,y,A){var C,E=[],$=m.length;if(w===s&&y===s&&A===s)return n.copy(m);if(w=w||0,y=y||m.length,w=w>=0?w:$+w,y=y>=0?y:$+y,A=A||1,w===y||A===0)return[];if(w<y&&A<0)return[];if(w>y&&A>0)return[];if(A>0)for(C=w;C<y;C+=A)E.push(m[C]);else for(C=w;C>y;C+=A)E.push(m[C]);return E}function p(m,w){var y,A;if(w=w||{},a(w.row)){if(a(w.col))return m[w.row][w.col];var C=n.rowa(m,w.row);return y=w.col||{},x(C,y.start,y.end,y.step)}if(a(w.col)){var E=n.cola(m,w.col);return A=w.row||{},x(E,A.start,A.end,A.step)}A=w.row||{},y=w.col||{};var $=x(m,A.start,A.end,A.step);return $.map(function(P){return x(P,y.start,y.end,y.step)})}return p})(),n.sliceAssign=function(p,m,w){var y,A;if(a(m.row)){if(a(m.col))return p[m.row][m.col]=w;m.col=m.col||{},m.col.start=m.col.start||0,m.col.end=m.col.end||p[0].length,m.col.step=m.col.step||1,y=n.arange(m.col.start,t.min(p.length,m.col.end),m.col.step);var C=m.row;return y.forEach(function($,P){p[C][$]=w[P]}),p}if(a(m.col)){m.row=m.row||{},m.row.start=m.row.start||0,m.row.end=m.row.end||p.length,m.row.step=m.row.step||1,A=n.arange(m.row.start,t.min(p[0].length,m.row.end),m.row.step);var E=m.col;return A.forEach(function($,P){p[$][E]=w[P]}),p}return w[0].length===s&&(w=[w]),m.row.start=m.row.start||0,m.row.end=m.row.end||p.length,m.row.step=m.row.step||1,m.col.start=m.col.start||0,m.col.end=m.col.end||p[0].length,m.col.step=m.col.step||1,A=n.arange(m.row.start,t.min(p.length,m.row.end),m.row.step),y=n.arange(m.col.start,t.min(p[0].length,m.col.end),m.col.step),A.forEach(function($,P){y.forEach(function(z,L){p[$][z]=w[P][L]})}),p},n.diagonal=function(p){var m=n.zeros(p.length,p.length);return p.forEach(function(w,y){m[y][y]=w}),m},n.copy=function(p){return p.map(function(m){return a(m)?m:m.map(function(w){return w})})};var g=n.prototype;return g.length=0,g.push=Array.prototype.push,g.sort=Array.prototype.sort,g.splice=Array.prototype.splice,g.slice=Array.prototype.slice,g.toArray=function(){return this.length>1?f.call(this):f.call(this)[0]},g.map=function(p,m){return n(n.map(this,p,m))},g.cumreduce=function(p,m){return n(n.cumreduce(this,p,m))},g.alter=function(p){return n.alter(this,p),this},(function(x){for(var p=0;p<x.length;p++)(function(m){g[m]=function(w){var y=this,A;return w?(setTimeout(function(){w.call(y,g[m].call(y))}),this):(A=n[m](this),o(A)?n(A):A)}})(x[p])})("transpose clear symmetric rows cols dimensions diag antidiag".split(" ")),(function(x){for(var p=0;p<x.length;p++)(function(m){g[m]=function(w,y){var A=this;return y?(setTimeout(function(){y.call(A,g[m].call(A,w))}),this):n(n[m](this,w))}})(x[p])})("row col".split(" ")),(function(x){for(var p=0;p<x.length;p++)(function(m){g[m]=function(){return n(n[m].apply(null,arguments))}})(x[p])})("create zeros ones rand identity".split(" ")),n})(Math);return(function(t,s){var k=t.utils.isFunction;function f(o,e){return o-e}function h(o,e,a){return s.max(e,s.min(o,a))}t.sum=function(e){for(var a=0,r=e.length;--r>=0;)a+=e[r];return a},t.sumsqrd=function(e){for(var a=0,r=e.length;--r>=0;)a+=e[r]*e[r];return a},t.sumsqerr=function(e){for(var a=t.mean(e),r=0,n=e.length,c;--n>=0;)c=e[n]-a,r+=c*c;return r},t.sumrow=function(e){for(var a=0,r=e.length;--r>=0;)a+=e[r];return a},t.product=function(e){for(var a=1,r=e.length;--r>=0;)a*=e[r];return a},t.min=function(e){for(var a=e[0],r=0;++r<e.length;)e[r]<a&&(a=e[r]);return a},t.max=function(e){for(var a=e[0],r=0;++r<e.length;)e[r]>a&&(a=e[r]);return a},t.unique=function(e){for(var a={},r=[],n=0;n<e.length;n++)a[e[n]]||(a[e[n]]=!0,r.push(e[n]));return r},t.mean=function(e){return t.sum(e)/e.length},t.meansqerr=function(e){return t.sumsqerr(e)/e.length},t.geomean=function(e){var a=e.map(s.log),r=t.mean(a);return s.exp(r)},t.median=function(e){var a=e.length,r=e.slice().sort(f);return a&1?r[a/2|0]:(r[a/2-1]+r[a/2])/2},t.cumsum=function(e){return t.cumreduce(e,function(a,r){return a+r})},t.cumprod=function(e){return t.cumreduce(e,function(a,r){return a*r})},t.diff=function(e){var a=[],r=e.length,n;for(n=1;n<r;n++)a.push(e[n]-e[n-1]);return a},t.rank=function(o){var e,a=[],r={};for(e=0;e<o.length;e++){var n=o[e];r[n]?r[n]++:(r[n]=1,a.push(n))}var c=a.sort(f),d={},u=1;for(e=0;e<c.length;e++){var n=c[e],g=r[n],x=u,p=u+g-1,m=(x+p)/2;d[n]=m,u+=g}return o.map(function(w){return d[w]})},t.mode=function(e){var a=e.length,r=e.slice().sort(f),n=1,c=0,d=0,u=[],g;for(g=0;g<a;g++)r[g]===r[g+1]?n++:(n>c?(u=[r[g]],c=n,d=0):n===c&&(u.push(r[g]),d++),n=1);return d===0?u[0]:u},t.range=function(e){return t.max(e)-t.min(e)},t.variance=function(e,a){return t.sumsqerr(e)/(e.length-(a?1:0))},t.pooledvariance=function(e){var a=e.reduce(function(n,c){return n+t.sumsqerr(c)},0),r=e.reduce(function(n,c){return n+c.length},0);return a/(r-e.length)},t.deviation=function(o){for(var e=t.mean(o),a=o.length,r=new Array(a),n=0;n<a;n++)r[n]=o[n]-e;return r},t.stdev=function(e,a){return s.sqrt(t.variance(e,a))},t.pooledstdev=function(e){return s.sqrt(t.pooledvariance(e))},t.meandev=function(e){for(var a=t.mean(e),r=[],n=e.length-1;n>=0;n--)r.push(s.abs(e[n]-a));return t.mean(r)},t.meddev=function(e){for(var a=t.median(e),r=[],n=e.length-1;n>=0;n--)r.push(s.abs(e[n]-a));return t.median(r)},t.coeffvar=function(e){return t.stdev(e)/t.mean(e)},t.quartiles=function(e){var a=e.length,r=e.slice().sort(f);return[r[s.round(a/4)-1],r[s.round(a/2)-1],r[s.round(a*3/4)-1]]},t.quantiles=function(e,a,r,n){var c=e.slice().sort(f),d=[a.length],u=e.length,g,x,p,m,w,y;for(typeof r>"u"&&(r=3/8),typeof n>"u"&&(n=3/8),g=0;g<a.length;g++)x=a[g],p=r+x*(1-r-n),m=u*x+p,w=s.floor(h(m,1,u-1)),y=h(m-w,0,1),d[g]=(1-y)*c[w-1]+y*c[w];return d},t.percentile=function(e,a,r){var n=e.slice().sort(f),c=a*(n.length+(r?1:-1))+(r?0:1),d=parseInt(c),u=c-d;return d+1<n.length?n[d-1]+u*(n[d]-n[d-1]):n[d-1]},t.percentileOfScore=function(e,a,r){var n=0,c=e.length,d=!1,u,g;for(r==="strict"&&(d=!0),g=0;g<c;g++)u=e[g],(d&&u<a||!d&&u<=a)&&n++;return n/c},t.histogram=function(e,a){a=a||4;var r=t.min(e),n=(t.max(e)-r)/a,c=e.length,d=[],u;for(u=0;u<a;u++)d[u]=0;for(u=0;u<c;u++)d[s.min(s.floor((e[u]-r)/n),a-1)]+=1;return d},t.covariance=function(e,a){var r=t.mean(e),n=t.mean(a),c=e.length,d=new Array(c),u;for(u=0;u<c;u++)d[u]=(e[u]-r)*(a[u]-n);return t.sum(d)/(c-1)},t.corrcoeff=function(e,a){return t.covariance(e,a)/t.stdev(e,1)/t.stdev(a,1)},t.spearmancoeff=function(o,e){return o=t.rank(o),e=t.rank(e),t.corrcoeff(o,e)},t.stanMoment=function(e,a){for(var r=t.mean(e),n=t.stdev(e),c=e.length,d=0,u=0;u<c;u++)d+=s.pow((e[u]-r)/n,a);return d/e.length},t.skewness=function(e){return t.stanMoment(e,3)},t.kurtosis=function(e){return t.stanMoment(e,4)-3};var v=t.prototype;(function(o){for(var e=0;e<o.length;e++)(function(a){v[a]=function(r,n){var c=[],d=0,u=this;if(k(r)&&(n=r,r=!1),n)return setTimeout(function(){n.call(u,v[a].call(u,r))}),this;if(this.length>1){for(u=r===!0?this:this.transpose();d<u.length;d++)c[d]=t[a](u[d]);return c}return t[a](this[0],r)}})(o[e])})("cumsum cumprod".split(" ")),(function(o){for(var e=0;e<o.length;e++)(function(a){v[a]=function(r,n){var c=[],d=0,u=this;if(k(r)&&(n=r,r=!1),n)return setTimeout(function(){n.call(u,v[a].call(u,r))}),this;if(this.length>1){for(a!=="sumrow"&&(u=r===!0?this:this.transpose());d<u.length;d++)c[d]=t[a](u[d]);return r===!0?t[a](t.utils.toVector(c)):c}return t[a](this[0],r)}})(o[e])})("sum sumsqrd sumsqerr sumrow product min max unique mean meansqerr geomean median diff rank mode range variance deviation stdev meandev meddev coeffvar quartiles histogram skewness kurtosis".split(" ")),(function(o){for(var e=0;e<o.length;e++)(function(a){v[a]=function(){var r=[],n=0,c=this,d=Array.prototype.slice.call(arguments),u;if(k(d[d.length-1])){u=d[d.length-1];var g=d.slice(0,d.length-1);return setTimeout(function(){u.call(c,v[a].apply(c,g))}),this}else{u=void 0;var x=function(m){return t[a].apply(c,[m].concat(d))}}if(this.length>1){for(c=c.transpose();n<c.length;n++)r[n]=x(c[n]);return r}return x(this[0])}})(o[e])})("quantiles percentileOfScore".split(" "))})(b,Math),(function(t,s){t.gammaln=function(f){var h=0,v=[76.18009172947146,-86.50532032941678,24.01409824083091,-1.231739572450155,.001208650973866179,-5395239384953e-18],o=1.000000000190015,e,a,r;for(r=(a=e=f)+5.5,r-=(e+.5)*s.log(r);h<6;h++)o+=v[h]/++a;return s.log(2.5066282746310007*o/e)-r},t.loggam=function(f){var h,v,o,e,a,r,n,c=[.08333333333333333,-.002777777777777778,.0007936507936507937,-.0005952380952380952,.0008417508417508418,-.001917526917526918,.00641025641025641,-.02955065359477124,.1796443723688307,-1.3924322169059];if(h=f,n=0,f==1||f==2)return 0;for(f<=7&&(n=s.floor(7-f),h=f+n),v=1/(h*h),o=2*s.PI,a=c[9],r=8;r>=0;r--)a*=v,a+=c[r];if(e=a/h+.5*s.log(o)+(h-.5)*s.log(h)-h,f<=7)for(r=1;r<=n;r++)e-=s.log(h-1),h-=1;return e},t.gammafn=function(f){var h=[-1.716185138865495,24.76565080557592,-379.80425647094563,629.3311553128184,866.9662027904133,-31451.272968848367,-36144.413418691176,66456.14382024054],v=[-30.8402300119739,315.35062697960416,-1015.1563674902192,-3107.771671572311,22538.11842098015,4755.846277527881,-134659.9598649693,-115132.2596755535],o=!1,e=0,a=0,r=0,n=f,c,d,u,g;if(f>171.6243769536076)return 1/0;if(n<=0)if(g=n%1+36e-17,g)o=(n&1?-1:1)*s.PI/s.sin(s.PI*g),n=1-n;else return 1/0;for(u=n,n<1?d=n++:d=(n-=e=(n|0)-1)-1,c=0;c<8;++c)r=(r+h[c])*d,a=a*d+v[c];if(g=r/a+1,u<n)g/=u;else if(u>n)for(c=0;c<e;++c)g*=n,n++;return o&&(g=o/g),g},t.gammap=function(f,h){return t.lowRegGamma(f,h)*t.gammafn(f)},t.lowRegGamma=function(f,h){var v=t.gammaln(f),o=f,e=1/f,a=e,r=h+1-f,n=1/1e-30,c=1/r,d=c,u=1,g=-~(s.log(f>=1?f:1/f)*8.5+f*.4+17),x;if(h<0||f<=0)return NaN;if(h<f+1){for(;u<=g;u++)e+=a*=h/++o;return e*s.exp(-h+f*s.log(h)-v)}for(;u<=g;u++)x=-u*(u-f),r+=2,c=x*c+r,n=r+x/n,c=1/c,d*=c*n;return 1-d*s.exp(-h+f*s.log(h)-v)},t.factorialln=function(f){return f<0?NaN:t.gammaln(f+1)},t.factorial=function(f){return f<0?NaN:t.gammafn(f+1)},t.combination=function(f,h){return f>170||h>170?s.exp(t.combinationln(f,h)):t.factorial(f)/t.factorial(h)/t.factorial(f-h)},t.combinationln=function(f,h){return t.factorialln(f)-t.factorialln(h)-t.factorialln(f-h)},t.permutation=function(f,h){return t.factorial(f)/t.factorial(f-h)},t.betafn=function(f,h){if(!(f<=0||h<=0))return f+h>170?s.exp(t.betaln(f,h)):t.gammafn(f)*t.gammafn(h)/t.gammafn(f+h)},t.betaln=function(f,h){return t.gammaln(f)+t.gammaln(h)-t.gammaln(f+h)},t.betacf=function(f,h,v){var o=1e-30,e=1,a=h+v,r=h+1,n=h-1,c=1,d=1-a*f/r,u,g,x,p;for(s.abs(d)<o&&(d=o),d=1/d,p=d;e<=100&&(u=2*e,g=e*(v-e)*f/((n+u)*(h+u)),d=1+g*d,s.abs(d)<o&&(d=o),c=1+g/c,s.abs(c)<o&&(c=o),d=1/d,p*=d*c,g=-(h+e)*(a+e)*f/((h+u)*(r+u)),d=1+g*d,s.abs(d)<o&&(d=o),c=1+g/c,s.abs(c)<o&&(c=o),d=1/d,x=d*c,p*=x,!(s.abs(x-1)<3e-7));e++);return p},t.gammapinv=function(f,h){var v=0,o=h-1,e=1e-8,a=t.gammaln(h),r,n,c,d,u,g,x;if(f>=1)return s.max(100,h+100*s.sqrt(h));if(f<=0)return 0;for(h>1?(g=s.log(o),x=s.exp(o*(g-1)-a),u=f<.5?f:1-f,c=s.sqrt(-2*s.log(u)),r=(2.30753+c*.27061)/(1+c*(.99229+c*.04481))-c,f<.5&&(r=-r),r=s.max(.001,h*s.pow(1-1/(9*h)-r/(3*s.sqrt(h)),3))):(c=1-h*(.253+h*.12),f<c?r=s.pow(f/c,1/h):r=1-s.log(1-(f-c)/(1-c)));v<12;v++){if(r<=0)return 0;if(n=t.lowRegGamma(h,r)-f,h>1?c=x*s.exp(-(r-o)+o*(s.log(r)-g)):c=s.exp(-r+o*s.log(r)-a),d=n/c,r-=c=d/(1-.5*s.min(1,d*((h-1)/r-1))),r<=0&&(r=.5*(r+c)),s.abs(c)<e*r)break}return r},t.erf=function(f){var h=[-1.3026537197817094,.6419697923564902,.019476473204185836,-.00956151478680863,-.000946595344482036,.000366839497852761,42523324806907e-18,-20278578112534e-18,-1624290004647e-18,130365583558e-17,15626441722e-18,-85238095915e-18,6529054439e-18,5059343495e-18,-991364156e-18,-227365122e-18,96467911e-18,2394038e-18,-6886027e-18,894487e-18,313092e-18,-112708e-18,381e-18,7106e-18,-1523e-18,-94e-18,121e-18,-28e-18],v=h.length-1,o=!1,e=0,a=0,r,n,c,d;for(f<0&&(f=-f,o=!0),r=2/(2+f),n=4*r-2;v>0;v--)c=e,e=n*e-a+h[v],a=c;return d=r*s.exp(-f*f+.5*(h[0]+n*e)-a),o?d-1:1-d},t.erfc=function(f){return 1-t.erf(f)},t.erfcinv=function(f){var h=0,v,o,e,a;if(f>=2)return-100;if(f<=0)return 100;for(a=f<1?f:2-f,e=s.sqrt(-2*s.log(a/2)),v=-.70711*((2.30753+e*.27061)/(1+e*(.99229+e*.04481))-e);h<2;h++)o=t.erfc(v)-a,v+=o/(1.1283791670955126*s.exp(-v*v)-v*o);return f<1?v:-v},t.ibetainv=function(f,h,v){var o=1e-8,e=h-1,a=v-1,r=0,n,c,d,u,g,x,p,m,w,y,A;if(f<=0)return 0;if(f>=1)return 1;for(h>=1&&v>=1?(d=f<.5?f:1-f,u=s.sqrt(-2*s.log(d)),p=(2.30753+u*.27061)/(1+u*(.99229+u*.04481))-u,f<.5&&(p=-p),m=(p*p-3)/6,w=2/(1/(2*h-1)+1/(2*v-1)),y=p*s.sqrt(m+w)/w-(1/(2*v-1)-1/(2*h-1))*(m+5/6-2/(3*w)),p=h/(h+v*s.exp(2*y))):(n=s.log(h/(h+v)),c=s.log(v/(h+v)),u=s.exp(h*n)/h,g=s.exp(v*c)/v,y=u+g,f<u/y?p=s.pow(h*y*f,1/h):p=1-s.pow(v*y*(1-f),1/v)),A=-t.gammaln(h)-t.gammaln(v)+t.gammaln(h+v);r<10;r++){if(p===0||p===1)return p;if(x=t.ibeta(p,h,v)-f,u=s.exp(e*s.log(p)+a*s.log(1-p)+A),g=x/u,p-=u=g/(1-.5*s.min(1,g*(e/p-a/(1-p)))),p<=0&&(p=.5*(p+u)),p>=1&&(p=.5*(p+u+1)),s.abs(u)<o*p&&r>0)break}return p},t.ibeta=function(f,h,v){var o=f===0||f===1?0:s.exp(t.gammaln(h+v)-t.gammaln(h)-t.gammaln(v)+h*s.log(f)+v*s.log(1-f));return f<0||f>1?!1:f<(h+1)/(h+v+2)?o*t.betacf(f,h,v)/h:1-o*t.betacf(1-f,v,h)/v},t.randn=function(f,h){var v,o,e,a,r;if(h||(h=f),f)return t.create(f,h,function(){return t.randn()});do v=t._random_fn(),o=1.7156*(t._random_fn()-.5),e=v-.449871,a=s.abs(o)+.386595,r=e*e+a*(.196*a-.25472*e);while(r>.27597&&(r>.27846||o*o>-4*s.log(v)*v*v));return o/v},t.randg=function(f,h,v){var o=f,e,a,r,n,c,d;if(v||(v=h),f||(f=1),h)return d=t.zeros(h,v),d.alter(function(){return t.randg(f)}),d;f<1&&(f+=1),e=f-1/3,a=1/s.sqrt(9*e);do{do c=t.randn(),n=1+a*c;while(n<=0);n=n*n*n,r=t._random_fn()}while(r>1-.331*s.pow(c,4)&&s.log(r)>.5*c*c+e*(1-n+s.log(n)));if(f==o)return e*n;do r=t._random_fn();while(r===0);return s.pow(r,1/o)*e*n},(function(k){for(var f=0;f<k.length;f++)(function(h){t.fn[h]=function(){return t(t.map(this,function(v){return t[h](v)}))}})(k[f])})("gammaln gammafn factorial factorialln".split(" ")),(function(k){for(var f=0;f<k.length;f++)(function(h){t.fn[h]=function(){return t(t[h].apply(null,arguments))}})(k[f])})("randn".split(" "))})(b,Math),(function(t,s){(function(o){for(var e=0;e<o.length;e++)(function(a){t[a]=function r(n,c,d){return this instanceof r?(this._a=n,this._b=c,this._c=d,this):new r(n,c,d)},t.fn[a]=function(r,n,c){var d=t[a](r,n,c);return d.data=this,d},t[a].prototype.sample=function(r){var n=this._a,c=this._b,d=this._c;return r?t.alter(r,function(){return t[a].sample(n,c,d)}):t[a].sample(n,c,d)},(function(r){for(var n=0;n<r.length;n++)(function(c){t[a].prototype[c]=function(d){var u=this._a,g=this._b,x=this._c;return!d&&d!==0&&(d=this.data),typeof d!="number"?t.fn.map.call(d,function(p){return t[a][c](p,u,g,x)}):t[a][c](d,u,g,x)}})(r[n])})("pdf cdf inv".split(" ")),(function(r){for(var n=0;n<r.length;n++)(function(c){t[a].prototype[c]=function(){return t[a][c](this._a,this._b,this._c)}})(r[n])})("mean median mode variance".split(" "))})(o[e])})("beta centralF cauchy chisquare exponential gamma invgamma kumaraswamy laplace lognormal noncentralt normal pareto studentt weibull uniform binomial negbin hypgeom poisson triangular tukey arcsine".split(" ")),t.extend(t.beta,{pdf:function(e,a,r){return e>1||e<0?0:a==1&&r==1?1:a<512&&r<512?s.pow(e,a-1)*s.pow(1-e,r-1)/t.betafn(a,r):s.exp((a-1)*s.log(e)+(r-1)*s.log(1-e)-t.betaln(a,r))},cdf:function(e,a,r){return e>1||e<0?(e>1)*1:t.ibeta(e,a,r)},inv:function(e,a,r){return t.ibetainv(e,a,r)},mean:function(e,a){return e/(e+a)},median:function(e,a){return t.ibetainv(.5,e,a)},mode:function(e,a){return(e-1)/(e+a-2)},sample:function(e,a){var r=t.randg(e);return r/(r+t.randg(a))},variance:function(e,a){return e*a/(s.pow(e+a,2)*(e+a+1))}}),t.extend(t.centralF,{pdf:function(e,a,r){var n,c,d;return e<0?0:a<=2?e===0&&a<2?1/0:e===0&&a===2?1:1/t.betafn(a/2,r/2)*s.pow(a/r,a/2)*s.pow(e,a/2-1)*s.pow(1+a/r*e,-(a+r)/2):(n=a*e/(r+e*a),c=r/(r+e*a),d=a*c/2,d*t.binomial.pdf((a-2)/2,(a+r-2)/2,n))},cdf:function(e,a,r){return e<0?0:t.ibeta(a*e/(a*e+r),a/2,r/2)},inv:function(e,a,r){return r/(a*(1/t.ibetainv(e,a/2,r/2)-1))},mean:function(e,a){return a>2?a/(a-2):void 0},mode:function(e,a){return e>2?a*(e-2)/(e*(a+2)):void 0},sample:function(e,a){var r=t.randg(e/2)*2,n=t.randg(a/2)*2;return r/e/(n/a)},variance:function(e,a){if(!(a<=4))return 2*a*a*(e+a-2)/(e*(a-2)*(a-2)*(a-4))}}),t.extend(t.cauchy,{pdf:function(e,a,r){return r<0?0:r/(s.pow(e-a,2)+s.pow(r,2))/s.PI},cdf:function(e,a,r){return s.atan((e-a)/r)/s.PI+.5},inv:function(o,e,a){return e+a*s.tan(s.PI*(o-.5))},median:function(e){return e},mode:function(e){return e},sample:function(e,a){return t.randn()*s.sqrt(1/(2*t.randg(.5)))*a+e}}),t.extend(t.chisquare,{pdf:function(e,a){return e<0?0:e===0&&a===2?.5:s.exp((a/2-1)*s.log(e)-e/2-a/2*s.log(2)-t.gammaln(a/2))},cdf:function(e,a){return e<0?0:t.lowRegGamma(a/2,e/2)},inv:function(o,e){return 2*t.gammapinv(o,.5*e)},mean:function(o){return o},median:function(e){return e*s.pow(1-2/(9*e),3)},mode:function(e){return e-2>0?e-2:0},sample:function(e){return t.randg(e/2)*2},variance:function(e){return 2*e}}),t.extend(t.exponential,{pdf:function(e,a){return e<0?0:a*s.exp(-a*e)},cdf:function(e,a){return e<0?0:1-s.exp(-a*e)},inv:function(o,e){return-s.log(1-o)/e},mean:function(o){return 1/o},median:function(o){return 1/o*s.log(2)},mode:function(){return 0},sample:function(e){return-1/e*s.log(t._random_fn())},variance:function(o){return s.pow(o,-2)}}),t.extend(t.gamma,{pdf:function(e,a,r){return e<0?0:e===0&&a===1?1/r:s.exp((a-1)*s.log(e)-e/r-t.gammaln(a)-a*s.log(r))},cdf:function(e,a,r){return e<0?0:t.lowRegGamma(a,e/r)},inv:function(o,e,a){return t.gammapinv(o,e)*a},mean:function(o,e){return o*e},mode:function(e,a){if(e>1)return(e-1)*a},sample:function(e,a){return t.randg(e)*a},variance:function(e,a){return e*a*a}}),t.extend(t.invgamma,{pdf:function(e,a,r){return e<=0?0:s.exp(-(a+1)*s.log(e)-r/e-t.gammaln(a)+a*s.log(r))},cdf:function(e,a,r){return e<=0?0:1-t.lowRegGamma(a,r/e)},inv:function(o,e,a){return a/t.gammapinv(1-o,e)},mean:function(o,e){return o>1?e/(o-1):void 0},mode:function(e,a){return a/(e+1)},sample:function(e,a){return a/t.randg(e)},variance:function(e,a){if(!(e<=2))return a*a/((e-1)*(e-1)*(e-2))}}),t.extend(t.kumaraswamy,{pdf:function(e,a,r){return e===0&&a===1?r:e===1&&r===1?a:s.exp(s.log(a)+s.log(r)+(a-1)*s.log(e)+(r-1)*s.log(1-s.pow(e,a)))},cdf:function(e,a,r){return e<0?0:e>1?1:1-s.pow(1-s.pow(e,a),r)},inv:function(e,a,r){return s.pow(1-s.pow(1-e,1/r),1/a)},mean:function(o,e){return e*t.gammafn(1+1/o)*t.gammafn(e)/t.gammafn(1+1/o+e)},median:function(e,a){return s.pow(1-s.pow(2,-1/a),1/e)},mode:function(e,a){if(e>=1&&a>=1&&e!==1&&a!==1)return s.pow((e-1)/(e*a-1),1/e)},variance:function(){throw new Error("variance not yet implemented")}}),t.extend(t.lognormal,{pdf:function(e,a,r){return e<=0?0:s.exp(-s.log(e)-.5*s.log(2*s.PI)-s.log(r)-s.pow(s.log(e)-a,2)/(2*r*r))},cdf:function(e,a,r){return e<0?0:.5+.5*t.erf((s.log(e)-a)/s.sqrt(2*r*r))},inv:function(o,e,a){return s.exp(-1.4142135623730951*a*t.erfcinv(2*o)+e)},mean:function(e,a){return s.exp(e+a*a/2)},median:function(e){return s.exp(e)},mode:function(e,a){return s.exp(e-a*a)},sample:function(e,a){return s.exp(t.randn()*a+e)},variance:function(e,a){return(s.exp(a*a)-1)*s.exp(2*e+a*a)}}),t.extend(t.noncentralt,{pdf:function(e,a,r){var n=1e-14;return s.abs(r)<n?t.studentt.pdf(e,a):s.abs(e)<n?s.exp(t.gammaln((a+1)/2)-r*r/2-.5*s.log(s.PI*a)-t.gammaln(a/2)):a/e*(t.noncentralt.cdf(e*s.sqrt(1+2/a),a+2,r)-t.noncentralt.cdf(e,a,r))},cdf:function(e,a,r){var n=1e-14,c=200;if(s.abs(r)<n)return t.studentt.cdf(e,a);var d=!1;e<0&&(d=!0,r=-r);for(var u=t.normal.cdf(-r,0,1),g=n+1,x=g,p=e*e/(e*e+a),m=0,w=s.exp(-r*r/2),y=s.exp(-r*r/2-.5*s.log(2)-t.gammaln(3/2))*r;m<c||x>n||g>n;)x=g,m>0&&(w*=r*r/(2*m),y*=r*r/(2*(m+1/2))),g=w*t.beta.cdf(p,m+.5,a/2)+y*t.beta.cdf(p,m+1,a/2),u+=.5*g,m++;return d?1-u:u}}),t.extend(t.normal,{pdf:function(e,a,r){return s.exp(-.5*s.log(2*s.PI)-s.log(r)-s.pow(e-a,2)/(2*r*r))},cdf:function(e,a,r){return .5*(1+t.erf((e-a)/s.sqrt(2*r*r)))},inv:function(o,e,a){return-1.4142135623730951*a*t.erfcinv(2*o)+e},mean:function(o){return o},median:function(e){return e},mode:function(o){return o},sample:function(e,a){return t.randn()*a+e},variance:function(o,e){return e*e}}),t.extend(t.pareto,{pdf:function(e,a,r){return e<a?0:r*s.pow(a,r)/s.pow(e,r+1)},cdf:function(e,a,r){return e<a?0:1-s.pow(a/e,r)},inv:function(e,a,r){return a/s.pow(1-e,1/r)},mean:function(e,a){if(!(a<=1))return a*s.pow(e,a)/(a-1)},median:function(e,a){return e*(a*s.SQRT2)},mode:function(e){return e},variance:function(o,e){if(!(e<=2))return o*o*e/(s.pow(e-1,2)*(e-2))}}),t.extend(t.studentt,{pdf:function(e,a){return a=a>1e100?1e100:a,1/(s.sqrt(a)*t.betafn(.5,a/2))*s.pow(1+e*e/a,-((a+1)/2))},cdf:function(e,a){var r=a/2;return t.ibeta((e+s.sqrt(e*e+a))/(2*s.sqrt(e*e+a)),r,r)},inv:function(o,e){var a=t.ibetainv(2*s.min(o,1-o),.5*e,.5);return a=s.sqrt(e*(1-a)/a),o>.5?a:-a},mean:function(e){return e>1?0:void 0},median:function(){return 0},mode:function(){return 0},sample:function(e){return t.randn()*s.sqrt(e/(2*t.randg(e/2)))},variance:function(e){return e>2?e/(e-2):e>1?1/0:void 0}}),t.extend(t.weibull,{pdf:function(e,a,r){return e<0||a<0||r<0?0:r/a*s.pow(e/a,r-1)*s.exp(-s.pow(e/a,r))},cdf:function(e,a,r){return e<0?0:1-s.exp(-s.pow(e/a,r))},inv:function(o,e,a){return e*s.pow(-s.log(1-o),1/a)},mean:function(o,e){return o*t.gammafn(1+1/e)},median:function(e,a){return e*s.pow(s.log(2),1/a)},mode:function(e,a){return a<=1?0:e*s.pow((a-1)/a,1/a)},sample:function(e,a){return e*s.pow(-s.log(t._random_fn()),1/a)},variance:function(e,a){return e*e*t.gammafn(1+2/a)-s.pow(t.weibull.mean(e,a),2)}}),t.extend(t.uniform,{pdf:function(e,a,r){return e<a||e>r?0:1/(r-a)},cdf:function(e,a,r){return e<a?0:e<r?(e-a)/(r-a):1},inv:function(o,e,a){return e+o*(a-e)},mean:function(e,a){return .5*(e+a)},median:function(e,a){return t.mean(e,a)},mode:function(){throw new Error("mode is not yet implemented")},sample:function(e,a){return e/2+a/2+(a/2-e/2)*(2*t._random_fn()-1)},variance:function(e,a){return s.pow(a-e,2)/12}});function k(o,e,a,r){for(var n=0,c=1,d=1,u=1,g=0,x=0,p;s.abs((d-x)/d)>r;)x=d,p=-(e+g)*(e+a+g)*o/(e+2*g)/(e+2*g+1),n=d+p*n,c=u+p*c,g=g+1,p=g*(a-g)*o/(e+2*g-1)/(e+2*g),d=n+p*d,u=c+p*u,n=n/u,c=c/u,d=d/u,u=1;return d/e}t.extend(t.binomial,{pdf:function(e,a,r){return r===0||r===1?a*r===e?1:0:t.combination(a,e)*s.pow(r,e)*s.pow(1-r,a-e)},cdf:function(e,a,r){var n,c=1e-10;if(e<0)return 0;if(e>=a)return 1;if(r<0||r>1||a<=0)return NaN;e=s.floor(e);var d=r,u=e+1,g=a-e,x=u+g,p=s.exp(t.gammaln(x)-t.gammaln(g)-t.gammaln(u)+u*s.log(d)+g*s.log(1-d));return d<(u+1)/(x+2)?n=p*k(d,u,g,c):n=1-p*k(1-d,g,u,c),s.round((1-n)*(1/c))/(1/c)}}),t.extend(t.negbin,{pdf:function(e,a,r){return e!==e>>>0?!1:e<0?0:t.combination(e+a-1,a-1)*s.pow(1-r,e)*s.pow(r,a)},cdf:function(e,a,r){var n=0,c=0;if(e<0)return 0;for(;c<=e;c++)n+=t.negbin.pdf(c,a,r);return n}}),t.extend(t.hypgeom,{pdf:function(e,a,r,n){if(e!==e|0)return!1;if(e<0||e<r-(a-n))return 0;if(e>n||e>r)return 0;if(r*2>a)return n*2>a?t.hypgeom.pdf(a-r-n+e,a,a-r,a-n):t.hypgeom.pdf(n-e,a,a-r,n);if(n*2>a)return t.hypgeom.pdf(r-e,a,r,a-n);if(r<n)return t.hypgeom.pdf(e,a,n,r);for(var c=1,d=0,u=0;u<e;u++){for(;c>1&&d<n;)c*=1-r/(a-d),d++;c*=(n-u)*(r-u)/((u+1)*(a-r-n+u+1))}for(;d<n;d++)c*=1-r/(a-d);return s.min(1,s.max(0,c))},cdf:function(e,a,r,n){if(e<0||e<r-(a-n))return 0;if(e>=n||e>=r)return 1;if(r*2>a)return n*2>a?t.hypgeom.cdf(a-r-n+e,a,a-r,a-n):1-t.hypgeom.cdf(n-e-1,a,a-r,n);if(n*2>a)return 1-t.hypgeom.cdf(r-e-1,a,r,a-n);if(r<n)return t.hypgeom.cdf(e,a,n,r);for(var c=1,d=1,u=0,g=0;g<e;g++){for(;c>1&&u<n;){var x=1-r/(a-u);d*=x,c*=x,u++}d*=(n-g)*(r-g)/((g+1)*(a-r-n+g+1)),c+=d}for(;u<n;u++)c*=1-r/(a-u);return s.min(1,s.max(0,c))}}),t.extend(t.poisson,{pdf:function(e,a){return a<0||e%1!==0||e<0?0:s.pow(a,e)*s.exp(-a)/t.factorial(e)},cdf:function(e,a){var r=[],n=0;if(e<0)return 0;for(;n<=e;n++)r.push(t.poisson.pdf(n,a));return t.sum(r)},mean:function(o){return o},variance:function(o){return o},sampleSmall:function(e){var a=1,r=0,n=s.exp(-e);do r++,a*=t._random_fn();while(a>n);return r-1},sampleLarge:function(e){var a=e,r,n,c,d,u,g,x,p,m,w;for(d=s.sqrt(a),u=s.log(a),x=.931+2.53*d,g=-.059+.02483*x,p=1.1239+1.1328/(x-3.4),m=.9277-3.6224/(x-2);;){if(n=s.random()-.5,c=s.random(),w=.5-s.abs(n),r=s.floor((2*g/w+x)*n+a+.43),w>=.07&&c<=m)return r;if(!(r<0||w<.013&&c>w)&&s.log(c)+s.log(p)-s.log(g/(w*w)+x)<=-a+r*u-t.loggam(r+1))return r}},sample:function(e){return e<10?this.sampleSmall(e):this.sampleLarge(e)}}),t.extend(t.triangular,{pdf:function(e,a,r,n){return r<=a||n<a||n>r?NaN:e<a||e>r?0:e<n?2*(e-a)/((r-a)*(n-a)):e===n?2/(r-a):2*(r-e)/((r-a)*(r-n))},cdf:function(e,a,r,n){return r<=a||n<a||n>r?NaN:e<=a?0:e>=r?1:e<=n?s.pow(e-a,2)/((r-a)*(n-a)):1-s.pow(r-e,2)/((r-a)*(r-n))},inv:function(e,a,r,n){return r<=a||n<a||n>r?NaN:e<=(n-a)/(r-a)?a+(r-a)*s.sqrt(e*((n-a)/(r-a))):a+(r-a)*(1-s.sqrt((1-e)*(1-(n-a)/(r-a))))},mean:function(e,a,r){return(e+a+r)/3},median:function(e,a,r){if(r<=(e+a)/2)return a-s.sqrt((a-e)*(a-r))/s.sqrt(2);if(r>(e+a)/2)return e+s.sqrt((a-e)*(r-e))/s.sqrt(2)},mode:function(e,a,r){return r},sample:function(e,a,r){var n=t._random_fn();return n<(r-e)/(a-e)?e+s.sqrt(n*(a-e)*(r-e)):a-s.sqrt((1-n)*(a-e)*(a-r))},variance:function(e,a,r){return(e*e+a*a+r*r-e*a-e*r-a*r)/18}}),t.extend(t.arcsine,{pdf:function(e,a,r){return r<=a?NaN:e<=a||e>=r?0:2/s.PI*s.pow(s.pow(r-a,2)-s.pow(2*e-a-r,2),-.5)},cdf:function(e,a,r){return e<a?0:e<r?2/s.PI*s.asin(s.sqrt((e-a)/(r-a))):1},inv:function(o,e,a){return e+(.5-.5*s.cos(s.PI*o))*(a-e)},mean:function(e,a){return a<=e?NaN:(e+a)/2},median:function(e,a){return a<=e?NaN:(e+a)/2},mode:function(){throw new Error("mode is not yet implemented")},sample:function(e,a){return(e+a)/2+(a-e)/2*s.sin(2*s.PI*t.uniform.sample(0,1))},variance:function(e,a){return a<=e?NaN:s.pow(a-e,2)/8}});function f(o){return o/s.abs(o)}t.extend(t.laplace,{pdf:function(e,a,r){return r<=0?0:s.exp(-s.abs(e-a)/r)/(2*r)},cdf:function(e,a,r){return r<=0?0:e<a?.5*s.exp((e-a)/r):1-.5*s.exp(-(e-a)/r)},mean:function(o){return o},median:function(o){return o},mode:function(o){return o},variance:function(o,e){return 2*e*e},sample:function(e,a){var r=t._random_fn()-.5;return e-a*f(r)*s.log(1-2*s.abs(r))}});function h(o,e,a){var r=12,n=6,c=-30,d=-50,u=60,g=8,x=3,p=2,m=3,w=[.9815606342467192,.9041172563704749,.7699026741943047,.5873179542866175,.3678314989981802,.1252334085114689],y=[.04717533638651183,.10693932599531843,.16007832854334622,.20316742672306592,.2334925365383548,.24914704581340277],A=o*.5;if(A>=g)return 1;var C=2*t.normal.cdf(A,0,1,1,0)-1;C>=s.exp(d/a)?C=s.pow(C,a):C=0;var E;o>x?E=p:E=m;for(var $=A,P=(g-A)/E,z=$+P,L=0,q=a-1,V=1;V<=E;V++){for(var G=0,R=.5*(z+$),_=.5*(z-$),J=1;J<=r;J++){var Q,W;n<J?(Q=r-J+1,W=w[Q-1]):(Q=J,W=-w[Q-1]);var S=_*W,U=R+S,te=U*U;if(te>u)break;var ce=2*t.normal.cdf(U,0,1,1,0),ze=2*t.normal.cdf(U,o,1,1,0),ne=ce*.5-ze*.5;ne>=s.exp(c/q)&&(ne=y[Q-1]*s.exp(-(.5*te))*s.pow(ne,q),G+=ne)}G*=2*_*a/s.sqrt(2*s.PI),L+=G,$=z,z+=P}return C+=L,C<=s.exp(c/e)?0:(C=s.pow(C,e),C>=1?1:C)}function v(o,e,a){var r=.322232421088,n=.099348462606,c=-1,d=.588581570495,u=-.342242088547,g=.531103462366,x=-.204231210125,p=.10353775285,m=-453642210148e-16,w=.0038560700634,y=.8832,A=.2368,C=1.208,E=1.4142,$=120,P=.5-.5*o,z=s.sqrt(s.log(1/(P*P))),L=z+((((z*m+x)*z+u)*z+c)*z+r)/((((z*w+p)*z+g)*z+d)*z+n);a<$&&(L+=(L*L*L+L)/a/4);var q=y-A*L;return a<$&&(q+=-1.214/a+C*L/a),L*(q*s.log(e-1)+E)}t.extend(t.tukey,{cdf:function(e,a,r){var n=1,c=a,d=16,u=8,g=-30,x=1e-14,p=100,m=800,w=5e3,y=25e3,A=1,C=.5,E=.25,$=.125,P=[.9894009349916499,.9445750230732326,.8656312023878318,.755404408355003,.6178762444026438,.45801677765722737,.2816035507792589,.09501250983763744],z=[.027152459411754096,.062253523938647894,.09515851168249279,.12462897125553388,.14959598881657674,.16915651939500254,.18260341504492358,.1894506104550685];if(e<=0)return 0;if(r<2||n<1||c<2)return NaN;if(!Number.isFinite(e))return 1;if(r>y)return h(e,n,c);var L=r*.5,q=L*s.log(r)-r*s.log(2)-t.gammaln(L),V=L-1,G=r*.25,R;r<=p?R=A:r<=m?R=C:r<=w?R=E:R=$,q+=s.log(R);for(var _=0,J=1;J<=50;J++){for(var Q=0,W=(2*J-1)*R,S=1;S<=d;S++){var U,te;u<S?(U=S-u-1,te=q+V*s.log(W+P[U]*R)-(P[U]*R+W)*G):(U=S-1,te=q+V*s.log(W-P[U]*R)+(P[U]*R-W)*G);var ce;if(te>=g){u<S?ce=e*s.sqrt((P[U]*R+W)*.5):ce=e*s.sqrt((-(P[U]*R)+W)*.5);var ze=h(ce,n,c),ne=ze*z[U]*s.exp(te);Q+=ne}}if(J*R>=1&&Q<=x)break;_+=Q}if(Q>x)throw new Error("tukey.cdf failed to converge");return _>1&&(_=1),_},inv:function(o,e,a){var r=1,n=e,c=1e-4,d=50;if(a<2||r<1||n<2)return NaN;if(o<0||o>1)return NaN;if(o===0)return 0;if(o===1)return 1/0;var u=v(o,n,a),g=t.tukey.cdf(u,e,a)-o,x;g>0?x=s.max(0,u-1):x=u+1;for(var p=t.tukey.cdf(x,e,a)-o,m,w=1;w<d;w++){m=x-p*(x-u)/(p-g),g=p,u=x,m<0&&(m=0,p=-o),p=t.tukey.cdf(m,e,a)-o,x=m;var y=s.abs(x-u);if(y<c)return m}throw new Error("tukey.inv failed to converge")}})})(b,Math),(function(t,s){var k=Array.prototype.push,f=t.utils.isArray;function h(v){return f(v)||v instanceof t}t.extend({add:function(o,e){return h(e)?(h(e[0])||(e=[e]),t.map(o,function(a,r,n){return a+e[r][n]})):t.map(o,function(a){return a+e})},subtract:function(o,e){return h(e)?(h(e[0])||(e=[e]),t.map(o,function(a,r,n){return a-e[r][n]||0})):t.map(o,function(a){return a-e})},divide:function(o,e){return h(e)?(h(e[0])||(e=[e]),t.multiply(o,t.inv(e))):t.map(o,function(a){return a/e})},multiply:function(o,e){var a,r,n,c,d,u,g,x;if(o.length===void 0&&e.length===void 0)return o*e;if(d=o.length,u=o[0].length,g=t.zeros(d,n=h(e)?e[0].length:u),x=0,h(e)){for(;x<n;x++)for(a=0;a<d;a++){for(c=0,r=0;r<u;r++)c+=o[a][r]*e[r][x];g[a][x]=c}return d===1&&x===1?g[0][0]:g}return t.map(o,function(p){return p*e})},outer:function(o,e){return t.multiply(o.map(function(a){return[a]}),[e])},dot:function(o,e){h(o[0])||(o=[o]),h(e[0])||(e=[e]);for(var a=o[0].length===1&&o.length!==1?t.transpose(o):o,r=e[0].length===1&&e.length!==1?t.transpose(e):e,n=[],c=0,d=a.length,u=a[0].length,g,x;c<d;c++){for(n[c]=[],g=0,x=0;x<u;x++)g+=a[c][x]*r[c][x];n[c]=g}return n.length===1?n[0]:n},pow:function(o,e){return t.map(o,function(a){return s.pow(a,e)})},exp:function(o){return t.map(o,function(e){return s.exp(e)})},log:function(o){return t.map(o,function(e){return s.log(e)})},abs:function(o){return t.map(o,function(e){return s.abs(e)})},norm:function(o,e){var a=0,r=0;for(isNaN(e)&&(e=2),h(o[0])&&(o=o[0]);r<o.length;r++)a+=s.pow(s.abs(o[r]),e);return s.pow(a,1/e)},angle:function(o,e){return s.acos(t.dot(o,e)/(t.norm(o)*t.norm(e)))},aug:function(o,e){var a=[],r;for(r=0;r<o.length;r++)a.push(o[r].slice());for(r=0;r<a.length;r++)k.apply(a[r],e[r]);return a},inv:function(o){for(var e=o.length,a=o[0].length,r=t.identity(e,a),n=t.gauss_jordan(o,r),c=[],d=0,u;d<e;d++)for(c[d]=[],u=a;u<n[0].length;u++)c[d][u-a]=n[d][u];return c},det:function v(o){if(o.length===2)return o[0][0]*o[1][1]-o[0][1]*o[1][0];for(var e=0,a=0;a<o.length;a++){for(var r=[],n=1;n<o.length;n++){r[n-1]=[];for(var c=0;c<o.length;c++)c<a?r[n-1][c]=o[n][c]:c>a&&(r[n-1][c-1]=o[n][c])}var d=a%2?-1:1;e+=v(r)*o[0][a]*d}return e},gauss_elimination:function(o,e){var a=0,r=0,n=o.length,c=o[0].length,d=1,u=0,g=[],x,p,m,w;for(o=t.aug(o,e),x=o[0].length,a=0;a<n;a++){for(p=o[a][a],r=a,w=a+1;w<c;w++)p<s.abs(o[w][a])&&(p=o[w][a],r=w);if(r!=a)for(w=0;w<x;w++)m=o[a][w],o[a][w]=o[r][w],o[r][w]=m;for(r=a+1;r<n;r++)for(d=o[r][a]/o[a][a],w=a;w<x;w++)o[r][w]=o[r][w]-d*o[a][w]}for(a=n-1;a>=0;a--){for(u=0,r=a+1;r<=n-1;r++)u=u+g[r]*o[a][r];g[a]=(o[a][x-1]-u)/o[a][a]}return g},gauss_jordan:function(o,e){var a=t.aug(o,e),r=a.length,n=a[0].length,c=0,d,u,g;for(u=0;u<r;u++){var x=u;for(g=u+1;g<r;g++)s.abs(a[g][u])>s.abs(a[x][u])&&(x=g);var p=a[u];for(a[u]=a[x],a[x]=p,g=u+1;g<r;g++)for(c=a[g][u]/a[u][u],d=u;d<n;d++)a[g][d]-=a[u][d]*c}for(u=r-1;u>=0;u--){for(c=a[u][u],g=0;g<u;g++)for(d=n-1;d>u-1;d--)a[g][d]-=a[u][d]*a[g][u]/c;for(a[u][u]/=c,d=r;d<n;d++)a[u][d]/=c}return a},triaUpSolve:function(o,e){var a=o[0].length,r=t.zeros(1,a)[0],n,c=!1;return e[0].length!=null&&(e=e.map(function(d){return d[0]}),c=!0),t.arange(a-1,-1,-1).forEach(function(d){n=t.arange(d+1,a).map(function(u){return r[u]*o[d][u]}),r[d]=(e[d]-t.sum(n))/o[d][d]}),c?r.map(function(d){return[d]}):r},triaLowSolve:function(o,e){var a=o[0].length,r=t.zeros(1,a)[0],n,c=!1;return e[0].length!=null&&(e=e.map(function(d){return d[0]}),c=!0),t.arange(a).forEach(function(d){n=t.arange(d).map(function(u){return o[d][u]*r[u]}),r[d]=(e[d]-t.sum(n))/o[d][d]}),c?r.map(function(d){return[d]}):r},lu:function(o){var e=o.length,a=t.identity(e),r=t.zeros(o.length,o[0].length),n;return t.arange(e).forEach(function(c){r[0][c]=o[0][c]}),t.arange(1,e).forEach(function(c){t.arange(c).forEach(function(d){n=t.arange(d).map(function(u){return a[c][u]*r[u][d]}),a[c][d]=(o[c][d]-t.sum(n))/r[d][d]}),t.arange(c,e).forEach(function(d){n=t.arange(c).map(function(u){return a[c][u]*r[u][d]}),r[c][d]=o[n.length][d]-t.sum(n)})}),[a,r]},cholesky:function(o){var e=o.length,a=t.zeros(o.length,o[0].length),r;return t.arange(e).forEach(function(n){r=t.arange(n).map(function(c){return s.pow(a[n][c],2)}),a[n][n]=s.sqrt(o[n][n]-t.sum(r)),t.arange(n+1,e).forEach(function(c){r=t.arange(n).map(function(d){return a[n][d]*a[c][d]}),a[c][n]=(o[n][c]-t.sum(r))/a[n][n]})}),a},gauss_jacobi:function(o,e,a,r){for(var n=0,c=0,d=o.length,u=[],g=[],x=[],p,m,w,y;n<d;n++)for(u[n]=[],g[n]=[],x[n]=[],c=0;c<d;c++)n>c?(u[n][c]=o[n][c],g[n][c]=x[n][c]=0):n<c?(g[n][c]=o[n][c],u[n][c]=x[n][c]=0):(x[n][c]=o[n][c],u[n][c]=g[n][c]=0);for(w=t.multiply(t.multiply(t.inv(x),t.add(u,g)),-1),m=t.multiply(t.inv(x),e),p=a,y=t.add(t.multiply(w,a),m),n=2;s.abs(t.norm(t.subtract(y,p)))>r;)p=y,y=t.add(t.multiply(w,p),m),n++;return y},gauss_seidel:function(o,e,a,r){for(var n=0,c=o.length,d=[],u=[],g=[],x,p,m,w,y;n<c;n++)for(d[n]=[],u[n]=[],g[n]=[],x=0;x<c;x++)n>x?(d[n][x]=o[n][x],u[n][x]=g[n][x]=0):n<x?(u[n][x]=o[n][x],d[n][x]=g[n][x]=0):(g[n][x]=o[n][x],d[n][x]=u[n][x]=0);for(w=t.multiply(t.multiply(t.inv(t.add(g,d)),u),-1),m=t.multiply(t.inv(t.add(g,d)),e),p=a,y=t.add(t.multiply(w,a),m),n=2;s.abs(t.norm(t.subtract(y,p)))>r;)p=y,y=t.add(t.multiply(w,p),m),n=n+1;return y},SOR:function(o,e,a,r,n){for(var c=0,d=o.length,u=[],g=[],x=[],p,m,w,y,A;c<d;c++)for(u[c]=[],g[c]=[],x[c]=[],p=0;p<d;p++)c>p?(u[c][p]=o[c][p],g[c][p]=x[c][p]=0):c<p?(g[c][p]=o[c][p],u[c][p]=x[c][p]=0):(x[c][p]=o[c][p],u[c][p]=g[c][p]=0);for(y=t.multiply(t.inv(t.add(x,t.multiply(u,n))),t.subtract(t.multiply(x,1-n),t.multiply(g,n))),w=t.multiply(t.multiply(t.inv(t.add(x,t.multiply(u,n))),e),n),m=a,A=t.add(t.multiply(y,a),w),c=2;s.abs(t.norm(t.subtract(A,m)))>r;)m=A,A=t.add(t.multiply(y,m),w),c++;return A},householder:function(o){for(var e=o.length,a=o[0].length,r=0,n=[],c=[],d,u,g,x,p;r<e-1;r++){for(d=0,x=r+1;x<a;x++)d+=o[x][r]*o[x][r];for(p=o[r+1][r]>0?-1:1,d=p*s.sqrt(d),u=s.sqrt((d*d-o[r+1][r]*d)/2),n=t.zeros(e,1),n[r+1][0]=(o[r+1][r]-d)/(2*u),g=r+2;g<e;g++)n[g][0]=o[g][r]/(2*u);c=t.subtract(t.identity(e,a),t.multiply(t.multiply(n,t.transpose(n)),2)),o=t.multiply(c,t.multiply(o,c))}return o},QR:(function(){var v=t.sum,o=t.arange;function e(a){var r=a.length,n=a[0].length,c=t.zeros(n,n);a=t.copy(a);var d,u,g;for(u=0;u<n;u++){for(c[u][u]=s.sqrt(v(o(r).map(function(x){return a[x][u]*a[x][u]}))),d=0;d<r;d++)a[d][u]=a[d][u]/c[u][u];for(g=u+1;g<n;g++)for(c[u][g]=v(o(r).map(function(x){return a[x][u]*a[x][g]})),d=0;d<r;d++)a[d][g]=a[d][g]-a[d][u]*c[u][g]}return[a,c]}return e})(),lstsq:(function(){function v(e){e=t.copy(e);var a=e.length,r=t.identity(a);return t.arange(a-1,-1,-1).forEach(function(n){t.sliceAssign(r,{row:n},t.divide(t.slice(r,{row:n}),e[n][n])),t.sliceAssign(e,{row:n},t.divide(t.slice(e,{row:n}),e[n][n])),t.arange(n).forEach(function(c){var d=t.multiply(e[c][n],-1),u=t.slice(e,{row:c}),g=t.multiply(t.slice(e,{row:n}),d);t.sliceAssign(e,{row:c},t.add(u,g));var x=t.slice(r,{row:c}),p=t.multiply(t.slice(r,{row:n}),d);t.sliceAssign(r,{row:c},t.add(x,p))})}),r}function o(e,a){var r=!1;a[0].length===void 0&&(a=a.map(function(y){return[y]}),r=!0);var n=t.QR(e),c=n[0],d=n[1],u=e[0].length,g=t.slice(c,{col:{end:u}}),x=t.slice(d,{row:{end:u}}),p=v(x),m=t.transpose(g);m[0].length===void 0&&(m=[m]);var w=t.multiply(t.multiply(p,m),a);return w.length===void 0&&(w=[[w]]),r?w.map(function(y){return y[0]}):w}return o})(),jacobi:function(o){for(var e=1,a=o.length,r=t.identity(a,a),n=[],c,d,u,g,x,p,m,w;e===1;){for(p=o[0][1],g=0,x=1,d=0;d<a;d++)for(u=0;u<a;u++)d!=u&&p<s.abs(o[d][u])&&(p=s.abs(o[d][u]),g=d,x=u);for(o[g][g]===o[x][x]?m=o[g][x]>0?s.PI/4:-s.PI/4:m=s.atan(2*o[g][x]/(o[g][g]-o[x][x]))/2,w=t.identity(a,a),w[g][g]=s.cos(m),w[g][x]=-s.sin(m),w[x][g]=s.sin(m),w[x][x]=s.cos(m),r=t.multiply(r,w),c=t.multiply(t.multiply(t.inv(w),o),w),o=c,e=0,d=1;d<a;d++)for(u=1;u<a;u++)d!=u&&s.abs(o[d][u])>.001&&(e=1)}for(d=0;d<a;d++)n.push(o[d][d]);return[r,n]},rungekutta:function(o,e,a,r,n,c){var d,u,g,x,p;if(c===2)for(;r<=a;)d=e*o(r,n),u=e*o(r+e,n+d),g=n+(d+u)/2,n=g,r=r+e;if(c===4)for(;r<=a;)d=e*o(r,n),u=e*o(r+e/2,n+d/2),x=e*o(r+e/2,n+u/2),p=e*o(r+e,n+x),g=n+(d+2*u+2*x+p)/6,n=g,r=r+e;return n},romberg:function(o,e,a,r){for(var n=0,c=(a-e)/2,d=[],u=[],g=[],x,p,m,w,y;n<r/2;){for(y=o(e),m=e,w=0;m<=a;m=m+c,w++)d[w]=m;for(x=d.length,m=1;m<x-1;m++)y+=(m%2!==0?4:2)*o(d[m]);y=c/3*(y+o(a)),g[n]=y,c/=2,n++}for(p=g.length,x=1;p!==1;){for(m=0;m<p-1;m++)u[m]=(s.pow(4,x)*g[m+1]-g[m])/(s.pow(4,x)-1);p=u.length,g=u,u=[],x++}return g},richardson:function(o,e,a,r){function n(A,C){for(var E=0,$=A.length,P;E<$;E++)A[E]===C&&(P=E);return P}for(var c=s.abs(a-o[n(o,a)+1]),d=0,u=[],g=[],x,p,m,w,y;r>=c;)x=n(o,a+r),p=n(o,a),u[d]=(e[x]-2*e[p]+e[2*p-x])/(r*r),r/=2,d++;for(w=u.length,m=1;w!=1;){for(y=0;y<w-1;y++)g[y]=(s.pow(4,m)*u[y+1]-u[y])/(s.pow(4,m)-1);w=g.length,u=g,g=[],m++}return u},simpson:function(o,e,a,r){for(var n=(a-e)/r,c=o(e),d=[],u=e,g=0,x=1,p;u<=a;u=u+n,g++)d[g]=u;for(p=d.length;x<p-1;x++)c+=(x%2!==0?4:2)*o(d[x]);return n/3*(c+o(a))},hermite:function(o,e,a,r){for(var n=o.length,c=0,d=0,u=[],g=[],x=[],p=[],m;d<n;d++){for(u[d]=1,m=0;m<n;m++)d!=m&&(u[d]*=(r-o[m])/(o[d]-o[m]));for(g[d]=0,m=0;m<n;m++)d!=m&&(g[d]+=1/(o[d]-o[m]));x[d]=(1-2*(r-o[d])*g[d])*(u[d]*u[d]),p[d]=(r-o[d])*(u[d]*u[d]),c+=x[d]*e[d]+p[d]*a[d]}return c},lagrange:function(o,e,a){for(var r=0,n=0,c,d,u=o.length;n<u;n++){for(d=e[n],c=0;c<u;c++)n!=c&&(d*=(a-o[c])/(o[n]-o[c]));r+=d}return r},cubic_spline:function(o,e,a){for(var r=o.length,n=0,c,d=[],u=[],g=[],x=[],p=[],m=[],w=[];n<r-1;n++)p[n]=o[n+1]-o[n];for(g[0]=0,n=1;n<r-1;n++)g[n]=3/p[n]*(e[n+1]-e[n])-3/p[n-1]*(e[n]-e[n-1]);for(n=1;n<r-1;n++)d[n]=[],u[n]=[],d[n][n-1]=p[n-1],d[n][n]=2*(p[n-1]+p[n]),d[n][n+1]=p[n],u[n][0]=g[n];for(x=t.multiply(t.inv(d),u),c=0;c<r-1;c++)m[c]=(e[c+1]-e[c])/p[c]-p[c]*(x[c+1][0]+2*x[c][0])/3,w[c]=(x[c+1][0]-x[c][0])/(3*p[c]);for(c=0;c<r&&!(o[c]>a);c++);return c-=1,e[c]+(a-o[c])*m[c]+t.sq(a-o[c])*x[c]+(a-o[c])*t.sq(a-o[c])*w[c]},gauss_quadrature:function(){throw new Error("gauss_quadrature not yet implemented")},PCA:function(o){var e=o.length,a=o[0].length,r=0,n,c,d=[],u=[],g=[],x=[],p=[],m=[],w=[],y=[],A=[],C=[];for(r=0;r<e;r++)d[r]=t.sum(o[r])/a;for(r=0;r<a;r++)for(w[r]=[],n=0;n<e;n++)w[r][n]=o[n][r]-d[n];for(w=t.transpose(w),r=0;r<e;r++)for(y[r]=[],n=0;n<e;n++)y[r][n]=t.dot([w[r]],[w[n]])/(a-1);for(g=t.jacobi(y),A=g[0],u=g[1],C=t.transpose(A),r=0;r<u.length;r++)for(n=r;n<u.length;n++)u[r]<u[n]&&(c=u[r],u[r]=u[n],u[n]=c,x=C[r],C[r]=C[n],C[n]=x);for(m=t.transpose(w),r=0;r<e;r++)for(p[r]=[],n=0;n<m.length;n++)p[r][n]=t.dot([C[r]],[m[n]]);return[o,u,C,p]}}),(function(v){for(var o=0;o<v.length;o++)(function(e){t.fn[e]=function(a,r){var n=this;return r?(setTimeout(function(){r.call(n,t.fn[e].call(n,a))},15),this):typeof t[e](this,a)=="number"?t[e](this,a):t(t[e](this,a))}})(v[o])})("add divide multiply subtract dot pow exp log abs norm angle".split(" "))})(b,Math),(function(t,s){var k=[].slice,f=t.utils.isNumber,h=t.utils.isArray;t.extend({zscore:function(){var e=k.call(arguments);return f(e[1])?(e[0]-e[1])/e[2]:(e[0]-t.mean(e[1]))/t.stdev(e[1],e[2])},ztest:function(){var e=k.call(arguments),a;return h(e[1])?(a=t.zscore(e[0],e[1],e[3]),e[2]===1?t.normal.cdf(-s.abs(a),0,1):t.normal.cdf(-s.abs(a),0,1)*2):e.length>2?(a=t.zscore(e[0],e[1],e[2]),e[3]===1?t.normal.cdf(-s.abs(a),0,1):t.normal.cdf(-s.abs(a),0,1)*2):(a=e[0],e[1]===1?t.normal.cdf(-s.abs(a),0,1):t.normal.cdf(-s.abs(a),0,1)*2)}}),t.extend(t.fn,{zscore:function(e,a){return(e-this.mean())/this.stdev(a)},ztest:function(e,a,r){var n=s.abs(this.zscore(e,r));return a===1?t.normal.cdf(-n,0,1):t.normal.cdf(-n,0,1)*2}}),t.extend({tscore:function(){var e=k.call(arguments);return e.length===4?(e[0]-e[1])/(e[2]/s.sqrt(e[3])):(e[0]-t.mean(e[1]))/(t.stdev(e[1],!0)/s.sqrt(e[1].length))},ttest:function(){var e=k.call(arguments),a;return e.length===5?(a=s.abs(t.tscore(e[0],e[1],e[2],e[3])),e[4]===1?t.studentt.cdf(-a,e[3]-1):t.studentt.cdf(-a,e[3]-1)*2):f(e[1])?(a=s.abs(e[0]),e[2]==1?t.studentt.cdf(-a,e[1]-1):t.studentt.cdf(-a,e[1]-1)*2):(a=s.abs(t.tscore(e[0],e[1])),e[2]==1?t.studentt.cdf(-a,e[1].length-1):t.studentt.cdf(-a,e[1].length-1)*2)}}),t.extend(t.fn,{tscore:function(e){return(e-this.mean())/(this.stdev(!0)/s.sqrt(this.cols()))},ttest:function(e,a){return a===1?1-t.studentt.cdf(s.abs(this.tscore(e)),this.cols()-1):t.studentt.cdf(-s.abs(this.tscore(e)),this.cols()-1)*2}}),t.extend({anovafscore:function(){var e=k.call(arguments),a,r,n,c,d,u,g,x;if(e.length===1){for(d=new Array(e[0].length),g=0;g<e[0].length;g++)d[g]=e[0][g];e=d}for(r=new Array,g=0;g<e.length;g++)r=r.concat(e[g]);for(n=t.mean(r),a=0,g=0;g<e.length;g++)a=a+e[g].length*s.pow(t.mean(e[g])-n,2);for(a/=e.length-1,u=0,g=0;g<e.length;g++)for(c=t.mean(e[g]),x=0;x<e[g].length;x++)u+=s.pow(e[g][x]-c,2);return u/=r.length-e.length,a/u},anovaftest:function(){var e=k.call(arguments),a,r,n,c;if(f(e[0]))return 1-t.centralF.cdf(e[0],e[1],e[2]);var d=t.anovafscore(e);for(a=e.length-1,n=0,c=0;c<e.length;c++)n=n+e[c].length;return r=n-a-1,1-t.centralF.cdf(d,a,r)},ftest:function(e,a,r){return 1-t.centralF.cdf(e,a,r)}}),t.extend(t.fn,{anovafscore:function(){return t.anovafscore(this.toArray())},anovaftes:function(){var e=0,a;for(a=0;a<this.length;a++)e=e+this[a].length;return t.ftest(this.anovafscore(),this.length-1,e-this.length)}}),t.extend({qscore:function(){var e=k.call(arguments),a,r,n,c,d;return f(e[0])?(a=e[0],r=e[1],n=e[2],c=e[3],d=e[4]):(a=t.mean(e[0]),r=t.mean(e[1]),n=e[0].length,c=e[1].length,d=e[2]),s.abs(a-r)/(d*s.sqrt((1/n+1/c)/2))},qtest:function(){var e=k.call(arguments),a;e.length===3?(a=e[0],e=e.slice(1)):e.length===7?(a=t.qscore(e[0],e[1],e[2],e[3],e[4]),e=e.slice(5)):(a=t.qscore(e[0],e[1],e[2]),e=e.slice(3));var r=e[0],n=e[1];return 1-t.tukey.cdf(a,n,r-n)},tukeyhsd:function(e){for(var a=t.pooledstdev(e),r=e.map(function(x){return t.mean(x)}),n=e.reduce(function(x,p){return x+p.length},0),c=[],d=0;d<e.length;++d)for(var u=d+1;u<e.length;++u){var g=t.qtest(r[d],r[u],e[d].length,e[u].length,a,n,e.length);c.push([[d,u],g])}return c}}),t.extend({normalci:function(){var e=k.call(arguments),a=new Array(2),r;return e.length===4?r=s.abs(t.normal.inv(e[1]/2,0,1)*e[2]/s.sqrt(e[3])):r=s.abs(t.normal.inv(e[1]/2,0,1)*t.stdev(e[2])/s.sqrt(e[2].length)),a[0]=e[0]-r,a[1]=e[0]+r,a},tci:function(){var e=k.call(arguments),a=new Array(2),r;return e.length===4?r=s.abs(t.studentt.inv(e[1]/2,e[3]-1)*e[2]/s.sqrt(e[3])):r=s.abs(t.studentt.inv(e[1]/2,e[2].length-1)*t.stdev(e[2],!0)/s.sqrt(e[2].length)),a[0]=e[0]-r,a[1]=e[0]+r,a},significant:function(e,a){return e<a}}),t.extend(t.fn,{normalci:function(e,a){return t.normalci(e,a,this.toArray())},tci:function(e,a){return t.tci(e,a,this.toArray())}});function v(o,e,a,r){if(o>1||a>1||o<=0||a<=0)throw new Error("Proportions should be greater than 0 and less than 1");var n=(o*e+a*r)/(e+r),c=s.sqrt(n*(1-n)*(1/e+1/r));return(o-a)/c}t.extend(t.fn,{oneSidedDifferenceOfProportions:function(e,a,r,n){var c=v(e,a,r,n);return t.ztest(c,1)},twoSidedDifferenceOfProportions:function(e,a,r,n){var c=v(e,a,r,n);return t.ztest(c,2)}})})(b,Math),b.models=(function(){function t(v){var o=v[0].length,e=b.arange(o).map(function(a){var r=b.arange(o).filter(function(n){return n!==a});return s(b.col(v,a).map(function(n){return n[0]}),b.col(v,r))});return e}function s(v,o){var e=v.length,a=o[0].length-1,r=e-a-1,n=b.lstsq(o,v),c=b.multiply(o,n.map(function(w){return[w]})).map(function(w){return w[0]}),d=b.subtract(v,c),u=b.mean(v),g=b.sum(c.map(function(w){return Math.pow(w-u,2)})),x=b.sum(v.map(function(w,y){return Math.pow(w-c[y],2)})),p=g+x,m=g/p;return{exog:o,endog:v,nobs:e,df_model:a,df_resid:r,coef:n,predict:c,resid:d,ybar:u,SST:p,SSE:g,SSR:x,R2:m}}function k(v){var o=t(v.exog),e=Math.sqrt(v.SSR/v.df_resid),a=o.map(function(u){var g=u.SST,x=u.R2;return e/Math.sqrt(g*(1-x))}),r=v.coef.map(function(u,g){return(u-0)/a[g]}),n=r.map(function(u){var g=b.studentt.cdf(u,v.df_resid);return(g>.5?1-g:g)*2}),c=b.studentt.inv(.975,v.df_resid),d=v.coef.map(function(u,g){var x=c*a[g];return[u-x,u+x]});return{se:a,t:r,p:n,sigmaHat:e,interval95:d}}function f(v){var o=v.R2/v.df_model/((1-v.R2)/v.df_resid),e=function(r,n,c){return b.beta.cdf(r/(c/n+r),n/2,c/2)},a=1-e(o,v.df_model,v.df_resid);return{F_statistic:o,pvalue:a}}function h(v,o){var e=s(v,o),a=k(e),r=f(e),n=1-(1-e.R2)*((e.nobs-1)/e.df_resid);return e.t=a,e.f=r,e.adjust_R2=n,e}return{ols:h}})(),b.extend({buildxmatrix:function(){for(var s=new Array(arguments.length),k=0;k<arguments.length;k++){var f=[1];s[k]=f.concat(arguments[k])}return b(s)},builddxmatrix:function(){for(var s=new Array(arguments[0].length),k=0;k<arguments[0].length;k++){var f=[1];s[k]=f.concat(arguments[0][k])}return b(s)},buildjxmatrix:function(s){for(var k=new Array(s.length),f=0;f<s.length;f++)k[f]=s[f];return b.builddxmatrix(k)},buildymatrix:function(s){return b(s).transpose()},buildjymatrix:function(s){return s.transpose()},matrixmult:function(s,k){var f,h,v,o,e;if(s.cols()==k.rows()){if(k.rows()>1){for(o=[],f=0;f<s.rows();f++)for(o[f]=[],h=0;h<k.cols();h++){for(e=0,v=0;v<s.cols();v++)e+=s.toArray()[f][v]*k.toArray()[v][h];o[f][h]=e}return b(o)}for(o=[],f=0;f<s.rows();f++)for(o[f]=[],h=0;h<k.cols();h++){for(e=0,v=0;v<s.cols();v++)e+=s.toArray()[f][v]*k.toArray()[h];o[f][h]=e}return b(o)}},regress:function(s,k){var f=b.xtranspxinv(s),h=s.transpose(),v=b.matrixmult(b(f),h);return b.matrixmult(v,k)},regresst:function(s,k,f){var h=b.regress(s,k),v={};v.anova={};var o=b.jMatYBar(s,h);v.yBar=o;var e=k.mean();v.anova.residuals=b.residuals(k,o),v.anova.ssr=b.ssr(o,e),v.anova.msr=v.anova.ssr/(s[0].length-1),v.anova.sse=b.sse(k,o),v.anova.mse=v.anova.sse/(k.length-(s[0].length-1)-1),v.anova.sst=b.sst(k,e),v.anova.mst=v.anova.sst/(k.length-1),v.anova.r2=1-v.anova.sse/v.anova.sst,v.anova.r2<0&&(v.anova.r2=0),v.anova.fratio=v.anova.msr/v.anova.mse,v.anova.pvalue=b.anovaftest(v.anova.fratio,s[0].length-1,k.length-(s[0].length-1)-1),v.anova.rmse=Math.sqrt(v.anova.mse),v.anova.r2adj=1-v.anova.mse/v.anova.mst,v.anova.r2adj<0&&(v.anova.r2adj=0),v.stats=new Array(s[0].length);for(var a=b.xtranspxinv(s),r,n,c,d=0;d<h.length;d++)r=Math.sqrt(v.anova.mse*Math.abs(a[d][d])),n=Math.abs(h[d]/r),c=b.ttest(n,k.length-s[0].length-1,f),v.stats[d]=[h[d],r,n,c];return v.regress=h,v},xtranspx:function(s){return b.matrixmult(s.transpose(),s)},xtranspxinv:function(s){var k=b.matrixmult(s.transpose(),s),f=b.inv(k);return f},jMatYBar:function(s,k){var f=b.matrixmult(s,k);return new b(f)},residuals:function(s,k){return b.matrixsubtract(s,k)},ssr:function(s,k){for(var f=0,h=0;h<s.length;h++)f+=Math.pow(s[h]-k,2);return f},sse:function(s,k){for(var f=0,h=0;h<s.length;h++)f+=Math.pow(s[h]-k[h],2);return f},sst:function(s,k){for(var f=0,h=0;h<s.length;h++)f+=Math.pow(s[h]-k,2);return f},matrixsubtract:function(s,k){for(var f=new Array(s.length),h=0;h<s.length;h++){f[h]=new Array(s[h].length);for(var v=0;v<s[h].length;v++)f[h][v]=s[h][v]-k[h][v]}return b(f)}}),b.jStat=b,b})})(we)),we.exports}var ga=Br();const Vr=Or(ga),$e=ga.jStat??Vr?.jStat;if(!$e)throw new Error("No fue posible cargar el motor estadístico jStat.");function xa(i){return Math.min(1,Math.max(0,i))}function Gr(i){if(!Number.isFinite(i)||i<=0||i>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function Mr(i){return typeof i=="string"&&i.trim()===""?Number.NaN:Number(typeof i=="string"?i.trim().replace(",","."):i)}function re(i,l){if(!Array.isArray(i))throw new TypeError(`${l} debe ser un arreglo de valores.`);const b=i.map(Mr),t=b.findIndex(s=>!Number.isFinite(s));if(t!==-1)throw new TypeError(`${l} contiene un valor no numérico en la posición ${t+1}.`);if(b.length<2)throw new RangeError(`${l} debe contener al menos dos observaciones.`);return b}function Hr(i){return i.reduce((l,b)=>l+b,0)/i.length}function Kr(i){const l=[...i].sort((t,s)=>t-s),b=Math.floor(l.length/2);return l.length%2!==0?l[b]:(l[b-1]+l[b])/2}function _r(i,l){return i.reduce((t,s)=>t+(s-l)**2,0)/(i.length-1)}function le(i){const l=re(i,"La muestra"),b=Hr(l),t=_r(l,b);return{n:l.length,media:b,mediana:Kr(l),varianza:t,desviacionEstandar:Math.sqrt(t),minimo:Math.min(...l),maximo:Math.max(...l)}}function va(i,l){return xa(2*(1-$e.studentt.cdf(Math.abs(i),l)))}function ha(i,l,b,t){Gr(t);const s=1-t,k=$e.studentt.inv(1-s/2,b),f=k*l;return{nivel:t,valorCritico:k,inferior:i-f,superior:i+f}}function wa(i,l,b,t,s){const k=t+s-2,f=((t-1)*l+(s-1)*b)/k,h=Math.sqrt(f);if(h===0)return{dCohen:0,gHedges:0,correccionHedges:1};const v=i/h,o=1-3/(4*k-1);return{dCohen:v,gHedges:o*v,correccionHedges:o}}function Jr(i,l,b={}){const{nivelConfianza:t=.95}=b,s=re(i,"El grupo 1"),k=re(l,"El grupo 2"),f=le(s),h=le(k),v=f.n+h.n-2,o=((f.n-1)*f.varianza+(h.n-1)*h.varianza)/v,e=Math.sqrt(o*(1/f.n+1/h.n));if(e===0)throw new Error("No puede calcularse la prueba porque ambos grupos carecen de variabilidad.");const a=f.media-h.media,r=a/e,n=va(r,v);return{id:"t-student-independiente",nombre:"t de Student para muestras independientes",metodo:"Varianzas combinadas",grupo1:f,grupo2:h,diferenciaMedias:a,errorEstandar:e,varianzaCombinada:o,estadistico:{simbolo:"t",valor:r},gradosLibertad:v,valorP:n,intervaloConfianza:ha(a,e,v,t),tamanioEfecto:wa(a,f.varianza,h.varianza,f.n,h.n)}}function Qr(i,l,b={}){const{nivelConfianza:t=.95}=b,s=re(i,"El grupo 1"),k=re(l,"El grupo 2"),f=le(s),h=le(k),v=f.varianza/f.n,o=h.varianza/h.n,e=v+o,a=Math.sqrt(e);if(a===0)throw new Error("No puede calcularse la prueba porque ambos grupos carecen de variabilidad.");const r=e**2,n=v**2/(f.n-1)+o**2/(h.n-1),c=r/n,d=f.media-h.media,u=d/a,g=va(u,c);return{id:"t-welch-independiente",nombre:"t de Welch para muestras independientes",metodo:"Varianzas no combinadas",grupo1:f,grupo2:h,diferenciaMedias:d,errorEstandar:a,estadistico:{simbolo:"t",valor:u},gradosLibertad:c,valorP:g,intervaloConfianza:ha(d,a,c,t),tamanioEfecto:wa(d,f.varianza,h.varianza,f.n,h.n)}}function Wr(i,l){const b=[...i.map(k=>({valor:k,grupo:1,rango:0})),...l.map(k=>({valor:k,grupo:2,rango:0}))].sort((k,f)=>k.valor-f.valor);let t=0,s=0;for(;t<b.length;){let k=t+1;for(;k<b.length&&b[k].valor===b[t].valor;)k+=1;const f=k-t,h=(t+1+k)/2;for(let v=t;v<k;v+=1)b[v].rango=h;f>1&&(s+=f**3-f),t=k}return{observaciones:b,correccionEmpates:s}}function Yr(i,l){const b=re(i,"El grupo 1"),t=re(l,"El grupo 2"),s=le(b),k=le(t),{observaciones:f,correccionEmpates:h}=Wr(b,t),v=f.filter(({grupo:C})=>C===1).reduce((C,E)=>C+E.rango,0),o=f.filter(({grupo:C})=>C===2).reduce((C,E)=>C+E.rango,0),e=s.n,a=k.n,r=e+a,n=v-e*(e+1)/2,c=o-a*(a+1)/2,d=Math.min(n,c),u=e*a/2,g=e*a/12*(r+1-h/(r*(r-1)));if(g<=0)throw new Error("No puede calcularse Mann–Whitney porque todos los valores son idénticos.");const x=Math.sqrt(g),p=n-u,m=p===0?0:Math.sign(p)*.5,w=(p-m)/x,y=xa(2*(1-$e.normal.cdf(Math.abs(w),0,1))),A=2*n/(e*a)-1;return{id:"mann-whitney",nombre:"Prueba U de Mann–Whitney",metodoValorP:"Aproximación normal bilateral con corrección por continuidad y empates",grupo1:s,grupo2:k,sumaRangos1:v,sumaRangos2:o,estadistico:{simbolo:"U",valor:d,u1:n,u2:c},estadisticoZ:w,valorP:y,correccionEmpates:h,tamanioEfecto:{deltaCliff:A,correlacionBiserialRangos:A,r:w/Math.sqrt(r)}}}function Zr({grupo1:i,grupo2:l,prueba:b,nivelConfianza:t=.95}){switch(b){case"student":return Jr(i,l,{nivelConfianza:t});case"welch":return Qr(i,l,{nivelConfianza:t});case"mann-whitney":return Yr(i,l);default:throw new Error("La prueba solicitada no está disponible.")}}function Xr(){const i=document.createElement("section");i.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,i.innerHTML=`
...
18"
        ...
        <section
            ...
            aria-live="polite"
        ></section>
    `;const l=i.querySelector("#formulario-dos-grupos"),b=i.querySelector("#mensaje-error"),t=i.querySelector("#resultados-dos-grupos"),s=["student","welch","mann-whitney"],k=sessionStorage.getItem("kernel-prueba-dos-grupos");s.includes(k)&&(l.elements.prueba.value=k),sessionStorage.removeItem("kernel-prueba-dos-grupos");const f=l.elements.grupo1,h=l.elements.grupo2,v=i.querySelector("#contador-grupo-1"),o=i.querySelector("#contador-grupo-2"),e=()=>{v.textContent=ta(aa(f.value)),o.textContent=ta(aa(h.value))};return f.addEventListener("input",e),h.addEventListener("input",e),l.addEventListener("submit",a=>{a.preventDefault(),Oe(b);try{const r=l.elements.prueba.value;if(!r)throw new Error("Seleccione la prueba estadística que desea ejecutar.");const n=ea(f.value,"El grupo 1"),c=ea(h.value,"El grupo 2"),d=Number(l.elements.nivelConfianza.value),u=Zr({grupo1:n,grupo2:c,prueba:r,nivelConfianza:d});t.innerHTML=en(u),t.classList.remove("hidden"),t.scrollIntoView({behavior:"smooth",block:"start"})}catch(r){t.classList.add("hidden"),Sr(b,r instanceof Error?r.message:"No fue posible ejecutar el análisis.")}}),i.addEventListener("click",a=>{const r=a.target.closest("[data-action]");if(!r)return;const n=r.dataset.action;if(n==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}if(n==="cargar-ejemplo"){l.elements.prueba.value||(l.elements.prueba.value="welch"),f.value=`18
20
17.5
19
21
...
16
15.5
14.5`,e(),Oe(b),t.classList.add("hidden");return}n==="limpiar"&&(l.reset(),f.value="",h.value="",e(),Oe(b),t.innerHTML="",t.classList.add("hidden"))}),i}function ea(i,l){const b=i.trim();if(!b)throw new Error(`${l} no contiene datos.`);const t=b.split(/[\s;]+/).filter(Boolean),s=t.map(f=>Number(f.replace(",","."))),k=s.findIndex(f=>!Number.isFinite(f));if(k!==-1)throw new Error(`${l} contiene un valor no válido: "${t[k]}".`);if(s.length<2)throw new Error(`${l} debe contener al menos dos observaciones.`);return s}function aa(i){return i.trim()?i.trim().split(/[\s;]+/).filter(Boolean).length:0}function ta(i){return i===1?"1 valor":`${i} valores`}function Sr(i,l){i.textContent=l,i.classList.remove("hidden")}function Oe(i){i.textContent="",i.classList.add("hidden")}function I(i,l=4){return Number.isFinite(i)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:l}).format(i):"—"}function jr(i){return Number.isFinite(i)?i<.001?"< 0.001":I(i,4):"—"}function en(i){const l=i.valorP<.05,b=l?"Se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = 0.05.":"No se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = 0.05.";return`
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            <header class="bg-emerald-700 text-white px-6 py-8 md:px-10">
                <p class="uppercase tracking-widest text-emerald-100 text-xs font-black mb-2">
                ...
                <p class="text-emerald-100 mt-3 font-semibold">
                    ${i.metodo||i.metodoValorP||""}
                </p>
            </header>

            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ${ve(i.estadistico.simbolo,I(i.estadistico.valor),"Estadístico")}

                    ${ve("p",jr(i.valorP),"Valor bilateral")}

                    ${ve("n₁",i.grupo1.n,"Grupo 1")}

                    ${ve("n₂",i.grupo2.n,"Grupo 2")}
                </div>
    ...
    `}function ra(i,l){return`
        <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <dl class="grid grid-cols-2 gap-4">
                ...
                ${N("Mediana",I(l.mediana))}

                ${N("Desviación estándar",I(l.desviacionEstandar))}

                ${N("Varianza",I(l.varianza))}
    ...
    `}function an(i){if(i.id==="mann-whitney")return`
            <article class="mt-6 rounded-2xl border border-violet-200 bg-violet-50 p-6">
                ...
                <dl class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ${N("Suma de rangos, grupo 1",I(i.sumaRangos1))}

                    ${N("Suma de rangos, grupo 2",I(i.sumaRangos2))}

                    ${N("U₁",I(i.estadistico.u1))}

                    ${N("U₂",I(i.estadistico.u2))}

                    ${N("z",I(i.estadisticoZ))}

                    ${N("Delta de Cliff",I(i.tamanioEfecto.deltaCliff))}

                    ${N("Correlación r",I(i.tamanioEfecto.r))}
                </dl>
            </article>
        `;const l=i.intervaloConfianza;return`
        <article class="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-6">
            ...
            <dl class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ${N("Diferencia de medias",I(i.diferenciaMedias))}

                ${N("Error estándar",I(i.errorEstandar))}

                ${N("Grados de libertad",I(i.gradosLibertad))}

                ${N(`IC ${l.nivel*100} %: límite inferior`,I(l.inferior))}

                ${N(`IC ${l.nivel*100} %: límite superior`,I(l.superior))}

                ${N("d de Cohen",I(i.tamanioEfecto.dCohen))}

                ${N("g de Hedges",I(i.tamanioEfecto.gHedges))}
            </dl>
        </article>
    `}function N(i,l){return`
    ...
    `}const tn={home:{page:Ma,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:st,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:ft,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:ht,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:Nt,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Vt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:ar,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:Wt,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:ur,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:xr,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:vr,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Cr,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},calculadoraDosGrupos:{page:Xr,layout:"default",title:"Comparación de dos grupos | El Kernel"}};let na=document.referrer||"";function Le(i){window.location.hash=`/${i}`}function rn(){const i=()=>{const l=window.location.hash.replace("#/","")||"home";on(l)};window.addEventListener("hashchange",i),i()}function nn(i,l){const b=`${window.location.origin}${window.location.pathname}#/${i}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:l,page_location:b,page_referrer:na}),na=b}function on(i){const l=document.querySelector("main"),b=tn[i];if(l){if(l.innerHTML="",!b){Le("home");return}bt(b.layout),document.title=b.title,l.appendChild(b.page()),window.scrollTo({top:0,behavior:"auto"}),nn(i,b.title)}}function sn(i,l){ia(i,Le),rn();const b=window.matchMedia("(max-width: 768px)");let t=!1;function s(f){f.matches&&!t&&(Ve(i),t=!0)}b.addEventListener("change",s),s(b),Ve(i);const k=l.querySelector('[data-action ="open-menu"]');Pa(k,i),$a(i)}const ya=document.querySelector("#header");ya.innerHTML=Aa();const ka=document.querySelector("#navBar");ka.innerHTML=Ca();const ln=document.querySelector("#footer");ln.innerHTML=Ea();sn(ka,ya);
