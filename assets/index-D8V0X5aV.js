(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const re=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Me(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function $e(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${re}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function be(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function Fe(e){be(e,ae)}const ge=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Ne=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Be=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,de=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${ge}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${Ne}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        <img src="${Be}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function qe(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=de.length,n=1500;let r=0,c=null;function h(d){return(d%o+o)%o}function v(){i.innerHTML=de[r].content}function p(d){r=h(r+d),v()}function E(){f(),c=setInterval(()=>p(1),n)}function f(){c&&(clearInterval(c),c=null)}function u(){E()}v(),E(),t.addEventListener("click",()=>{p(1),u()}),a.addEventListener("click",()=>{p(-1),u()})}function Ue(){const e=`
        <section class="
    ...
    `,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return qe(a.querySelector("#containerFather")),Fe(a.querySelector("#btnsGroup")),a}const Re="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function Oe(){try{const e=await fetch(Re,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const t=await e.json();if(!t.ok||!t.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(t.visitantes.total)||0,hoy:Number(t.visitantes.hoy)||0,ultimos7Dias:Number(t.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(t.visitantes.ultimos30Dias)||0,actualizadoEn:t.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function W(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function Ge(e){if(!e)return null;const t=new Date(e);return Number.isNaN(t.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(t)}async function Ke(e){const t=e.querySelector("#analytics-total"),a=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!t||!a||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const r=await Oe();t.textContent=W(r.total),a.textContent=W(r.hoy),i.textContent=W(r.ultimos7Dias),o.textContent=W(r.ultimos30Dias);const c=Ge(r.actualizadoEn);n.textContent=c?`Actualizado: ${c}`:"Estadísticas temporalmente no disponibles"}catch(r){console.error("Error al mostrar las estadísticas en la portada:",r),t.textContent="—",a.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function Ve(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=Te();const t=Ue();return e.appendChild(t),Ke(e),e}function He(){return Ve()}const Je=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Qe(){return`
        <section 
            role="banner" 
    ...
    `}const et="data:image/png;base64,",tt="data:image/png;base64,",at="data:image/png;base64,",it="data:image/png;base64,",ot="data:image/png;base64,",st=[{icon:et,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:tt,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:at,title:"Objetivos",content:`
      ...
      </ul>`},{icon:it,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function nt({icon:e,title:t,content:a}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${ot}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function lt(){const e=document.createElement("section");return e.className=`
    ...
    `,e.innerHTML=`
        ...
        ${Ze()}
        ${rt()}
    `,e}function ct(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),n=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(r=>{r.classList.remove("max-h-[1000px]"),r.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(r=>{r.classList.remove("rotate-180")}),n||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function dt(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function pt(){const e=lt();return ct(e),dt(e),e}function F(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ut(e=[]){return!e||e.length===0?`
    ...
    `).join("")}function mt(e){return e?String(e).split(",").map(a=>a.trim()).filter(Boolean).slice(0,4).map(a=>`
    ...
    `).join(""):""}function xt(e){const t=document.createElement("article");t.className=`
    ...
    `;const a=ut(e.redes||[]),i=mt(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return t.innerHTML=`
    ...
    `,t}const fe=""+new URL("rad-B3ff1btG.png",import.meta.url).href,he=""+new URL("mar-Cru0HERG.png",import.meta.url).href,K=[{img:Z,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:te,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:fe,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:ne,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:he,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:ee,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:Y,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function bt(){let e=0,t=null,a=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const u=o();return Math.max(K.length-u,0)},r=()=>{const u=n();e>u&&(e=0),e<0&&(e=u)},c=()=>{const u=n();e>=u?e=0:e++,f()},h=()=>{const u=n();e<=0?e=u:e--,f()},v=()=>{p(),K.length>o()&&(t=setInterval(c,4500))},p=()=>{t&&(clearInterval(t),t=null)},E=()=>{const u=o(),d=Math.max(K.length-u+1,1);return Array.from({length:d}).map((w,x)=>`
        ...
        `).join("")},f=()=>{if(!K||K.length===0){i.innerHTML=`
            ...
            `;return}r();const u=o(),d=K.slice(e,e+u);i.innerHTML=`
        ...
        `;const w=i.querySelector("#cards-wrapper");d.forEach(k=>{w.appendChild(xt(k))});const x=i.querySelector("#prev-btn"),y=i.querySelector("#next-btn");x&&(x.onclick=()=>{h(),v()}),y&&(y.onclick=()=>{c(),v()}),i.querySelectorAll("[data-dot-index]").forEach(k=>{k.onclick=()=>{e=parseInt(k.dataset.dotIndex),f(),v()}})};return i.addEventListener("mouseenter",p),i.addEventListener("mouseleave",v),document.addEventListener("visibilitychange",()=>{document.hidden?p():v()}),window.addEventListener("resize",()=>{clearTimeout(a),a=setTimeout(()=>{e=0,f(),v()},150)}),f(),v(),i}function gt(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-route]");if(!a)return;const i=window.location.hash.replace("#/","")||"equipment";a.dataset.route!==i&&ae(a.dataset.route)})}function ve(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",t=document.createElement("nav"),a="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return t.className="w-full flex justify-center mb-6",t.innerHTML=`
    ...
    `,gt(t),t}function ft(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=document.createElement("div");t.className="mb-6",t.appendChild(ve());const a=bt();return e.appendChild(t),e.appendChild(a),e}function ht(){return ft()}function vt(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function z(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function we(e){return e.formacion?.length||0}function ye(e){return e.experiencia?.length||0}function wt(e,t=!1){const a=we(e),i=ye(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function yt(e){const t=e.formacion||[],a=e.experiencia||[],i=t.length?t.map(c=>`
                        ...
                        ">
                            ...
                            ">
                                ...
                                <div class="flex flex-wrap items-center gap-3 mb-5">
                                    ...
                                    ">
                                        ${R(e.category||"Noticia destacada")}
                                    </span>
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Dt({id:e,title:t,date:a,image:i,imageAlt:o,excerpt:n,category:r="Noticia",imageFit:c="contain"}){const h=c==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
        ...
        >
            ...
            ">
                ${i?`
                            <img
                                src="${B(i)}"
                                alt="${B(o||t)}"
                                class="w-full h-full ${h} rounded-xl"
                                loading="lazy"
                            />
                          `:`
                            <div class="w-full h-full flex items-center justify-center text-slate-400 font-bold">
            ...
            <div class="p-4 space-y-3 flex flex-col flex-1">
                ...
                <button
                    type="button"
                    data-news-btn="${B(e)}"
                    aria-label="Ver detalles de la noticia ${B(t)}"
                    class="
    ...
    `}function jt(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),t=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function It(e=[]){return[...e].sort((t,a)=>t.featured&&!a.featured?-1:!t.featured&&a.featured?1:0)}function zt(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const t=It(ke),a=t.find(i=>i.featured)||t[0];return e.innerHTML=`
        ${$t(a)}
        ${Pt(t)}
        ${jt()}
    `,e}function Tt({title:e,content:t={paragraphs:[],list:[]},articleURL:a}){const i=(t.paragraphs||[]).map(r=>`<p>${r}</p>`).join(""),o=(t.list||[]).length?`
    ...
    `}function Ft(e){e&&e.addEventListener("click",t=>{const a=t.target.closest("[data-news-btn], [data-news-card]");if(!a||!e.contains(a))return;const i=a.dataset.newsBtn||a.dataset.newsCard,o=ke.find(n=>String(n.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}Nt(o)})}function Nt(e){const t=document.querySelector("#newsModal");t&&t.remove();const a=document.createElement("div");a.innerHTML=Tt(e);const i=a.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",n)}function n(r){r.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(r=>{r.addEventListener("click",o)}),i.addEventListener("click",r=>{r.target===i&&o()}),document.addEventListener("keydown",n)}function Bt(){const e=zt();return Ft(e),e}function D(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ae(e){return e?.name||e?.title||"Investigador"}function pe(e){return e?.title||e?.tile||"Revista no especificada"}function Ce(e){return String(e?.DOI||e?.doi||"").trim()}function qt(e){const t=Ce(e);return e?.url?e.url:t?t.startsWith("http")?t:`https://doi.org/${t}`:"#"}function Ut(e){return[...e?.publicaciones||[]].sort((t,a)=>{const i=Number(t.year||0),o=Number(a.year||0);return i!==o?o-i:String(t.contenido||"").localeCompare(String(a.contenido||""))})}function Rt(e,t=!1){const a=Ae(e),i=e.publicaciones||[],o=i.length,n=i.map(c=>Number(c.year)).filter(Boolean),r=n.length?Math.max(...n):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${t?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function Ot(e){if(!e)return`
        ...
        `;const t=Ae(e),a=Ut(e),i=a.length,o=a.map(p=>Number(p.year)).filter(Boolean),n=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",c=[...new Set(a.map(p=>p.q).filter(Boolean))],h=[...new Set(a.map(p=>pe(p)).filter(Boolean))],v=a.map(p=>{const E=pe(p),f=Ce(p),u=qt(p);return`
    ...
    `}function Gt(){let e=N[0]?.id||1,t=!1,a=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(d){return String(d?.DOI||d?.doi||"").trim().toLowerCase()}function n(d){return String(d?.journal||d?.title||d?.tile||"").trim()}function r(d){return String(d?.articleTitle||d?.contenido||"").trim()}function c(d){return String(d?.q||d?.quartile||"").trim().toUpperCase()}function h(d){const w=o(d);return w||[d?.year||"",n(d),r(d)].join("-").trim().toLowerCase()}function v(){const d=new Map;return N.forEach(w=>{(w.publicaciones||[]).forEach(x=>{const y=h(x);y&&!d.has(y)&&d.set(y,x)})}),Array.from(d.values())}function p(){const d=v(),w=d.map(L=>Number(L.year)).filter(Boolean),x=w.length?Math.max(...w):"—",y=w.length?Math.min(...w):"—",k=d.filter(L=>c(L)==="Q1").length;return{totalPublicaciones:d.length,investigadores:N.length,q1:k,primerYear:y,ultimoYear:x}}function E(){return N.find(d=>Number(d.id)===Number(e))||N[0]}const f=()=>{const d=E(),w=p(),x=window.innerWidth<768&&!t;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${N.map(k=>Rt(k,Number(k.id)===Number(e))).join("")}
                </aside>
    ...
    `).join("")}function Jt(e=[]){return e.map(t=>`
    ...
    `}function Yt(e){const t=e.proyectosAsociados&&e.proyectosAsociados.length>0,a=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function Wt(){const e=new Set(O.map(i=>i.categoria)),t=O.filter(i=>i.proyectosAsociados?.length>0).length,a=O.filter(i=>i.publicacionesClave?.length>0).length;return{total:O.length,categorias:e.size,conProyectos:t,conPublicaciones:a}}function Xt(){let e=O[0]?.id||1;const t=document.createElement("section");t.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=Vt(e),o=Wt();t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function oa(){let e=Q[0]?.id||1;const t=document.createElement("section");t.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=Zt(e);t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,t.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),a()}})};return a(),t}function sa(){return oa()}function ra(){return`
    ...
    `}function la(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${na()}
    `,e}function ca(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",da)}async function da(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=pa(i);if(o.length>0){ma(o);return}await xa(t,i)}function pa(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?ua(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function ua(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function ma(e){_(e[0],"error")}function _(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function xa(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(_("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):_("Hubo un problema al enviar el mensaje.","error")}catch{_("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function ba(){const e=la();return setTimeout(()=>{ca()},0),e}function ga(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
A00116736    13    7"
    ...
    `;const t=e.querySelector("#banner-primer-input"),a=e.querySelector("#banner-primer-process"),i=e.querySelector("#banner-primer-clear"),o=e.querySelector("#banner-primer-message"),n=e.querySelector("#banner-primer-preview"),r=e.querySelector("#banner-primer-count"),c=e.querySelector("#banner-primer-download-1ac"),h=e.querySelector("#banner-primer-download-2pp");let v=[];function p(s,g="success"){o.textContent=s,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),g==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function E(){o.textContent="",o.classList.add("hidden")}function f(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function u(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function d(s){const g=String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return g.includes("	")?g.split("	").map(b=>b.trim()).filter(b=>b!==""):g.includes(";")?g.split(";").map(b=>b.trim()).filter(b=>b!==""):g.split(/\s+/).map(b=>b.trim()).filter(b=>b!=="")}function w(s){const g=s.split(/\r?\n/).map(A=>A.trim()).filter(Boolean),b=[],C=[],j=new Set;return g.forEach((A,$)=>{const S=$+1,P=d(A);if(P.length!==3){C.push(`Línea ${S}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const G=f(P[0]),H=Number(u(P[1])),J=Number(u(P[2]));if(!/^A[0-9]{8}$/.test(G)){C.push(`Línea ${S}: la matrícula "${G}" no es válida. Debe tener el formato A00108671.`);return}if(j.has(G)){C.push(`Línea ${S}: la matrícula ${G} está repetida.`);return}if(!Number.isFinite(H)){C.push(`Línea ${S}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(J)){C.push(`Línea ${S}: la calificación 2PP no es numérica.`);return}if(H<0||H>15){C.push(`Línea ${S}: 1AC debe estar entre 0 y 15.`);return}if(J<0||J>20){C.push(`Línea ${S}: 2PP debe estar entre 0 y 20.`);return}const le=H+J;if(le>35){C.push(`Línea ${S}: la suma de 1AC y 2PP no puede superar 35 puntos.`);return}j.add(G),b.push({matricula:G,grade1AC:H,grade2PP:J,total:le})}),{records:b,errors:C}}function x(s){return Number.isInteger(s)?String(s):s.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function y(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function k(s){if(s.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="5"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=s.map((g,b)=>`
                ...
                `).join(""),r.textContent=`${s.length} estudiante${s.length===1?"":"s"}`}function L(s,g,b){return[["MATRICULA",b],...s.map(A=>[A.matricula,x(A[g])])].map(A=>A.join(";")).join(`\r
`)}function l(s,g){const C=new Blob(["\uFEFF"+s],{type:"text/csv;charset=utf-8;"}),j=URL.createObjectURL(C),A=document.createElement("a");A.href=j,A.download=g,document.body.appendChild(A),A.click(),A.remove(),window.setTimeout(()=>{URL.revokeObjectURL(j)},1e3)}function m(){v=[],t.value="",k([]),c.disabled=!0,h.disabled=!0,E(),t.focus()}return a.addEventListener("click",()=>{const s=t.value.trim();if(!s){v=[],k([]),c.disabled=!0,h.disabled=!0,p("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:g,errors:b}=w(s);if(b.length>0){v=[],k([]),c.disabled=!0,h.disabled=!0,p(b.join(" "),"error");return}v=g,k(v),c.disabled=!1,h.disabled=!1,p(`Los datos de ${g.length} estudiante${g.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",m),c.addEventListener("click",()=>{if(v.length===0)return;const s=L(v,"grade1AC","1AC");l(s,"Banner_APEC_Primer_Periodo_1AC.csv")}),h.addEventListener("click",()=>{if(v.length===0)return;const s=L(v,"grade2PP","2PP");l(s,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function fa(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    25"
    ...
    `;const t=e.querySelector("#banner-segundo-input"),a=e.querySelector("#banner-segundo-process"),i=e.querySelector("#banner-segundo-clear"),o=e.querySelector("#banner-segundo-message"),n=e.querySelector("#banner-segundo-preview"),r=e.querySelector("#banner-segundo-count"),c=e.querySelector("#banner-segundo-download");let h=[];function v(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function p(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function E(l){const m=String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return m.includes("	")?m.split("	").map(s=>s.trim()).filter(s=>s!==""):m.includes(";")?m.split(";").map(s=>s.trim()).filter(s=>s!==""):m.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function f(l){return Number.isInteger(l)?String(l):l.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function u(l){return String(l).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function d(l,m="success"){o.textContent=l,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),m==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(l){const m=l.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),s=[],g=[],b=new Set;return m.forEach((C,j)=>{const A=j+1,$=E(C);if($.length!==2){g.push(`Línea ${A}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const S=v($[0]),P=Number(p($[1]));if(!/^A[0-9]{8}$/.test(S)){g.push(`Línea ${A}: la matrícula "${S}" no es válida. Debe tener el formato A00108671.`);return}if(b.has(S)){g.push(`Línea ${A}: la matrícula ${S} está repetida.`);return}if(!Number.isFinite(P)){g.push(`Línea ${A}: la calificación 3SP no es numérica.`);return}if(P<0||P>35){g.push(`Línea ${A}: 3SP debe estar entre 0 y 35.`);return}b.add(S),s.push({matricula:S,grade3SP:P})}),{records:s,errors:g}}function x(l){if(l.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=l.map((m,s)=>`
                    <tr class="border-b border-slate-100 last:border-b-0">
                        <td class="px-4 py-3 text-slate-500">
                            ${s+1}
                        </td>
                ...
                `).join(""),r.textContent=`${l.length} estudiante${l.length===1?"":"s"}`}function y(l){return[["MATRICULA","3SP"],...l.map(s=>[s.matricula,f(s.grade3SP)])].map(s=>s.join(";")).join(`\r
`)}function k(l,m){const s=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),g=URL.createObjectURL(s),b=document.createElement("a");b.href=g,b.download=m,document.body.appendChild(b),b.click(),b.remove(),window.setTimeout(()=>{URL.revokeObjectURL(g)},1e3)}function L(){h=[],t.value="",x([]),c.disabled=!0,o.textContent="",o.classList.add("hidden"),t.focus()}return a.addEventListener("click",()=>{const l=t.value.trim();if(!l){h=[],x([]),c.disabled=!0,d("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:m,errors:s}=w(l);if(s.length>0){h=[],x([]),c.disabled=!0,d(s.join(" "),"error");return}h=m,x(m),c.disabled=!1,d(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",L),c.addEventListener("click",()=>{h.length!==0&&k(y(h),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function ha(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    20"
    ...
    `;const t=e.querySelector("#banner-final-input"),a=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),n=e.querySelector("#banner-final-preview"),r=e.querySelector("#banner-final-count"),c=e.querySelector("#banner-final-download");let h=[];function v(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function p(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function E(l){const m=String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return m.includes("	")?m.split("	").map(s=>s.trim()).filter(s=>s!==""):m.includes(";")?m.split(";").map(s=>s.trim()).filter(s=>s!==""):m.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function f(l){return Number.isInteger(l)?String(l):l.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function u(l){return String(l).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function d(l,m="success"){o.textContent=l,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),m==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(l){const m=l.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),s=[],g=[],b=new Set;return m.forEach((C,j)=>{const A=j+1,$=E(C);if($.length!==2){g.push(`Línea ${A}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const S=v($[0]),P=Number(p($[1]));if(!/^A[0-9]{8}$/.test(S)){g.push(`Línea ${A}: la matrícula "${S}" no es válida. Debe tener el formato A00108671.`);return}if(b.has(S)){g.push(`Línea ${A}: la matrícula ${S} está repetida.`);return}if(!Number.isFinite(P)){g.push(`Línea ${A}: la calificación 4EF no es numérica.`);return}if(P<0||P>30){g.push(`Línea ${A}: 4EF debe estar entre 0 y 30.`);return}b.add(S),s.push({matricula:S,grade4EF:P})}),{records:s,errors:g}}function x(l){if(l.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=l.map((m,s)=>`
                ...
                `).join(""),r.textContent=`${l.length} estudiante${l.length===1?"":"s"}`}function y(l){return[["MATRICULA","4EF"],...l.map(s=>[s.matricula,f(s.grade4EF)])].map(s=>s.join(";")).join(`\r
`)}function k(l,m){const s=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),g=URL.createObjectURL(s),b=document.createElement("a");b.href=g,b.download=m,document.body.appendChild(b),b.click(),b.remove(),window.setTimeout(()=>{URL.revokeObjectURL(g)},1e3)}function L(){h=[],t.value="",x([]),c.disabled=!0,o.textContent="",o.classList.add("hidden"),t.focus()}return a.addEventListener("click",()=>{const l=t.value.trim();if(!l){h=[],x([]),c.disabled=!0,d("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:m,errors:s}=w(l);if(s.length>0){h=[],x([]),c.disabled=!0,d(s.join(" "),"error");return}h=m,x(m),c.disabled=!1,d(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",L),c.addEventListener("click",()=>{h.length!==0&&k(y(h),"Banner_APEC_Examen_Final_4EF.csv")}),e}function va(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const t=e.querySelector("#banner-menu"),a=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),n=e.querySelector("#open-segundo-periodo"),r=e.querySelector("#open-calificacion-final"),c=e.querySelector("#banner-back");function h(){t.classList.add("hidden"),a.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}function v(f){console.error("No fue posible abrir la herramienta de Banner:",f),i.innerHTML=`
            <div
        ...
        `,h()}function p(f){i.innerHTML="";try{if(typeof f!="function")throw new TypeError("El componente seleccionado no es una función válida.");const u=f();if(!(u instanceof HTMLElement))throw new TypeError("El componente seleccionado no devolvió un elemento HTML válido.");i.appendChild(u),h()}catch(u){v(u)}}function E(){i.replaceChildren(),a.classList.add("hidden"),t.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}return o.addEventListener("click",()=>{p(ga)}),n.addEventListener("click",()=>{p(fa)}),r.addEventListener("click",()=>{p(ha)}),c.addEventListener("click",E),e}function wa(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
        <div class="mb-8 text-center">
...
20252000     0"
    ...
    `;const t=e.querySelector("#xmera-input"),a=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),n=e.querySelector("#xmera-clear"),r=e.querySelector("#xmera-message"),c=e.querySelector("#tab-xmera"),h=e.querySelector("#tab-banner"),v=e.querySelector("#panel-xmera"),p=e.querySelector("#panel-banner");function E(){a.textContent=`var data_todo = {
};`,o.disabled=!0}function f(x,y="success"){r.textContent=x,r.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),r.classList.add("border"),y==="error"?r.classList.add("border-red-200","bg-red-50","text-red-800"):r.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function u(x){const y=x.split(/\r?\n/).map(m=>m.trim()).filter(Boolean),k=[],L=[],l=new Set;return y.forEach((m,s)=>{const g=m.split(/[\t,; ]+/).map($=>$.trim()).filter(Boolean),b=s+1,C=g[0],j=g.slice(1);if(!C){L.push(`Línea ${b}: falta la matrícula.`);return}if(!/^\d+$/.test(C)){L.push(`Línea ${b}: la matrícula "${C}" no es válida.`);return}if(l.has(C)){L.push(`Línea ${b}: la matrícula ${C} está repetida.`);return}if(j.length===0){L.push(`Línea ${b}: falta al menos una calificación.`);return}const A=j.map($=>Number($));if(A.some($=>!Number.isFinite($))){L.push(`Línea ${b}: existe una calificación no numérica.`);return}l.add(C),k.push({matricula:C,grades:A})}),{records:k,errors:L}}function d(x){return`var data_todo = {
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function w(x){const y=x==="xmera";v.classList.toggle("hidden",!y),p.classList.toggle("hidden",y),c.className=y?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",h.className=y?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const x=t.value.trim();if(!x){E(),f("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:y,errors:k}=u(x);if(k.length>0){E(),f(k.join(" "),"error");return}a.textContent=d(y),o.disabled=!1,f(`Código generado correctamente para ${y.length} estudiante${y.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a.textContent),f("El código fue copiado al portapapeles.")}catch(x){console.error("No fue posible copiar el código:",x),f("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),n.addEventListener("click",()=>{t.value="",E(),r.textContent="",r.classList.add("hidden"),t.focus()});try{const x=va();if(x instanceof HTMLElement)p.appendChild(x);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(x){console.error("No fue posible cargar el módulo Banner:",x),p.innerHTML=`
        ...
        `}return c.addEventListener("click",()=>{w("xmera")}),h.addEventListener("click",()=>{w("banner")}),w("xmera"),e}function ya(){return wa()}function ka(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
        ...
        <section class="
            ...
            gap-6 mt-10
        ">
            ${oe("Aprender","Comprenda qué mide cada estadístico, cuándo debe utilizarse, cuáles son sus supuestos y cómo se interpreta correctamente.","libro","bg-sky-100","text-sky-700","border-sky-200")}

            ${oe("Decidir","Identifique la prueba adecuada según el objetivo, el tipo de variable, el número de grupos y el diseño de su investigación.","decision","bg-amber-100","text-amber-700","border-amber-200")}

            ${oe("Analizar","Introduzca sus datos, ejecute el análisis, interprete los resultados y genere reportes metodológicamente adecuados.","analisis","bg-emerald-100","text-emerald-700","border-emerald-200")}
        </section>
        ...
        <section class="mt-14">
            ...
            ">
                ${q("Estadística descriptiva","Media, mediana, varianza, desviación estándar, cuartiles, asimetría y gráficos.","estadistica","bg-sky-100","text-sky-700","border-sky-200")}

                ${q("Comparación de grupos","Pruebas t, Welch, Mann–Whitney, Wilcoxon, ANOVA y alternativas no paramétricas.","grupos","bg-indigo-100","text-indigo-700","border-indigo-200")}

                ${q("Correlación y asociación","Pearson, Spearman, Kendall y medidas de asociación entre variables.","correlacion","bg-violet-100","text-violet-700","border-violet-200")}

                ${q("Cuestionarios y fiabilidad","Alfa de Cronbach, omega de McDonald y análisis de ítems.","cuestionario","bg-amber-100","text-amber-700","border-amber-200")}

                ${q("Evaluación educativa","Dificultad, discriminación, correlación punto-biserial y análisis de distractores.","evaluacion","bg-emerald-100","text-emerald-700","border-emerald-200")}

                ${q("Tamaño de muestra","Estimación del tamaño mínimo, potencia estadística y pérdidas previstas.","muestra","bg-cyan-100","text-cyan-700","border-cyan-200")}

                ${q("Regresión","Regresión lineal, múltiple y logística con interpretación guiada.","regresion","bg-rose-100","text-rose-700","border-rose-200")}

                ${q("¿Qué prueba debo utilizar?","Asistente guiado para seleccionar la prueba más adecuada según su diseño.","decision","bg-blue-100","text-blue-700","border-blue-200","asistentePruebas")}
                
                ${q("Biblioteca metodológica","Definiciones, supuestos, tamaños del efecto, intervalos de confianza y errores frecuentes.","biblioteca","bg-slate-200","text-slate-700","border-slate-300")}
            </div>
        </section>
    `,e}function oe(e,t,a,i,o,n){return`
        <article class="
            h-full bg-white
            border border-slate-200
            rounded-3xl p-7
    ...
    `}function q(e,t,a,i,o,n,r=""){return`
        <article class="
    ...
    `}function T(e,t="w-7 h-7"){const a=`
        class="${t}"
        viewBox="0 0 24 24"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
    ...
    `,i={analisis:`
        ...
        `};return i[e]||i.estadistica}function Aa(){const e=document.createElement("section");e.className=`
    ...
    `;const t=e.querySelector("#asistente-pruebas");return t.addEventListener("click",a=>{const i=a.target.closest("[data-action]");if(!i)return;const o=i.dataset.action;o==="iniciar"&&(t.innerHTML=Ca()),o==="volver-inicio"&&(t.innerHTML=me()),o==="volver-laboratorio"&&(window.location.hash="/laboratorioKernel")}),e}function me(){return`
        <section class="
            relative overflow-hidden
            rounded-3xl
            bg-slate-950 text-white
        ...
        ">
            ...
            <div class="relative z-10 max-w-4xl">
                ...
                ">
                    ${X("1","Describa su investigación","Indique qué desea comparar, relacionar, asociar o predecir.")}

                    ${X("2","Identifique sus variables","Seleccione el tipo de variable y la estructura de sus datos.")}

                    ${X("3","Responda sobre el diseño","Informe el número de grupos y si las muestras son independientes.")}

                    ${X("4","Obtenga una recomendación","Reciba la prueba sugerida, sus supuestos y su interpretación.")}
                </div>
        ...
        <section class="
            ...
            gap-5 mt-8
        ">
            ${se("Comparación de grupos","Pruebas t, Welch, ANOVA, Mann–Whitney, Wilcoxon, Kruskal–Wallis y Friedman.")}

            ${se("Relación y asociación","Correlaciones de Pearson, Spearman y Kendall, chi-cuadrado y otras medidas.")}

            ${se("Predicción y modelización","Regresión lineal, múltiple, logística y modelos para variables de conteo.")}
        </section>
    `}function Ca(){return`
        <section class="
            rounded-3xl
        ...
        ">
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                ...
                <div class="
                    ...
                    gap-4
                ">
                    ${V("comparar","Comparar grupos","Determinar si existen diferencias entre dos o más grupos.")}

                    ${V("relacionar","Relacionar variables","Analizar la intensidad y dirección de la relación entre variables.")}

                    ${V("asociar","Medir asociación","Evaluar si dos variables categóricas están asociadas.")}

                    ${V("predecir","Predecir una variable","Construir un modelo para explicar o predecir un resultado.")}

                    ${V("instrumento","Evaluar un instrumento","Analizar fiabilidad, consistencia interna o comportamiento de ítems.")}

                    ${V("otro","Otro objetivo","Explorar otros tipos de análisis estadístico o metodológico.")}
                </div>
    ...
    `}const Ea={home:{page:He,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:pt,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:ht,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:At,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:Bt,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Kt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:sa,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:_t,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:ba,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:ya,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:ka,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Aa,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"}};let xe=document.referrer||"";function ae(e){window.location.hash=`/${e}`}function Sa(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";La(t)};window.addEventListener("hashchange",e),e()}function Ma(e,t){const a=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:t,page_location:a,page_referrer:xe}),xe=a}function La(e){const t=document.querySelector("main"),a=Ea[e];if(t){if(t.innerHTML="",!a){ae("home");return}vt(a.layout),document.title=a.title,t.appendChild(a.page()),window.scrollTo({top:0,behavior:"auto"}),Ma(e,a.title)}}function $a(e,t){be(e,ae),Sa();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(ce(e),i=!0)}a.addEventListener("change",o),o(a),ce(e);const n=t.querySelector('[data-action ="open-menu"]');De(n,e),Pe(e)}const Ee=document.querySelector("#header");Ee.innerHTML=Me();const Se=document.querySelector("#navBar");Se.innerHTML=Le();const Da=document.querySelector("#footer");Da.innerHTML=$e();$a(Se,Ee);
