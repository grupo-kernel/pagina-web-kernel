const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./authGuard-CEzcrBkK.js","./authService-CgfoSPdf.js","./firebase-BzP43VG7.js","./login-BtABpxCq.js","./LaboratorioKernel-BtMa0jdz.js","./AsistentePruebas-BOi_3rhz.js","./metadatosFichasMetodologicas-BbzfSE5K.js","./CalculadoraDosGrupos-DiyIaRBM.js","./jstat-DiDocX-r.js","./exportacionesCalculadoras-CyqpoDub.js","./CalculadoraDosMuestrasRelacionadas-Gp_ZJZML.js","./estadisticaDosMuestrasRelacionadas-BqGxjkhn.js","./CalculadoraTresOMasGrupos-DrdNVeR5.js","./CalculadoraTresOMasMedicionesRelacionadas-tA6HRycI.js","./CalculadoraRelacionVariables-LFWvl0Yx.js","./CalculadoraAsociacionCategorica-CM1GEPxd.js","./CalculadoraEstadisticaDescriptiva-BFzIXE2D.js","./CalculadoraFiabilidadCuestionarios-CyGGGm8w.js","./CalculadoraEvaluacionEducativa-D_bSZkvD.js","./CalculadoraTamanoMuestraPotencia-BPLOehAH.js","./BibliotecaMetodologica-BzzsJJUi.js","./CalculadoraRegresionCompleta--jpj7e9z.js","./CalculadoraRegresionLogistica-DDhA4hE5.js","./CalculadoraRegresionConteo-CMkj4ZtH.js","./CalculadoraUnaMuestra-IXrYuSIm.js"])))=>i.map(i=>d[i]);
(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();const Le=""+new URL("ElKernel-BvHOWfRq.webp",import.meta.url).href;function yt(){return`
    ...
    `}function $a({id:e,etiqueta:a,icono:t,elementos:i}){return`
    ...
    `}function kt(){return`
        ...
        <ul class="relative z-[230] flex min-h-full w-full flex-col gap-1 p-3 text-black lg:min-h-0 lg:flex-row lg:items-center lg:justify-end lg:gap-0.5 lg:p-0 xl:gap-1">
            ...
            ${$a({id:"submenu-nuestro-trabajo",etiqueta:"Investigación",icono:"bx-briefcase-alt-2",elementos:[be("lineas","Líneas de investigación","bx-git-branch"),be("proyectos","Proyectos","bx-bulb"),be("publicaciones","Publicaciones","bx-book-open"),be("herramientas","Herramientas","bx-wrench")]})}

            ${$a({id:"submenu-nosotros",etiqueta:"Nosotros",icono:"bx-group",elementos:[be("quienesSomos","Quiénes somos","bx-info-circle"),be("equipment","Equipo","bx-group")]})}

            ${we("noticias","Noticias","bx-news","lg:hidden 2xl:block")}
            ${we("contacto","Contacto","bx-envelope","lg:hidden xl:block")}
            ${wt()}
        </ul>
    `}function At(){const e=new Date().getFullYear();return`
    ...
    `});function z(e,a="text-2xl"){const t=Ia[e]||Ia["bx-grid-alt"];return`
        <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
            fill="none"
    ...
    `}const Kt=""+new URL("isfodosu-campus-Dxbx_r-n.webp",import.meta.url).href,Ht=""+new URL("uasd-campus-B6v1rNpv.webp",import.meta.url).href,Jt=""+new URL("unapec-campus-DqZO-eEo.webp",import.meta.url).href,Qt=5e3,X=Object.freeze([Object.freeze({id:"isfodosu",sigla:"ISFODOSU",nombre:"Instituto Superior de Formación Docente Salomé Ureña",descripcion:"Formación docente, educación matemática e investigación educativa.",imagen:Kt,enlace:"https://www.isfodosu.edu.do/",alt:"Fachada del Instituto Superior de Formación Docente Salomé Ureña",ancho:1260,alto:790,posicion:"50% 46%"}),Object.freeze({id:"uasd",sigla:"UASD",nombre:"Universidad Autónoma de Santo Domingo",descripcion:"Ciencias básicas, optimización, matemática aplicada y colaboración interdisciplinaria.",imagen:Ht,enlace:"https://uasd.edu.do/",alt:"Edificio y estatua en el campus de la Universidad Autónoma de Santo Domingo",ancho:1758,alto:1284,posicion:"50% 42%"}),Object.freeze({id:"unapec",sigla:"UNAPEC",nombre:"Universidad APEC",descripcion:"Matemática aplicada, computación científica, docencia y proyectos de investigación.",imagen:Jt,enlace:"https://unapec.edu.do/",alt:"Entrada principal del campus de Universidad APEC",ancho:608,alto:342,posicion:"50% 50%"})]),Ae=Object.freeze({anterior:`
    ...
    `});function le(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Xt(e,a){const t=a===0;return`
        <button
            type="button"
            role="tab"
    ...
    `;const t=[...a.querySelectorAll("[data-universidad-imagen-capa]")],i=a.querySelector("[data-universidad-sigla]"),o=a.querySelector("[data-universidad-nombre]"),r=a.querySelector("[data-universidad-descripcion]"),s=a.querySelector("[data-universidad-enlace]"),n=a.querySelector("[data-universidad-contador]"),d=a.querySelector("[data-universidad-estado]"),b=a.querySelector("[data-universidad-escenario]"),p=a.querySelector("[data-universidad-progreso]"),u=[...a.querySelectorAll("[data-universidad-control]")],f=a.querySelector("[data-action='universidad-anterior']"),h=a.querySelector("[data-action='universidad-siguiente']"),w=a.querySelector("[data-action='pausar-rotacion']"),A=a.querySelector("[data-universidad-icono-pausa]"),y=a.querySelector("[data-universidad-icono-reproducir]"),g=a.querySelector("[data-universidad-texto-rotacion]"),E=window.matchMedia("(prefers-reduced-motion: reduce)"),C=new AbortController,l={signal:C.signal};let m=0,c=0,x=0,v=null,k=null,D=null,M=!1,q=!1,P=!1,T=!1,Z=!1,B=!E.matches,H=typeof window.IntersectionObserver!="function";function me(j){return(j%X.length+X.length)%X.length}function vt(j){const S=t[c];if(S?.dataset.institucionId===j.id)return;const Q=c===0?1:0,F=t[Q],ye=++x;let Ca=!1;function Sa(){Ca||ye!==x||!F.naturalWidth||(Ca=!0,S.alt="",F.alt=j.alt,F.classList.remove("opacity-0"),F.classList.add("opacity-100"),S.classList.remove("opacity-100"),S.classList.add("opacity-0"),c=Q)}F.onload=Sa,F.onerror=()=>{ye===x&&F.removeAttribute("src")},F.alt="",F.width=j.ancho,F.height=j.alto,F.style.objectPosition=j.posicion,F.dataset.institucionId=j.id,F.src=j.imagen,F.complete&&F.naturalWidth&&window.requestAnimationFrame(Sa)}function ka(){k!==null&&window.clearTimeout(k),H&&(k=window.setTimeout(()=>{const j=X[me(m+1)],S=new Image;S.decoding="async",S.src=j.imagen,k=null},700))}function ta(j=!1){const S=X[m];vt(S),i.textContent=S.sigla,o.textContent=S.nombre,r.textContent=S.descripcion,s.href=S.enlace,s.setAttribute("aria-label",`Visitar el sitio institucional de ${S.sigla}`),n.textContent=`${String(m+1).padStart(2,"0")} / ${String(X.length).padStart(2,"0")}`,b.setAttribute("aria-labelledby",`pestana-institucion-${S.id}`),p.style.width=`${(m+1)/X.length*100}%`,u.forEach((Q,F)=>{const ye=F===m;Q.setAttribute("aria-selected",String(ye)),Q.tabIndex=ye?0:-1}),j&&(d.textContent=`${S.sigla}: ${S.nombre}`),ka()}function ee(){v!==null&&(window.clearInterval(v),v=null)}function ht(){return B&&H&&!document.hidden&&!q&&!P&&!T&&a.isConnected}function J(){ee(),ht()&&(v=window.setInterval(()=>{m=me(m+1),ta(!1)},Qt))}function ia(){const j=!B;w.setAttribute("aria-pressed",String(j)),w.setAttribute("aria-label",j?"Reanudar la rotación automática":"Pausar la rotación automática"),A.classList.toggle("hidden",j),y.classList.toggle("hidden",!j),g.textContent=j?"Reanudar rotación":"Pausar rotación"}function te(j,S=!0,Q=!1){m=me(j),ta(S),Q&&u[m]?.focus(),J()}f?.addEventListener("click",()=>te(m-1),l),h?.addEventListener("click",()=>te(m+1),l),w?.addEventListener("click",()=>{Z=!0,B=!B,ia(),B?(d.textContent="Rotación automática reanudada.",J()):(d.textContent="Rotación automática pausada.",ee())},l),u.forEach(j=>{j.addEventListener("click",()=>te(Number(j.dataset.indice)),l),j.addEventListener("keydown",S=>{S.key==="ArrowLeft"?(S.preventDefault(),te(m-1,!0,!0)):S.key==="ArrowRight"?(S.preventDefault(),te(m+1,!0,!0)):S.key==="Home"?(S.preventDefault(),te(0,!0,!0)):S.key==="End"&&(S.preventDefault(),te(X.length-1,!0,!0))},l)}),a.addEventListener("mouseenter",()=>{q=!0,ee()},l),a.addEventListener("mouseleave",()=>{q=!1,J()},l),a.addEventListener("focusin",()=>{P=!0,ee()},l),a.addEventListener("focusout",j=>{P=a.contains(j.relatedTarget),P||J()},l),b?.addEventListener("touchstart",j=>{D=j.changedTouches[0]?.clientX??null,T=!0,ee()},{...l,passive:!0}),b?.addEventListener("touchend",j=>{const S=j.changedTouches[0]?.clientX??null;if(T=!1,D!==null&&S!==null){const Q=S-D;Math.abs(Q)>45?te(m+(Q<0?1:-1)):J()}D=null},{...l,passive:!0}),b?.addEventListener("touchcancel",()=>{D=null,T=!1,J()},l),document.addEventListener("visibilitychange",()=>{document.hidden?ee():J()},l),E.addEventListener("change",()=>{Z||(B=!E.matches,ia()),B?J():ee()},l);const Aa=typeof window.IntersectionObserver=="function"?new IntersectionObserver(j=>{H=j.some(S=>S.isIntersecting&&S.intersectionRatio>=.15),H?(ka(),J()):ee()},{threshold:[0,.15,.5]}):null;Aa?.observe(a);const Ea=new MutationObserver(()=>{if(a.isConnected){M||(M=!0,J());return}M&&(ee(),k!==null&&window.clearTimeout(k),C.abort(),Aa?.disconnect(),Ea.disconnect())});return Ea.observe(document.body,{childList:!0,subtree:!0}),ta(!1),ia(),a}function Ie(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Pe(e,a,t=""){return`
    ...
    `}function Yt({integrantes:e,servicios:a,lineas:t,publicaciones:i}){const o=document.createElement("section");return o.className="mx-4 overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-lg sm:mx-6 lg:mx-8 xl:mx-10",o.setAttribute("aria-labelledby","titulo-confianza-portada"),o.innerHTML=`
    ...
    `}function oi(){const e=document.createElement("section");e.id="servicios-portada",e.className="mx-4 overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-50 shadow-lg sm:mx-6 lg:mx-8 xl:mx-10",e.setAttribute("aria-labelledby","titulo-servicios-portada");const a=ai.map(t=>ce.find(i=>i.numero===t)).filter(Boolean);return e.innerHTML=`
    ...
    `}function li(){const e=document.createElement("section");return e.className="mx-4 grid grid-cols-1 gap-6 sm:mx-6 lg:mx-8 xl:mx-10 2xl:grid-cols-[0.72fr_1.28fr]",e.setAttribute("aria-label","Proceso de trabajo y ejemplos de aplicación"),e.innerHTML=`
    ...
    `,e}function W(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ci(e){const a=String(e?.DOI||e?.doi||"").trim().toLowerCase();return a||[e?.year||"",e?.title||e?.journal||e?.tile||"",e?.contenido||e?.articleTitle||""].join("-").trim().toLowerCase()}function di(){const e=new Set;return ne.forEach(a=>{(a.publicaciones||[]).forEach(t=>{const i=ci(t);i&&e.add(i)})}),e.size}function ge(e,a,t){return`
    ...
    `}function gi(){const e=di(),a=document.createElement("section");return a.className="w-full space-y-10 bg-white pb-10 font-sans",a.innerHTML=`
        ...
        <section class="mx-4 grid grid-cols-1 gap-6 sm:mx-6 lg:mx-8 xl:mx-10 2xl:grid-cols-[1.1fr_0.9fr]" aria-label="Proyectos, equipo y producción científica">
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">${_e.slice(0,2).map(pi).join("")}</div>
            </div>
    ...
    `}function Ai(e){const a=[...e.querySelectorAll("h2")].find(n=>Oe(n.textContent)==="propuestas de investigacion");if(a){const n=a.closest("section");a.textContent="Experiencia en proyectos competitivos";const d=a.parentElement,b=d?.querySelector("p");if(b&&(b.textContent="Trayectoria financiada"),d&&!d.querySelector("[data-resumen-proyectos-portada]")){const u=document.createElement("p");u.dataset.resumenProyectosPortada="true",u.className="mt-3 max-w-3xl text-sm leading-relaxed text-slate-600 md:text-base",u.textContent=`${L.participacionesProyectosAprobados} participaciones registradas en proyectos de I+D+i; se presentan diez proyectos destacados y se contabilizan ${L.proyectosNoMostrados} registros adicionales sin desplegarlos.`,d.appendChild(u)}[...n?.querySelectorAll("article")||[]].slice(0,2).forEach((u,f)=>{const h=$e[f];h&&(u.innerHTML=ki(h))})}const i=[...e.querySelectorAll("h2")].find(n=>Oe(n.textContent).includes("conocimiento academico conectado"))?.closest("aside");if(!i||i.querySelector("[data-metrica-proyectos-aprobados]"))return;const r=[...i.querySelectorAll("p")].find(n=>Oe(n.textContent)==="articulos cientificos acumulados")?.parentElement?.parentElement;if(!r)return;r.className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3";const s=document.createElement("div");s.dataset.metricaProyectosAprobados="true",s.className="rounded-2xl bg-white p-4 ring-1 ring-slate-200",s.innerHTML=`<p class="text-3xl font-black text-[#0f5b5d]">${L.participacionesProyectosAprobadosTexto}</p><p class="mt-1 text-sm font-semibold text-slate-600">${L.etiquetaProyectos}</p>`,s.setAttribute("title",`${L.descripcionProyectos}. ${L.notaProyectos}`),s.setAttribute("aria-label",`${L.participacionesProyectosAprobadosTexto} ${L.etiquetaProyectos}. ${L.descripcionProyectos}.`),r.appendChild(s)}async function Ei(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),r=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!r){console.warn("No se encontraron los elementos de Analytics en la portada.");return}r.textContent="Cargando estadísticas…";try{const s=await fi();a.textContent=De(s.total),t.textContent=De(s.hoy),i.textContent=De(s.ultimos7Dias),o.textContent=De(s.ultimos30Dias);const n=yi(s.actualizadoEn);r.textContent=n?`Actualizado: ${n}`:"Estadísticas temporalmente no disponibles"}catch(s){console.error("Error al mostrar las estadísticas en la portada:",s),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",r.textContent="No fue posible cargar las estadísticas"}}function Ci(){tt("full");const e=gi();return wi(e),Ai(e),Ei(e),e}function Si(){return Ci()}const $i=""+new URL("QuienesSomos-CIhVjMhZ.webp",import.meta.url).href;function Mi(){return`
        <section 
            role="banner" 
  ...
  `}function Ui({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${Oi}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function Bi(){const e=document.createElement("section");return e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12",e.innerHTML=`
    ...
    `).join("")}function Hi(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function Ji(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=Ki(e.redes||[]),i=Hi(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}function Qi(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,r=()=>{const h=o();return Math.max(oe.length-h,0)},s=()=>{const h=r();e>h&&(e=0),e<0&&(e=h)},n=()=>{const h=r();e>=h?e=0:e++,f()},d=()=>{const h=r();e<=0?e=h:e--,f()},b=()=>{p(),oe.length>o()&&(a=setInterval(n,4500))},p=()=>{a&&(clearInterval(a),a=null)},u=()=>{const h=o(),w=Math.max(oe.length-h+1,1);return Array.from({length:w}).map((A,y)=>`
        ...
        `;const A=i.querySelector("#cards-wrapper");w.forEach(E=>{A.appendChild(Ji(E))});const y=i.querySelector("#prev-btn"),g=i.querySelector("#next-btn");y&&(y.onclick=()=>{d(),b()}),g&&(g.onclick=()=>{n(),b()}),i.querySelectorAll("[data-dot-index]").forEach(E=>{E.onclick=()=>{e=parseInt(E.dataset.dotIndex),f(),b()}})};return i.addEventListener("mouseenter",p),i.addEventListener("mouseleave",b),document.addEventListener("visibilitychange",()=>{document.hidden?p():b()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,f(),b()},150)}),f(),b(),i}function Xi(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&aa(t.dataset.route)})}function it(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Xi(a),a}function Wi(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";const a=document.createElement("div");a.className="mx-auto max-w-[1600px]",a.innerHTML=`
    ...
    `;const t=document.createElement("div");t.className="mt-8 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm",t.appendChild(it());const i=Qi();return i.className="w-full py-8 flex flex-col gap-8 items-center font-sans",a.appendChild(t),a.appendChild(i),e.appendChild(a),e}function Yi(){return Wi()}function G(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ot(e){return e.formacion?.length||0}function st(e){return e.experiencia?.length||0}function Zi(e,a=!1){const t=ot(e),i=st(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function eo(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(n=>`
    ...
    `}const Pa=Object.freeze([rt,no,lo,co,uo,po,mo,bo,go]),fo=Object.freeze([{nombre:"Miguel A. Leonardo Sepúlveda",tema:"Funciones peso y método Singh–Sharma de quinto orden"},{nombre:"Natanael Ureña Castillo",tema:"Algoritmos híbridos cuasi-Newton con correctores de alto orden"},{nombre:"Antmel Rodríguez Cabral",tema:"Familia generalizada de Traub y método óptimo de cuarto orden"}]);function vo(e){return e?`
    ...
    `}function ya({compacto:e=!1}={}){return`
    ...
    `}function se(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function yo(e){if(e?.visualType==="mmehb-2026")return ha();if(e?.visualType==="mescyt-cic-2026")return ya();const a=e?.imageFit==="cover"?"object-cover":"object-contain";return e?.image?`
            <img
                src="${se(e.image)}"
                ...
                loading="eager"
            />
        `:'<div class="flex h-full w-full items-center justify-center font-bold text-slate-400">Imagen no disponible</div>'}function wo(e=null){return e?`
    ...
    `:""}function ae(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ko(e){return e==="mmehb-2026"?ha({compacto:!0}):e==="mescyt-cic-2026"?ya({compacto:!0}):null}function Ao({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:r,category:s="Noticia",imageFit:n="contain",visualType:d="image"}){const b=n==="cover"?"object-cover":"object-contain",p=ko(d),u=p?"h-[430px] md:h-[500px]":"h-64 md:h-72 2xl:h-96",f=p||(i?`
            <img
                src="${ae(i)}"
                alt="${ae(o||a)}"
...
Gracias.`);return`
    ...
    `}function So(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function $o(){const e=document.createElement("section");e.className="w-full bg-slate-100 font-sans";const a=new Set([Ge.id,Ke.id]),t=So([Ge,Ke,...nt.filter(o=>!a.has(o.id))]),i=t.find(o=>o.featured)||t[0];return e.innerHTML=`
        ...
        ${Eo(t)}
        ${Co()}
    `,e}function xe(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Mo(e){return e==="mmehb-2026"?ha():e==="mescyt-cic-2026"?ya():""}function jo({title:e,date:a,category:t,visualType:i,content:o={paragraphs:[],list:[]},articleURL:r}){const s=(o.paragraphs||[]).map(b=>`<p>${xe(b)}</p>`).join(""),n=(o.list||[]).length?`<ul class="space-y-3">${o.list.map(b=>`<li class="flex items-start gap-3"><span class="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-[#0b5963]"></span><span>${xe(b)}</span></li>`).join("")}</ul>`:"",d=Mo(i);return`
    ...
    `}function Oo(e,a=!1){const t=lt(e),i=e.publicaciones||[],o=Math.max(...i.map(r=>Number(r.year||0)),0)||"";return`
    ...
    `}function No(e){if(!e)return'<div class="flex h-full items-center justify-center text-white">No hay investigador seleccionado.</div>';const a=lt(e),t=To(e),i=t.map(d=>Number(d.year)).filter(Boolean),o=[...new Set(t.map(d=>d.q).filter(Boolean))],r=[...new Set(t.map(oa).filter(Boolean))],s=[...new Set(t.map(d=>Da(oa(d)).editorial))],n=t.map(d=>{const b=oa(d),p=ct(d),u=Da(b);return`
            <article class="mb-5 rounded-3xl border border-slate-200 bg-white p-5 text-slate-900 shadow-sm transition hover:-translate-y-0.5 hover:shadow-xl md:p-6">
                ...
                <div class="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
                    ${sa("Editorial",u.editorial)}
                    ${sa("Identificación",u.issn)}
                    ${sa("Modelo de publicación",u.modelo)}
                </div>
                ...
                <div class="mt-5 flex flex-wrap gap-3 border-t border-slate-100 pt-4">
                    ${p?`<a href="${N(qo(d))}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-xl bg-[#0f5b5d] px-4 py-2 text-sm font-black text-white hover:bg-[#0a4648]">Abrir DOI <span aria-hidden="true">↗</span></a>`:'<span class="text-sm font-bold text-slate-400">DOI no disponible</span>'}
            ...
            <div class="mx-auto max-w-[1600px]">
                ...
                <div class="mt-8 grid min-h-[720px] grid-cols-1 gap-6 rounded-[2rem] border border-slate-200 bg-white p-4 shadow-xl md:grid-cols-[0.78fr_1.5fr] md:p-6">
                    <aside class="max-h-[430px] overflow-y-auto rounded-3xl border border-slate-200 bg-slate-50 p-4 custom-scrollbar md:max-h-none">
                        ...
                        <div class="mt-5 flex flex-col gap-4">${ne.map(k=>Oo(k,Number(k.id)===Number(e))).join("")}</div>
                    </aside>
                    ...
                    <div id="detalle-container" ${x} class="fixed inset-0 z-[350] items-center justify-center bg-slate-950/80 p-4 md:relative md:inset-auto md:z-0 md:flex md:bg-transparent md:p-0 ${c?"hidden":"flex"}">
                        <div class="h-[88%] w-full max-w-lg rounded-[2rem] border border-white/10 bg-[#071820] p-5 shadow-2xl md:h-full md:max-w-none md:p-6">${No(l)}</div>
                    </div>
                </div>
            </div>
        `,n.querySelectorAll("[data-id]").forEach(k=>{k.onclick=()=>{e=Number(k.dataset.id),window.innerWidth<768&&(a=!0,r=k.dataset.id),C()}}),E()};return window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{window.innerWidth>=768&&(y(),a=!1),C()},120)}),C(),n}function Uo(){return Fo()}function V(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Bo(e){return Y.find(a=>a.id===e)||Y[0]}function ra(e=[]){return e.map(a=>`
        <li class="flex gap-3 text-sm md:text-base text-slate-600 leading-relaxed">
            <span class="mt-2 w-2 h-2 rounded-full bg-orange-500 shrink-0"></span>
            <span>${V(a)}</span>
        </li>
    `).join("")}function Vo(e=[]){return e.map(a=>`
    ...
    `).join("")}function _o(e=[]){return e.map(a=>`
    ...
    `}function Ko(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function Ho(){const e=new Set(Y.map(i=>i.categoria)),a=Y.filter(i=>i.proyectosAsociados?.length>0).length,t=Y.filter(i=>i.publicacionesClave?.length>0).length;return{total:Y.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function Jo(){let e=Y[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Bo(e),o=Ho();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-linea-id]").forEach(r=>{r.onclick=()=>{e=parseInt(r.dataset.lineaId),t()}})};return t(),a}function Qo(){return Jo()}const Xo=[...$e,..._e];function I(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function pa(e=[],a="text-slate-600"){return e.map(t=>`
        <li class="flex gap-3 text-sm leading-relaxed ${a} md:text-base">
            <span class="mt-2 h-2 w-2 shrink-0 rounded-full bg-[#b37a2a]"></span>
            <span>${I(t)}</span>
        </li>
    `).join("")}function dt(e=[]){return e.map(a=>`
    ...
    `:""}function Wo(e,a){const t=e.categoria==="aprobado";return`
        <button
            type="button"
    ...
    `}function ut(e){const a=[...e.equipo||[]],t=[...e.asesores||[],...e.serviciosProfesionalesEspecializados||[]];return`
            ...
            <div class="p-6 md:p-9">
                ...
                <section class="mt-8 grid grid-cols-1 gap-8 xl:grid-cols-[0.9fr_1.1fr]">
                    ...
                    <div>
                        ...
                        <ul class="mt-5 space-y-3">${pa(e.impacto)}</ul>
                    </div>
                </section>

                ${ut(e)}
                <div class="mt-7 flex flex-wrap gap-2">${dt(e.etiquetas)}</div>
            </div>
        </article>
            ...
            <div class="p-6 md:p-9">
                ...
                <section class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div><h3 class="text-lg font-black text-[#071820]">Objetivos</h3><ul class="mt-3 space-y-3">${pa(e.objetivos)}</ul></div>
                        <div><h3 class="text-lg font-black text-[#071820]">Resultados esperados</h3><ul class="mt-3 space-y-3">${pa(e.resultados)}</ul></div>
                    </div>
                </section>
                ${ut(e)}
                <div class="mt-7 flex flex-wrap gap-2">${dt(e.etiquetas)}</div>
    ...
    `}function es(e){return e.categoria==="aprobado"?Yo(e):Zo(e)}function as(){let e="aprobado",a=$e[0]?.id||Xo[0]?.id;const t=document.createElement("section");t.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";const i=()=>e==="aprobado"?$e:_e,o=()=>{const r=i(),s=r.find(n=>n.id===a)||r[0];s&&s.id!==a&&(a=s.id),t.innerHTML=`
            <div class="mx-auto max-w-[1600px]">
                ...
                <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-[0.72fr_1.5fr]">
                    <aside class="max-h-[780px] overflow-y-auto rounded-[2rem] border border-slate-200 bg-white p-4 shadow-lg custom-scrollbar">
                        ...
                        <div class="mt-5 space-y-4">${r.map(n=>Wo(n,n.id===a)).join("")}</div>
                    </aside>
                    <div>${s?es(s):""}</div>
                </div>
            </div>
        `,t.querySelectorAll("[data-proyecto-id]").forEach(n=>{n.addEventListener("click",()=>{a=Number(n.dataset.proyectoId),o()})}),t.querySelectorAll("[data-categoria]").forEach(n=>{n.addEventListener("click",()=>{e=n.dataset.categoria,a=i()[0]?.id,o()})})};return o(),t}function ts(){return as()}function is(){return`
    ...
    `}function ss(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${os()}
    `,e}function rs(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",ns)}async function ns(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=ls(i);if(o.length>0){ds(o);return}await us(a,i)}function ls(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?cs(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function cs(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function ds(e){Ne(e[0],"error")}function Ne(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function us(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(Ne("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):Ne("Hubo un problema al enviar el mensaje.","error")}catch{Ne("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function ps(){const e=ss();return setTimeout(()=>{rs()},0),e}function ms(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function A(y){const g=y==="xmera";b.classList.toggle("hidden",!g),p.classList.toggle("hidden",g),n.className=g?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",d.className=g?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const y=a.value.trim();if(!y){u(),f("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:g,errors:E}=h(y);if(E.length>0){u(),f(E.join(" "),"error");return}t.textContent=w(g),o.disabled=!1,f(`Código generado correctamente para ${g.length} estudiante${g.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),f("El código fue copiado al portapapeles.")}catch(y){console.error("No fue posible copiar el código:",y),f("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),r.addEventListener("click",()=>{a.value="",u(),s.textContent="",s.classList.add("hidden"),a.focus()});try{const y=xs();if(y instanceof HTMLElement)p.appendChild(y);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(y){console.error("No fue posible cargar el módulo Banner:",y),p.innerHTML=`
        ...
        `}return n.addEventListener("click",()=>{A("xmera")}),d.addEventListener("click",()=>{A("banner")}),A("xmera"),e}function vs(){return fs()}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function pt(e){return String(e??"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim()}function hs(e,a=!1){return`
        <button
            type="button"
    ...
    `}function ys(e){const a=pt([e.numero,e.titulo,e.tituloCorto,e.resumen,e.descripcion,e.categoriaNombre,...e.subservicios||[],e.entregables].join(" "));return`
        <article
            data-servicio-card
    ...
    `}function $s(e){const a=encodeURIComponent(`Solicitud de servicio: ${e.titulo}`);return`
    ...
    `}function Ms(){const e=document.createElement("section");e.id="catalogo-servicios",e.className="relative overflow-hidden rounded-[2rem] border border-sky-100 bg-gradient-to-br from-slate-50 via-white to-sky-50 px-5 py-9 shadow-lg md:px-8 md:py-12 xl:px-10",e.setAttribute("aria-labelledby","titulo-catalogo-servicios"),e.innerHTML=`
        ...
        <div class="relative z-10 space-y-10">
            ...
            <section class="grid grid-cols-2 gap-3 md:grid-cols-4" aria-label="Resumen del catálogo">
                ${[[ce.length,"áreas de servicio"],[ua.length-1,"bloques temáticos"],[La.length,"paquetes sugeridos"],[za.length,"etapas de trabajo"]].map(([p,u])=>`
        ...
        ></dialog>
    `;const a=[...e.querySelectorAll("[data-servicio-card]")],t=[...e.querySelectorAll("[data-filtro-servicio]")],i=e.querySelector("[data-buscador-servicios]"),o=e.querySelector("[data-contador-servicios]"),r=e.querySelector("[data-vacio-servicios]"),s=e.querySelector("[data-dialogo-servicio]");let n="todos",d=null;function b(){const p=pt(i?.value);let u=0;a.forEach(f=>{const h=n==="todos"||f.dataset.categoria===n,w=!p||String(f.dataset.busqueda||"").includes(p),A=h&&w;f.classList.toggle("hidden",!A),A&&(u+=1)}),o&&(o.textContent=`${u} servicio${u===1?"":"s"} disponible${u===1?"":"s"}`),r?.classList.toggle("hidden",u!==0)}return t.forEach(p=>{p.addEventListener("click",()=>{n=p.dataset.filtroServicio||"todos",t.forEach(u=>{const f=u===p;u.setAttribute("aria-pressed",String(f)),u.classList.toggle("border-sky-700",f),u.classList.toggle("bg-sky-700",f),u.classList.toggle("text-white",f),u.classList.toggle("shadow-md",f),u.classList.toggle("border-slate-300",!f),u.classList.toggle("bg-white",!f),u.classList.toggle("text-slate-700",!f)}),b()})}),i?.addEventListener("input",b),e.addEventListener("click",p=>{const u=p.target.closest("[data-servicio-detalle]");if(!u||!e.contains(u))return;const f=ce.find(h=>h.id===u.dataset.servicioDetalle);!f||!s||(d=u,s.innerHTML=$s(f),typeof s.showModal=="function"?s.showModal():s.setAttribute("open",""),s.querySelector("[data-cerrar-dialogo-servicio]")?.focus())}),s?.addEventListener("click",p=>{(p.target===s||p.target.closest("[data-cerrar-dialogo-servicio]"))&&(s.close?.(),s.removeAttribute("open"))}),s?.addEventListener("close",()=>{d?.focus(),d=null}),e}const Ra="kernel-services-filter",js="kernel-service-interest";function zs(e){let a=null;try{a=window.sessionStorage.getItem(Ra),window.sessionStorage.removeItem(Ra)}catch(i){console.warn("[Kernel] No fue posible recuperar el filtro del catálogo.",i)}if(!a||a==="todos")return;const t=e.querySelector(`[data-filtro-servicio="${CSS.escape(a)}"]`);window.requestAnimationFrame(()=>t?.click())}function Ls(e){if(e)try{window.sessionStorage.setItem(js,e)}catch(a){console.warn("[Kernel] No fue posible conservar el servicio de interés.",a)}}function Is(e){e.querySelectorAll('a[href="#/contacto"]').forEach(t=>{t.href="#/diagnosticoServicios",t.textContent="Solicitar diagnóstico"});let a=null;e.addEventListener("click",t=>{const i=t.target.closest("[data-servicio-detalle]");if(i&&e.contains(i)){a=i.dataset.servicioDetalle||null;return}const o=t.target.closest('a[href="#/contacto"], a[href="#/diagnosticoServicios"]');!o||!e.contains(o)||(t.preventDefault(),Ls(a),window.location.hash="/diagnosticoServicios")})}function Ps(){const e=document.createElement("section");e.className="w-full bg-slate-100 px-3 py-6 font-sans sm:px-5 md:py-9 lg:px-8";const a=document.createElement("div");a.className="mx-auto max-w-[1680px]";const t=Ms();return t.classList.remove("rounded-[2rem]"),t.classList.add("rounded-3xl"),Is(t),a.appendChild(t),e.appendChild(a),zs(t),e}const qa="mleonardos@unapec.edu.do",Ta="kernel-service-interest";function He(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ds(){return ce.map(e=>`
        <option value="${He(e.id)}">${String(e.numero).padStart(2,"0")} · ${He(e.tituloCorto)}</option>
    `).join("")}function Rs(){return et.map(e=>`
    ...
    `}function qs(e){if(e)try{const a=window.sessionStorage.getItem(Ta);window.sessionStorage.removeItem(Ta),a&&[...e.options].some(t=>t.value===a)&&(e.value=a)}catch(a){console.warn("[Kernel] No fue posible recuperar el servicio de interés.",a)}}function U(e,a){return String(new FormData(e).get(a)||"").trim()}function mt(e){return ce.find(a=>a.id===e)?.titulo||"No especificado"}function Oa(e){const a={nombre:U(e,"nombre"),organizacion:U(e,"organizacion"),cargo:U(e,"cargo"),correo:U(e,"correo"),telefono:U(e,"telefono"),sector:U(e,"sector"),servicio:mt(U(e,"servicio")),necesidad:U(e,"necesidad"),datos:U(e,"datos"),plazo:U(e,"plazo"),presupuesto:U(e,"presupuesto"),producto:U(e,"producto"),modalidad:U(e,"modalidad")};return["SOLICITUD DE DIAGNÓSTICO INICIAL — GRUPO EL KERNEL","",`Nombre: ${a.nombre}`,`Organización: ${a.organizacion||"No indicada"}`,`Cargo o función: ${a.cargo||"No indicado"}`,`Correo: ${a.correo}`,`Teléfono: ${a.telefono||"No indicado"}`,`Sector: ${a.sector||"No especificado"}`,`Servicio de interés: ${a.servicio}`,`Modalidad preferida: ${a.modalidad||"No especificada"}`,`Plazo esperado: ${a.plazo||"No especificado"}`,`Presupuesto estimado: ${a.presupuesto||"No especificado"}`,"","Problema o necesidad:",a.necesidad,"","Datos, documentos o recursos disponibles:",a.datos||"No especificados","","Producto o resultado esperado:",a.producto||"No especificado","","Nota: adjuntaré al correo generado los términos de referencia o documentos pertinentes, si aplica."].join(`
`)}async function Ts(e){if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(e);return}const a=document.createElement("textarea");a.value=e,a.setAttribute("readonly",""),a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove()}function Os(){const e=document.createElement("section");e.className="w-full bg-slate-100 px-3 py-6 font-sans sm:px-5 md:py-10 lg:px-8",e.innerHTML=`
            ...
            <div class="grid grid-cols-1 gap-8 p-5 md:p-8 xl:grid-cols-[1.25fr_0.75fr] xl:p-10">
                ...
                <aside class="space-y-5">
                    ...
                    <section class="rounded-3xl bg-[#071820] p-6 text-white">
                        ...
                        <h2 class="mt-2 text-2xl font-black">${qa}</h2>
    ...
    `;const a=e.querySelector("[data-formulario-diagnostico]"),t=e.querySelector("[data-estado-diagnostico]"),i=e.querySelector("#servicio");return qs(i),a?.addEventListener("submit",o=>{if(o.preventDefault(),!a.checkValidity()){a.reportValidity(),t&&(t.textContent="Complete los campos obligatorios antes de continuar.");return}const r=Oa(a),s=encodeURIComponent(`Solicitud de diagnóstico: ${mt(U(a,"servicio"))}`),n=encodeURIComponent(r);t&&(t.textContent="Abriendo su aplicación de correo. Adjunte los documentos pertinentes antes de enviar."),window.location.href=`mailto:${qa}?subject=${s}&body=${n}`}),e.querySelector("[data-copiar-diagnostico]")?.addEventListener("click",async()=>{if(!a?.checkValidity()){a?.reportValidity(),t&&(t.textContent="Complete los campos obligatorios para copiar un resumen útil.");return}try{await Ts(Oa(a)),t&&(t.textContent="Resumen copiado. Puede pegarlo en un correo o documento.")}catch(o){console.error("[Kernel] No fue posible copiar el diagnóstico.",o),t&&(t.textContent="No fue posible copiar automáticamente. Utilice el botón para preparar el correo.")}}),e}const Ns=450,Me="kernel:recuperacion-modulo";let fe=0,Te=null;function bt(e){return new Promise(a=>{window.setTimeout(a,e)})}function wa(e){const a=String(e?.message||e||"");return/chunkloaderror|failed to fetch dynamically imported module|importing a module script failed|error loading dynamically imported module|networkerror.*module|load failed.*module/i.test(a)}function Fs(e){return["kernel/auth-timeout","auth/network-request-failed"].includes(e?.code)}async function ma(e){let a;for(let t=0;t<2;t+=1)try{return await e()}catch(i){if(a=i,t>0||!wa(i))throw i;await bt(Ns)}throw a}function O(e,a,t){return async()=>{const o=(await ma(e))[a];if(typeof o!="function")throw new Error(t);return o()}}function Us(){return Te||(Te=Promise.all([ma(()=>R(()=>import("./authGuard-CEzcrBkK.js"),__vite__mapDeps([0,1,2]),import.meta.url)),ma(()=>R(()=>import("./login-BtABpxCq.js"),__vite__mapDeps([3,1,2]),import.meta.url))]).then(([e,a])=>({esperarAutenticacion:e.esperarAutenticacion,crearLogin:a.crearLogin})).catch(e=>{throw Te=null,e})),Te}const Bs=O(()=>R(()=>import("./LaboratorioKernel-BtMa0jdz.js"),__vite__mapDeps([4,1,2]),import.meta.url),"LaboratorioKernel","El Laboratorio Inteligente no está disponible."),Vs=O(()=>R(()=>import("./AsistentePruebas-BOi_3rhz.js"),__vite__mapDeps([5,6]),import.meta.url),"AsistentePruebas","El asistente metodológico no está disponible."),_s=O(()=>R(()=>import("./ComparacionGrupos-BqmYk_OJ.js"),[],import.meta.url),"ComparacionGrupos","El módulo de comparación de grupos no está disponible."),Gs=O(()=>R(()=>import("./CalculadoraDosGrupos-DiyIaRBM.js"),__vite__mapDeps([7,8,9]),import.meta.url),"CalculadoraDosGrupos","La calculadora de dos grupos no está disponible."),Ks=O(()=>R(()=>import("./CalculadoraDosMuestrasRelacionadas-Gp_ZJZML.js"),__vite__mapDeps([10,11,8,9]),import.meta.url),"CalculadoraDosMuestrasRelacionadas","La calculadora de muestras relacionadas no está disponible."),Hs=O(()=>R(()=>import("./CalculadoraTresOMasGrupos-DrdNVeR5.js"),__vite__mapDeps([12,8,9]),import.meta.url),"CalculadoraTresOMasGrupos","La calculadora de tres o más grupos no está disponible."),Js=O(()=>R(()=>import("./CalculadoraTresOMasMedicionesRelacionadas-tA6HRycI.js"),__vite__mapDeps([13,8,11,9]),import.meta.url),"CalculadoraTresOMasMedicionesRelacionadas","La calculadora de mediciones relacionadas no está disponible."),Qs=O(()=>R(()=>import("./CorrelacionAsociacion-BJOAMDeR.js"),[],import.meta.url),"CorrelacionAsociacion","El módulo de correlación y asociación no está disponible."),Xs=O(()=>R(()=>import("./CalculadoraRelacionVariables-LFWvl0Yx.js"),__vite__mapDeps([14,8,9]),import.meta.url),"CalculadoraRelacionVariables","La calculadora de relación entre variables no está disponible."),Ws=O(()=>R(()=>import("./CalculadoraAsociacionCategorica-CM1GEPxd.js"),__vite__mapDeps([15,8,9]),import.meta.url),"CalculadoraAsociacionCategorica","La calculadora de asociación categórica no está disponible."),Ys=O(()=>R(()=>import("./CalculadoraEstadisticaDescriptiva-BFzIXE2D.js"),__vite__mapDeps([16,9]),import.meta.url),"CalculadoraEstadisticaDescriptiva","La calculadora de estadística descriptiva no está disponible."),Zs=O(()=>R(()=>import("./CalculadoraFiabilidadCuestionarios-CyGGGm8w.js"),__vite__mapDeps([17,9]),import.meta.url),"CalculadoraFiabilidadCuestionarios","La calculadora de cuestionarios y fiabilidad no está disponible."),er=O(()=>R(()=>import("./CalculadoraEvaluacionEducativa-D_bSZkvD.js"),__vite__mapDeps([18,9]),import.meta.url),"CalculadoraEvaluacionEducativa","La calculadora de evaluación educativa no está disponible."),ar=O(()=>R(()=>import("./CalculadoraTamanoMuestraPotencia-BPLOehAH.js"),__vite__mapDeps([19,9]),import.meta.url),"CalculadoraTamanoMuestraPotencia","La calculadora de tamaño de muestra y potencia no está disponible."),tr=O(()=>R(()=>import("./BibliotecaMetodologica-BzzsJJUi.js"),__vite__mapDeps([20,6]),import.meta.url),"BibliotecaMetodologica","La Biblioteca metodológica no está disponible."),ir=O(()=>R(()=>import("./RegresionModelos-q4rY9Zve.js"),[],import.meta.url),"RegresionModelos","El área de modelos de regresión no está disponible."),or=O(()=>R(()=>import("./CalculadoraRegresionCompleta--jpj7e9z.js"),__vite__mapDeps([21,9]),import.meta.url),"CalculadoraRegresionCompleta","La calculadora de regresión lineal no está disponible."),sr=O(()=>R(()=>import("./CalculadoraRegresionLogistica-DDhA4hE5.js"),__vite__mapDeps([22,9]),import.meta.url),"CalculadoraRegresionLogistica","La calculadora de regresión logística no está disponible."),rr=O(()=>R(()=>import("./CalculadoraRegresionConteo-CMkj4ZtH.js"),__vite__mapDeps([23,9]),import.meta.url),"CalculadoraRegresionConteo","La calculadora de regresión de conteo no está disponible."),nr={home:{page:Si,layout:"full",title:"Portada | El Kernel"},servicios:{page:Ps,layout:"full",title:"Servicios profesionales y académicos | El Kernel"},diagnosticoServicios:{page:Os,layout:"full",title:"Solicitar diagnóstico | El Kernel"},quienesSomos:{page:Gi,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Yi,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:to,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:Do,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Uo,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:ts,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:Qo,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:ps,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:vs,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Bs,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Vs,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},comparacionGrupos:{page:_s,layout:"default",title:"Comparación de grupos y mediciones | El Kernel"},calculadoraDosGrupos:{page:Gs,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:Ks,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"},calculadoraTresOMasGrupos:{page:Hs,layout:"default",title:"Comparación de tres o más grupos independientes | El Kernel"},calculadoraTresOMasMedicionesRelacionadas:{page:Js,layout:"default",title:"Comparación de tres o más mediciones relacionadas | El Kernel"},correlacionAsociacion:{page:Qs,layout:"default",title:"Correlación y asociación | El Kernel"},calculadoraRelacionVariables:{page:Xs,layout:"default",title:"Relación entre variables | El Kernel"},calculadoraAsociacionCategorica:{page:Ws,layout:"default",title:"Asociación entre variables categóricas | El Kernel"},calculadoraEstadisticaDescriptiva:{page:Ys,layout:"default",title:"Estadística descriptiva | El Kernel"},calculadoraFiabilidadCuestionarios:{page:Zs,layout:"default",title:"Cuestionarios y fiabilidad | El Kernel"},calculadoraEvaluacionEducativa:{page:er,layout:"default",title:"Evaluación educativa | El Kernel"},calculadoraTamanoMuestraPotencia:{page:ar,layout:"default",title:"Tamaño de muestra y potencia | El Kernel"},bibliotecaMetodologica:{page:tr,layout:"default",title:"Biblioteca metodológica | El Kernel"},regresionModelos:{page:ir,layout:"default",title:"Modelos de regresión | El Kernel"},calculadoraRegresion:{page:or,layout:"default",title:"Regresión lineal y múltiple | El Kernel"},calculadoraRegresionLogistica:{page:sr,layout:"default",title:"Regresión logística binaria | El Kernel"},calculadoraRegresionConteo:{page:rr,layout:"default",title:"Regresión de Poisson y binomial negativa | El Kernel"}},lr=new Set(["laboratorioKernel","asistentePruebas","comparacionGrupos","calculadoraDosGrupos","calculadoraDosMuestrasRelacionadas","calculadoraTresOMasGrupos","calculadoraTresOMasMedicionesRelacionadas","correlacionAsociacion","calculadoraRelacionVariables","calculadoraAsociacionCategorica","calculadoraEstadisticaDescriptiva","calculadoraFiabilidadCuestionarios","calculadoraEvaluacionEducativa","calculadoraTamanoMuestraPotencia","bibliotecaMetodologica","regresionModelos","calculadoraRegresion","calculadoraRegresionLogistica","calculadoraRegresionConteo"]);let Na=document.referrer||"";function aa(e){window.location.hash=`/${e}`}function gt(){return window.location.hash.replace("#/","")||"home"}function cr(){const e=()=>{Je(gt())};window.addEventListener("hashchange",e),e()}function dr(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:Na}),Na=t}function ur(e){return document.title="Acceso al Laboratorio | El Kernel",e(()=>{Je(gt())})}function pr(){const e=document.createElement("section");return e.className="w-full max-w-4xl mx-auto px-4 py-16 md:px-8 font-sans",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.innerHTML=`
        ...
        </div>`,e}function mr(e){return e?.code==="kernel/auth-timeout"?"La verificación de la sesión tardó más de lo esperado. Compruebe su conexión e inténtelo nuevamente.":wa(e)?"No fue posible descargar esta sección. Puede tratarse de una interrupción temporal de la conexión.":"Ocurrió un problema inesperado al preparar esta sección."}function br(e,a){const t=document.createElement("section");t.className="w-full max-w-4xl mx-auto px-4 py-12 md:px-8 font-sans",t.setAttribute("role","alert"),t.setAttribute("aria-live","assertive"),t.innerHTML=`
        ...
        </div>`;const i=t.querySelector("[data-mensaje-error-ruta]");return i&&(i.textContent=mr(e)),t.querySelector("[data-action='reintentar-ruta']")?.addEventListener("click",a),t.querySelector("[data-action='volver-portada']")?.addEventListener("click",()=>aa("home")),t}function gr(e,a){if(!wa(a))return!1;try{const t=JSON.parse(window.sessionStorage.getItem(Me)||"null"),i=Date.now();return t?.route===e&&Number.isFinite(t?.timestamp)&&i-t.timestamp<12e4?!1:(window.sessionStorage.setItem(Me,JSON.stringify({route:e,timestamp:i})),window.location.reload(),!0)}catch{return!1}}function xr(e){try{JSON.parse(window.sessionStorage.getItem(Me)||"null")?.route===e&&window.sessionStorage.removeItem(Me)}catch{try{window.sessionStorage.removeItem(Me)}catch{}}}function Fa(e){const a=e.querySelector("h1");a&&(a.setAttribute("tabindex","-1"),a.focus({preventScroll:!0}))}async function fr(e,a){if(!lr.has(e))return a.page();const{esperarAutenticacion:t,crearLogin:i}=await Us();return await t()?a.page():ur(i)}async function Je(e,a={}){const{intentoAutenticacion:t=0}=a,i=document.querySelector("main"),o=nr[e];if(!i)return;if(!o){aa("home");return}const r=++fe;tt(o.layout),document.title=o.title,i.setAttribute("aria-busy","true"),i.replaceChildren(pr());try{const s=await fr(e,o);if(r!==fe)return;if(!(s instanceof Element))throw new Error("La sección no devolvió un componente válido.");i.replaceChildren(s),i.setAttribute("aria-busy","false"),window.scrollTo({top:0,behavior:"auto"}),window.requestAnimationFrame(()=>{r===fe&&Fa(i)}),xr(e),dr(e,document.title)}catch(s){if(r!==fe)return;if(console.error(`[Kernel] Error al cargar la ruta ${e}.`,s),Fs(s)&&t<1)return await bt(650),r===fe?Je(e,{intentoAutenticacion:t+1}):void 0;if(gr(e,s))return;i.setAttribute("aria-busy","false"),i.replaceChildren(br(s,()=>Je(e))),window.requestAnimationFrame(()=>{r===fe&&Fa(i)})}}function vr(e,a){e&&e.addEventListener("click",t=>{const i=t.target.closest("[data-route]");!i||!e.contains(i)||(t.preventDefault(),a(i.dataset.route),pe(e))})}function hr(e){return/^(?:laboratorioKernel|asistentePruebas|comparacionGrupos|calculadora|correlacionAsociacion|bibliotecaMetodologica|regresionModelos)/.test(e)?"laboratorioKernel":e}function Ua(e){const a=window.location.hash.replace("#/","")||"home",t=hr(a);e.querySelectorAll("[data-route]").forEach(i=>{i.dataset.route===t?i.setAttribute("aria-current","page"):i.removeAttribute("aria-current")})}function yr(e,a){if(!e||!a)return;vr(e,aa),Et(e);const t=a.querySelector('[data-action="open-menu"]');t&&Pt(t,e),Dt(e),Ua(e),window.addEventListener("hashchange",()=>Ua(e)),cr()}function wr(e){const a=String(e??"").replace(/\u00a0/g,"").replace(/\s/g,"").replace(/[^0-9+\-.,eE]/g,"");if(!a)return null;const t=a.lastIndexOf(","),i=a.lastIndexOf(".");let o=a;t>=0&&i>=0?o=i>t?a.replace(/,/g,""):a.replace(/\./g,"").replace(",","."):t>=0&&(o=a.length-t-1===3&&t>0?a.replace(/,/g,""):a.replace(",","."));const r=Number(o);return Number.isFinite(r)?r:null}function kr(e){const a=e.querySelector("table");if(!a)return null;const i=[...a.querySelectorAll("thead th")].map(r=>r.textContent.trim().toLowerCase()).some(r=>r.includes("marca")),o=[...a.querySelectorAll("tbody tr")].map(r=>{const s=[...r.children],n=Number(s[i?2:1]?.textContent.trim()),d=Number(s[i?4:3]?.textContent.trim());return{etiqueta:s[0]?.textContent.trim()||"",valor:wr(s[i?1:0]?.textContent),frecuencia:Number.isFinite(n)?n:0,acumulada:Number.isFinite(d)?d:0}}).filter(r=>r.etiqueta&&r.frecuencia>=0);return{agrupados:i,filas:o}}function xt(e){return Number.isFinite(Number(e))?Number(e).toLocaleString("es-DO",{maximumFractionDigits:3}):"—"}function Ba(e,a){let t=0;for(const i of e)if(t+=i.frecuencia,a<t)return i.valor;return e.at(-1)?.valor??null}function na(e,a){const t=e.reduce((d,b)=>d+b.frecuencia,0);if(!t)return null;if(a<=0)return e[0].valor;if(a>=1)return e.at(-1).valor;const i=(t-1)*a,o=Math.floor(i),r=Math.ceil(i),s=Ba(e,o),n=Ba(e,r);return o===r?s:s*(r-i)+n*(i-o)}function Ce(e,a,t){return`
        <text
            x="${e}"
            y="${a}"
            text-anchor="middle"
        ...
        >${xt(t)}</text>
    `}function Ar(e,a){if(!e||e.dataset.cajaDescriptivaSegura==="true"||a.agrupados)return;e.dataset.cajaDescriptivaSegura="true";const t=a.filas.filter(l=>l.valor!==null&&l.frecuencia>0).sort((l,m)=>l.valor-m.valor);if(t.reduce((l,m)=>l+m.frecuencia,0)<2)return;const o=t[0].valor,r=t.at(-1).valor,s=na(t,.25),n=na(t,.5),d=na(t,.75),b=d-s,p=s-1.5*b,u=d+1.5*b,f=t.filter(l=>l.valor>=p&&l.valor<=u),h=t.filter(l=>l.valor<p||l.valor>u),w=f[0]?.valor??o,A=f.at(-1)?.valor??r,y=Math.max(r-o,1),g=l=>40+(l-o)/y*520,E=e.querySelector("svg");if(!E)return;E.setAttribute("aria-label","Diagrama de caja con cuartiles, mediana, bigotes y valores atípicos potenciales"),E.innerHTML=`
        ...
        ${h.map((l,m)=>`
            <circle
                ...
                class="text-red-600"
            >
                <title>Valor atípico potencial: ${xt(l.valor)}${l.frecuencia>1?` (${l.frecuencia} observaciones)`:""}</title>
            </circle>
        `).join("")}
        ${Ce(g(w),140,w)}
        ${Ce(g(s),30,s)}
        ...
        ${Ce(g(d),30,d)}
        ${Ce(g(A),140,A)}
    `;const C=e.querySelector("h3 + p");C&&(C.textContent="Los bigotes terminan en los valores extremos no atípicos. Los puntos rojos representan valores atípicos potenciales según el criterio de Tukey.")}function Er(){const e=document.createElement("section");return e.dataset.encabezadoGraficosSeguro="true",e.className="mt-10",e.innerHTML=`
    ...
    `,e}function Cr(e){const a=document.createElement("article");a.dataset.graficoExportable="true",a.dataset.graficoId="histograma",a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const t=Math.max(...e.map(i=>i.frecuencia),1);return a.innerHTML=`
    ...
    `,a}function $r(e){const a=[...e.querySelectorAll("article")],t=a.find(s=>s.querySelector("h3")?.textContent.includes("Distribución de frecuencias")),i=a.find(s=>s.querySelector("h3")?.textContent.includes("Diagrama de caja"));if(!t||!i)return;const o=t.parentElement,r=kr(e);if(!(!o||!r?.filas.length)&&(e.querySelector("[data-encabezado-graficos-seguro='true']")||(o.before(Er()),o.classList.remove("mt-8")),Ar(i,r),!e.querySelector("[data-graficos-descriptivos-seguros='true']"))){const s=document.createElement("div");s.dataset.graficosDescriptivosSeguros="true",s.className="grid grid-cols-1 xl:grid-cols-2 gap-7 mt-7",s.append(Cr(r.filas),Sr(r.filas)),o.after(s)}}function Mr(){let e=!1;const a=()=>{e=!1;const o=document.querySelector("#resultados-estadistica-descriptiva");o&&!o.classList.contains("hidden")&&$r(o)},t=()=>{e||(e=!0,window.requestAnimationFrame(a))};new MutationObserver(t).observe(document.body,{childList:!0,subtree:!0}),t()}const jr=["#formulario-estadistica-descriptiva","#formulario-regresion","#formulario-regresion-conteo","#form-tamano","[id*='calculadora'] form","section form"].join(",");function zr(){return document.querySelector("main h1, #app h1, h1")?.textContent?.trim()?.toLowerCase()||""}function Lr(){return zr().includes("laboratorio inteligente de investigación")}function Ir(){const e=document.querySelector("main h1, #app h1, h1"),a=document.querySelector("[data-action='volver-laboratorio'], [data-action='volver-modelos'], [data-action='volver-regresion'], [data-action='volver']"),t=document.querySelector(jr);return!!(e&&a&&t)}function Pr(){const e=document.createElement("section");return e.dataset.creditosCalculadoras="true",e.className=["w-full max-w-7xl mx-auto","px-4 pb-10 md:px-8","font-sans"].join(" "),e.innerHTML=`
    ...
    `,a.querySelector("button")?.addEventListener("click",n=>{const d=n.currentTarget,b=d.dataset.almacenamientoRegresion;b&&sessionStorage.setItem(b,d.dataset.tipoRegresion||""),window.location.hash=`/${d.dataset.routeRegresion}`}),a}function _a(){const e=qr();if(!e)return;const a=e.encabezado.closest("section");if(!a||a.querySelector("[data-ejecutar-modelo-regresion='true']")||a.querySelector("[data-action='ejecutar-prueba']"))return;(a.querySelector("header + div")||a).appendChild(Tr(e.modelo))}function Ga(){const a=document.querySelector("#formulario-regresion")?.elements?.tipoModelo;if(!a)return;const t=sessionStorage.getItem("kernel-tipo-modelo-regresion");t!=="simple"&&t!=="multiple"||(a.value=t,a.dispatchEvent(new Event("change",{bubbles:!0})),sessionStorage.removeItem("kernel-tipo-modelo-regresion"))}function Or(){new MutationObserver(()=>{_a(),Ga()}).observe(document.body,{childList:!0,subtree:!0}),_a(),Ga()}let Fe=null;function Se({restaurarFoco:e=!0}={}){if(Fe){const a=Fe;Fe=null,a(e);return}document.querySelector("[data-selector-instrumento='true']")?.remove()}function Nr(){Se({restaurarFoco:!1});const e=document.activeElement,a=document.body.style.overflow,t=document.createElement("div");t.dataset.selectorInstrumento="true",t.className=`
        fixed inset-0 z-[500]
    ...
    `,e.querySelector("button")?.addEventListener("click",()=>ft()),e}function Vr(){const a=[...document.querySelectorAll("main h1")].find(i=>ga(i.textContent)==="comparacion de grupos y mediciones")?.closest("section");if(!a||a.querySelector("[data-calculadora-una-muestra-card='true']"))return;[...a.children].find(i=>i.tagName==="SECTION"&&i.classList.contains("grid"))?.prepend(Br())}function _r(){const e=[...document.querySelectorAll("main h1")];for(const a of e){const t=ga(a.textContent),i=a.closest("section");if(ga(i?.textContent).includes("categoria: comparacion de una muestra")){if(t==="t de student para una muestra")return{contenedor:i,prueba:"t-una-muestra",descripcion:"Abra la calculadora con la t de Student seleccionada para comparar la media de su muestra con el valor de referencia."};if(t==="prueba de rangos con signo de wilcoxon")return{contenedor:i,prueba:"wilcoxon-una-muestra",descripcion:"Abra la calculadora con Wilcoxon seleccionado para comparar la localización basada en rangos con el valor de referencia."}}}return null}function Gr(e){const a=document.createElement("div");return a.dataset.ejecutarUnaMuestra="true",a.className="mt-8 rounded-2xl border border-cyan-200 bg-cyan-50 p-6",a.innerHTML=`
        <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
    ...
    `,a.querySelector("button")?.addEventListener("click",()=>ft(e.prueba)),a}function Kr(){const e=_r();if(!e?.contenedor||e.contenedor.querySelector("[data-ejecutar-una-muestra='true']")||e.contenedor.querySelector("[data-action='ejecutar-prueba']"))return;(e.contenedor.querySelector("header + div")||e.contenedor).appendChild(Gr(e))}async function Hr(){if(xa()!==Xe||sessionStorage.getItem(Qe)!=="true")return;const e=document.querySelector("#main");if(!(!e||e.querySelector("#formulario-una-muestra")||la||!e.querySelector("#formulario-dos-grupos"))){la=!0;try{const t=await R(()=>import("./CalculadoraUnaMuestra-IXrYuSIm.js"),__vite__mapDeps([24,11,8,9]),import.meta.url);if(xa()!==Xe||sessionStorage.getItem(Qe)!=="true")return;e.replaceChildren(t.CalculadoraUnaMuestra()),document.title="Comparación de una muestra | El Kernel"}catch(t){console.error("[Kernel] No fue posible abrir la calculadora de una muestra.",t)}finally{la=!1}}}function Jr(){xa()!==Xe&&(sessionStorage.removeItem(Qe),sessionStorage.removeItem(ba))}function Qr(){const e=()=>{Vr(),Kr(),Hr()};new MutationObserver(e).observe(document.body,{childList:!0,subtree:!0}),window.addEventListener("hashchange",()=>{Jr(),e()}),e()}function he(e,a){try{a()}catch(t){console.error(`[Kernel] No fue posible iniciar ${e}.`,t)}}function Xr(e){if(!e)return;const a=e.parentElement,t=a?.parentElement,i=document.querySelector("#main");t?.classList.add("relative","z-[200]","overflow-visible"),a?.classList.add("overflow-visible"),e.classList.remove("lg:z-auto","lg:z-[210]"),e.classList.add("overflow-visible","lg:z-[220]"),i?.classList.add("relative","z-0")}const We=document.querySelector("#header"),je=document.querySelector("#navBar"),Ka=document.querySelector("#footer");We&&(We.innerHTML=yt());je&&(je.innerHTML=kt(),Xr(je));Ka&&(Ka.innerHTML=At());he("la navegación",()=>{je&&We&&yr(je,We)});he("los gráficos de estadística descriptiva",Mr);he("los créditos de las calculadoras",Dr);he("la integración de regresión con el asistente",Or);he("cuestionarios y fiabilidad en el asistente",Ur);he("la calculadora de una muestra",Qr);export{Tt as M,R as _,z as i};
