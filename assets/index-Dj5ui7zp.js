(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const u of o)if(u.type==="childList")for(const d of u.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function n(o){const u={};return o.integrity&&(u.integrity=o.integrity),o.referrerPolicy&&(u.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?u.credentials="include":o.crossOrigin==="anonymous"?u.credentials="omit":u.credentials="same-origin",u}function a(o){if(o.ep)return;o.ep=!0;const u=n(o);fetch(o.href,u)}})();const da=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Nr(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function yn(t,e){t.addEventListener("click",n=>{const a=n.target.closest(["[data-route]"]);a&&(n.preventDefault(),e(a.dataset.route))})}function Br(t){yn(t,Ft)}const En=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Vr=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Hr=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,Ca=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        </div>`}];function Gr(t){const e=t.querySelector("#arrowR"),n=t.querySelector("#arrowL"),a=t.querySelector("#contenedorSlide");if(!e||!n||!a)return;const o=Ca.length,u=1500;let d=0,h=null;function g(p){return(p%o+o)%o}function l(){a.innerHTML=Ca[d].content}function r(p){d=g(d+p),l()}function i(){s(),h=setInterval(()=>r(1),u)}function s(){h&&(clearInterval(h),h=null)}function c(){i()}l(),i(),e.addEventListener("click",()=>{r(1),c()}),n.addEventListener("click",()=>{r(-1),c()})}function Wr(){const t=`
        <section class="
  ...
  `}function fi(){const t=document.createElement("section");return t.className=`
    ...
    `}function re(t){return String(t??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Si({id:t,title:e,date:n,image:a,imageAlt:o,excerpt:u,category:d="Noticia",imageFit:h="contain"}){const g=h==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${re(t)}"
            class="
        ...
        >
            ...
            <div class="p-4 space-y-3 flex flex-col flex-1">
                ...
                <button
                    type="button"
                    data-news-btn="${re(t)}"
                    aria-label="Ver detalles de la noticia ${re(e)}"
                    class="
...
Gracias.`);return`
    ...
    `}function Ji(t){if(!t)return`
        ...
        `;const e=Tn(t),n=Wi(t),a=n.length,o=n.map(r=>Number(r.year)).filter(Boolean),u=o.length?Math.min(...o):"",d=o.length?Math.max(...o):"",h=[...new Set(n.map(r=>r.q).filter(Boolean))],g=[...new Set(n.map(r=>Ia(r)).filter(Boolean))],l=n.map(r=>{const i=Ia(r),s=Rn(r),c=Gi(r);return`
...
if (!contenedor) {
  ...
  `;const n=e.querySelector("#kernel-login"),a=e.querySelector("#login-error");return n.addEventListener("submit",async o=>{o.preventDefault(),a.classList.add("hidden");const u=n.correo.value.trim(),d=n.password.value;try{await Cd(u,d),t&&t()}catch{a.textContent="Correo o contraseña incorrectos.",a.classList.remove("hidden")}}),e}function Td(){return new Promise(t=>{const e=_d(n=>{e(),t(n)})})}async function Rd(){if(!await Td())return Pd(()=>{window.location.reload()});const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
        ...
        <section class="
            ...
            gap-6 mt-10
        ">
            ${Yt("Aprender","Comprenda qué mide cada estadístico, cuándo debe utilizarse, cuáles son sus supuestos y cómo se interpreta correctamente.","libro","bg-sky-100","text-sky-700","border-sky-200")}

            ${Yt("Decidir","Identifique la prueba adecuada según el objetivo, el tipo de variable, el número de grupos y el diseño de su investigación.","decision","bg-amber-100","text-amber-700","border-amber-200")}

            ${Yt("Analizar","Introduzca sus datos, ejecute el análisis, interprete los resultados y genere reportes metodológicamente adecuados.","analisis","bg-emerald-100","text-emerald-700","border-emerald-200")}
        </section>
        ...
        <section class="mt-14">
            ...
            ">
                ${ie("Estadística descriptiva","Media, mediana, varianza, desviación estándar, cuartiles, asimetría y gráficos.","estadistica","bg-sky-100","text-sky-700","border-sky-200")}

                ${ie("Comparación de grupos","Pruebas t, Welch, Mann–Whitney, Wilcoxon, ANOVA y alternativas no paramétricas.","grupos","bg-indigo-100","text-indigo-700","border-indigo-200","calculadoraDosGrupos")}

                ${ie("Correlación y asociación","Pearson, Spearman, Kendall y medidas de asociación entre variables.","correlacion","bg-violet-100","text-violet-700","border-violet-200")}

                ${ie("Cuestionarios y fiabilidad","Alfa de Cronbach, omega de McDonald y análisis de ítems.","cuestionario","bg-amber-100","text-amber-700","border-amber-200")}

                ${ie("Evaluación educativa","Dificultad, discriminación, correlación punto-biserial y análisis de distractores.","evaluacion","bg-emerald-100","text-emerald-700","border-emerald-200")}

                ${ie("Tamaño de muestra","Estimación del tamaño mínimo, potencia estadística y pérdidas previstas.","muestra","bg-cyan-100","text-cyan-700","border-cyan-200")}

                ${ie("Regresión","Regresión lineal, múltiple y logística con interpretación guiada.","regresion","bg-rose-100","text-rose-700","border-rose-200")}

                ${ie("¿Qué prueba debo utilizar?","Asistente guiado para seleccionar la prueba más adecuada según su diseño.","decision","bg-blue-100","text-blue-700","border-blue-200","asistentePruebas")}
                
                ${ie("Biblioteca metodológica","Definiciones, supuestos, tamaños del efecto, intervalos de confianza y errores frecuentes.","biblioteca","bg-slate-200","text-slate-700","border-slate-300")}
            </div>
        </section>
    `,e.querySelector("#cerrar-sesion-kernel")?.addEventListener("click",async()=>{await Id(),window.location.reload()}),e}function Yt(t,e,n,a,o,u){return`
        <article class="
            h-full bg-white
            border border-slate-200
            rounded-3xl p-7
    ...
    `}function ie(t,e,n,a,o,u,d=""){return`
        <article class="
        ...
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    ${ea("Tamaño del efecto",t.efecto)}

                    ${ea("Reporte recomendado","Informe el estadístico, el valor p, el intervalo de confianza y el tamaño del efecto. Incluya gráficos y una interpretación sustantiva.")}
                </div>
...
18"
        ...
        <section
            ...
            aria-live="polite"
        ></section>
    `;const e=t.querySelector("#formulario-dos-grupos"),n=t.querySelector("#mensaje-error"),a=t.querySelector("#resultados-dos-grupos"),o=["student","welch","mann-whitney"],u=sessionStorage.getItem("kernel-prueba-dos-grupos");o.includes(u)&&(e.elements.prueba.value=u),sessionStorage.removeItem("kernel-prueba-dos-grupos");const d=e.elements.grupo1,h=e.elements.grupo2,g=t.querySelector("#contador-grupo-1"),l=t.querySelector("#contador-grupo-2"),r=()=>{g.textContent=vn(bn(d.value)),l.textContent=vn(bn(h.value))};return d.addEventListener("input",r),h.addEventListener("input",r),e.addEventListener("submit",i=>{i.preventDefault(),aa(n);try{const s=e.elements.prueba.value;if(!s)throw new Error("Seleccione la prueba estadística que desea ejecutar.");const c=hn(d.value,"El grupo 1"),p=hn(h.value,"El grupo 2"),m=Number(e.elements.nivelConfianza.value),f=lu({grupo1:c,grupo2:p,prueba:s,nivelConfianza:m});a.innerHTML=pu(f),a.classList.remove("hidden"),a.scrollIntoView({behavior:"smooth",block:"start"})}catch(s){a.classList.add("hidden"),du(n,s instanceof Error?s.message:"No fue posible ejecutar el análisis.")}}),t.addEventListener("click",i=>{const s=i.target.closest("[data-action]");if(!s)return;const c=s.dataset.action;if(c==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}if(c==="cargar-ejemplo"){e.elements.prueba.value||(e.elements.prueba.value="welch"),d.value=`18
20
17.5
19
21
...
16
15.5
14.5`,r(),aa(n),a.classList.add("hidden");return}c==="limpiar"&&(e.reset(),d.value="",h.value="",r(),aa(n),a.innerHTML="",a.classList.add("hidden"))}),t}function hn(t,e){const n=t.trim();if(!n)throw new Error(`${e} no contiene datos.`);const a=n.split(/[\s;]+/).filter(Boolean),o=a.map(d=>Number(d.replace(",","."))),u=o.findIndex(d=>!Number.isFinite(d));if(u!==-1)throw new Error(`${e} contiene un valor no válido: "${a[u]}".`);if(o.length<2)throw new Error(`${e} debe contener al menos dos observaciones.`);return o}function bn(t){return t.trim()?t.trim().split(/[\s;]+/).filter(Boolean).length:0}function vn(t){return t===1?"1 valor":`${t} valores`}function du(t,e){t.textContent=e,t.classList.remove("hidden")}function aa(t){t.textContent="",t.classList.add("hidden")}function O(t,e=4){return Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):"—"}function uu(t){return Number.isFinite(t)?t<.001?"< 0.001":O(t,4):"—"}function pu(t){const e=t.valorP<.05,n=e?"Se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = 0.05.":"No se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = 0.05.";return`
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            <header class="bg-emerald-700 text-white px-6 py-8 md:px-10">
                <p class="uppercase tracking-widest text-emerald-100 text-xs font-black mb-2">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${gt("p",uu(t.valorP),"Valor bilateral")}
    ...
    `}function mu(t){if(t.id==="mann-whitney")return`
    ...
    `}const fu={home:{page:Zr,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:bi,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Ai,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Ti,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:Hi,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Yi,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:po,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:ro,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Eo,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Po,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Rd,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Sd,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},calculadoraDosGrupos:{page:cu,layout:"default",title:"Comparación de dos grupos | El Kernel"}};let wn=document.referrer||"";function Ft(t){window.location.hash=`/${t}`}function gu(){const t=()=>{const e=window.location.hash.replace("#/","")||"home";bu(e)};window.addEventListener("hashchange",t),t()}function hu(t,e){const n=`${window.location.origin}${window.location.pathname}#/${t}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:e,page_location:n,page_referrer:wn}),wn=n}async function bu(t){const e=document.querySelector("main"),n=fu[t];if(!e)return;if(e.innerHTML="",!n){Ft("home");return}Ci(n.layout),document.title=n.title;const a=await n.page();e.appendChild(a),window.scrollTo({top:0,behavior:"auto"}),hu(t,n.title)}function vu(t,e){yn(t,Ft),gu();const n=window.matchMedia("(max-width: 768px)");let a=!1;function o(d){d.matches&&!a&&(Aa(t),a=!0)}n.addEventListener("change",o),o(n),Aa(t);const u=e.querySelector('[data-action ="open-menu"]');Sr(u,t),zr(t)}const Lr=document.querySelector("#header");Lr.innerHTML=Nr();const Dr=document.querySelector("#navBar");Dr.innerHTML=Or();const xu=document.querySelector("#footer");xu.innerHTML=$r();vu(Dr,Lr);
