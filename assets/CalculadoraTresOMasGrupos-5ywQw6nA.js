import{j as Q,a as Z}from"./jstat-DiDocX-r.js";import{p as _}from"./exportacionesCalculadoras-C-2g2EIK.js";import"./index-D9akd3km.js";const M=Q.jStat??Z?.jStat;if(!M)throw new Error("No fue posible cargar el motor estadístico jStat.");const z=e=>Math.min(1,Math.max(0,e));function G(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function U(e){return typeof e=="string"?e.trim()===""?Number.NaN:Number(e.trim().replace(",",".")):Number(e)}const D=e=>e.reduce((t,a)=>t+a,0)/e.length;function J(e){const t=[...e].sort((o,r)=>o-r),a=Math.floor(t.length/2);return t.length%2?t[a]:(t[a-1]+t[a])/2}function X(e,t=D(e)){return e.reduce((a,o)=>a+(o-t)**2,0)/(e.length-1)}function Y(e){const t=D(e),a=X(e,t);return{n:e.length,media:t,mediana:J(e),varianza:a,desviacionEstandar:Math.sqrt(a),minimo:Math.min(...e),maximo:Math.max(...e)}}function ee(e,t){const a=Array.isArray(e),o=a?e:e?.valores;if(!Array.isArray(o))throw new TypeError(`El grupo ${t+1} debe contener un arreglo llamado valores.`);const r=o.map(U),n=r.findIndex(l=>!Number.isFinite(l));if(n!==-1)throw new TypeError(`El grupo ${t+1} contiene un valor no numérico en la posición ${n+1}.`);if(r.length<2)throw new RangeError(`El grupo ${t+1} debe contener al menos dos observaciones.`);return{nombre:(a?"":String(e?.nombre??"").trim())||`Grupo ${t+1}`,valores:r,...Y(r)}}function P(e){if(!Array.isArray(e))throw new TypeError("Los grupos deben proporcionarse mediante un arreglo.");if(e.length<3)throw new RangeError("El análisis requiere al menos tres grupos independientes.");const t=e.map(ee),a=t.map(({nombre:o})=>o);if(new Set(a).size!==a.length)throw new Error("Cada grupo debe tener un nombre diferente.");return t}function S(e){const t=e.reduce((o,r)=>o+r.n,0),a=e.reduce((o,r)=>o+r.valores.reduce((n,s)=>n+s,0),0);return{numeroGrupos:e.length,nTotal:t,mediaGeneral:a/t}}function H(e,t,a){return e===1/0?0:z(1-M.centralF.cdf(e,t,a))}function te(e,t){return z(1-M.chisquare.cdf(e,t))}function F(){if(!M.tukey?.cdf||!M.tukey?.inv)throw new Error("La distribución de Tukey no está disponible en la versión instalada de jStat.")}function I(e,t,a){return F(),e===1/0?0:z(1-M.tukey.cdf(e,t,a))}function R(e,t,a){return F(),M.tukey.inv(e,t,a)}function q(e){const t=Math.abs(e);return t<.01?"Prácticamente nulo":t<.06?"Pequeño":t<.14?"Moderado":"Grande"}function V(e,t){const a=[];for(let o=0;o<e.length-1;o+=1)for(let r=o+1;r<e.length;r+=1)a.push(t(e[o],e[r],o,r));return a}function ae(e,t,a,o){const r=1-o,n=e.length,s=R(o,n,a);return{id:"tukey-kramer",nombre:"Comparaciones de Tukey–Kramer",metodo:"Rango studentizado con control del error familiar.",recomendado:!1,comparaciones:V(e,(l,i)=>{const c=l.media-i.media,d=Math.sqrt(t/2*(1/l.n+1/i.n)),p=d===0?c===0?0:1/0:Math.abs(c)/d,m=I(p,n,a),b=s*d;return{grupo1:l.nombre,grupo2:i.nombre,diferenciaMedias:c,errorEstandar:d,estadisticoQ:p,gradosLibertad:a,valorP:m,valorPAjustado:m,intervaloConfianza:{nivel:o,inferior:c-b,superior:c+b,margen:b},significativo:m<r}})}}function oe(e,t){const a=1-t,o=e.length;return{id:"games-howell",nombre:"Comparaciones de Games–Howell",metodo:"Comparaciones pareadas robustas ante varianzas y tamaños desiguales.",recomendado:!1,comparaciones:V(e,(r,n)=>{const s=r.media-n.media,l=r.varianza/r.n,i=n.varianza/n.n,c=l+i,d=Math.sqrt(c/2),p=c**2/(l**2/(r.n-1)+i**2/(n.n-1)),m=d===0?s===0?0:1/0:Math.abs(s)/d,b=I(m,o,p),g=R(t,o,p)*d;return{grupo1:r.nombre,grupo2:n.nombre,diferenciaMedias:s,errorEstandar:d,estadisticoQ:m,gradosLibertad:p,valorP:b,valorPAjustado:b,intervaloConfianza:{nivel:t,inferior:s-g,superior:s+g,margen:g},significativo:b<a}})}}function re(e){const t=e.map(n=>({...n,rango:0})).sort((n,s)=>n.valor-s.valor);let a=0,o=0,r=0;for(;a<t.length;){let n=a+1;for(;n<t.length&&t[n].valor===t[a].valor;)n+=1;const s=n-a,l=(a+1+n)/2;for(let i=a;i<n;i+=1)t[i].rango=l;s>1&&(r+=1,o+=s**3-s),a=n}return{observaciones:t,sumaCorreccionEmpates:o,cantidadGruposEmpatados:r}}function ne(e){const t=e.map((o,r)=>({...o,indiceOriginal:r})).sort((o,r)=>o.valorP-r.valorP);let a=0;return t.forEach((o,r)=>{const n=Math.min(1,o.valorP*(t.length-r));o.valorPAjustado=Math.max(a,n),a=o.valorPAjustado}),t.sort((o,r)=>o.indiceOriginal-r.indiceOriginal).map(({indiceOriginal:o,...r})=>r)}function se(e,t,a,o,r){const n=1-r,s=a*(a+1)/12-o/(12*(a-1)),l=V(e,(i,c,d,p)=>{const m=t[d]/i.n,b=t[p]/c.n,g=m-b,v=Math.sqrt(s*(1/i.n+1/c.n)),w=v===0?0:g/v,k=z(2*(1-M.normal.cdf(Math.abs(w),0,1)));return{grupo1:i.nombre,grupo2:c.nombre,rangoMedio1:m,rangoMedio2:b,diferenciaRangos:g,errorEstandar:v,estadisticoZ:w,valorP:k,tamanioEfectoR:w/Math.sqrt(a)}});return{id:"dunn-holm",nombre:"Comparaciones de Dunn con ajuste de Holm",metodo:"Comparaciones de rangos con corrección secuencial de Holm.",recomendado:!1,comparaciones:ne(l).map(i=>({...i,significativo:i.valorPAjustado<n}))}}function ie(e,t={}){const{nivelConfianza:a=.95}=t;G(a);const o=P(e),r=S(o),n=o.reduce(($,f)=>$+f.n*(f.media-r.mediaGeneral)**2,0),s=o.reduce(($,f)=>$+f.valores.reduce((y,B)=>y+(B-f.media)**2,0),0),l=n+s,i=o.length-1,c=r.nTotal-o.length,d=n/i,p=s/c,m=p===0?d===0?0:1/0:d/p,b=H(m,i,c),g=l===0?0:n/l,v=l+p===0?0:(n-i*p)/(l+p),w=Math.max(0,v),k=1-a,x=b<k,h=ae(o,p,c,a);return h.recomendado=x,{id:"anova-un-factor",nombre:"ANOVA de un factor",metodo:"ANOVA clásico para tres o más grupos independientes con varianzas homogéneas.",grupos:o,...r,estadistico:{simbolo:"F",valor:m},gradosLibertad:{numerador:i,denominador:c},valorP:b,nivelConfianza:a,alfa:k,significativo:x,tablaAnova:{entreGrupos:{sumaCuadrados:n,gradosLibertad:i,cuadradoMedio:d},dentroGrupos:{sumaCuadrados:s,gradosLibertad:c,cuadradoMedio:p},total:{sumaCuadrados:l,gradosLibertad:r.nTotal-1}},tamanioEfecto:{etaCuadrado:g,omegaCuadrado:w,interpretacion:q(w)},postHoc:h}}function le(e,t={}){const{nivelConfianza:a=.95}=t;G(a);const o=P(e),r=S(o),n=o.find(({varianza:f})=>f<=0);if(n)throw new Error(`El ANOVA de Welch requiere varianza positiva en cada grupo. Revise ${n.nombre}.`);const s=o.map(f=>({...f,peso:f.n/f.varianza})),l=s.reduce((f,y)=>f+y.peso,0),i=s.reduce((f,y)=>f+y.peso*y.media,0)/l,c=o.length,d=c-1,p=s.reduce((f,y)=>f+y.peso*(y.media-i)**2,0)/d,m=s.reduce((f,y)=>f+(1-y.peso/l)**2/(y.n-1),0),b=1+2*(c-2)/(c**2-1)*m,g=p/b,v=(c**2-1)/(3*m),w=H(g,d,v),k=Math.max(0,d*(g-1)/(d*g+v+1)),x=1-a,h=w<x,$=oe(o,a);return $.recomendado=h,{id:"anova-welch",nombre:"ANOVA de Welch",metodo:"ANOVA robusto para tres o más grupos independientes sin exigir igualdad de varianzas.",grupos:o,...r,mediaPonderada:i,sumaPesos:l,estadistico:{simbolo:"F_W",valor:g},gradosLibertad:{numerador:d,denominador:v},valorP:w,nivelConfianza:a,alfa:x,significativo:h,componentesWelch:{numeradorBase:p,terminoCorreccion:m,denominadorCorreccion:b},tamanioEfecto:{omegaCuadradoAproximado:k,interpretacion:q(k),nota:"Estimación aproximada basada en el estadístico F de Welch y sus grados de libertad."},postHoc:$}}function ce(e,t={}){const{nivelConfianza:a=.95}=t;G(a);const o=P(e),r=S(o),n=o.flatMap((x,h)=>x.valores.map($=>({valor:$,indiceGrupo:h}))),s=re(n),l=new Array(o.length).fill(0);s.observaciones.forEach(({indiceGrupo:x,rango:h})=>{l[x]+=h});const i=12/(r.nTotal*(r.nTotal+1))*o.reduce((x,h,$)=>x+l[$]**2/h.n,0)-3*(r.nTotal+1),c=1-s.sumaCorreccionEmpates/(r.nTotal**3-r.nTotal),d=c<=0?0:i/c,p=o.length-1,m=te(d,p),b=Math.max(0,(d-o.length+1)/(r.nTotal-o.length)),g=1-a,v=m<g,w=o.map((x,h)=>({...x,sumaRangos:l[h],rangoMedio:l[h]/x.n})),k=se(o,l,r.nTotal,s.sumaCorreccionEmpates,a);return k.recomendado=v,{id:"kruskal-wallis",nombre:"Prueba de Kruskal–Wallis",metodo:"Comparación no paramétrica de tres o más grupos independientes mediante rangos.",grupos:w,...r,estadistico:{simbolo:"H",valor:d,sinCorreccion:i},gradosLibertad:{valor:p},valorP:m,nivelConfianza:a,alfa:g,significativo:v,empates:{factorCorreccion:c,sumaCorreccion:s.sumaCorreccionEmpates,cantidadGruposEmpatados:s.cantidadGruposEmpatados},tamanioEfecto:{epsilonCuadrado:b,interpretacion:q(b)},postHoc:k}}function de({grupos:e,prueba:t,nivelConfianza:a=.95}){switch(t){case"anova-un-factor":case"anova":return ie(e,{nivelConfianza:a});case"anova-welch":case"welch":return le(e,{nivelConfianza:a});case"kruskal-wallis":return ce(e,{nivelConfianza:a});default:throw new Error("La prueba solicitada no está disponible.")}}function Ee(){const e=document.createElement("section");e.className=`
        ...
        <section class="grid grid-cols-1 xl:grid-cols-[0.72fr_1.28fr] gap-7 mt-8">
            <aside class="rounded-3xl border border-slate-200 bg-white p-6 md:p-8 shadow-lg">
                ...
                <div class="space-y-5 text-slate-600 leading-relaxed">
                    ${L("ANOVA de un factor","Variable cuantitativa, normalidad aproximada y varianzas homogéneas.")}
                    ${L("ANOVA de Welch","Variable cuantitativa con varianzas desiguales o tamaños muestrales diferentes.")}
                    ${L("Kruskal–Wallis","Datos ordinales, distribuciones no normales o presencia importante de valores atípicos.")}
                </div>
...
88`}];[...t.querySelectorAll("[data-grupo]")].forEach((o,r)=>{o.querySelector("[data-nombre-grupo]").value=a[r].nombre,o.querySelector("[data-valores-grupo]").value=a[r].valores,W(o)}),e.elements.prueba.value||(e.elements.prueba.value="anova-un-factor")}function O(e,t){e.textContent=t,e.classList.remove("hidden")}function j(e){e.textContent="",e.classList.add("hidden")}function C(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function u(e,t=4){return e===1/0?"∞":Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:t}).format(e):"—"}function K(e){return Number.isFinite(e)?e<.001?"< 0.001":u(e,4):"—"}function fe(e){const t=e.alfa.toFixed(2),a=Math.round(e.nivelConfianza*100),o=e.significativo?`Se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${t}, correspondiente a un nivel de confianza del ${a} %.`:`No se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${t}, correspondiente a un nivel de confianza del ${a} %.`;return`
    ...
    `}function ge(e){const t=e.id==="kruskal-wallis";return`
                ...
                <table class="w-full min-w-[850px] text-sm">
                    ...
                    <thead class="bg-slate-50 text-slate-700">
                        <tr>
                            ...
                            ${t?'<th scope="col" class="text-right px-4 py-4 font-black">Rango medio</th>':""}
                        </tr>
                    </thead>
    ...
    `}function xe(e){if(e.id==="anova-un-factor"){const t=e.tablaAnova;return`
    ...
    `}function he(e){let t;return e.id==="anova-un-factor"?t=[["Eta cuadrado, η²",e.tamanioEfecto.etaCuadrado],["Omega cuadrado, ω²",e.tamanioEfecto.omegaCuadrado]]:e.id==="anova-welch"?t=[["Omega cuadrado aproximado",e.tamanioEfecto.omegaCuadradoAproximado]]:t=[["Épsilon cuadrado, ε²",e.tamanioEfecto.epsilonCuadrado]],`
    ...
    `}function ve(e){const t=e.postHoc;return t?.comparaciones?.length?`
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[980px] text-sm">
                    ...
                    <tbody class="divide-y divide-fuchsia-100">
                        ${t.comparaciones.map(ye).join("")}
                    </tbody>
                </table>
            </div>
        </article>
    `:""}function ye(e){const t=e.diferenciaMedias??e.diferenciaRangos,a=e.estadisticoQ??e.estadisticoZ,o=e.valorPAjustado??e.valorP,r=e.intervaloConfianza?`${u(e.intervaloConfianza.inferior)} a ${u(e.intervaloConfianza.superior)}`:"—";return`
        <tr>
            <th scope="row" class="px-5 py-4 text-left font-bold text-slate-900">
    ...
    `}export{Ee as CalculadoraTresOMasGrupos};
