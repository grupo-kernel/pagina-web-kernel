(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const G=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function te(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function ie(){return`<div class="lg:hidden  border-b-zinc-500 border-b  pb-2.5  w-full  flex px-2.5  justify-between items-center  mb-7">
              <span class="text-4xl font-medium ">El Kernel</span>
                ...
                <ul class="flex w-full text-black flex-col lg:flex-row p-4 gap-4 xl:gap-9">
                  ...
                  <li data-action="open-subMenu" class="gap-1 text-nowrap lg:relative  2xl:text-3xl  hover:cursor-pointer 
                    ...
                    </ul>`}function oe(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${G}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
        ...
        `}function T(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(t=>{const i=t.querySelector("ul"),o=t.querySelector("i");let s=!i.classList.contains("hidden");t.addEventListener("click",l=>{l.preventDefault(),s?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),s=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),s=!0)})})}function se(e,a){e.addEventListener("click",()=>{a.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function ne(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function le(){return`
        <div class="
    ...
    `}function J(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function re(e){J(e,R)}const K=""+new URL("apec-ConmXkrT.png",import.meta.url).href,ce=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,de=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,N=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${K}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${ce}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function pe(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=N.length,s=1500;let l=0,p=null;function g(n){return(n%o+o)%o}function m(){i.innerHTML=N[l].content}function c(n){l=g(l+n),m()}function f(){d(),p=setInterval(()=>c(1),s)}function d(){p&&(clearInterval(p),p=null)}function r(){f()}m(),f(),a.addEventListener("click",()=>{c(1),r()}),t.addEventListener("click",()=>{c(-1),r()})}function me(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return pe(t.querySelector("#containerFather")),re(t.querySelector("#btnsGroup")),t}function ue(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=`${le()}`;const a=me();return e.appendChild(a),e}function xe(){return ue()}const ge=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function be(){return`
        <section 
            role="banner" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-8 items-start">
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 md:p-8">
                    ...
                    <div class="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="bg-slate-50 border border-slate-100 rounded-2xl p-4 text-center">
                            <p class="text-2xl font-black text-slate-900">7+</p>
                            <p class="text-xs text-slate-500 font-semibold">Investigadores</p>
                        </div>
                        ...
                        <div class="bg-slate-50 border border-slate-100 rounded-2xl p-4 text-center">
                            <p class="text-2xl font-black text-slate-900">6</p>
                            <p class="text-xs text-slate-500 font-semibold">Líneas activas</p>
                        </div>
                    </div>
                ...
                <div class="space-y-5">
                    ...
                    <article class="bg-[#1E1E1E] text-white rounded-3xl shadow-2xl p-6 md:p-7 relative overflow-hidden">
                        ...
                        <p class="text-white/75 leading-relaxed">
                            Desarrollar investigación científica en análisis numérico, métodos iterativos,
                            optimización, modelización matemática, álgebra y educación matemática,
                            promoviendo publicaciones, formación académica y colaboración interdisciplinaria.
                        </p>
                    </article>
                    ...
                    <article class="bg-[#5580C1] text-white rounded-3xl shadow-xl p-6 md:p-7 relative overflow-hidden">
                        ...
                        <p class="text-white/85 leading-relaxed">
                            Ser un grupo reconocido por su producción científica, el diseño de métodos
                            matemáticos y computacionales, la formación de investigadores y la vinculación
                            de la matemática con problemas científicos, tecnológicos y educativos.
                        </p>
                    </article>
    ...
    `}const ve="data:image/png;base64,",he="data:image/png;base64,",we="data:image/png;base64,",ye="data:image/png;base64,",Ae="data:image/png;base64,",ke=[{icon:ve,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:he,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:we,title:"Objetivos",content:`
      ...
      </ul>`},{icon:ye,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Ee({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${Ae}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function Se(){const e=document.createElement("section");return e.className=`
    ...
    `).join("")}function je(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `;const t=Le(e.redes||[]),i=je(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}const j=""+new URL("sep-BCMURSaM.png",import.meta.url).href,z=""+new URL("nat-CaDYa76I.png",import.meta.url).href,V=""+new URL("rad-B3ff1btG.png",import.meta.url).href,O=""+new URL("ant-D2J2W27b.png",import.meta.url).href,H=""+new URL("mar-Cru0HERG.png",import.meta.url).href,P=""+new URL("marc-D-jKwb4F.png",import.meta.url).href,I=""+new URL("jos-BToFZdIf.png",import.meta.url).href,S=[{img:j,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:z,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:V,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:O,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:H,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:P,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:I,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function Pe(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,s=()=>{const r=o();return Math.max(S.length-r,0)},l=()=>{const r=s();e>r&&(e=0),e<0&&(e=r)},p=()=>{const r=s();e>=r?e=0:e++,d()},g=()=>{const r=s();e<=0?e=r:e--,d()},m=()=>{c(),S.length>o()&&(a=setInterval(p,4500))},c=()=>{a&&(clearInterval(a),a=null)},f=()=>{const r=o(),n=Math.max(S.length-r+1,1);return Array.from({length:n}).map((u,v)=>`
        ...
        `).join("")},d=()=>{if(!S||S.length===0){i.innerHTML=`
            ...
            `;return}l();const r=o(),n=S.slice(e,e+r);i.innerHTML=`
        ...
        `;const u=i.querySelector("#cards-wrapper");n.forEach(w=>{u.appendChild(ze(w))});const v=i.querySelector("#prev-btn"),y=i.querySelector("#next-btn");v&&(v.onclick=()=>{g(),m()}),y&&(y.onclick=()=>{p(),m()}),i.querySelectorAll("[data-dot-index]").forEach(w=>{w.onclick=()=>{e=parseInt(w.dataset.dotIndex),d(),m()}})};return i.addEventListener("mouseenter",c),i.addEventListener("mouseleave",m),document.addEventListener("visibilitychange",()=>{document.hidden?c():m()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,d(),m()},150)}),d(),m(),i}function Be(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&R(t.dataset.route)})}function Q(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Be(a),a}function $e(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(Q());const t=Pe();return e.appendChild(a),e.appendChild(t),e}function Oe(){return $e()}function Ue(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function A(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Y(e){return e.formacion?.length||0}function W(e){return e.experiencia?.length||0}function Re(e,a=!1){const t=Y(e),i=W(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function Te(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(p=>`
    ...
    `}function He({id:e,title:a,date:t,image:i,excerpt:o}){return`
  ...
  `}function We(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ${Ve()}
    ${Qe(Z)}
    ${Ye()}
    
    `,e}function Ze({title:e,content:a,articleURL:t}){const i=a.paragraphs.map(l=>`<p>${l}<p>`).join(""),o=a.list.length?` 
    ...
    `}function la(e){if(!e)return`
        ...
        `;const a=X(e),t=sa(e),i=t.length,o=t.map(c=>Number(c.year)).filter(Boolean),s=o.length?Math.min(...o):"",l=o.length?Math.max(...o):"",p=[...new Set(t.map(c=>c.q).filter(Boolean))],g=[...new Set(t.map(c=>q(c)).filter(Boolean))],m=t.map(c=>{const f=q(c),d=_(c),r=oa(c);return`
    ...
    `}function ra(){let e=M[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(n){return String(n?.DOI||n?.doi||"").trim().toLowerCase()}function s(n){return String(n?.journal||n?.title||n?.tile||"").trim()}function l(n){return String(n?.articleTitle||n?.contenido||"").trim()}function p(n){return String(n?.q||n?.quartile||"").trim().toUpperCase()}function g(n){const u=o(n);return u||[n?.year||"",s(n),l(n)].join("-").trim().toLowerCase()}function m(){const n=new Map;return M.forEach(u=>{(u.publicaciones||[]).forEach(v=>{const y=g(v);y&&!n.has(y)&&n.set(y,v)})}),Array.from(n.values())}function c(){const n=m(),u=n.map(B=>Number(B.year)).filter(Boolean),v=u.length?Math.max(...u):"—",y=u.length?Math.min(...u):"—",w=n.filter(B=>p(B)==="Q1").length;return{totalPublicaciones:n.length,investigadores:M.length,q1:w,primerYear:y,ultimoYear:v}}function f(){return M.find(n=>Number(n.id)===Number(e))||M[0]}const d=()=>{const n=f(),u=c(),v=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${M.map(w=>na(w,Number(w.id)===Number(e))).join("")}
                </aside>
    ...
    `}function xa(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function ga(){const e=new Set(E.map(i=>i.categoria)),a=E.filter(i=>i.proyectosAsociados?.length>0).length,t=E.filter(i=>i.publicacionesClave?.length>0).length;return{total:E.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function ba(){let e=E[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=da(e),o=ga();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `).join("")}function wa(e=[]){return e.map(a=>`
        <span class="inline-flex items-center bg-white/10 text-white border border-white/10 px-3 py-1 rounded-full text-xs font-semibold">
            ${x(a)}
        </span>
    `).join("")}function ya(e,a=!1){return`
        <button 
            type="button"
    ...
    `}function ka(){let e=D[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=va(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function Ca(){return ka()}function Ea(){return`
    ...
    `}function Ma(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Sa()}
    `,e}function Da(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Ia)}async function Ia(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=La(i);if(o.length>0){za(o);return}await Pa(a,i)}function La(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?ja(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function ja(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function za(e){L(e[0],"error")}function L(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Pa(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(L("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):L("Hubo un problema al enviar el mensaje.","error")}catch{L("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Ba(){const e=Ma();return setTimeout(()=>{Da()},0),e}const $a={home:{page:xe,layout:"default"},quienesSomos:{page:Ie,layout:"full"},equipment:{page:Oe,layout:"default"},FormacionAcademica:{page:qe,layout:"default"},noticias:{page:ia,layout:"full"},publicaciones:{page:ca,layout:"default"},proyectos:{page:Ca,layout:"default"},lineas:{page:fa,layout:"default"},contacto:{page:Ba,layout:"default"}};function R(e){window.location.hash=`/${e}`}function Oa(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";Ua(a)};window.addEventListener("hashchange",e),e()}function Ua(e){const a=document.querySelector("main"),t=$a[e];a&&(a.innerHTML="",t&&(Ue(t.layout),a.appendChild(t.page())))}function Ra(e,a){J(e,R),Oa();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(l){l.matches&&!i&&(T(e),i=!0)}t.addEventListener("change",o),o(t),T(e);const s=a.querySelector('[data-action ="open-menu"]');se(s,e),ne(e)}const ee=document.querySelector("#header");ee.innerHTML=te();const ae=document.querySelector("#navBar");ae.innerHTML=ie();const Ta=document.querySelector("#footer");Ta.innerHTML=oe();Ra(ae,ee);
