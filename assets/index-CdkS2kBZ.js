(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const O=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function F(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${O}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
        ...
        `}function S(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(a=>{const i=a.querySelector("ul"),o=a.querySelector("i");let s=!i.classList.contains("hidden");a.addEventListener("click",n=>{n.preventDefault(),s?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),s=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),s=!0)})})}function $(e,t){e.addEventListener("click",()=>{t.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function H(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function V(){return`<div class =" flex justify-center 
            ...
            <!-- Fin tarjeta principal  -->  `}function R(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function Q(e){R(e,M)}const U=""+new URL("apec-ConmXkrT.png",import.meta.url).href,K=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Y=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,D=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        </div>`}];function W(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=D.length,s=1500;let n=0,r=null;function l(h){return(h%o+o)%o}function c(){i.innerHTML=D[n].content}function d(h){n=l(n+h),c()}function f(){b(),r=setInterval(()=>d(1),s)}function b(){r&&(clearInterval(r),r=null)}function E(){f()}c(),f(),t.addEventListener("click",()=>{d(1),E()}),a.addEventListener("click",()=>{d(-1),E()})}function Z(){const e=`
  ...
  `}function Oe(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ${Le()}
    ${Ie(z)}
    ${je()}
    ...
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function ot(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(p("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):p("Hubo un problema al enviar el mensaje.","error")}catch{p("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function nt(){const e=Xe();return setTimeout(()=>{_e()},0),e}const st={home:{page:_,layout:"default"},quienesSomos:{page:xe,layout:"full"},equipment:{page:ve,layout:"default"},FormacionAcademica:{page:Me,layout:"default"},noticias:{page:Ne,layout:"full"},publicaciones:{page:Je,layout:"default"},proyectos:{page:Ye,layout:"default"},lineas:{page:Ve,layout:"default"},contacto:{page:nt,layout:"default"}};function M(e){window.location.hash=`/${e}`}function rt(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";lt(t)};window.addEventListener("hashchange",e),e()}function lt(e){const t=document.querySelector("main"),a=st[e];t&&(t.innerHTML="",a&&(we(a.layout),t.appendChild(a.page())))}function ct(e,t){R(e,M),rt();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(S(e),i=!0)}a.addEventListener("change",o),o(a),S(e);const s=t.querySelector('[data-action ="open-menu"]');$(s,e),H(e)}const N=document.querySelector("#header");N.innerHTML=F();const q=document.querySelector("#navBar");q.innerHTML=G();const dt=document.querySelector("#footer");dt.innerHTML=J();ct(q,N);
