(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const U=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function H(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function V(){return`<div class="lg:hidden  border-b-zinc-500 border-b  pb-2.5  w-full  flex px-2.5  justify-between items-center  mb-7">
              <span class="text-4xl font-medium ">El Kernel</span>
                ...
                <ul class="flex w-full text-black flex-col lg:flex-row p-4 gap-4 xl:gap-9">
                  ...
                  <li data-action="open-subMenu" class="gap-1 text-nowrap lg:relative  2xl:text-3xl  hover:cursor-pointer 
                    ...
                    </ul>`}function Q(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
        ...
        `}function D(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(a=>{const i=a.querySelector("ul"),o=a.querySelector("i");let n=!i.classList.contains("hidden");a.addEventListener("click",s=>{s.preventDefault(),n?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),n=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),n=!0)})})}function Y(e,t){e.addEventListener("click",()=>{t.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function K(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function W(){return`<div class =" flex justify-center 
            ...
            <!-- Fin tarjeta principal  -->  `}function P(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function Z(e){P(e,k)}const B=""+new URL("apec-ConmXkrT.png",import.meta.url).href,X=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,_=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,L=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${B}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${X}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function ee(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=L.length,n=1500;let s=0,l=null;function d(g){return(g%o+o)%o}function c(){i.innerHTML=L[s].content}function r(g){s=d(s+g),c()}function x(){u(),l=setInterval(()=>r(1),n)}function u(){l&&(clearInterval(l),l=null)}function p(){x()}c(),x(),t.addEventListener("click",()=>{r(1),p()}),a.addEventListener("click",()=>{r(-1),p()})}function te(){const e=`
    <div class="absolute bottom-0 col-span-4
            ...
            </div>`,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return ee(a.querySelector("#containerFather")),Z(a.querySelector("#btnsGroup")),a}function ae(){const e=document.createElement("section");e.classList.add("relative","w-full","flex","flex-col","m-auto","tabletBig:flex-row","md:mb-50","tabletBig:w-7xl","tabletBig:px-20","xl:mb-0","xl:pb-0","xl:w-full","xl:px-0","2xl:w-450","2xl:h-187.5"),e.innerHTML=`${W()}`;const t=document.createElement("div");return t.appendChild(te()),e.appendChild(t.firstElementChild),e}function ie(){return ae()}const oe=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function ne(){return`
    <section role="banner" class="relative w-full min-h-screen overflow-hidden">
     
    <!-- Imagen del banner -->
      <img src="${oe}" alt="QuienesSomos" class="absolute inset-0 w-full h-full object-cover" loading="lazy"/>
  ...
  `}const re="data:image/png;base64,",le="data:image/png;base64,",ce="data:image/png;base64,",de="data:image/png;base64,",me="data:image/png;base64,",ue=[{icon:re,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:le,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:ce,title:"Objetivos",content:`
      ...
      </ul>`},{icon:de,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function xe({icon:e,title:t,content:a}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${me}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function ge(){const e=document.createElement("section");return e.classList.add("w-full","lg:w-320"),e.innerHTML=`
    ${ne()}
    ${se()}
    ${pe()}
  `,e}function fe(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),n=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(s=>{s.classList.remove("max-h-[1000px]"),s.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(s=>{s.classList.remove("rotate-180")}),n||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function be(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function he(){const e=ge();return fe(e),be(e),e}function ve(e){const t=document.createElement("div");t.className="flex bg-white border rounded-xl shadow-2xl border-black w-89.5 h-139 flex-col items-center text-center justify-between p-4 gap-4 transition-all hover:scale-[1.02]";const a=e.redes.map(i=>`
        <a href="${i.url}" 
           target="_blank" 
    ...
    `,t}const C=""+new URL("sep-BCMURSaM.png",import.meta.url).href,M=""+new URL("nat-CaDYa76I.png",import.meta.url).href,T=""+new URL("rad-B3ff1btG.png",import.meta.url).href,E=""+new URL("ant-D2J2W27b.png",import.meta.url).href,N=""+new URL("mar-Cru0HERG.png",import.meta.url).href,w=""+new URL("marc-D-jKwb4F.png",import.meta.url).href,y=""+new URL("jos-BToFZdIf.png",import.meta.url).href,A=[{img:C,title:"Miguel A. Miguel A. Leonardo Sepúlveda, Ph.D",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente.",afilaciones:" ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&amp;hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con enfoque en métodos numéricos avanzados. Asesor de tesis de posgrado y pregrado. Diseñador y rediseñador de programas curriculares universitarios. Investigador en métodos libres de Jacobiano, análisis numérico y formación de docentes."},{img:M,title:"Natanael Ureña Castillo, M.Sc",subtitle:"Optimización, entrenamiento de redes neuronales, formación docente",areas:"Métodos iterativos, optimización, redes neuronales, ciencias actuariales, matemática computacional, formación docente.",afilaciones:" ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Especialista en métodos iterativos, optimización y redes neuronales aplicadas a problemas complejos y riesgos. Docente universitario y asesor en proyectos de investigación matemática."},{img:T,title:"Randy Leonardo, M.Sc",subtitle:"Álgebra Lineal, Matrices combinadas, Educación Matemática",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa..",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador en álgebra y docencia, co-investigador de proyectos de matrices combinadas. Ponente en congresos nacionales."},{img:E,title:"Antmel Rodríguez Cabral, Ph.D",subtitle:"Especialista en dinámica compleja y dinámica real de métodos iterativos para sistemas no lineales",rec:"Recientemente defendió su tesis doctoral (Doctor en Matemática).",areas:" EDPs, sistemas no lineales, planos/dinámicas compleja y real, análisis complejo, educación matemática.",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Profesor universitario e investigador en métodos numéricos, EDPs y planos dinámicos; ponente en congresos internacionales."},{img:N,title:"Marino Brito Guillén, M.Sc",subtitle:"Gestión universitaria, Matemática Educativa, Educación",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente.",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Ex-vicerrector académico, profesor universitario y consultor educativo. Experto en desarrollo curricular y formación docente."},{img:w,title:"Marc-Kelly Jean Philippe Jean, Ph.D",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",areas:"Álgebra, matemática pura, educación matemática, recursos educativos.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?hl=es&amp;user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Profesor adjunto, asesor y conferencista en álgebra, con experiencia en investigación y divulgación científica internacional."},{img:y,title:"José Alberto Reyes Reyes, M.Sc",subtitle:"Métodos Iterativos, Educación Matemática",areas:"Matemática pura, métodos iterativos, análisis de estabilidad, innovación educativa.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Docente universitario y de postgrado. Investigador en métodos numéricos y asesor de tesis en análisis de estabilidad y convergencia."}];function we(){let e=0,t;const a=document.createElement("div");a.className="relative flex flex-col gap-7 w-full items-center";const i=()=>window.innerWidth>=1024?3:window.innerWidth>=768?2:1,o=()=>{const c=i();e+c>=A.length?e=0:e++,d()},n=()=>{const c=i();e<=0?e=A.length-c:e--,d()},s=()=>{l(),t=setInterval(o,3500)},l=()=>{t&&clearInterval(t)},d=()=>{const c=i();a.innerHTML=`
        ...
        `;const r=a.querySelector("#cards-wrapper");A.slice(e,e+c).forEach(u=>{r.appendChild(ve(u))}),a.querySelector("#prev-btn").onclick=()=>{n(),s()},a.querySelector("#next-btn").onclick=()=>{o(),s()}};return document.addEventListener("visibilitychange",()=>{document.hidden?l():s()}),window.addEventListener("resize",()=>{e=0,d()}),d(),s(),a}function ye(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-route]");if(!a)return;const i=window.location.hash.replace("#/","")||"equipment";a.dataset.route!==i&&k(a.dataset.route)})}function z(){const e=window.location.hash.replace("#/","")||"equipment",t=document.createElement("div"),a="bg-sky-800 text-white border-b-sky-800",i="bg-transparent text-black hover:bg-gray-50";return t.innerHTML=`
    ...
    </nav>`,ye(t.firstElementChild),t.firstElementChild}function Ae(){const e=document.createElement("section");e.classList.add("flex","flex-col","gap-5","m-auto","p-4","max-w-7xl","tabletBig:w-7xl","xl:w-full"),e.appendChild(z());const t=we();return e.appendChild(t),e}function Ce(){return Ae()}function Me(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function Ee(e,t=!1){return`
        <div data-id="${e.id}" 
    ...
    `}function Se(e){const t=e.formacion.map(i=>`
        <div class="mb-4">
  ...
  `}function Be(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ${Oe()}
    ${Ue(q)}
    ${Pe()}
    
    `,e}function Te({title:e,content:t,articleURL:a}){const i=t.paragraphs.map(s=>`<p>${s}<p>`).join(""),o=t.list.length?` 
    ...
    `}function Qe(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const t=F(e),a=He(e),i=a.length,o=a.map(r=>Number(r.year)).filter(Boolean),n=o.length?Math.min(...o):"",s=o.length?Math.max(...o):"",l=[...new Set(a.map(r=>r.q).filter(Boolean))],d=[...new Set(a.map(r=>j(r)).filter(Boolean))],c=a.map(r=>{const x=j(r),u=$(r),p=Je(r);return`
    ...
    `}function Ye(){let e=f[0]?.id||1,t=!1,a=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(c){const r=String(c.DOI||c.doi||"").trim().toLowerCase();return r||`${c.year||""}-${c.title||c.tile||""}-${c.contenido||""}`.trim().toLowerCase()}function n(){const c=new Map;return f.forEach(r=>{(r.publicaciones||[]).forEach(x=>{const u=o(x);c.has(u)||c.set(u,x)})}),Array.from(c.values())}function s(){const c=n(),r=c.map(g=>Number(g.year)).filter(Boolean),x=r.length?Math.max(...r):"—",u=r.length?Math.min(...r):"—",p=c.filter(g=>g.q==="Q1").length;return{totalPublicaciones:c.length,investigadores:f.length,q1:p,primerYear:u,ultimoYear:x}}const l=()=>{const c=f.find(p=>p.id===e)||f[0],r=s(),x=window.innerWidth<768&&!t;i.innerHTML=`
    ...
    `}function Xe(){return We()}const h=[{id:1,title:"Plataforma de Simulación para Ecuaciones Diferenciales Parciales No Lineales",contenido:"Diseño e implementación de un software web para la simulación y visualización de soluciones aproximadas a EDPs no lineales utilizando métodos numéricos avanzados. El objetivo es crear una herramienta didáctica y de investigación abierta a estudiantes y científicos."},{id:2,title:"Entrenamiento de Redes Neuronales para la Solución de Problemas Matemáticos",contenido:"Proyecto orientado al desarrollo y entrenamiento de arquitecturas de redes neuronales profundas para el aprendizaje y la resolución automatizada de ecuaciones diferenciales y problemas complejos en optimización matemática."},{id:3,title:"Métodos Cuasi-Newton de Memoria Limitada Aplicados a Grandes Sistemas",contenido:"Investigación sobre el diseño y análisis de métodos cuasi-Newton híbridos de memoria limitada, dirigidos a la resolución eficiente de sistemas de ecuaciones de gran escala, con énfasis en aplicaciones de ingeniería y finanzas."},{id:4,title:"Modelización Matemática de Riesgo Actuarial y Financiero",contenido:"Elaboración de modelos para la evaluación y gestión del riesgo en problemas actuariales y financieros, combinando técnicas de optimización y simulación para ofrecer soluciones robustas a la toma de decisiones en estos campos."},{id:5,title:"Innovación en la Enseñanza y Evaluación de la Matemática",contenido:"Diseño de estrategias y recursos innovadores para la enseñanza de las matemáticas en distintos niveles educativos, incorporando metodologías activas, plataformas tecnológicas y evaluación por competencias."},{id:6,title:"Desarrollo de Métodos Metaheurísticos Híbridos",contenido:"Propuesta de integración de algoritmos metaheurísticos con métodos iterativos clásicos y cuasi-Newton para abordar problemas no lineales de alta complejidad en diferentes áreas de la ciencia y la ingeniería."}];function _e(){let e=0;const t=h.length,a=document.createElement("section");a.className="w-full max-w-6xl mx-auto p-4 mt-10 mb-20 font-sans tabletBig:w-7xl tabletBig:px-20 xl:w-full xl:px-0";const i=()=>{const o=(e+1)%t,n=(e+2)%t,s=h[e],l=h[o],d=h[n];a.innerHTML=`
        ...
        `,a.querySelector("#next-btn").onclick=()=>{e=o,i()}};return i(),a}function R(e,t){return`
    ...
    `}function tt(){return _e()}function at(){return`
    ...
    `}function ot(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${it()}
    `,e}function nt(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",st)}async function st(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=rt(i);if(o.length>0){ct(o);return}await dt(t,i)}function rt(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?lt(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function lt(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function ct(e){v(e[0],"error")}function v(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function dt(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(v("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):v("Hubo un problema al enviar el mensaje.","error")}catch{v("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function mt(){const e=ot();return setTimeout(()=>{nt()},0),e}const ut={home:{page:ie,layout:"default"},quienesSomos:{page:he,layout:"full"},equipment:{page:Ce,layout:"default"},FormacionAcademica:{page:De,layout:"default"},noticias:{page:Ge,layout:"full"},publicaciones:{page:Ke,layout:"default"},proyectos:{page:tt,layout:"default"},lineas:{page:Xe,layout:"default"},contacto:{page:mt,layout:"default"}};function k(e){window.location.hash=`/${e}`}function pt(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";xt(t)};window.addEventListener("hashchange",e),e()}function xt(e){const t=document.querySelector("main"),a=ut[e];t&&(t.innerHTML="",a&&(Me(a.layout),t.appendChild(a.page())))}function gt(e,t){P(e,k),pt();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(s){s.matches&&!i&&(D(e),i=!0)}a.addEventListener("change",o),o(a),D(e);const n=t.querySelector('[data-action ="open-menu"]');Y(n,e),K(e)}const G=document.querySelector("#header");G.innerHTML=H();const J=document.querySelector("#navBar");J.innerHTML=V();const ft=document.querySelector("#footer");ft.innerHTML=Q();gt(J,G);
