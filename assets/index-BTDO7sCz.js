const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./authGuard-CEzcrBkK.js","./authService-CgfoSPdf.js","./firebase-BzP43VG7.js","./login-BtABpxCq.js","./LaboratorioKernel-VOt58Y8K.js","./AsistentePruebas-9ENxU2k9.js","./metadatosFichasMetodologicas-BbzfSE5K.js","./CalculadoraDosGrupos-D4Iouvf1.js","./jstat-DiDocX-r.js","./exportacionesCalculadoras-DArupM7z.js","./CalculadoraDosMuestrasRelacionadas-CLmKbmMN.js","./estadisticaDosMuestrasRelacionadas-C0D8qKdR.js","./CalculadoraTresOMasGrupos-DyIl_4DB.js","./CalculadoraTresOMasMedicionesRelacionadas-CAClNdSZ.js","./CalculadoraRelacionVariables-CE2hEK09.js","./CalculadoraAsociacionCategorica-CwQkWUi6.js","./CalculadoraEstadisticaDescriptiva-DmKuTGyv.js","./CalculadoraFiabilidadCuestionarios-pb8qIuXi.js","./CalculadoraEvaluacionEducativa-DNPYJGwt.js","./CalculadoraTamanoMuestraPotencia-COosHYIX.js","./BibliotecaMetodologica-BzzsJJUi.js","./CalculadoraRegresionCompleta-Bnn8O0X-.js","./CalculadoraRegresionLogistica-VIvX69aA.js","./CalculadoraRegresionConteo-D4IHm9Of.js"])))=>i.map(i=>d[i]);
(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const $e=""+new URL("ElKernel-BvHOWfRq.webp",import.meta.url).href;function rt(){return`
    ...
    `}function lt(){return`
        ...
        <ul class="relative z-[230] flex min-h-full w-full flex-col gap-1 p-3 text-black lg:min-h-0 lg:flex-row lg:items-center lg:justify-end lg:gap-0.5 lg:p-0 xl:gap-1">
            ...
            ${ga({id:"submenu-nuestro-trabajo",etiqueta:"Investigación",icono:"bx-briefcase-alt-2",elementos:[ue("lineas","Líneas de investigación","bx-git-branch"),ue("proyectos","Proyectos","bx-bulb"),ue("publicaciones","Publicaciones","bx-book-open"),ue("herramientas","Herramientas","bx-wrench")]})}

            ${ga({id:"submenu-nosotros",etiqueta:"Nosotros",icono:"bx-group",elementos:[ue("quienesSomos","Quiénes somos","bx-info-circle"),ue("equipment","Equipo","bx-group")]})}
    ...
    `});function re(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ot(e,a){const t=a===0;return`
        <button
            type="button"
            role="tab"
    ...
    `;const t=[...a.querySelectorAll("[data-universidad-imagen-capa]")],i=a.querySelector("[data-universidad-sigla]"),o=a.querySelector("[data-universidad-nombre]"),n=a.querySelector("[data-universidad-descripcion]"),s=a.querySelector("[data-universidad-enlace]"),l=a.querySelector("[data-universidad-contador]"),d=a.querySelector("[data-universidad-estado]"),b=a.querySelector("[data-universidad-escenario]"),u=a.querySelector("[data-universidad-progreso]"),p=[...a.querySelectorAll("[data-universidad-control]")],v=a.querySelector("[data-action='universidad-anterior']"),y=a.querySelector("[data-action='universidad-siguiente']"),w=a.querySelector("[data-action='pausar-rotacion']"),k=a.querySelector("[data-universidad-icono-pausa]"),h=a.querySelector("[data-universidad-icono-reproducir]"),g=a.querySelector("[data-universidad-texto-rotacion]"),A=window.matchMedia("(prefers-reduced-motion: reduce)"),C=new AbortController,r={signal:C.signal};let m=0,c=0,x=0,f=null,E=null,I=null,M=!1,P=!1,z=!1,R=!1,Y=!1,U=!A.matches,K=typeof window.IntersectionObserver!="function";function de(j){return(j%J.length+J.length)%J.length}function ot(j){const S=t[c];if(S?.dataset.institucionId===j.id)return;const H=c===0?1:0,T=t[H],fe=++x;let ma=!1;function ba(){ma||fe!==x||!T.naturalWidth||(ma=!0,S.alt="",T.alt=j.alt,T.classList.remove("opacity-0"),T.classList.add("opacity-100"),S.classList.remove("opacity-100"),S.classList.add("opacity-0"),c=H)}T.onload=ba,T.onerror=()=>{fe===x&&T.removeAttribute("src")},T.alt="",T.width=j.ancho,T.height=j.alto,T.style.objectPosition=j.posicion,T.dataset.institucionId=j.id,T.src=j.imagen,T.complete&&T.naturalWidth&&window.requestAnimationFrame(ba)}function da(){E!==null&&window.clearTimeout(E),K&&(E=window.setTimeout(()=>{const j=J[de(m+1)],S=new Image;S.decoding="async",S.src=j.imagen,E=null},700))}function Qe(j=!1){const S=J[m];ot(S),i.textContent=S.sigla,o.textContent=S.nombre,n.textContent=S.descripcion,s.href=S.enlace,s.setAttribute("aria-label",`Visitar el sitio institucional de ${S.sigla}`),l.textContent=`${String(m+1).padStart(2,"0")} / ${String(J.length).padStart(2,"0")}`,b.setAttribute("aria-labelledby",`pestana-institucion-${S.id}`),u.style.width=`${(m+1)/J.length*100}%`,p.forEach((H,T)=>{const fe=T===m;H.setAttribute("aria-selected",String(fe)),H.tabIndex=fe?0:-1}),j&&(d.textContent=`${S.sigla}: ${S.nombre}`),da()}function Z(){f!==null&&(window.clearInterval(f),f=null)}function st(){return U&&K&&!document.hidden&&!P&&!z&&!R&&a.isConnected}function G(){Z(),st()&&(f=window.setInterval(()=>{m=de(m+1),Qe(!1)},Rt))}function Xe(){const j=!U;w.setAttribute("aria-pressed",String(j)),w.setAttribute("aria-label",j?"Reanudar la rotación automática":"Pausar la rotación automática"),k.classList.toggle("hidden",j),h.classList.toggle("hidden",!j),g.textContent=j?"Reanudar rotación":"Pausar rotación"}function ae(j,S=!0,H=!1){m=de(j),Qe(S),H&&p[m]?.focus(),G()}v?.addEventListener("click",()=>ae(m-1),r),y?.addEventListener("click",()=>ae(m+1),r),w?.addEventListener("click",()=>{Y=!0,U=!U,Xe(),U?(d.textContent="Rotación automática reanudada.",G()):(d.textContent="Rotación automática pausada.",Z())},r),p.forEach(j=>{j.addEventListener("click",()=>ae(Number(j.dataset.indice)),r),j.addEventListener("keydown",S=>{S.key==="ArrowLeft"?(S.preventDefault(),ae(m-1,!0,!0)):S.key==="ArrowRight"?(S.preventDefault(),ae(m+1,!0,!0)):S.key==="Home"?(S.preventDefault(),ae(0,!0,!0)):S.key==="End"&&(S.preventDefault(),ae(J.length-1,!0,!0))},r)}),a.addEventListener("mouseenter",()=>{P=!0,Z()},r),a.addEventListener("mouseleave",()=>{P=!1,G()},r),a.addEventListener("focusin",()=>{z=!0,Z()},r),a.addEventListener("focusout",j=>{z=a.contains(j.relatedTarget),z||G()},r),b?.addEventListener("touchstart",j=>{I=j.changedTouches[0]?.clientX??null,R=!0,Z()},{...r,passive:!0}),b?.addEventListener("touchend",j=>{const S=j.changedTouches[0]?.clientX??null;if(R=!1,I!==null&&S!==null){const H=S-I;Math.abs(H)>45?ae(m+(H<0?1:-1)):G()}I=null},{...r,passive:!0}),b?.addEventListener("touchcancel",()=>{I=null,R=!1,G()},r),document.addEventListener("visibilitychange",()=>{document.hidden?Z():G()},r),A.addEventListener("change",()=>{Y||(U=!A.matches,Xe()),U?G():Z()},r);const ua=typeof window.IntersectionObserver=="function"?new IntersectionObserver(j=>{K=j.some(S=>S.isIntersecting&&S.intersectionRatio>=.15),K?(da(),G()):Z()},{threshold:[0,.15,.5]}):null;ua?.observe(a);const pa=new MutationObserver(()=>{if(a.isConnected){M||(M=!0,G());return}M&&(Z(),E!==null&&window.clearTimeout(E),C.abort(),ua?.disconnect(),pa.disconnect())});return pa.observe(document.body,{childList:!0,subtree:!0}),Qe(!1),Xe(),a}function je(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Le(e,a,t=""){return`
        <div class="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-center"${t?` title="${je(t)}" aria-label="${je(`${e} ${a}. ${t}.`)}"`:""}>
            <p class="text-2xl font-black text-white md:text-3xl">${je(e)}</p>
            <p class="mt-1 text-xs font-semibold leading-tight text-slate-300">${je(a)}</p>
        </div>
        ...
        <div class="grid grid-cols-1 border-t border-slate-200 xl:grid-cols-[minmax(0,1.45fr)_minmax(19rem,0.55fr)]">
            ...
            <aside class="bg-[#071820] p-5 text-white md:p-7" aria-label="Indicadores y principios de confianza">
                ...
                <div class="mt-4 grid grid-cols-2 gap-3">
                    ${Le(e,"Integrantes","Miembros nacionales e internacionales del Grupo El Kernel")}
                    ${Le(a,"Áreas de servicio")}
                    ${Le(t,"Líneas de investigación")}
                    ${Le(i,"Artículos científicos acumulados","Producción de los 9 integrantes a lo largo de sus trayectorias académicas")}
                </div>
    ...
    `}function Vt(){const e=document.createElement("section");e.id="servicios-portada",e.className="mx-4 overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-50 shadow-lg sm:mx-6 lg:mx-8 xl:mx-10",e.setAttribute("aria-labelledby","titulo-servicios-portada");const a=Ut.map(t=>ne.find(i=>i.numero===t)).filter(Boolean);return e.innerHTML=`
    ...
    `,e}function X(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Qt(e){const a=String(e?.DOI||e?.doi||"").trim().toLowerCase();return a||[e?.year||"",e?.title||e?.journal||e?.tile||"",e?.contenido||e?.articleTitle||""].join("-").trim().toLowerCase()}function Xt(){const e=new Set;return Q.forEach(a=>{(a.publicaciones||[]).forEach(t=>{const i=Qt(t);i&&e.add(i)})}),e.size}function pe(e,a,t){return`
    ...
    `}function ai(){const e=Xt(),a=document.createElement("section");return a.className="w-full space-y-10 bg-white pb-10 font-sans",a.innerHTML=`
        ...
        <section class="mx-4 grid grid-cols-1 gap-6 sm:mx-6 lg:mx-8 xl:mx-10 2xl:grid-cols-[1.1fr_0.9fr]" aria-label="Proyectos, equipo y producción científica">
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">${ge.slice(0,2).map(Yt).join("")}</div>
            </div>
    ...
    `,a.querySelector("[data-franja-institucional]")?.replaceWith(Tt({integrantes:ie.length,servicios:ne.length,lineas:W.length,publicaciones:e})),a.querySelector("[data-resumen-servicios]")?.replaceWith(Vt()),a.querySelector("[data-proceso-aplicaciones]")?.replaceWith(Jt()),a}const ti="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function ii(){try{const e=await fetch(ti,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}const oi=["w-full","min-w-0","max-w-none","max-w-7xl","tabletBig:max-w-6xl","xl:max-w-7xl","2xl:max-w-500","3xl:max-w-none","m-auto","m-0","p-0","p-2","mt-0","mt-8","md:mt-12","pt-0"],si=["max-w-7xl","tabletBig:max-w-6xl","xl:max-w-7xl","2xl:max-w-500","3xl:max-w-none"];function Ka(e="default"){const a=document.getElementById("main");if(a){if(a.classList.remove(...oi),a.classList.add("w-full","min-w-0"),e==="full"){a.classList.add("max-w-none","m-0","p-0","mt-0","pt-0");return}a.classList.add(...si,"p-2","mt-8","md:mt-12"),e==="left"?a.classList.add("m-0"):a.classList.add("m-auto")}}function ze(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function ri(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function ni(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const s=await ii();a.textContent=ze(s.total),t.textContent=ze(s.hoy),i.textContent=ze(s.ultimos7Dias),o.textContent=ze(s.ultimos30Dias);const l=ri(s.actualizadoEn);n.textContent=l?`Actualizado: ${l}`:"Estadísticas temporalmente no disponibles"}catch(s){console.error("Error al mostrar las estadísticas en la portada:",s),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function li(){Ka("full");const e=ai();return ni(e),e}function ci(){return li()}const di=""+new URL("QuienesSomos-CIhVjMhZ.webp",import.meta.url).href,Ie=Object.freeze({integrantes:9,articulosAcumulados:572,articulosAcumuladosTexto:"572+",etiquetaArticulos:"Artículos científicos acumulados",descripcionArticulos:"Producción de los 9 integrantes a lo largo de sus trayectorias académicas",notaArticulos:"Cota mínima basada en artículos de revista declarados en perfiles institucionales y registros científicos verificados. La suma representa la producción individual acumulada; las coautorías compartidas pueden formar parte de más de una trayectoria."});function ui(){return`
        <section 
            role="banner" 
                ...
                <div class="max-w-4xl text-white">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl">
                        <div class="bg-white/10 border border-white/20 backdrop-blur-sm rounded-2xl p-4">
                            <p class="text-3xl font-black text-white">${Ie.integrantes}</p>
                        ...
                        <div
                            ...
                            title="${Ie.descripcionArticulos}"
                        >
                            <p class="text-3xl font-black text-white">${Ie.articulosAcumuladosTexto}</p>
                            <p class="text-white/75 text-xs md:text-sm font-semibold">
                                ${Ie.etiquetaArticulos}
                            </p>
                        </div>
  ...
  `}function Ci(){const e=document.createElement("section");return e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12",e.innerHTML=`
    ...
    `,a}function Ii(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const y=o();return Math.max(ie.length-y,0)},s=()=>{const y=n();e>y&&(e=0),e<0&&(e=y)},l=()=>{const y=n();e>=y?e=0:e++,v()},d=()=>{const y=n();e<=0?e=y:e--,v()},b=()=>{u(),ie.length>o()&&(a=setInterval(l,4500))},u=()=>{a&&(clearInterval(a),a=null)},p=()=>{const y=o(),w=Math.max(ie.length-y+1,1);return Array.from({length:w}).map((k,h)=>`
        ...
        `;const k=i.querySelector("#cards-wrapper");w.forEach(A=>{k.appendChild(zi(A))});const h=i.querySelector("#prev-btn"),g=i.querySelector("#next-btn");h&&(h.onclick=()=>{d(),b()}),g&&(g.onclick=()=>{l(),b()}),i.querySelectorAll("[data-dot-index]").forEach(A=>{A.onclick=()=>{e=parseInt(A.dataset.dotIndex),v(),b()}})};return i.addEventListener("mouseenter",u),i.addEventListener("mouseleave",b),document.addEventListener("visibilitychange",()=>{document.hidden?u():b()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,v(),b()},150)}),v(),b(),i}function Di(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&Je(t.dataset.route)})}function Ga(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `;const t=document.createElement("div");t.className="mt-8 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm",t.appendChild(Ga());const i=Ii();return i.className="w-full py-8 flex flex-col gap-8 items-center font-sans",a.appendChild(t),a.appendChild(i),e.appendChild(a),e}function Ri(){return Pi()}function _(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ha(e){return e.formacion?.length||0}function Ja(e){return e.experiencia?.length||0}function Oi(e,a=!1){const t=Ha(e),i=Ja(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
...
Gracias.`);return`
    ...
    `}function lo(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function co(){const e=document.createElement("section");e.className="w-full bg-slate-100 font-sans";const a=new Set([Fe.id,Ue.id]),t=lo([Fe,Ue,...Xa.filter(o=>!a.has(o.id))]),i=t.find(o=>o.featured)||t[0];return e.innerHTML=`
        ...
        ${ro(t)}
        ${no()}
    `,e}function me(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function uo(e){return e==="mmehb-2026"?na():e==="mescyt-cic-2026"?la():""}function po({title:e,date:a,category:t,visualType:i,content:o={paragraphs:[],list:[]},articleURL:n}){const s=(o.paragraphs||[]).map(b=>`<p>${me(b)}</p>`).join(""),l=(o.list||[]).length?`<ul class="space-y-3">${o.list.map(b=>`<li class="flex items-start gap-3"><span class="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-[#0b5963]"></span><span>${me(b)}</span></li>`).join("")}</ul>`:"",d=uo(i);return`
            ...
            <div class="mx-auto max-w-[1600px]">
                ...
                <div class="mt-8 grid min-h-[720px] grid-cols-1 gap-6 rounded-[2rem] border border-slate-200 bg-white p-4 shadow-xl md:grid-cols-[0.78fr_1.5fr] md:p-6">
                    <aside class="max-h-[430px] overflow-y-auto rounded-3xl border border-slate-200 bg-slate-50 p-4 custom-scrollbar md:max-h-none">
                        ...
                        <div class="mt-5 flex flex-col gap-4">${Q.map(f=>wo(f,Number(f.id)===Number(e))).join("")}</div>
                    </aside>
    ...
    `}function Lo(){const e=new Set(W.map(i=>i.categoria)),a=W.filter(i=>i.proyectosAsociados?.length>0).length,t=W.filter(i=>i.publicacionesClave?.length>0).length;return{total:W.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function zo(){let e=W[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Co(e),o=Lo();a.innerHTML=`
        ...
        <div class="p-6 md:p-9">
    ...
    </article>`}function Oo(){let e=ge[0]?.id||1;const a=document.createElement("section");a.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";const t=()=>{const i=ge.find(o=>o.id===e)||ge[0];a.innerHTML=`<div class="mx-auto max-w-[1600px]">
            ...
            <div class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[0.72fr_1.5fr]"><aside class="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-lg"><p class="text-xs font-black uppercase tracking-[0.18em] text-[#805615]">Portafolio</p><h2 class="mt-1 text-2xl font-black text-slate-950">Seleccione una iniciativa</h2><div class="mt-5 space-y-4">${ge.map(o=>Po(o,o.id===e)).join("")}</div></aside><div>${Ro(i)}</div></div>
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
        ...
        `}return l.addEventListener("click",()=>{k("xmera")}),d.addEventListener("click",()=>{k("banner")}),k("xmera"),e}function Zo(){return Yo()}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Za(e){return String(e??"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim()}function es(e,a=!1){return`
        <button
            type="button"
    ...
    `}function cs(){const e=document.createElement("section");e.id="catalogo-servicios",e.className="relative overflow-hidden rounded-[2rem] border border-sky-100 bg-gradient-to-br from-slate-50 via-white to-sky-50 px-5 py-9 shadow-lg md:px-8 md:py-12 xl:px-10",e.setAttribute("aria-labelledby","titulo-catalogo-servicios"),e.innerHTML=`
        ...
        <div class="relative z-10 space-y-10">
            ...
            <section class="grid grid-cols-2 gap-3 md:grid-cols-4" aria-label="Resumen del catálogo">
                ${[[ne.length,"áreas de servicio"],[ia.length-1,"bloques temáticos"],[ha.length,"paquetes sugeridos"],[va.length,"etapas de trabajo"]].map(([u,p])=>`
