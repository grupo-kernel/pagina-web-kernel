const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./authGuard-CEzcrBkK.js","./authService-CgfoSPdf.js","./firebase-BzP43VG7.js","./login-BtABpxCq.js","./LaboratorioKernel-BTRu55uv.js","./AsistentePruebas-BOi_3rhz.js","./metadatosFichasMetodologicas-BbzfSE5K.js","./CalculadoraDosGrupos-D89iYWJ6.js","./jstat-DiDocX-r.js","./exportacionesCalculadoras-HR95mCKS.js","./CalculadoraDosMuestrasRelacionadas-Hp6anDRf.js","./estadisticaDosMuestrasRelacionadas-BqGxjkhn.js","./CalculadoraTresOMasGrupos-D6Hmbqiv.js","./CalculadoraTresOMasMedicionesRelacionadas-Dw2E-SJU.js","./CalculadoraRelacionVariables-Bjiv_HBx.js","./CalculadoraAsociacionCategorica-Cyy2NU6t.js","./CalculadoraEstadisticaDescriptiva-H47xodIs.js","./CalculadoraFiabilidadCuestionarios-RXCJPQgL.js","./CalculadoraEvaluacionEducativa-cvXPNNzC.js","./CalculadoraTamanoMuestraPotencia-gf1DqFyl.js","./BibliotecaMetodologica-BzzsJJUi.js","./CalculadoraRegresionCompleta-CxbLvmGe.js","./CalculadoraRegresionLogistica-DliyTC4D.js","./CalculadoraRegresionConteo-BuCyd_Nj.js","./CalculadoraUnaMuestra-DOjZzXFw.js","./CalculadoraProporcionesRelacionadas-CkMdlkc4.js"])))=>i.map(i=>d[i]);
(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();const Le=""+new URL("ElKernel-BvHOWfRq.webp",import.meta.url).href;function $t(){return`
        <div class="flex w-full items-center justify-between gap-4">
            <a href="#/home" class="flex min-w-0 items-center gap-3 rounded-xl focus:outline-none focus-visible:ring-4 focus-visible:ring-emerald-100" aria-label="Ir a la portada de El Kernel">
                <img class="h-12 w-12 shrink-0 rounded-xl object-contain md:h-14 md:w-14" src="${Le}" alt="Logo del Grupo de Investigación El Kernel" title="El Kernel" />
                <span class="min-w-0">
    ...
    `}function Ia({id:e,etiqueta:a,icono:t,elementos:i}){return`
    ...
    `}function jt(){return`
        ...
        <ul class="relative z-[230] flex min-h-full w-full flex-col gap-1 p-3 text-black lg:min-h-0 lg:flex-row lg:items-center lg:justify-end lg:gap-0.5 lg:p-0 xl:gap-1">
            ${we("home","Portada","bx-home")}
            ${we("servicios","Servicios","bx-grid-alt")}
            ${we("laboratorioKernel","Laboratorio","bx-bar-chart-alt-2")}

            ${Ia({id:"submenu-nuestro-trabajo",etiqueta:"Investigación",icono:"bx-briefcase-alt-2",elementos:[ge("lineas","Líneas de investigación","bx-git-branch"),ge("proyectos","Proyectos","bx-bulb"),ge("publicaciones","Publicaciones","bx-book-open"),ge("herramientas","Herramientas","bx-wrench")]})}

            ${Ia({id:"submenu-nosotros",etiqueta:"Nosotros",icono:"bx-group",elementos:[ge("quienesSomos","Quiénes somos","bx-info-circle"),ge("equipment","Equipo","bx-group")]})}

            ${we("noticias","Noticias","bx-news","lg:hidden 2xl:block")}
            ${we("contacto","Contacto","bx-envelope","lg:hidden xl:block")}
            ${Mt()}
        </ul>
    `}function zt(){const e=new Date().getFullYear();return`
            ...
            <div class="mx-auto grid max-w-[1600px] grid-cols-1 gap-9 px-5 py-10 md:px-8 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] lg:px-10">
                <section class="text-white" aria-labelledby="titulo-footer-kernel">
                    <div class="flex items-center gap-4">
                        <img class="h-16 w-16 rounded-2xl bg-white p-1.5 object-contain shadow-lg" src="${Le}" alt="Logo del Grupo de Investigación El Kernel" loading="lazy" />
                        <div>
    ...
    `});function z(e,a="text-2xl"){const t=Ta[e]||Ta["bx-grid-alt"];return`
        <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
            fill="none"
    ...
    `}const Zt=""+new URL("isfodosu-campus-Dxbx_r-n.webp",import.meta.url).href,ei=""+new URL("uasd-campus-B6v1rNpv.webp",import.meta.url).href,ai=""+new URL("unapec-campus-DqZO-eEo.webp",import.meta.url).href,ti=5e3,X=Object.freeze([Object.freeze({id:"isfodosu",sigla:"ISFODOSU",nombre:"Instituto Superior de Formación Docente Salomé Ureña",descripcion:"Formación docente, educación matemática e investigación educativa.",imagen:Zt,enlace:"https://www.isfodosu.edu.do/",alt:"Fachada del Instituto Superior de Formación Docente Salomé Ureña",ancho:1260,alto:790,posicion:"50% 46%"}),Object.freeze({id:"uasd",sigla:"UASD",nombre:"Universidad Autónoma de Santo Domingo",descripcion:"Ciencias básicas, optimización, matemática aplicada y colaboración interdisciplinaria.",imagen:ei,enlace:"https://uasd.edu.do/",alt:"Edificio y estatua en el campus de la Universidad Autónoma de Santo Domingo",ancho:1758,alto:1284,posicion:"50% 42%"}),Object.freeze({id:"unapec",sigla:"UNAPEC",nombre:"Universidad APEC",descripcion:"Matemática aplicada, computación científica, docencia y proyectos de investigación.",imagen:ai,enlace:"https://unapec.edu.do/",alt:"Entrada principal del campus de Universidad APEC",ancho:608,alto:342,posicion:"50% 50%"})]),Ae=Object.freeze({anterior:`
    ...
    `});function le(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ii(e,a){const t=a===0;return`
        <button
            type="button"
            role="tab"
            ...
            <div class="flex min-h-full flex-col p-5 sm:p-6 lg:p-8">
                ...
                <div class="mt-8 border-t border-slate-200 pt-5">
                    ...
                    <div class="mt-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        >
                            <span data-universidad-icono-pausa>${Ae.pausa}</span>
                            <span data-universidad-icono-reproducir class="hidden">${Ae.reproducir}</span>
    ...
    `;const t=[...a.querySelectorAll("[data-universidad-imagen-capa]")],i=a.querySelector("[data-universidad-sigla]"),o=a.querySelector("[data-universidad-nombre]"),r=a.querySelector("[data-universidad-descripcion]"),s=a.querySelector("[data-universidad-enlace]"),n=a.querySelector("[data-universidad-contador]"),d=a.querySelector("[data-universidad-estado]"),b=a.querySelector("[data-universidad-escenario]"),p=a.querySelector("[data-universidad-progreso]"),u=[...a.querySelectorAll("[data-universidad-control]")],x=a.querySelector("[data-action='universidad-anterior']"),h=a.querySelector("[data-action='universidad-siguiente']"),w=a.querySelector("[data-action='pausar-rotacion']"),A=a.querySelector("[data-universidad-icono-pausa]"),y=a.querySelector("[data-universidad-icono-reproducir]"),g=a.querySelector("[data-universidad-texto-rotacion]"),E=window.matchMedia("(prefers-reduced-motion: reduce)"),C=new AbortController,l={signal:C.signal};let m=0,c=0,f=0,v=null,k=null,D=null,M=!1,R=!1,P=!1,T=!1,Z=!1,B=!E.matches,H=typeof window.IntersectionObserver!="function";function be(j){return(j%X.length+X.length)%X.length}function Ct(j){const S=t[c];if(S?.dataset.institucionId===j.id)return;const Q=c===0?1:0,F=t[Q],ye=++f;let za=!1;function La(){za||ye!==f||!F.naturalWidth||(za=!0,S.alt="",F.alt=j.alt,F.classList.remove("opacity-0"),F.classList.add("opacity-100"),S.classList.remove("opacity-100"),S.classList.add("opacity-0"),c=Q)}F.onload=La,F.onerror=()=>{ye===f&&F.removeAttribute("src")},F.alt="",F.width=j.ancho,F.height=j.alto,F.style.objectPosition=j.posicion,F.dataset.institucionId=j.id,F.src=j.imagen,F.complete&&F.naturalWidth&&window.requestAnimationFrame(La)}function $a(){k!==null&&window.clearTimeout(k),H&&(k=window.setTimeout(()=>{const j=X[be(m+1)],S=new Image;S.decoding="async",S.src=j.imagen,k=null},700))}function oa(j=!1){const S=X[m];Ct(S),i.textContent=S.sigla,o.textContent=S.nombre,r.textContent=S.descripcion,s.href=S.enlace,s.setAttribute("aria-label",`Visitar el sitio institucional de ${S.sigla}`),n.textContent=`${String(m+1).padStart(2,"0")} / ${String(X.length).padStart(2,"0")}`,b.setAttribute("aria-labelledby",`pestana-institucion-${S.id}`),p.style.width=`${(m+1)/X.length*100}%`,u.forEach((Q,F)=>{const ye=F===m;Q.setAttribute("aria-selected",String(ye)),Q.tabIndex=ye?0:-1}),j&&(d.textContent=`${S.sigla}: ${S.nombre}`),$a()}function ee(){v!==null&&(window.clearInterval(v),v=null)}function St(){return B&&H&&!document.hidden&&!R&&!P&&!T&&a.isConnected}function J(){ee(),St()&&(v=window.setInterval(()=>{m=be(m+1),oa(!1)},ti))}function sa(){const j=!B;w.setAttribute("aria-pressed",String(j)),w.setAttribute("aria-label",j?"Reanudar la rotación automática":"Pausar la rotación automática"),A.classList.toggle("hidden",j),y.classList.toggle("hidden",!j),g.textContent=j?"Reanudar rotación":"Pausar rotación"}function te(j,S=!0,Q=!1){m=be(j),oa(S),Q&&u[m]?.focus(),J()}x?.addEventListener("click",()=>te(m-1),l),h?.addEventListener("click",()=>te(m+1),l),w?.addEventListener("click",()=>{Z=!0,B=!B,sa(),B?(d.textContent="Rotación automática reanudada.",J()):(d.textContent="Rotación automática pausada.",ee())},l),u.forEach(j=>{j.addEventListener("click",()=>te(Number(j.dataset.indice)),l),j.addEventListener("keydown",S=>{S.key==="ArrowLeft"?(S.preventDefault(),te(m-1,!0,!0)):S.key==="ArrowRight"?(S.preventDefault(),te(m+1,!0,!0)):S.key==="Home"?(S.preventDefault(),te(0,!0,!0)):S.key==="End"&&(S.preventDefault(),te(X.length-1,!0,!0))},l)}),a.addEventListener("mouseenter",()=>{R=!0,ee()},l),a.addEventListener("mouseleave",()=>{R=!1,J()},l),a.addEventListener("focusin",()=>{P=!0,ee()},l),a.addEventListener("focusout",j=>{P=a.contains(j.relatedTarget),P||J()},l),b?.addEventListener("touchstart",j=>{D=j.changedTouches[0]?.clientX??null,T=!0,ee()},{...l,passive:!0}),b?.addEventListener("touchend",j=>{const S=j.changedTouches[0]?.clientX??null;if(T=!1,D!==null&&S!==null){const Q=S-D;Math.abs(Q)>45?te(m+(Q<0?1:-1)):J()}D=null},{...l,passive:!0}),b?.addEventListener("touchcancel",()=>{D=null,T=!1,J()},l),document.addEventListener("visibilitychange",()=>{document.hidden?ee():J()},l),E.addEventListener("change",()=>{Z||(B=!E.matches,sa()),B?J():ee()},l);const Ma=typeof window.IntersectionObserver=="function"?new IntersectionObserver(j=>{H=j.some(S=>S.isIntersecting&&S.intersectionRatio>=.15),H?($a(),J()):ee()},{threshold:[0,.15,.5]}):null;Ma?.observe(a);const ja=new MutationObserver(()=>{if(a.isConnected){M||(M=!0,J());return}M&&(ee(),k!==null&&window.clearTimeout(k),C.abort(),Ma?.disconnect(),ja.disconnect())});return ja.observe(document.body,{childList:!0,subtree:!0}),oa(!1),sa(),a}function Ie(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Pe(e,a,t=""){return`
    ...
    `}function si({integrantes:e,servicios:a,lineas:t,publicaciones:i}){const o=document.createElement("section");return o.className="mx-4 overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-lg sm:mx-6 lg:mx-8 xl:mx-10",o.setAttribute("aria-labelledby","titulo-confianza-portada"),o.innerHTML=`
    ...
    `,o.querySelector("[data-carrusel-institucional]")?.replaceWith(oi()),o}const ri="kernel-services-filter",ni=Object.freeze([Object.freeze({titulo:"Investigación y producción científica",descripcion:"Proyectos de I+D+i, tesis, publicación, edición y comunicación científica.",icono:"bx-book-open",categoria:"investigacion"}),Object.freeze({titulo:"Estadística y metodología",descripcion:"Diseño de estudios, muestreo, instrumentos, análisis e informes reproducibles.",icono:"bx-bar-chart-alt-2",categoria:"matematica-datos"}),Object.freeze({titulo:"Matemática computacional y optimización",descripcion:"Modelización, simulación, métodos numéricos, algoritmos y decisiones bajo restricciones.",icono:"bx-atom",categoria:"matematica-datos"}),Object.freeze({titulo:"Ciencia de datos, IA y software científico",descripcion:"Modelos predictivos, tableros, automatización, prototipos y transferencia tecnológica.",icono:"bx-grid-alt",categoria:"tecnologia-transferencia"}),Object.freeze({titulo:"Educación, posgrado y diseño curricular",descripcion:"Maestrías, programas académicos, sílabos, formación docente, evaluación y calidad.",icono:"bx-group",categoria:"educacion"}),Object.freeze({titulo:"Riesgo, finanzas y soluciones sectoriales",descripcion:"Actuaría, econometría, políticas públicas, logística, industria y apoyo a decisiones.",icono:"bx-trending-up",categoria:"riesgo-finanzas"})]),li=Object.freeze([1,7,12,15]);function he(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ci(e){const a=ba.find(t=>t.id===e.categoria);return`
        ...
        >
            ...
            <h3 class="mt-5 text-xl font-black leading-tight text-slate-950">${he(e.titulo)}</h3>
            <p class="mt-3 flex-1 text-sm leading-relaxed text-slate-600 md:text-base">${he(e.descripcion)}</p>
            <span class="mt-5 inline-flex items-center gap-2 text-sm font-black text-[#0f5b5d]">
                Explorar ${he(a?.rango||"servicios")}
    ...
    `}function di(e){return`
        <article class="flex h-full flex-col rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm md:p-6">
            ...
            <h3 class="mt-5 text-xl font-black leading-tight text-white">${he(e.tituloCorto)}</h3>
            <p class="mt-3 flex-1 text-sm leading-relaxed text-slate-300">${he(e.resumen)}</p>
    ...
    `}function ui(){const e=document.createElement("section");e.id="servicios-portada",e.className="mx-4 overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-50 shadow-lg sm:mx-6 lg:mx-8 xl:mx-10",e.setAttribute("aria-labelledby","titulo-servicios-portada");const a=li.map(t=>ce.find(i=>i.numero===t)).filter(Boolean);return e.innerHTML=`
    ...
    `}function gi(){const e=document.createElement("section");return e.className="mx-4 grid grid-cols-1 gap-6 sm:mx-6 lg:mx-8 xl:mx-10 2xl:grid-cols-[0.72fr_1.28fr]",e.setAttribute("aria-label","Proceso de trabajo y ejemplos de aplicación"),e.innerHTML=`
    ...
    `,e}function W(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function fi(e){const a=String(e?.DOI||e?.doi||"").trim().toLowerCase();return a||[e?.year||"",e?.title||e?.journal||e?.tile||"",e?.contenido||e?.articleTitle||""].join("-").trim().toLowerCase()}function xi(){const e=new Set;return ne.forEach(a=>{(a.publicaciones||[]).forEach(t=>{const i=fi(t);i&&e.add(i)})}),e.size}function fe(e,a,t){return`
    ...
    `}function ki(){const e=xi(),a=document.createElement("section");return a.className="w-full space-y-10 bg-white pb-10 font-sans",a.innerHTML=`
            ...
            <div class="relative z-10 mx-auto grid min-h-[calc(100svh-5rem)] max-w-[1600px] grid-cols-1 gap-10 px-5 py-10 md:px-8 md:py-14 xl:grid-cols-[1.05fr_0.95fr] xl:items-center xl:px-12">
                <div>
                    <div class="flex items-center gap-4">
                        <div class="flex h-20 w-20 shrink-0 items-center justify-center rounded-3xl border border-white/15 bg-white p-2 shadow-xl md:h-24 md:w-24">
                            <img src="${Le}" alt="Logo del Grupo de Investigación El Kernel" class="h-full w-full object-contain" loading="eager" />
                        </div>
                        <div>
                ...
                <aside class="rounded-[2rem] border border-white/15 bg-white/5 p-5 shadow-2xl backdrop-blur-md md:p-7" aria-label="Capacidades principales del grupo">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-3 md:grid-cols-2">
                        ${fe("Investigación y tesis","Formulación, metodología, análisis y producción científica.","bx-book-open")}
                        ${fe("Estadística y datos","Diseño de estudios, instrumentos, modelos y tableros.","bx-bar-chart-alt-2")}
                        ${fe("Matemática computacional","Modelización, métodos numéricos, simulación y optimización.","bx-atom")}
                        ${fe("Educación y currículo","Maestrías, programas de asignatura, evaluación y formación docente.","bx-group")}
                        ${fe("Software científico","Prototipos, calculadoras, automatización y herramientas reproducibles.","bx-grid-alt")}
                        ${fe("Riesgo y decisiones","Actuaría, finanzas, políticas públicas y soluciones sectoriales.","bx-trending-up")}
                    </div>
        ...
        <section class="mx-4 overflow-hidden rounded-[2rem] bg-[#071820] px-6 py-10 text-white shadow-2xl sm:mx-6 md:px-10 md:py-12 lg:mx-8 xl:mx-10" aria-labelledby="titulo-laboratorio-portada">
            <div class="grid grid-cols-1 gap-8 xl:grid-cols-[0.78fr_1.22fr] xl:items-center">
                ...
                <div class="flex flex-wrap gap-3">${yi()}</div>
            </div>
        </section>
        ...
        <section class="mx-4 grid grid-cols-1 gap-6 sm:mx-6 lg:mx-8 xl:mx-10 2xl:grid-cols-[1.1fr_0.9fr]" aria-label="Proyectos, equipo y producción científica">
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">${_e.slice(0,2).map(hi).join("")}</div>
            </div>
    ...
    `}function zi(e){const a=[...e.querySelectorAll("h2")].find(n=>Oe(n.textContent)==="propuestas de investigacion");if(a){const n=a.closest("section");a.textContent="Experiencia en proyectos competitivos";const d=a.parentElement,b=d?.querySelector("p");if(b&&(b.textContent="Trayectoria financiada"),d&&!d.querySelector("[data-resumen-proyectos-portada]")){const u=document.createElement("p");u.dataset.resumenProyectosPortada="true",u.className="mt-3 max-w-3xl text-sm leading-relaxed text-slate-600 md:text-base",u.textContent=`${L.participacionesProyectosAprobados} participaciones registradas en proyectos de I+D+i; se presentan diez proyectos destacados y se contabilizan ${L.proyectosNoMostrados} registros adicionales sin desplegarlos.`,d.appendChild(u)}[...n?.querySelectorAll("article")||[]].slice(0,2).forEach((u,x)=>{const h=$e[x];h&&(u.innerHTML=ji(h))})}const i=[...e.querySelectorAll("h2")].find(n=>Oe(n.textContent).includes("conocimiento academico conectado"))?.closest("aside");if(!i||i.querySelector("[data-metrica-proyectos-aprobados]"))return;const r=[...i.querySelectorAll("p")].find(n=>Oe(n.textContent)==="articulos cientificos acumulados")?.parentElement?.parentElement;if(!r)return;r.className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3";const s=document.createElement("div");s.dataset.metricaProyectosAprobados="true",s.className="rounded-2xl bg-white p-4 ring-1 ring-slate-200",s.innerHTML=`<p class="text-3xl font-black text-[#0f5b5d]">${L.participacionesProyectosAprobadosTexto}</p><p class="mt-1 text-sm font-semibold text-slate-600">${L.etiquetaProyectos}</p>`,s.setAttribute("title",`${L.descripcionProyectos}. ${L.notaProyectos}`),s.setAttribute("aria-label",`${L.participacionesProyectosAprobadosTexto} ${L.etiquetaProyectos}. ${L.descripcionProyectos}.`),r.appendChild(s)}async function Li(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),r=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!r){console.warn("No se encontraron los elementos de Analytics en la portada.");return}r.textContent="Cargando estadísticas…";try{const s=await Ei();a.textContent=De(s.total),t.textContent=De(s.hoy),i.textContent=De(s.ultimos7Dias),o.textContent=De(s.ultimos30Dias);const n=$i(s.actualizadoEn);r.textContent=n?`Actualizado: ${n}`:"Estadísticas temporalmente no disponibles"}catch(s){console.error("Error al mostrar las estadísticas en la portada:",s),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",r.textContent="No fue posible cargar las estadísticas"}}function Ii(){nt("full");const e=ki();return Mi(e),zi(e),Li(e),e}function Pi(){return Ii()}const Di=""+new URL("QuienesSomos-CIhVjMhZ.webp",import.meta.url).href;function qi(){return`
        <section 
            role="banner" 
  ...
  `}function Ji({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${Ki}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function Qi(){const e=document.createElement("section");return e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12",e.innerHTML=`
    ...
    `,e}function Xi(e){e.querySelectorAll("[data-accordion-header]").forEach(t=>{t.addEventListener("click",()=>{const i=t.nextElementSibling,o=t.querySelector("[data-accordion-icon]"),r=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(s=>{s.classList.remove("max-h-[1000px]"),s.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(s=>{s.classList.remove("rotate-180")}),r||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function Wi(e){const a=e.querySelector("[data-description-text]"),t=e.querySelector("[data-description-btn]");if(!a||!t)return;let i=!1;t.addEventListener("click",()=>{i=!i,a.classList.toggle("line-clamp-4",!i),t.textContent=i?"Leer menos":"Leer más"})}function Yi(){const e=Qi();return Xi(e),Wi(e),e}function G(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Zi(e=[]){return!e||e.length===0?`
        ...
        <a href="${G(a.url)}" 
           ...
           title="${G(a.name)}">
            <i class="${G(a.icon)} text-xl"></i>
        </a>
    `).join("")}function eo(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function ao(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=Zi(e.redes||[]),i=eo(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
        ...
        <div class="w-full flex flex-col gap-4 text-left flex-1">
                ...
                <div class="flex flex-wrap gap-2">
                    ${i||`
                                <p class="text-sm text-slate-500 leading-relaxed">
                                    ${G(e.areas||"Área no especificada")}
                                </p>
                              `}
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-sm text-slate-600 leading-relaxed">
                    ${G(e.afilaciones||e.afiliaciones||"No especificadas")}
                </p>
            </div>
    ...
    `,a}function to(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,r=()=>{const h=o();return Math.max(oe.length-h,0)},s=()=>{const h=r();e>h&&(e=0),e<0&&(e=h)},n=()=>{const h=r();e>=h?e=0:e++,x()},d=()=>{const h=r();e<=0?e=h:e--,x()},b=()=>{p(),oe.length>o()&&(a=setInterval(n,4500))},p=()=>{a&&(clearInterval(a),a=null)},u=()=>{const h=o(),w=Math.max(oe.length-h+1,1);return Array.from({length:w}).map((A,y)=>`
        ...
        `).join("")},x=()=>{if(!oe||oe.length===0){i.innerHTML=`
        ...
        `;const A=i.querySelector("#cards-wrapper");w.forEach(E=>{A.appendChild(ao(E))});const y=i.querySelector("#prev-btn"),g=i.querySelector("#next-btn");y&&(y.onclick=()=>{d(),b()}),g&&(g.onclick=()=>{n(),b()}),i.querySelectorAll("[data-dot-index]").forEach(E=>{E.onclick=()=>{e=parseInt(E.dataset.dotIndex),x(),b()}})};return i.addEventListener("mouseenter",p),i.addEventListener("mouseleave",b),document.addEventListener("visibilitychange",()=>{document.hidden?p():b()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,x(),b()},150)}),x(),b(),i}function io(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&ia(t.dataset.route)})}function lt(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,io(a),a}function oo(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";const a=document.createElement("div");a.className="mx-auto max-w-[1600px]",a.innerHTML=`
    ...
    `;const t=document.createElement("div");t.className="mt-8 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm",t.appendChild(lt());const i=to();return i.className="w-full py-8 flex flex-col gap-8 items-center font-sans",a.appendChild(t),a.appendChild(i),e.appendChild(a),e}function so(){return oo()}function K(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ct(e){return e.formacion?.length||0}function dt(e){return e.experiencia?.length||0}function ro(e,a=!1){const t=ct(e),i=dt(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function no(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(n=>`
            ...
            <div class="relative z-10 flex items-center justify-between gap-4 border-b border-white/15 pb-4">
                <div class="flex min-w-0 items-center gap-3">
                    <span class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white p-1.5 shadow-md">
                        <img src="${Le}" alt="Logo del Grupo de Investigación El Kernel" class="h-full w-full object-contain" />
                    </span>
                    <div class="min-w-0">
    ...
    `}const Oa=Object.freeze([ut,go,fo,xo,vo,ho,yo,wo,ko]),Eo=Object.freeze([{nombre:"Miguel A. Leonardo Sepúlveda",tema:"Funciones peso y método Singh–Sharma de quinto orden"},{nombre:"Natanael Ureña Castillo",tema:"Algoritmos híbridos cuasi-Newton con correctores de alto orden"},{nombre:"Antmel Rodríguez Cabral",tema:"Familia generalizada de Traub y método óptimo de cuarto orden"}]);function Co(e){return e?`
    ...
    `}function Ca({compacto:e=!1}={}){return`
    ...
    `}function se(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function $o(e){if(e?.visualType==="mmehb-2026")return Ea();if(e?.visualType==="mescyt-cic-2026")return Ca();const a=e?.imageFit==="cover"?"object-cover":"object-contain";return e?.image?`
            <img
                src="${se(e.image)}"
                ...
                loading="eager"
            />
        `:'<div class="flex h-full w-full items-center justify-center font-bold text-slate-400">Imagen no disponible</div>'}function Mo(e=null){return e?`
    ...
    `:""}function ae(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function jo(e){return e==="mmehb-2026"?Ea({compacto:!0}):e==="mescyt-cic-2026"?Ca({compacto:!0}):null}function zo({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:r,category:s="Noticia",imageFit:n="contain",visualType:d="image"}){const b=n==="cover"?"object-cover":"object-contain",p=jo(d),u=p?"h-[430px] md:h-[500px]":"h-64 md:h-72 2xl:h-96",x=p||(i?`
            <img
                src="${ae(i)}"
                alt="${ae(o||a)}"
    ...
    `}function Io(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function Po(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function Do(){const e=document.createElement("section");e.className="w-full bg-slate-100 font-sans";const a=new Set([Ke.id,Ge.id]),t=Po([Ke,Ge,...pt.filter(o=>!a.has(o.id))]),i=t.find(o=>o.featured)||t[0];return e.innerHTML=`
        ...
        ${Lo(t)}
        ${Io()}
    `,e}function xe(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function qo(e){return e==="mmehb-2026"?Ea():e==="mescyt-cic-2026"?Ca():""}function Ro({title:e,date:a,category:t,visualType:i,content:o={paragraphs:[],list:[]},articleURL:r}){const s=(o.paragraphs||[]).map(b=>`<p>${xe(b)}</p>`).join(""),n=(o.list||[]).length?`<ul class="space-y-3">${o.list.map(b=>`<li class="flex items-start gap-3"><span class="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-[#0b5963]"></span><span>${xe(b)}</span></li>`).join("")}</ul>`:"",d=qo(i);return`
    ...
    `}function Ko(e,a=!1){const t=mt(e),i=e.publicaciones||[],o=Math.max(...i.map(r=>Number(r.year||0)),0)||"";return`
    ...
    `}function Go(e){if(!e)return'<div class="flex h-full items-center justify-center text-white">No hay investigador seleccionado.</div>';const a=mt(e),t=_o(e),i=t.map(d=>Number(d.year)).filter(Boolean),o=[...new Set(t.map(d=>d.q).filter(Boolean))],r=[...new Set(t.map(ra).filter(Boolean))],s=[...new Set(t.map(d=>Na(ra(d)).editorial))],n=t.map(d=>{const b=ra(d),p=bt(d),u=Na(b);return`
            <article class="mb-5 rounded-3xl border border-slate-200 bg-white p-5 text-slate-900 shadow-sm transition hover:-translate-y-0.5 hover:shadow-xl md:p-6">
                ...
                <div class="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
                    ${na("Editorial",u.editorial)}
                    ${na("Identificación",u.issn)}
                    ${na("Modelo de publicación",u.modelo)}
                </div>
                ...
                <div class="mt-5 flex flex-wrap gap-3 border-t border-slate-100 pt-4">
                    ${p?`<a href="${N(Vo(d))}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-xl bg-[#0f5b5d] px-4 py-2 text-sm font-black text-white hover:bg-[#0a4648]">Abrir DOI <span aria-hidden="true">↗</span></a>`:'<span class="text-sm font-bold text-slate-400">DOI no disponible</span>'}
    ...
    `}function Ho(){let e=ne[0]?.id||1,a=!1,t=null,i=null,o="",r=null,s=!1;const n=document.createElement("section");n.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";function d(l){return String(l?.DOI||l?.doi||"").trim().toLowerCase()}function b(l){return String(l?.journal||l?.title||l?.tile||"").trim()}function p(l){return String(l?.articleTitle||l?.contenido||"").trim()}function u(l){return String(l?.q||l?.quartile||"").trim().toUpperCase()}function x(l){return d(l)||[l?.year||"",b(l),p(l)].join("-").trim().toLowerCase()}function h(){const l=new Map;return ne.forEach(m=>(m.publicaciones||[]).forEach(c=>{const f=x(c);f&&!l.has(f)&&l.set(f,c)})),[...l.values()]}function w(){const l=h(),m=l.map(c=>Number(c.year)).filter(Boolean);return{total:l.length,investigadores:L.integrantes,q1:l.filter(c=>u(c)==="Q1").length,periodo:m.length?`${Math.min(...m)}–${Math.max(...m)}`:"—"}}function A(){return ne.find(l=>Number(l.id)===Number(e))||ne[0]}const y=()=>{i?.abort(),i=null,s&&(document.body.style.overflow=o,o="",s=!1)},g=({restaurarFoco:l=!0,renderizar:m=!0}={})=>{const c=r;y(),a=!1,m&&(C(),l&&c!==null&&window.requestAnimationFrame(()=>{n.querySelector(`[data-id="${c}"]`)?.focus()}))},E=()=>{if(!a||window.innerWidth>=768)return;const l=n.querySelector("#detalle-container");if(!l)return;o=document.body.style.overflow,document.body.style.overflow="hidden",s=!0,i=new AbortController;const m={signal:i.signal},c=()=>[...l.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')].filter(f=>f instanceof HTMLElement&&f.getAttribute("aria-hidden")!=="true");document.addEventListener("keydown",f=>{if(f.key==="Escape"){f.preventDefault(),g();return}if(f.key!=="Tab")return;const v=c();if(!v.length){f.preventDefault();return}const k=v[0],D=v.at(-1);f.shiftKey&&document.activeElement===k?(f.preventDefault(),D.focus()):!f.shiftKey&&document.activeElement===D&&(f.preventDefault(),k.focus())},m),window.addEventListener("hashchange",()=>{g({restaurarFoco:!1,renderizar:!1})},m),l.addEventListener("click",f=>{f.target===l&&g()},m),l.querySelector("#close-modal")?.addEventListener("click",()=>g(),m),l.querySelector("#close-modal")?.focus()},C=()=>{y();const l=A(),m=w(),c=window.innerWidth<768&&!a,f=window.innerWidth<768&&a?'role="dialog" aria-modal="true" aria-labelledby="titulo-detalle-publicaciones"':"",v=[[L.articulosAcumuladosTexto,L.etiquetaArticulos],[m.investigadores,"Integrantes del grupo"],[m.total,"Registros únicos con DOI"],[m.periodo,"Periodo registrado"]];n.innerHTML=`
            <div class="mx-auto max-w-[1600px]">
                ...
                <div class="mt-8 grid min-h-[720px] grid-cols-1 gap-6 rounded-[2rem] border border-slate-200 bg-white p-4 shadow-xl md:grid-cols-[0.78fr_1.5fr] md:p-6">
                    <aside class="max-h-[430px] overflow-y-auto rounded-3xl border border-slate-200 bg-slate-50 p-4 custom-scrollbar md:max-h-none">
                        ...
                        <div class="mt-5 flex flex-col gap-4">${ne.map(k=>Ko(k,Number(k.id)===Number(e))).join("")}</div>
                    </aside>

                    <div id="detalle-container" ${f} class="fixed inset-0 z-[350] items-center justify-center bg-slate-950/80 p-4 md:relative md:inset-auto md:z-0 md:flex md:bg-transparent md:p-0 ${c?"hidden":"flex"}">
                        <div class="h-[88%] w-full max-w-lg rounded-[2rem] border border-white/10 bg-[#071820] p-5 shadow-2xl md:h-full md:max-w-none md:p-6">${Go(l)}</div>
                    </div>
                </div>
            </div>
        `,n.querySelectorAll("[data-id]").forEach(k=>{k.onclick=()=>{e=Number(k.dataset.id),window.innerWidth<768&&(a=!0,r=k.dataset.id),C()}}),E()};return window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{window.innerWidth>=768&&(y(),a=!1),C()},120)}),C(),n}function Jo(){return Ho()}function V(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Qo(e){return Y.find(a=>a.id===e)||Y[0]}function la(e=[]){return e.map(a=>`
        <li class="flex gap-3 text-sm md:text-base text-slate-600 leading-relaxed">
            <span class="mt-2 w-2 h-2 rounded-full bg-orange-500 shrink-0"></span>
            <span>${V(a)}</span>
        </li>
    `).join("")}function Xo(e=[]){return e.map(a=>`
    ...
    `).join("")}function Wo(e=[]){return e.map(a=>`
    ...
    `}function es(){const e=new Set(Y.map(i=>i.categoria)),a=Y.filter(i=>i.proyectosAsociados?.length>0).length,t=Y.filter(i=>i.publicacionesClave?.length>0).length;return{total:Y.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function as(){let e=Y[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Qo(e),o=es();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-linea-id]").forEach(r=>{r.onclick=()=>{e=parseInt(r.dataset.lineaId),t()}})};return t(),a}function ts(){return as()}const is=[...$e,..._e];function I(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ga(e=[],a="text-slate-600"){return e.map(t=>`
    ...
    `:""}function os(e,a){const t=e.categoria==="aprobado";return`
        <button
            type="button"
    ...
    `}function ft(e){const a=[...e.equipo||[]],t=[...e.asesores||[],...e.serviciosProfesionalesEspecializados||[]];return`
            ...
            <div class="p-6 md:p-9">
                ...
                <section class="mt-8 grid grid-cols-1 gap-8 xl:grid-cols-[0.9fr_1.1fr]">
                    ...
                    <div>
                        ...
                        <ul class="mt-5 space-y-3">${ga(e.impacto)}</ul>
                    </div>
                </section>

                ${ft(e)}
                <div class="mt-7 flex flex-wrap gap-2">${gt(e.etiquetas)}</div>
            </div>
        </article>
            ...
            <div class="p-6 md:p-9">
                ...
                <section class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div><h3 class="text-lg font-black text-[#071820]">Objetivos</h3><ul class="mt-3 space-y-3">${ga(e.objetivos)}</ul></div>
                        <div><h3 class="text-lg font-black text-[#071820]">Resultados esperados</h3><ul class="mt-3 space-y-3">${ga(e.resultados)}</ul></div>
                    </div>
                </section>
                ${ft(e)}
                <div class="mt-7 flex flex-wrap gap-2">${gt(e.etiquetas)}</div>
    ...
    `}function ns(e){return e.categoria==="aprobado"?ss(e):rs(e)}function ls(){let e="aprobado",a=$e[0]?.id||is[0]?.id;const t=document.createElement("section");t.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";const i=()=>e==="aprobado"?$e:_e,o=()=>{const r=i(),s=r.find(n=>n.id===a)||r[0];s&&s.id!==a&&(a=s.id),t.innerHTML=`
            <div class="mx-auto max-w-[1600px]">
                <header class="rounded-[2rem] bg-[#071820] px-6 py-10 text-white shadow-2xl md:px-10 md:py-12">
                    ...
                    <div class="mt-7 grid grid-cols-2 gap-3 xl:grid-cols-4">
                        ${Re(de.participacionesAcumuladas,"Participaciones registradas","24 en el perfil de Alicia y 34 en el de Juan Ramón")}
                        ${Re(de.proyectosDestacados,"Proyectos aprobados destacados","Selección mostrada con información verificable")}
                        ${Re(de.registrosNoMostrados,"Registros adicionales","Contabilizados, pero no desplegados")}
                        ${Re(de.propuestasPendientes,"Propuestas en evaluación","No se presentan como financiadas")}
                    </div>
                ...
                <div class="mt-6 flex flex-wrap gap-3" role="group" aria-label="Filtrar iniciativas por estado">
                    <button type="button" data-categoria="aprobado" class="rounded-xl px-5 py-3 text-sm font-black transition ${e==="aprobado"?"bg-[#0f5b5d] text-white shadow-lg":"border border-slate-300 bg-white text-slate-700"}">Proyectos aprobados (${$e.length})</button>
                ...
                <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-[0.72fr_1.5fr]">
                    <aside class="max-h-[780px] overflow-y-auto rounded-[2rem] border border-slate-200 bg-white p-4 shadow-lg custom-scrollbar">
                        ...
                        <div class="mt-5 space-y-4">${r.map(n=>os(n,n.id===a)).join("")}</div>
                    </aside>
                    <div>${s?ns(s):""}</div>
                </div>
            </div>
        `,t.querySelectorAll("[data-proyecto-id]").forEach(n=>{n.addEventListener("click",()=>{a=Number(n.dataset.proyectoId),o()})}),t.querySelectorAll("[data-categoria]").forEach(n=>{n.addEventListener("click",()=>{e=n.dataset.categoria,a=i()[0]?.id,o()})})};return o(),t}function cs(){return ls()}function ds(){return`
    ...
    `}function ps(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${us()}
    `,e}function ms(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",bs)}async function bs(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=gs(i);if(o.length>0){xs(o);return}await vs(a,i)}function gs(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?fs(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function fs(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function xs(e){Ne(e[0],"error")}function Ne(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function vs(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(Ne("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):Ne("Hubo un problema al enviar el mensaje.","error")}catch{Ne("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function hs(){const e=ps();return setTimeout(()=>{ms()},0),e}function ys(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
A00116736    13    7"
    ...
    `;const a=e.querySelector("#banner-primer-input"),t=e.querySelector("#banner-primer-process"),i=e.querySelector("#banner-primer-clear"),o=e.querySelector("#banner-primer-message"),r=e.querySelector("#banner-primer-preview"),s=e.querySelector("#banner-primer-count"),n=e.querySelector("#banner-primer-download-1ac"),d=e.querySelector("#banner-primer-download-2pp");let b=[];function p(c,f="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),f==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function u(){o.textContent="",o.classList.add("hidden")}function x(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function h(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function w(c){const f=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return f.includes("	")?f.split("	").map(v=>v.trim()).filter(v=>v!==""):f.includes(";")?f.split(";").map(v=>v.trim()).filter(v=>v!==""):f.split(/\s+/).map(v=>v.trim()).filter(v=>v!=="")}function A(c){const f=c.split(/\r?\n/).map(M=>M.trim()).filter(Boolean),v=[],k=[],D=new Set;return f.forEach((M,R)=>{const P=R+1,T=w(M);if(T.length!==3){k.push(`Línea ${P}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const Z=x(T[0]),B=Number(h(T[1])),H=Number(h(T[2]));if(!/^A[0-9]{8}$/.test(Z)){k.push(`Línea ${P}: la matrícula "${Z}" no es válida. Debe tener el formato A00108671.`);return}if(D.has(Z)){k.push(`Línea ${P}: la matrícula ${Z} está repetida.`);return}if(!Number.isFinite(B)){k.push(`Línea ${P}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(H)){k.push(`Línea ${P}: la calificación 2PP no es numérica.`);return}if(B<0||B>15){k.push(`Línea ${P}: 1AC debe estar entre 0 y 15.`);return}if(H<0||H>20){k.push(`Línea ${P}: 2PP debe estar entre 0 y 20.`);return}const be=B+H;if(be>35){k.push(`Línea ${P}: la suma de 1AC y 2PP no puede superar 35 puntos.`);return}D.add(Z),v.push({matricula:Z,grade1AC:B,grade2PP:H,total:be})}),{records:v,errors:k}}function y(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function g(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function E(c){if(c.length===0){r.innerHTML=`
                <tr>
                    <td
                        colspan="5"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,s.textContent="0 estudiantes";return}r.innerHTML=c.map((f,v)=>`
                ...
                `).join(""),s.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function C(c,f,v){return[["MATRICULA",v],...c.map(M=>[M.matricula,y(M[f])])].map(M=>M.join(";")).join(`\r
`)}function l(c,f){const k=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),D=URL.createObjectURL(k),M=document.createElement("a");M.href=D,M.download=f,document.body.appendChild(M),M.click(),M.remove(),window.setTimeout(()=>{URL.revokeObjectURL(D)},1e3)}function m(){b=[],a.value="",E([]),n.disabled=!0,d.disabled=!0,u(),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){b=[],E([]),n.disabled=!0,d.disabled=!0,p("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:f,errors:v}=A(c);if(v.length>0){b=[],E([]),n.disabled=!0,d.disabled=!0,p(v.join(" "),"error");return}b=f,E(b),n.disabled=!1,d.disabled=!1,p(`Los datos de ${f.length} estudiante${f.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",m),n.addEventListener("click",()=>{if(b.length===0)return;const c=C(b,"grade1AC","1AC");l(c,"Banner_APEC_Primer_Periodo_1AC.csv")}),d.addEventListener("click",()=>{if(b.length===0)return;const c=C(b,"grade2PP","2PP");l(c,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function ws(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    25"
    ...
    `;const a=e.querySelector("#banner-segundo-input"),t=e.querySelector("#banner-segundo-process"),i=e.querySelector("#banner-segundo-clear"),o=e.querySelector("#banner-segundo-message"),r=e.querySelector("#banner-segundo-preview"),s=e.querySelector("#banner-segundo-count"),n=e.querySelector("#banner-segundo-download");let d=[];function b(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function p(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function u(l){const m=String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return m.includes("	")?m.split("	").map(c=>c.trim()).filter(c=>c!==""):m.includes(";")?m.split(";").map(c=>c.trim()).filter(c=>c!==""):m.split(/\s+/).map(c=>c.trim()).filter(c=>c!=="")}function x(l){return Number.isInteger(l)?String(l):l.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function h(l){return String(l).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function w(l,m="success"){o.textContent=l,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),m==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function A(l){const m=l.split(/\r?\n/).map(k=>k.trim()).filter(Boolean),c=[],f=[],v=new Set;return m.forEach((k,D)=>{const M=D+1,R=u(k);if(R.length!==2){f.push(`Línea ${M}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const P=b(R[0]),T=Number(p(R[1]));if(!/^A[0-9]{8}$/.test(P)){f.push(`Línea ${M}: la matrícula "${P}" no es válida. Debe tener el formato A00108671.`);return}if(v.has(P)){f.push(`Línea ${M}: la matrícula ${P} está repetida.`);return}if(!Number.isFinite(T)){f.push(`Línea ${M}: la calificación 3SP no es numérica.`);return}if(T<0||T>35){f.push(`Línea ${M}: 3SP debe estar entre 0 y 35.`);return}v.add(P),c.push({matricula:P,grade3SP:T})}),{records:c,errors:f}}function y(l){if(l.length===0){r.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,s.textContent="0 estudiantes";return}r.innerHTML=l.map((m,c)=>`
                ...
                `).join(""),s.textContent=`${l.length} estudiante${l.length===1?"":"s"}`}function g(l){return[["MATRICULA","3SP"],...l.map(c=>[c.matricula,x(c.grade3SP)])].map(c=>c.join(";")).join(`\r
`)}function E(l,m){const c=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),f=URL.createObjectURL(c),v=document.createElement("a");v.href=f,v.download=m,document.body.appendChild(v),v.click(),v.remove(),window.setTimeout(()=>{URL.revokeObjectURL(f)},1e3)}function C(){d=[],a.value="",y([]),n.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const l=a.value.trim();if(!l){d=[],y([]),n.disabled=!0,w("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:m,errors:c}=A(l);if(c.length>0){d=[],y([]),n.disabled=!0,w(c.join(" "),"error");return}d=m,y(m),n.disabled=!1,w(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",C),n.addEventListener("click",()=>{d.length!==0&&E(g(d),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function ks(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    20"
    ...
    `;const a=e.querySelector("#banner-final-input"),t=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),r=e.querySelector("#banner-final-preview"),s=e.querySelector("#banner-final-count"),n=e.querySelector("#banner-final-download");let d=[];function b(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function p(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function u(l){const m=String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return m.includes("	")?m.split("	").map(c=>c.trim()).filter(c=>c!==""):m.includes(";")?m.split(";").map(c=>c.trim()).filter(c=>c!==""):m.split(/\s+/).map(c=>c.trim()).filter(c=>c!=="")}function x(l){return Number.isInteger(l)?String(l):l.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function h(l){return String(l).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function w(l,m="success"){o.textContent=l,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),m==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function A(l){const m=l.split(/\r?\n/).map(k=>k.trim()).filter(Boolean),c=[],f=[],v=new Set;return m.forEach((k,D)=>{const M=D+1,R=u(k);if(R.length!==2){f.push(`Línea ${M}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const P=b(R[0]),T=Number(p(R[1]));if(!/^A[0-9]{8}$/.test(P)){f.push(`Línea ${M}: la matrícula "${P}" no es válida. Debe tener el formato A00108671.`);return}if(v.has(P)){f.push(`Línea ${M}: la matrícula ${P} está repetida.`);return}if(!Number.isFinite(T)){f.push(`Línea ${M}: la calificación 4EF no es numérica.`);return}if(T<0||T>30){f.push(`Línea ${M}: 4EF debe estar entre 0 y 30.`);return}v.add(P),c.push({matricula:P,grade4EF:T})}),{records:c,errors:f}}function y(l){if(l.length===0){r.innerHTML=`
            ...
            `,s.textContent="0 estudiantes";return}r.innerHTML=l.map((m,c)=>`
                ...
                `).join(""),s.textContent=`${l.length} estudiante${l.length===1?"":"s"}`}function g(l){return[["MATRICULA","4EF"],...l.map(c=>[c.matricula,x(c.grade4EF)])].map(c=>c.join(";")).join(`\r
`)}function E(l,m){const c=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),f=URL.createObjectURL(c),v=document.createElement("a");v.href=f,v.download=m,document.body.appendChild(v),v.click(),v.remove(),window.setTimeout(()=>{URL.revokeObjectURL(f)},1e3)}function C(){d=[],a.value="",y([]),n.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const l=a.value.trim();if(!l){d=[],y([]),n.disabled=!0,w("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:m,errors:c}=A(l);if(c.length>0){d=[],y([]),n.disabled=!0,w(c.join(" "),"error");return}d=m,y(m),n.disabled=!1,w(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",C),n.addEventListener("click",()=>{d.length!==0&&E(g(d),"Banner_APEC_Examen_Final_4EF.csv")}),e}function As(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),r=e.querySelector("#open-segundo-periodo"),s=e.querySelector("#open-calificacion-final"),n=e.querySelector("#banner-back");function d(){a.classList.add("hidden"),t.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}function b(x){console.error("No fue posible abrir la herramienta de Banner:",x),i.innerHTML=`
        ...
        `,d()}function p(x){i.innerHTML="";try{if(typeof x!="function")throw new TypeError("El componente seleccionado no es una función válida.");const h=x();if(!(h instanceof HTMLElement))throw new TypeError("El componente seleccionado no devolvió un elemento HTML válido.");i.appendChild(h),d()}catch(h){b(h)}}function u(){i.replaceChildren(),t.classList.add("hidden"),a.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}return o.addEventListener("click",()=>{p(ys)}),r.addEventListener("click",()=>{p(ws)}),s.addEventListener("click",()=>{p(ks)}),n.addEventListener("click",u),e}function Es(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
...
};`,o.disabled=!0}function x(y,g="success"){s.textContent=y,s.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),s.classList.add("border"),g==="error"?s.classList.add("border-red-200","bg-red-50","text-red-800"):s.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function h(y){const g=y.split(/\r?\n/).map(m=>m.trim()).filter(Boolean),E=[],C=[],l=new Set;return g.forEach((m,c)=>{const f=m.split(/[\t,; ]+/).map(R=>R.trim()).filter(Boolean),v=c+1,k=f[0],D=f.slice(1);if(!k){C.push(`Línea ${v}: falta la matrícula.`);return}if(!/^\d+$/.test(k)){C.push(`Línea ${v}: la matrícula "${k}" no es válida.`);return}if(l.has(k)){C.push(`Línea ${v}: la matrícula ${k} está repetida.`);return}if(D.length===0){C.push(`Línea ${v}: falta al menos una calificación.`);return}const M=D.map(R=>Number(R));if(M.some(R=>!Number.isFinite(R))){C.push(`Línea ${v}: existe una calificación no numérica.`);return}l.add(k),E.push({matricula:k,grades:M})}),{records:E,errors:C}}function w(y){return`var data_todo = {
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function A(y){const g=y==="xmera";b.classList.toggle("hidden",!g),p.classList.toggle("hidden",g),n.className=g?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",d.className=g?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const y=a.value.trim();if(!y){u(),x("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:g,errors:E}=h(y);if(E.length>0){u(),x(E.join(" "),"error");return}t.textContent=w(g),o.disabled=!1,x(`Código generado correctamente para ${g.length} estudiante${g.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),x("El código fue copiado al portapapeles.")}catch(y){console.error("No fue posible copiar el código:",y),x("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),r.addEventListener("click",()=>{a.value="",u(),s.textContent="",s.classList.add("hidden"),a.focus()});try{const y=As();if(y instanceof HTMLElement)p.appendChild(y);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(y){console.error("No fue posible cargar el módulo Banner:",y),p.innerHTML=`
        ...
        `}return n.addEventListener("click",()=>{A("xmera")}),d.addEventListener("click",()=>{A("banner")}),A("xmera"),e}function Cs(){return Es()}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function xt(e){return String(e??"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim()}function Ss(e,a=!1){return`
        <button
            type="button"
    ...
    `}function $s(e){const a=xt([e.numero,e.titulo,e.tituloCorto,e.resumen,e.descripcion,e.categoriaNombre,...e.subservicios||[],e.entregables].join(" "));return`
        <article
            data-servicio-card
        ...
        <div class="relative z-10 space-y-10">
            <header class="grid grid-cols-1 gap-7 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
                <div>
                    ...
                    <p class="mt-4 text-sm font-bold text-slate-500 md:text-base">${$(ke.subtitulo)}</p>
                ...
                <aside class="rounded-3xl border border-slate-800 bg-slate-950 p-6 text-white shadow-xl">
                    ...
                    <p class="mt-3 text-sm leading-relaxed text-slate-300">${$(ke.notaAlcance)}</p>
            ...
            <section class="grid grid-cols-2 gap-3 md:grid-cols-4" aria-label="Resumen del catálogo">
                ${[[ce.length,"áreas de servicio"],[ba.length-1,"bloques temáticos"],[Ra.length,"paquetes sugeridos"],[qa.length,"etapas de trabajo"]].map(([p,u])=>`
    ...
    `).join("")}function Ee({id:e,etiqueta:a,tipo:t="text",requerido:i=!1,placeholder:o="",autocomplete:r="off"}){return`
    ...
    `}function Vs(e){if(e)try{const a=window.sessionStorage.getItem(Ba);window.sessionStorage.removeItem(Ba),a&&[...e.options].some(t=>t.value===a)&&(e.value=a)}catch(a){console.warn("[Kernel] No fue posible recuperar el servicio de interés.",a)}}function U(e,a){return String(new FormData(e).get(a)||"").trim()}function vt(e){return ce.find(a=>a.id===e)?.titulo||"No especificado"}function Va(e){const a={nombre:U(e,"nombre"),organizacion:U(e,"organizacion"),cargo:U(e,"cargo"),correo:U(e,"correo"),telefono:U(e,"telefono"),sector:U(e,"sector"),servicio:vt(U(e,"servicio")),necesidad:U(e,"necesidad"),datos:U(e,"datos"),plazo:U(e,"plazo"),presupuesto:U(e,"presupuesto"),producto:U(e,"producto"),modalidad:U(e,"modalidad")};return["SOLICITUD DE DIAGNÓSTICO INICIAL — GRUPO EL KERNEL","",`Nombre: ${a.nombre}`,`Organización: ${a.organizacion||"No indicada"}`,`Cargo o función: ${a.cargo||"No indicado"}`,`Correo: ${a.correo}`,`Teléfono: ${a.telefono||"No indicado"}`,`Sector: ${a.sector||"No especificado"}`,`Servicio de interés: ${a.servicio}`,`Modalidad preferida: ${a.modalidad||"No especificada"}`,`Plazo esperado: ${a.plazo||"No especificado"}`,`Presupuesto estimado: ${a.presupuesto||"No especificado"}`,"","Problema o necesidad:",a.necesidad,"","Datos, documentos o recursos disponibles:",a.datos||"No especificados","","Producto o resultado esperado:",a.producto||"No especificado","","Nota: adjuntaré al correo generado los términos de referencia o documentos pertinentes, si aplica."].join(`
`)}async function _s(e){if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(e);return}const a=document.createElement("textarea");a.value=e,a.setAttribute("readonly",""),a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove()}function Ks(){const e=document.createElement("section");e.className="w-full bg-slate-100 px-3 py-6 font-sans sm:px-5 md:py-10 lg:px-8",e.innerHTML=`
            ...
            <div class="grid grid-cols-1 gap-8 p-5 md:p-8 xl:grid-cols-[1.25fr_0.75fr] xl:p-10">
                <form data-formulario-diagnostico class="space-y-7" novalidate>
                    <section aria-labelledby="titulo-identificacion-diagnostico">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ${Ee({id:"nombre",etiqueta:"Nombre completo",requerido:!0,placeholder:"Nombre y apellidos",autocomplete:"name"})}
                            ${Ee({id:"correo",etiqueta:"Correo electrónico",tipo:"email",requerido:!0,placeholder:"nombre@institucion.edu",autocomplete:"email"})}
                            ${Ee({id:"organizacion",etiqueta:"Organización o institución",placeholder:"Universidad, empresa, organismo...",autocomplete:"organization"})}
                            ${Ee({id:"cargo",etiqueta:"Cargo o función",placeholder:"Director, docente, investigador...",autocomplete:"organization-title"})}
                            ${Ee({id:"telefono",etiqueta:"Teléfono",tipo:"tel",placeholder:"+1 809 ...",autocomplete:"tel"})}
                ...
                <aside class="space-y-5">
                    ...
                    <section class="rounded-3xl bg-[#071820] p-6 text-white">
                        ...
                        <h2 class="mt-2 text-2xl font-black">${Ua}</h2>
    ...
    `;const a=e.querySelector("[data-formulario-diagnostico]"),t=e.querySelector("[data-estado-diagnostico]"),i=e.querySelector("#servicio");return Vs(i),a?.addEventListener("submit",o=>{if(o.preventDefault(),!a.checkValidity()){a.reportValidity(),t&&(t.textContent="Complete los campos obligatorios antes de continuar.");return}const r=Va(a),s=encodeURIComponent(`Solicitud de diagnóstico: ${vt(U(a,"servicio"))}`),n=encodeURIComponent(r);t&&(t.textContent="Abriendo su aplicación de correo. Adjunte los documentos pertinentes antes de enviar."),window.location.href=`mailto:${Ua}?subject=${s}&body=${n}`}),e.querySelector("[data-copiar-diagnostico]")?.addEventListener("click",async()=>{if(!a?.checkValidity()){a?.reportValidity(),t&&(t.textContent="Complete los campos obligatorios para copiar un resumen útil.");return}try{await _s(Va(a)),t&&(t.textContent="Resumen copiado. Puede pegarlo en un correo o documento.")}catch(o){console.error("[Kernel] No fue posible copiar el diagnóstico.",o),t&&(t.textContent="No fue posible copiar automáticamente. Utilice el botón para preparar el correo.")}}),e}const Gs=450,Me="kernel:recuperacion-modulo";let ve=0,Te=null;function ht(e){return new Promise(a=>{window.setTimeout(a,e)})}function Sa(e){const a=String(e?.message||e||"");return/chunkloaderror|failed to fetch dynamically imported module|importing a module script failed|error loading dynamically imported module|networkerror.*module|load failed.*module/i.test(a)}function Hs(e){return["kernel/auth-timeout","auth/network-request-failed"].includes(e?.code)}async function fa(e){let a;for(let t=0;t<2;t+=1)try{return await e()}catch(i){if(a=i,t>0||!Sa(i))throw i;await ht(Gs)}throw a}function O(e,a,t){return async()=>{const o=(await fa(e))[a];if(typeof o!="function")throw new Error(t);return o()}}function Js(){return Te||(Te=Promise.all([fa(()=>q(()=>import("./authGuard-CEzcrBkK.js"),__vite__mapDeps([0,1,2]),import.meta.url)),fa(()=>q(()=>import("./login-BtABpxCq.js"),__vite__mapDeps([3,1,2]),import.meta.url))]).then(([e,a])=>({esperarAutenticacion:e.esperarAutenticacion,crearLogin:a.crearLogin})).catch(e=>{throw Te=null,e})),Te}const Qs=O(()=>q(()=>import("./LaboratorioKernel-BTRu55uv.js"),__vite__mapDeps([4,1,2]),import.meta.url),"LaboratorioKernel","El Laboratorio Inteligente no está disponible."),Xs=O(()=>q(()=>import("./AsistentePruebas-BOi_3rhz.js"),__vite__mapDeps([5,6]),import.meta.url),"AsistentePruebas","El asistente metodológico no está disponible."),Ws=O(()=>q(()=>import("./ComparacionGrupos-BqmYk_OJ.js"),[],import.meta.url),"ComparacionGrupos","El módulo de comparación de grupos no está disponible."),Ys=O(()=>q(()=>import("./CalculadoraDosGrupos-D89iYWJ6.js"),__vite__mapDeps([7,8,9]),import.meta.url),"CalculadoraDosGrupos","La calculadora de dos grupos no está disponible."),Zs=O(()=>q(()=>import("./CalculadoraDosMuestrasRelacionadas-Hp6anDRf.js"),__vite__mapDeps([10,11,8,9]),import.meta.url),"CalculadoraDosMuestrasRelacionadas","La calculadora de muestras relacionadas no está disponible."),er=O(()=>q(()=>import("./CalculadoraTresOMasGrupos-D6Hmbqiv.js"),__vite__mapDeps([12,8,9]),import.meta.url),"CalculadoraTresOMasGrupos","La calculadora de tres o más grupos no está disponible."),ar=O(()=>q(()=>import("./CalculadoraTresOMasMedicionesRelacionadas-Dw2E-SJU.js"),__vite__mapDeps([13,8,11,9]),import.meta.url),"CalculadoraTresOMasMedicionesRelacionadas","La calculadora de mediciones relacionadas no está disponible."),tr=O(()=>q(()=>import("./CorrelacionAsociacion-BJOAMDeR.js"),[],import.meta.url),"CorrelacionAsociacion","El módulo de correlación y asociación no está disponible."),ir=O(()=>q(()=>import("./CalculadoraRelacionVariables-Bjiv_HBx.js"),__vite__mapDeps([14,8,9]),import.meta.url),"CalculadoraRelacionVariables","La calculadora de relación entre variables no está disponible."),or=O(()=>q(()=>import("./CalculadoraAsociacionCategorica-Cyy2NU6t.js"),__vite__mapDeps([15,8,9]),import.meta.url),"CalculadoraAsociacionCategorica","La calculadora de asociación categórica no está disponible."),sr=O(()=>q(()=>import("./CalculadoraEstadisticaDescriptiva-H47xodIs.js"),__vite__mapDeps([16,9]),import.meta.url),"CalculadoraEstadisticaDescriptiva","La calculadora de estadística descriptiva no está disponible."),rr=O(()=>q(()=>import("./CalculadoraFiabilidadCuestionarios-RXCJPQgL.js"),__vite__mapDeps([17,9]),import.meta.url),"CalculadoraFiabilidadCuestionarios","La calculadora de cuestionarios y fiabilidad no está disponible."),nr=O(()=>q(()=>import("./CalculadoraEvaluacionEducativa-cvXPNNzC.js"),__vite__mapDeps([18,9]),import.meta.url),"CalculadoraEvaluacionEducativa","La calculadora de evaluación educativa no está disponible."),lr=O(()=>q(()=>import("./CalculadoraTamanoMuestraPotencia-gf1DqFyl.js"),__vite__mapDeps([19,9]),import.meta.url),"CalculadoraTamanoMuestraPotencia","La calculadora de tamaño de muestra y potencia no está disponible."),cr=O(()=>q(()=>import("./BibliotecaMetodologica-BzzsJJUi.js"),__vite__mapDeps([20,6]),import.meta.url),"BibliotecaMetodologica","La Biblioteca metodológica no está disponible."),dr=O(()=>q(()=>import("./RegresionModelos-q4rY9Zve.js"),[],import.meta.url),"RegresionModelos","El área de modelos de regresión no está disponible."),ur=O(()=>q(()=>import("./CalculadoraRegresionCompleta-CxbLvmGe.js"),__vite__mapDeps([21,9]),import.meta.url),"CalculadoraRegresionCompleta","La calculadora de regresión lineal no está disponible."),pr=O(()=>q(()=>import("./CalculadoraRegresionLogistica-DliyTC4D.js"),__vite__mapDeps([22,9]),import.meta.url),"CalculadoraRegresionLogistica","La calculadora de regresión logística no está disponible."),mr=O(()=>q(()=>import("./CalculadoraRegresionConteo-BuCyd_Nj.js"),__vite__mapDeps([23,9]),import.meta.url),"CalculadoraRegresionConteo","La calculadora de regresión de conteo no está disponible."),br={home:{page:Pi,layout:"full",title:"Portada | El Kernel"},servicios:{page:Fs,layout:"full",title:"Servicios profesionales y académicos | El Kernel"},diagnosticoServicios:{page:Ks,layout:"full",title:"Solicitar diagnóstico | El Kernel"},quienesSomos:{page:Yi,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:so,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:co,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:Uo,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Jo,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:cs,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:ts,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:hs,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Cs,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Qs,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Xs,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},comparacionGrupos:{page:Ws,layout:"default",title:"Comparación de grupos y mediciones | El Kernel"},calculadoraDosGrupos:{page:Ys,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:Zs,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"},calculadoraTresOMasGrupos:{page:er,layout:"default",title:"Comparación de tres o más grupos independientes | El Kernel"},calculadoraTresOMasMedicionesRelacionadas:{page:ar,layout:"default",title:"Comparación de tres o más mediciones relacionadas | El Kernel"},correlacionAsociacion:{page:tr,layout:"default",title:"Correlación y asociación | El Kernel"},calculadoraRelacionVariables:{page:ir,layout:"default",title:"Relación entre variables | El Kernel"},calculadoraAsociacionCategorica:{page:or,layout:"default",title:"Asociación entre variables categóricas | El Kernel"},calculadoraEstadisticaDescriptiva:{page:sr,layout:"default",title:"Estadística descriptiva | El Kernel"},calculadoraFiabilidadCuestionarios:{page:rr,layout:"default",title:"Cuestionarios y fiabilidad | El Kernel"},calculadoraEvaluacionEducativa:{page:nr,layout:"default",title:"Evaluación educativa | El Kernel"},calculadoraTamanoMuestraPotencia:{page:lr,layout:"default",title:"Tamaño de muestra y potencia | El Kernel"},bibliotecaMetodologica:{page:cr,layout:"default",title:"Biblioteca metodológica | El Kernel"},regresionModelos:{page:dr,layout:"default",title:"Modelos de regresión | El Kernel"},calculadoraRegresion:{page:ur,layout:"default",title:"Regresión lineal y múltiple | El Kernel"},calculadoraRegresionLogistica:{page:pr,layout:"default",title:"Regresión logística binaria | El Kernel"},calculadoraRegresionConteo:{page:mr,layout:"default",title:"Regresión de Poisson y binomial negativa | El Kernel"}},gr=new Set(["laboratorioKernel","asistentePruebas","comparacionGrupos","calculadoraDosGrupos","calculadoraDosMuestrasRelacionadas","calculadoraTresOMasGrupos","calculadoraTresOMasMedicionesRelacionadas","correlacionAsociacion","calculadoraRelacionVariables","calculadoraAsociacionCategorica","calculadoraEstadisticaDescriptiva","calculadoraFiabilidadCuestionarios","calculadoraEvaluacionEducativa","calculadoraTamanoMuestraPotencia","bibliotecaMetodologica","regresionModelos","calculadoraRegresion","calculadoraRegresionLogistica","calculadoraRegresionConteo"]);let _a=document.referrer||"";function ia(e){window.location.hash=`/${e}`}function yt(){return window.location.hash.replace("#/","")||"home"}function fr(){const e=()=>{Je(yt())};window.addEventListener("hashchange",e),e()}function xr(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:_a}),_a=t}function vr(e){return document.title="Acceso al Laboratorio | El Kernel",e(()=>{Je(yt())})}function hr(){const e=document.createElement("section");return e.className="w-full max-w-4xl mx-auto px-4 py-16 md:px-8 font-sans",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.innerHTML=`
        ...
        </div>`,e}function yr(e){return e?.code==="kernel/auth-timeout"?"La verificación de la sesión tardó más de lo esperado. Compruebe su conexión e inténtelo nuevamente.":Sa(e)?"No fue posible descargar esta sección. Puede tratarse de una interrupción temporal de la conexión.":"Ocurrió un problema inesperado al preparar esta sección."}function wr(e,a){const t=document.createElement("section");t.className="w-full max-w-4xl mx-auto px-4 py-12 md:px-8 font-sans",t.setAttribute("role","alert"),t.setAttribute("aria-live","assertive"),t.innerHTML=`
        ...
        </div>`;const i=t.querySelector("[data-mensaje-error-ruta]");return i&&(i.textContent=yr(e)),t.querySelector("[data-action='reintentar-ruta']")?.addEventListener("click",a),t.querySelector("[data-action='volver-portada']")?.addEventListener("click",()=>ia("home")),t}function kr(e,a){if(!Sa(a))return!1;try{const t=JSON.parse(window.sessionStorage.getItem(Me)||"null"),i=Date.now();return t?.route===e&&Number.isFinite(t?.timestamp)&&i-t.timestamp<12e4?!1:(window.sessionStorage.setItem(Me,JSON.stringify({route:e,timestamp:i})),window.location.reload(),!0)}catch{return!1}}function Ar(e){try{JSON.parse(window.sessionStorage.getItem(Me)||"null")?.route===e&&window.sessionStorage.removeItem(Me)}catch{try{window.sessionStorage.removeItem(Me)}catch{}}}function Ka(e){const a=e.querySelector("h1");a&&(a.setAttribute("tabindex","-1"),a.focus({preventScroll:!0}))}async function Er(e,a){if(!gr.has(e))return a.page();const{esperarAutenticacion:t,crearLogin:i}=await Js();return await t()?a.page():vr(i)}async function Je(e,a={}){const{intentoAutenticacion:t=0}=a,i=document.querySelector("main"),o=br[e];if(!i)return;if(!o){ia("home");return}const r=++ve;nt(o.layout),document.title=o.title,i.setAttribute("aria-busy","true"),i.replaceChildren(hr());try{const s=await Er(e,o);if(r!==ve)return;if(!(s instanceof Element))throw new Error("La sección no devolvió un componente válido.");i.replaceChildren(s),i.setAttribute("aria-busy","false"),window.scrollTo({top:0,behavior:"auto"}),window.requestAnimationFrame(()=>{r===ve&&Ka(i)}),Ar(e),xr(e,document.title)}catch(s){if(r!==ve)return;if(console.error(`[Kernel] Error al cargar la ruta ${e}.`,s),Hs(s)&&t<1)return await ht(650),r===ve?Je(e,{intentoAutenticacion:t+1}):void 0;if(kr(e,s))return;i.setAttribute("aria-busy","false"),i.replaceChildren(wr(s,()=>Je(e))),window.requestAnimationFrame(()=>{r===ve&&Ka(i)})}}function Cr(e,a){e&&e.addEventListener("click",t=>{const i=t.target.closest("[data-route]");!i||!e.contains(i)||(t.preventDefault(),a(i.dataset.route),pe(e))})}function Sr(e){return/^(?:laboratorioKernel|asistentePruebas|comparacionGrupos|calculadora|correlacionAsociacion|bibliotecaMetodologica|regresionModelos)/.test(e)?"laboratorioKernel":e}function Ga(e){const a=window.location.hash.replace("#/","")||"home",t=Sr(a);e.querySelectorAll("[data-route]").forEach(i=>{i.dataset.route===t?i.setAttribute("aria-current","page"):i.removeAttribute("aria-current")})}function $r(e,a){if(!e||!a)return;Cr(e,ia),Lt(e);const t=a.querySelector('[data-action="open-menu"]');t&&Ft(t,e),Ut(e),Ga(e),window.addEventListener("hashchange",()=>Ga(e)),fr()}function Mr(e){const a=String(e??"").replace(/\u00a0/g,"").replace(/\s/g,"").replace(/[^0-9+\-.,eE]/g,"");if(!a)return null;const t=a.lastIndexOf(","),i=a.lastIndexOf(".");let o=a;t>=0&&i>=0?o=i>t?a.replace(/,/g,""):a.replace(/\./g,"").replace(",","."):t>=0&&(o=a.length-t-1===3&&t>0?a.replace(/,/g,""):a.replace(",","."));const r=Number(o);return Number.isFinite(r)?r:null}function jr(e){const a=e.querySelector("table");if(!a)return null;const i=[...a.querySelectorAll("thead th")].map(r=>r.textContent.trim().toLowerCase()).some(r=>r.includes("marca")),o=[...a.querySelectorAll("tbody tr")].map(r=>{const s=[...r.children],n=Number(s[i?2:1]?.textContent.trim()),d=Number(s[i?4:3]?.textContent.trim());return{etiqueta:s[0]?.textContent.trim()||"",valor:Mr(s[i?1:0]?.textContent),frecuencia:Number.isFinite(n)?n:0,acumulada:Number.isFinite(d)?d:0}}).filter(r=>r.etiqueta&&r.frecuencia>=0);return{agrupados:i,filas:o}}function wt(e){return Number.isFinite(Number(e))?Number(e).toLocaleString("es-DO",{maximumFractionDigits:3}):"—"}function Ha(e,a){let t=0;for(const i of e)if(t+=i.frecuencia,a<t)return i.valor;return e.at(-1)?.valor??null}function ca(e,a){const t=e.reduce((d,b)=>d+b.frecuencia,0);if(!t)return null;if(a<=0)return e[0].valor;if(a>=1)return e.at(-1).valor;const i=(t-1)*a,o=Math.floor(i),r=Math.ceil(i),s=Ha(e,o),n=Ha(e,r);return o===r?s:s*(r-i)+n*(i-o)}function Ce(e,a,t){return`
        <text
            x="${e}"
            y="${a}"
            text-anchor="middle"
        ...
        >${wt(t)}</text>
    `}function zr(e,a){if(!e||e.dataset.cajaDescriptivaSegura==="true"||a.agrupados)return;e.dataset.cajaDescriptivaSegura="true";const t=a.filas.filter(l=>l.valor!==null&&l.frecuencia>0).sort((l,m)=>l.valor-m.valor);if(t.reduce((l,m)=>l+m.frecuencia,0)<2)return;const o=t[0].valor,r=t.at(-1).valor,s=ca(t,.25),n=ca(t,.5),d=ca(t,.75),b=d-s,p=s-1.5*b,u=d+1.5*b,x=t.filter(l=>l.valor>=p&&l.valor<=u),h=t.filter(l=>l.valor<p||l.valor>u),w=x[0]?.valor??o,A=x.at(-1)?.valor??r,y=Math.max(r-o,1),g=l=>40+(l-o)/y*520,E=e.querySelector("svg");if(!E)return;E.setAttribute("aria-label","Diagrama de caja con cuartiles, mediana, bigotes y valores atípicos potenciales"),E.innerHTML=`
        ...
        ${h.map((l,m)=>`
            <circle
                ...
                class="text-red-600"
            >
                <title>Valor atípico potencial: ${wt(l.valor)}${l.frecuencia>1?` (${l.frecuencia} observaciones)`:""}</title>
            </circle>
        `).join("")}
        ${Ce(g(w),140,w)}
        ${Ce(g(s),30,s)}
        ...
        ${Ce(g(d),30,d)}
        ${Ce(g(A),140,A)}
    `;const C=e.querySelector("h3 + p");C&&(C.textContent="Los bigotes terminan en los valores extremos no atípicos. Los puntos rojos representan valores atípicos potenciales según el criterio de Tukey.")}function Lr(){const e=document.createElement("section");return e.dataset.encabezadoGraficosSeguro="true",e.className="mt-10",e.innerHTML=`
    ...
    `,e}function Ir(e){const a=document.createElement("article");a.dataset.graficoExportable="true",a.dataset.graficoId="histograma",a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const t=Math.max(...e.map(i=>i.frecuencia),1);return a.innerHTML=`
    ...
    `,a}function Pr(e){const a=document.createElement("article");a.dataset.graficoExportable="true",a.dataset.graficoId="ojiva-frecuencia-acumulada",a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const t=600,i=250,o=48,r=24,s=24,n=48,d=Math.max(...e.map(u=>u.acumulada),1),b=Math.max(e.length-1,1),p=e.map((u,x)=>({...u,x:o+x/b*(t-o-r),y:s+(1-u.acumulada/d)*(i-s-n)}));return a.innerHTML=`
    ...
    `,a}function Dr(e){const a=[...e.querySelectorAll("article")],t=a.find(s=>s.querySelector("h3")?.textContent.includes("Distribución de frecuencias")),i=a.find(s=>s.querySelector("h3")?.textContent.includes("Diagrama de caja"));if(!t||!i)return;const o=t.parentElement,r=jr(e);if(!(!o||!r?.filas.length)&&(e.querySelector("[data-encabezado-graficos-seguro='true']")||(o.before(Lr()),o.classList.remove("mt-8")),zr(i,r),!e.querySelector("[data-graficos-descriptivos-seguros='true']"))){const s=document.createElement("div");s.dataset.graficosDescriptivosSeguros="true",s.className="grid grid-cols-1 xl:grid-cols-2 gap-7 mt-7",s.append(Ir(r.filas),Pr(r.filas)),o.after(s)}}function qr(){let e=!1;const a=()=>{e=!1;const o=document.querySelector("#resultados-estadistica-descriptiva");o&&!o.classList.contains("hidden")&&Dr(o)},t=()=>{e||(e=!0,window.requestAnimationFrame(a))};new MutationObserver(t).observe(document.body,{childList:!0,subtree:!0}),t()}const Rr=["#formulario-estadistica-descriptiva","#formulario-regresion","#formulario-regresion-conteo","#form-tamano","[id*='calculadora'] form","section form"].join(",");function Tr(){return document.querySelector("main h1, #app h1, h1")?.textContent?.trim()?.toLowerCase()||""}function Or(){return Tr().includes("laboratorio inteligente de investigación")}function Nr(){const e=document.querySelector("main h1, #app h1, h1"),a=document.querySelector("[data-action='volver-laboratorio'], [data-action='volver-modelos'], [data-action='volver-regresion'], [data-action='volver']"),t=document.querySelector(Rr);return!!(e&&a&&t)}function Fr(){const e=document.createElement("section");return e.dataset.creditosCalculadoras="true",e.className=["w-full max-w-7xl mx-auto","px-4 pb-10 md:px-8","font-sans"].join(" "),e.innerHTML=`
    ...
    `,a.querySelector("button")?.addEventListener("click",n=>{const d=n.currentTarget,b=d.dataset.almacenamientoRegresion;b&&sessionStorage.setItem(b,d.dataset.tipoRegresion||""),window.location.hash=`/${d.dataset.routeRegresion}`}),a}function Qa(){const e=Vr();if(!e)return;const a=e.encabezado.closest("section");if(!a||a.querySelector("[data-ejecutar-modelo-regresion='true']")||a.querySelector("[data-action='ejecutar-prueba']"))return;(a.querySelector("header + div")||a).appendChild(_r(e.modelo))}function Xa(){const a=document.querySelector("#formulario-regresion")?.elements?.tipoModelo;if(!a)return;const t=sessionStorage.getItem("kernel-tipo-modelo-regresion");t!=="simple"&&t!=="multiple"||(a.value=t,a.dispatchEvent(new Event("change",{bubbles:!0})),sessionStorage.removeItem("kernel-tipo-modelo-regresion"))}function Kr(){new MutationObserver(()=>{Qa(),Xa()}).observe(document.body,{childList:!0,subtree:!0}),Qa(),Xa()}let Fe=null;function Se({restaurarFoco:e=!0}={}){if(Fe){const a=Fe;Fe=null,a(e);return}document.querySelector("[data-selector-instrumento='true']")?.remove()}function Gr(){Se({restaurarFoco:!1});const e=document.activeElement,a=document.body.style.overflow,t=document.createElement("div");t.dataset.selectorInstrumento="true",t.className=`
        fixed inset-0 z-[500]
    ...
    `;const i=()=>[...t.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')].filter(s=>s.getAttribute("aria-hidden")!=="true"),o=s=>{if(s.key==="Escape"){s.preventDefault(),Se();return}if(s.key!=="Tab")return;const n=i();if(!n.length){s.preventDefault();return}const d=n[0],b=n.at(-1);s.shiftKey&&document.activeElement===d?(s.preventDefault(),b.focus()):!s.shiftKey&&document.activeElement===b&&(s.preventDefault(),d.focus())},r=()=>{Se({restaurarFoco:!1})};Fe=s=>{document.removeEventListener("keydown",o),window.removeEventListener("hashchange",r),t.remove(),document.body.style.overflow=a,s&&e instanceof HTMLElement&&e.isConnected&&e.focus()},t.addEventListener("click",s=>{const n=s.target.closest("[data-route-instrumento]")?.dataset.routeInstrumento;if(n){Se({restaurarFoco:!1}),window.location.hash=`/${n}`;return}(s.target===t||s.target.closest("[data-action='cerrar-selector-instrumento']"))&&Se()}),document.body.appendChild(t),document.body.style.overflow="hidden",document.addEventListener("keydown",o),window.addEventListener("hashchange",r),t.querySelector("[data-route-instrumento]")?.focus()}function Hr(e){e.target.closest("#asistente-pruebas [data-value='instrumento']")&&(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),Gr())}function Jr(){document.addEventListener("click",Hr,!0)}const Qe="kernel-calculadora-una-muestra-activa",xa="kernel-prueba-una-muestra",Xe="calculadoraDosGrupos";let da=!1;function va(e){return String(e||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\s+/g," ").trim().toLowerCase()}function ha(){return window.location.hash.replace("#/","")||"home"}function kt(e=""){sessionStorage.setItem(Qe,"true"),e?sessionStorage.setItem(xa,e):sessionStorage.removeItem(xa),window.location.hash=`/${Xe}`}function Qr(){const e=document.createElement("article");return e.dataset.calculadoraUnaMuestraCard="true",e.className="h-full rounded-3xl border border-cyan-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
    ...
    `,e.querySelector("button")?.addEventListener("click",()=>kt()),e}function Xr(){const a=[...document.querySelectorAll("main h1")].find(i=>va(i.textContent)==="comparacion de grupos y mediciones")?.closest("section");if(!a||a.querySelector("[data-calculadora-una-muestra-card='true']"))return;[...a.children].find(i=>i.tagName==="SECTION"&&i.classList.contains("grid"))?.prepend(Qr())}function Wr(){const e=[...document.querySelectorAll("main h1")];for(const a of e){const t=va(a.textContent),i=a.closest("section");if(va(i?.textContent).includes("categoria: comparacion de una muestra")){if(t==="t de student para una muestra")return{contenedor:i,prueba:"t-una-muestra",descripcion:"Abra la calculadora con la t de Student seleccionada para comparar la media de su muestra con el valor de referencia."};if(t==="prueba de rangos con signo de wilcoxon")return{contenedor:i,prueba:"wilcoxon-una-muestra",descripcion:"Abra la calculadora con Wilcoxon seleccionado para comparar la localización basada en rangos con el valor de referencia."}}}return null}function Yr(e){const a=document.createElement("div");return a.dataset.ejecutarUnaMuestra="true",a.className="mt-8 rounded-2xl border border-cyan-200 bg-cyan-50 p-6",a.innerHTML=`
        <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
                ...
                <p class="leading-relaxed text-slate-600">
                    ${e.descripcion} Obtendrá descriptivos, valor p, estimación, intervalo de confianza cuando corresponda y tamaño del efecto.
                </p>
            </div>

            <button
                type="button"
                data-prueba-una-muestra="${e.prueba}"
    ...
    `,a.querySelector("button")?.addEventListener("click",()=>kt(e.prueba)),a}function Zr(){const e=Wr();if(!e?.contenedor||e.contenedor.querySelector("[data-ejecutar-una-muestra='true']")||e.contenedor.querySelector("[data-action='ejecutar-prueba']"))return;(e.contenedor.querySelector("header + div")||e.contenedor).appendChild(Yr(e))}async function en(){if(ha()!==Xe||sessionStorage.getItem(Qe)!=="true")return;const e=document.querySelector("#main");if(!(!e||e.querySelector("#formulario-una-muestra")||da||!e.querySelector("#formulario-dos-grupos"))){da=!0;try{const t=await q(()=>import("./CalculadoraUnaMuestra-DOjZzXFw.js"),__vite__mapDeps([24,11,8,9]),import.meta.url);if(ha()!==Xe||sessionStorage.getItem(Qe)!=="true")return;e.replaceChildren(t.CalculadoraUnaMuestra()),document.title="Comparación de una muestra | El Kernel"}catch(t){console.error("[Kernel] No fue posible abrir la calculadora de una muestra.",t)}finally{da=!1}}}function an(){ha()!==Xe&&(sessionStorage.removeItem(Qe),sessionStorage.removeItem(xa))}function tn(){const e=()=>{Xr(),Zr(),en()};new MutationObserver(e).observe(document.body,{childList:!0,subtree:!0}),window.addEventListener("hashchange",()=>{an(),e()}),e()}const We="kernel-calculadora-proporciones-relacionadas-activa",ya="kernel-prueba-proporciones-relacionadas",Ye="calculadoraDosMuestrasRelacionadas";let ua=!1;function At(e){return String(e||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/\s+/g," ").trim().toLowerCase()}function wa(){return window.location.hash.replace("#/","")||"home"}function Et(e=""){sessionStorage.setItem(We,"true"),e?sessionStorage.setItem(ya,e):sessionStorage.removeItem(ya),window.location.hash=`/${Ye}`}function on(){const e=document.createElement("article");return e.dataset.proporcionesRelacionadasCard="true",e.className="h-full rounded-3xl border border-fuchsia-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex h-full flex-col">
    ...
    `,e.querySelector("button")?.addEventListener("click",()=>Et()),e}function sn(){const a=[...document.querySelectorAll("main h1")].find(i=>At(i.textContent)==="comparacion de grupos y mediciones")?.closest("section");if(!a||a.querySelector("[data-proporciones-relacionadas-card='true']"))return;[...a.children].find(i=>i.tagName==="SECTION"&&i.classList.contains("grid"))?.appendChild(on())}function rn(){const e=[...document.querySelectorAll("main h1")];for(const a of e){const t=At(a.textContent),i=a.closest("section");if(t==="prueba de mcnemar")return{contenedor:i,prueba:"mcnemar",descripcion:"Abra la calculadora con McNemar seleccionada para comparar dos proporciones relacionadas."};if(t==="prueba q de cochran")return{contenedor:i,prueba:"q-cochran",descripcion:"Abra la calculadora con Q de Cochran seleccionada para comparar tres o más proporciones relacionadas."}}return null}function nn(e){const a=document.createElement("div");return a.dataset.ejecutarProporcionesRelacionadas="true",a.className="mt-8 rounded-2xl border border-fuchsia-200 bg-fuchsia-50 p-6",a.innerHTML=`
        <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
                ...
                <p class="leading-relaxed text-slate-600">
                    ${e.descripcion} Obtendrá proporciones, valor p, tamaño del efecto y, para Cochran, comparaciones posteriores ajustadas.
                </p>
            </div>

            <button
                type="button"
                data-prueba-proporciones="${e.prueba}"
    ...
    `,a.querySelector("button")?.addEventListener("click",()=>Et(e.prueba)),a}function ln(){const e=rn();if(!e?.contenedor||e.contenedor.querySelector("[data-ejecutar-proporciones-relacionadas='true']")||e.contenedor.querySelector("[data-action='ejecutar-prueba']"))return;(e.contenedor.querySelector("header + div")||e.contenedor).appendChild(nn(e))}async function cn(){if(wa()!==Ye||sessionStorage.getItem(We)!=="true")return;const e=document.querySelector("#main");if(!(!e||e.querySelector("#formulario-proporciones-relacionadas")||ua||!e.querySelector("#formulario-dos-relacionadas, h1"))){ua=!0;try{const t=await q(()=>import("./CalculadoraProporcionesRelacionadas-CkMdlkc4.js"),__vite__mapDeps([25,8,9]),import.meta.url);if(wa()!==Ye||sessionStorage.getItem(We)!=="true")return;e.replaceChildren(t.CalculadoraProporcionesRelacionadas()),document.title="Proporciones relacionadas | El Kernel"}catch(t){console.error("[Kernel] No fue posible abrir la calculadora de proporciones relacionadas.",t)}finally{ua=!1}}}function dn(){wa()!==Ye&&(sessionStorage.removeItem(We),sessionStorage.removeItem(ya))}function un(){const e=()=>{sn(),ln(),cn()};new MutationObserver(e).observe(document.body,{childList:!0,subtree:!0}),window.addEventListener("hashchange",()=>{dn(),e()}),e()}function me(e,a){try{a()}catch(t){console.error(`[Kernel] No fue posible iniciar ${e}.`,t)}}function pn(e){if(!e)return;const a=e.parentElement,t=a?.parentElement,i=document.querySelector("#main");t?.classList.add("relative","z-[200]","overflow-visible"),a?.classList.add("overflow-visible"),e.classList.remove("lg:z-auto","lg:z-[210]"),e.classList.add("overflow-visible","lg:z-[220]"),i?.classList.add("relative","z-0")}const Ze=document.querySelector("#header"),je=document.querySelector("#navBar"),Wa=document.querySelector("#footer");Ze&&(Ze.innerHTML=$t());je&&(je.innerHTML=jt(),pn(je));Wa&&(Wa.innerHTML=zt());me("la navegación",()=>{je&&Ze&&$r(je,Ze)});me("los gráficos de estadística descriptiva",qr);me("los créditos de las calculadoras",Ur);me("la integración de regresión con el asistente",Kr);me("cuestionarios y fiabilidad en el asistente",Jr);me("la calculadora de una muestra",tn);me("la calculadora de proporciones relacionadas",un);export{_t as M,q as _,z as i};
