        ...
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${Lt("p",Pp(t.valorP),"Valor bilateral")}
...
17`,l(),Pa(n),a.classList.add("hidden");return}s==="limpiar"&&(e.reset(),i.value="",u.value="",l(),Pa(n),a.innerHTML="",a.classList.add("hidden"))}),t}function Ia(t,e){return`
        ...
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${$t("p",qp(t.valorP),"Valor bilateral")}
    ...
    `}function Bp(t){return Number.isFinite(t)?t>0?"La dirección estimada favorece valores mayores en la medición 1.":t<0?"La dirección estimada favorece valores mayores en la medición 2.":"La diferencia central estimada es igual a cero.":""}function $t(t,e,n){return`
        <article class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
...
88`}];[...e.querySelectorAll("[data-grupo]")].forEach((a,i)=>{a.querySelector("[data-nombre-grupo]").value=n[i].nombre,a.querySelector("[data-valores-grupo]").value=n[i].valores,Ni(a)}),t.elements.prueba.value||(t.elements.prueba.value="anova-un-factor")}function dr(t,e){t.textContent=e,t.classList.remove("hidden")}function rt(t){t.textContent="",t.classList.add("hidden")}function pe(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function S(t,e=4){return t===1/0?"∞":Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):"—"}function Oi(t){return Number.isFinite(t)?t<.001?"< 0.001":S(t,4):"—"}function um(t){const e=t.alfa.toFixed(2),n=Math.round(t.nivelConfianza*100),a=t.significativo?`Se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${e}, correspondiente a un nivel de confianza del ${n} %.`:`No se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${e}, correspondiente a un nivel de confianza del ${n} %.`;return`
        <section class="rounded-3xl border border-indigo-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                    ${Rt(t.estadistico.simbolo,S(t.estadistico.valor),"Estadístico global")}
                    ${Rt("p",Oi(t.valorP),"Valor de significación")}
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ${t.grupos.map(n=>`
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-right">${S(n.media)}</td>
                                        <td class="px-4 py-4 text-right">${S(n.mediana)}</td>
                                        <td class="px-4 py-4 text-right">${S(n.desviacionEstandar)}</td>
                                        <td class="px-4 py-4 text-right">${S(n.varianza)}</td>
                                        <td class="px-4 py-4 text-right">${S(n.minimo)}</td>
                                        <td class="px-4 py-4 text-right">${S(n.maximo)}</td>
                                        ${e?`<td class="px-4 py-4 text-right">${S(n.rangoMedio)}</td>`:""}
                                    </tr>
                                `).join("")}
                    </tbody>
                </table>
        ...
        `}return t.id==="anova-welch"?`
            <article class="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-6">
                ...
                <dl class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ${re("gl del numerador",S(t.gradosLibertad.numerador))}
                    ${re("gl del denominador",S(t.gradosLibertad.denominador))}
                    ${re("Media ponderada",S(t.mediaPonderada))}
                    ${re("Factor de corrección",S(t.componentesWelch.denominadorCorreccion))}
                </dl>
            </article>
        `:`
        <article class="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-6">
            ...
            <dl class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ${re("Grados de libertad",S(t.gradosLibertad.valor))}
                ${re("H sin corrección",S(t.estadistico.sinCorreccion))}
                ${re("Factor por empates",S(t.empates.factorCorreccion))}
    ...
    `:""}function bm(t){const e=t.diferenciaMedias??t.diferenciaRangos,n=t.estadisticoQ??t.estadisticoZ,a=t.valorPAjustado??t.valorP,i=t.intervaloConfianza?`${S(t.intervaloConfianza.inferior)} a ${S(t.intervaloConfianza.superior)}`:"—";return`
        <tr>
            <td class="px-5 py-4 font-bold text-slate-900">
...
20`];[...e.querySelectorAll("[data-medicion]")].forEach((u,d)=>{u.querySelector('[data-campo="nombre"]').value=n[d],u.querySelector('[data-campo="valores"]').value=a[d],Bi(u)})}function Bi(t){const e=t.querySelector('[data-campo="valores"]'),n=t.querySelector("[data-contador]"),a=e.value.trim()?e.value.trim().split(/[\s;]+/).filter(Boolean).length:0;n.textContent=a===1?"1 valor":`${a} valores`}document.addEventListener("input",t=>{const e=t.target.closest('#formulario-mediciones-relacionadas [data-campo="valores"]');if(!e)return;const n=e.closest("[data-medicion]");n&&Bi(n)});function mr(t,e){t.textContent=e,t.classList.remove("hidden")}function Ra(t){t.textContent="",t.classList.add("hidden")}function le(t,e=4){return Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):t===1/0?"∞":"—"}function jt(t){return Number.isFinite(t)?t<.001?"< 0.001":le(t,4):"—"}function zm(t){const e=t.id==="anova-medidas-repetidas",n=e?t.esfericidad.greenhouseGeisser.valorP:t.valorP,a=n<t.alfa,i=Math.round(t.nivelConfianza*100),u=e?"Greenhouse–Geisser":"sin corrección adicional",d=a?`Se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${t.alfa.toFixed(2)}. Para la decisión principal se utilizó ${u}.`:`No se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${t.alfa.toFixed(2)}. Para la decisión principal se utilizó ${u}.`;return`
    ...
    `:""}const Bm={home:{page:uo,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:Lo,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:zo,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Bo,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:ns,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:cs,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:As,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:hs,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Ns,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:qs,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Vu,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Zu,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},comparacionGrupos:{page:up,layout:"default",title:"Comparación de grupos y mediciones | El Kernel"},calculadoraDosGrupos:{page:Cp,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:Mp,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"},calculadoraTresOMasGrupos:{page:om,layout:"default",title:"Comparación de tres o más grupos independientes | El Kernel"},calculadoraTresOMasMedicionesRelacionadas:{page:Dm,layout:"default",title:"Comparación de tres o más mediciones relacionadas | El Kernel"}};let fr=document.referrer||"";function ca(t){window.location.hash=`/${t}`}function Vm(){const t=()=>{const e=window.location.hash.replace("#/","")||"home";Hm(e)};window.addEventListener("hashchange",t),t()}function Gm(t,e){const n=`${window.location.origin}${window.location.pathname}#/${t}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:e,page_location:n,page_referrer:fr}),fr=n}async function Hm(t){const e=document.querySelector("main"),n=Bm[t];if(!e)return;if(e.innerHTML="",!n){ca("home");return}Mo(n.layout),document.title=n.title;const a=await n.page();e.appendChild(a),window.scrollTo({top:0,behavior:"auto"}),Gm(t,n.title)}function Wm(t,e){gr(t,ca),Vm();const n=window.matchMedia("(max-width: 768px)");let a=!1;function i(d){d.matches&&!a&&(cn(t),a=!0)}n.addEventListener("change",i),i(n),cn(t);const u=e.querySelector('[data-action ="open-menu"]');ji(u,t),Ji(t)}const Vi=document.querySelector("#header");Vi.innerHTML=Hi();const Gi=document.querySelector("#navBar");Gi.innerHTML=Wi();const Km=document.querySelector("#footer");Km.innerHTML=Ki();Wm(Gi,Vi);
