(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const F=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function me(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return Ce(t.querySelector("#containerFather")),ye(t.querySelector("#btnsGroup")),t}function Se(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=`${we()}`;const a=Ee();return e.appendChild(a),e}function Me(){return Se()}const De=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Le(){return`
        <section 
            role="banner" 
    ...
    `}const Te="data:image/png;base64,",Be="data:image/png;base64,",Ue="data:image/png;base64,",Oe="data:image/png;base64,",qe="data:image/png;base64,",Ne=[{icon:Te,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:Be,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:Ue,title:"Objetivos",content:`
      ...
      </ul>`},{icon:Oe,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Fe({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${qe}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function Ge(){const e=document.createElement("section");return e.className=`
    ...
    `;const t=He(e.redes||[]),i=Qe(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
...
Gracias.`);return`
    ...
    `}function ka(e){if(!e)return`
        ...
        `;const a=re(e),t=ya(e),i=t.length,o=t.map(l=>Number(l.year)).filter(Boolean),s=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",m=[...new Set(t.map(l=>l.q).filter(Boolean))],b=[...new Set(t.map(l=>X(l)).filter(Boolean))],u=t.map(l=>{const f=X(l),d=le(l),c=wa(l);return`
    ...
    `}function Ca(){let e=E[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(r){return String(r?.DOI||r?.doi||"").trim().toLowerCase()}function s(r){return String(r?.journal||r?.title||r?.tile||"").trim()}function n(r){return String(r?.articleTitle||r?.contenido||"").trim()}function m(r){return String(r?.q||r?.quartile||"").trim().toUpperCase()}function b(r){const x=o(r);return x||[r?.year||"",s(r),n(r)].join("-").trim().toLowerCase()}function u(){const r=new Map;return E.forEach(x=>{(x.publicaciones||[]).forEach(p=>{const g=b(p);g&&!r.has(g)&&r.set(g,p)})}),Array.from(r.values())}function l(){const r=u(),x=r.map(A=>Number(A.year)).filter(Boolean),p=x.length?Math.max(...x):"—",g=x.length?Math.min(...x):"—",v=r.filter(A=>m(A)==="Q1").length;return{totalPublicaciones:r.length,investigadores:E.length,q1:v,primerYear:g,ultimoYear:p}}function f(){return E.find(r=>Number(r.id)===Number(e))||E[0]}const d=()=>{const r=f(),x=l(),p=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${E.map(v=>Aa(v,Number(v.id)===Number(e))).join("")}
                </aside>
    ...
    `}function ja(){const e=new Set(L.map(i=>i.categoria)),a=L.filter(i=>i.proyectosAsociados?.length>0).length,t=L.filter(i=>i.publicacionesClave?.length>0).length;return{total:L.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function Pa(){let e=L[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Sa(e),o=ja();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${h(e.institucion)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Tipo</p>
                        <p class="text-slate-800 font-bold mt-1">${h(e.tipo)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Duración estimada</p>
                        <p class="text-slate-800 font-bold mt-1">${h(e.duracion)}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        ...
                        <p class="text-slate-700 font-semibold mt-1">${h(e.fechaInicio)}</p>
                    </div>

                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Fecha final prevista</p>
                        <p class="text-slate-700 font-semibold mt-1">${h(e.fechaFinalizacion)}</p>
                    </div>
                </div>
    ...
    `}function qa(){let e=z[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=za(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function Na(){return qa()}function Ra(){return`
    ...
    `,e}function et(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),s=e.querySelector("#open-segundo-periodo"),n=e.querySelector("#open-calificacion-final"),m=e.querySelector("#banner-back");function b(l){i.innerHTML="";try{const f=l();if(!(f instanceof HTMLElement))throw new Error("El componente seleccionado no devolvió un elemento HTML válido.");i.appendChild(f),a.classList.add("hidden"),t.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"start"})}catch(f){console.error("No fue posible abrir la herramienta de Banner:",f),i.innerHTML=`
            ...
            `,a.classList.add("hidden"),t.classList.remove("hidden")}}function u(){i.innerHTML="",t.classList.add("hidden"),a.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"start"})}return o.addEventListener("click",()=>{b(Xa)}),s.addEventListener("click",()=>{b(Za)}),n.addEventListener("click",()=>{b(_a)}),m.addEventListener("click",u),e}function at(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
        <div class="mb-8 text-center">
...
20252000     0"
    ...
    `;const a=e.querySelector("#xmera-input"),t=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),s=e.querySelector("#xmera-clear"),n=e.querySelector("#xmera-message"),m=e.querySelector("#tab-xmera"),b=e.querySelector("#tab-banner"),u=e.querySelector("#panel-xmera"),l=e.querySelector("#panel-banner");function f(){t.textContent=`var data_todo = {
};`,o.disabled=!0}function d(p,g="success"){n.textContent=p,n.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),n.classList.add("border"),g==="error"?n.classList.add("border-red-200","bg-red-50","text-red-800"):n.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function c(p){const g=p.split(/\r?\n/).map(N=>N.trim()).filter(Boolean),v=[],A=[],K=new Set;return g.forEach((N,pe)=>{const V=N.split(/[\t,; ]+/).map($=>$.trim()).filter(Boolean),P=pe+1,I=V[0],H=V.slice(1);if(!I){A.push(`Línea ${P}: falta la matrícula.`);return}if(!/^\d+$/.test(I)){A.push(`Línea ${P}: la matrícula "${I}" no es válida.`);return}if(K.has(I)){A.push(`Línea ${P}: la matrícula ${I} está repetida.`);return}if(H.length===0){A.push(`Línea ${P}: falta al menos una calificación.`);return}const Q=H.map($=>Number($));if(Q.some($=>!Number.isFinite($))){A.push(`Línea ${P}: existe una calificación no numérica.`);return}K.add(I),v.push({matricula:I,grades:Q})}),{records:v,errors:A}}function r(p){return`var data_todo = {
${p.map(({matricula:v,grades:A})=>`  "${v}":[${A.join(",")}]`).join(`,
`)}
};
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function x(p){const g=p==="xmera";u.classList.toggle("hidden",!g),l.classList.toggle("hidden",g),m.className=g?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",b.className=g?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const p=a.value.trim();if(!p){f(),d("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:g,errors:v}=c(p);if(v.length>0){f(),d(v.join(" "),"error");return}t.textContent=r(g),o.disabled=!1,d(`Código generado correctamente para ${g.length} estudiante${g.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),d("El código fue copiado al portapapeles.")}catch(p){console.error("No fue posible copiar el código:",p),d("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),s.addEventListener("click",()=>{a.value="",f(),n.textContent="",n.classList.add("hidden"),a.focus()});try{const p=et();if(p instanceof HTMLElement)l.appendChild(p);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(p){console.error("No fue posible cargar el módulo Banner:",p),l.innerHTML=`
            <div class="rounded-2xl border border-red-200 bg-red-50 p-5 text-red-800">
                <p class="font-black">
        ...
        `}return m.addEventListener("click",()=>{x("xmera")}),b.addEventListener("click",()=>{x("banner")}),x("xmera"),e}function tt(){return at()}const it={home:{page:Me,layout:"default"},quienesSomos:{page:Ve,layout:"full"},equipment:{page:_e,layout:"default"},FormacionAcademica:{page:oa,layout:"default"},noticias:{page:ha,layout:"full"},publicaciones:{page:Ea,layout:"default"},proyectos:{page:Na,layout:"default"},lineas:{page:$a,layout:"default"},contacto:{page:Wa,layout:"default"},herramientas:{page:tt,layout:"default"}};function J(e){window.location.hash=`/${e}`}function ot(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";st(a)};window.addEventListener("hashchange",e),e()}function st(e){const a=document.querySelector("main"),t=it[e];a&&(a.innerHTML="",t&&(ea(t.layout),a.appendChild(t.page())))}function nt(e,a){_(e,J),ot();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(Y(e),i=!0)}t.addEventListener("change",o),o(t),Y(e);const s=a.querySelector('[data-action ="open-menu"]');ge(s,e),be(e)}const ce=document.querySelector("#header");ce.innerHTML=me();const de=document.querySelector("#navBar");de.innerHTML=ue();const rt=document.querySelector("#footer");rt.innerHTML=xe();nt(de,ce);
