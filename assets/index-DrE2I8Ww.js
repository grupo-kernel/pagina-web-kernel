...
>
  ...
  `}function hc(){const e=document.createElement("section");return e.className=`
    ...
    `}function ze(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Oc({id:e,title:a,date:r,image:t,imageAlt:n,excerpt:c,category:s="Noticia",imageFit:p="contain"}){const u=p==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${ze(e)}"
            class="
        ...
        >
            ...
            <div class="p-4 space-y-3 flex flex-col flex-1">
                ...
                <button
                    type="button"
                    data-news-btn="${ze(e)}"
                    aria-label="Ver detalles de la noticia ${ze(a)}"
                    class="
...
if (!contenedor) {
  ...
  `;const r=a.querySelector("#kernel-login"),t=a.querySelector("#login-error"),n=a.querySelector("#correo"),c=a.querySelector("#password"),s=r.querySelector('button[type="submit"]');return r.addEventListener("submit",async p=>{p.preventDefault(),t.classList.add("hidden"),t.textContent="";const u=n.value.trim(),l=c.value;if(!u||!l){t.textContent="Introduzca el correo electrónico y la contraseña.",t.classList.remove("hidden");return}s.disabled=!0,s.textContent="Verificando...";try{await Lf(u,l),e&&await e()}catch(i){console.error("Error de autenticación:",i);const o={"auth/invalid-email":"El correo electrónico no tiene un formato válido.","auth/invalid-credential":"El correo o la contraseña son incorrectos.","auth/user-not-found":"El correo no está autorizado.","auth/wrong-password":"El correo o la contraseña son incorrectos.","auth/user-disabled":"Este usuario está deshabilitado.","auth/too-many-requests":"Demasiados intentos. Espere unos minutos e inténtelo nuevamente.","auth/network-request-failed":"No fue posible conectarse con Firebase. Revise su conexión.","auth/unauthorized-domain":"El dominio de Grupo Kernel no está autorizado en Firebase."};t.textContent=o[i.code]||`No fue posible iniciar sesión. Error: ${i.code||"desconocido"}`,t.classList.remove("hidden")}finally{s.disabled=!1,s.textContent="Iniciar sesión"}}),a}function Nf(){return new Promise(e=>{const a=Mf(r=>{a(),e(r)})})}async function Sf(){if(!await Nf())return Tf(()=>{window.dispatchEvent(new HashChangeEvent("hashchange"))});const a=document.createElement("section");return a.className=`
    ...
    `}function sb(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
14.5`,i(),Wr(r),t.classList.add("hidden");return}m==="limpiar"&&(a.reset(),s.value="",p.value="",i(),Wr(r),t.innerHTML="",t.classList.add("hidden"))}),e}function eo(e,a){const r=e.trim();if(!r)throw new Error(`${a} no contiene datos.`);const t=r.split(/[\s;]+/).filter(Boolean),n=t.map(s=>Number(s.replace(",","."))),c=n.findIndex(s=>!Number.isFinite(s));if(c!==-1)throw new Error(`${a} contiene un valor no válido: "${t[c]}".`);if(n.length<2)throw new Error(`${a} debe contener al menos dos observaciones.`);return n}function ao(e){return e.trim()?e.trim().split(/[\s;]+/).filter(Boolean).length:0}function to(e){return e===1?"1 valor":`${e} valores`}function kb(e,a){e.textContent=a,e.classList.remove("hidden")}function Wr(e){e.textContent="",e.classList.add("hidden")}function H(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):"—"}function Eb(e){return Number.isFinite(e)?e<.001?"< 0.001":H(e,4):"—"}function Cb(e,a=.95){const r=1-a,t=e.valorP<r,n=r.toFixed(2),c=Math.round(a*100),s=t?`Se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${n}, correspondiente a un nivel de confianza del ${c} %.`:`No se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${n}, correspondiente a un nivel de confianza del ${c} %.`;return`
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${At("p",Eb(e.valorP),"Valor bilateral")}
    ...
    `}function $b(e){if(e.id==="mann-whitney")return`
...
17`,l(),Yr(r),t.classList.add("hidden");return}d==="limpiar"&&(a.reset(),n.value="",c.value="",l(),Yr(r),t.innerHTML="",t.classList.add("hidden"))}),e}function Kr(e,a){return`
    ...
    `}function so(e,a){const r=e.trim();if(!r)throw new Error(`${a} no contiene datos.`);const t=r.split(/[\s;]+/).filter(Boolean),n=t.map(s=>Number(s.replace(",","."))),c=n.findIndex(s=>!Number.isFinite(s));if(c!==-1)throw new Error(`${a} contiene un valor no válido: "${t[c]}".`);if(n.length<2)throw new Error(`${a} debe contener al menos dos observaciones.`);return n}function lo(e){return e.trim()?e.trim().split(/[\s;]+/).filter(Boolean).length:0}function co(e){return e===1?"1 valor":`${e} valores`}function _b(e,a){e.textContent=a,e.classList.remove("hidden")}function Yr(e){e.textContent="",e.classList.add("hidden")}function U(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):"—"}function zb(e){return Number.isFinite(e)?e<.001?"< 0.001":U(e,4):"—"}function Db(e,a=.95){const r=1-a,t=e.valorP<r,n=r.toFixed(2),c=Math.round(a*100),s=e.id==="t-student-relacionadas"?e.diferenciaMedia:e.diferencias.mediana,p=qb(s),u=t?`Se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${n}, correspondiente a un nivel de confianza del ${c} %. ${p}`:`No se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${n}, correspondiente a un nivel de confianza del ${c} %. ${p}`;return`
    ...
    `}function qb(e){return Number.isFinite(e)?e>0?"La dirección estimada favorece valores mayores en la medición 1.":e<0?"La dirección estimada favorece valores mayores en la medición 2.":"La diferencia central estimada es igual a cero.":""}function It(e,a,r){return`
        <article class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
    ...
    `}function Fb(e){if(e.id==="wilcoxon-relacionadas")return`
    ...
    `}const ia=va.jStat??Ua?.jStat;if(!ia)throw new Error("No fue posible cargar el motor estadístico jStat.");const Er=e=>Math.min(1,Math.max(0,e));function Gn(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function Ub(e){return typeof e=="string"?e.trim()===""?Number.NaN:Number(e.trim().replace(",",".")):Number(e)}const ll=e=>e.reduce((a,r)=>a+r,0)/e.length;function jb(e){const a=[...e].sort((t,n)=>t-n),r=Math.floor(a.length/2);return a.length%2?a[r]:(a[r-1]+a[r])/2}function Vb(e,a=ll(e)){return e.reduce((r,t)=>r+(t-a)**2,0)/(e.length-1)}function Bb(e){const a=ll(e),r=Vb(e,a);return{n:e.length,media:a,mediana:jb(e),varianza:r,desviacionEstandar:Math.sqrt(r),minimo:Math.min(...e),maximo:Math.max(...e)}}function Gb(e,a){const r=Array.isArray(e),t=r?e:e?.valores;if(!Array.isArray(t))throw new TypeError(`El grupo ${a+1} debe contener un arreglo llamado valores.`);const n=t.map(Ub),c=n.findIndex(p=>!Number.isFinite(p));if(c!==-1)throw new TypeError(`El grupo ${a+1} contiene un valor no numérico en la posición ${c+1}.`);if(n.length<2)throw new RangeError(`El grupo ${a+1} debe contener al menos dos observaciones.`);return{nombre:(r?"":String(e?.nombre??"").trim())||`Grupo ${a+1}`,valores:n,...Bb(n)}}function Hn(e){if(!Array.isArray(e))throw new TypeError("Los grupos deben proporcionarse mediante un arreglo.");if(e.length<3)throw new RangeError("El análisis requiere al menos tres grupos independientes.");const a=e.map(Gb),r=a.map(({nombre:t})=>t);if(new Set(r).size!==r.length)throw new Error("Cada grupo debe tener un nombre diferente.");return a}function Wn(e){const a=e.reduce((t,n)=>t+n.n,0),r=e.reduce((t,n)=>t+n.valores.reduce((c,s)=>c+s,0),0);return{numeroGrupos:e.length,nTotal:a,mediaGeneral:r/a}}function cl(e,a,r){return e===1/0?0:Er(1-ia.centralF.cdf(e,a,r))}function Hb(e,a){return Er(1-ia.chisquare.cdf(e,a))}function dl(){if(!ia.tukey?.cdf||!ia.tukey?.inv)throw new Error("La distribución de Tukey no está disponible en la versión instalada de jStat.")}function ul(e,a,r){return dl(),e===1/0?0:Er(1-ia.tukey.cdf(e,a,r))}function pl(e,a,r){return dl(),ia.tukey.inv(e,a,r)}function Kn(e){const a=Math.abs(e);return a<.01?"Prácticamente nulo":a<.06?"Pequeño":a<.14?"Moderado":"Grande"}function Yn(e,a){const r=[];for(let t=0;t<e.length-1;t+=1)for(let n=t+1;n<e.length;n+=1)r.push(a(e[t],e[n],t,n));return r}function Wb(e,a,r,t){const n=1-t,c=e.length,s=pl(t,c,r);return{id:"tukey-kramer",nombre:"Comparaciones de Tukey–Kramer",metodo:"Rango studentizado con control del error familiar.",recomendado:!1,comparaciones:Yn(e,(p,u)=>{const l=p.media-u.media,i=Math.sqrt(a/2*(1/p.n+1/u.n)),o=i===0?l===0?0:1/0:Math.abs(l)/i,d=ul(o,c,r),m=s*i;return{grupo1:p.nombre,grupo2:u.nombre,diferenciaMedias:l,errorEstandar:i,estadisticoQ:o,gradosLibertad:r,valorP:d,valorPAjustado:d,intervaloConfianza:{nivel:t,inferior:l-m,superior:l+m,margen:m},significativo:d<n}})}}function Kb(e,a){const r=1-a,t=e.length;return{id:"games-howell",nombre:"Comparaciones de Games–Howell",metodo:"Comparaciones pareadas robustas ante varianzas y tamaños desiguales.",recomendado:!1,comparaciones:Yn(e,(n,c)=>{const s=n.media-c.media,p=n.varianza/n.n,u=c.varianza/c.n,l=p+u,i=Math.sqrt(l/2),o=l**2/(p**2/(n.n-1)+u**2/(c.n-1)),d=i===0?s===0?0:1/0:Math.abs(s)/i,m=ul(d,t,o),f=pl(a,t,o)*i;return{grupo1:n.nombre,grupo2:c.nombre,diferenciaMedias:s,errorEstandar:i,estadisticoQ:d,gradosLibertad:o,valorP:m,valorPAjustado:m,intervaloConfianza:{nivel:a,inferior:s-f,superior:s+f,margen:f},significativo:m<r}})}}function Yb(e){const a=e.map(c=>({...c,rango:0})).sort((c,s)=>c.valor-s.valor);let r=0,t=0,n=0;for(;r<a.length;){let c=r+1;for(;c<a.length&&a[c].valor===a[r].valor;)c+=1;const s=c-r,p=(r+1+c)/2;for(let u=r;u<c;u+=1)a[u].rango=p;s>1&&(n+=1,t+=s**3-s),r=c}return{observaciones:a,sumaCorreccionEmpates:t,cantidadGruposEmpatados:n}}function Jb(e){const a=e.map((t,n)=>({...t,indiceOriginal:n})).sort((t,n)=>t.valorP-n.valorP);let r=0;return a.forEach((t,n)=>{const c=Math.min(1,t.valorP*(a.length-n));t.valorPAjustado=Math.max(r,c),r=t.valorPAjustado}),a.sort((t,n)=>t.indiceOriginal-n.indiceOriginal).map(({indiceOriginal:t,...n})=>n)}function Qb(e,a,r,t,n){const c=1-n,s=r*(r+1)/12-t/(12*(r-1)),p=Yn(e,(u,l,i,o)=>{const d=a[i]/u.n,m=a[o]/l.n,f=d-m,g=Math.sqrt(s*(1/u.n+1/l.n)),b=g===0?0:f/g,x=Er(2*(1-ia.normal.cdf(Math.abs(b),0,1)));return{grupo1:u.nombre,grupo2:l.nombre,rangoMedio1:d,rangoMedio2:m,diferenciaRangos:f,errorEstandar:g,estadisticoZ:b,valorP:x,tamanioEfectoR:b/Math.sqrt(r)}});return{id:"dunn-holm",nombre:"Comparaciones de Dunn con ajuste de Holm",metodo:"Comparaciones de rangos con corrección secuencial de Holm.",recomendado:!1,comparaciones:Jb(p).map(u=>({...u,significativo:u.valorPAjustado<c}))}}function Xb(e,a={}){const{nivelConfianza:r=.95}=a;Gn(r);const t=Hn(e),n=Wn(t),c=t.reduce((h,w)=>h+w.n*(w.media-n.mediaGeneral)**2,0),s=t.reduce((h,w)=>h+w.valores.reduce((k,E)=>k+(E-w.media)**2,0),0),p=c+s,u=t.length-1,l=n.nTotal-t.length,i=c/u,o=s/l,d=o===0?i===0?0:1/0:i/o,m=cl(d,u,l),f=p===0?0:c/p,g=p+o===0?0:(c-u*o)/(p+o),b=Math.max(0,g),x=1-r,y=m<x,v=Wb(t,o,l,r);return v.recomendado=y,{id:"anova-un-factor",nombre:"ANOVA de un factor",metodo:"ANOVA clásico para tres o más grupos independientes con varianzas homogéneas.",grupos:t,...n,estadistico:{simbolo:"F",valor:d},gradosLibertad:{numerador:u,denominador:l},valorP:m,nivelConfianza:r,alfa:x,significativo:y,tablaAnova:{entreGrupos:{sumaCuadrados:c,gradosLibertad:u,cuadradoMedio:i},dentroGrupos:{sumaCuadrados:s,gradosLibertad:l,cuadradoMedio:o},total:{sumaCuadrados:p,gradosLibertad:n.nTotal-1}},tamanioEfecto:{etaCuadrado:f,omegaCuadrado:b,interpretacion:Kn(b)},postHoc:v}}function Zb(e,a={}){const{nivelConfianza:r=.95}=a;Gn(r);const t=Hn(e),n=Wn(t),c=t.find(({varianza:w})=>w<=0);if(c)throw new Error(`El ANOVA de Welch requiere varianza positiva en cada grupo. Revise ${c.nombre}.`);const s=t.map(w=>({...w,peso:w.n/w.varianza})),p=s.reduce((w,k)=>w+k.peso,0),u=s.reduce((w,k)=>w+k.peso*k.media,0)/p,l=t.length,i=l-1,o=s.reduce((w,k)=>w+k.peso*(k.media-u)**2,0)/i,d=s.reduce((w,k)=>w+(1-k.peso/p)**2/(k.n-1),0),m=1+2*(l-2)/(l**2-1)*d,f=o/m,g=(l**2-1)/(3*d),b=cl(f,i,g),x=Math.max(0,i*(f-1)/(i*f+g+1)),y=1-r,v=b<y,h=Kb(t,r);return h.recomendado=v,{id:"anova-welch",nombre:"ANOVA de Welch",metodo:"ANOVA robusto para tres o más grupos independientes sin exigir igualdad de varianzas.",grupos:t,...n,mediaPonderada:u,sumaPesos:p,estadistico:{simbolo:"F_W",valor:f},gradosLibertad:{numerador:i,denominador:g},valorP:b,nivelConfianza:r,alfa:y,significativo:v,componentesWelch:{numeradorBase:o,terminoCorreccion:d,denominadorCorreccion:m},tamanioEfecto:{omegaCuadradoAproximado:x,interpretacion:Kn(x),nota:"Estimación aproximada basada en el estadístico F de Welch y sus grados de libertad."},postHoc:h}}function eg(e,a={}){const{nivelConfianza:r=.95}=a;Gn(r);const t=Hn(e),n=Wn(t),c=t.flatMap((y,v)=>y.valores.map(h=>({valor:h,indiceGrupo:v}))),s=Yb(c),p=new Array(t.length).fill(0);s.observaciones.forEach(({indiceGrupo:y,rango:v})=>{p[y]+=v});const u=12/(n.nTotal*(n.nTotal+1))*t.reduce((y,v,h)=>y+p[h]**2/v.n,0)-3*(n.nTotal+1),l=1-s.sumaCorreccionEmpates/(n.nTotal**3-n.nTotal),i=l<=0?0:u/l,o=t.length-1,d=Hb(i,o),m=Math.max(0,(i-t.length+1)/(n.nTotal-t.length)),f=1-r,g=d<f,b=t.map((y,v)=>({...y,sumaRangos:p[v],rangoMedio:p[v]/y.n})),x=Qb(t,p,n.nTotal,s.sumaCorreccionEmpates,r);return x.recomendado=g,{id:"kruskal-wallis",nombre:"Prueba de Kruskal–Wallis",metodo:"Comparación no paramétrica de tres o más grupos independientes mediante rangos.",grupos:b,...n,estadistico:{simbolo:"H",valor:i,sinCorreccion:u},gradosLibertad:{valor:o},valorP:d,nivelConfianza:r,alfa:f,significativo:g,empates:{factorCorreccion:l,sumaCorreccion:s.sumaCorreccionEmpates,cantidadGruposEmpatados:s.cantidadGruposEmpatados},tamanioEfecto:{epsilonCuadrado:m,interpretacion:Kn(m)},postHoc:x}}function ag({grupos:e,prueba:a,nivelConfianza:r=.95}){switch(a){case"anova-un-factor":case"anova":return Xb(e,{nivelConfianza:r});case"anova-welch":case"welch":return Zb(e,{nivelConfianza:r});case"kruskal-wallis":return eg(e,{nivelConfianza:r});default:throw new Error("La prueba solicitada no está disponible.")}}function tg(){const e=document.createElement("section");e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
74"
    ...
    `}function rg(e){return[...e.querySelectorAll("[data-grupo]")].map((a,r)=>{const t=a.querySelector("[data-nombre-grupo]").value.trim();if(!t)throw new Error(`El grupo ${r+1} debe tener un nombre.`);const n=a.querySelector("[data-valores-grupo]").value;return{nombre:t,valores:ng(n,t)}})}function ng(e,a){const r=e.trim();if(!r)throw new Error(`${a} no contiene datos.`);const t=r.split(/[\s;]+/).filter(Boolean),n=t.map(s=>Number(s.replace(",","."))),c=n.findIndex(s=>!Number.isFinite(s));if(c!==-1)throw new Error(`${a} contiene un valor no válido: "${t[c]}".`);if(n.length<2)throw new Error(`${a} debe contener al menos dos observaciones.`);return n}function ig(e){return e.trim()?e.trim().split(/[\s;]+/).filter(Boolean).length:0}function ml(e){if(!e)return;const a=e.querySelector("[data-valores-grupo]"),r=e.querySelector("[data-contador-grupo]"),t=ig(a.value);r.textContent=t===1?"1 valor":`${t} valores`}function og(e,a){a.innerHTML=`
        ${Ce(1)}
        ${Ce(2)}
        ${Ce(3)}
...
88`}];[...a.querySelectorAll("[data-grupo]")].forEach((t,n)=>{t.querySelector("[data-nombre-grupo]").value=r[n].nombre,t.querySelector("[data-valores-grupo]").value=r[n].valores,ml(t)}),e.elements.prueba.value||(e.elements.prueba.value="anova-un-factor")}function po(e,a){e.textContent=a,e.classList.remove("hidden")}function Ga(e){e.textContent="",e.classList.add("hidden")}function Me(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function B(e,a=4){return e===1/0?"∞":Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):"—"}function fl(e){return Number.isFinite(e)?e<.001?"< 0.001":B(e,4):"—"}function sg(e){const a=e.alfa.toFixed(2),r=Math.round(e.nivelConfianza*100),t=e.significativo?`Se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${a}, correspondiente a un nivel de confianza del ${r} %.`:`No se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${a}, correspondiente a un nivel de confianza del ${r} %.`;return`
    ...
    `}function lg(e){const a=e.id==="kruskal-wallis";return`
    ...
    `}function cg(e){if(e.id==="anova-un-factor"){const a=e.tablaAnova;return`
    ...
    `}function dg(e){let a;return e.id==="anova-un-factor"?a=[["Eta cuadrado, η²",e.tamanioEfecto.etaCuadrado],["Omega cuadrado, ω²",e.tamanioEfecto.omegaCuadrado]]:e.id==="anova-welch"?a=[["Omega cuadrado aproximado",e.tamanioEfecto.omegaCuadradoAproximado]]:a=[["Épsilon cuadrado, ε²",e.tamanioEfecto.epsilonCuadrado]],`
        <article class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-6">
            <h3 class="text-xl font-black text-amber-950 mb-5">
                Tamaño del efecto
            </h3>
    ...
    `}function ug(e){const a=e.postHoc;return a?.comparaciones?.length?`
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[980px] text-sm">
                    ...
                    <tbody class="divide-y divide-fuchsia-100">
                        ${a.comparaciones.map(pg).join("")}
                    </tbody>
                </table>
            </div>
        </article>
    `:""}function pg(e){const a=e.diferenciaMedias??e.diferenciaRangos,r=e.estadisticoQ??e.estadisticoZ,t=e.valorPAjustado??e.valorP,n=e.intervaloConfianza?`${B(e.intervaloConfianza.inferior)} a ${B(e.intervaloConfianza.superior)}`:"—";return`
        <tr>
            <td class="px-5 py-4 font-bold text-slate-900">
    ...
    `}const Jn=va.jStat??Ua?.jStat;if(!Jn)throw new Error("No fue posible cargar el motor estadístico jStat.");const bl=e=>Math.min(1,Math.max(0,e));function gl(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function mg(e){return typeof e=="string"?e.trim()===""?Number.NaN:Number(e.trim().replace(",",".")):Number(e)}function ct(e){return e.reduce((a,r)=>a+r,0)/e.length}function fg(e){const a=[...e].sort((t,n)=>t-n),r=Math.floor(a.length/2);return a.length%2?a[r]:(a[r-1]+a[r])/2}function bg(e,a=ct(e)){return e.reduce((r,t)=>r+(t-a)**2,0)/(e.length-1)}function gg(e){const a=ct(e),r=bg(e,a);return{n:e.length,media:a,mediana:fg(e),varianza:r,desviacionEstandar:Math.sqrt(r),minimo:Math.min(...e),maximo:Math.max(...e)}}function hg(e,a){const r=Array.isArray(e),t=r?e:e?.valores;if(!Array.isArray(t))throw new TypeError(`La medición ${a+1} debe contener un arreglo llamado valores.`);const n=t.map(mg),c=n.findIndex(p=>!Number.isFinite(p));if(c!==-1)throw new TypeError(`La medición ${a+1} contiene un valor no numérico en la posición ${c+1}.`);if(n.length<2)throw new RangeError(`La medición ${a+1} debe contener al menos dos observaciones.`);return{nombre:(r?"":String(e?.nombre??"").trim())||`Medición ${a+1}`,valores:n,...gg(n)}}function hl(e){if(!Array.isArray(e))throw new TypeError("Las mediciones deben proporcionarse mediante un arreglo.");if(e.length<3)throw new RangeError("El análisis requiere al menos tres mediciones relacionadas.");const a=e.map(hg),r=a[0].n;if(a.find(({n:c})=>c!==r))throw new RangeError("Todas las mediciones deben contener el mismo número de observaciones y conservar el mismo orden de participantes.");const n=a.map(({nombre:c})=>c);if(new Set(n).size!==n.length)throw new Error("Cada medición debe tener un nombre diferente.");return a}function xl(e){const a=e[0].n;return Array.from({length:a},(r,t)=>e.map(({valores:n})=>n[t]))}function Xr(e,a,r){return e===1/0?0:bl(1-Jn.centralF.cdf(e,a,r))}function xg(e,a){return bl(1-Jn.chisquare.cdf(e,a))}function vl(e){const a=e.map((t,n)=>({...t,indiceOriginal:n})).sort((t,n)=>t.valorP-n.valorP);let r=0;return a.forEach((t,n)=>{const c=Math.min(1,t.valorP*(a.length-n));t.valorPAjustado=Math.max(r,c),r=t.valorPAjustado}),a.sort((t,n)=>t.indiceOriginal-n.indiceOriginal).map(({indiceOriginal:t,...n})=>n)}function yl(e,a){const r=[];for(let t=0;t<e.length-1;t+=1)for(let n=t+1;n<e.length;n+=1)r.push(a(e[t],e[n],t,n));return r}function Zr(e,a){const r=e.length,t=a[0].length,n=a.length;return Array.from({length:r},(c,s)=>Array.from({length:t},(p,u)=>{let l=0;for(let i=0;i<n;i+=1)l+=e[s][i]*a[i][u];return l}))}function mo(e){return e.reduce((a,r,t)=>a+r[t],0)}function vg(e){const a=e.length,r=e[0].length,t=Array.from({length:r},(n,c)=>ct(e.map(s=>s[c])));return Array.from({length:r},(n,c)=>Array.from({length:r},(s,p)=>{let u=0;for(let l=0;l<a;l+=1)u+=(e[l][c]-t[c])*(e[l][p]-t[p]);return u/(a-1)}))}function yg(e){const a=e.length,r=e[0].length,t=vg(e),n=Array.from({length:r},(f,g)=>Array.from({length:r},(b,x)=>(g===x?1:0)-1/r)),c=Zr(Zr(n,t),n),s=mo(c),p=Zr(c,c),u=mo(p),l=1/(r-1);let i=u===0?1:s**2/((r-1)*u);i=Math.min(1,Math.max(l,i));const o=a*(r-1)*i-2,d=(r-1)*(a-1-(r-1)*i);let m=d<=0?1:o/d;return m=Math.min(1,Math.max(l,m)),{limiteInferior:l,greenhouseGeisser:i,huynhFeldt:m,covarianzas:t}}function wg(e){const a=Math.abs(e);return a<.01?"Prácticamente nulo":a<.06?"Pequeño":a<.14?"Moderado":"Grande"}function kg(e){const a=Math.abs(e);return a<.1?"Muy pequeño":a<.3?"Pequeño":a<.5?"Moderado":"Grande"}function Eg(e,a){const r=1-a,t=yl(e,(n,c)=>{const s=ol(n.valores,c.valores,{nivelConfianza:a});return{medicion1:n.nombre,medicion2:c.nombre,diferenciaMedia:s.diferenciaMedia,estadisticoT:s.estadistico.valor,gradosLibertad:s.gradosLibertad,valorP:s.valorP,intervaloConfianza:s.intervaloConfianza,dZ:s.tamanioEfecto.dZ}});return{id:"t-pareadas-holm",nombre:"Comparaciones t pareadas con ajuste de Holm",metodo:"Comparaciones pareadas bilaterales con ajuste secuencial de Holm sobre los valores p.",recomendado:!1,comparaciones:vl(t).map(n=>({...n,significativo:n.valorPAjustado<r}))}}function Cg(e,a){const r=1-a,t=yl(e,(n,c)=>{const s=sl(n.valores,c.valores);return{medicion1:n.nombre,medicion2:c.nombre,estadisticoW:s.estadistico.valor,estadisticoZ:s.estadisticoZ,valorP:s.valorP,correlacionBiserialRangos:s.tamanioEfecto.correlacionBiserialRangos,r:s.tamanioEfecto.r,nEfectivo:s.nEfectivo,cantidadCeros:s.cantidadCeros}});return{id:"wilcoxon-holm",nombre:"Comparaciones de Wilcoxon con ajuste de Holm",metodo:"Comparaciones pareadas de rangos con signo y ajuste secuencial de Holm sobre los valores p.",recomendado:!1,comparaciones:vl(t).map(n=>({...n,significativo:n.valorPAjustado<r}))}}function $g(e){const a=e.map((s,p)=>({valor:s,indice:p,rango:0})).sort((s,p)=>s.valor-p.valor);let r=0,t=0,n=0;for(;r<a.length;){let s=r+1;for(;s<a.length&&a[s].valor===a[r].valor;)s+=1;const p=s-r,u=(r+1+s)/2;for(let l=r;l<s;l+=1)a[l].rango=u;p>1&&(n+=1,t+=p**3-p),r=s}const c=new Array(e.length).fill(0);return a.forEach(({indice:s,rango:p})=>{c[s]=p}),{rangos:c,correccionEmpates:t,cantidadGruposEmpatados:n}}function Ag(e,a={}){const{nivelConfianza:r=.95}=a;gl(r);const t=hl(e),n=xl(t),c=n.length,s=t.length,p=n.flat(),u=ct(p),l=n.map(P=>ct(P)),i=p.reduce((P,D)=>P+(D-u)**2,0),o=c*t.reduce((P,D)=>P+(D.media-u)**2,0),d=s*l.reduce((P,D)=>P+(D-u)**2,0),m=Math.max(0,i-o-d),f=s-1,g=c-1,b=f*g,x=o/f,y=m/b,v=y===0?x===0?0:1/0:x/y,h=Xr(v,f,b),w=o+m===0?0:o/(o+m),k=o+m+d===0?0:o/(o+m+d),E=yg(n),C=f*E.greenhouseGeisser,$=b*E.greenhouseGeisser,I=f*E.huynhFeldt,A=b*E.huynhFeldt,L=Xr(v,C,$),R=Xr(v,I,A),N=1-r,V=Eg(t,r);return V.recomendado=L<N,{id:"anova-medidas-repetidas",nombre:"ANOVA de medidas repetidas",metodo:"ANOVA unifactorial intra-sujetos para tres o más mediciones completas y relacionadas.",mediciones:t,nSujetos:c,numeroMediciones:s,mediaGeneral:u,mediasSujetos:l,estadistico:{simbolo:"F",valor:v},gradosLibertad:{numerador:f,denominador:b},valorP:h,nivelConfianza:r,alfa:N,significativo:h<N,tablaAnova:{mediciones:{sumaCuadrados:o,gradosLibertad:f,cuadradoMedio:x},sujetos:{sumaCuadrados:d,gradosLibertad:g},error:{sumaCuadrados:m,gradosLibertad:b,cuadradoMedio:y},total:{sumaCuadrados:i,gradosLibertad:c*s-1}},esfericidad:{...E,greenhouseGeisser:{epsilon:E.greenhouseGeisser,gradosLibertadNumerador:C,gradosLibertadDenominador:$,valorP:L,significativo:L<N},huynhFeldt:{epsilon:E.huynhFeldt,gradosLibertadNumerador:I,gradosLibertadDenominador:A,valorP:R,significativo:R<N},nota:"Se informan correcciones de Greenhouse–Geisser y Huynh–Feldt. La calculadora no sustituye una prueba formal de esfericidad ni el examen de la matriz de covarianzas."},tamanioEfecto:{etaCuadradoParcial:w,etaCuadradoGeneralizado:k,interpretacion:wg(w)},postHoc:V}}function Ig(e,a={}){const{nivelConfianza:r=.95}=a;gl(r);const t=hl(e),n=xl(t),c=n.length,s=t.length,p=new Array(s).fill(0);let u=0,l=0;n.forEach(v=>{const h=$g(v);h.rangos.forEach((w,k)=>{p[k]+=w}),u+=h.correccionEmpates,l+=h.cantidadGruposEmpatados});const i=12/(c*s*(s+1))*p.reduce((v,h)=>v+h**2,0)-3*c*(s+1),o=1-u/(c*(s**3-s)),d=o<=0?0:i/o,m=s-1,f=xg(d,m),g=c*(s-1)===0?0:d/(c*(s-1)),b=1-r,x=t.map((v,h)=>({...v,sumaRangos:p[h],rangoMedio:p[h]/c})),y=Cg(t,r);return y.recomendado=f<b,{id:"friedman",nombre:"Prueba de Friedman",metodo:"Comparación no paramétrica de tres o más mediciones relacionadas mediante rangos dentro de cada participante.",mediciones:x,nSujetos:c,numeroMediciones:s,estadistico:{simbolo:"χ²_F",valor:d,sinCorreccion:i},gradosLibertad:{valor:m},valorP:f,nivelConfianza:r,alfa:b,significativo:f<b,empates:{factorCorreccion:o,sumaCorreccion:u,cantidadGruposEmpatados:l},tamanioEfecto:{kendallW:g,interpretacion:kg(g)},postHoc:y}}function Pg({mediciones:e,prueba:a,nivelConfianza:r=.95}){switch(a){case"anova-medidas-repetidas":case"anova-repetidas":return Ag(e,{nivelConfianza:r});case"friedman":return Ig(e,{nivelConfianza:r});default:throw new Error("La prueba solicitada no está disponible.")}}function Lg(){const e=document.createElement("section");e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
19"
    ...
    `}function Rg(e,a){const r=e.trim();if(!r)throw new Error(`${a} no contiene datos.`);const t=r.split(/[\s;]+/).filter(Boolean),n=t.map(s=>Number(s.replace(",","."))),c=n.findIndex(s=>!Number.isFinite(s));if(c!==-1)throw new Error(`${a} contiene un valor no válido: "${t[c]}".`);if(n.length<2)throw new Error(`${a} debe contener al menos dos observaciones.`);return n}function Mg(e){const a=[...e.querySelectorAll("[data-medicion]")];if(a.length<3)throw new Error("El análisis requiere al menos tres mediciones.");return a.map((r,t)=>{const n=r.querySelector('[data-campo="nombre"]'),c=r.querySelector('[data-campo="valores"]'),s=n.value.trim()||`Medición ${t+1}`;return{nombre:s,valores:Rg(c.value,s)}})}function Tg(e,a){e.elements.prueba.value=e.elements.prueba.value||"anova-medidas-repetidas",a.innerHTML=`
        ${$e(1)}
        ${$e(2)}
        ${$e(3)}
...
20`];[...a.querySelectorAll("[data-medicion]")].forEach((c,s)=>{c.querySelector('[data-campo="nombre"]').value=r[s],c.querySelector('[data-campo="valores"]').value=t[s],wl(c)})}function wl(e){const a=e.querySelector('[data-campo="valores"]'),r=e.querySelector("[data-contador]"),t=a.value.trim()?a.value.trim().split(/[\s;]+/).filter(Boolean).length:0;r.textContent=t===1?"1 valor":`${t} valores`}document.addEventListener("input",e=>{const a=e.target.closest('#formulario-mediciones-relacionadas [data-campo="valores"]');if(!a)return;const r=a.closest("[data-medicion]");r&&wl(r)});function bo(e,a){e.textContent=a,e.classList.remove("hidden")}function en(e){e.textContent="",e.classList.add("hidden")}function Ie(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):e===1/0?"∞":"—"}function rr(e){return Number.isFinite(e)?e<.001?"< 0.001":Ie(e,4):"—"}function Ng(e){const a=e.id==="anova-medidas-repetidas",r=a?e.esfericidad.greenhouseGeisser.valorP:e.valorP,t=r<e.alfa,n=Math.round(e.nivelConfianza*100),c=a?"Greenhouse–Geisser":"sin corrección adicional",s=t?`Se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${e.alfa.toFixed(2)}. Para la decisión principal se utilizó ${c}.`:`No se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${e.alfa.toFixed(2)}. Para la decisión principal se utilizó ${c}.`;return`
    ...
    `}function Dg(e){return e?.comparaciones?.length?`
    ...
    `:""}function qg(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
5
4
3`}function pe(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):e===1/0?"∞":e===-1/0?"−∞":"—"}function Xg(e){return Number.isFinite(e)?e<.001?"< 0.001":pe(e,4):"—"}function me(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Zg(e){const a=Math.round(e.nivelConfianza*100),r=e.significativo,t=r?`Se observa una relación estadísticamente significativa al nivel α = ${e.alfa.toFixed(2)}.`:`No se observa una relación estadísticamente significativa al nivel α = ${e.alfa.toFixed(2)}.`;return`
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            <header class="bg-violet-700 text-white px-6 py-8 md:px-10">
                <p class="uppercase tracking-widest text-violet-100 text-xs font-black mb-2">
                    Resultado del análisis
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${Tt("p",Xg(e.valorP),"Valor p bilateral")}
    ...
    `}function e0(e){const a=e.tamanioEfecto.rCuadrado;return`
        <article class="rounded-2xl border border-violet-200 bg-violet-50 p-6">
            <h3 class="text-xl font-black text-violet-950 mb-5">
    ...
    `}function a0(e){const a=e.intervaloConfianza;return`
        <article class="rounded-2xl border border-blue-200 bg-blue-50 p-6">
            <h3 class="text-xl font-black text-blue-950 mb-5">
    ...
    `}function t0(e){if(e.id==="punto-biserial"){const a=e.grupos.categoriaCero,r=e.grupos.categoriaUno;return`
            <article class="mt-6 rounded-2xl border border-slate-200 bg-white overflow-hidden">
                <header class="bg-slate-50 border-b border-slate-200 px-6 py-4">
                    <h3 class="text-xl font-black text-slate-900">
    ...
    `}function r0(e){return e.id==="pearson"?`
    ...
    `}function i0(e){return e.id==="punto-biserial"?s0(e):o0(e)}function o0(e){const a=e.datosGrafico,r=760,t=380,n=55,c=a.map(b=>b.x),s=a.map(b=>b.y),p=Math.min(...c),u=Math.max(...c),l=Math.min(...s),i=Math.max(...s),o=u-p||1,d=i-l||1,m=b=>n+(b-p)/o*(r-2*n),f=b=>t-n-(b-l)/d*(t-2*n),g=a.map(b=>`
                <circle
                    cx="${m(b.x)}"
                    cy="${f(b.y)}"
                    r="5"
    ...
    `}function s0(e){const a=e.datosGrafico,r=e.variables.dicotomica.categorias,t=760,n=380,c=60,s=a.map(m=>m.valor),p=Math.min(...s),l=Math.max(...s)-p||1,i=[t*.32,t*.68],o=m=>n-c-(m-p)/l*(n-2*c),d=a.map((m,f)=>{const g=m.codigo===0?i[0]:i[1],b=(f%5-2)*6;return`
                <circle
                    cx="${g+b}"
                    cy="${o(m.valor)}"
                    r="5"
    ...
    `,e.innerHTML=`
        ...
        <section
            ...
            aria-live="polite"
        ></section>
    `;const a=e.querySelector("#formulario-asociacion-categorica"),r=e.querySelector("#contenedor-tabla-contingencia"),t=e.querySelector("#mensaje-error-asociacion"),n=e.querySelector("#resultados-asociacion-categorica");let c=2,s=2;const p=sessionStorage.getItem("kernel-prueba-asociacion-categorica");return["chi-cuadrado-independencia-2x2","chi-cuadrado-independencia-rxc","fisher-exacta-2x2","fisher-freeman-halton"].includes(p)&&(a.elements.prueba.value=p.startsWith("chi-cuadrado")?"chi-cuadrado-independencia":p),sessionStorage.removeItem("kernel-prueba-asociacion-categorica"),da(r,c,s),a.addEventListener("submit",u=>{u.preventDefault(),on(t);try{const l=$l(r),i=h0({tabla:l.tabla,etiquetasFilas:l.etiquetasFilas,etiquetasColumnas:l.etiquetasColumnas,prueba:a.elements.prueba.value,nivelConfianza:Number(a.elements.nivelConfianza.value),maximoTablasExactas:5e4,simulaciones:1e4});n.innerHTML=C0(i),n.classList.remove("hidden"),n.scrollIntoView({behavior:"smooth",block:"start"})}catch(l){n.classList.add("hidden"),Ha(t,l instanceof Error?l.message:"No fue posible ejecutar el análisis.")}}),e.addEventListener("click",u=>{const l=u.target.closest("[data-action]");if(!l)return;const i=l.dataset.action;if(i==="volver-modulo"){window.location.hash="/correlacionAsociacion";return}const o=v0(r);if(i==="agregar-fila"){if(c>=6){Ha(t,"Esta interfaz admite hasta seis filas.");return}c+=1,da(r,c,s,o),w0(r,c),n.classList.add("hidden");return}if(i==="quitar-fila"){if(c<=2){Ha(t,"La tabla debe conservar al menos dos filas.");return}c-=1,da(r,c,s,o),n.classList.add("hidden");return}if(i==="agregar-columna"){if(s>=6){Ha(t,"Esta interfaz admite hasta seis columnas.");return}s+=1,da(r,c,s,o),k0(r,s),n.classList.add("hidden");return}if(i==="quitar-columna"){if(s<=2){Ha(t,"La tabla debe conservar al menos dos columnas.");return}s-=1,da(r,c,s,o),n.classList.add("hidden");return}if(i==="cargar-ejemplo"){const d=a.elements.prueba.value,m=E0(d);c=m.tabla.length,s=m.tabla[0].length,da(r,c,s),y0(r,m),a.elements.nivelConfianza.value="0.95",n.classList.add("hidden"),on(t);return}i==="limpiar"&&(c=2,s=2,a.reset(),da(r,c,s),n.innerHTML="",n.classList.add("hidden"),on(t))}),e}function nn(e,a){return`
        <article class="flex items-start gap-4">
            <span class="shrink-0 mt-1 w-3 h-3 rounded-full bg-violet-500"></span>
            <div>
                <h3 class="font-black text-slate-900 mb-1">
    ...
    `}function v0(e){try{return $l(e,!1)}catch{return{tabla:[],etiquetasFilas:[],etiquetasColumnas:[]}}}function $l(e,a=!0){const r=[...e.querySelectorAll("[data-etiqueta-fila]")].map((p,u)=>p.value.trim()||`Fila ${u+1}`),t=[...e.querySelectorAll("[data-etiqueta-columna]")].map((p,u)=>p.value.trim()||`Columna ${u+1}`),n=r.length,c=t.length,s=Array.from({length:n},()=>new Array(c).fill(""));return[...e.querySelectorAll("[data-frecuencia]")].forEach(p=>{const u=Number(p.dataset.fila),l=Number(p.dataset.columna),i=p.value.trim();if(a&&i==="")throw new Error(`Complete la frecuencia de la celda (${u+1}, ${l+1}).`);s[u][l]=i}),{tabla:s,etiquetasFilas:r,etiquetasColumnas:t}}function y0(e,a){a.etiquetasFilas.forEach((r,t)=>{e.querySelector(`[data-etiqueta-fila="${t}"]`).value=r}),a.etiquetasColumnas.forEach((r,t)=>{e.querySelector(`[data-etiqueta-columna="${t}"]`).value=r}),a.tabla.forEach((r,t)=>{r.forEach((n,c)=>{e.querySelector(`[data-fila="${t}"][data-columna="${c}"]`).value=n})})}function w0(e,a){const r=e.querySelector(`[data-etiqueta-fila="${a-1}"]`);r&&(r.value=`Fila ${a}`)}function k0(e,a){const r=e.querySelector(`[data-etiqueta-columna="${a-1}"]`);r&&(r.value=`Columna ${a}`)}function E0(e){return e==="fisher-exacta-2x2"?{etiquetasFilas:["Intervención","Control"],etiquetasColumnas:["Aprobó","No aprobó"],tabla:[[8,2],[1,5]]}:e==="fisher-freeman-halton"?{etiquetasFilas:["Presencial","Virtual","Híbrida"],etiquetasColumnas:["Bajo","Medio","Alto"],tabla:[[1,4,2],[3,1,1],[1,2,5]]}:{etiquetasFilas:["Presencial","Virtual","Híbrida"],etiquetasColumnas:["Bajo","Medio","Alto"],tabla:[[18,22,10],[30,15,5],[12,20,18]]}}function C0(e){const a=Math.round(e.nivelConfianza*100),r=e.significativo,t=r?`Se observa evidencia estadísticamente significativa de asociación entre las variables al nivel α = ${e.alfa.toFixed(2)}.`:`No se observa evidencia estadísticamente significativa de asociación entre las variables al nivel α = ${e.alfa.toFixed(2)}.`;return`
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            <header class="bg-violet-700 text-white px-6 py-8 md:px-10">
                <p class="uppercase tracking-widest text-violet-100 text-xs font-black mb-2">
                    Resultado del análisis
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${St("p",T0(e.valorP),e.detallesExactos?.exacta===!1?"Valor p Monte Carlo":"Valor p bilateral")}
    ...
    `}function $0(e){const a=e.tamanioEfecto;return`
        <article class="rounded-2xl border border-violet-200 bg-violet-50 p-6">
            <h3 class="text-xl font-black text-violet-950 mb-5">
    ...
    `}function A0(e){const a=e.diagnosticoFrecuenciasEsperadas;return`
    ...
    `}function I0(e){const a=e.tabla,r=a.etiquetasColumnas.map(n=>`
    ...
    `}function P0(e){if(!e.oddsRatio)return"";const a=e.oddsRatio,r=e.correccionYates;return`
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-6">
            <article class="rounded-2xl border border-blue-200 bg-blue-50 p-6">
                <h3 class="text-xl font-black text-blue-950 mb-5">
                    Odds ratio
    ...
    `}function L0(e){const a=e.detallesExactos;return a?`
    ...
    `:""}function R0(e){const a=e.residuos.celdasDestacadas;return a.length?`
        <article class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-6">
            <h3 class="text-xl font-black text-amber-950 mb-4">
    ...
    `:`
        ...
        `}function M0(e){return e.advertencias?.length?`
    ...
    `,e.innerHTML=`
        ...
        <section
            ...
            aria-live="polite"
        ></section>
    `;const a=e.querySelector("#formulario-estadistica-descriptiva"),r=e.querySelector("#entrada-datos-descriptivos"),t=e.querySelector("#mensaje-error-descriptiva"),n=e.querySelector("#resultados-estadistica-descriptiva"),c=()=>{r.innerHTML=Q0(a.elements.tipoDatos.value),n.classList.add("hidden"),_t(t)};return c(),a.elements.tipoDatos.addEventListener("change",c),a.addEventListener("submit",s=>{s.preventDefault(),_t(t);try{const p=a.elements.tipoDatos.value,u=Z0(p,r),l=Y0(u);n.innerHTML=ah(l),n.classList.remove("hidden"),n.scrollIntoView({behavior:"smooth",block:"start"})}catch(p){n.classList.add("hidden"),ch(t,p instanceof Error?p.message:"No fue posible calcular los descriptivos.")}}),e.addEventListener("click",s=>{const p=s.target.closest("[data-action]");if(!p)return;const u=p.dataset.action;if(u==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}if(u==="cargar-ejemplo"){eh(a.elements.tipoDatos.value,r),n.classList.add("hidden"),_t(t);return}if(u==="limpiar"){const l=r.querySelector("textarea");l&&(l.value=""),n.classList.add("hidden"),_t(t)}}),e}function ln(e,a){return`
        <div>
            <h3 class="font-black text-slate-900 mb-1">
                ${e}
            </h3>
    ...
    `}function Q0(e){const r={individuales:{titulo:"Observaciones",ayuda:"Separe los valores mediante comas, espacios, punto y coma o saltos de línea.",marcador:"12, 15, 18, 18, 20, 22, 25, 27"},frecuencias:{titulo:"Valor y frecuencia",ayuda:"Escriba una fila por valor con el formato: valor, frecuencia.",marcador:`10, 3
12, 5
14, 7
...
20, 30, 7`}}[e];return`
    ...
    `}function X0(e){return e.trim().split(/[\s,;]+/).filter(Boolean).map(Number)}function Ro(e,a){const r=e.trim().split(/\n+/).map(t=>t.trim()).filter(Boolean).map((t,n)=>{const c=t.split(/[,;\t ]+/).filter(Boolean).map(Number);if(c.length!==a||!c.every(Number.isFinite))throw new Error(`La fila ${n+1} debe contener exactamente ${a} valores numéricos.`);return c});if(!r.length)throw new Error("Introduzca los datos antes de calcular.");return r}function Z0(e,a){const r=a.querySelector("textarea").value;if(!r.trim())throw new Error("Introduzca los datos antes de calcular.");if(e==="individuales")return{tipoDatos:e,valores:X0(r)};if(e==="frecuencias"){const n=Ro(r,2);return{tipoDatos:e,valores:n.map(c=>c[0]),frecuencias:n.map(c=>c[1])}}const t=Ro(r,3);return{tipoDatos:e,clases:t.map(n=>({limiteInferior:n[0],limiteSuperior:n[1],frecuencia:n[2]}))}}function eh(e,a){const r={individuales:"42, 48, 51, 53, 55, 55, 57, 59, 61, 64, 67, 72, 96",frecuencias:`1, 2
2, 5
3, 8
4, 6
...
20, 30, 12
30, 40, 9
40, 50, 3`};a.querySelector("textarea").value=r[e]}function ah(e){const a=e.resumen;return`
        <section class="rounded-3xl border border-sky-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                ...
                ${e.advertencias?.length?nh(e.advertencias):""}
    ...
    `}function ih(e){const a=e.tablaFrecuencias,r=Math.max(...a.map(t=>t.frecuencia),1);return`
    ...
    `}function oh(e,a){const r=e.minimo,t=e.maximo,n=Math.max(t-r,1),c=o=>40+(o-r)/n*520,s=c(r),p=c(e.q1),u=c(e.mediana),l=c(e.q3),i=c(t);return`
        <article class="rounded-3xl border border-slate-200 bg-white p-6 shadow-md">
            <h3 class="text-2xl font-black text-slate-900 mb-2">
                Diagrama de caja
            </h3>
    ...
    `}function sh(e){const a=e.tipoDatos==="intervalos";return`
    ...
    `}function ie(e){return e==null||!Number.isFinite(Number(e))?"—":Number(e).toLocaleString("es-DO",{maximumFractionDigits:4})}function Mo(e){return`${(e*100).toLocaleString("es-DO",{maximumFractionDigits:2})} %`}function lh(e){return e?"valores"in e?e.valores.length?e.valores.map(ie).join(", "):"Sin moda":ie(e.valor):"—"}function ch(e,a){e.textContent=a,e.classList.remove("hidden")}function _t(e){e.textContent="",e.classList.add("hidden")}function dh(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
    ...
    `}const qe=1e-12;function To(e,a){if(!Array.isArray(a)||a.length<3)throw new Error(`${e} debe contener al menos tres observaciones.`);const r=a.map(Number);if(!r.every(Number.isFinite))throw new Error(`${e} contiene valores no numéricos o no finitos.`);return r}function ph(e){return e[0].map((a,r)=>e.map(t=>t[r]))}function mh(e,a){return e.map(r=>a[0].map((t,n)=>r.reduce((c,s,p)=>c+s*a[p][n],0)))}function zt(e,a){return e.map(r=>r.reduce((t,n,c)=>t+n*a[c],0))}function fh(e){return Array.from({length:e},(a,r)=>Array.from({length:e},(t,n)=>r===n?1:0))}function bh(e){const a=e.length,r=e.map((t,n)=>[...t.map(Number),...fh(a)[n]]);for(let t=0;t<a;t+=1){let n=t;for(let s=t+1;s<a;s+=1)Math.abs(r[s][t])>Math.abs(r[n][t])&&(n=s);if(Math.abs(r[n][t])<qe)throw new Error("La matriz de predictores es singular. Elimine variables redundantes o perfectamente colineales.");[r[t],r[n]]=[r[n],r[t]];const c=r[t][t];r[t]=r[t].map(s=>s/c);for(let s=0;s<a;s+=1){if(s===t)continue;const p=r[s][t];r[s]=r[s].map((u,l)=>u-p*r[t][l])}}return r.map(t=>t.slice(a))}function Pl(e){return e.reduce((a,r)=>a+r,0)/e.length}function gh(e,a=Pl(e)){return e.reduce((r,t)=>r+(t-a)**2,0)}function Wt(e){const a=[676.5203681218851,-1259.1392167224028,771.3234287776531,-176.6150291621406,12.507343278686905,-.13857109526572012,9984369578019572e-21,15056327351493116e-23];if(e<.5)return Math.log(Math.PI)-Math.log(Math.sin(Math.PI*e))-Wt(1-e);let r=.9999999999998099;const t=e-1;a.forEach((c,s)=>{r+=c/(t+s+1)});const n=t+a.length-.5;return .5*Math.log(2*Math.PI)+(t+.5)*Math.log(n)-n+Math.log(r)}function No(e,a,r){const s=e+a,p=e+1,u=e-1;let l=1,i=1-s*r/p;Math.abs(i)<1e-300&&(i=1e-300),i=1/i;let o=i;for(let d=1;d<=200;d+=1){const m=2*d;let f=d*(a-d)*r/((u+m)*(e+m));i=1+f*i,Math.abs(i)<1e-300&&(i=1e-300),l=1+f/l,Math.abs(l)<1e-300&&(l=1e-300),i=1/i,o*=i*l,f=-(e+d)*(s+d)*r/((e+m)*(p+m)),i=1+f*i,Math.abs(i)<1e-300&&(i=1e-300),l=1+f/l,Math.abs(l)<1e-300&&(l=1e-300),i=1/i;const g=i*l;if(o*=g,Math.abs(g-1)<3e-14)break}return o}function Ll(e,a,r){if(e<=0)return 0;if(e>=1)return 1;const t=Math.exp(Wt(a+r)-Wt(a)-Wt(r)+a*Math.log(e)+r*Math.log(1-e));return e<(a+1)/(a+r+2)?t*No(a,r,e)/a:1-t*No(r,a,1-e)/r}function hh(e,a){if(!Number.isFinite(e))return 0;const r=a/(a+e**2);return Math.min(1,Ll(r,a/2,.5))}function xh(e,a,r){if(!Number.isFinite(e))return 0;if(e<=0)return 1;const t=r/(r+a*e);return Ll(t,r/2,a/2)}function vh(e){const a=[-39.6968302866538,220.946098424521,-275.928510446969,138.357751867269,-30.6647980661472,2.50662827745924],r=[-54.4760987982241,161.585836858041,-155.698979859887,66.8013118877197,-13.2806815528857],t=[-.00778489400243029,-.322396458041136,-2.40075827716184,-2.54973253934373,4.37466414146497,2.93816398269878],n=[.00778469570904146,.32246712907004,2.445134137143,3.75440866190742],c=.02425,s=1-c;if(e<=0||e>=1)throw new Error("La probabilidad debe estar entre 0 y 1.");if(e<c){const l=Math.sqrt(-2*Math.log(e));return(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}if(e>s){const l=Math.sqrt(-2*Math.log(1-e));return-(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}const p=e-.5,u=p*p;return(((((a[0]*u+a[1])*u+a[2])*u+a[3])*u+a[4])*u+a[5])*p/(((((r[0]*u+r[1])*u+r[2])*u+r[3])*u+r[4])*u+1)}function yh(e,a){const r=vh(e),t=r*r,n=t*r,c=n*t,s=c*t;return r+(n+r)/(4*a)+(5*c+16*n+3*r)/(96*a**2)+(3*s+19*c+17*n-15*r)/(384*a**3)}function wh(e,a){const r=e[0].length;return Array.from({length:r},(t,n)=>[...a?[1]:[],...e.map(c=>c[n])])}function kh(e,a){return e.length<2?[]:e.map((r,t)=>{const n=e.filter((c,s)=>s!==t);try{const c=Rl({y:r,X:n,nombresPredictores:a.filter((p,u)=>u!==t),incluirIntercepto:!0,nivelConfianza:.95,calcularDiagnosticos:!1,calcularVif:!1}),s=Math.max(1-c.ajuste.r2,qe);return{variable:a[t],tolerancia:s,vif:1/s}}catch{return{variable:a[t],tolerancia:0,vif:1/0}}})}function Rl({y:e,X:a,nombresPredictores:r=[],incluirIntercepto:t=!0,nivelConfianza:n=.95,calcularDiagnosticos:c=!0,calcularVif:s=!0}){const p=To("La variable dependiente",e);if(!Array.isArray(a)||!a.length)throw new Error("Debe proporcionar al menos una variable predictora.");const u=a.map((T,S)=>To(r[S]||`X${S+1}`,T));if(!u.every(T=>T.length===p.length))throw new Error("Todas las variables deben contener la misma cantidad de observaciones.");if(!(n>0&&n<1))throw new Error("El nivel de confianza debe estar entre 0 y 1.");const l=u.map((T,S)=>r[S]||`X${S+1}`),i=wh(u,t),o=p.length,d=i[0].length,m=o-d;if(m<=0)throw new Error("No hay suficientes observaciones para estimar el modelo.");const f=ph(i),g=mh(f,i),b=bh(g),x=zt(f,p),y=zt(b,x),v=zt(i,y),h=p.map((T,S)=>T-v[S]),w=Pl(p),k=t?gh(p,w):p.reduce((T,S)=>T+S**2,0),E=h.reduce((T,S)=>T+S**2,0),C=Math.max(k-E,0),$=k>qe?1-E/k:1,I=t?1-(1-$)*(o-1)/m:1-(1-$)*o/m,A=E/m,L=Math.sqrt(A),R=h.reduce((T,S)=>T+Math.abs(S),0)/o,N=d-(t?1:0),V=N>0&&A>qe?C/N/A:1/0,P=N>0?xh(V,N,m):null,D=yh(.5+n/2,m),te=[...t?["Intercepto"]:[],...l],Y=y.map((T,S)=>{const X=Math.sqrt(Math.max(A*b[S][S],0)),ca=X>qe?T/X:T===0?0:1/0,Tr=hh(Math.abs(ca),m);return{termino:te[S],estimacion:T,errorEstandar:X,t:ca,p:Tr,intervaloConfianza:{inferior:T-D*X,superior:T+D*X,nivel:n}}}),J=i.map(T=>{const S=zt(b,T);return T.reduce((X,ca,Tr)=>X+ca*S[Tr],0)}),oe=h.map((T,S)=>{const X=Math.sqrt(Math.max(A*(1-J[S]),qe));return T/X}),ue=h.map((T,S)=>{const X=J[S];return d>0&&A>qe?T**2/(d*A)*X/Math.max((1-X)**2,qe):0}),Q=h.reduce((T,S)=>T+S**2,0),ge=h.slice(1).reduce((T,S,X)=>T+(S-h[X])**2,0),Se=Q>qe?ge/Q:null,_=s&&u.length>1?kh(u,l):[],z=c?ue.map((T,S)=>({observacion:S+1,distanciaCook:T,leverage:J[S],residuoEstandarizado:oe[S]})).filter(T=>T.distanciaCook>4/o||Math.abs(T.residuoEstandarizado)>2||T.leverage>2*d/o):[],_e=[`El modelo explica ${($*100).toFixed(2)} % de la variabilidad de la variable dependiente.`,`El R² ajustado es ${I.toFixed(4)} y el error estándar de estimación es ${L.toFixed(4)}.`,P===null?"No se calculó una prueba global del modelo.":P<.05?`El modelo global es estadísticamente significativo (F = ${V.toFixed(4)}, p ${P<.001?"< 0.001":`= ${P.toFixed(4)}`}).`:`El modelo global no alcanza significación estadística al 5 % (F = ${V.toFixed(4)}, p = ${P.toFixed(4)}).`,_.some(T=>T.vif>=10)?"Se detectó multicolinealidad severa en al menos un predictor (VIF ≥ 10).":_.some(T=>T.vif>=5)?"Se detectó multicolinealidad moderada en al menos un predictor (VIF ≥ 5).":_.length?"No se detectó multicolinealidad relevante mediante el criterio VIF.":"El VIF no aplica a un modelo con un solo predictor.",z.length?`Se identificaron ${z.length} observaciones potencialmente influyentes que deben revisarse.`:"No se identificaron observaciones claramente influyentes mediante los criterios automáticos."];return{tipoModelo:u.length===1?"regresion-lineal-simple":"regresion-lineal-multiple",n:o,numeroPredictores:u.length,incluirIntercepto:t,nombresPredictores:l,coeficientes:Y,ajuste:{r2:$,r2Ajustado:I,mae:R,mse:A,rmse:L,errorEstandarEstimacion:L},anova:{sumaCuadradosModelo:C,sumaCuadradosError:E,sumaCuadradosTotal:k,gradosLibertadModelo:N,gradosLibertadError:m,gradosLibertadTotal:t?o-1:o,mediaCuadraticaModelo:N>0?C/N:null,mediaCuadraticaError:A,f:V,p:P},predichos:v,residuos:h,diagnosticos:{leverage:J,residuosEstandarizados:oe,distanciaCook:ue,durbinWatson:Se,vif:_,observacionesInfluyentes:z},datosGrafico:p.map((T,S)=>({observacion:S+1,observado:T,predicho:v[S],residuo:h[S],residuoEstandarizado:oe[S],leverage:J[S],distanciaCook:ue[S],predictores:u.map(X=>X[S])})),interpretacion:_e}}function Eh(e,a){if(!e?.coeficientes?.length)throw new Error("El modelo proporcionado no es válido.");if(!Array.isArray(a)||a.length!==e.numeroPredictores)throw new Error(`Debe proporcionar ${e.numeroPredictores} valores predictores.`);const r=a.map(Number);if(!r.every(Number.isFinite))throw new Error("Los valores predictores deben ser numéricos.");const t=e.coeficientes.map(c=>c.estimacion);return[...e.incluirIntercepto?[1]:[],...r].reduce((c,s,p)=>c+s*t[p],0)}function le(e,a=3){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{maximumFractionDigits:a}).format(e):"—"}function $n(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function qa(e,a=.08){const r=e.filter(Number.isFinite);let t=Math.min(...r),n=Math.max(...r);if(!r.length)return{minimo:0,maximo:1};if(Math.abs(n-t)<1e-12){const c=Math.max(Math.abs(n)*.1,1);t-=c,n+=c}else{const c=(n-t)*a;t-=c,n+=c}return{minimo:t,maximo:n}}function An(e,a,r,t){const n=Math.max(a-e,1e-12);return c=>r+(c-e)/n*(t-r)}function Mr({ancho:e,alto:a,margen:r,rangoX:t,rangoY:n,etiquetaX:c,etiquetaY:s}){const p=[],u=[],l=[],i=An(t.minimo,t.maximo,r.izquierdo,e-r.derecho),o=An(n.minimo,n.maximo,a-r.inferior,r.superior);for(let d=0;d<=4;d+=1){const m=d/4,f=t.minimo+m*(t.maximo-t.minimo),g=n.minimo+m*(n.maximo-n.minimo),b=i(f),x=o(g);p.push(`
    ...
    `).join("");return ja("Observado frente a predicho","Un ajuste adecuado concentra los puntos cerca de la línea diagonal de igualdad.",Va(`
            ...
            />
            ${p}
        `,"Gráfico de valores observados frente a valores predichos"))}function Ah(e){const a=e.datosGrafico.map(u=>u.predicho),r=e.datosGrafico.map(u=>u.residuo),t=qa(a),n=qa([...r,0]),s=Mr({ancho:640,alto:360,margen:{izquierdo:66,derecho:28,superior:24,inferior:60},rangoX:t,rangoY:n,etiquetaX:"Valor predicho",etiquetaY:"Residuo"}),p=e.datosGrafico.map((u,l)=>`
        <circle
            cx="${s.x(u.predicho)}"
            cy="${s.y(u.residuo)}"
            r="5"
    ...
    `).join("");return ja("Residuos frente a valores predichos","Se espera una nube aproximadamente aleatoria alrededor de cero. Los puntos rojos tienen residuos estandarizados con magnitud mayor que 2.",Va(`
        ...
        `,"Histograma de los residuos"))}function Ph(e){const a=[-39.6968302866538,220.946098424521,-275.928510446969,138.357751867269,-30.6647980661472,2.50662827745924],r=[-54.4760987982241,161.585836858041,-155.698979859887,66.8013118877197,-13.2806815528857],t=[-.00778489400243029,-.322396458041136,-2.40075827716184,-2.54973253934373,4.37466414146497,2.93816398269878],n=[.00778469570904146,.32246712907004,2.445134137143,3.75440866190742],c=.02425,s=1-c;if(e<c){const l=Math.sqrt(-2*Math.log(e));return(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}if(e>s){const l=Math.sqrt(-2*Math.log(1-e));return-(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}const p=e-.5,u=p*p;return(((((a[0]*u+a[1])*u+a[2])*u+a[3])*u+a[4])*u+a[5])*p/(((((r[0]*u+r[1])*u+r[2])*u+r[3])*u+r[4])*u+1)}function Lh(e){const a=[...e.diagnosticos.residuosEstandarizados].sort((p,u)=>p-u),r=a.map((p,u)=>Ph((u+.5)/a.length)),t=qa([...a,...r]),c=Mr({ancho:640,alto:360,margen:{izquierdo:66,derecho:28,superior:24,inferior:60},rangoX:t,rangoY:t,etiquetaX:"Cuantil normal teórico",etiquetaY:"Residuo estandarizado ordenado"}),s=a.map((p,u)=>`
        <circle
            cx="${c.x(r[u])}"
            cy="${c.y(p)}"
            r="4.5"
    ...
    `).join("");return ja("Gráfico Q–Q de residuos","La proximidad de los puntos a la diagonal ofrece una evaluación visual de la normalidad residual.",Va(`
        ...
        `,"Gráfico de distancia de Cook por observación"))}function Mh(e,a="Y"){return`
        <section class="mt-10" data-seccion-graficos-regresion="true">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-7">
                ${[Ch(e,a),$h(e,a),Ah(e),Ih(e),Lh(e),Rh(e)].filter(Boolean).join("")}
            </div>
        </section>
    `}function Th(){const e=document.createElement("section");let a=null,r=null;e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
94; 10`}function q(e,a=4){return e==null?"—":e===1/0?"∞":e===-1/0?"−∞":Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):"—"}function sr(e){return e==null?"—":e<.001?"< 0.001":q(e,4)}function Te(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function zh(e,a){const r=[];return e.coeficientes.forEach((t,n)=>{const c=t.estimacion,s=q(Math.abs(c),6);if(n===0&&e.incluirIntercepto){r.push(q(c,6));return}const p=c>=0&&r.length?"+":"−",u=Te(t.termino);r.length?r.push(`${p} ${s}·${u}`):r.push(`${c<0?"−":""}${s}·${u}`)}),`${Te(a)}̂ = ${r.join(" ")}`}function pa(e,a,r=""){return`
    ...
    `}function Fh(e){return e.diagnosticos.vif.length?`
        <div class="overflow-x-auto rounded-2xl border border-slate-200">
            <table class="min-w-full text-sm">
                <thead class="bg-slate-950 text-white">
                    <tr>
    ...
    `}function Vh(e,a){const r=e.anova.p!==null&&e.anova.p<.05,t=q(e.ajuste.r2*100,2);return`
...
`),n=new Blob([`\uFEFF${t}`],{type:"text/csv;charset=utf-8"}),c=document.createElement("a");c.href=URL.createObjectURL(n),c.download="regresion-lineal-multiple-kernel.csv",document.body.appendChild(c),c.click(),c.remove(),URL.revokeObjectURL(c.href)}function _o(e,a){e.textContent=a,e.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"center"})}function Ya(e){e.textContent="",e.classList.add("hidden")}const re=1e-12,Ye=35;function zo(e,a,r=5){if(!Array.isArray(a)||a.length<r)throw new Error(`${e} debe contener al menos ${r} observaciones.`);const t=a.map(Number);if(!t.every(Number.isFinite))throw new Error(`${e} contiene valores no numéricos o no finitos.`);return t}function Wh(e){return Array.from({length:e},(a,r)=>Array.from({length:e},(t,n)=>r===n?1:0))}function Kh(e){return e[0].map((a,r)=>e.map(t=>t[r]))}function Yh(e,a){return e.map(r=>a[0].map((t,n)=>r.reduce((c,s,p)=>c+s*a[p][n],0)))}function at(e,a){return e.map(r=>r.reduce((t,n,c)=>t+n*a[c],0))}function tt(e,a){return e.reduce((r,t,n)=>r+t*a[n],0)}function In(e){const a=e.length,r=e.map((t,n)=>[...t.map(Number),...Wh(a)[n]]);for(let t=0;t<a;t+=1){let n=t;for(let s=t+1;s<a;s+=1)Math.abs(r[s][t])>Math.abs(r[n][t])&&(n=s);if(Math.abs(r[n][t])<re)throw new Error("La matriz de información es singular. Elimine predictores redundantes o perfectamente colineales.");[r[t],r[n]]=[r[n],r[t]];const c=r[t][t];r[t]=r[t].map(s=>s/c);for(let s=0;s<a;s+=1){if(s===t)continue;const p=r[s][t];r[s]=r[s].map((u,l)=>u-p*r[t][l])}}return r.map(t=>t.slice(a))}function Ml(e,a){const r=e[0].length;return Array.from({length:r},(t,n)=>[...a?[1]:[],...e.map(c=>c[n])])}function Kt(e){const a=Math.max(-Ye,Math.min(Ye,e));if(a>=0)return 1/(1+Math.exp(-a));const r=Math.exp(a);return r/(1+r)}function rt(e,a){return e.reduce((r,t,n)=>{const c=Math.max(re,Math.min(1-re,a[n]));return r+t*Math.log(c)+(1-t)*Math.log(1-c)},0)}function Jh(e){const a=e<0?-1:1,r=Math.abs(e)/Math.sqrt(2),t=1/(1+.3275911*r),l=1-((((1.061405429*t+-1.453152027)*t+1.421413741)*t+-.284496736)*t+.254829592)*t*Math.exp(-r*r);return .5*(1+a*l)}function Qh(e){return Math.max(0,Math.min(1,2*(1-Jh(Math.abs(e)))))}function Pn(e){const a=[676.5203681218851,-1259.1392167224028,771.3234287776531,-176.6150291621406,12.507343278686905,-.13857109526572012,9984369578019572e-21,15056327351493116e-23];if(e<.5)return Math.log(Math.PI)-Math.log(Math.sin(Math.PI*e))-Pn(1-e);let r=.9999999999998099;const t=e-1;a.forEach((c,s)=>{r+=c/(t+s+1)});const n=t+a.length-.5;return .5*Math.log(2*Math.PI)+(t+.5)*Math.log(n)-n+Math.log(r)}function Xh(e,a){if(a<=0)return 0;if(a<e+1){let p=1/e,u=p,l=e;for(let i=1;i<=300&&(l+=1,p*=a/l,u+=p,!(Math.abs(p)<Math.abs(u)*1e-14));i+=1);return u*Math.exp(-a+e*Math.log(a)-Pn(e))}let r=a+1-e,t=1/1e-300,n=1/r,c=n;for(let p=1;p<=300;p+=1){const u=-p*(p-e);r+=2,n=u*n+r,Math.abs(n)<1e-300&&(n=1e-300),t=r+u/t,Math.abs(t)<1e-300&&(t=1e-300),n=1/n;const l=n*t;if(c*=l,Math.abs(l-1)<1e-14)break}return 1-Math.exp(-a+e*Math.log(a)-Pn(e))*c}function Tl(e,a){return!(e>=0)||!(a>0)?null:Math.max(0,Math.min(1,1-Xh(a/2,e/2)))}function Zh(e){const a=[-39.6968302866538,220.946098424521,-275.928510446969,138.357751867269,-30.6647980661472,2.50662827745924],r=[-54.4760987982241,161.585836858041,-155.698979859887,66.8013118877197,-13.2806815528857],t=[-.00778489400243029,-.322396458041136,-2.40075827716184,-2.54973253934373,4.37466414146497,2.93816398269878],n=[.00778469570904146,.32246712907004,2.445134137143,3.75440866190742],c=.02425,s=1-c;if(e<=0||e>=1)throw new Error("La probabilidad debe estar entre 0 y 1.");if(e<c){const l=Math.sqrt(-2*Math.log(e));return(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}if(e>s){const l=Math.sqrt(-2*Math.log(1-e));return-(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}const p=e-.5,u=p*p;return(((((a[0]*u+a[1])*u+a[2])*u+a[3])*u+a[4])*u+a[5])*p/(((((r[0]*u+r[1])*u+r[2])*u+r[3])*u+r[4])*u+1)}function Do(e,a){const r=e[0].length,t=Array.from({length:r},()=>Array(r).fill(0));return e.forEach((n,c)=>{const s=Math.max(a[c]*(1-a[c]),re);for(let p=0;p<r;p+=1)for(let u=0;u<r;u+=1)t[p][u]+=s*n[p]*n[u]}),t}function ex(e,a,r={}){const t=r.maxIteraciones??100,n=r.tolerancia??1e-8,c=e[0].length;let s=Array(c).fill(0),p=e.map(()=>.5),u=rt(a,p),l=!1,i=0;for(let m=1;m<=t;m+=1){i=m,p=e.map(C=>Kt(tt(C,s)));const f=Do(e,p),g=In(f),b=Array(c).fill(0);e.forEach((C,$)=>{const I=a[$]-p[$];C.forEach((A,L)=>{b[L]+=A*I})});const x=at(g,b);let y=1,v=s.map((C,$)=>C+x[$]),h=e.map(C=>Kt(tt(C,v))),w=rt(a,h);for(;w<u-1e-10&&y>1/1024;)y/=2,v=s.map((C,$)=>C+y*x[$]),h=e.map(C=>Kt(tt(C,v))),w=rt(a,h);const k=Math.max(...v.map((C,$)=>Math.abs(C-s[$]))),E=Math.abs(w-u);if(s=v,p=h,u=w,k<n&&E<n){l=!0;break}if(s.some(C=>Math.abs(C)>100))break}const o=Do(e,p),d=In(o);return{beta:s,probabilidades:p,logLik:u,covarianza:d,informacion:o,convergio:l,iteraciones:i}}function ax(e,a){if(!a){const c=e.map(()=>.5);return{probabilidades:c,logLik:rt(e,c)}}const r=e.reduce((c,s)=>c+s,0)/e.length,t=Math.max(re,Math.min(1-re,r)),n=e.map(()=>t);return{probabilidades:n,logLik:rt(e,n)}}function tx(e,a,r){let t=0,n=0,c=0,s=0;e.forEach((f,g)=>{const b=a[g]>=r?1:0;f===1&&b===1&&(t+=1),f===0&&b===0&&(n+=1),f===0&&b===1&&(c+=1),f===1&&b===0&&(s+=1)});const p=e.length,u=(f,g)=>g>0?f/g:null,l=u(t,t+s),i=u(n,n+c),o=u(t,t+c),d=u(n,n+s),m=o!==null&&l!==null&&o+l>0?2*o*l/(o+l):null;return{umbral:r,verdaderosPositivos:t,verdaderosNegativos:n,falsosPositivos:c,falsosNegativos:s,exactitud:(t+n)/p,sensibilidad:l,especificidad:i,precision:o,valorPredictivoNegativo:d,f1:m,exactitudBalanceada:l!==null&&i!==null?(l+i)/2:null}}function rx(e,a){const r=e.map((u,l)=>({observado:u,probabilidad:a[l]})).sort((u,l)=>l.probabilidad-u.probabilidad),t=e.reduce((u,l)=>u+l,0),n=e.length-t,s=[1/0,...new Set(r.map(u=>u.probabilidad)),-1/0].map(u=>{let l=0,i=0;return r.forEach(o=>{const d=o.probabilidad>=u;d&&o.observado===1&&(l+=1),d&&o.observado===0&&(i+=1)}),{umbral:Number.isFinite(u)?u:null,sensibilidad:t>0?l/t:0,unoMenosEspecificidad:n>0?i/n:0}}).sort((u,l)=>u.unoMenosEspecificidad-l.unoMenosEspecificidad||u.sensibilidad-l.sensibilidad);let p=0;for(let u=1;u<s.length;u+=1){const l=s[u].unoMenosEspecificidad-s[u-1].unoMenosEspecificidad,i=(s[u].sensibilidad+s[u-1].sensibilidad)/2;p+=l*i}return{puntos:s,auc:Math.max(0,Math.min(1,p))}}function nx(e,a){const r=e.map((p,u)=>({observado:p,probabilidad:a[u]})).sort((p,u)=>p.probabilidad-u.probabilidad),t=Math.min(10,Math.max(3,Math.floor(e.length/5))),n=[];for(let p=0;p<t;p+=1){const u=Math.floor(p*r.length/t),l=Math.floor((p+1)*r.length/t),i=r.slice(u,l);if(!i.length)continue;const o=i.reduce((g,b)=>g+b.observado,0),d=i.reduce((g,b)=>g+b.probabilidad,0),m=i.length-o,f=i.length-d;n.push({grupo:n.length+1,n:i.length,probabilidadMedia:i.reduce((g,b)=>g+b.probabilidad,0)/i.length,observadosPositivos:o,esperadosPositivos:d,observadosNegativos:m,esperadosNegativos:f})}const c=n.reduce((p,u)=>{const l=u.esperadosPositivos>re?(u.observadosPositivos-u.esperadosPositivos)**2/u.esperadosPositivos:0,i=u.esperadosNegativos>re?(u.observadosNegativos-u.esperadosNegativos)**2/u.esperadosNegativos:0;return p+l+i},0),s=Math.max(n.length-2,1);return{estadistico:c,gradosLibertad:s,p:Tl(c,s),grupos:n}}function ix(e,a,r,t){const n=e[0].length,c=e.map((l,i)=>{const o=at(t,l);return r[i]*(1-r[i])*tt(l,o)}),s=a.map((l,i)=>{const o=Math.max(r[i]*(1-r[i]),re);return(l-r[i])/Math.sqrt(o)}),p=a.map((l,i)=>{const o=Math.max(re,Math.min(1-re,r[i])),d=l===1?2*Math.log(1/o):2*Math.log(1/(1-o));return Math.sign(l-o)*Math.sqrt(Math.max(d,0))}),u=s.map((l,i)=>{const o=Math.min(c[i],1-re);return l**2*o/(n*Math.max((1-o)**2,re))});return{leverage:c,residuosPearson:s,residuosDeviance:p,distanciaCook:u}}function ox(e,a){return e.length<2?[]:e.map((r,t)=>{const n=e.filter((u,l)=>l!==t),c=Ml(n,!0),s=Kh(c),p=Yh(s,c);try{const u=In(p),l=at(s,r),i=at(u,l),o=at(c,i),d=r.reduce((x,y)=>x+y,0)/r.length,m=r.reduce((x,y)=>x+(y-d)**2,0),f=r.reduce((x,y,v)=>x+(y-o[v])**2,0),g=m>re?Math.max(0,1-f/m):1,b=Math.max(1-g,re);return{variable:a[t],tolerancia:b,vif:1/b}}catch{return{variable:a[t],tolerancia:0,vif:1/0}}})}function sx({y:e,X:a,nombresPredictores:r=[],incluirIntercepto:t=!0,nivelConfianza:n=.95,umbral:c=.5,maxIteraciones:s=100,tolerancia:p=1e-8}){const u=zo("La variable dependiente",e,8);if(!u.every(_=>_===0||_===1))throw new Error("La variable dependiente debe estar codificada exclusivamente con 0 y 1.");const l=u.reduce((_,z)=>_+z,0),i=u.length-l;if(l===0||i===0)throw new Error("La variable dependiente debe contener observaciones de ambas categorías: 0 y 1.");if(!Array.isArray(a)||!a.length)throw new Error("Debe proporcionar al menos una variable predictora.");const o=a.map((_,z)=>zo(r[z]||`X${z+1}`,_,8));if(!o.every(_=>_.length===u.length))throw new Error("Todas las variables deben contener la misma cantidad de observaciones.");if(!(n>0&&n<1))throw new Error("El nivel de confianza debe estar entre 0 y 1.");if(!(c>0&&c<1))throw new Error("El umbral de clasificación debe estar entre 0 y 1.");const d=o.map((_,z)=>r[z]||`X${z+1}`),m=Ml(o,t),f=u.length,g=m[0].length;if(f<=g+2)throw new Error("No hay suficientes observaciones para estimar el modelo logístico con esta cantidad de predictores.");const b=ex(m,u,{maxIteraciones:s,tolerancia:p});if(!b.convergio)throw new Error("El algoritmo no alcanzó convergencia. Revise separación perfecta, predictores extremos, colinealidad o tamaño muestral insuficiente.");const x=ax(u,t),y=o.length,v=Math.max(0,2*(b.logLik-x.logLik)),h=Tl(v,y),w=Zh(.5+n/2),k=[...t?["Intercepto"]:[],...d],E=b.beta.map((_,z)=>{const _e=Math.sqrt(Math.max(b.covarianza[z][z],0)),T=_e>re?_/_e:_===0?0:1/0,S=Qh(T),X=_-w*_e,ca=_+w*_e;return{termino:k[z],estimacion:_,errorEstandar:_e,z:T,p:S,intervaloConfianza:{inferior:X,superior:ca,nivel:n},oddsRatio:Math.exp(Math.max(-Ye,Math.min(Ye,_))),intervaloOddsRatio:{inferior:Math.exp(Math.max(-Ye,Math.min(Ye,X))),superior:Math.exp(Math.max(-Ye,Math.min(Ye,ca))),nivel:n}}}),C=tx(u,b.probabilidades,c),$=rx(u,b.probabilidades),I=nx(u,b.probabilidades),A=ix(m,u,b.probabilidades,b.covarianza),L=ox(o,d),R=u.map((_,z)=>({observacion:z+1,observado:_,probabilidad:b.probabilidades[z],residuoPearson:A.residuosPearson[z],residuoDeviance:A.residuosDeviance[z],leverage:A.leverage[z],distanciaCook:A.distanciaCook[z]})).filter(_=>Math.abs(_.residuoPearson)>2||_.leverage>2*g/f||_.distanciaCook>4/f),N=-2*b.logLik,V=-2*x.logLik,P=-2*b.logLik+2*g,D=-2*b.logLik+g*Math.log(f),te=x.logLik!==0?1-b.logLik/x.logLik:null,Y=1-Math.exp(2/f*(x.logLik-b.logLik)),J=1-Math.exp(2/f*x.logLik),oe=J>re?Y/J:null,ue=C.exactitud===1,Q=b.beta.some(_=>Math.abs(_)>15),ge=ue&&Q,Se=[h!==null&&h<.05?`El modelo global mejora significativamente al modelo nulo (χ² = ${v.toFixed(4)}, gl = ${y}, p ${h<.001?"< 0.001":`= ${h.toFixed(4)}`}).`:`El modelo global no alcanza significación estadística al 5 % (χ² = ${v.toFixed(4)}, gl = ${y}, p = ${h?.toFixed(4)??"no disponible"}).`,`El área bajo la curva ROC es ${$.auc.toFixed(4)}, lo que resume la capacidad del modelo para ordenar casos positivos por encima de casos negativos.`,`Con umbral ${c.toFixed(2)}, la exactitud es ${(C.exactitud*100).toFixed(2)} %, la sensibilidad es ${C.sensibilidad===null?"no calculable":`${(C.sensibilidad*100).toFixed(2)} %`} y la especificidad es ${C.especificidad===null?"no calculable":`${(C.especificidad*100).toFixed(2)} %`}.`,I.p!==null&&I.p>=.05?`La prueba de Hosmer–Lemeshow no detecta una discrepancia significativa entre probabilidades observadas y esperadas (p = ${I.p.toFixed(4)}).`:`La prueba de Hosmer–Lemeshow sugiere revisar la calibración del modelo (p ${I.p!==null&&I.p<.001?"< 0.001":`= ${I.p?.toFixed(4)??"no disponible"}`}).`,L.some(_=>_.vif>=10)?"Se detectó multicolinealidad severa en al menos un predictor (VIF ≥ 10).":L.some(_=>_.vif>=5)?"Se detectó multicolinealidad moderada en al menos un predictor (VIF ≥ 5).":L.length?"No se detectó multicolinealidad relevante mediante el criterio VIF.":"El VIF no aplica a un modelo con un solo predictor.",R.length?`Se identificaron ${R.length} observaciones potencialmente influyentes que deben revisarse.`:"No se identificaron observaciones claramente influyentes mediante los criterios automáticos.",ge?"La clasificación perfecta junto con coeficientes extremos sugiere posible separación completa o cuasicompleta; los coeficientes pueden ser inestables.":"No se detectó el patrón automático de separación completa basado en clasificación perfecta y coeficientes extremos."];return{tipoModelo:"regresion-logistica-binaria",n:f,numeroPredictores:o.length,incluirIntercepto:t,nombresPredictores:d,nivelConfianza:n,convergencia:{convergio:b.convergio,iteraciones:b.iteraciones,posibleSeparacion:ge},distribucionRespuesta:{positivos:l,negativos:i,proporcionPositivos:l/f},coeficientes:E,ajuste:{logVerosimilitud:b.logLik,logVerosimilitudNula:x.logLik,deviance:N,devianceNula:V,aic:P,bic:D,r2McFadden:te,r2CoxSnell:Y,r2Nagelkerke:oe},pruebaGlobal:{chiCuadrado:v,gradosLibertad:y,p:h},clasificacion:C,roc:$,calibracion:I,diagnosticos:{...A,vif:L,observacionesInfluyentes:R},probabilidades:b.probabilidades,datosGrafico:u.map((_,z)=>({observacion:z+1,observado:_,probabilidad:b.probabilidades[z],clasePredicha:b.probabilidades[z]>=c?1:0,residuoPearson:A.residuosPearson[z],residuoDeviance:A.residuosDeviance[z],leverage:A.leverage[z],distanciaCook:A.distanciaCook[z],predictores:o.map(_e=>_e[z])})),interpretacion:Se}}function lx(e,a,r=e?.clasificacion?.umbral??.5){if(!e?.coeficientes?.length)throw new Error("El modelo proporcionado no es válido.");if(!Array.isArray(a)||a.length!==e.numeroPredictores)throw new Error(`Debe proporcionar ${e.numeroPredictores} valores predictores.`);if(!(r>0&&r<1))throw new Error("El umbral de clasificación debe estar entre 0 y 1.");const t=a.map(Number);if(!t.every(Number.isFinite))throw new Error("Los valores predictores deben ser numéricos.");const n=e.coeficientes.map(u=>u.estimacion),c=[...e.incluirIntercepto?[1]:[],...t],s=tt(c,n),p=Kt(s);return{predictorLineal:s,probabilidad:p,umbral:r,clasePredicha:p>=r?1:0}}function Ln(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ne(e,a=3){return e==null?"—":Number.isFinite(e)?Number(e).toLocaleString("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}):e>0?"∞":"—"}function Ba(e,a,r,t=""){return`
    ...
    `}function cx(e){const t={izquierda:62,derecha:24,superior:26,inferior:58},n=560-t.izquierda-t.derecha,c=390-t.superior-t.inferior,s=i=>t.izquierda+i*n,p=i=>t.superior+(1-i)*c,u=e.roc.puntos.map(i=>`${s(i.unoMenosEspecificidad)},${p(i.sensibilidad)}`).join(" "),l=`
        <div class="overflow-x-auto">
            <svg
                viewBox="0 0 560 390"
    ...
    `;return Ba("Curva ROC","Relaciona sensibilidad y tasa de falsos positivos para todos los umbrales posibles. La diagonal representa una clasificación sin capacidad discriminativa.",l)}function dx(e){const a=e.clasificacion,r=(n,c,s)=>`
    ...
    `;return Ba("Matriz de confusión",`Resume la clasificación con umbral ${ne(a.umbral,2)}. Los falsos positivos y falsos negativos deben interpretarse según el costo real de cada error.`,t)}function ux(e,a){const s=d=>48+d*504,l=e.datosGrafico.map((d,m)=>{const f=d.observado===1?90:210,g=(m%7-3)*5,b=d.observado===1?"text-indigo-700":"text-sky-500";return`
            <circle
                cx="${s(d.probabilidad)}"
                cy="${f+g}"
                r="5"
    ...
    `;return Ba("Probabilidades estimadas por clase","Una buena separación visual concentra los casos observados con valor 1 hacia probabilidades altas y los casos con valor 0 hacia probabilidades bajas.",o)}function px(e){const a=e.calibracion.grupos.map(o=>({...o,proporcionObservada:o.n>0?o.observadosPositivos/o.n:0})),r=560,t=390,n={izquierda:62,derecha:24,superior:26,inferior:58},c=r-n.izquierda-n.derecha,s=t-n.superior-n.inferior,p=o=>n.izquierda+o*c,u=o=>n.superior+(1-o)*s,l=a.map(o=>`${p(o.probabilidadMedia)},${u(o.proporcionObservada)}`).join(" "),i=`
        <div class="overflow-x-auto">
    ...
    `;return Ba("Distancia de Cook","Señala observaciones con potencial influencia sobre el ajuste. El criterio 4/n es orientativo y no sustituye la revisión del caso y del diseño del estudio.",c)}function bx(e,a="Y"){return`
        <section class="mt-10">
            <p class="uppercase tracking-widest text-indigo-700 text-xs font-black mb-2">
    ...
    `}function gx(){const e=document.createElement("section");let a=null,r=null;e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
1, 8.5, 96`,e.elements.nivelConfianza.value="0.95",e.elements.umbral.value="0.50",e.elements.incluirIntercepto.checked=!0}function qo(e,a){e.textContent=a,e.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"center"})}function Ot(e){e.textContent="",e.classList.add("hidden")}function oa(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function O(e,a=4){return e==null?"—":Number.isFinite(e)?Number(e).toLocaleString("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}):e>0?"∞":"—"}function lr(e){return e==null||!Number.isFinite(e)?"no disponible":e<.001?"< 0.001":`= ${O(e,4)}`}function Ft(e,a,r){return`
    ...
    `}function Cx(e){const a=e.clasificacion;return`
        <div class="overflow-x-auto rounded-2xl border border-slate-200">
            <table class="min-w-full text-sm">
                <thead class="bg-slate-950 text-white">
                    <tr>
    ...
    `}function $x(e){return e.diagnosticos.vif.length?`
        <div class="overflow-x-auto rounded-2xl border border-slate-200">
            <table class="min-w-full text-sm">
                <thead class="bg-slate-950 text-white">
                    <tr>
    ...
    `}function Px(e,a){const r=e.pruebaGlobal.p!==null&&e.pruebaGlobal.p<.05;return`
        <div class="rounded-3xl bg-slate-950 text-white p-6 md:p-9 shadow-2xl">
            <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
                <div>
    ...
    `}function Lx(e,a){const r=["REGRESIÓN LOGÍSTICA BINARIA — LABORATORIO KERNEL","",`Variable dependiente: ${a.nombreDependiente} (evento = 1)`,`Predictores: ${e.nombresPredictores.join(", ")}`,`n = ${e.n}`,`χ² global = ${O(e.pruebaGlobal.chiCuadrado,4)}`,`p del modelo ${lr(e.pruebaGlobal.p)}`,`R² Nagelkerke = ${O(e.ajuste.r2Nagelkerke,4)}`,`AUC = ${O(e.roc.auc,4)}`,`Exactitud = ${O(e.clasificacion.exactitud*100,2)} %`,`Sensibilidad = ${e.clasificacion.sensibilidad===null?"no calculable":`${O(e.clasificacion.sensibilidad*100,2)} %`}`,`Especificidad = ${e.clasificacion.especificidad===null?"no calculable":`${O(e.clasificacion.especificidad*100,2)} %`}`,"","Coeficientes:"];return e.coeficientes.forEach(t=>{r.push(`${t.termino}: B = ${O(t.estimacion,6)}, OR = ${O(t.oddsRatio,5)}, z = ${O(t.z,4)}, p ${lr(t.p)}`)}),r.push("","Interpretación:"),e.interpretacion.forEach(t=>r.push(`- ${t}`)),r.push("","Diseño y desarrollo de las calculadoras: Miguel Antonio Leonardo Sepúlveda y Natanael Ureña Castillo."),r.join(`
`)}function Rx(e){return`"${String(e??"").replaceAll('"','""')}"`}function Mx(e,a){const t=[["REGRESIÓN LOGÍSTICA BINARIA"],["Variable dependiente",a.nombreDependiente],["Predictores",e.nombresPredictores.join(", ")],["n",e.n],["Chi-cuadrado global",e.pruebaGlobal.chiCuadrado],["p del modelo",e.pruebaGlobal.p],["R2 McFadden",e.ajuste.r2McFadden],["R2 Cox-Snell",e.ajuste.r2CoxSnell],["R2 Nagelkerke",e.ajuste.r2Nagelkerke],["AIC",e.ajuste.aic],["BIC",e.ajuste.bic],["AUC",e.roc.auc],["Umbral",e.clasificacion.umbral],["Exactitud",e.clasificacion.exactitud],["Sensibilidad",e.clasificacion.sensibilidad],["Especificidad",e.clasificacion.especificidad],[],["Término","Coeficiente","Error estándar","z","p","Odds ratio","IC OR inferior","IC OR superior"],...e.coeficientes.map(s=>[s.termino,s.estimacion,s.errorEstandar,s.z,s.p,s.oddsRatio,s.intervaloOddsRatio.inferior,s.intervaloOddsRatio.superior]),[],["Observación","Observado","Probabilidad","Clase predicha","Residuo Pearson","Residuo deviance","Leverage","Distancia de Cook"],...e.datosGrafico.map(s=>[s.observacion,s.observado,s.probabilidad,s.clasePredicha,s.residuoPearson,s.residuoDeviance,s.leverage,s.distanciaCook]),[],["Diseño y desarrollo","Miguel Antonio Leonardo Sepúlveda y Natanael Ureña Castillo"]].map(s=>s.map(Rx).join(",")).join(`
`),n=new Blob(["\uFEFF",t],{type:"text/csv;charset=utf-8"}),c=document.createElement("a");c.href=URL.createObjectURL(n),c.download="regresion-logistica-binaria-kernel.csv",c.click(),URL.revokeObjectURL(c.href)}async function Tx(e,a,r){const t=Lx(e,a),n=r.textContent;try{await navigator.clipboard.writeText(t),r.textContent="Reporte copiado"}catch{const c=document.createElement("textarea");c.value=t,document.body.appendChild(c),c.select(),document.execCommand("copy"),c.remove(),r.textContent="Reporte copiado"}window.setTimeout(()=>{r.textContent=n},1800)}async function Nx(){const e=await Mn(()=>import("./CalculadoraRegresionConteo-VE7dPXsR.js"),[],import.meta.url);if(typeof e.CalculadoraRegresionConteo!="function")throw new Error("La calculadora de regresión de conteo no está disponible.");return e.CalculadoraRegresionConteo()}async function Sx(){const e=await Mn(()=>import("./CalculadoraFiabilidadCuestionarios-cvzxa8nN.js"),[],import.meta.url);if(typeof e.CalculadoraFiabilidadCuestionarios!="function")throw new Error("La calculadora de cuestionarios y fiabilidad no está disponible.");return e.CalculadoraFiabilidadCuestionarios()}async function _x(){const e=await Mn(()=>import("./CalculadoraEvaluacionEducativa-PuzJmWyR.js"),[],import.meta.url);if(typeof e.CalculadoraEvaluacionEducativa!="function")throw new Error("La calculadora de evaluación educativa no está disponible.");return e.CalculadoraEvaluacionEducativa()}const zx={home:{page:ac,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:yc,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Ic,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Tc,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:Wc,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Zc,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:fd,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:sd,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Cd,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Rd,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Sf,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Kf,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},comparacionGrupos:{page:sb,layout:"default",title:"Comparación de grupos y mediciones | El Kernel"},calculadoraDosGrupos:{page:wb,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:Sb,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"},calculadoraTresOMasGrupos:{page:tg,layout:"default",title:"Comparación de tres o más grupos independientes | El Kernel"},calculadoraTresOMasMedicionesRelacionadas:{page:Lg,layout:"default",title:"Comparación de tres o más mediciones relacionadas | El Kernel"},correlacionAsociacion:{page:qg,layout:"default",title:"Correlación y asociación | El Kernel"},calculadoraRelacionVariables:{page:Yg,layout:"default",title:"Relación entre variables | El Kernel"},calculadoraAsociacionCategorica:{page:x0,layout:"default",title:"Asociación entre variables categóricas | El Kernel"},calculadoraEstadisticaDescriptiva:{page:J0,layout:"default",title:"Estadística descriptiva | El Kernel"},calculadoraFiabilidadCuestionarios:{page:Sx,layout:"default",title:"Cuestionarios y fiabilidad | El Kernel"},calculadoraEvaluacionEducativa:{page:_x,layout:"default",title:"Evaluación educativa | El Kernel"},regresionModelos:{page:dh,layout:"default",title:"Modelos de regresión | El Kernel"},calculadoraRegresion:{page:Th,layout:"default",title:"Regresión lineal y múltiple | El Kernel"},calculadoraRegresionLogistica:{page:gx,layout:"default",title:"Regresión logística binaria | El Kernel"},calculadoraRegresionConteo:{page:Nx,layout:"default",title:"Regresión de Poisson y binomial negativa | El Kernel"}};let Oo=document.referrer||"";function ht(e){window.location.hash=`/${e}`}function Dx(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";Fx(a)};window.addEventListener("hashchange",e),e()}function qx(e,a){const r=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:r,page_referrer:Oo}),Oo=r}function Ox(e){const a=document.createElement("section");a.className=`
    ...
    `;const r=a.querySelector("[data-mensaje-error-ruta]");return r&&(r.textContent=e instanceof Error?e.message:"Se produjo un error inesperado."),a.querySelector("[data-action='reintentar-ruta']")?.addEventListener("click",()=>{window.location.reload()}),a.querySelector("[data-action='volver-laboratorio']")?.addEventListener("click",()=>{ht("laboratorioKernel")}),a}async function Fx(e){const a=document.querySelector("main"),r=zx[e];if(a){if(a.innerHTML="",!r){ht("home");return}Pc(r.layout),document.title=r.title;try{const t=await r.page();if(!(t instanceof Element))throw new Error("La herramienta no devolvió un componente válido.");a.appendChild(t),window.scrollTo({top:0,behavior:"auto"}),qx(e,r.title)}catch(t){console.error(`[Kernel] Error al cargar la ruta ${e}.`,t),a.appendChild(Ox(t))}}}function Ux(e,a){Wo(e,ht),Dx();const r=window.matchMedia("(max-width: 768px)");let t=!1;function n(s){s.matches&&!t&&(oi(e),t=!0)}r.addEventListener("change",n),n(r),oi(e);const c=a.querySelector('[data-action ="open-menu"]');Dl(c,e),ql(e)}function jx(e){const a=String(e??"").replace(/\u00a0/g,"").replace(/\s/g,"").replace(/[^0-9+\-.,eE]/g,"");if(!a)return null;const r=a.lastIndexOf(","),t=a.lastIndexOf(".");let n=a;r>=0&&t>=0?n=t>r?a.replace(/,/g,""):a.replace(/\./g,"").replace(",","."):r>=0&&(n=a.length-r-1===3&&r>0?a.replace(/,/g,""):a.replace(",","."));const c=Number(n);return Number.isFinite(c)?c:null}function Vx(e){const a=e.querySelector("table");if(!a)return null;const t=[...a.querySelectorAll("thead th")].map(c=>c.textContent.trim().toLowerCase()).some(c=>c.includes("marca")),n=[...a.querySelectorAll("tbody tr")].map(c=>{const s=[...c.querySelectorAll("td")],p=Number(s[t?2:1]?.textContent.trim()),u=Number(s[t?4:3]?.textContent.trim());return{etiqueta:s[0]?.textContent.trim()||"",valor:jx(s[t?1:0]?.textContent),frecuencia:Number.isFinite(p)?p:0,acumulada:Number.isFinite(u)?u:0}}).filter(c=>c.etiqueta&&c.frecuencia>=0);return{agrupados:t,filas:n}}function Nl(e){return Number.isFinite(Number(e))?Number(e).toLocaleString("es-DO",{maximumFractionDigits:3}):"—"}function Fo(e,a){let r=0;for(const t of e)if(r+=t.frecuencia,a<r)return t.valor;return e.at(-1)?.valor??null}function pn(e,a){const r=e.reduce((u,l)=>u+l.frecuencia,0);if(!r)return null;if(a<=0)return e[0].valor;if(a>=1)return e.at(-1).valor;const t=(r-1)*a,n=Math.floor(t),c=Math.ceil(t),s=Fo(e,n),p=Fo(e,c);return n===c?s:s*(c-t)+p*(t-n)}function Ja(e,a,r){return`
        <text
            x="${e}"
            y="${a}"
            text-anchor="middle"
        ...
        >${Nl(r)}</text>
    `}function Bx(e,a){if(!e||e.dataset.cajaDescriptivaSegura==="true"||a.agrupados)return;e.dataset.cajaDescriptivaSegura="true";const r=a.filas.filter(h=>h.valor!==null&&h.frecuencia>0).sort((h,w)=>h.valor-w.valor);if(r.reduce((h,w)=>h+w.frecuencia,0)<2)return;const n=r[0].valor,c=r.at(-1).valor,s=pn(r,.25),p=pn(r,.5),u=pn(r,.75),l=u-s,i=s-1.5*l,o=u+1.5*l,d=r.filter(h=>h.valor>=i&&h.valor<=o),m=r.filter(h=>h.valor<i||h.valor>o),f=d[0]?.valor??n,g=d.at(-1)?.valor??c,b=Math.max(c-n,1),x=h=>40+(h-n)/b*520,y=e.querySelector("svg");if(!y)return;y.setAttribute("aria-label","Diagrama de caja con cuartiles, mediana, bigotes y valores atípicos potenciales"),y.innerHTML=`
        ...
        ${Ja(x(u),30,u)}
        ${Ja(x(g),140,g)}
    `;const v=e.querySelector("h3 + p");v&&(v.textContent="Los bigotes terminan en los valores extremos no atípicos. Los puntos rojos representan valores atípicos potenciales según el criterio de Tukey.")}function Gx(){const e=document.createElement("section");return e.dataset.encabezadoGraficosSeguro="true",e.className="mt-10",e.innerHTML=`
        <p class="uppercase tracking-widest text-sky-700 text-xs font-black mb-2">
            Visualización estadística
        </p>
    ...
    `,e}function Hx(e){const a=document.createElement("article");a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const r=Math.max(...e.map(t=>t.frecuencia),1);return a.innerHTML=`
    ...
    `,a}function Kx(e){const a=[...e.querySelectorAll("article")],r=a.find(s=>s.querySelector("h3")?.textContent.includes("Distribución de frecuencias")),t=a.find(s=>s.querySelector("h3")?.textContent.includes("Diagrama de caja"));if(!r||!t)return;const n=r.parentElement,c=Vx(e);if(!(!n||!c?.filas.length)&&(e.querySelector("[data-encabezado-graficos-seguro='true']")||(n.before(Gx()),n.classList.remove("mt-8")),Bx(t,c),!e.querySelector("[data-graficos-descriptivos-seguros='true']"))){const s=document.createElement("div");s.dataset.graficosDescriptivosSeguros="true",s.className="grid grid-cols-1 xl:grid-cols-2 gap-7 mt-7",s.append(Hx(c.filas),Wx(c.filas)),n.after(s)}}function Yx(){let e=!1;const a=()=>{e=!1;const n=document.querySelector("#resultados-estadistica-descriptiva");n&&!n.classList.contains("hidden")&&Kx(n)},r=()=>{e||(e=!0,window.requestAnimationFrame(a))};new MutationObserver(r).observe(document.body,{childList:!0,subtree:!0}),r()}function Jx(e,a){return`${e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||`grafico-${a+1}`}.svg`}function Qx(e,a,r){const t=e.cloneNode(!0);t.getAttribute("xmlns")||t.setAttribute("xmlns","http://www.w3.org/2000/svg");const c=new XMLSerializer().serializeToString(t),s=new Blob([c],{type:"image/svg+xml;charset=utf-8"}),p=URL.createObjectURL(s),u=document.createElement("a");u.href=p,u.download=Jx(a,r),document.body.appendChild(u),u.click(),u.remove(),setTimeout(()=>URL.revokeObjectURL(p),1e3)}function Xx(e,a,r){if(e.querySelector("[data-descargar-svg]"))return;const t=e.querySelector("h3")?.textContent.trim()||`Gráfico ${r+1}`,n=document.createElement("button");n.type="button",n.dataset.descargarSvg="true",n.className=`
    ...
    `,n.innerHTML=`
        <span aria-hidden="true">↓</span>
        Descargar SVG
    `,n.setAttribute("aria-label",`Descargar ${t} en formato SVG`),n.addEventListener("click",()=>{Qx(a,t,r)}),e.appendChild(n)}function Zx(e){const a=window.open("","_blank");if(!a){window.print();return}const r=`
        <style>
    ...
    `),a.document.close(),a.addEventListener("load",()=>{a.focus(),a.print()})}function ev(e){if(e.querySelector("[data-herramientas-exportacion='true']"))return;const a=document.createElement("section");a.dataset.herramientasExportacion="true",a.className=`
    ...
    `,a.querySelector("[data-imprimir-informe]")?.addEventListener("click",()=>{Zx(e)}),e.prepend(a)}function av(e){ev(e),[...e.querySelectorAll("article")].forEach((r,t)=>{const n=r.querySelector("svg");n&&Xx(r,n,t)})}function tv(){const e=()=>{const r=document.querySelector("#resultados-estadistica-descriptiva");r&&!r.classList.contains("hidden")&&av(r)};new MutationObserver(e).observe(document.body,{childList:!0,subtree:!0}),e()}const rv=["#formulario-estadistica-descriptiva","#formulario-regresion","#formulario-regresion-conteo","[id*='calculadora'] form","section form"].join(",");function nv(){return document.querySelector("main h1, #app h1, h1")?.textContent?.trim()?.toLowerCase()||""}function iv(){return nv().includes("laboratorio inteligente de investigación")}function ov(){const e=document.querySelector("main h1, #app h1, h1"),a=document.querySelector("[data-action='volver-laboratorio'], [data-action='volver-modelos'], [data-action='volver-regresion']"),r=document.querySelector(rv);return!!(e&&a&&r)}function sv(){const e=document.createElement("section");return e.dataset.creditosCalculadoras="true",e.className=["w-full max-w-7xl mx-auto","px-4 pb-10 md:px-8","font-sans"].join(" "),e.innerHTML=`
    ...
    `,e}function Uo(){if(!ov()&&!iv()||document.querySelector("[data-creditos-calculadoras='true']"))return;const e=document.querySelector("main, #app, [data-router-view]");e&&e.appendChild(sv())}function lv(){new MutationObserver(Uo).observe(document.body,{childList:!0,subtree:!0}),Uo()}function cv(){return[...document.querySelectorAll("main h1")].find(a=>a.textContent.trim().toLowerCase().includes("laboratorio inteligente de investigación"))&&[...document.querySelectorAll("main article")].find(a=>a.querySelector("h3")?.textContent?.trim()?.toLowerCase()==="regresión")||null}function jo(){const e=cv();if(!e||e.dataset.regresionConectada==="true")return;const a=e.querySelector("h3 + p"),r=e.querySelector("button");a&&(a.textContent="Regresión lineal simple y múltiple, y regresión logística binaria, con inferencia, diagnósticos gráficos, predicción e interpretación guiada."),r&&(r.onclick=()=>{window.location.hash="/regresionModelos"},r.setAttribute("aria-label","Explorar los modelos de regresión")),e.dataset.regresionConectada="true"}function dv(){new MutationObserver(jo).observe(document.body,{childList:!0,subtree:!0}),jo()}const uv={"regresión lineal simple":{ruta:"calculadoraRegresion",tipo:"simple",almacenamiento:"kernel-tipo-modelo-regresion",clase:"rose",texto:"Abra la calculadora de regresión lineal y cargue una variable dependiente cuantitativa y un predictor."},"regresión lineal múltiple":{ruta:"calculadoraRegresion",tipo:"multiple",almacenamiento:"kernel-tipo-modelo-regresion",clase:"rose",texto:"Abra la calculadora de regresión lineal y cargue una variable dependiente cuantitativa y dos o más predictores."},"regresión logística binaria simple":{ruta:"calculadoraRegresionLogistica",tipo:"simple",almacenamiento:"kernel-tipo-modelo-regresion",clase:"rose",texto:"Abra la calculadora logística y cargue una variable dependiente codificada 0/1 y un predictor."},"regresión logística binaria múltiple":{ruta:"calculadoraRegresionLogistica",tipo:"multiple",almacenamiento:"kernel-tipo-modelo-regresion",clase:"rose",texto:"Abra la calculadora logística y cargue una variable dependiente codificada 0/1 y dos o más predictores."},"regresión de poisson":{ruta:"calculadoraRegresionConteo",tipo:"poisson",almacenamiento:"kernel-modelo-conteo",clase:"amber",texto:"Abra la calculadora de conteo y ajuste un modelo de Poisson con una variable dependiente formada por enteros no negativos."},"regresión binomial negativa":{ruta:"calculadoraRegresionConteo",tipo:"negativa",almacenamiento:"kernel-modelo-conteo",clase:"amber",texto:"Abra la calculadora de conteo y ajuste un modelo binomial negativo cuando exista sobredispersión respecto a Poisson."}};function pv(){const e=[...document.querySelectorAll("main h1")];for(const a of e){const r=a.textContent.trim().toLowerCase(),t=uv[r];if(t)return{encabezado:a,modelo:t}}return null}function mv(e){const a=document.createElement("div"),r=e.clase==="amber",t=r?"border-amber-200":"border-rose-200",n=r?"bg-amber-50":"bg-rose-50",c=r?"text-amber-700":"text-rose-700",s=r?"bg-amber-600 hover:bg-amber-700":"bg-rose-700 hover:bg-rose-800";return a.dataset.ejecutarModeloRegresion="true",a.className=`mt-8 rounded-2xl border ${t} ${n} p-6`,a.innerHTML=`
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            <div>
    ...
    `,a.querySelector("button")?.addEventListener("click",p=>{const u=p.currentTarget,l=u.dataset.almacenamientoRegresion||"kernel-tipo-modelo-regresion";sessionStorage.setItem(l,u.dataset.tipoRegresion||""),window.location.hash=`/${u.dataset.routeRegresion}`}),a}function Vo(){const e=pv();if(!e)return;const a=e.encabezado.closest("section");if(!a||a.querySelector("[data-ejecutar-modelo-regresion='true']"))return;(a.querySelector("header + div")||a).appendChild(mv(e.modelo))}function fv(){new MutationObserver(Vo).observe(document.body,{childList:!0,subtree:!0}),Vo()}function bv(){return[...document.querySelectorAll("main h1")].find(a=>a.textContent.trim().toLowerCase().includes("laboratorio inteligente de investigación"))&&[...document.querySelectorAll("main article")].find(a=>a.querySelector("h3")?.textContent?.trim()?.toLowerCase()==="cuestionarios y fiabilidad")||null}function Bo(){const e=bv();if(!e||e.dataset.fiabilidadConectada==="true")return;const a=e.querySelector("h3 + p"),r=e.querySelector("button");a&&(a.textContent="Alfa de Cronbach, alfa estandarizado, omega aproximado, análisis de ítems, recodificación y gráficos diagnósticos."),r&&(r.onclick=()=>{window.location.hash="/calculadoraFiabilidadCuestionarios"},r.setAttribute("aria-label","Abrir la calculadora de cuestionarios y fiabilidad")),e.dataset.fiabilidadConectada="true"}function gv(){new MutationObserver(Bo).observe(document.body,{childList:!0,subtree:!0}),Bo()}function hv(e){e.target.closest("#asistente-pruebas [data-value='instrumento']")&&(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),window.location.hash="/calculadoraFiabilidadCuestionarios")}function xv(){document.addEventListener("click",hv,!0)}function vv(){return[...document.querySelectorAll("main h1")].find(a=>a.textContent.trim().toLowerCase().includes("laboratorio inteligente de investigación"))&&[...document.querySelectorAll("main article")].find(a=>a.querySelector("h3")?.textContent?.trim()?.toLowerCase()==="evaluación educativa")||null}function Go(){const e=vv();if(!e||e.dataset.evaluacionEducativaConectada==="true")return;const a=e.querySelector("h3 + p"),r=e.querySelector("button");a&&(a.textContent="Dificultad, discriminación, correlación punto-biserial, KR-20, distractores, puntuaciones y gráficos diagnósticos."),r&&(r.onclick=()=>{window.location.hash="/calculadoraEvaluacionEducativa"},r.setAttribute("aria-label","Abrir la calculadora de evaluación educativa")),e.dataset.evaluacionEducativaConectada="true"}function yv(){new MutationObserver(Go).observe(document.body,{childList:!0,subtree:!0}),Go()}function Be(e,a){try{a()}catch(r){console.error(`[Kernel] No fue posible iniciar ${e}.`,r)}}const cr=document.querySelector("#header"),dr=document.querySelector("#navBar"),Ho=document.querySelector("#footer");cr&&(cr.innerHTML=Sl());dr&&(dr.innerHTML=_l());Ho&&(Ho.innerHTML=zl());Be("la navegación",()=>{dr&&cr&&Ux(dr,cr)});Be("los gráficos de estadística descriptiva",Yx);Be("la exportación de estadística descriptiva",tv);Be("los créditos de las calculadoras",lv);Be("la integración del área de regresión",dv);Be("la integración de regresión con el asistente",fv);Be("la integración de cuestionarios y fiabilidad",gv);Be("cuestionarios y fiabilidad en el asistente",xv);Be("la integración de evaluación educativa",yv);
