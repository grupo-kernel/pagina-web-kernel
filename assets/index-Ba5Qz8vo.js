(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const ge=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Je(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function We(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    ...
    `}function Ie(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function ta(e){Ie(e,ce)}const Re=""+new URL("apec-ConmXkrT.png",import.meta.url).href,ia=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,oa=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,Ae=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        <img src="${oa}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return sa(t.querySelector("#containerFather")),ta(t.querySelector("#btnsGroup")),t}const na="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function la(){try{const e=await fetch(na,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function Z(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function ca(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function da(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const s=await la();a.textContent=Z(s.total),t.textContent=Z(s.hoy),i.textContent=Z(s.ultimos7Dias),o.textContent=Z(s.ultimos30Dias);const d=ca(s.actualizadoEn);n.textContent=d?`Actualizado: ${d}`:"Estadísticas temporalmente no disponibles"}catch(s){console.error("Error al mostrar las estadísticas en la portada:",s),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function pa(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=aa();const a=ra();return e.appendChild(a),da(e),e}function ua(){return pa()}const ma=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function xa(){return`
        <section 
            role="banner" 
    ...
    `}const wa="data:image/png;base64,",ya="data:image/png;base64,",ka="data:image/png;base64,",Aa="data:image/png;base64,",Ca="data:image/png;base64,",Ea=[{icon:wa,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:ya,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:ka,title:"Objetivos",content:`
      ...
      </ul>`},{icon:Aa,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Ma({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${Ca}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function Pa(){const e=document.createElement("section");return e.className=`
    ...
    `).join("")}function za(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function Ia(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=Da(e.redes||[]),i=za(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}const Ne=""+new URL("rad-B3ff1btG.png",import.meta.url).href,Fe=""+new URL("mar-Cru0HERG.png",import.meta.url).href,K=[{img:re,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:le,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:Ne,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:fe,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:Fe,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:ne,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:_,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function Ra(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const m=o();return Math.max(K.length-m,0)},s=()=>{const m=n();e>m&&(e=0),e<0&&(e=m)},d=()=>{const m=n();e>=m?e=0:e++,u()},x=()=>{const m=n();e<=0?e=m:e--,u()},v=()=>{l(),K.length>o()&&(a=setInterval(d,4500))},l=()=>{a&&(clearInterval(a),a=null)},w=()=>{const m=o(),p=Math.max(K.length-m+1,1);return Array.from({length:p}).map((y,g)=>`
        ...
        `).join("")},u=()=>{if(!K||K.length===0){i.innerHTML=`
            ...
            `;return}s();const m=o(),p=K.slice(e,e+m);i.innerHTML=`
        ...
        `;const y=i.querySelector("#cards-wrapper");p.forEach(A=>{y.appendChild(Ia(A))});const g=i.querySelector("#prev-btn"),k=i.querySelector("#next-btn");g&&(g.onclick=()=>{x(),v()}),k&&(k.onclick=()=>{d(),v()}),i.querySelectorAll("[data-dot-index]").forEach(A=>{A.onclick=()=>{e=parseInt(A.dataset.dotIndex),u(),v()}})};return i.addEventListener("mouseenter",l),i.addEventListener("mouseleave",v),document.addEventListener("visibilitychange",()=>{document.hidden?l():v()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,u(),v()},150)}),u(),v(),i}function Na(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&ce(t.dataset.route)})}function qe(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Na(a),a}function Fa(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(qe());const t=Ra();return e.appendChild(a),e.appendChild(t),e}function qa(){return Fa()}function Ta(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function N(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Te(e){return e.formacion?.length||0}function Be(e){return e.experiencia?.length||0}function Ba(e,a=!1){const t=Te(e),i=Be(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function Oa(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(d=>`
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ya({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:n,category:s="Noticia",imageFit:d="contain"}){const x=d==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
    ...
    `}function _a(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function Za(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function et(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const a=Za(Oe),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ${Wa(t)}
        ${Xa(a)}
        ${_a()}
    `,e}function at({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(s=>`<p>${s}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function tt(e){e&&e.addEventListener("click",a=>{const t=a.target.closest("[data-news-btn], [data-news-card]");if(!t||!e.contains(t))return;const i=t.dataset.newsBtn||t.dataset.newsCard,o=Oe.find(n=>String(n.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}it(o)})}function it(e){const a=document.querySelector("#newsModal");a&&a.remove();const t=document.createElement("div");t.innerHTML=at(e);const i=t.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",n)}function n(s){s.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(s=>{s.addEventListener("click",o)}),i.addEventListener("click",s=>{s.target===i&&o()}),document.addEventListener("keydown",n)}function ot(){const e=et();return tt(e),e}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ue(e){return e?.name||e?.title||"Investigador"}function Ce(e){return e?.title||e?.tile||"Revista no especificada"}function Ve(e){return String(e?.DOI||e?.doi||"").trim()}function st(e){const a=Ve(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function rt(e){return[...e?.publicaciones||[]].sort((a,t)=>{const i=Number(a.year||0),o=Number(t.year||0);return i!==o?o-i:String(a.contenido||"").localeCompare(String(t.contenido||""))})}function nt(e,a=!1){const t=Ue(e),i=e.publicaciones||[],o=i.length,n=i.map(d=>Number(d.year)).filter(Boolean),s=n.length?Math.max(...n):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${a?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function lt(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const a=Ue(e),t=rt(e),i=t.length,o=t.map(l=>Number(l.year)).filter(Boolean),n=o.length?Math.min(...o):"",s=o.length?Math.max(...o):"",d=[...new Set(t.map(l=>l.q).filter(Boolean))],x=[...new Set(t.map(l=>Ce(l)).filter(Boolean))],v=t.map(l=>{const w=Ce(l),u=Ve(l),m=st(l);return`
    ...
    `}function ct(){let e=T[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(p){return String(p?.DOI||p?.doi||"").trim().toLowerCase()}function n(p){return String(p?.journal||p?.title||p?.tile||"").trim()}function s(p){return String(p?.articleTitle||p?.contenido||"").trim()}function d(p){return String(p?.q||p?.quartile||"").trim().toUpperCase()}function x(p){const y=o(p);return y||[p?.year||"",n(p),s(p)].join("-").trim().toLowerCase()}function v(){const p=new Map;return T.forEach(y=>{(y.publicaciones||[]).forEach(g=>{const k=x(g);k&&!p.has(k)&&p.set(k,g)})}),Array.from(p.values())}function l(){const p=v(),y=p.map(L=>Number(L.year)).filter(Boolean),g=y.length?Math.max(...y):"—",k=y.length?Math.min(...y):"—",A=p.filter(L=>d(L)==="Q1").length;return{totalPublicaciones:p.length,investigadores:T.length,q1:A,primerYear:k,ultimoYear:g}}function w(){return T.find(p=>Number(p.id)===Number(e))||T[0]}const u=()=>{const p=w(),y=l(),g=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${T.map(A=>nt(A,Number(A.id)===Number(e))).join("")}
                </aside>
    ...
    `}function bt(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function gt(){const e=new Set(G.map(i=>i.categoria)),a=G.filter(i=>i.proyectosAsociados?.length>0).length,t=G.filter(i=>i.publicacionesClave?.length>0).length;return{total:G.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function ft(){let e=G[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=pt(e),o=gt();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function Ct(){let e=X[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=ht(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function Et(){return Ct()}function St(){return`
    ...
    `}function Pt(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Mt()}
    `,e}function Lt(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",jt)}async function jt(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=$t(i);if(o.length>0){zt(o);return}await It(a,i)}function $t(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?Dt(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function Dt(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function zt(e){se(e[0],"error")}function se(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function It(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(se("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):se("Hubo un problema al enviar el mensaje.","error")}catch{se("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Rt(){const e=Pt();return setTimeout(()=>{Lt()},0),e}function Nt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
A00116736    13    7"
    ...
    `;const a=e.querySelector("#banner-primer-input"),t=e.querySelector("#banner-primer-process"),i=e.querySelector("#banner-primer-clear"),o=e.querySelector("#banner-primer-message"),n=e.querySelector("#banner-primer-preview"),s=e.querySelector("#banner-primer-count"),d=e.querySelector("#banner-primer-download-1ac"),x=e.querySelector("#banner-primer-download-2pp");let v=[];function l(r,h="success"){o.textContent=r,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),h==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(){o.textContent="",o.classList.add("hidden")}function u(r){return String(r).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function m(r){return String(r).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function p(r){const h=String(r).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return h.includes("	")?h.split("	").map(f=>f.trim()).filter(f=>f!==""):h.includes(";")?h.split(";").map(f=>f.trim()).filter(f=>f!==""):h.split(/\s+/).map(f=>f.trim()).filter(f=>f!=="")}function y(r){const h=r.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),f=[],E=[],z=new Set;return h.forEach((C,j)=>{const M=j+1,D=p(C);if(D.length!==3){E.push(`Línea ${M}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const H=u(D[0]),Q=Number(m(D[1])),W=Number(m(D[2]));if(!/^A[0-9]{8}$/.test(H)){E.push(`Línea ${M}: la matrícula "${H}" no es válida. Debe tener el formato A00108671.`);return}if(z.has(H)){E.push(`Línea ${M}: la matrícula ${H} está repetida.`);return}if(!Number.isFinite(Q)){E.push(`Línea ${M}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(W)){E.push(`Línea ${M}: la calificación 2PP no es numérica.`);return}if(Q<0||Q>15){E.push(`Línea ${M}: 1AC debe estar entre 0 y 15.`);return}if(W<0||W>20){E.push(`Línea ${M}: 2PP debe estar entre 0 y 20.`);return}const ye=Q+W;if(ye>35){E.push(`Línea ${M}: la suma de 1AC y 2PP no puede superar 35 puntos.`);return}z.add(H),f.push({matricula:H,grade1AC:Q,grade2PP:W,total:ye})}),{records:f,errors:E}}function g(r){return Number.isInteger(r)?String(r):r.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function k(r){return String(r).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function A(r){if(r.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="5"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,s.textContent="0 estudiantes";return}n.innerHTML=r.map((h,f)=>`
                ...
                `).join(""),s.textContent=`${r.length} estudiante${r.length===1?"":"s"}`}function L(r,h,f){return[["MATRICULA",f],...r.map(C=>[C.matricula,g(C[h])])].map(C=>C.join(";")).join(`\r
`)}function c(r,h){const E=new Blob(["\uFEFF"+r],{type:"text/csv;charset=utf-8;"}),z=URL.createObjectURL(E),C=document.createElement("a");C.href=z,C.download=h,document.body.appendChild(C),C.click(),C.remove(),window.setTimeout(()=>{URL.revokeObjectURL(z)},1e3)}function b(){v=[],a.value="",A([]),d.disabled=!0,x.disabled=!0,w(),a.focus()}return t.addEventListener("click",()=>{const r=a.value.trim();if(!r){v=[],A([]),d.disabled=!0,x.disabled=!0,l("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:h,errors:f}=y(r);if(f.length>0){v=[],A([]),d.disabled=!0,x.disabled=!0,l(f.join(" "),"error");return}v=h,A(v),d.disabled=!1,x.disabled=!1,l(`Los datos de ${h.length} estudiante${h.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",b),d.addEventListener("click",()=>{if(v.length===0)return;const r=L(v,"grade1AC","1AC");c(r,"Banner_APEC_Primer_Periodo_1AC.csv")}),x.addEventListener("click",()=>{if(v.length===0)return;const r=L(v,"grade2PP","2PP");c(r,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function Ft(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    25"
    ...
    `;const a=e.querySelector("#banner-segundo-input"),t=e.querySelector("#banner-segundo-process"),i=e.querySelector("#banner-segundo-clear"),o=e.querySelector("#banner-segundo-message"),n=e.querySelector("#banner-segundo-preview"),s=e.querySelector("#banner-segundo-count"),d=e.querySelector("#banner-segundo-download");let x=[];function v(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function l(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function w(c){const b=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return b.includes("	")?b.split("	").map(r=>r.trim()).filter(r=>r!==""):b.includes(";")?b.split(";").map(r=>r.trim()).filter(r=>r!==""):b.split(/\s+/).map(r=>r.trim()).filter(r=>r!=="")}function u(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function m(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function p(c,b="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),b==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(c){const b=c.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),r=[],h=[],f=new Set;return b.forEach((E,z)=>{const C=z+1,j=w(E);if(j.length!==2){h.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const M=v(j[0]),D=Number(l(j[1]));if(!/^A[0-9]{8}$/.test(M)){h.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(f.has(M)){h.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(D)){h.push(`Línea ${C}: la calificación 3SP no es numérica.`);return}if(D<0||D>35){h.push(`Línea ${C}: 3SP debe estar entre 0 y 35.`);return}f.add(M),r.push({matricula:M,grade3SP:D})}),{records:r,errors:h}}function g(c){if(c.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,s.textContent="0 estudiantes";return}n.innerHTML=c.map((b,r)=>`
                    <tr class="border-b border-slate-100 last:border-b-0">
                        <td class="px-4 py-3 text-slate-500">
                            ${r+1}
                        </td>
                ...
                `).join(""),s.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function k(c){return[["MATRICULA","3SP"],...c.map(r=>[r.matricula,u(r.grade3SP)])].map(r=>r.join(";")).join(`\r
`)}function A(c,b){const r=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(r),f=document.createElement("a");f.href=h,f.download=b,document.body.appendChild(f),f.click(),f.remove(),window.setTimeout(()=>{URL.revokeObjectURL(h)},1e3)}function L(){x=[],a.value="",g([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){x=[],g([]),d.disabled=!0,p("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:b,errors:r}=y(c);if(r.length>0){x=[],g([]),d.disabled=!0,p(r.join(" "),"error");return}x=b,g(b),d.disabled=!1,p(`Los datos de ${b.length} estudiante${b.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",L),d.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function qt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    20"
    ...
    `;const a=e.querySelector("#banner-final-input"),t=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),n=e.querySelector("#banner-final-preview"),s=e.querySelector("#banner-final-count"),d=e.querySelector("#banner-final-download");let x=[];function v(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function l(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function w(c){const b=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return b.includes("	")?b.split("	").map(r=>r.trim()).filter(r=>r!==""):b.includes(";")?b.split(";").map(r=>r.trim()).filter(r=>r!==""):b.split(/\s+/).map(r=>r.trim()).filter(r=>r!=="")}function u(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function m(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function p(c,b="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),b==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(c){const b=c.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),r=[],h=[],f=new Set;return b.forEach((E,z)=>{const C=z+1,j=w(E);if(j.length!==2){h.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const M=v(j[0]),D=Number(l(j[1]));if(!/^A[0-9]{8}$/.test(M)){h.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(f.has(M)){h.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(D)){h.push(`Línea ${C}: la calificación 4EF no es numérica.`);return}if(D<0||D>30){h.push(`Línea ${C}: 4EF debe estar entre 0 y 30.`);return}f.add(M),r.push({matricula:M,grade4EF:D})}),{records:r,errors:h}}function g(c){if(c.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,s.textContent="0 estudiantes";return}n.innerHTML=c.map((b,r)=>`
                ...
                `).join(""),s.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function k(c){return[["MATRICULA","4EF"],...c.map(r=>[r.matricula,u(r.grade4EF)])].map(r=>r.join(";")).join(`\r
`)}function A(c,b){const r=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(r),f=document.createElement("a");f.href=h,f.download=b,document.body.appendChild(f),f.click(),f.remove(),window.setTimeout(()=>{URL.revokeObjectURL(h)},1e3)}function L(){x=[],a.value="",g([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){x=[],g([]),d.disabled=!0,p("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:b,errors:r}=y(c);if(r.length>0){x=[],g([]),d.disabled=!0,p(r.join(" "),"error");return}x=b,g(b),d.disabled=!1,p(`Los datos de ${b.length} estudiante${b.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",L),d.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Examen_Final_4EF.csv")}),e}function Tt(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),n=e.querySelector("#open-segundo-periodo"),s=e.querySelector("#open-calificacion-final"),d=e.querySelector("#banner-back");function x(){a.classList.add("hidden"),t.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}function v(u){console.error("No fue posible abrir la herramienta de Banner:",u),i.innerHTML=`
            <div
...
20252000     0"
    ...
    `;const a=e.querySelector("#xmera-input"),t=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),n=e.querySelector("#xmera-clear"),s=e.querySelector("#xmera-message"),d=e.querySelector("#tab-xmera"),x=e.querySelector("#tab-banner"),v=e.querySelector("#panel-xmera"),l=e.querySelector("#panel-banner");function w(){t.textContent=`var data_todo = {
};`,o.disabled=!0}function u(g,k="success"){s.textContent=g,s.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),s.classList.add("border"),k==="error"?s.classList.add("border-red-200","bg-red-50","text-red-800"):s.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function m(g){const k=g.split(/\r?\n/).map(b=>b.trim()).filter(Boolean),A=[],L=[],c=new Set;return k.forEach((b,r)=>{const h=b.split(/[\t,; ]+/).map(j=>j.trim()).filter(Boolean),f=r+1,E=h[0],z=h.slice(1);if(!E){L.push(`Línea ${f}: falta la matrícula.`);return}if(!/^\d+$/.test(E)){L.push(`Línea ${f}: la matrícula "${E}" no es válida.`);return}if(c.has(E)){L.push(`Línea ${f}: la matrícula ${E} está repetida.`);return}if(z.length===0){L.push(`Línea ${f}: falta al menos una calificación.`);return}const C=z.map(j=>Number(j));if(C.some(j=>!Number.isFinite(j))){L.push(`Línea ${f}: existe una calificación no numérica.`);return}c.add(E),A.push({matricula:E,grades:C})}),{records:A,errors:L}}function p(g){return`var data_todo = {
${g.map(({matricula:A,grades:L})=>`  "${A}":[${L.join(",")}]`).join(`,
`)}
};
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
        ...
        `}return d.addEventListener("click",()=>{y("xmera")}),x.addEventListener("click",()=>{y("banner")}),y("xmera"),e}function Ot(){return Bt()}function Ut(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
    ...
    `}function O(e,a,t,i,o,n,s=""){return`
        <article class="
        ...
        <section class="rounded-3xl border border-blue-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    ${J("¿Cuándo utilizarla?",e.cuandoUsar)}

                    ${J("Supuestos",e.supuestos)}
                </div>
                ...
                ${e.posthoc?.length?J("Análisis posteriores",e.posthoc):""}

                ${e.alternativas?.length?J("Pruebas y procedimientos alternativos",e.alternativas):""}

                ${e.erroresFrecuentes?.length?J("Errores frecuentes",e.erroresFrecuentes,"advertencia"):""}

                ${ie("Ejemplo de investigación",e.ejemplo)}

                ${e.referencias?.length?J("Referencias recomendadas",e.referencias,"referencias"):""}
    ...
    `}const si={home:{page:ua,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:$a,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:qa,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Va,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:ot,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:dt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:Et,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:vt,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Rt,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Ot,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Ut,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Qt,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"}};let ze=document.referrer||"";function ce(e){window.location.hash=`/${e}`}function ri(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";li(a)};window.addEventListener("hashchange",e),e()}function ni(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:ze}),ze=t}function li(e){const a=document.querySelector("main"),t=si[e];if(a){if(a.innerHTML="",!t){ce("home");return}Ta(t.layout),document.title=t.title,a.appendChild(t.page()),window.scrollTo({top:0,behavior:"auto"}),ni(e,t.title)}}function ci(e,a){Ie(e,ce),ri();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(s){s.matches&&!i&&(ke(e),i=!0)}t.addEventListener("change",o),o(t),ke(e);const n=a.querySelector('[data-action ="open-menu"]');Ye(n,e),Xe(e)}const He=document.querySelector("#header");He.innerHTML=Je();const Ke=document.querySelector("#navBar");Ke.innerHTML=Qe();const di=document.querySelector("#footer");di.innerHTML=We();ci(Ke,He);
