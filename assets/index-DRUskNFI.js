(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const R=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function ie(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function oe(){return`<div class="lg:hidden border-b-zinc-500 border-b pb-2.5 w-full flex px-2.5 justify-between items-center mb-7">
        ...
        </ul>`}function se(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    ...
    `}function K(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function pe(e){K(e,N)}const V=""+new URL("apec-ConmXkrT.png",import.meta.url).href,ue=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,xe=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,F=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${V}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${ue}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function ge(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=F.length,s=1500;let n=0,d=null;function g(l){return(l%o+o)%o}function p(){i.innerHTML=F[n].content}function c(l){n=g(n+l),p()}function f(){m(),d=setInterval(()=>c(1),s)}function m(){d&&(clearInterval(d),d=null)}function r(){f()}p(),f(),a.addEventListener("click",()=>{c(1),r()}),t.addEventListener("click",()=>{c(-1),r()})}function be(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return ge(t.querySelector("#containerFather")),pe(t.querySelector("#btnsGroup")),t}function fe(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=`${me()}`;const a=be();return e.appendChild(a),e}function ve(){return fe()}const he=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function we(){return`
        <section 
            role="banner" 
    ...
    `}const Se="data:image/png;base64,",Me="data:image/png;base64,",De="data:image/png;base64,",Ie="data:image/png;base64,",je="data:image/png;base64,",Le=[{icon:Se,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:Me,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:De,title:"Objetivos",content:`
      ...
      </ul>`},{icon:Ie,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function ze({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${je}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function Pe(){const e=document.createElement("section");return e.className=`
    ...
    `).join("")}function Be(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function Ne(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=Re(e.redes||[]),i=Be(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}const H=""+new URL("rad-B3ff1btG.png",import.meta.url).href,Q=""+new URL("mar-Cru0HERG.png",import.meta.url).href,I=[{img:z,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:U,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:H,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:B,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:Q,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:P,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:L,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function qe(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,s=()=>{const r=o();return Math.max(I.length-r,0)},n=()=>{const r=s();e>r&&(e=0),e<0&&(e=r)},d=()=>{const r=s();e>=r?e=0:e++,m()},g=()=>{const r=s();e<=0?e=r:e--,m()},p=()=>{c(),I.length>o()&&(a=setInterval(d,4500))},c=()=>{a&&(clearInterval(a),a=null)},f=()=>{const r=o(),l=Math.max(I.length-r+1,1);return Array.from({length:l}).map((u,v)=>`
        ...
        `).join("")},m=()=>{if(!I||I.length===0){i.innerHTML=`
            ...
            `;return}n();const r=o(),l=I.slice(e,e+r);i.innerHTML=`
        ...
        `;const u=i.querySelector("#cards-wrapper");l.forEach(w=>{u.appendChild(Ne(w))});const v=i.querySelector("#prev-btn"),y=i.querySelector("#next-btn");v&&(v.onclick=()=>{g(),p()}),y&&(y.onclick=()=>{d(),p()}),i.querySelectorAll("[data-dot-index]").forEach(w=>{w.onclick=()=>{e=parseInt(w.dataset.dotIndex),m(),p()}})};return i.addEventListener("mouseenter",c),i.addEventListener("mouseleave",p),document.addEventListener("visibilitychange",()=>{document.hidden?c():p()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,m(),p()},150)}),m(),p(),i}function Fe(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&N(t.dataset.route)})}function Y(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Fe(a),a}function Ge(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(Y());const t=qe();return e.appendChild(a),e.appendChild(t),e}function Je(){return Ge()}function Ke(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function A(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function W(e){return e.formacion?.length||0}function X(e){return e.experiencia?.length||0}function Ve(e,a=!1){const t=W(e),i=X(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function He(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(d=>`
                        ...
                        ">
                            ...
                            ">
                                ...
                                <div class="flex flex-wrap items-center gap-3 mb-5">
                                    ...
                                    ">
                                        ${M(e.category||"Noticia destacada")}
                                    </span>
    ...
    `}function E(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ta({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:s,category:n="Noticia",imageFit:d="contain"}){const g=d==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${E(e)}"
            class="
        ...
        >
            ...
            <div class="p-4 space-y-3 flex flex-col flex-1">
                ...
                <button
                    type="button"
                    data-news-btn="${E(e)}"
                    aria-label="Ver detalles de la noticia ${E(a)}"
                    class="
    ...
    `}function oa(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function sa(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function na(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const a=sa(Z),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ${aa(t)}
        ${ia(a)}
        ${oa()}
    `,e}function la({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(n=>`<p>${n}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function ra(e){e&&e.addEventListener("click",a=>{const t=a.target.closest("[data-news-btn], [data-news-card]");if(!t||!e.contains(t))return;const i=t.dataset.newsBtn||t.dataset.newsCard,o=Z.find(s=>String(s.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}ca(o)})}function ca(e){const a=document.querySelector("#newsModal");a&&a.remove();const t=document.createElement("div");t.innerHTML=la(e);const i=t.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",s)}function s(n){n.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(n=>{n.addEventListener("click",o)}),i.addEventListener("click",n=>{n.target===i&&o()}),document.addEventListener("keydown",s)}function da(){const e=na();return ra(e),e}function b(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function _(e){return e?.name||e?.title||"Investigador"}function G(e){return e?.title||e?.tile||"Revista no especificada"}function ee(e){return String(e?.DOI||e?.doi||"").trim()}function ma(e){const a=ee(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function pa(e){return[...e?.publicaciones||[]].sort((a,t)=>{const i=Number(a.year||0),o=Number(t.year||0);return i!==o?o-i:String(a.contenido||"").localeCompare(String(t.contenido||""))})}function ua(e,a=!1){const t=_(e),i=e.publicaciones||[],o=i.length,s=i.map(d=>Number(d.year)).filter(Boolean),n=s.length?Math.max(...s):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${a?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function xa(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const a=_(e),t=pa(e),i=t.length,o=t.map(c=>Number(c.year)).filter(Boolean),s=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",d=[...new Set(t.map(c=>c.q).filter(Boolean))],g=[...new Set(t.map(c=>G(c)).filter(Boolean))],p=t.map(c=>{const f=G(c),m=ee(c),r=ma(c);return`
    ...
    `}function ga(){let e=C[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(l){return String(l?.DOI||l?.doi||"").trim().toLowerCase()}function s(l){return String(l?.journal||l?.title||l?.tile||"").trim()}function n(l){return String(l?.articleTitle||l?.contenido||"").trim()}function d(l){return String(l?.q||l?.quartile||"").trim().toUpperCase()}function g(l){const u=o(l);return u||[l?.year||"",s(l),n(l)].join("-").trim().toLowerCase()}function p(){const l=new Map;return C.forEach(u=>{(u.publicaciones||[]).forEach(v=>{const y=g(v);y&&!l.has(y)&&l.set(y,v)})}),Array.from(l.values())}function c(){const l=p(),u=l.map(O=>Number(O.year)).filter(Boolean),v=u.length?Math.max(...u):"—",y=u.length?Math.min(...u):"—",w=l.filter(O=>d(O)==="Q1").length;return{totalPublicaciones:l.length,investigadores:C.length,q1:w,primerYear:y,ultimoYear:v}}function f(){return C.find(l=>Number(l.id)===Number(e))||C[0]}const m=()=>{const l=f(),u=c(),v=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${C.map(w=>ua(w,Number(w.id)===Number(e))).join("")}
                </aside>
    ...
    `).join("")}function wa(e,a=!1){return`
        <button 
            ...
            <p class="text-sm leading-relaxed ${a?"text-white/90":"text-slate-500"}">
                ${h(e.desarrollo).slice(0,185)}${String(e.desarrollo).length>185?"...":""}
            </p>
        </button>
    `}function ya(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${h(e.categoria)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Prioridad</p>
                        <p class="text-slate-800 font-bold mt-1">${h(e.prioridad)}</p>
                    </div>
    ...
    `}function Aa(){const e=new Set(D.map(i=>i.categoria)),a=D.filter(i=>i.proyectosAsociados?.length>0).length,t=D.filter(i=>i.publicacionesClave?.length>0).length;return{total:D.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function ka(){let e=D[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=fa(e),o=Aa();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${x(e.institucion)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Tipo</p>
                        <p class="text-slate-800 font-bold mt-1">${x(e.tipo)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Duración estimada</p>
                        <p class="text-slate-800 font-bold mt-1">${x(e.duracion)}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        ...
                        <p class="text-slate-700 font-semibold mt-1">${x(e.fechaInicio)}</p>
                    </div>

                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Fecha final prevista</p>
                        <p class="text-slate-700 font-semibold mt-1">${x(e.fechaFinalizacion)}</p>
                    </div>
                </div>
    ...
    `}function ja(){let e=j[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Ea(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function La(){return ja()}function $a(){return`
    ...
    `}function Pa(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${za()}
    `,e}function Ua(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Oa)}async function Oa(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=Ta(i);if(o.length>0){Ba(o);return}await Na(a,i)}function Ta(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?Ra(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function Ra(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Ba(e){$(e[0],"error")}function $(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Na(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?($("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):$("Hubo un problema al enviar el mensaje.","error")}catch{$("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function qa(){const e=Pa();return setTimeout(()=>{Ua()},0),e}function Fa(){const e=document.createElement("section");return e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
    <div class="mb-8 text-center">
      <p class="text-sky-600 font-bold uppercase tracking-wide text-sm mb-2">
        Grupo de Investigación Kernel
      </p>
  ...
  `,e}function Ga(){return Fa()}const Ja={home:{page:ve,layout:"default"},quienesSomos:{page:Te,layout:"full"},equipment:{page:Je,layout:"default"},FormacionAcademica:{page:Ye,layout:"default"},noticias:{page:da,layout:"full"},publicaciones:{page:ba,layout:"default"},proyectos:{page:La,layout:"default"},lineas:{page:Ca,layout:"default"},contacto:{page:qa,layout:"default"},herramientas:{page:Ga,layout:"default"}};function N(e){window.location.hash=`/${e}`}function Ka(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";Va(a)};window.addEventListener("hashchange",e),e()}function Va(e){const a=document.querySelector("main"),t=Ja[e];a&&(a.innerHTML="",t&&(Ke(t.layout),a.appendChild(t.page())))}function Ha(e,a){K(e,N),Ka();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(q(e),i=!0)}t.addEventListener("change",o),o(t),q(e);const s=a.querySelector('[data-action ="open-menu"]');ne(s,e),le(e)}const ae=document.querySelector("#header");ae.innerHTML=ie();const te=document.querySelector("#navBar");te.innerHTML=oe();const Qa=document.querySelector("#footer");Qa.innerHTML=se();Ha(te,ae);
