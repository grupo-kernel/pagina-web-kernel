function p(){const e=document.createElement("section");return e.className=`
    ...
    `,e.addEventListener("click",t=>{const i=t.target.closest("[data-route]");if(t.target.closest("[data-action='volver-laboratorio']")){window.location.hash="/laboratorioKernel";return}i?.dataset.route&&(window.location.hash=`/${i.dataset.route}`)}),e}function o({etiqueta:e,titulo:t,descripcion:i,caracteristicas:s,ruta:l,clase:n}){const c={rose:{borde:"border-rose-200",fondo:"bg-rose-50",etiqueta:"text-rose-700",boton:"bg-rose-700 hover:bg-rose-800",icono:"bg-rose-100 text-rose-700 border-rose-200"},amber:{borde:"border-amber-200",fondo:"bg-amber-50",etiqueta:"text-amber-700",boton:"bg-amber-700 hover:bg-amber-800",icono:"bg-amber-100 text-amber-700 border-amber-200"},indigo:{borde:"border-indigo-200",fondo:"bg-indigo-50",etiqueta:"text-indigo-700",boton:"bg-indigo-700 hover:bg-indigo-800",icono:"bg-indigo-100 text-indigo-700 border-indigo-200"}},a=c[n]||c.indigo;return`
