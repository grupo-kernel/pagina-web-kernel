...
>
  ...
  `}function gc(){const e=document.createElement("section");return e.className=`
    ...
    `}function ze(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function qc({id:e,title:a,date:r,image:t,imageAlt:n,excerpt:c,category:s="Noticia",imageFit:p="contain"}){const u=p==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${ze(e)}"
            class="
...
if (!contenedor) {
  ...
  `;const r=a.querySelector("#kernel-login"),t=a.querySelector("#login-error"),n=a.querySelector("#correo"),c=a.querySelector("#password"),s=r.querySelector('button[type="submit"]');return r.addEventListener("submit",async p=>{p.preventDefault(),t.classList.add("hidden"),t.textContent="";const u=n.value.trim(),l=c.value;if(!u||!l){t.textContent="Introduzca el correo electrónico y la contraseña.",t.classList.remove("hidden");return}s.disabled=!0,s.textContent="Verificando...";try{await Pf(u,l),e&&await e()}catch(i){console.error("Error de autenticación:",i);const o={"auth/invalid-email":"El correo electrónico no tiene un formato válido.","auth/invalid-credential":"El correo o la contraseña son incorrectos.","auth/user-not-found":"El correo no está autorizado.","auth/wrong-password":"El correo o la contraseña son incorrectos.","auth/user-disabled":"Este usuario está deshabilitado.","auth/too-many-requests":"Demasiados intentos. Espere unos minutos e inténtelo nuevamente.","auth/network-request-failed":"No fue posible conectarse con Firebase. Revise su conexión.","auth/unauthorized-domain":"El dominio de Grupo Kernel no está autorizado en Firebase."};t.textContent=o[i.code]||`No fue posible iniciar sesión. Error: ${i.code||"desconocido"}`,t.classList.remove("hidden")}finally{s.disabled=!1,s.textContent="Iniciar sesión"}}),a}function Tf(){return new Promise(e=>{const a=Rf(r=>{a(),e(r)})})}async function Nf(){if(!await Tf())return Mf(()=>{window.dispatchEvent(new HashChangeEvent("hashchange"))});const a=document.createElement("section");return a.className=`
    ...
    `}function ib(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
14.5`,i(),Wr(r),t.classList.add("hidden");return}m==="limpiar"&&(a.reset(),s.value="",p.value="",i(),Wr(r),t.innerHTML="",t.classList.add("hidden"))}),e}function Zi(e,a){const r=e.trim();if(!r)throw new Error(`${a} no contiene datos.`);const t=r.split(/[\s;]+/).filter(Boolean),n=t.map(s=>Number(s.replace(",","."))),c=n.findIndex(s=>!Number.isFinite(s));if(c!==-1)throw new Error(`${a} contiene un valor no válido: "${t[c]}".`);if(n.length<2)throw new Error(`${a} debe contener al menos dos observaciones.`);return n}function eo(e){return e.trim()?e.trim().split(/[\s;]+/).filter(Boolean).length:0}function ao(e){return e===1?"1 valor":`${e} valores`}function yb(e,a){e.textContent=a,e.classList.remove("hidden")}function Wr(e){e.textContent="",e.classList.add("hidden")}function H(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):"—"}function wb(e){return Number.isFinite(e)?e<.001?"< 0.001":H(e,4):"—"}function kb(e,a=.95){const r=1-a,t=e.valorP<r,n=r.toFixed(2),c=Math.round(a*100),s=t?`Se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${n}, correspondiente a un nivel de confianza del ${c} %.`:`No se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${n}, correspondiente a un nivel de confianza del ${c} %.`;return`
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${At("p",wb(e.valorP),"Valor bilateral")}
    ...
    `}function Eb(e){if(e.id==="mann-whitney")return`
...
17`,l(),Yr(r),t.classList.add("hidden");return}d==="limpiar"&&(a.reset(),n.value="",c.value="",l(),Yr(r),t.innerHTML="",t.classList.add("hidden"))}),e}function Kr(e,a){return`
    ...
    `}function oo(e,a){const r=e.trim();if(!r)throw new Error(`${a} no contiene datos.`);const t=r.split(/[\s;]+/).filter(Boolean),n=t.map(s=>Number(s.replace(",","."))),c=n.findIndex(s=>!Number.isFinite(s));if(c!==-1)throw new Error(`${a} contiene un valor no válido: "${t[c]}".`);if(n.length<2)throw new Error(`${a} debe contener al menos dos observaciones.`);return n}function so(e){return e.trim()?e.trim().split(/[\s;]+/).filter(Boolean).length:0}function lo(e){return e===1?"1 valor":`${e} valores`}function Nb(e,a){e.textContent=a,e.classList.remove("hidden")}function Yr(e){e.textContent="",e.classList.add("hidden")}function U(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):"—"}function Sb(e){return Number.isFinite(e)?e<.001?"< 0.001":U(e,4):"—"}function _b(e,a=.95){const r=1-a,t=e.valorP<r,n=r.toFixed(2),c=Math.round(a*100),s=e.id==="t-student-relacionadas"?e.diferenciaMedia:e.diferencias.mediana,p=zb(s),u=t?`Se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${n}, correspondiente a un nivel de confianza del ${c} %. ${p}`:`No se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${n}, correspondiente a un nivel de confianza del ${c} %. ${p}`;return`
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${It("p",Sb(e.valorP),"Valor bilateral")}
    ...
    `}function zb(e){return Number.isFinite(e)?e>0?"La dirección estimada favorece valores mayores en la medición 1.":e<0?"La dirección estimada favorece valores mayores en la medición 2.":"La diferencia central estimada es igual a cero.":""}function It(e,a,r){return`
        <article class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
    ...
    `}function qb(e){if(e.id==="wilcoxon-relacionadas")return`
    ...
    `}const na=xa.jStat??Ua?.jStat;if(!na)throw new Error("No fue posible cargar el motor estadístico jStat.");const Er=e=>Math.min(1,Math.max(0,e));function Bn(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function Ob(e){return typeof e=="string"?e.trim()===""?Number.NaN:Number(e.trim().replace(",",".")):Number(e)}const sl=e=>e.reduce((a,r)=>a+r,0)/e.length;function Fb(e){const a=[...e].sort((t,n)=>t-n),r=Math.floor(a.length/2);return a.length%2?a[r]:(a[r-1]+a[r])/2}function Ub(e,a=sl(e)){return e.reduce((r,t)=>r+(t-a)**2,0)/(e.length-1)}function jb(e){const a=sl(e),r=Ub(e,a);return{n:e.length,media:a,mediana:Fb(e),varianza:r,desviacionEstandar:Math.sqrt(r),minimo:Math.min(...e),maximo:Math.max(...e)}}function Vb(e,a){const r=Array.isArray(e),t=r?e:e?.valores;if(!Array.isArray(t))throw new TypeError(`El grupo ${a+1} debe contener un arreglo llamado valores.`);const n=t.map(Ob),c=n.findIndex(p=>!Number.isFinite(p));if(c!==-1)throw new TypeError(`El grupo ${a+1} contiene un valor no numérico en la posición ${c+1}.`);if(n.length<2)throw new RangeError(`El grupo ${a+1} debe contener al menos dos observaciones.`);return{nombre:(r?"":String(e?.nombre??"").trim())||`Grupo ${a+1}`,valores:n,...jb(n)}}function Gn(e){if(!Array.isArray(e))throw new TypeError("Los grupos deben proporcionarse mediante un arreglo.");if(e.length<3)throw new RangeError("El análisis requiere al menos tres grupos independientes.");const a=e.map(Vb),r=a.map(({nombre:t})=>t);if(new Set(r).size!==r.length)throw new Error("Cada grupo debe tener un nombre diferente.");return a}function Hn(e){const a=e.reduce((t,n)=>t+n.n,0),r=e.reduce((t,n)=>t+n.valores.reduce((c,s)=>c+s,0),0);return{numeroGrupos:e.length,nTotal:a,mediaGeneral:r/a}}function ll(e,a,r){return e===1/0?0:Er(1-na.centralF.cdf(e,a,r))}function Bb(e,a){return Er(1-na.chisquare.cdf(e,a))}function cl(){if(!na.tukey?.cdf||!na.tukey?.inv)throw new Error("La distribución de Tukey no está disponible en la versión instalada de jStat.")}function dl(e,a,r){return cl(),e===1/0?0:Er(1-na.tukey.cdf(e,a,r))}function ul(e,a,r){return cl(),na.tukey.inv(e,a,r)}function Wn(e){const a=Math.abs(e);return a<.01?"Prácticamente nulo":a<.06?"Pequeño":a<.14?"Moderado":"Grande"}function Kn(e,a){const r=[];for(let t=0;t<e.length-1;t+=1)for(let n=t+1;n<e.length;n+=1)r.push(a(e[t],e[n],t,n));return r}function Gb(e,a,r,t){const n=1-t,c=e.length,s=ul(t,c,r);return{id:"tukey-kramer",nombre:"Comparaciones de Tukey–Kramer",metodo:"Rango studentizado con control del error familiar.",recomendado:!1,comparaciones:Kn(e,(p,u)=>{const l=p.media-u.media,i=Math.sqrt(a/2*(1/p.n+1/u.n)),o=i===0?l===0?0:1/0:Math.abs(l)/i,d=dl(o,c,r),m=s*i;return{grupo1:p.nombre,grupo2:u.nombre,diferenciaMedias:l,errorEstandar:i,estadisticoQ:o,gradosLibertad:r,valorP:d,valorPAjustado:d,intervaloConfianza:{nivel:t,inferior:l-m,superior:l+m,margen:m},significativo:d<n}})}}function Hb(e,a){const r=1-a,t=e.length;return{id:"games-howell",nombre:"Comparaciones de Games–Howell",metodo:"Comparaciones pareadas robustas ante varianzas y tamaños desiguales.",recomendado:!1,comparaciones:Kn(e,(n,c)=>{const s=n.media-c.media,p=n.varianza/n.n,u=c.varianza/c.n,l=p+u,i=Math.sqrt(l/2),o=l**2/(p**2/(n.n-1)+u**2/(c.n-1)),d=i===0?s===0?0:1/0:Math.abs(s)/i,m=dl(d,t,o),f=ul(a,t,o)*i;return{grupo1:n.nombre,grupo2:c.nombre,diferenciaMedias:s,errorEstandar:i,estadisticoQ:d,gradosLibertad:o,valorP:m,valorPAjustado:m,intervaloConfianza:{nivel:a,inferior:s-f,superior:s+f,margen:f},significativo:m<r}})}}function Wb(e){const a=e.map(c=>({...c,rango:0})).sort((c,s)=>c.valor-s.valor);let r=0,t=0,n=0;for(;r<a.length;){let c=r+1;for(;c<a.length&&a[c].valor===a[r].valor;)c+=1;const s=c-r,p=(r+1+c)/2;for(let u=r;u<c;u+=1)a[u].rango=p;s>1&&(n+=1,t+=s**3-s),r=c}return{observaciones:a,sumaCorreccionEmpates:t,cantidadGruposEmpatados:n}}function Kb(e){const a=e.map((t,n)=>({...t,indiceOriginal:n})).sort((t,n)=>t.valorP-n.valorP);let r=0;return a.forEach((t,n)=>{const c=Math.min(1,t.valorP*(a.length-n));t.valorPAjustado=Math.max(r,c),r=t.valorPAjustado}),a.sort((t,n)=>t.indiceOriginal-n.indiceOriginal).map(({indiceOriginal:t,...n})=>n)}function Yb(e,a,r,t,n){const c=1-n,s=r*(r+1)/12-t/(12*(r-1)),p=Kn(e,(u,l,i,o)=>{const d=a[i]/u.n,m=a[o]/l.n,f=d-m,g=Math.sqrt(s*(1/u.n+1/l.n)),b=g===0?0:f/g,x=Er(2*(1-na.normal.cdf(Math.abs(b),0,1)));return{grupo1:u.nombre,grupo2:l.nombre,rangoMedio1:d,rangoMedio2:m,diferenciaRangos:f,errorEstandar:g,estadisticoZ:b,valorP:x,tamanioEfectoR:b/Math.sqrt(r)}});return{id:"dunn-holm",nombre:"Comparaciones de Dunn con ajuste de Holm",metodo:"Comparaciones de rangos con corrección secuencial de Holm.",recomendado:!1,comparaciones:Kb(p).map(u=>({...u,significativo:u.valorPAjustado<c}))}}function Jb(e,a={}){const{nivelConfianza:r=.95}=a;Bn(r);const t=Gn(e),n=Hn(t),c=t.reduce((h,w)=>h+w.n*(w.media-n.mediaGeneral)**2,0),s=t.reduce((h,w)=>h+w.valores.reduce((k,E)=>k+(E-w.media)**2,0),0),p=c+s,u=t.length-1,l=n.nTotal-t.length,i=c/u,o=s/l,d=o===0?i===0?0:1/0:i/o,m=ll(d,u,l),f=p===0?0:c/p,g=p+o===0?0:(c-u*o)/(p+o),b=Math.max(0,g),x=1-r,y=m<x,v=Gb(t,o,l,r);return v.recomendado=y,{id:"anova-un-factor",nombre:"ANOVA de un factor",metodo:"ANOVA clásico para tres o más grupos independientes con varianzas homogéneas.",grupos:t,...n,estadistico:{simbolo:"F",valor:d},gradosLibertad:{numerador:u,denominador:l},valorP:m,nivelConfianza:r,alfa:x,significativo:y,tablaAnova:{entreGrupos:{sumaCuadrados:c,gradosLibertad:u,cuadradoMedio:i},dentroGrupos:{sumaCuadrados:s,gradosLibertad:l,cuadradoMedio:o},total:{sumaCuadrados:p,gradosLibertad:n.nTotal-1}},tamanioEfecto:{etaCuadrado:f,omegaCuadrado:b,interpretacion:Wn(b)},postHoc:v}}function Qb(e,a={}){const{nivelConfianza:r=.95}=a;Bn(r);const t=Gn(e),n=Hn(t),c=t.find(({varianza:w})=>w<=0);if(c)throw new Error(`El ANOVA de Welch requiere varianza positiva en cada grupo. Revise ${c.nombre}.`);const s=t.map(w=>({...w,peso:w.n/w.varianza})),p=s.reduce((w,k)=>w+k.peso,0),u=s.reduce((w,k)=>w+k.peso*k.media,0)/p,l=t.length,i=l-1,o=s.reduce((w,k)=>w+k.peso*(k.media-u)**2,0)/i,d=s.reduce((w,k)=>w+(1-k.peso/p)**2/(k.n-1),0),m=1+2*(l-2)/(l**2-1)*d,f=o/m,g=(l**2-1)/(3*d),b=ll(f,i,g),x=Math.max(0,i*(f-1)/(i*f+g+1)),y=1-r,v=b<y,h=Hb(t,r);return h.recomendado=v,{id:"anova-welch",nombre:"ANOVA de Welch",metodo:"ANOVA robusto para tres o más grupos independientes sin exigir igualdad de varianzas.",grupos:t,...n,mediaPonderada:u,sumaPesos:p,estadistico:{simbolo:"F_W",valor:f},gradosLibertad:{numerador:i,denominador:g},valorP:b,nivelConfianza:r,alfa:y,significativo:v,componentesWelch:{numeradorBase:o,terminoCorreccion:d,denominadorCorreccion:m},tamanioEfecto:{omegaCuadradoAproximado:x,interpretacion:Wn(x),nota:"Estimación aproximada basada en el estadístico F de Welch y sus grados de libertad."},postHoc:h}}function Xb(e,a={}){const{nivelConfianza:r=.95}=a;Bn(r);const t=Gn(e),n=Hn(t),c=t.flatMap((y,v)=>y.valores.map(h=>({valor:h,indiceGrupo:v}))),s=Wb(c),p=new Array(t.length).fill(0);s.observaciones.forEach(({indiceGrupo:y,rango:v})=>{p[y]+=v});const u=12/(n.nTotal*(n.nTotal+1))*t.reduce((y,v,h)=>y+p[h]**2/v.n,0)-3*(n.nTotal+1),l=1-s.sumaCorreccionEmpates/(n.nTotal**3-n.nTotal),i=l<=0?0:u/l,o=t.length-1,d=Bb(i,o),m=Math.max(0,(i-t.length+1)/(n.nTotal-t.length)),f=1-r,g=d<f,b=t.map((y,v)=>({...y,sumaRangos:p[v],rangoMedio:p[v]/y.n})),x=Yb(t,p,n.nTotal,s.sumaCorreccionEmpates,r);return x.recomendado=g,{id:"kruskal-wallis",nombre:"Prueba de Kruskal–Wallis",metodo:"Comparación no paramétrica de tres o más grupos independientes mediante rangos.",grupos:b,...n,estadistico:{simbolo:"H",valor:i,sinCorreccion:u},gradosLibertad:{valor:o},valorP:d,nivelConfianza:r,alfa:f,significativo:g,empates:{factorCorreccion:l,sumaCorreccion:s.sumaCorreccionEmpates,cantidadGruposEmpatados:s.cantidadGruposEmpatados},tamanioEfecto:{epsilonCuadrado:m,interpretacion:Wn(m)},postHoc:x}}function Zb({grupos:e,prueba:a,nivelConfianza:r=.95}){switch(a){case"anova-un-factor":case"anova":return Jb(e,{nivelConfianza:r});case"anova-welch":case"welch":return Qb(e,{nivelConfianza:r});case"kruskal-wallis":return Xb(e,{nivelConfianza:r});default:throw new Error("La prueba solicitada no está disponible.")}}function eg(){const e=document.createElement("section");e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
74"
    ...
    `}function ag(e){return[...e.querySelectorAll("[data-grupo]")].map((a,r)=>{const t=a.querySelector("[data-nombre-grupo]").value.trim();if(!t)throw new Error(`El grupo ${r+1} debe tener un nombre.`);const n=a.querySelector("[data-valores-grupo]").value;return{nombre:t,valores:tg(n,t)}})}function tg(e,a){const r=e.trim();if(!r)throw new Error(`${a} no contiene datos.`);const t=r.split(/[\s;]+/).filter(Boolean),n=t.map(s=>Number(s.replace(",","."))),c=n.findIndex(s=>!Number.isFinite(s));if(c!==-1)throw new Error(`${a} contiene un valor no válido: "${t[c]}".`);if(n.length<2)throw new Error(`${a} debe contener al menos dos observaciones.`);return n}function rg(e){return e.trim()?e.trim().split(/[\s;]+/).filter(Boolean).length:0}function pl(e){if(!e)return;const a=e.querySelector("[data-valores-grupo]"),r=e.querySelector("[data-contador-grupo]"),t=rg(a.value);r.textContent=t===1?"1 valor":`${t} valores`}function ng(e,a){a.innerHTML=`
        ${Ce(1)}
        ${Ce(2)}
        ${Ce(3)}
...
88`}];[...a.querySelectorAll("[data-grupo]")].forEach((t,n)=>{t.querySelector("[data-nombre-grupo]").value=r[n].nombre,t.querySelector("[data-valores-grupo]").value=r[n].valores,pl(t)}),e.elements.prueba.value||(e.elements.prueba.value="anova-un-factor")}function uo(e,a){e.textContent=a,e.classList.remove("hidden")}function Ga(e){e.textContent="",e.classList.add("hidden")}function Me(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function B(e,a=4){return e===1/0?"∞":Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):"—"}function ml(e){return Number.isFinite(e)?e<.001?"< 0.001":B(e,4):"—"}function ig(e){const a=e.alfa.toFixed(2),r=Math.round(e.nivelConfianza*100),t=e.significativo?`Se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${a}, correspondiente a un nivel de confianza del ${r} %.`:`No se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${a}, correspondiente a un nivel de confianza del ${r} %.`;return`
    ...
    `}function og(e){const a=e.id==="kruskal-wallis";return`
    ...
    `}function sg(e){if(e.id==="anova-un-factor"){const a=e.tablaAnova;return`
    ...
    `}function lg(e){let a;return e.id==="anova-un-factor"?a=[["Eta cuadrado, η²",e.tamanioEfecto.etaCuadrado],["Omega cuadrado, ω²",e.tamanioEfecto.omegaCuadrado]]:e.id==="anova-welch"?a=[["Omega cuadrado aproximado",e.tamanioEfecto.omegaCuadradoAproximado]]:a=[["Épsilon cuadrado, ε²",e.tamanioEfecto.epsilonCuadrado]],`
        <article class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-6">
            <h3 class="text-xl font-black text-amber-950 mb-5">
                Tamaño del efecto
            </h3>
    ...
    `}function cg(e){const a=e.postHoc;return a?.comparaciones?.length?`
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[980px] text-sm">
                    ...
                    <tbody class="divide-y divide-fuchsia-100">
                        ${a.comparaciones.map(dg).join("")}
                    </tbody>
                </table>
            </div>
        </article>
    `:""}function dg(e){const a=e.diferenciaMedias??e.diferenciaRangos,r=e.estadisticoQ??e.estadisticoZ,t=e.valorPAjustado??e.valorP,n=e.intervaloConfianza?`${B(e.intervaloConfianza.inferior)} a ${B(e.intervaloConfianza.superior)}`:"—";return`
        <tr>
            <td class="px-5 py-4 font-bold text-slate-900">
    ...
    `}const Yn=xa.jStat??Ua?.jStat;if(!Yn)throw new Error("No fue posible cargar el motor estadístico jStat.");const fl=e=>Math.min(1,Math.max(0,e));function bl(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function ug(e){return typeof e=="string"?e.trim()===""?Number.NaN:Number(e.trim().replace(",",".")):Number(e)}function ct(e){return e.reduce((a,r)=>a+r,0)/e.length}function pg(e){const a=[...e].sort((t,n)=>t-n),r=Math.floor(a.length/2);return a.length%2?a[r]:(a[r-1]+a[r])/2}function mg(e,a=ct(e)){return e.reduce((r,t)=>r+(t-a)**2,0)/(e.length-1)}function fg(e){const a=ct(e),r=mg(e,a);return{n:e.length,media:a,mediana:pg(e),varianza:r,desviacionEstandar:Math.sqrt(r),minimo:Math.min(...e),maximo:Math.max(...e)}}function bg(e,a){const r=Array.isArray(e),t=r?e:e?.valores;if(!Array.isArray(t))throw new TypeError(`La medición ${a+1} debe contener un arreglo llamado valores.`);const n=t.map(ug),c=n.findIndex(p=>!Number.isFinite(p));if(c!==-1)throw new TypeError(`La medición ${a+1} contiene un valor no numérico en la posición ${c+1}.`);if(n.length<2)throw new RangeError(`La medición ${a+1} debe contener al menos dos observaciones.`);return{nombre:(r?"":String(e?.nombre??"").trim())||`Medición ${a+1}`,valores:n,...fg(n)}}function gl(e){if(!Array.isArray(e))throw new TypeError("Las mediciones deben proporcionarse mediante un arreglo.");if(e.length<3)throw new RangeError("El análisis requiere al menos tres mediciones relacionadas.");const a=e.map(bg),r=a[0].n;if(a.find(({n:c})=>c!==r))throw new RangeError("Todas las mediciones deben contener el mismo número de observaciones y conservar el mismo orden de participantes.");const n=a.map(({nombre:c})=>c);if(new Set(n).size!==n.length)throw new Error("Cada medición debe tener un nombre diferente.");return a}function hl(e){const a=e[0].n;return Array.from({length:a},(r,t)=>e.map(({valores:n})=>n[t]))}function Xr(e,a,r){return e===1/0?0:fl(1-Yn.centralF.cdf(e,a,r))}function gg(e,a){return fl(1-Yn.chisquare.cdf(e,a))}function xl(e){const a=e.map((t,n)=>({...t,indiceOriginal:n})).sort((t,n)=>t.valorP-n.valorP);let r=0;return a.forEach((t,n)=>{const c=Math.min(1,t.valorP*(a.length-n));t.valorPAjustado=Math.max(r,c),r=t.valorPAjustado}),a.sort((t,n)=>t.indiceOriginal-n.indiceOriginal).map(({indiceOriginal:t,...n})=>n)}function vl(e,a){const r=[];for(let t=0;t<e.length-1;t+=1)for(let n=t+1;n<e.length;n+=1)r.push(a(e[t],e[n],t,n));return r}function Zr(e,a){const r=e.length,t=a[0].length,n=a.length;return Array.from({length:r},(c,s)=>Array.from({length:t},(p,u)=>{let l=0;for(let i=0;i<n;i+=1)l+=e[s][i]*a[i][u];return l}))}function po(e){return e.reduce((a,r,t)=>a+r[t],0)}function hg(e){const a=e.length,r=e[0].length,t=Array.from({length:r},(n,c)=>ct(e.map(s=>s[c])));return Array.from({length:r},(n,c)=>Array.from({length:r},(s,p)=>{let u=0;for(let l=0;l<a;l+=1)u+=(e[l][c]-t[c])*(e[l][p]-t[p]);return u/(a-1)}))}function xg(e){const a=e.length,r=e[0].length,t=hg(e),n=Array.from({length:r},(f,g)=>Array.from({length:r},(b,x)=>(g===x?1:0)-1/r)),c=Zr(Zr(n,t),n),s=po(c),p=Zr(c,c),u=po(p),l=1/(r-1);let i=u===0?1:s**2/((r-1)*u);i=Math.min(1,Math.max(l,i));const o=a*(r-1)*i-2,d=(r-1)*(a-1-(r-1)*i);let m=d<=0?1:o/d;return m=Math.min(1,Math.max(l,m)),{limiteInferior:l,greenhouseGeisser:i,huynhFeldt:m,covarianzas:t}}function vg(e){const a=Math.abs(e);return a<.01?"Prácticamente nulo":a<.06?"Pequeño":a<.14?"Moderado":"Grande"}function yg(e){const a=Math.abs(e);return a<.1?"Muy pequeño":a<.3?"Pequeño":a<.5?"Moderado":"Grande"}function wg(e,a){const r=1-a,t=vl(e,(n,c)=>{const s=il(n.valores,c.valores,{nivelConfianza:a});return{medicion1:n.nombre,medicion2:c.nombre,diferenciaMedia:s.diferenciaMedia,estadisticoT:s.estadistico.valor,gradosLibertad:s.gradosLibertad,valorP:s.valorP,intervaloConfianza:s.intervaloConfianza,dZ:s.tamanioEfecto.dZ}});return{id:"t-pareadas-holm",nombre:"Comparaciones t pareadas con ajuste de Holm",metodo:"Comparaciones pareadas bilaterales con ajuste secuencial de Holm sobre los valores p.",recomendado:!1,comparaciones:xl(t).map(n=>({...n,significativo:n.valorPAjustado<r}))}}function kg(e,a){const r=1-a,t=vl(e,(n,c)=>{const s=ol(n.valores,c.valores);return{medicion1:n.nombre,medicion2:c.nombre,estadisticoW:s.estadistico.valor,estadisticoZ:s.estadisticoZ,valorP:s.valorP,correlacionBiserialRangos:s.tamanioEfecto.correlacionBiserialRangos,r:s.tamanioEfecto.r,nEfectivo:s.nEfectivo,cantidadCeros:s.cantidadCeros}});return{id:"wilcoxon-holm",nombre:"Comparaciones de Wilcoxon con ajuste de Holm",metodo:"Comparaciones pareadas de rangos con signo y ajuste secuencial de Holm sobre los valores p.",recomendado:!1,comparaciones:xl(t).map(n=>({...n,significativo:n.valorPAjustado<r}))}}function Eg(e){const a=e.map((s,p)=>({valor:s,indice:p,rango:0})).sort((s,p)=>s.valor-p.valor);let r=0,t=0,n=0;for(;r<a.length;){let s=r+1;for(;s<a.length&&a[s].valor===a[r].valor;)s+=1;const p=s-r,u=(r+1+s)/2;for(let l=r;l<s;l+=1)a[l].rango=u;p>1&&(n+=1,t+=p**3-p),r=s}const c=new Array(e.length).fill(0);return a.forEach(({indice:s,rango:p})=>{c[s]=p}),{rangos:c,correccionEmpates:t,cantidadGruposEmpatados:n}}function Cg(e,a={}){const{nivelConfianza:r=.95}=a;bl(r);const t=gl(e),n=hl(t),c=n.length,s=t.length,p=n.flat(),u=ct(p),l=n.map(P=>ct(P)),i=p.reduce((P,D)=>P+(D-u)**2,0),o=c*t.reduce((P,D)=>P+(D.media-u)**2,0),d=s*l.reduce((P,D)=>P+(D-u)**2,0),m=Math.max(0,i-o-d),f=s-1,g=c-1,b=f*g,x=o/f,y=m/b,v=y===0?x===0?0:1/0:x/y,h=Xr(v,f,b),w=o+m===0?0:o/(o+m),k=o+m+d===0?0:o/(o+m+d),E=xg(n),C=f*E.greenhouseGeisser,$=b*E.greenhouseGeisser,I=f*E.huynhFeldt,A=b*E.huynhFeldt,L=Xr(v,C,$),R=Xr(v,I,A),N=1-r,V=wg(t,r);return V.recomendado=L<N,{id:"anova-medidas-repetidas",nombre:"ANOVA de medidas repetidas",metodo:"ANOVA unifactorial intra-sujetos para tres o más mediciones completas y relacionadas.",mediciones:t,nSujetos:c,numeroMediciones:s,mediaGeneral:u,mediasSujetos:l,estadistico:{simbolo:"F",valor:v},gradosLibertad:{numerador:f,denominador:b},valorP:h,nivelConfianza:r,alfa:N,significativo:h<N,tablaAnova:{mediciones:{sumaCuadrados:o,gradosLibertad:f,cuadradoMedio:x},sujetos:{sumaCuadrados:d,gradosLibertad:g},error:{sumaCuadrados:m,gradosLibertad:b,cuadradoMedio:y},total:{sumaCuadrados:i,gradosLibertad:c*s-1}},esfericidad:{...E,greenhouseGeisser:{epsilon:E.greenhouseGeisser,gradosLibertadNumerador:C,gradosLibertadDenominador:$,valorP:L,significativo:L<N},huynhFeldt:{epsilon:E.huynhFeldt,gradosLibertadNumerador:I,gradosLibertadDenominador:A,valorP:R,significativo:R<N},nota:"Se informan correcciones de Greenhouse–Geisser y Huynh–Feldt. La calculadora no sustituye una prueba formal de esfericidad ni el examen de la matriz de covarianzas."},tamanioEfecto:{etaCuadradoParcial:w,etaCuadradoGeneralizado:k,interpretacion:vg(w)},postHoc:V}}function $g(e,a={}){const{nivelConfianza:r=.95}=a;bl(r);const t=gl(e),n=hl(t),c=n.length,s=t.length,p=new Array(s).fill(0);let u=0,l=0;n.forEach(v=>{const h=Eg(v);h.rangos.forEach((w,k)=>{p[k]+=w}),u+=h.correccionEmpates,l+=h.cantidadGruposEmpatados});const i=12/(c*s*(s+1))*p.reduce((v,h)=>v+h**2,0)-3*c*(s+1),o=1-u/(c*(s**3-s)),d=o<=0?0:i/o,m=s-1,f=gg(d,m),g=c*(s-1)===0?0:d/(c*(s-1)),b=1-r,x=t.map((v,h)=>({...v,sumaRangos:p[h],rangoMedio:p[h]/c})),y=kg(t,r);return y.recomendado=f<b,{id:"friedman",nombre:"Prueba de Friedman",metodo:"Comparación no paramétrica de tres o más mediciones relacionadas mediante rangos dentro de cada participante.",mediciones:x,nSujetos:c,numeroMediciones:s,estadistico:{simbolo:"χ²_F",valor:d,sinCorreccion:i},gradosLibertad:{valor:m},valorP:f,nivelConfianza:r,alfa:b,significativo:f<b,empates:{factorCorreccion:o,sumaCorreccion:u,cantidadGruposEmpatados:l},tamanioEfecto:{kendallW:g,interpretacion:yg(g)},postHoc:y}}function Ag({mediciones:e,prueba:a,nivelConfianza:r=.95}){switch(a){case"anova-medidas-repetidas":case"anova-repetidas":return Cg(e,{nivelConfianza:r});case"friedman":return $g(e,{nivelConfianza:r});default:throw new Error("La prueba solicitada no está disponible.")}}function Ig(){const e=document.createElement("section");e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
19"
    ...
    `}function Pg(e,a){const r=e.trim();if(!r)throw new Error(`${a} no contiene datos.`);const t=r.split(/[\s;]+/).filter(Boolean),n=t.map(s=>Number(s.replace(",","."))),c=n.findIndex(s=>!Number.isFinite(s));if(c!==-1)throw new Error(`${a} contiene un valor no válido: "${t[c]}".`);if(n.length<2)throw new Error(`${a} debe contener al menos dos observaciones.`);return n}function Lg(e){const a=[...e.querySelectorAll("[data-medicion]")];if(a.length<3)throw new Error("El análisis requiere al menos tres mediciones.");return a.map((r,t)=>{const n=r.querySelector('[data-campo="nombre"]'),c=r.querySelector('[data-campo="valores"]'),s=n.value.trim()||`Medición ${t+1}`;return{nombre:s,valores:Pg(c.value,s)}})}function Rg(e,a){e.elements.prueba.value=e.elements.prueba.value||"anova-medidas-repetidas",a.innerHTML=`
        ${$e(1)}
        ${$e(2)}
        ${$e(3)}
...
20`];[...a.querySelectorAll("[data-medicion]")].forEach((c,s)=>{c.querySelector('[data-campo="nombre"]').value=r[s],c.querySelector('[data-campo="valores"]').value=t[s],yl(c)})}function yl(e){const a=e.querySelector('[data-campo="valores"]'),r=e.querySelector("[data-contador]"),t=a.value.trim()?a.value.trim().split(/[\s;]+/).filter(Boolean).length:0;r.textContent=t===1?"1 valor":`${t} valores`}document.addEventListener("input",e=>{const a=e.target.closest('#formulario-mediciones-relacionadas [data-campo="valores"]');if(!a)return;const r=a.closest("[data-medicion]");r&&yl(r)});function fo(e,a){e.textContent=a,e.classList.remove("hidden")}function en(e){e.textContent="",e.classList.add("hidden")}function Ie(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):e===1/0?"∞":"—"}function rr(e){return Number.isFinite(e)?e<.001?"< 0.001":Ie(e,4):"—"}function Mg(e){const a=e.id==="anova-medidas-repetidas",r=a?e.esfericidad.greenhouseGeisser.valorP:e.valorP,t=r<e.alfa,n=Math.round(e.nivelConfianza*100),c=a?"Greenhouse–Geisser":"sin corrección adicional",s=t?`Se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${e.alfa.toFixed(2)}. Para la decisión principal se utilizó ${c}.`:`No se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${e.alfa.toFixed(2)}. Para la decisión principal se utilizó ${c}.`;return`
    ...
    `}function Ng(e){const a=e.tablaAnova,r=e.esfericidad.greenhouseGeisser,t=e.esfericidad.huynhFeldt;return`
    ...
    `:""}function zg(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
5
4
3`}function pe(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):e===1/0?"∞":e===-1/0?"−∞":"—"}function Jg(e){return Number.isFinite(e)?e<.001?"< 0.001":pe(e,4):"—"}function me(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Qg(e){const a=Math.round(e.nivelConfianza*100),r=e.significativo,t=r?`Se observa una relación estadísticamente significativa al nivel α = ${e.alfa.toFixed(2)}.`:`No se observa una relación estadísticamente significativa al nivel α = ${e.alfa.toFixed(2)}.`;return`
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            <header class="bg-violet-700 text-white px-6 py-8 md:px-10">
                <p class="uppercase tracking-widest text-violet-100 text-xs font-black mb-2">
                    Resultado del análisis
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${Tt("p",Jg(e.valorP),"Valor p bilateral")}
    ...
    `}function Xg(e){const a=e.tamanioEfecto.rCuadrado;return`
        <article class="rounded-2xl border border-violet-200 bg-violet-50 p-6">
            <h3 class="text-xl font-black text-violet-950 mb-5">
    ...
    `}function Zg(e){const a=e.intervaloConfianza;return`
        <article class="rounded-2xl border border-blue-200 bg-blue-50 p-6">
            <h3 class="text-xl font-black text-blue-950 mb-5">
    ...
    `}function e0(e){if(e.id==="punto-biserial"){const a=e.grupos.categoriaCero,r=e.grupos.categoriaUno;return`
            <article class="mt-6 rounded-2xl border border-slate-200 bg-white overflow-hidden">
                <header class="bg-slate-50 border-b border-slate-200 px-6 py-4">
                    <h3 class="text-xl font-black text-slate-900">
    ...
    `}function a0(e){return e.id==="pearson"?`
    ...
    `}function r0(e){return e.id==="punto-biserial"?i0(e):n0(e)}function n0(e){const a=e.datosGrafico,r=760,t=380,n=55,c=a.map(b=>b.x),s=a.map(b=>b.y),p=Math.min(...c),u=Math.max(...c),l=Math.min(...s),i=Math.max(...s),o=u-p||1,d=i-l||1,m=b=>n+(b-p)/o*(r-2*n),f=b=>t-n-(b-l)/d*(t-2*n),g=a.map(b=>`
                <circle
                    cx="${m(b.x)}"
                    cy="${f(b.y)}"
                    r="5"
    ...
    `}function i0(e){const a=e.datosGrafico,r=e.variables.dicotomica.categorias,t=760,n=380,c=60,s=a.map(m=>m.valor),p=Math.min(...s),l=Math.max(...s)-p||1,i=[t*.32,t*.68],o=m=>n-c-(m-p)/l*(n-2*c),d=a.map((m,f)=>{const g=m.codigo===0?i[0]:i[1],b=(f%5-2)*6;return`
                <circle
                    cx="${g+b}"
                    cy="${o(m.valor)}"
                    r="5"
    ...
    `,e.innerHTML=`
        ...
        <section
            ...
            aria-live="polite"
        ></section>
    `;const a=e.querySelector("#formulario-asociacion-categorica"),r=e.querySelector("#contenedor-tabla-contingencia"),t=e.querySelector("#mensaje-error-asociacion"),n=e.querySelector("#resultados-asociacion-categorica");let c=2,s=2;const p=sessionStorage.getItem("kernel-prueba-asociacion-categorica");return["chi-cuadrado-independencia-2x2","chi-cuadrado-independencia-rxc","fisher-exacta-2x2","fisher-freeman-halton"].includes(p)&&(a.elements.prueba.value=p.startsWith("chi-cuadrado")?"chi-cuadrado-independencia":p),sessionStorage.removeItem("kernel-prueba-asociacion-categorica"),ca(r,c,s),a.addEventListener("submit",u=>{u.preventDefault(),on(t);try{const l=Cl(r),i=b0({tabla:l.tabla,etiquetasFilas:l.etiquetasFilas,etiquetasColumnas:l.etiquetasColumnas,prueba:a.elements.prueba.value,nivelConfianza:Number(a.elements.nivelConfianza.value),maximoTablasExactas:5e4,simulaciones:1e4});n.innerHTML=k0(i),n.classList.remove("hidden"),n.scrollIntoView({behavior:"smooth",block:"start"})}catch(l){n.classList.add("hidden"),Ha(t,l instanceof Error?l.message:"No fue posible ejecutar el análisis.")}}),e.addEventListener("click",u=>{const l=u.target.closest("[data-action]");if(!l)return;const i=l.dataset.action;if(i==="volver-modulo"){window.location.hash="/correlacionAsociacion";return}const o=h0(r);if(i==="agregar-fila"){if(c>=6){Ha(t,"Esta interfaz admite hasta seis filas.");return}c+=1,ca(r,c,s,o),v0(r,c),n.classList.add("hidden");return}if(i==="quitar-fila"){if(c<=2){Ha(t,"La tabla debe conservar al menos dos filas.");return}c-=1,ca(r,c,s,o),n.classList.add("hidden");return}if(i==="agregar-columna"){if(s>=6){Ha(t,"Esta interfaz admite hasta seis columnas.");return}s+=1,ca(r,c,s,o),y0(r,s),n.classList.add("hidden");return}if(i==="quitar-columna"){if(s<=2){Ha(t,"La tabla debe conservar al menos dos columnas.");return}s-=1,ca(r,c,s,o),n.classList.add("hidden");return}if(i==="cargar-ejemplo"){const d=a.elements.prueba.value,m=w0(d);c=m.tabla.length,s=m.tabla[0].length,ca(r,c,s),x0(r,m),a.elements.nivelConfianza.value="0.95",n.classList.add("hidden"),on(t);return}i==="limpiar"&&(c=2,s=2,a.reset(),ca(r,c,s),n.innerHTML="",n.classList.add("hidden"),on(t))}),e}function nn(e,a){return`
        <article class="flex items-start gap-4">
            <span class="shrink-0 mt-1 w-3 h-3 rounded-full bg-violet-500"></span>
            <div>
                <h3 class="font-black text-slate-900 mb-1">
    ...
    `}function h0(e){try{return Cl(e,!1)}catch{return{tabla:[],etiquetasFilas:[],etiquetasColumnas:[]}}}function Cl(e,a=!0){const r=[...e.querySelectorAll("[data-etiqueta-fila]")].map((p,u)=>p.value.trim()||`Fila ${u+1}`),t=[...e.querySelectorAll("[data-etiqueta-columna]")].map((p,u)=>p.value.trim()||`Columna ${u+1}`),n=r.length,c=t.length,s=Array.from({length:n},()=>new Array(c).fill(""));return[...e.querySelectorAll("[data-frecuencia]")].forEach(p=>{const u=Number(p.dataset.fila),l=Number(p.dataset.columna),i=p.value.trim();if(a&&i==="")throw new Error(`Complete la frecuencia de la celda (${u+1}, ${l+1}).`);s[u][l]=i}),{tabla:s,etiquetasFilas:r,etiquetasColumnas:t}}function x0(e,a){a.etiquetasFilas.forEach((r,t)=>{e.querySelector(`[data-etiqueta-fila="${t}"]`).value=r}),a.etiquetasColumnas.forEach((r,t)=>{e.querySelector(`[data-etiqueta-columna="${t}"]`).value=r}),a.tabla.forEach((r,t)=>{r.forEach((n,c)=>{e.querySelector(`[data-fila="${t}"][data-columna="${c}"]`).value=n})})}function v0(e,a){const r=e.querySelector(`[data-etiqueta-fila="${a-1}"]`);r&&(r.value=`Fila ${a}`)}function y0(e,a){const r=e.querySelector(`[data-etiqueta-columna="${a-1}"]`);r&&(r.value=`Columna ${a}`)}function w0(e){return e==="fisher-exacta-2x2"?{etiquetasFilas:["Intervención","Control"],etiquetasColumnas:["Aprobó","No aprobó"],tabla:[[8,2],[1,5]]}:e==="fisher-freeman-halton"?{etiquetasFilas:["Presencial","Virtual","Híbrida"],etiquetasColumnas:["Bajo","Medio","Alto"],tabla:[[1,4,2],[3,1,1],[1,2,5]]}:{etiquetasFilas:["Presencial","Virtual","Híbrida"],etiquetasColumnas:["Bajo","Medio","Alto"],tabla:[[18,22,10],[30,15,5],[12,20,18]]}}function k0(e){const a=Math.round(e.nivelConfianza*100),r=e.significativo,t=r?`Se observa evidencia estadísticamente significativa de asociación entre las variables al nivel α = ${e.alfa.toFixed(2)}.`:`No se observa evidencia estadísticamente significativa de asociación entre las variables al nivel α = ${e.alfa.toFixed(2)}.`;return`
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            <header class="bg-violet-700 text-white px-6 py-8 md:px-10">
                <p class="uppercase tracking-widest text-violet-100 text-xs font-black mb-2">
                    Resultado del análisis
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${St("p",R0(e.valorP),e.detallesExactos?.exacta===!1?"Valor p Monte Carlo":"Valor p bilateral")}
    ...
    `}function E0(e){const a=e.tamanioEfecto;return`
        <article class="rounded-2xl border border-violet-200 bg-violet-50 p-6">
            <h3 class="text-xl font-black text-violet-950 mb-5">
    ...
    `}function C0(e){const a=e.diagnosticoFrecuenciasEsperadas;return`
    ...
    `}function A0(e){if(!e.oddsRatio)return"";const a=e.oddsRatio,r=e.correccionYates;return`
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-6">
            <article class="rounded-2xl border border-blue-200 bg-blue-50 p-6">
                <h3 class="text-xl font-black text-blue-950 mb-5">
                    Odds ratio
    ...
    `}function I0(e){const a=e.detallesExactos;return a?`
    ...
    `:""}function P0(e){const a=e.residuos.celdasDestacadas;return a.length?`
        <article class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-6">
            <h3 class="text-xl font-black text-amber-950 mb-4">
    ...
    `:`
        ...
        `}function L0(e){return e.advertencias?.length?`
    ...
    `}function Da(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):e===1/0?"∞":e===-1/0?"−∞":"—"}function R0(e){return Number.isFinite(e)?e<.001?"< 0.001":Da(e,4):"—"}function Ha(e,a){e.textContent=a,e.classList.remove("hidden")}function on(e){e.textContent="",e.classList.add("hidden")}function be(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function sn(e){return be(e)}const ga=1e-12,we=e=>e.reduce((a,r)=>a+r,0),or=e=>[...e].sort((a,r)=>a-r),da=e=>Math.abs(e)<ga?0:e;function Ea(e,a){if(!e.length)throw new Error("No hay datos para calcular cuantiles.");if(a<=0)return e[0];if(a>=1)return e.at(-1);const r=(e.length-1)*a,t=Math.floor(r),n=Math.ceil(r);return t===n?e[t]:e[t]*(n-r)+e[n]*(r-t)}function M0(e){const a=new Map;e.forEach(n=>{a.set(n,(a.get(n)||0)+1)});const r=Math.max(...a.values());if(r===1)return{valores:[],frecuencia:1,tipo:"sin-moda"};const t=[...a].filter(([,n])=>n===r).map(([n])=>n).sort((n,c)=>n-c);return{valores:t,frecuencia:r,tipo:t.length===1?"unimodal":"multimodal"}}function $l(e,a,r,t){const n=a/e,c=e>1?a/(e-1):null;let s=null,p=null;if(e>=3&&a>ga){const u=r/e/(a/e)**1.5;s=Math.sqrt(e*(e-1))/(e-2)*u}if(e>=4&&a>ga){const u=t/e/(a/e)**2-3;p=(e-1)/((e-2)*(e-3))*((e+1)*u+6)}return{sumaCuadrados:da(a),varianzaPoblacional:da(n),varianzaMuestral:c===null?null:da(c),desviacionPoblacional:da(Math.sqrt(n)),desviacionMuestral:c===null?null:da(Math.sqrt(c)),asimetria:s===null?null:da(s),curtosisExceso:p===null?null:da(p)}}function T0(e,a){let r=0,t=0,n=0;return e.forEach(c=>{const s=c-a;r+=s**2,t+=s**3,n+=s**4}),$l(e.length,r,t,n)}function Al(e,a,r){let t=0,n=0,c=0;return e.forEach(({valor:s,frecuencia:p})=>{const u=s-a;t+=p*u**2,n+=p*u**3,c+=p*u**4}),$l(r,t,n,c)}function N0(e){if(!Array.isArray(e))throw new Error("Los datos deben proporcionarse en una lista.");const a=e.map(Number);if(a.length<2)throw new Error("Introduzca al menos dos observaciones numéricas.");if(!a.every(Number.isFinite))throw new Error("Todos los datos deben ser números válidos.");return a}function S0(e){const a=new Map;or(e).forEach(t=>{a.set(t,(a.get(t)||0)+1)});let r=0;return[...a].map(([t,n])=>(r+=n,{valor:t,frecuencia:n,frecuenciaRelativa:n/e.length,frecuenciaAcumulada:r,frecuenciaRelativaAcumulada:r/e.length}))}function _0(e){const a=or(e),r=a.length,t=we(a)/r,n=Ea(a,.5),c=Ea(a,.25),s=Ea(a,.75),p=s-c,u=c-1.5*p,l=s+1.5*p,i=a.filter(f=>f>=u&&f<=l),o=a.filter(f=>f<u||f>l),d=T0(a,t),m=or(a.map(f=>Math.abs(f-n)));return{n:r,suma:we(a),minimo:a[0],maximo:a.at(-1),rango:a.at(-1)-a[0],media:t,mediana:n,moda:M0(a),q1:c,q3:s,iqr:p,percentiles:{p10:Ea(a,.1),p25:c,p50:n,p75:s,p90:Ea(a,.9)},desviacionMedia:a.reduce((f,g)=>f+Math.abs(g-t),0)/r,mad:Ea(m,.5),coeficienteVariacion:d.desviacionMuestral!==null&&Math.abs(t)>ga?Math.abs(d.desviacionMuestral/t)*100:null,limitesAtipicos:{inferior:u,superior:l},bigotesCaja:{inferior:i[0],superior:i.at(-1)},atipicos:o,atipicosCantidad:o.length,...d}}function z0(e,a){if(!Array.isArray(e)||!Array.isArray(a)||e.length!==a.length||!e.length)throw new Error("Los valores y las frecuencias deben tener la misma cantidad de filas.");const r=new Map;e.forEach((c,s)=>{const p=Number(c),u=Number(a[s]);if(!Number.isFinite(p))throw new Error(`El valor de la fila ${s+1} no es válido.`);if(!Number.isInteger(u)||u<0)throw new Error(`La frecuencia de la fila ${s+1} debe ser un entero no negativo.`);r.set(p,(r.get(p)||0)+u)});const t=[...r].map(([c,s])=>({valor:c,frecuencia:s})).filter(({frecuencia:c})=>c>0).sort((c,s)=>c.valor-s.valor),n=we(t.map(({frecuencia:c})=>c));if(n<2)throw new Error("La suma de las frecuencias debe ser al menos 2.");return{filas:t,n}}function Po(e,a){let r=0;for(const t of e)if(r+=t.frecuencia,a<r)return t.valor;return e.at(-1).valor}function Ca(e,a,r){if(r<=0)return e[0].valor;if(r>=1)return e.at(-1).valor;const t=(a-1)*r,n=Math.floor(t),c=Math.ceil(t),s=Po(e,n),p=Po(e,c);return n===c?s:s*(c-t)+p*(t-n)}function D0(e){const a=Math.max(...e.map(({frecuencia:t})=>t));if(a===1)return{valores:[],frecuencia:1,tipo:"sin-moda"};const r=e.filter(({frecuencia:t})=>t===a).map(({valor:t})=>t);return{valores:r,frecuencia:a,tipo:r.length===1?"unimodal":"multimodal"}}function q0(e,a){let r=0;return e.map(({valor:t,frecuencia:n})=>(r+=n,{valor:t,frecuencia:n,frecuenciaRelativa:n/a,frecuenciaAcumulada:r,frecuenciaRelativaAcumulada:r/a}))}function O0(e,a){const r=we(e.map(({valor:b,frecuencia:x})=>b*x)),t=r/a,n=Ca(e,a,.5),c=Ca(e,a,.25),s=Ca(e,a,.75),p=s-c,u=c-1.5*p,l=s+1.5*p,i=e.filter(({valor:b})=>b>=u&&b<=l),o=e.filter(({valor:b})=>b<u||b>l),d=Al(e,t,a),m=new Map;e.forEach(({valor:b,frecuencia:x})=>{const y=Math.abs(b-n);m.set(y,(m.get(y)||0)+x)});const f=[...m].map(([b,x])=>({valor:b,frecuencia:x})).sort((b,x)=>b.valor-x.valor),g=we(o.map(({frecuencia:b})=>b));return{n:a,suma:r,minimo:e[0].valor,maximo:e.at(-1).valor,rango:e.at(-1).valor-e[0].valor,media:t,mediana:n,moda:D0(e),q1:c,q3:s,iqr:p,percentiles:{p10:Ca(e,a,.1),p25:c,p50:n,p75:s,p90:Ca(e,a,.9)},desviacionMedia:we(e.map(({valor:b,frecuencia:x})=>Math.abs(b-t)*x))/a,mad:Ca(f,a,.5),coeficienteVariacion:d.desviacionMuestral!==null&&Math.abs(t)>ga?Math.abs(d.desviacionMuestral/t)*100:null,limitesAtipicos:{inferior:u,superior:l},bigotesCaja:{inferior:i[0].valor,superior:i.at(-1).valor},atipicos:o.map(({valor:b})=>b),atipicosCantidad:g,atipicosFrecuencias:o,...d}}function F0(e){if(!Array.isArray(e)||e.length<2)throw new Error("Introduzca al menos dos intervalos de clase.");const a=e.map((r,t)=>{const n=Number(r.limiteInferior),c=Number(r.limiteSuperior),s=Number(r.frecuencia);if(!Number.isFinite(n)||!Number.isFinite(c)||c<=n)throw new Error(`Los límites de la clase ${t+1} no son válidos.`);if(!Number.isInteger(s)||s<0)throw new Error(`La frecuencia de la clase ${t+1} debe ser un entero no negativo.`);return{limiteInferior:n,limiteSuperior:c,frecuencia:s,marcaClase:(n+c)/2,amplitud:c-n}}).sort((r,t)=>r.limiteInferior-t.limiteInferior);for(let r=1;r<a.length;r+=1)if(a[r].limiteInferior<a[r-1].limiteSuperior-ga)throw new Error("Los intervalos de clase no deben superponerse.");if(we(a.map(({frecuencia:r})=>r))<2)throw new Error("La suma de las frecuencias debe ser al menos 2.");return a}function Wa(e,a,r){const t=a*r;let n=0;for(const c of e){const s=n+c.frecuencia;if(t<=s||c===e.at(-1))return c.frecuencia===0?c.marcaClase:c.limiteInferior+(t-n)/c.frecuencia*c.amplitud;n=s}return e.at(-1).limiteSuperior}function U0(e){const a=Math.max(...e.map(({frecuencia:u})=>u)),r=e.findIndex(({frecuencia:u})=>u===a),t=e[r];if(a===0)return null;const n=r?e[r-1].frecuencia:0,c=r<e.length-1?e[r+1].frecuencia:0,s=a-n,p=a-c;return{valor:s+p>0?t.limiteInferior+s/(s+p)*t.amplitud:t.marcaClase,intervalo:{inferior:t.limiteInferior,superior:t.limiteSuperior},frecuencia:a}}function j0(e){const a=we(e.map(({frecuencia:l})=>l)),r=we(e.map(({marcaClase:l,frecuencia:i})=>l*i)),t=r/a,n=Al(e.map(({marcaClase:l,frecuencia:i})=>({valor:l,frecuencia:i})),t,a),c=Wa(e,.25,a),s=Wa(e,.5,a),p=Wa(e,.75,a),u=p-c;return{n:a,suma:r,minimo:e[0].limiteInferior,maximo:e.at(-1).limiteSuperior,rango:e.at(-1).limiteSuperior-e[0].limiteInferior,media:t,mediana:s,moda:U0(e),q1:c,q3:p,iqr:u,percentiles:{p10:Wa(e,.1,a),p25:c,p50:s,p75:p,p90:Wa(e,.9,a)},desviacionMedia:we(e.map(({marcaClase:l,frecuencia:i})=>Math.abs(l-t)*i))/a,mad:null,coeficienteVariacion:n.desviacionMuestral!==null&&Math.abs(t)>ga?Math.abs(n.desviacionMuestral/t)*100:null,limitesAtipicos:{inferior:c-1.5*u,superior:p+1.5*u},bigotesCaja:{inferior:e[0].limiteInferior,superior:e.at(-1).limiteSuperior},atipicos:[],atipicosCantidad:0,advertenciaAtipicos:"Con datos agrupados no es posible identificar observaciones atípicas individuales; los límites son aproximados.",...n}}function V0(e){const a=we(e.map(({frecuencia:t})=>t));let r=0;return e.map(t=>(r+=t.frecuencia,{intervalo:{inferior:t.limiteInferior,superior:t.limiteSuperior},marcaClase:t.marcaClase,amplitud:t.amplitud,frecuencia:t.frecuencia,frecuenciaRelativa:t.frecuencia/a,frecuenciaAcumulada:r,frecuenciaRelativaAcumulada:r/a}))}function ni(e,a){const r=e.asimetria===null?"Asimetría no disponible":Math.abs(e.asimetria)<.5?"Distribución aproximadamente simétrica":e.asimetria>0?"Distribución con asimetría positiva":"Distribución con asimetría negativa",t=e.curtosisExceso===null?"Curtosis no disponible":Math.abs(e.curtosisExceso)<.5?"Curtosis próxima a mesocúrtica":e.curtosisExceso>0?"Distribución leptocúrtica":"Distribución platicúrtica",n=e.atipicosCantidad??e.atipicos.length;return[`La media es ${e.media.toFixed(3)} y la mediana es ${e.mediana.toFixed(3)}.`,`La desviación estándar muestral es ${e.desviacionMuestral?.toFixed(3)??"no disponible"}.`,e.coeficienteVariacion===null?"El coeficiente de variación no es interpretable cuando la media es cero.":`El coeficiente de variación es ${e.coeficienteVariacion.toFixed(2)} %.`,`${r}.`,`${t}.`,a?e.advertenciaAtipicos:n?`Se detectaron ${n} valores atípicos potenciales mediante el criterio de Tukey.`:"No se detectaron valores atípicos potenciales mediante el criterio de Tukey."]}function B0(e){const a=N0(e),r=_0(a),t=S0(a);return{tipoDatos:"individuales",aproximado:!1,resumen:r,tablaFrecuencias:t,datosGrafico:{valores:or(a),frecuencias:t},interpretacion:ni(r,!1)}}function G0({valores:e,frecuencias:a}){const{filas:r,n:t}=z0(e,a),n=O0(r,t),c=q0(r,t);return{tipoDatos:"frecuencias",aproximado:!1,resumen:n,tablaFrecuencias:c,datosGrafico:{frecuencias:c},datosOriginales:{valores:r.map(({valor:s})=>s),frecuencias:r.map(({frecuencia:s})=>s)},interpretacion:ni(n,!1)}}function H0(e){const a=F0(e),r=j0(a),t=V0(a);return{tipoDatos:"intervalos",aproximado:!0,resumen:r,tablaFrecuencias:t,datosGrafico:{clases:t},interpretacion:ni(r,!0),advertencias:["Las medidas se estiman mediante marcas de clase e interpolación dentro de los intervalos."]}}function W0({tipoDatos:e="individuales",valores:a=[],frecuencias:r=[],clases:t=[]}){if(e==="individuales")return B0(a);if(e==="frecuencias")return G0({valores:a,frecuencias:r});if(e==="intervalos")return H0(t);throw new Error("El tipo de datos seleccionado no está disponible.")}function K0(){const e=document.createElement("section");e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
        ...
        <section
            ...
            aria-live="polite"
        ></section>
    `;const a=e.querySelector("#formulario-estadistica-descriptiva"),r=e.querySelector("#entrada-datos-descriptivos"),t=e.querySelector("#mensaje-error-descriptiva"),n=e.querySelector("#resultados-estadistica-descriptiva"),c=()=>{r.innerHTML=Y0(a.elements.tipoDatos.value),n.classList.add("hidden"),_t(t)};return c(),a.elements.tipoDatos.addEventListener("change",c),a.addEventListener("submit",s=>{s.preventDefault(),_t(t);try{const p=a.elements.tipoDatos.value,u=Q0(p,r),l=W0(u);n.innerHTML=Z0(l),n.classList.remove("hidden"),n.scrollIntoView({behavior:"smooth",block:"start"})}catch(p){n.classList.add("hidden"),sh(t,p instanceof Error?p.message:"No fue posible calcular los descriptivos.")}}),e.addEventListener("click",s=>{const p=s.target.closest("[data-action]");if(!p)return;const u=p.dataset.action;if(u==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}if(u==="cargar-ejemplo"){X0(a.elements.tipoDatos.value,r),n.classList.add("hidden"),_t(t);return}if(u==="limpiar"){const l=r.querySelector("textarea");l&&(l.value=""),n.classList.add("hidden"),_t(t)}}),e}function ln(e,a){return`
        <div>
            <h3 class="font-black text-slate-900 mb-1">
                ${e}
            </h3>
    ...
    `}function Y0(e){const r={individuales:{titulo:"Observaciones",ayuda:"Separe los valores mediante comas, espacios, punto y coma o saltos de línea.",marcador:"12, 15, 18, 18, 20, 22, 25, 27"},frecuencias:{titulo:"Valor y frecuencia",ayuda:"Escriba una fila por valor con el formato: valor, frecuencia.",marcador:`10, 3
12, 5
14, 7
...
20, 30, 7`}}[e];return`
    ...
    `}function J0(e){return e.trim().split(/[\s,;]+/).filter(Boolean).map(Number)}function Lo(e,a){const r=e.trim().split(/\n+/).map(t=>t.trim()).filter(Boolean).map((t,n)=>{const c=t.split(/[,;\t ]+/).filter(Boolean).map(Number);if(c.length!==a||!c.every(Number.isFinite))throw new Error(`La fila ${n+1} debe contener exactamente ${a} valores numéricos.`);return c});if(!r.length)throw new Error("Introduzca los datos antes de calcular.");return r}function Q0(e,a){const r=a.querySelector("textarea").value;if(!r.trim())throw new Error("Introduzca los datos antes de calcular.");if(e==="individuales")return{tipoDatos:e,valores:J0(r)};if(e==="frecuencias"){const n=Lo(r,2);return{tipoDatos:e,valores:n.map(c=>c[0]),frecuencias:n.map(c=>c[1])}}const t=Lo(r,3);return{tipoDatos:e,clases:t.map(n=>({limiteInferior:n[0],limiteSuperior:n[1],frecuencia:n[2]}))}}function X0(e,a){const r={individuales:"42, 48, 51, 53, 55, 55, 57, 59, 61, 64, 67, 72, 96",frecuencias:`1, 2
2, 5
3, 8
4, 6
...
20, 30, 12
30, 40, 9
40, 50, 3`};a.querySelector("textarea").value=r[e]}function Z0(e){const a=e.resumen;return`
        <section class="rounded-3xl border border-sky-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                ...
                ${e.advertencias?.length?th(e.advertencias):""}
    ...
    `}function rh(e){const a=e.tablaFrecuencias,r=Math.max(...a.map(t=>t.frecuencia),1);return`
    ...
    `}function nh(e,a){const r=e.minimo,t=e.maximo,n=Math.max(t-r,1),c=o=>40+(o-r)/n*520,s=c(r),p=c(e.q1),u=c(e.mediana),l=c(e.q3),i=c(t);return`
        <article class="rounded-3xl border border-slate-200 bg-white p-6 shadow-md">
            <h3 class="text-2xl font-black text-slate-900 mb-2">
                Diagrama de caja
            </h3>
    ...
    `}function ih(e){const a=e.tipoDatos==="intervalos";return`
    ...
    `}function ie(e){return e==null||!Number.isFinite(Number(e))?"—":Number(e).toLocaleString("es-DO",{maximumFractionDigits:4})}function Ro(e){return`${(e*100).toLocaleString("es-DO",{maximumFractionDigits:2})} %`}function oh(e){return e?"valores"in e?e.valores.length?e.valores.map(ie).join(", "):"Sin moda":ie(e.valor):"—"}function sh(e,a){e.textContent=a,e.classList.remove("hidden")}function _t(e){e.textContent="",e.classList.add("hidden")}function lh(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
    ...
    `).join("");return ja("Observado frente a predicho","Un ajuste adecuado concentra los puntos cerca de la línea diagonal de igualdad.",Va(`
            ...
            />
            ${p}
        `,"Gráfico de valores observados frente a valores predichos"))}function Ch(e){const a=e.datosGrafico.map(u=>u.predicho),r=e.datosGrafico.map(u=>u.residuo),t=qa(a),n=qa([...r,0]),s=Mr({ancho:640,alto:360,margen:{izquierdo:66,derecho:28,superior:24,inferior:60},rangoX:t,rangoY:n,etiquetaX:"Valor predicho",etiquetaY:"Residuo"}),p=e.datosGrafico.map((u,l)=>`
        <circle
            cx="${s.x(u.predicho)}"
            cy="${s.y(u.residuo)}"
            r="5"
    ...
    `).join("");return ja("Residuos frente a valores predichos","Se espera una nube aproximadamente aleatoria alrededor de cero. Los puntos rojos tienen residuos estandarizados con magnitud mayor que 2.",Va(`
        ...
        `,"Histograma de los residuos"))}function Ah(e){const a=[-39.6968302866538,220.946098424521,-275.928510446969,138.357751867269,-30.6647980661472,2.50662827745924],r=[-54.4760987982241,161.585836858041,-155.698979859887,66.8013118877197,-13.2806815528857],t=[-.00778489400243029,-.322396458041136,-2.40075827716184,-2.54973253934373,4.37466414146497,2.93816398269878],n=[.00778469570904146,.32246712907004,2.445134137143,3.75440866190742],c=.02425,s=1-c;if(e<c){const l=Math.sqrt(-2*Math.log(e));return(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}if(e>s){const l=Math.sqrt(-2*Math.log(1-e));return-(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}const p=e-.5,u=p*p;return(((((a[0]*u+a[1])*u+a[2])*u+a[3])*u+a[4])*u+a[5])*p/(((((r[0]*u+r[1])*u+r[2])*u+r[3])*u+r[4])*u+1)}function Ih(e){const a=[...e.diagnosticos.residuosEstandarizados].sort((p,u)=>p-u),r=a.map((p,u)=>Ah((u+.5)/a.length)),t=qa([...a,...r]),c=Mr({ancho:640,alto:360,margen:{izquierdo:66,derecho:28,superior:24,inferior:60},rangoX:t,rangoY:t,etiquetaX:"Cuantil normal teórico",etiquetaY:"Residuo estandarizado ordenado"}),s=a.map((p,u)=>`
        <circle
            cx="${c.x(r[u])}"
            cy="${c.y(p)}"
            r="4.5"
    ...
    `).join("");return ja("Gráfico Q–Q de residuos","La proximidad de los puntos a la diagonal ofrece una evaluación visual de la normalidad residual.",Va(`
        ...
        `,"Gráfico de distancia de Cook por observación"))}function Lh(e,a="Y"){return`
        <section class="mt-10" data-seccion-graficos-regresion="true">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-7">
                ${[kh(e,a),Eh(e,a),Ch(e),$h(e),Ih(e),Ph(e)].filter(Boolean).join("")}
            </div>
        </section>
    `}function Rh(){const e=document.createElement("section");let a=null,r=null;e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
64, 3"
    ...
    `;const t=e.querySelector("#formulario-regresion"),n=e.querySelector("#mensaje-error-regresion"),c=e.querySelector("#resultados-regresion"),s=e.querySelector("[data-nombre-archivo]");return t.elements.tipoModelo.addEventListener("change",()=>{un(t),c.classList.add("hidden"),Ya(n)}),t.elements.archivoDatos.addEventListener("change",async()=>{const p=t.elements.archivoDatos.files?.[0];if(p)try{t.elements.datos.value=await p.text(),s.textContent=`Archivo cargado: ${p.name}`,c.classList.add("hidden"),Ya(n)}catch{So(n,"No fue posible leer el archivo seleccionado.")}}),t.addEventListener("submit",p=>{p.preventDefault(),Ya(n);try{const u=Th(t);a=Ll(u.solicitud),r=u.metadatos,c.innerHTML=Uh(a,r),c.classList.remove("hidden"),c.scrollIntoView({behavior:"smooth",block:"start"})}catch(u){c.classList.add("hidden"),So(n,u instanceof Error?u.message:"No fue posible ajustar el modelo.")}}),e.addEventListener("submit",p=>{if(p.target.id!=="formulario-prediccion-regresion")return;p.preventDefault();const u=e.querySelector("#resultado-prediccion-regresion");try{const l=[...p.target.querySelectorAll("[data-predictor]")].map(o=>Number(o.value)),i=wh(a,l);u.innerHTML=`
            ...
            `}}),e.addEventListener("click",async p=>{const u=p.target.closest("[data-action]");if(!u)return;const l=u.dataset.action;if(l==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}if(l==="cargar-ejemplo"){Nh(t),s.textContent="",c.classList.add("hidden"),Ya(n);return}if(l==="limpiar"){t.reset(),un(t),t.elements.datos.value="",s.textContent="",a=null,r=null,c.innerHTML="",c.classList.add("hidden"),Ya(n);return}if(!(!a||!r)){if(l==="exportar-csv"){Bh(a,r);return}if(l==="imprimir"){window.print();return}if(l==="copiar-reporte")try{await navigator.clipboard.writeText(jh(a,r)),u.textContent="Reporte copiado",window.setTimeout(()=>{u.textContent="Copiar interpretación"},1800)}catch{u.textContent="No se pudo copiar"}}}),un(t),e}function Dt(e,a){return`
        <div>
...
94; 10`}function q(e,a=4){return e==null?"—":e===1/0?"∞":e===-1/0?"−∞":Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):"—"}function sr(e){return e==null?"—":e<.001?"< 0.001":q(e,4)}function Te(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Sh(e,a){const r=[];return e.coeficientes.forEach((t,n)=>{const c=t.estimacion,s=q(Math.abs(c),6);if(n===0&&e.incluirIntercepto){r.push(q(c,6));return}const p=c>=0&&r.length?"+":"−",u=Te(t.termino);r.length?r.push(`${p} ${s}·${u}`):r.push(`${c<0?"−":""}${s}·${u}`)}),`${Te(a)}̂ = ${r.join(" ")}`}function ua(e,a,r=""){return`
    ...
    `}function qh(e){return e.diagnosticos.vif.length?`
        <div class="overflow-x-auto rounded-2xl border border-slate-200">
            <table class="min-w-full text-sm">
                <thead class="bg-slate-950 text-white">
                    <tr>
    ...
    `}function Uh(e,a){const r=e.anova.p!==null&&e.anova.p<.05,t=q(e.ajuste.r2*100,2);return`
...
`),n=new Blob([`\uFEFF${t}`],{type:"text/csv;charset=utf-8"}),c=document.createElement("a");c.href=URL.createObjectURL(n),c.download="regresion-lineal-multiple-kernel.csv",document.body.appendChild(c),c.click(),c.remove(),URL.revokeObjectURL(c.href)}function So(e,a){e.textContent=a,e.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"center"})}function Ya(e){e.textContent="",e.classList.add("hidden")}const re=1e-12,Ke=35;function _o(e,a,r=5){if(!Array.isArray(a)||a.length<r)throw new Error(`${e} debe contener al menos ${r} observaciones.`);const t=a.map(Number);if(!t.every(Number.isFinite))throw new Error(`${e} contiene valores no numéricos o no finitos.`);return t}function Gh(e){return Array.from({length:e},(a,r)=>Array.from({length:e},(t,n)=>r===n?1:0))}function Hh(e){return e[0].map((a,r)=>e.map(t=>t[r]))}function Wh(e,a){return e.map(r=>a[0].map((t,n)=>r.reduce((c,s,p)=>c+s*a[p][n],0)))}function at(e,a){return e.map(r=>r.reduce((t,n,c)=>t+n*a[c],0))}function tt(e,a){return e.reduce((r,t,n)=>r+t*a[n],0)}function In(e){const a=e.length,r=e.map((t,n)=>[...t.map(Number),...Gh(a)[n]]);for(let t=0;t<a;t+=1){let n=t;for(let s=t+1;s<a;s+=1)Math.abs(r[s][t])>Math.abs(r[n][t])&&(n=s);if(Math.abs(r[n][t])<re)throw new Error("La matriz de información es singular. Elimine predictores redundantes o perfectamente colineales.");[r[t],r[n]]=[r[n],r[t]];const c=r[t][t];r[t]=r[t].map(s=>s/c);for(let s=0;s<a;s+=1){if(s===t)continue;const p=r[s][t];r[s]=r[s].map((u,l)=>u-p*r[t][l])}}return r.map(t=>t.slice(a))}function Rl(e,a){const r=e[0].length;return Array.from({length:r},(t,n)=>[...a?[1]:[],...e.map(c=>c[n])])}function Kt(e){const a=Math.max(-Ke,Math.min(Ke,e));if(a>=0)return 1/(1+Math.exp(-a));const r=Math.exp(a);return r/(1+r)}function rt(e,a){return e.reduce((r,t,n)=>{const c=Math.max(re,Math.min(1-re,a[n]));return r+t*Math.log(c)+(1-t)*Math.log(1-c)},0)}function Kh(e){const a=e<0?-1:1,r=Math.abs(e)/Math.sqrt(2),t=1/(1+.3275911*r),l=1-((((1.061405429*t+-1.453152027)*t+1.421413741)*t+-.284496736)*t+.254829592)*t*Math.exp(-r*r);return .5*(1+a*l)}function Yh(e){return Math.max(0,Math.min(1,2*(1-Kh(Math.abs(e)))))}function Pn(e){const a=[676.5203681218851,-1259.1392167224028,771.3234287776531,-176.6150291621406,12.507343278686905,-.13857109526572012,9984369578019572e-21,15056327351493116e-23];if(e<.5)return Math.log(Math.PI)-Math.log(Math.sin(Math.PI*e))-Pn(1-e);let r=.9999999999998099;const t=e-1;a.forEach((c,s)=>{r+=c/(t+s+1)});const n=t+a.length-.5;return .5*Math.log(2*Math.PI)+(t+.5)*Math.log(n)-n+Math.log(r)}function Jh(e,a){if(a<=0)return 0;if(a<e+1){let p=1/e,u=p,l=e;for(let i=1;i<=300&&(l+=1,p*=a/l,u+=p,!(Math.abs(p)<Math.abs(u)*1e-14));i+=1);return u*Math.exp(-a+e*Math.log(a)-Pn(e))}let r=a+1-e,t=1/1e-300,n=1/r,c=n;for(let p=1;p<=300;p+=1){const u=-p*(p-e);r+=2,n=u*n+r,Math.abs(n)<1e-300&&(n=1e-300),t=r+u/t,Math.abs(t)<1e-300&&(t=1e-300),n=1/n;const l=n*t;if(c*=l,Math.abs(l-1)<1e-14)break}return 1-Math.exp(-a+e*Math.log(a)-Pn(e))*c}function Ml(e,a){return!(e>=0)||!(a>0)?null:Math.max(0,Math.min(1,1-Jh(a/2,e/2)))}function Qh(e){const a=[-39.6968302866538,220.946098424521,-275.928510446969,138.357751867269,-30.6647980661472,2.50662827745924],r=[-54.4760987982241,161.585836858041,-155.698979859887,66.8013118877197,-13.2806815528857],t=[-.00778489400243029,-.322396458041136,-2.40075827716184,-2.54973253934373,4.37466414146497,2.93816398269878],n=[.00778469570904146,.32246712907004,2.445134137143,3.75440866190742],c=.02425,s=1-c;if(e<=0||e>=1)throw new Error("La probabilidad debe estar entre 0 y 1.");if(e<c){const l=Math.sqrt(-2*Math.log(e));return(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}if(e>s){const l=Math.sqrt(-2*Math.log(1-e));return-(((((t[0]*l+t[1])*l+t[2])*l+t[3])*l+t[4])*l+t[5])/((((n[0]*l+n[1])*l+n[2])*l+n[3])*l+1)}const p=e-.5,u=p*p;return(((((a[0]*u+a[1])*u+a[2])*u+a[3])*u+a[4])*u+a[5])*p/(((((r[0]*u+r[1])*u+r[2])*u+r[3])*u+r[4])*u+1)}function zo(e,a){const r=e[0].length,t=Array.from({length:r},()=>Array(r).fill(0));return e.forEach((n,c)=>{const s=Math.max(a[c]*(1-a[c]),re);for(let p=0;p<r;p+=1)for(let u=0;u<r;u+=1)t[p][u]+=s*n[p]*n[u]}),t}function Xh(e,a,r={}){const t=r.maxIteraciones??100,n=r.tolerancia??1e-8,c=e[0].length;let s=Array(c).fill(0),p=e.map(()=>.5),u=rt(a,p),l=!1,i=0;for(let m=1;m<=t;m+=1){i=m,p=e.map(C=>Kt(tt(C,s)));const f=zo(e,p),g=In(f),b=Array(c).fill(0);e.forEach((C,$)=>{const I=a[$]-p[$];C.forEach((A,L)=>{b[L]+=A*I})});const x=at(g,b);let y=1,v=s.map((C,$)=>C+x[$]),h=e.map(C=>Kt(tt(C,v))),w=rt(a,h);for(;w<u-1e-10&&y>1/1024;)y/=2,v=s.map((C,$)=>C+y*x[$]),h=e.map(C=>Kt(tt(C,v))),w=rt(a,h);const k=Math.max(...v.map((C,$)=>Math.abs(C-s[$]))),E=Math.abs(w-u);if(s=v,p=h,u=w,k<n&&E<n){l=!0;break}if(s.some(C=>Math.abs(C)>100))break}const o=zo(e,p),d=In(o);return{beta:s,probabilidades:p,logLik:u,covarianza:d,informacion:o,convergio:l,iteraciones:i}}function Zh(e,a){if(!a){const c=e.map(()=>.5);return{probabilidades:c,logLik:rt(e,c)}}const r=e.reduce((c,s)=>c+s,0)/e.length,t=Math.max(re,Math.min(1-re,r)),n=e.map(()=>t);return{probabilidades:n,logLik:rt(e,n)}}function ex(e,a,r){let t=0,n=0,c=0,s=0;e.forEach((f,g)=>{const b=a[g]>=r?1:0;f===1&&b===1&&(t+=1),f===0&&b===0&&(n+=1),f===0&&b===1&&(c+=1),f===1&&b===0&&(s+=1)});const p=e.length,u=(f,g)=>g>0?f/g:null,l=u(t,t+s),i=u(n,n+c),o=u(t,t+c),d=u(n,n+s),m=o!==null&&l!==null&&o+l>0?2*o*l/(o+l):null;return{umbral:r,verdaderosPositivos:t,verdaderosNegativos:n,falsosPositivos:c,falsosNegativos:s,exactitud:(t+n)/p,sensibilidad:l,especificidad:i,precision:o,valorPredictivoNegativo:d,f1:m,exactitudBalanceada:l!==null&&i!==null?(l+i)/2:null}}function ax(e,a){const r=e.map((u,l)=>({observado:u,probabilidad:a[l]})).sort((u,l)=>l.probabilidad-u.probabilidad),t=e.reduce((u,l)=>u+l,0),n=e.length-t,s=[1/0,...new Set(r.map(u=>u.probabilidad)),-1/0].map(u=>{let l=0,i=0;return r.forEach(o=>{const d=o.probabilidad>=u;d&&o.observado===1&&(l+=1),d&&o.observado===0&&(i+=1)}),{umbral:Number.isFinite(u)?u:null,sensibilidad:t>0?l/t:0,unoMenosEspecificidad:n>0?i/n:0}}).sort((u,l)=>u.unoMenosEspecificidad-l.unoMenosEspecificidad||u.sensibilidad-l.sensibilidad);let p=0;for(let u=1;u<s.length;u+=1){const l=s[u].unoMenosEspecificidad-s[u-1].unoMenosEspecificidad,i=(s[u].sensibilidad+s[u-1].sensibilidad)/2;p+=l*i}return{puntos:s,auc:Math.max(0,Math.min(1,p))}}function tx(e,a){const r=e.map((p,u)=>({observado:p,probabilidad:a[u]})).sort((p,u)=>p.probabilidad-u.probabilidad),t=Math.min(10,Math.max(3,Math.floor(e.length/5))),n=[];for(let p=0;p<t;p+=1){const u=Math.floor(p*r.length/t),l=Math.floor((p+1)*r.length/t),i=r.slice(u,l);if(!i.length)continue;const o=i.reduce((g,b)=>g+b.observado,0),d=i.reduce((g,b)=>g+b.probabilidad,0),m=i.length-o,f=i.length-d;n.push({grupo:n.length+1,n:i.length,probabilidadMedia:i.reduce((g,b)=>g+b.probabilidad,0)/i.length,observadosPositivos:o,esperadosPositivos:d,observadosNegativos:m,esperadosNegativos:f})}const c=n.reduce((p,u)=>{const l=u.esperadosPositivos>re?(u.observadosPositivos-u.esperadosPositivos)**2/u.esperadosPositivos:0,i=u.esperadosNegativos>re?(u.observadosNegativos-u.esperadosNegativos)**2/u.esperadosNegativos:0;return p+l+i},0),s=Math.max(n.length-2,1);return{estadistico:c,gradosLibertad:s,p:Ml(c,s),grupos:n}}function rx(e,a,r,t){const n=e[0].length,c=e.map((l,i)=>{const o=at(t,l);return r[i]*(1-r[i])*tt(l,o)}),s=a.map((l,i)=>{const o=Math.max(r[i]*(1-r[i]),re);return(l-r[i])/Math.sqrt(o)}),p=a.map((l,i)=>{const o=Math.max(re,Math.min(1-re,r[i])),d=l===1?2*Math.log(1/o):2*Math.log(1/(1-o));return Math.sign(l-o)*Math.sqrt(Math.max(d,0))}),u=s.map((l,i)=>{const o=Math.min(c[i],1-re);return l**2*o/(n*Math.max((1-o)**2,re))});return{leverage:c,residuosPearson:s,residuosDeviance:p,distanciaCook:u}}function nx(e,a){return e.length<2?[]:e.map((r,t)=>{const n=e.filter((u,l)=>l!==t),c=Rl(n,!0),s=Hh(c),p=Wh(s,c);try{const u=In(p),l=at(s,r),i=at(u,l),o=at(c,i),d=r.reduce((x,y)=>x+y,0)/r.length,m=r.reduce((x,y)=>x+(y-d)**2,0),f=r.reduce((x,y,v)=>x+(y-o[v])**2,0),g=m>re?Math.max(0,1-f/m):1,b=Math.max(1-g,re);return{variable:a[t],tolerancia:b,vif:1/b}}catch{return{variable:a[t],tolerancia:0,vif:1/0}}})}function ix({y:e,X:a,nombresPredictores:r=[],incluirIntercepto:t=!0,nivelConfianza:n=.95,umbral:c=.5,maxIteraciones:s=100,tolerancia:p=1e-8}){const u=_o("La variable dependiente",e,8);if(!u.every(_=>_===0||_===1))throw new Error("La variable dependiente debe estar codificada exclusivamente con 0 y 1.");const l=u.reduce((_,z)=>_+z,0),i=u.length-l;if(l===0||i===0)throw new Error("La variable dependiente debe contener observaciones de ambas categorías: 0 y 1.");if(!Array.isArray(a)||!a.length)throw new Error("Debe proporcionar al menos una variable predictora.");const o=a.map((_,z)=>_o(r[z]||`X${z+1}`,_,8));if(!o.every(_=>_.length===u.length))throw new Error("Todas las variables deben contener la misma cantidad de observaciones.");if(!(n>0&&n<1))throw new Error("El nivel de confianza debe estar entre 0 y 1.");if(!(c>0&&c<1))throw new Error("El umbral de clasificación debe estar entre 0 y 1.");const d=o.map((_,z)=>r[z]||`X${z+1}`),m=Rl(o,t),f=u.length,g=m[0].length;if(f<=g+2)throw new Error("No hay suficientes observaciones para estimar el modelo logístico con esta cantidad de predictores.");const b=Xh(m,u,{maxIteraciones:s,tolerancia:p});if(!b.convergio)throw new Error("El algoritmo no alcanzó convergencia. Revise separación perfecta, predictores extremos, colinealidad o tamaño muestral insuficiente.");const x=Zh(u,t),y=o.length,v=Math.max(0,2*(b.logLik-x.logLik)),h=Ml(v,y),w=Qh(.5+n/2),k=[...t?["Intercepto"]:[],...d],E=b.beta.map((_,z)=>{const _e=Math.sqrt(Math.max(b.covarianza[z][z],0)),T=_e>re?_/_e:_===0?0:1/0,S=Yh(T),X=_-w*_e,la=_+w*_e;return{termino:k[z],estimacion:_,errorEstandar:_e,z:T,p:S,intervaloConfianza:{inferior:X,superior:la,nivel:n},oddsRatio:Math.exp(Math.max(-Ke,Math.min(Ke,_))),intervaloOddsRatio:{inferior:Math.exp(Math.max(-Ke,Math.min(Ke,X))),superior:Math.exp(Math.max(-Ke,Math.min(Ke,la))),nivel:n}}}),C=ex(u,b.probabilidades,c),$=ax(u,b.probabilidades),I=tx(u,b.probabilidades),A=rx(m,u,b.probabilidades,b.covarianza),L=nx(o,d),R=u.map((_,z)=>({observacion:z+1,observado:_,probabilidad:b.probabilidades[z],residuoPearson:A.residuosPearson[z],residuoDeviance:A.residuosDeviance[z],leverage:A.leverage[z],distanciaCook:A.distanciaCook[z]})).filter(_=>Math.abs(_.residuoPearson)>2||_.leverage>2*g/f||_.distanciaCook>4/f),N=-2*b.logLik,V=-2*x.logLik,P=-2*b.logLik+2*g,D=-2*b.logLik+g*Math.log(f),te=x.logLik!==0?1-b.logLik/x.logLik:null,Y=1-Math.exp(2/f*(x.logLik-b.logLik)),J=1-Math.exp(2/f*x.logLik),oe=J>re?Y/J:null,ue=C.exactitud===1,Q=b.beta.some(_=>Math.abs(_)>15),ge=ue&&Q,Se=[h!==null&&h<.05?`El modelo global mejora significativamente al modelo nulo (χ² = ${v.toFixed(4)}, gl = ${y}, p ${h<.001?"< 0.001":`= ${h.toFixed(4)}`}).`:`El modelo global no alcanza significación estadística al 5 % (χ² = ${v.toFixed(4)}, gl = ${y}, p = ${h?.toFixed(4)??"no disponible"}).`,`El área bajo la curva ROC es ${$.auc.toFixed(4)}, lo que resume la capacidad del modelo para ordenar casos positivos por encima de casos negativos.`,`Con umbral ${c.toFixed(2)}, la exactitud es ${(C.exactitud*100).toFixed(2)} %, la sensibilidad es ${C.sensibilidad===null?"no calculable":`${(C.sensibilidad*100).toFixed(2)} %`} y la especificidad es ${C.especificidad===null?"no calculable":`${(C.especificidad*100).toFixed(2)} %`}.`,I.p!==null&&I.p>=.05?`La prueba de Hosmer–Lemeshow no detecta una discrepancia significativa entre probabilidades observadas y esperadas (p = ${I.p.toFixed(4)}).`:`La prueba de Hosmer–Lemeshow sugiere revisar la calibración del modelo (p ${I.p!==null&&I.p<.001?"< 0.001":`= ${I.p?.toFixed(4)??"no disponible"}`}).`,L.some(_=>_.vif>=10)?"Se detectó multicolinealidad severa en al menos un predictor (VIF ≥ 10).":L.some(_=>_.vif>=5)?"Se detectó multicolinealidad moderada en al menos un predictor (VIF ≥ 5).":L.length?"No se detectó multicolinealidad relevante mediante el criterio VIF.":"El VIF no aplica a un modelo con un solo predictor.",R.length?`Se identificaron ${R.length} observaciones potencialmente influyentes que deben revisarse.`:"No se identificaron observaciones claramente influyentes mediante los criterios automáticos.",ge?"La clasificación perfecta junto con coeficientes extremos sugiere posible separación completa o cuasicompleta; los coeficientes pueden ser inestables.":"No se detectó el patrón automático de separación completa basado en clasificación perfecta y coeficientes extremos."];return{tipoModelo:"regresion-logistica-binaria",n:f,numeroPredictores:o.length,incluirIntercepto:t,nombresPredictores:d,nivelConfianza:n,convergencia:{convergio:b.convergio,iteraciones:b.iteraciones,posibleSeparacion:ge},distribucionRespuesta:{positivos:l,negativos:i,proporcionPositivos:l/f},coeficientes:E,ajuste:{logVerosimilitud:b.logLik,logVerosimilitudNula:x.logLik,deviance:N,devianceNula:V,aic:P,bic:D,r2McFadden:te,r2CoxSnell:Y,r2Nagelkerke:oe},pruebaGlobal:{chiCuadrado:v,gradosLibertad:y,p:h},clasificacion:C,roc:$,calibracion:I,diagnosticos:{...A,vif:L,observacionesInfluyentes:R},probabilidades:b.probabilidades,datosGrafico:u.map((_,z)=>({observacion:z+1,observado:_,probabilidad:b.probabilidades[z],clasePredicha:b.probabilidades[z]>=c?1:0,residuoPearson:A.residuosPearson[z],residuoDeviance:A.residuosDeviance[z],leverage:A.leverage[z],distanciaCook:A.distanciaCook[z],predictores:o.map(_e=>_e[z])})),interpretacion:Se}}function ox(e,a,r=e?.clasificacion?.umbral??.5){if(!e?.coeficientes?.length)throw new Error("El modelo proporcionado no es válido.");if(!Array.isArray(a)||a.length!==e.numeroPredictores)throw new Error(`Debe proporcionar ${e.numeroPredictores} valores predictores.`);if(!(r>0&&r<1))throw new Error("El umbral de clasificación debe estar entre 0 y 1.");const t=a.map(Number);if(!t.every(Number.isFinite))throw new Error("Los valores predictores deben ser numéricos.");const n=e.coeficientes.map(u=>u.estimacion),c=[...e.incluirIntercepto?[1]:[],...t],s=tt(c,n),p=Kt(s);return{predictorLineal:s,probabilidad:p,umbral:r,clasePredicha:p>=r?1:0}}function Ln(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ne(e,a=3){return e==null?"—":Number.isFinite(e)?Number(e).toLocaleString("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}):e>0?"∞":"—"}function Ba(e,a,r,t=""){return`
    ...
    `}function sx(e){const t={izquierda:62,derecha:24,superior:26,inferior:58},n=560-t.izquierda-t.derecha,c=390-t.superior-t.inferior,s=i=>t.izquierda+i*n,p=i=>t.superior+(1-i)*c,u=e.roc.puntos.map(i=>`${s(i.unoMenosEspecificidad)},${p(i.sensibilidad)}`).join(" "),l=`
        <div class="overflow-x-auto">
            <svg
                viewBox="0 0 560 390"
    ...
    `;return Ba("Curva ROC","Relaciona sensibilidad y tasa de falsos positivos para todos los umbrales posibles. La diagonal representa una clasificación sin capacidad discriminativa.",l)}function lx(e){const a=e.clasificacion,r=(n,c,s)=>`
    ...
    `;return Ba("Matriz de confusión",`Resume la clasificación con umbral ${ne(a.umbral,2)}. Los falsos positivos y falsos negativos deben interpretarse según el costo real de cada error.`,t)}function cx(e,a){const s=d=>48+d*504,l=e.datosGrafico.map((d,m)=>{const f=d.observado===1?90:210,g=(m%7-3)*5,b=d.observado===1?"text-indigo-700":"text-sky-500";return`
            <circle
                cx="${s(d.probabilidad)}"
                cy="${f+g}"
                r="5"
    ...
    `;return Ba("Probabilidades estimadas por clase","Una buena separación visual concentra los casos observados con valor 1 hacia probabilidades altas y los casos con valor 0 hacia probabilidades bajas.",o)}function dx(e){const a=e.calibracion.grupos.map(o=>({...o,proporcionObservada:o.n>0?o.observadosPositivos/o.n:0})),r=560,t=390,n={izquierda:62,derecha:24,superior:26,inferior:58},c=r-n.izquierda-n.derecha,s=t-n.superior-n.inferior,p=o=>n.izquierda+o*c,u=o=>n.superior+(1-o)*s,l=a.map(o=>`${p(o.probabilidadMedia)},${u(o.proporcionObservada)}`).join(" "),i=`
        <div class="overflow-x-auto">
    ...
    `;return Ba("Distancia de Cook","Señala observaciones con potencial influencia sobre el ajuste. El criterio 4/n es orientativo y no sustituye la revisión del caso y del diseño del estudio.",c)}function mx(e,a="Y"){return`
        <section class="mt-10">
            <p class="uppercase tracking-widest text-indigo-700 text-xs font-black mb-2">
    ...
    `}function fx(){const e=document.createElement("section");let a=null,r=null;e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
...
1, 8.5, 96`,e.elements.nivelConfianza.value="0.95",e.elements.umbral.value="0.50",e.elements.incluirIntercepto.checked=!0}function Do(e,a){e.textContent=a,e.classList.remove("hidden"),e.scrollIntoView({behavior:"smooth",block:"center"})}function Ot(e){e.textContent="",e.classList.add("hidden")}function ia(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function O(e,a=4){return e==null?"—":Number.isFinite(e)?Number(e).toLocaleString("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}):e>0?"∞":"—"}function lr(e){return e==null||!Number.isFinite(e)?"no disponible":e<.001?"< 0.001":`= ${O(e,4)}`}function Ft(e,a,r){return`
    ...
    `}function kx(e){const a=e.clasificacion;return`
        <div class="overflow-x-auto rounded-2xl border border-slate-200">
            <table class="min-w-full text-sm">
                <thead class="bg-slate-950 text-white">
                    <tr>
    ...
    `}function Ex(e){return e.diagnosticos.vif.length?`
        <div class="overflow-x-auto rounded-2xl border border-slate-200">
            <table class="min-w-full text-sm">
                <thead class="bg-slate-950 text-white">
                    <tr>
    ...
    `}function Ax(e,a){const r=e.pruebaGlobal.p!==null&&e.pruebaGlobal.p<.05;return`
        <div class="rounded-3xl bg-slate-950 text-white p-6 md:p-9 shadow-2xl">
            <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
                <div>
    ...
    `}function Ix(e,a){const r=["REGRESIÓN LOGÍSTICA BINARIA — LABORATORIO KERNEL","",`Variable dependiente: ${a.nombreDependiente} (evento = 1)`,`Predictores: ${e.nombresPredictores.join(", ")}`,`n = ${e.n}`,`χ² global = ${O(e.pruebaGlobal.chiCuadrado,4)}`,`p del modelo ${lr(e.pruebaGlobal.p)}`,`R² Nagelkerke = ${O(e.ajuste.r2Nagelkerke,4)}`,`AUC = ${O(e.roc.auc,4)}`,`Exactitud = ${O(e.clasificacion.exactitud*100,2)} %`,`Sensibilidad = ${e.clasificacion.sensibilidad===null?"no calculable":`${O(e.clasificacion.sensibilidad*100,2)} %`}`,`Especificidad = ${e.clasificacion.especificidad===null?"no calculable":`${O(e.clasificacion.especificidad*100,2)} %`}`,"","Coeficientes:"];return e.coeficientes.forEach(t=>{r.push(`${t.termino}: B = ${O(t.estimacion,6)}, OR = ${O(t.oddsRatio,5)}, z = ${O(t.z,4)}, p ${lr(t.p)}`)}),r.push("","Interpretación:"),e.interpretacion.forEach(t=>r.push(`- ${t}`)),r.push("","Diseño y desarrollo de las calculadoras: Miguel Antonio Leonardo Sepúlveda y Natanael Ureña Castillo."),r.join(`
`)}function Px(e){return`"${String(e??"").replaceAll('"','""')}"`}function Lx(e,a){const t=[["REGRESIÓN LOGÍSTICA BINARIA"],["Variable dependiente",a.nombreDependiente],["Predictores",e.nombresPredictores.join(", ")],["n",e.n],["Chi-cuadrado global",e.pruebaGlobal.chiCuadrado],["p del modelo",e.pruebaGlobal.p],["R2 McFadden",e.ajuste.r2McFadden],["R2 Cox-Snell",e.ajuste.r2CoxSnell],["R2 Nagelkerke",e.ajuste.r2Nagelkerke],["AIC",e.ajuste.aic],["BIC",e.ajuste.bic],["AUC",e.roc.auc],["Umbral",e.clasificacion.umbral],["Exactitud",e.clasificacion.exactitud],["Sensibilidad",e.clasificacion.sensibilidad],["Especificidad",e.clasificacion.especificidad],[],["Término","Coeficiente","Error estándar","z","p","Odds ratio","IC OR inferior","IC OR superior"],...e.coeficientes.map(s=>[s.termino,s.estimacion,s.errorEstandar,s.z,s.p,s.oddsRatio,s.intervaloOddsRatio.inferior,s.intervaloOddsRatio.superior]),[],["Observación","Observado","Probabilidad","Clase predicha","Residuo Pearson","Residuo deviance","Leverage","Distancia de Cook"],...e.datosGrafico.map(s=>[s.observacion,s.observado,s.probabilidad,s.clasePredicha,s.residuoPearson,s.residuoDeviance,s.leverage,s.distanciaCook]),[],["Diseño y desarrollo","Miguel Antonio Leonardo Sepúlveda y Natanael Ureña Castillo"]].map(s=>s.map(Px).join(",")).join(`
`),n=new Blob(["\uFEFF",t],{type:"text/csv;charset=utf-8"}),c=document.createElement("a");c.href=URL.createObjectURL(n),c.download="regresion-logistica-binaria-kernel.csv",c.click(),URL.revokeObjectURL(c.href)}async function Rx(e,a,r){const t=Ix(e,a),n=r.textContent;try{await navigator.clipboard.writeText(t),r.textContent="Reporte copiado"}catch{const c=document.createElement("textarea");c.value=t,document.body.appendChild(c),c.select(),document.execCommand("copy"),c.remove(),r.textContent="Reporte copiado"}window.setTimeout(()=>{r.textContent=n},1800)}async function Mx(){const e=await Go(()=>import("./CalculadoraRegresionConteo-VE7dPXsR.js"),[],import.meta.url);if(typeof e.CalculadoraRegresionConteo!="function")throw new Error("La calculadora de regresión de conteo no está disponible.");return e.CalculadoraRegresionConteo()}async function Tx(){const e=await Go(()=>import("./CalculadoraFiabilidadCuestionarios-KzGE4zyc.js"),[],import.meta.url);if(typeof e.CalculadoraFiabilidadCuestionarios!="function")throw new Error("La calculadora de cuestionarios y fiabilidad no está disponible.");return e.CalculadoraFiabilidadCuestionarios()}const Nx={home:{page:ec,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:vc,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Ac,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Mc,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:Hc,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Xc,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:md,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:od,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Ed,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Ld,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Nf,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Hf,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},comparacionGrupos:{page:ib,layout:"default",title:"Comparación de grupos y mediciones | El Kernel"},calculadoraDosGrupos:{page:vb,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:Tb,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"},calculadoraTresOMasGrupos:{page:eg,layout:"default",title:"Comparación de tres o más grupos independientes | El Kernel"},calculadoraTresOMasMedicionesRelacionadas:{page:Ig,layout:"default",title:"Comparación de tres o más mediciones relacionadas | El Kernel"},correlacionAsociacion:{page:zg,layout:"default",title:"Correlación y asociación | El Kernel"},calculadoraRelacionVariables:{page:Wg,layout:"default",title:"Relación entre variables | El Kernel"},calculadoraAsociacionCategorica:{page:g0,layout:"default",title:"Asociación entre variables categóricas | El Kernel"},calculadoraEstadisticaDescriptiva:{page:K0,layout:"default",title:"Estadística descriptiva | El Kernel"},calculadoraFiabilidadCuestionarios:{page:Tx,layout:"default",title:"Cuestionarios y fiabilidad | El Kernel"},regresionModelos:{page:lh,layout:"default",title:"Modelos de regresión | El Kernel"},calculadoraRegresion:{page:Rh,layout:"default",title:"Regresión lineal y múltiple | El Kernel"},calculadoraRegresionLogistica:{page:fx,layout:"default",title:"Regresión logística binaria | El Kernel"},calculadoraRegresionConteo:{page:Mx,layout:"default",title:"Regresión de Poisson y binomial negativa | El Kernel"}};let qo=document.referrer||"";function ht(e){window.location.hash=`/${e}`}function Sx(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";Dx(a)};window.addEventListener("hashchange",e),e()}function _x(e,a){const r=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:r,page_referrer:qo}),qo=r}function zx(e){const a=document.createElement("section");a.className=`
    ...
    `;const r=a.querySelector("[data-mensaje-error-ruta]");return r&&(r.textContent=e instanceof Error?e.message:"Se produjo un error inesperado."),a.querySelector("[data-action='reintentar-ruta']")?.addEventListener("click",()=>{window.location.reload()}),a.querySelector("[data-action='volver-laboratorio']")?.addEventListener("click",()=>{ht("laboratorioKernel")}),a}async function Dx(e){const a=document.querySelector("main"),r=Nx[e];if(a){if(a.innerHTML="",!r){ht("home");return}Ic(r.layout),document.title=r.title;try{const t=await r.page();if(!(t instanceof Element))throw new Error("La herramienta no devolvió un componente válido.");a.appendChild(t),window.scrollTo({top:0,behavior:"auto"}),_x(e,r.title)}catch(t){console.error(`[Kernel] Error al cargar la ruta ${e}.`,t),a.appendChild(zx(t))}}}function qx(e,a){Ho(e,ht),Sx();const r=window.matchMedia("(max-width: 768px)");let t=!1;function n(s){s.matches&&!t&&(ii(e),t=!0)}r.addEventListener("change",n),n(r),ii(e);const c=a.querySelector('[data-action ="open-menu"]');zl(c,e),Dl(e)}function Ox(e){const a=String(e??"").replace(/\u00a0/g,"").replace(/\s/g,"").replace(/[^0-9+\-.,eE]/g,"");if(!a)return null;const r=a.lastIndexOf(","),t=a.lastIndexOf(".");let n=a;r>=0&&t>=0?n=t>r?a.replace(/,/g,""):a.replace(/\./g,"").replace(",","."):r>=0&&(n=a.length-r-1===3&&r>0?a.replace(/,/g,""):a.replace(",","."));const c=Number(n);return Number.isFinite(c)?c:null}function Fx(e){const a=e.querySelector("table");if(!a)return null;const t=[...a.querySelectorAll("thead th")].map(c=>c.textContent.trim().toLowerCase()).some(c=>c.includes("marca")),n=[...a.querySelectorAll("tbody tr")].map(c=>{const s=[...c.querySelectorAll("td")],p=Number(s[t?2:1]?.textContent.trim()),u=Number(s[t?4:3]?.textContent.trim());return{etiqueta:s[0]?.textContent.trim()||"",valor:Ox(s[t?1:0]?.textContent),frecuencia:Number.isFinite(p)?p:0,acumulada:Number.isFinite(u)?u:0}}).filter(c=>c.etiqueta&&c.frecuencia>=0);return{agrupados:t,filas:n}}function Tl(e){return Number.isFinite(Number(e))?Number(e).toLocaleString("es-DO",{maximumFractionDigits:3}):"—"}function Oo(e,a){let r=0;for(const t of e)if(r+=t.frecuencia,a<r)return t.valor;return e.at(-1)?.valor??null}function pn(e,a){const r=e.reduce((u,l)=>u+l.frecuencia,0);if(!r)return null;if(a<=0)return e[0].valor;if(a>=1)return e.at(-1).valor;const t=(r-1)*a,n=Math.floor(t),c=Math.ceil(t),s=Oo(e,n),p=Oo(e,c);return n===c?s:s*(c-t)+p*(t-n)}function Ja(e,a,r){return`
        <text
            x="${e}"
            y="${a}"
            text-anchor="middle"
        ...
        >${Tl(r)}</text>
    `}function Ux(e,a){if(!e||e.dataset.cajaDescriptivaSegura==="true"||a.agrupados)return;e.dataset.cajaDescriptivaSegura="true";const r=a.filas.filter(h=>h.valor!==null&&h.frecuencia>0).sort((h,w)=>h.valor-w.valor);if(r.reduce((h,w)=>h+w.frecuencia,0)<2)return;const n=r[0].valor,c=r.at(-1).valor,s=pn(r,.25),p=pn(r,.5),u=pn(r,.75),l=u-s,i=s-1.5*l,o=u+1.5*l,d=r.filter(h=>h.valor>=i&&h.valor<=o),m=r.filter(h=>h.valor<i||h.valor>o),f=d[0]?.valor??n,g=d.at(-1)?.valor??c,b=Math.max(c-n,1),x=h=>40+(h-n)/b*520,y=e.querySelector("svg");if(!y)return;y.setAttribute("aria-label","Diagrama de caja con cuartiles, mediana, bigotes y valores atípicos potenciales"),y.innerHTML=`
        ...
        ${Ja(x(u),30,u)}
        ${Ja(x(g),140,g)}
    `;const v=e.querySelector("h3 + p");v&&(v.textContent="Los bigotes terminan en los valores extremos no atípicos. Los puntos rojos representan valores atípicos potenciales según el criterio de Tukey.")}function jx(){const e=document.createElement("section");return e.dataset.encabezadoGraficosSeguro="true",e.className="mt-10",e.innerHTML=`
        <p class="uppercase tracking-widest text-sky-700 text-xs font-black mb-2">
            Visualización estadística
        </p>
    ...
    `,e}function Vx(e){const a=document.createElement("article");a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const r=Math.max(...e.map(t=>t.frecuencia),1);return a.innerHTML=`
    ...
    `,a}function Gx(e){const a=[...e.querySelectorAll("article")],r=a.find(s=>s.querySelector("h3")?.textContent.includes("Distribución de frecuencias")),t=a.find(s=>s.querySelector("h3")?.textContent.includes("Diagrama de caja"));if(!r||!t)return;const n=r.parentElement,c=Fx(e);if(!(!n||!c?.filas.length)&&(e.querySelector("[data-encabezado-graficos-seguro='true']")||(n.before(jx()),n.classList.remove("mt-8")),Ux(t,c),!e.querySelector("[data-graficos-descriptivos-seguros='true']"))){const s=document.createElement("div");s.dataset.graficosDescriptivosSeguros="true",s.className="grid grid-cols-1 xl:grid-cols-2 gap-7 mt-7",s.append(Vx(c.filas),Bx(c.filas)),n.after(s)}}function Hx(){let e=!1;const a=()=>{e=!1;const n=document.querySelector("#resultados-estadistica-descriptiva");n&&!n.classList.contains("hidden")&&Gx(n)},r=()=>{e||(e=!0,window.requestAnimationFrame(a))};new MutationObserver(r).observe(document.body,{childList:!0,subtree:!0}),r()}function Wx(e,a){return`${e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||`grafico-${a+1}`}.svg`}function Kx(e,a,r){const t=e.cloneNode(!0);t.getAttribute("xmlns")||t.setAttribute("xmlns","http://www.w3.org/2000/svg");const c=new XMLSerializer().serializeToString(t),s=new Blob([c],{type:"image/svg+xml;charset=utf-8"}),p=URL.createObjectURL(s),u=document.createElement("a");u.href=p,u.download=Wx(a,r),document.body.appendChild(u),u.click(),u.remove(),setTimeout(()=>URL.revokeObjectURL(p),1e3)}function Yx(e,a,r){if(e.querySelector("[data-descargar-svg]"))return;const t=e.querySelector("h3")?.textContent.trim()||`Gráfico ${r+1}`,n=document.createElement("button");n.type="button",n.dataset.descargarSvg="true",n.className=`
    ...
    `,n.innerHTML=`
        <span aria-hidden="true">↓</span>
        Descargar SVG
    `,n.setAttribute("aria-label",`Descargar ${t} en formato SVG`),n.addEventListener("click",()=>{Kx(a,t,r)}),e.appendChild(n)}function Jx(e){const a=window.open("","_blank");if(!a){window.print();return}const r=`
        <style>
    ...
    `),a.document.close(),a.addEventListener("load",()=>{a.focus(),a.print()})}function Qx(e){if(e.querySelector("[data-herramientas-exportacion='true']"))return;const a=document.createElement("section");a.dataset.herramientasExportacion="true",a.className=`
    ...
    `,a.querySelector("[data-imprimir-informe]")?.addEventListener("click",()=>{Jx(e)}),e.prepend(a)}function Xx(e){Qx(e),[...e.querySelectorAll("article")].forEach((r,t)=>{const n=r.querySelector("svg");n&&Yx(r,n,t)})}function Zx(){const e=()=>{const r=document.querySelector("#resultados-estadistica-descriptiva");r&&!r.classList.contains("hidden")&&Xx(r)};new MutationObserver(e).observe(document.body,{childList:!0,subtree:!0}),e()}const ev=["#formulario-estadistica-descriptiva","#formulario-regresion","#formulario-regresion-conteo","[id*='calculadora'] form","section form"].join(",");function av(){return document.querySelector("main h1, #app h1, h1")?.textContent?.trim()?.toLowerCase()||""}function tv(){return av().includes("laboratorio inteligente de investigación")}function rv(){const e=document.querySelector("main h1, #app h1, h1"),a=document.querySelector("[data-action='volver-laboratorio'], [data-action='volver-modelos'], [data-action='volver-regresion']"),r=document.querySelector(ev);return!!(e&&a&&r)}function nv(){const e=document.createElement("section");return e.dataset.creditosCalculadoras="true",e.className=["w-full max-w-7xl mx-auto","px-4 pb-10 md:px-8","font-sans"].join(" "),e.innerHTML=`
    ...
    `,e}function Fo(){if(!rv()&&!tv()||document.querySelector("[data-creditos-calculadoras='true']"))return;const e=document.querySelector("main, #app, [data-router-view]");e&&e.appendChild(nv())}function iv(){new MutationObserver(Fo).observe(document.body,{childList:!0,subtree:!0}),Fo()}function ov(){return[...document.querySelectorAll("main h1")].find(a=>a.textContent.trim().toLowerCase().includes("laboratorio inteligente de investigación"))&&[...document.querySelectorAll("main article")].find(a=>a.querySelector("h3")?.textContent?.trim()?.toLowerCase()==="regresión")||null}function Uo(){const e=ov();if(!e||e.dataset.regresionConectada==="true")return;const a=e.querySelector("h3 + p"),r=e.querySelector("button");a&&(a.textContent="Regresión lineal simple y múltiple, y regresión logística binaria, con inferencia, diagnósticos gráficos, predicción e interpretación guiada."),r&&(r.onclick=()=>{window.location.hash="/regresionModelos"},r.setAttribute("aria-label","Explorar los modelos de regresión")),e.dataset.regresionConectada="true"}function sv(){new MutationObserver(Uo).observe(document.body,{childList:!0,subtree:!0}),Uo()}const lv={"regresión lineal simple":{ruta:"calculadoraRegresion",tipo:"simple",almacenamiento:"kernel-tipo-modelo-regresion",clase:"rose",texto:"Abra la calculadora de regresión lineal y cargue una variable dependiente cuantitativa y un predictor."},"regresión lineal múltiple":{ruta:"calculadoraRegresion",tipo:"multiple",almacenamiento:"kernel-tipo-modelo-regresion",clase:"rose",texto:"Abra la calculadora de regresión lineal y cargue una variable dependiente cuantitativa y dos o más predictores."},"regresión logística binaria simple":{ruta:"calculadoraRegresionLogistica",tipo:"simple",almacenamiento:"kernel-tipo-modelo-regresion",clase:"rose",texto:"Abra la calculadora logística y cargue una variable dependiente codificada 0/1 y un predictor."},"regresión logística binaria múltiple":{ruta:"calculadoraRegresionLogistica",tipo:"multiple",almacenamiento:"kernel-tipo-modelo-regresion",clase:"rose",texto:"Abra la calculadora logística y cargue una variable dependiente codificada 0/1 y dos o más predictores."},"regresión de poisson":{ruta:"calculadoraRegresionConteo",tipo:"poisson",almacenamiento:"kernel-modelo-conteo",clase:"amber",texto:"Abra la calculadora de conteo y ajuste un modelo de Poisson con una variable dependiente formada por enteros no negativos."},"regresión binomial negativa":{ruta:"calculadoraRegresionConteo",tipo:"negativa",almacenamiento:"kernel-modelo-conteo",clase:"amber",texto:"Abra la calculadora de conteo y ajuste un modelo binomial negativo cuando exista sobredispersión respecto a Poisson."}};function cv(){const e=[...document.querySelectorAll("main h1")];for(const a of e){const r=a.textContent.trim().toLowerCase(),t=lv[r];if(t)return{encabezado:a,modelo:t}}return null}function dv(e){const a=document.createElement("div"),r=e.clase==="amber",t=r?"border-amber-200":"border-rose-200",n=r?"bg-amber-50":"bg-rose-50",c=r?"text-amber-700":"text-rose-700",s=r?"bg-amber-600 hover:bg-amber-700":"bg-rose-700 hover:bg-rose-800";return a.dataset.ejecutarModeloRegresion="true",a.className=`mt-8 rounded-2xl border ${t} ${n} p-6`,a.innerHTML=`
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            <div>
    ...
    `,a.querySelector("button")?.addEventListener("click",p=>{const u=p.currentTarget,l=u.dataset.almacenamientoRegresion||"kernel-tipo-modelo-regresion";sessionStorage.setItem(l,u.dataset.tipoRegresion||""),window.location.hash=`/${u.dataset.routeRegresion}`}),a}function jo(){const e=cv();if(!e)return;const a=e.encabezado.closest("section");if(!a||a.querySelector("[data-ejecutar-modelo-regresion='true']"))return;(a.querySelector("header + div")||a).appendChild(dv(e.modelo))}function uv(){new MutationObserver(jo).observe(document.body,{childList:!0,subtree:!0}),jo()}function pv(){return[...document.querySelectorAll("main h1")].find(a=>a.textContent.trim().toLowerCase().includes("laboratorio inteligente de investigación"))&&[...document.querySelectorAll("main article")].find(a=>a.querySelector("h3")?.textContent?.trim()?.toLowerCase()==="cuestionarios y fiabilidad")||null}function Vo(){const e=pv();if(!e||e.dataset.fiabilidadConectada==="true")return;const a=e.querySelector("h3 + p"),r=e.querySelector("button");a&&(a.textContent="Alfa de Cronbach, alfa estandarizado, omega aproximado, análisis de ítems, recodificación y gráficos diagnósticos."),r&&(r.onclick=()=>{window.location.hash="/calculadoraFiabilidadCuestionarios"},r.setAttribute("aria-label","Abrir la calculadora de cuestionarios y fiabilidad")),e.dataset.fiabilidadConectada="true"}function mv(){new MutationObserver(Vo).observe(document.body,{childList:!0,subtree:!0}),Vo()}function va(e,a){try{a()}catch(r){console.error(`[Kernel] No fue posible iniciar ${e}.`,r)}}const cr=document.querySelector("#header"),dr=document.querySelector("#navBar"),Bo=document.querySelector("#footer");cr&&(cr.innerHTML=Nl());dr&&(dr.innerHTML=Sl());Bo&&(Bo.innerHTML=_l());va("la navegación",()=>{dr&&cr&&qx(dr,cr)});va("los gráficos de estadística descriptiva",Hx);va("la exportación de estadística descriptiva",Zx);va("los créditos de las calculadoras",iv);va("la integración del área de regresión",sv);va("la integración de regresión con el asistente",uv);va("la integración de cuestionarios y fiabilidad",mv);
