import{j as F,a as H}from"./jstat-DiDocX-r.js";import{p as W}from"./exportacionesCalculadoras-C-2g2EIK.js";import"./index-D9akd3km.js";const k=F.jStat??H?.jStat;if(!k)throw new Error("No fue posible cargar el motor estadístico jStat.");function q(e){return Math.min(1,Math.max(0,e))}function B(e){if(!Number.isFinite(e)||e<=0||e>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function A(e){return typeof e=="string"&&e.trim()===""?Number.NaN:Number(typeof e=="string"?e.trim().replace(",","."):e)}function y(e,t){if(!Array.isArray(e))throw new TypeError(`${t} debe ser un arreglo de valores.`);const o=e.map(A),a=o.findIndex(i=>!Number.isFinite(i));if(a!==-1)throw new TypeError(`${t} contiene un valor no numérico en la posición ${a+1}.`);if(o.length<2)throw new RangeError(`${t} debe contener al menos dos observaciones.`);return o}function Z(e){return e.reduce((t,o)=>t+o,0)/e.length}function K(e){const t=[...e].sort((a,i)=>a-i),o=Math.floor(t.length/2);return t.length%2!==0?t[o]:(t[o-1]+t[o])/2}function O(e,t){return e.reduce((a,i)=>a+(i-t)**2,0)/(e.length-1)}function E(e){const t=y(e,"La muestra"),o=Z(t),a=O(t,o);return{n:t.length,media:o,mediana:K(t),varianza:a,desviacionEstandar:Math.sqrt(a),minimo:Math.min(...t),maximo:Math.max(...t)}}function P(e,t){return q(2*(1-k.studentt.cdf(Math.abs(e),t)))}function T(e,t,o,a){B(a);const i=1-a,r=k.studentt.inv(1-i/2,o),n=r*t;return{nivel:a,valorCritico:r,inferior:e-n,superior:e+n}}function G(e,t,o,a,i){const r=a+i-2,n=((a-1)*t+(i-1)*o)/r,s=Math.sqrt(n);if(s===0)return{dCohen:0,gHedges:0,correccionHedges:1};const u=e/s,f=1-3/(4*r-1);return{dCohen:u,gHedges:f*u,correccionHedges:f}}function _(e,t,o={}){const{nivelConfianza:a=.95}=o,i=y(e,"El grupo 1"),r=y(t,"El grupo 2"),n=E(i),s=E(r),u=n.n+s.n-2,f=((n.n-1)*n.varianza+(s.n-1)*s.varianza)/u,p=Math.sqrt(f*(1/n.n+1/s.n));if(p===0)throw new Error("No puede calcularse la prueba porque ambos grupos carecen de variabilidad.");const c=n.media-s.media,m=c/p,b=P(m,u);return{id:"t-student-independientes",nombre:"t de Student para muestras independientes",metodo:"Varianzas combinadas",grupo1:n,grupo2:s,diferenciaMedias:c,errorEstandar:p,varianzaCombinada:f,estadistico:{simbolo:"t",valor:m},gradosLibertad:u,valorP:b,intervaloConfianza:T(c,p,u,a),tamanioEfecto:G(c,n.varianza,s.varianza,n.n,s.n)}}function J(e,t,o={}){const{nivelConfianza:a=.95}=o,i=y(e,"El grupo 1"),r=y(t,"El grupo 2"),n=E(i),s=E(r),u=n.varianza/n.n,f=s.varianza/s.n,p=u+f,c=Math.sqrt(p);if(c===0)throw new Error("No puede calcularse la prueba porque ambos grupos carecen de variabilidad.");const m=p**2,b=u**2/(n.n-1)+f**2/(s.n-1),x=m/b,g=n.media-s.media,v=g/c,h=P(v,x);return{id:"t-welch-independientes",nombre:"t de Welch para muestras independientes",metodo:"Varianzas no combinadas",grupo1:n,grupo2:s,diferenciaMedias:g,errorEstandar:c,estadistico:{simbolo:"t",valor:v},gradosLibertad:x,valorP:h,intervaloConfianza:T(g,c,x,a),tamanioEfecto:G(g,n.varianza,s.varianza,n.n,s.n)}}function Q(e,t){const o=[...e.map(r=>({valor:r,grupo:1,rango:0})),...t.map(r=>({valor:r,grupo:2,rango:0}))].sort((r,n)=>r.valor-n.valor);let a=0,i=0;for(;a<o.length;){let r=a+1;for(;r<o.length&&o[r].valor===o[a].valor;)r+=1;const n=r-a,s=(a+1+r)/2;for(let u=a;u<r;u+=1)o[u].rango=s;n>1&&(i+=n**3-n),a=r}return{observaciones:o,correccionEmpates:i}}function X(e,t){const o=y(e,"El grupo 1"),a=y(t,"El grupo 2"),i=E(o),r=E(a),{observaciones:n,correccionEmpates:s}=Q(o,a),u=n.filter(({grupo:w})=>w===1).reduce((w,C)=>w+C.rango,0),f=n.filter(({grupo:w})=>w===2).reduce((w,C)=>w+C.rango,0),p=i.n,c=r.n,m=p+c,b=u-p*(p+1)/2,x=f-c*(c+1)/2,g=Math.min(b,x),v=p*c/2,h=p*c/12*(m+1-s/(m*(m-1)));if(h<=0)throw new Error("No puede calcularse Mann–Whitney porque todos los valores son idénticos.");const R=Math.sqrt(h),z=b-v,V=z===0?0:Math.sign(z)*.5,M=(z-V)/R,U=q(2*(1-k.normal.cdf(Math.abs(M),0,1))),N=2*b/(p*c)-1;return{id:"mann-whitney",nombre:"Prueba U de Mann–Whitney",metodoValorP:"Aproximación normal bilateral con corrección por continuidad y empates",grupo1:i,grupo2:r,sumaRangos1:u,sumaRangos2:f,estadistico:{simbolo:"U",valor:g,u1:b,u2:x},estadisticoZ:M,valorP:U,correccionEmpates:s,tamanioEfecto:{deltaCliff:N,correlacionBiserialRangos:N,r:M/Math.sqrt(m)}}}function Y({grupo1:e,grupo2:t,prueba:o,nivelConfianza:a=.95}){switch(o){case"student":return _(e,t,{nivelConfianza:a});case"welch":return J(e,t,{nivelConfianza:a});case"mann-whitney":return X(e,t);default:throw new Error("La prueba solicitada no está disponible.")}}function ie(){const e=document.createElement("section");e.className=`
...
14.5`,p(),j(o),a.classList.add("hidden");return}b==="limpiar"&&(t.reset(),n.value="",s.value="",p(),j(o),a.innerHTML="",a.classList.add("hidden"))}),e}function L(e,t){const o=e.trim();if(!o)throw new Error(`${t} no contiene datos.`);const a=o.split(/[\s;]+/).filter(Boolean),i=a.map(n=>Number(n.replace(",","."))),r=i.findIndex(n=>!Number.isFinite(n));if(r!==-1)throw new Error(`${t} contiene un valor no válido: "${a[r]}".`);if(i.length<2)throw new Error(`${t} debe contener al menos dos observaciones.`);return i}function S(e){return e.trim()?e.trim().split(/[\s;]+/).filter(Boolean).length:0}function D(e){return e===1?"1 valor":`${e} valores`}function ee(e,t){e.textContent=t,e.classList.remove("hidden")}function j(e){e.textContent="",e.classList.add("hidden")}function l(e,t=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:t}).format(e):"—"}function te(e){return Number.isFinite(e)?e<.001?"< 0.001":l(e,4):"—"}function ae(e,t=.95){const o=1-t,a=e.valorP<o,i=o.toFixed(2),r=Math.round(t*100),n=a?`Se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${i}, correspondiente a un nivel de confianza del ${r} %.`:`No se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${i}, correspondiente a un nivel de confianza del ${r} %.`;return`
    ...
    `}function oe(e){if(e.id==="mann-whitney")return`
    ...
    `}export{ie as CalculadoraDosGrupos};
