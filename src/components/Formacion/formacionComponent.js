...
export function formacionComponent() {
    ...
    const render = () => {
        ...
        const atributosModal = window.innerWidth < 768 && isModalOpen
            ? 'role="dialog" aria-modal="true" aria-labelledby="titulo-detalle-formacion"'
            : "";
