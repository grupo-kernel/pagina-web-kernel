...
>
    ...
    `}function gr(t,e){t.addEventListener("click",n=>{const a=n.target.closest(["[data-route]"]);a&&(n.preventDefault(),e(a.dataset.route))})}function eo(t){gr(t,la)}const br=""+new URL("apec-ConmXkrT.png",import.meta.url).href,to=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,ao=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,dn=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
  ...
  `;const n=e.querySelector("#kernel-login"),a=e.querySelector("#login-error"),i=e.querySelector("#correo"),u=e.querySelector("#password"),d=n.querySelector('button[type="submit"]');return n.addEventListener("submit",async f=>{f.preventDefault(),a.classList.add("hidden"),a.textContent="";const m=i.value.trim(),l=u.value;if(!m||!l){a.textContent="Introduzca el correo electrónico y la contraseña.",a.classList.remove("hidden");return}d.disabled=!0,d.textContent="Verificando...";try{await Mu(m,l),t&&await t()}catch(r){console.error("Error de autenticación:",r);const o={"auth/invalid-email":"El correo electrónico no tiene un formato válido.","auth/invalid-credential":"El correo o la contraseña son incorrectos.","auth/user-not-found":"El correo no está autorizado.","auth/wrong-password":"El correo o la contraseña son incorrectos.","auth/user-disabled":"Este usuario está deshabilitado.","auth/too-many-requests":"Demasiados intentos. Espere unos minutos e inténtelo nuevamente.","auth/network-request-failed":"No fue posible conectarse con Firebase. Revise su conexión.","auth/unauthorized-domain":"El dominio de Grupo Kernel no está autorizado en Firebase."};a.textContent=o[r.code]||`No fue posible iniciar sesión. Error: ${r.code||"desconocido"}`,a.classList.remove("hidden")}finally{d.disabled=!1,d.textContent="Iniciar sesión"}}),e}function Bu(){return new Promise(t=>{const e=qu(n=>{e(),t(n)})})}async function Vu(){if(!await Bu())return Uu(()=>{window.dispatchEvent(new HashChangeEvent("hashchange"))});const e=document.createElement("section");return e.className=`
    ...
    `,e.innerHTML=`
        ...
        <section class="
            ...
            gap-6 mt-10
        ">
            ${va("Aprender","Comprenda qué mide cada estadístico, cuándo debe utilizarse, cuáles son sus supuestos y cómo se interpreta correctamente.","libro","bg-sky-100","text-sky-700","border-sky-200")}

            ${va("Decidir","Identifique la prueba adecuada según el objetivo, el tipo de variable, el número de grupos y el diseño de su investigación.","decision","bg-amber-100","text-amber-700","border-amber-200")}

            ${va("Analizar","Introduzca sus datos, ejecute el análisis, interprete los resultados y genere reportes metodológicamente adecuados.","analisis","bg-emerald-100","text-emerald-700","border-emerald-200")}
        </section>
    ...
    `,e.querySelector("#cerrar-sesion-kernel")?.addEventListener("click",async()=>{await Fu(),window.location.reload()}),e}function va(t,e,n,a,i,u){return`
        <article class="
            h-full bg-white
            border border-slate-200
            rounded-3xl p-7
    ...
    `}function up(){const t=document.createElement("section");return t.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,t.innerHTML=`
    ...
    `,t.addEventListener("click",e=>{const n=e.target.closest("[data-route], [data-action]");if(!n)return;if(n.dataset.action==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}const a=n.dataset.route;a&&(window.location.hash=`/${a}`)}),t}function Aa({etiqueta:t,titulo:e,descripcion:n,pruebas:a,ruta:i,textoBoton:u,clases:d}){return`
...
14.5`,r(),Ca(n),a.classList.add("hidden");return}c==="limpiar"&&(e.reset(),d.value="",f.value="",r(),Ca(n),a.innerHTML="",a.classList.add("hidden"))}),t}function Xn(t,e){const n=t.trim();if(!n)throw new Error(`${e} no contiene datos.`);const a=n.split(/[\s;]+/).filter(Boolean),i=a.map(d=>Number(d.replace(",","."))),u=i.findIndex(d=>!Number.isFinite(d));if(u!==-1)throw new Error(`${e} contiene un valor no válido: "${a[u]}".`);if(i.length<2)throw new Error(`${e} debe contener al menos dos observaciones.`);return i}function er(t){return t.trim()?t.trim().split(/[\s;]+/).filter(Boolean).length:0}function tr(t){return t===1?"1 valor":`${t} valores`}function Ip(t,e){t.textContent=e,t.classList.remove("hidden")}function Ca(t){t.textContent="",t.classList.add("hidden")}function M(t,e=4){return Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):"—"}function Pp(t){return Number.isFinite(t)?t<.001?"< 0.001":M(t,4):"—"}function _p(t,e=.95){const n=1-e,a=t.valorP<n,i=n.toFixed(2),u=Math.round(e*100),d=a?`Se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %.`:`No se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %.`;return`
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ${Tt(t.estadistico.simbolo,M(t.estadistico.valor),"Estadístico")}

                    ${Tt("p",Pp(t.valorP),"Valor bilateral")}

                    ${Tt("n₁",t.grupo1.n,"Grupo 1")}

                    ${Tt("n₂",t.grupo2.n,"Grupo 2")}
                </div>
    ...
    `}function Tp(t){if(t.id==="mann-whitney")return`
...
17`,l(),Pa(n),a.classList.add("hidden");return}s==="limpiar"&&(e.reset(),i.value="",u.value="",l(),Pa(n),a.innerHTML="",a.classList.add("hidden"))}),t}function Ia(t,e){return`
    ...
    `}function or(t,e){const n=t.trim();if(!n)throw new Error(`${e} no contiene datos.`);const a=n.split(/[\s;]+/).filter(Boolean),i=a.map(d=>Number(d.replace(",","."))),u=i.findIndex(d=>!Number.isFinite(d));if(u!==-1)throw new Error(`${e} contiene un valor no válido: "${a[u]}".`);if(i.length<2)throw new Error(`${e} debe contener al menos dos observaciones.`);return i}function sr(t){return t.trim()?t.trim().split(/[\s;]+/).filter(Boolean).length:0}function lr(t){return t===1?"1 valor":`${t} valores`}function Fp(t,e){t.textContent=e,t.classList.remove("hidden")}function Pa(t){t.textContent="",t.classList.add("hidden")}function D(t,e=4){return Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):"—"}function qp(t){return Number.isFinite(t)?t<.001?"< 0.001":D(t,4):"—"}function Up(t,e=.95){const n=1-e,a=t.valorP<n,i=n.toFixed(2),u=Math.round(e*100),d=t.id==="t-student-relacionadas"?t.diferenciaMedia:t.diferencias.mediana,f=Bp(d),m=a?`Se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %. ${f}`:`No se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %. ${f}`;return`
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ${Lt(t.estadistico.simbolo,D(t.estadistico.valor),"Estadístico")}
                    ${Lt("p",qp(t.valorP),"Valor bilateral")}
                    ${Lt("n",t.nParejas,"Parejas originales")}
                    ${Lt("Δ",D(d),t.id==="t-student-relacionadas"?"Diferencia media":"Diferencia mediana")}
                </div>
    ...
    `}function Bp(t){return Number.isFinite(t)?t>0?"La dirección estimada favorece valores mayores en la medición 1.":t<0?"La dirección estimada favorece valores mayores en la medición 2.":"La diferencia central estimada es igual a cero.":""}function Lt(t,e,n){return`
        <article class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
    ...
    `}function Gp(t){if(t.id==="wilcoxon-relacionadas")return`
    ...
    `}const De=wt.jStat??ra?.jStat;if(!De)throw new Error("No fue posible cargar el motor estadístico jStat.");const sa=t=>Math.min(1,Math.max(0,t));function an(t){if(!Number.isFinite(t)||t<=0||t>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function Hp(t){return typeof t=="string"?t.trim()===""?Number.NaN:Number(t.trim().replace(",",".")):Number(t)}const Ti=t=>t.reduce((e,n)=>e+n,0)/t.length;function Wp(t){const e=[...t].sort((a,i)=>a-i),n=Math.floor(e.length/2);return e.length%2?e[n]:(e[n-1]+e[n])/2}function Kp(t,e=Ti(t)){return t.reduce((n,a)=>n+(a-e)**2,0)/(t.length-1)}function jp(t){const e=Ti(t),n=Kp(t,e);return{n:t.length,media:e,mediana:Wp(t),varianza:n,desviacionEstandar:Math.sqrt(n),minimo:Math.min(...t),maximo:Math.max(...t)}}function Jp(t,e){const n=Array.isArray(t),a=n?t:t?.valores;if(!Array.isArray(a))throw new TypeError(`El grupo ${e+1} debe contener un arreglo llamado valores.`);const i=a.map(Hp),u=i.findIndex(f=>!Number.isFinite(f));if(u!==-1)throw new TypeError(`El grupo ${e+1} contiene un valor no numérico en la posición ${u+1}.`);if(i.length<2)throw new RangeError(`El grupo ${e+1} debe contener al menos dos observaciones.`);return{nombre:(n?"":String(t?.nombre??"").trim())||`Grupo ${e+1}`,valores:i,...jp(i)}}function nn(t){if(!Array.isArray(t))throw new TypeError("Los grupos deben proporcionarse mediante un arreglo.");if(t.length<3)throw new RangeError("El análisis requiere al menos tres grupos independientes.");const e=t.map(Jp),n=e.map(({nombre:a})=>a);if(new Set(n).size!==n.length)throw new Error("Cada grupo debe tener un nombre diferente.");return e}function rn(t){const e=t.reduce((a,i)=>a+i.n,0),n=t.reduce((a,i)=>a+i.valores.reduce((u,d)=>u+d,0),0);return{numeroGrupos:t.length,nTotal:e,mediaGeneral:n/e}}function Li(t,e,n){return t===1/0?0:sa(1-De.centralF.cdf(t,e,n))}function Qp(t,e){return sa(1-De.chisquare.cdf(t,e))}function $i(){if(!De.tukey?.cdf||!De.tukey?.inv)throw new Error("La distribución de Tukey no está disponible en la versión instalada de jStat.")}function Ri(t,e,n){return $i(),t===1/0?0:sa(1-De.tukey.cdf(t,e,n))}function Di(t,e,n){return $i(),De.tukey.inv(t,e,n)}function on(t){const e=Math.abs(t);return e<.01?"Prácticamente nulo":e<.06?"Pequeño":e<.14?"Moderado":"Grande"}function sn(t,e){const n=[];for(let a=0;a<t.length-1;a+=1)for(let i=a+1;i<t.length;i+=1)n.push(e(t[a],t[i],a,i));return n}function Yp(t,e,n,a){const i=1-a,u=t.length,d=Di(a,u,n);return{id:"tukey-kramer",nombre:"Comparaciones de Tukey–Kramer",metodo:"Rango studentizado con control del error familiar.",recomendado:!1,comparaciones:sn(t,(f,m)=>{const l=f.media-m.media,r=Math.sqrt(e/2*(1/f.n+1/m.n)),o=r===0?l===0?0:1/0:Math.abs(l)/r,s=Ri(o,u,n),c=d*r;return{grupo1:f.nombre,grupo2:m.nombre,diferenciaMedias:l,errorEstandar:r,estadisticoQ:o,gradosLibertad:n,valorP:s,valorPAjustado:s,intervaloConfianza:{nivel:a,inferior:l-c,superior:l+c,margen:c},significativo:s<i}})}}function Zp(t,e){const n=1-e,a=t.length;return{id:"games-howell",nombre:"Comparaciones de Games–Howell",metodo:"Comparaciones pareadas robustas ante varianzas y tamaños desiguales.",recomendado:!1,comparaciones:sn(t,(i,u)=>{const d=i.media-u.media,f=i.varianza/i.n,m=u.varianza/u.n,l=f+m,r=Math.sqrt(l/2),o=l**2/(f**2/(i.n-1)+m**2/(u.n-1)),s=r===0?d===0?0:1/0:Math.abs(d)/r,c=Ri(s,a,o),p=Di(e,a,o)*r;return{grupo1:i.nombre,grupo2:u.nombre,diferenciaMedias:d,errorEstandar:r,estadisticoQ:s,gradosLibertad:o,valorP:c,valorPAjustado:c,intervaloConfianza:{nivel:e,inferior:d-p,superior:d+p,margen:p},significativo:c<n}})}}function Xp(t){const e=t.map(u=>({...u,rango:0})).sort((u,d)=>u.valor-d.valor);let n=0,a=0,i=0;for(;n<e.length;){let u=n+1;for(;u<e.length&&e[u].valor===e[n].valor;)u+=1;const d=u-n,f=(n+1+u)/2;for(let m=n;m<u;m+=1)e[m].rango=f;d>1&&(i+=1,a+=d**3-d),n=u}return{observaciones:e,sumaCorreccionEmpates:a,cantidadGruposEmpatados:i}}function em(t){const e=t.map((a,i)=>({...a,indiceOriginal:i})).sort((a,i)=>a.valorP-i.valorP);let n=0;return e.forEach((a,i)=>{const u=Math.min(1,a.valorP*(e.length-i));a.valorPAjustado=Math.max(n,u),n=a.valorPAjustado}),e.sort((a,i)=>a.indiceOriginal-i.indiceOriginal).map(({indiceOriginal:a,...i})=>i)}function tm(t,e,n,a,i){const u=1-i,d=n*(n+1)/12-a/(12*(n-1)),f=sn(t,(m,l,r,o)=>{const s=e[r]/m.n,c=e[o]/l.n,p=s-c,g=Math.sqrt(d*(1/m.n+1/l.n)),b=g===0?0:p/g,x=sa(2*(1-De.normal.cdf(Math.abs(b),0,1)));return{grupo1:m.nombre,grupo2:l.nombre,rangoMedio1:s,rangoMedio2:c,diferenciaRangos:p,errorEstandar:g,estadisticoZ:b,valorP:x,tamanioEfectoR:b/Math.sqrt(n)}});return{id:"dunn-holm",nombre:"Comparaciones de Dunn con ajuste de Holm",metodo:"Comparaciones de rangos con corrección secuencial de Holm.",recomendado:!1,comparaciones:em(f).map(m=>({...m,significativo:m.valorPAjustado<u}))}}function am(t,e={}){const{nivelConfianza:n=.95}=e;an(n);const a=nn(t),i=rn(a),u=a.reduce((v,w)=>v+w.n*(w.media-i.mediaGeneral)**2,0),d=a.reduce((v,w)=>v+w.valores.reduce((E,k)=>E+(k-w.media)**2,0),0),f=u+d,m=a.length-1,l=i.nTotal-a.length,r=u/m,o=d/l,s=o===0?r===0?0:1/0:r/o,c=Li(s,m,l),p=f===0?0:u/f,g=f+o===0?0:(u-m*o)/(f+o),b=Math.max(0,g),x=1-n,y=c<x,h=Yp(a,o,l,n);return h.recomendado=y,{id:"anova-un-factor",nombre:"ANOVA de un factor",metodo:"ANOVA clásico para tres o más grupos independientes con varianzas homogéneas.",grupos:a,...i,estadistico:{simbolo:"F",valor:s},gradosLibertad:{numerador:m,denominador:l},valorP:c,nivelConfianza:n,alfa:x,significativo:y,tablaAnova:{entreGrupos:{sumaCuadrados:u,gradosLibertad:m,cuadradoMedio:r},dentroGrupos:{sumaCuadrados:d,gradosLibertad:l,cuadradoMedio:o},total:{sumaCuadrados:f,gradosLibertad:i.nTotal-1}},tamanioEfecto:{etaCuadrado:p,omegaCuadrado:b,interpretacion:on(b)},postHoc:h}}function nm(t,e={}){const{nivelConfianza:n=.95}=e;an(n);const a=nn(t),i=rn(a),u=a.find(({varianza:w})=>w<=0);if(u)throw new Error(`El ANOVA de Welch requiere varianza positiva en cada grupo. Revise ${u.nombre}.`);const d=a.map(w=>({...w,peso:w.n/w.varianza})),f=d.reduce((w,E)=>w+E.peso,0),m=d.reduce((w,E)=>w+E.peso*E.media,0)/f,l=a.length,r=l-1,o=d.reduce((w,E)=>w+E.peso*(E.media-m)**2,0)/r,s=d.reduce((w,E)=>w+(1-E.peso/f)**2/(E.n-1),0),c=1+2*(l-2)/(l**2-1)*s,p=o/c,g=(l**2-1)/(3*s),b=Li(p,r,g),x=Math.max(0,r*(p-1)/(r*p+g+1)),y=1-n,h=b<y,v=Zp(a,n);return v.recomendado=h,{id:"anova-welch",nombre:"ANOVA de Welch",metodo:"ANOVA robusto para tres o más grupos independientes sin exigir igualdad de varianzas.",grupos:a,...i,mediaPonderada:m,sumaPesos:f,estadistico:{simbolo:"F_W",valor:p},gradosLibertad:{numerador:r,denominador:g},valorP:b,nivelConfianza:n,alfa:y,significativo:h,componentesWelch:{numeradorBase:o,terminoCorreccion:s,denominadorCorreccion:c},tamanioEfecto:{omegaCuadradoAproximado:x,interpretacion:on(x),nota:"Estimación aproximada basada en el estadístico F de Welch y sus grados de libertad."},postHoc:v}}function rm(t,e={}){const{nivelConfianza:n=.95}=e;an(n);const a=nn(t),i=rn(a),u=a.flatMap((y,h)=>y.valores.map(v=>({valor:v,indiceGrupo:h}))),d=Xp(u),f=new Array(a.length).fill(0);d.observaciones.forEach(({indiceGrupo:y,rango:h})=>{f[y]+=h});const m=12/(i.nTotal*(i.nTotal+1))*a.reduce((y,h,v)=>y+f[v]**2/h.n,0)-3*(i.nTotal+1),l=1-d.sumaCorreccionEmpates/(i.nTotal**3-i.nTotal),r=l<=0?0:m/l,o=a.length-1,s=Qp(r,o),c=Math.max(0,(r-a.length+1)/(i.nTotal-a.length)),p=1-n,g=s<p,b=a.map((y,h)=>({...y,sumaRangos:f[h],rangoMedio:f[h]/y.n})),x=tm(a,f,i.nTotal,d.sumaCorreccionEmpates,n);return x.recomendado=g,{id:"kruskal-wallis",nombre:"Prueba de Kruskal–Wallis",metodo:"Comparación no paramétrica de tres o más grupos independientes mediante rangos.",grupos:b,...i,estadistico:{simbolo:"H",valor:r,sinCorreccion:m},gradosLibertad:{valor:o},valorP:s,nivelConfianza:n,alfa:p,significativo:g,empates:{factorCorreccion:l,sumaCorreccion:d.sumaCorreccionEmpates,cantidadGruposEmpatados:d.cantidadGruposEmpatados},tamanioEfecto:{epsilonCuadrado:c,interpretacion:on(c)},postHoc:x}}function im({grupos:t,prueba:e,nivelConfianza:n=.95}){switch(e){case"anova-un-factor":case"anova":return am(t,{nivelConfianza:n});case"anova-welch":case"welch":return nm(t,{nivelConfianza:n});case"kruskal-wallis":return rm(t,{nivelConfianza:n});default:throw new Error("La prueba solicitada no está disponible.")}}function om(){const t=document.createElement("section");t.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,t.innerHTML=`
...
74"
    ...
    `}function sm(t){return[...t.querySelectorAll("[data-grupo]")].map((e,n)=>{const a=e.querySelector("[data-nombre-grupo]").value.trim();if(!a)throw new Error(`El grupo ${n+1} debe tener un nombre.`);const i=e.querySelector("[data-valores-grupo]").value;return{nombre:a,valores:lm(i,a)}})}function lm(t,e){const n=t.trim();if(!n)throw new Error(`${e} no contiene datos.`);const a=n.split(/[\s;]+/).filter(Boolean),i=a.map(d=>Number(d.replace(",","."))),u=i.findIndex(d=>!Number.isFinite(d));if(u!==-1)throw new Error(`${e} contiene un valor no válido: "${a[u]}".`);if(i.length<2)throw new Error(`${e} debe contener al menos dos observaciones.`);return i}function cm(t){return t.trim()?t.trim().split(/[\s;]+/).filter(Boolean).length:0}function Ni(t){if(!t)return;const e=t.querySelector("[data-valores-grupo]"),n=t.querySelector("[data-contador-grupo]"),a=cm(e.value);n.textContent=a===1?"1 valor":`${a} valores`}function dm(t,e){e.innerHTML=`
        ${ie(1)}
        ${ie(2)}
        ${ie(3)}
...
88`}];[...e.querySelectorAll("[data-grupo]")].forEach((a,i)=>{a.querySelector("[data-nombre-grupo]").value=n[i].nombre,a.querySelector("[data-valores-grupo]").value=n[i].valores,Ni(a)}),t.elements.prueba.value||(t.elements.prueba.value="anova-un-factor")}function dr(t,e){t.textContent=e,t.classList.remove("hidden")}function rt(t){t.textContent="",t.classList.add("hidden")}function pe(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function O(t,e=4){return t===1/0?"∞":Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):"—"}function Si(t){return Number.isFinite(t)?t<.001?"< 0.001":O(t,4):"—"}function um(t){const e=t.alfa.toFixed(2),n=Math.round(t.nivelConfianza*100),a=t.significativo?`Se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${e}, correspondiente a un nivel de confianza del ${n} %.`:`No se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${e}, correspondiente a un nivel de confianza del ${n} %.`;return`
        <section class="rounded-3xl border border-indigo-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                    ${$t(t.estadistico.simbolo,O(t.estadistico.valor),"Estadístico global")}
                    ${$t("p",Si(t.valorP),"Valor de significación")}
                    ${$t("k",t.numeroGrupos,"Número de grupos")}
                    ${$t("N",t.nTotal,"Tamaño total")}
                </div>
    ...
    `}function pm(t){const e=t.id==="kruskal-wallis";return`
    ...
    `}function mm(t){if(t.id==="anova-un-factor"){const e=t.tablaAnova;return`
    ...
    `}function fm(t){let e;return t.id==="anova-un-factor"?e=[["Eta cuadrado, η²",t.tamanioEfecto.etaCuadrado],["Omega cuadrado, ω²",t.tamanioEfecto.omegaCuadrado]]:t.id==="anova-welch"?e=[["Omega cuadrado aproximado",t.tamanioEfecto.omegaCuadradoAproximado]]:e=[["Épsilon cuadrado, ε²",t.tamanioEfecto.epsilonCuadrado]],`
        <article class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-6">
            <h3 class="text-xl font-black text-amber-950 mb-5">
                Tamaño del efecto
            </h3>
    ...
    `}function gm(t){const e=t.postHoc;return e?.comparaciones?.length?`
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[980px] text-sm">
                    ...
                    <tbody class="divide-y divide-fuchsia-100">
                        ${e.comparaciones.map(bm).join("")}
                    </tbody>
                </table>
            </div>
        </article>
    `:""}function bm(t){const e=t.diferenciaMedias??t.diferenciaRangos,n=t.estadisticoQ??t.estadisticoZ,a=t.valorPAjustado??t.valorP,i=t.intervaloConfianza?`${O(t.intervaloConfianza.inferior)} a ${O(t.intervaloConfianza.superior)}`:"—";return`
        <tr>
            <td class="px-5 py-4 font-bold text-slate-900">
    ...
    `}const ln=wt.jStat??ra?.jStat;if(!ln)throw new Error("No fue posible cargar el motor estadístico jStat.");const Oi=t=>Math.min(1,Math.max(0,t));function zi(t){if(!Number.isFinite(t)||t<=0||t>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function hm(t){return typeof t=="string"?t.trim()===""?Number.NaN:Number(t.trim().replace(",",".")):Number(t)}function ft(t){return t.reduce((e,n)=>e+n,0)/t.length}function vm(t){const e=[...t].sort((a,i)=>a-i),n=Math.floor(e.length/2);return e.length%2?e[n]:(e[n-1]+e[n])/2}function xm(t,e=ft(t)){return t.reduce((n,a)=>n+(a-e)**2,0)/(t.length-1)}function ym(t){const e=ft(t),n=xm(t,e);return{n:t.length,media:e,mediana:vm(t),varianza:n,desviacionEstandar:Math.sqrt(n),minimo:Math.min(...t),maximo:Math.max(...t)}}function wm(t,e){const n=Array.isArray(t),a=n?t:t?.valores;if(!Array.isArray(a))throw new TypeError(`La medición ${e+1} debe contener un arreglo llamado valores.`);const i=a.map(hm),u=i.findIndex(f=>!Number.isFinite(f));if(u!==-1)throw new TypeError(`La medición ${e+1} contiene un valor no numérico en la posición ${u+1}.`);if(i.length<2)throw new RangeError(`La medición ${e+1} debe contener al menos dos observaciones.`);return{nombre:(n?"":String(t?.nombre??"").trim())||`Medición ${e+1}`,valores:i,...ym(i)}}function Mi(t){if(!Array.isArray(t))throw new TypeError("Las mediciones deben proporcionarse mediante un arreglo.");if(t.length<3)throw new RangeError("El análisis requiere al menos tres mediciones relacionadas.");const e=t.map(wm),n=e[0].n;if(e.find(({n:u})=>u!==n))throw new RangeError("Todas las mediciones deben contener el mismo número de observaciones y conservar el mismo orden de participantes.");const i=e.map(({nombre:u})=>u);if(new Set(i).size!==i.length)throw new Error("Cada medición debe tener un nombre diferente.");return e}function Fi(t){const e=t[0].n;return Array.from({length:e},(n,a)=>t.map(({valores:i})=>i[a]))}function La(t,e,n){return t===1/0?0:Oi(1-ln.centralF.cdf(t,e,n))}function Em(t,e){return Oi(1-ln.chisquare.cdf(t,e))}function qi(t){const e=t.map((a,i)=>({...a,indiceOriginal:i})).sort((a,i)=>a.valorP-i.valorP);let n=0;return e.forEach((a,i)=>{const u=Math.min(1,a.valorP*(e.length-i));a.valorPAjustado=Math.max(n,u),n=a.valorPAjustado}),e.sort((a,i)=>a.indiceOriginal-i.indiceOriginal).map(({indiceOriginal:a,...i})=>i)}function Ui(t,e){const n=[];for(let a=0;a<t.length-1;a+=1)for(let i=a+1;i<t.length;i+=1)n.push(e(t[a],t[i],a,i));return n}function $a(t,e){const n=t.length,a=e[0].length,i=e.length;return Array.from({length:n},(u,d)=>Array.from({length:a},(f,m)=>{let l=0;for(let r=0;r<i;r+=1)l+=t[d][r]*e[r][m];return l}))}function ur(t){return t.reduce((e,n,a)=>e+n[a],0)}function km(t){const e=t.length,n=t[0].length,a=Array.from({length:n},(i,u)=>ft(t.map(d=>d[u])));return Array.from({length:n},(i,u)=>Array.from({length:n},(d,f)=>{let m=0;for(let l=0;l<e;l+=1)m+=(t[l][u]-a[u])*(t[l][f]-a[f]);return m/(e-1)}))}function Am(t){const e=t.length,n=t[0].length,a=km(t),i=Array.from({length:n},(p,g)=>Array.from({length:n},(b,x)=>(g===x?1:0)-1/n)),u=$a($a(i,a),i),d=ur(u),f=$a(u,u),m=ur(f),l=1/(n-1);let r=m===0?1:d**2/((n-1)*m);r=Math.min(1,Math.max(l,r));const o=e*(n-1)*r-2,s=(n-1)*(e-1-(n-1)*r);let c=s<=0?1:o/s;return c=Math.min(1,Math.max(l,c)),{limiteInferior:l,greenhouseGeisser:r,huynhFeldt:c,covarianzas:a}}function Cm(t){const e=Math.abs(t);return e<.01?"Prácticamente nulo":e<.06?"Pequeño":e<.14?"Moderado":"Grande"}function Im(t){const e=Math.abs(t);return e<.1?"Muy pequeño":e<.3?"Pequeño":e<.5?"Moderado":"Grande"}function Pm(t,e){const n=1-e,a=Ui(t,(i,u)=>{const d=Pi(i.valores,u.valores,{nivelConfianza:e});return{medicion1:i.nombre,medicion2:u.nombre,diferenciaMedia:d.diferenciaMedia,estadisticoT:d.estadistico.valor,gradosLibertad:d.gradosLibertad,valorP:d.valorP,intervaloConfianza:d.intervaloConfianza,dZ:d.tamanioEfecto.dZ}});return{id:"t-pareadas-holm",nombre:"Comparaciones t pareadas con ajuste de Holm",metodo:"Comparaciones pareadas bilaterales con ajuste secuencial de Holm sobre los valores p.",recomendado:!1,comparaciones:qi(a).map(i=>({...i,significativo:i.valorPAjustado<n}))}}function _m(t,e){const n=1-e,a=Ui(t,(i,u)=>{const d=_i(i.valores,u.valores);return{medicion1:i.nombre,medicion2:u.nombre,estadisticoW:d.estadistico.valor,estadisticoZ:d.estadisticoZ,valorP:d.valorP,correlacionBiserialRangos:d.tamanioEfecto.correlacionBiserialRangos,r:d.tamanioEfecto.r,nEfectivo:d.nEfectivo,cantidadCeros:d.cantidadCeros}});return{id:"wilcoxon-holm",nombre:"Comparaciones de Wilcoxon con ajuste de Holm",metodo:"Comparaciones pareadas de rangos con signo y ajuste secuencial de Holm sobre los valores p.",recomendado:!1,comparaciones:qi(a).map(i=>({...i,significativo:i.valorPAjustado<n}))}}function Tm(t){const e=t.map((d,f)=>({valor:d,indice:f,rango:0})).sort((d,f)=>d.valor-f.valor);let n=0,a=0,i=0;for(;n<e.length;){let d=n+1;for(;d<e.length&&e[d].valor===e[n].valor;)d+=1;const f=d-n,m=(n+1+d)/2;for(let l=n;l<d;l+=1)e[l].rango=m;f>1&&(i+=1,a+=f**3-f),n=d}const u=new Array(t.length).fill(0);return e.forEach(({indice:d,rango:f})=>{u[d]=f}),{rangos:u,correccionEmpates:a,cantidadGruposEmpatados:i}}function Lm(t,e={}){const{nivelConfianza:n=.95}=e;zi(n);const a=Mi(t),i=Fi(a),u=i.length,d=a.length,f=i.flat(),m=ft(f),l=i.map(F=>ft(F)),r=f.reduce((F,N)=>F+(N-m)**2,0),o=u*a.reduce((F,N)=>F+(N.media-m)**2,0),s=d*l.reduce((F,N)=>F+(N-m)**2,0),c=Math.max(0,r-o-s),p=d-1,g=u-1,b=p*g,x=o/p,y=c/b,h=y===0?x===0?0:1/0:x/y,v=La(h,p,b),w=o+c===0?0:o/(o+c),E=o+c+s===0?0:o/(o+c+s),k=Am(i),A=p*k.greenhouseGeisser,C=b*k.greenhouseGeisser,I=p*k.huynhFeldt,P=b*k.huynhFeldt,L=La(h,A,C),T=La(h,I,P),$=1-n,V=Pm(a,n);return V.recomendado=L<$,{id:"anova-medidas-repetidas",nombre:"ANOVA de medidas repetidas",metodo:"ANOVA unifactorial intra-sujetos para tres o más mediciones completas y relacionadas.",mediciones:a,nSujetos:u,numeroMediciones:d,mediaGeneral:m,mediasSujetos:l,estadistico:{simbolo:"F",valor:h},gradosLibertad:{numerador:p,denominador:b},valorP:v,nivelConfianza:n,alfa:$,significativo:v<$,tablaAnova:{mediciones:{sumaCuadrados:o,gradosLibertad:p,cuadradoMedio:x},sujetos:{sumaCuadrados:s,gradosLibertad:g},error:{sumaCuadrados:c,gradosLibertad:b,cuadradoMedio:y},total:{sumaCuadrados:r,gradosLibertad:u*d-1}},esfericidad:{...k,greenhouseGeisser:{epsilon:k.greenhouseGeisser,gradosLibertadNumerador:A,gradosLibertadDenominador:C,valorP:L,significativo:L<$},huynhFeldt:{epsilon:k.huynhFeldt,gradosLibertadNumerador:I,gradosLibertadDenominador:P,valorP:T,significativo:T<$},nota:"Se informan correcciones de Greenhouse–Geisser y Huynh–Feldt. La calculadora no sustituye una prueba formal de esfericidad ni el examen de la matriz de covarianzas."},tamanioEfecto:{etaCuadradoParcial:w,etaCuadradoGeneralizado:E,interpretacion:Cm(w)},postHoc:V}}function $m(t,e={}){const{nivelConfianza:n=.95}=e;zi(n);const a=Mi(t),i=Fi(a),u=i.length,d=a.length,f=new Array(d).fill(0);let m=0,l=0;i.forEach(h=>{const v=Tm(h);v.rangos.forEach((w,E)=>{f[E]+=w}),m+=v.correccionEmpates,l+=v.cantidadGruposEmpatados});const r=12/(u*d*(d+1))*f.reduce((h,v)=>h+v**2,0)-3*u*(d+1),o=1-m/(u*(d**3-d)),s=o<=0?0:r/o,c=d-1,p=Em(s,c),g=u*(d-1)===0?0:s/(u*(d-1)),b=1-n,x=a.map((h,v)=>({...h,sumaRangos:f[v],rangoMedio:f[v]/u})),y=_m(a,n);return y.recomendado=p<b,{id:"friedman",nombre:"Prueba de Friedman",metodo:"Comparación no paramétrica de tres o más mediciones relacionadas mediante rangos dentro de cada participante.",mediciones:x,nSujetos:u,numeroMediciones:d,estadistico:{simbolo:"χ²_F",valor:s,sinCorreccion:r},gradosLibertad:{valor:c},valorP:p,nivelConfianza:n,alfa:b,significativo:p<b,empates:{factorCorreccion:o,sumaCorreccion:m,cantidadGruposEmpatados:l},tamanioEfecto:{kendallW:g,interpretacion:Im(g)},postHoc:y}}function Rm({mediciones:t,prueba:e,nivelConfianza:n=.95}){switch(e){case"anova-medidas-repetidas":case"anova-repetidas":return Lm(t,{nivelConfianza:n});case"friedman":return $m(t,{nivelConfianza:n});default:throw new Error("La prueba solicitada no está disponible.")}}function Dm(){const t=document.createElement("section");t.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,t.innerHTML=`
...
20`];[...e.querySelectorAll("[data-medicion]")].forEach((u,d)=>{u.querySelector('[data-campo="nombre"]').value=n[d],u.querySelector('[data-campo="valores"]').value=a[d],Bi(u)})}function Bi(t){const e=t.querySelector('[data-campo="valores"]'),n=t.querySelector("[data-contador]"),a=e.value.trim()?e.value.trim().split(/[\s;]+/).filter(Boolean).length:0;n.textContent=a===1?"1 valor":`${a} valores`}document.addEventListener("input",t=>{const e=t.target.closest('#formulario-mediciones-relacionadas [data-campo="valores"]');if(!e)return;const n=e.closest("[data-medicion]");n&&Bi(n)});function mr(t,e){t.textContent=e,t.classList.remove("hidden")}function Ra(t){t.textContent="",t.classList.add("hidden")}function le(t,e=4){return Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):t===1/0?"∞":"—"}function Kt(t){return Number.isFinite(t)?t<.001?"< 0.001":le(t,4):"—"}function zm(t){const e=t.id==="anova-medidas-repetidas",n=e?t.esfericidad.greenhouseGeisser.valorP:t.valorP,a=n<t.alfa,i=Math.round(t.nivelConfianza*100),u=e?"Greenhouse–Geisser":"sin corrección adicional",d=a?`Se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${t.alfa.toFixed(2)}. Para la decisión principal se utilizó ${u}.`:`No se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${t.alfa.toFixed(2)}. Para la decisión principal se utilizó ${u}.`;return`
        <section class="rounded-3xl border border-fuchsia-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ${Rt(t.estadistico.simbolo,le(t.estadistico.valor),"Estadístico global")}
                    ${Rt("p",Kt(n),e?"Valor p Greenhouse–Geisser":"Valor p bilateral")}
                    ${Rt("n",t.nSujetos,"Participantes completos")}
                    ${Rt("k",t.numeroMediciones,"Mediciones")}
                </div>
    ...
    `}function Fm(t){const e=t.tablaAnova,n=t.esfericidad.greenhouseGeisser,a=t.esfericidad.huynhFeldt;return`
    ...
    `}function B(t,e,n=!1,a=!1){const i=a?e:n?Kt(e):le(e);return`
        <div>
            <dt class="text-xs uppercase tracking-wide font-black text-slate-500">
                ${t}
            </dt>
    ...
    `}function Um(t){return t?.comparaciones?.length?`
    ...
    `:""}const Bm={home:{page:uo,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:Lo,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:zo,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Bo,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:ns,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:cs,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:As,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:hs,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Ns,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:qs,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Vu,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Zu,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},comparacionGrupos:{page:up,layout:"default",title:"Comparación de grupos y mediciones | El Kernel"},calculadoraDosGrupos:{page:Cp,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:Mp,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"},calculadoraTresOMasGrupos:{page:om,layout:"default",title:"Comparación de tres o más grupos independientes | El Kernel"},calculadoraTresOMasMedicionesRelacionadas:{page:Dm,layout:"default",title:"Comparación de tres o más mediciones relacionadas | El Kernel"}};let fr=document.referrer||"";function la(t){window.location.hash=`/${t}`}function Vm(){const t=()=>{const e=window.location.hash.replace("#/","")||"home";Hm(e)};window.addEventListener("hashchange",t),t()}function Gm(t,e){const n=`${window.location.origin}${window.location.pathname}#/${t}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:e,page_location:n,page_referrer:fr}),fr=n}async function Hm(t){const e=document.querySelector("main"),n=Bm[t];if(!e)return;if(e.innerHTML="",!n){la("home");return}Mo(n.layout),document.title=n.title;const a=await n.page();e.appendChild(a),window.scrollTo({top:0,behavior:"auto"}),Gm(t,n.title)}function Wm(t,e){gr(t,la),Vm();const n=window.matchMedia("(max-width: 768px)");let a=!1;function i(d){d.matches&&!a&&(cn(t),a=!0)}n.addEventListener("change",i),i(n),cn(t);const u=e.querySelector('[data-action ="open-menu"]');ji(u,t),Ji(t)}const Vi=document.querySelector("#header");Vi.innerHTML=Hi();const Gi=document.querySelector("#navBar");Gi.innerHTML=Wi();const Km=document.querySelector("#footer");Km.innerHTML=Ki();Wm(Gi,Vi);
