export function CorrelacionAsociacion() {
    ...
    section.innerHTML = `
        ...
        <section class="grid grid-cols-1 lg:grid-cols-2 gap-7 mt-8">
            ${crearTarjeta({
                ...
                descripcion:
                    "Analice la intensidad, dirección y significación de la relación entre dos variables mediante Pearson, Spearman, Kendall o correlación punto-biserial.",
                elementos: [
                ...
                textoBoton: "Abrir calculadora de correlación",
                clases: {
    ...
    return `
        <article class="h-full rounded-3xl border ${clases.borde} bg-white p-6 md:p-8 shadow-xl">
            <div class="flex flex-col h-full">
                ...
                >
                    ${textoBoton}
                    ${deshabilitada ? "" : '<span class="ml-2" aria-hidden="true">→</span>'}
                </button>
            </div>
        </article>
    `;
