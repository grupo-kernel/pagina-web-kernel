(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=t(o);fetch(o.href,s)}})();const F=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function ae(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function G(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function le(e){G(e,O)}const J=""+new URL("apec-ConmXkrT.png",import.meta.url).href,re=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,ce=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,T=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        <img src="${re}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function de(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=T.length,s=1500;let r=0,p=null;function x(b){return(b%o+o)%o}function c(){i.innerHTML=T[r].content}function n(b){r=x(r+b),c()}function u(){d(),p=setInterval(()=>n(1),s)}function d(){p&&(clearInterval(p),p=null)}function l(){u()}c(),u(),a.addEventListener("click",()=>{n(1),l()}),t.addEventListener("click",()=>{n(-1),l()})}function pe(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return de(t.querySelector("#containerFather")),le(t.querySelector("#btnsGroup")),t}function me(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=`${ne()}`;const a=pe();return e.appendChild(a),e}function ue(){return me()}const xe=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function ge(){return`
        <section 
            role="banner" 
  ...
  `}function Ce(){const e=document.createElement("section");return e.className=`
    ...
    `).join(""):""}function Le(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=Ie(e.redes||[]),i=je(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}const j=""+new URL("sep-BCMURSaM.png",import.meta.url).href,L=""+new URL("nat-CaDYa76I.png",import.meta.url).href,K=""+new URL("rad-B3ff1btG.png",import.meta.url).href,$=""+new URL("ant-D2J2W27b.png",import.meta.url).href,V=""+new URL("mar-Cru0HERG.png",import.meta.url).href,z=""+new URL("marc-D-jKwb4F.png",import.meta.url).href,M=""+new URL("jos-BToFZdIf.png",import.meta.url).href,k=[{img:j,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:L,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:K,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:$,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:V,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:z,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:M,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function ze(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,s=()=>{const l=o();return Math.max(k.length-l,0)},r=()=>{const l=s();e>l&&(e=0),e<0&&(e=l)},p=()=>{const l=s();e>=l?e=0:e++,d()},x=()=>{const l=s();e<=0?e=l:e--,d()},c=()=>{n(),k.length>o()&&(a=setInterval(p,4500))},n=()=>{a&&(clearInterval(a),a=null)},u=()=>{const l=o(),b=Math.max(k.length-l+1,1);return Array.from({length:b}).map((C,A)=>`
        ...
        `).join("")},d=()=>{if(!k||k.length===0){i.innerHTML=`
            ...
            `;return}r();const l=o(),b=k.slice(e,e+l);i.innerHTML=`
        ...
        `;const C=i.querySelector("#cards-wrapper");b.forEach(D=>{C.appendChild(Le(D))});const A=i.querySelector("#prev-btn"),U=i.querySelector("#next-btn");A&&(A.onclick=()=>{x(),c()}),U&&(U.onclick=()=>{p(),c()}),i.querySelectorAll("[data-dot-index]").forEach(D=>{D.onclick=()=>{e=parseInt(D.dataset.dotIndex),d(),c()}})};return i.addEventListener("mouseenter",n),i.addEventListener("mouseleave",c),document.addEventListener("visibilitychange",()=>{document.hidden?n():c()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,d(),c()},150)}),d(),c(),i}function Be(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&O(t.dataset.route)})}function H(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Be(a),a}function $e(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(H());const t=ze();return e.appendChild(a),e.appendChild(t),e}function Pe(){return $e()}function Oe(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function v(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Q(e){return e.formacion?.length||0}function Y(e){return e.experiencia?.length||0}function Ue(e,a=!1){const t=Q(e),i=Y(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function Re(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(p=>`
  ...
  `}function Ye(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ...
    `,e}function We({title:e,content:a,articleURL:t}){const i=a.paragraphs.map(r=>`<p>${r}<p>`).join(""),o=a.list.length?` 
    ...
    `}function na(e){if(!e)return`
        ...
        `;const a=Z(e),t=oa(e),i=t.length,o=t.map(n=>Number(n.year)).filter(Boolean),s=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",p=[...new Set(t.map(n=>n.q).filter(Boolean))],x=[...new Set(t.map(n=>N(n)).filter(Boolean))],c=t.map(n=>{const u=N(n),d=X(n),l=ia(n);return`
    ...
    `}function la(){let e=E[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(c){const n=String(c.DOI||c.doi||"").trim().toLowerCase();return n||`${c.year||""}-${c.title||c.tile||""}-${c.contenido||""}`.trim().toLowerCase()}function s(){const c=new Map;return E.forEach(n=>{(n.publicaciones||[]).forEach(u=>{const d=o(u);c.has(d)||c.set(d,u)})}),Array.from(c.values())}function r(){const c=s(),n=c.map(b=>Number(b.year)).filter(Boolean),u=n.length?Math.max(...n):"—",d=n.length?Math.min(...n):"—",l=c.filter(b=>b.q==="Q1").length;return{totalPublicaciones:c.length,investigadores:E.length,q1:l,primerYear:d,ultimoYear:u}}const p=()=>{const c=E.find(l=>l.id===e)||E[0],n=r(),u=window.innerWidth<768&&!a;i.innerHTML=`
    ...
    `}function Aa(){let e=S[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=fa(e);a.innerHTML=`
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function ka(){return Aa()}function Ea(){return`
