...
>
    ...
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${$a}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function ar(t,e){t.addEventListener("click",n=>{const a=n.target.closest(["[data-route]"]);a&&(n.preventDefault(),e(a.dataset.route))})}function $i(t){ar(t,ta)}const nr=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Di=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Ni=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,Xa=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
    ...
    `,e=document.createElement("div");e.innerHTML=t;const n=e.firstElementChild;return Oi(n.querySelector("#containerFather")),$i(n.querySelector("#btnsGroup")),n}const zi="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function Mi(){try{const t=await fetch(zi,{method:"GET",cache:"no-store"});if(!t.ok)throw new Error(`La API de Analytics respondió con estado ${t.status}`);const e=await t.json();if(!e.ok||!e.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(e.visitantes.total)||0,hoy:Number(e.visitantes.hoy)||0,ultimos7Dias:Number(e.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(e.visitantes.ultimos30Dias)||0,actualizadoEn:e.actualizadoEn||null}}catch(t){return console.error("No fue posible obtener las estadísticas de Analytics:",t),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function ht(t){return new Intl.NumberFormat("es-DO").format(Number(t)||0)}function Ui(t){if(!t)return null;const e=new Date(t);return Number.isNaN(e.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(e)}async function qi(t){const e=t.querySelector("#analytics-total"),n=t.querySelector("#analytics-hoy"),a=t.querySelector("#analytics-semana"),i=t.querySelector("#analytics-mes"),u=t.querySelector("#analytics-actualizado");if(!e||!n||!a||!i||!u){console.warn("No se encontraron los elementos de Analytics en la portada.");return}u.textContent="Cargando estadísticas…";try{const d=await Mi();e.textContent=ht(d.total),n.textContent=ht(d.hoy),a.textContent=ht(d.ultimos7Dias),i.textContent=ht(d.ultimos30Dias);const g=Ui(d.actualizadoEn);u.textContent=g?`Actualizado: ${g}`:"Estadísticas temporalmente no disponibles"}catch(d){console.error("Error al mostrar las estadísticas en la portada:",d),e.textContent="—",n.textContent="—",a.textContent="—",i.textContent="—",u.textContent="No fue posible cargar las estadísticas"}}function Fi(){const t=document.createElement("section");t.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,t.innerHTML=Ri();const e=Si();return t.appendChild(e),qi(t),t}function Bi(){return Fi()}const Vi=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Hi(){return`
        <section 
            role="banner" 
...
Gracias.`);return`
    ...
    `;const e=Lo(cr),n=e.find(a=>a.featured)||e[0];return t.innerHTML=`
        ...
        ${_o(e)}
        ${To()}
    `,t}function $o({title:t,content:e={paragraphs:[],list:[]},articleURL:n}){const a=(e.paragraphs||[]).map(d=>`<p>${d}</p>`).join(""),i=(e.list||[]).length?`
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${q(t.institucion)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Tipo</p>
                        <p class="text-slate-800 font-bold mt-1">${q(t.tipo)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Duración estimada</p>
                        <p class="text-slate-800 font-bold mt-1">${q(t.duracion)}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        ...
                        <p class="text-slate-700 font-semibold mt-1">${q(t.fechaInicio)}</p>
                    </div>

                    <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Fecha final prevista</p>
                        <p class="text-slate-700 font-semibold mt-1">${q(t.fechaFinalizacion)}</p>
                    </div>
                </div>
...
if (!contenedor) {
  ...
  `;const n=e.querySelector("#kernel-login"),a=e.querySelector("#login-error"),i=e.querySelector("#correo"),u=e.querySelector("#password"),d=n.querySelector('button[type="submit"]');return n.addEventListener("submit",async g=>{g.preventDefault(),a.classList.add("hidden"),a.textContent="";const m=i.value.trim(),l=u.value;if(!m||!l){a.textContent="Introduzca el correo electrónico y la contraseña.",a.classList.remove("hidden");return}d.disabled=!0,d.textContent="Verificando...";try{await bu(m,l),t&&await t()}catch(r){console.error("Error de autenticación:",r);const o={"auth/invalid-email":"El correo electrónico no tiene un formato válido.","auth/invalid-credential":"El correo o la contraseña son incorrectos.","auth/user-not-found":"El correo no está autorizado.","auth/wrong-password":"El correo o la contraseña son incorrectos.","auth/user-disabled":"Este usuario está deshabilitado.","auth/too-many-requests":"Demasiados intentos. Espere unos minutos e inténtelo nuevamente.","auth/network-request-failed":"No fue posible conectarse con Firebase. Revise su conexión.","auth/unauthorized-domain":"El dominio de Grupo Kernel no está autorizado en Firebase."};a.textContent=o[r.code]||`No fue posible iniciar sesión. Error: ${r.code||"desconocido"}`,a.classList.remove("hidden")}finally{d.disabled=!1,d.textContent="Iniciar sesión"}}),e}function wu(){return new Promise(t=>{const e=vu(n=>{e(),t(n)})})}async function yu(){if(!await wu())return xu(()=>{window.dispatchEvent(new HashChangeEvent("hashchange"))});const e=document.createElement("section");return e.className=`
    ...
    `;const n=t.querySelector("#asistente-pruebas"),a=o=>{n.innerHTML=o,window.scrollTo({top:0,behavior:"auto"})},i=()=>{Object.assign(e,{pantalla:"inicio",objetivo:"",tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:"",tipoResultado:"",numeroPredictores:"",sobredispersion:""})},u=()=>{e.pantalla="resultado-comparacion",a($u(e))},d=()=>{e.pantalla="resultado-relacion",a(Du(e))},g=()=>{e.pantalla="resultado-asociacion",a(Nu(e))},m=()=>{e.pantalla="resultado-prediccion",a(Ou(e))},l=o=>{if(e.pantalla==="objetivo"){if(Object.assign(e,{objetivo:o,tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:"",tipoResultado:"",numeroPredictores:"",sobredispersion:""}),o==="comparar"){e.pantalla="tipo-variable",a(Nn());return}if(o==="relacionar"){e.pantalla="tipo-relacion",a(yt());return}if(o==="asociar"){e.pantalla="tipo-asociacion",a(Sn());return}if(o==="predecir"){e.pantalla="tipo-resultado",a(zn());return}a(qu(o)),e.pantalla="desarrollo";return}if(e.pantalla==="tipo-variable"){Object.assign(e,{tipoVariable:o,numeroGrupos:"",relacion:"",normalidad:"",varianzas:""}),e.pantalla="numero-grupos",a(xt());return}if(e.pantalla==="numero-grupos"){if(Object.assign(e,{numeroGrupos:o,relacion:"",normalidad:"",varianzas:""}),o==="uno"){if(e.relacion="una-muestra",e.tipoVariable==="categorica"){u();return}e.pantalla="normalidad",a(wt());return}e.pantalla="relacion-muestras",a(pa(e));return}if(e.pantalla==="relacion-muestras"){if(Object.assign(e,{relacion:o,normalidad:"",varianzas:""}),e.tipoVariable==="categorica"){u();return}e.pantalla="normalidad",a(wt());return}if(e.pantalla==="normalidad"){if(e.normalidad=o,e.varianzas="",e.tipoVariable==="cuantitativa"&&o==="si"&&e.relacion==="independientes"&&e.numeroGrupos!=="uno"){e.pantalla="varianzas",a(On());return}u();return}if(e.pantalla==="varianzas"){e.varianzas=o,u();return}if(e.pantalla==="tipo-relacion"){if(Object.assign(e,{tipoRelacion:o,normalidad:"",linealidad:"",empates:""}),o==="dicotomica-cuantitativa"){d();return}if(o==="ordinales"){e.pantalla="empates",a(Fn());return}e.pantalla="normalidad-relacion",a(fa());return}if(e.pantalla==="normalidad-relacion"){if(e.normalidad=o,e.linealidad="",o!=="si"){d();return}e.pantalla="linealidad",a(qn());return}if(e.pantalla==="linealidad"){e.linealidad=o,d();return}if(e.pantalla==="empates"){e.empates=o,d();return}if(e.pantalla==="tipo-asociacion"){Object.assign(e,{tipoAsociacion:o,frecuenciasEsperadas:""}),e.pantalla="frecuencias-esperadas",a(Un());return}if(e.pantalla==="frecuencias-esperadas"){e.frecuenciasEsperadas=o,g();return}if(e.pantalla==="tipo-resultado"){Object.assign(e,{tipoResultado:o,numeroPredictores:"",sobredispersion:""}),e.pantalla="numero-predictores",a(ma());return}if(e.pantalla==="numero-predictores"){if(e.numeroPredictores=o,e.sobredispersion="",e.tipoResultado==="conteo"){e.pantalla="sobredispersion",a(Mn());return}m();return}if(e.pantalla==="sobredispersion"){e.sobredispersion=o,m();return}},r=()=>{const s={"tipo-variable":()=>["objetivo",qe()],"numero-grupos":()=>["tipo-variable",Nn()],"relacion-muestras":()=>["numero-grupos",xt()],normalidad:()=>e.numeroGrupos==="uno"?["numero-grupos",xt()]:["relacion-muestras",pa(e)],varianzas:()=>["normalidad",wt()],"tipo-relacion":()=>["objetivo",qe()],"normalidad-relacion":()=>["tipo-relacion",yt()],linealidad:()=>["normalidad-relacion",fa()],empates:()=>["tipo-relacion",yt()],"tipo-asociacion":()=>["objetivo",qe()],"tipo-resultado":()=>["objetivo",qe()],"numero-predictores":()=>["tipo-resultado",zn()],sobredispersion:()=>["numero-predictores",ma()],"resultado-prediccion":()=>e.tipoResultado==="conteo"?["sobredispersion",Mn()]:["numero-predictores",ma()],"frecuencias-esperadas":()=>["tipo-asociacion",Sn()],"resultado-asociacion":()=>["frecuencias-esperadas",Un()],"resultado-comparacion":()=>e.varianzas?["varianzas",On()]:e.tipoVariable==="categorica"?e.numeroGrupos==="uno"?["numero-grupos",xt()]:["relacion-muestras",pa(e)]:["normalidad",wt()],"resultado-relacion":()=>e.tipoRelacion==="ordinales"?["empates",Fn()]:e.tipoRelacion==="dicotomica-cuantitativa"?["tipo-relacion",yt()]:e.linealidad?["linealidad",qn()]:["normalidad-relacion",fa()]}[e.pantalla];if(!s){e.pantalla="objetivo",a(qe());return}const[c,p]=s();e.pantalla=c,a(p)};return n.addEventListener("click",o=>{const s=o.target.closest("[data-action], [data-value]");if(!s)return;const c=s.dataset.action,p=s.dataset.value;if(p){l(p);return}if(c==="ejecutar-prueba"){const f=s.dataset.prueba;if(!f)return;const x=["student-pareada","wilcoxon"].includes(f);sessionStorage.setItem(x?"kernel-prueba-dos-relacionadas":"kernel-prueba-dos-grupos",f),window.location.hash=x?"/calculadoraDosMuestrasRelacionadas":"/calculadoraDosGrupos";return}if(c==="ver-ficha"){const f=s.dataset.fichaId,b=oi(f);if(!b)return;e.pantallaAnterior=e.pantalla,e.fichaActual=f,e.pantalla="ficha-metodologica",a(zu(b,f));return}if(c==="volver-resultado"){if(e.objetivo==="comparar"){u();return}if(e.objetivo==="relacionar"){d();return}if(e.objetivo==="asociar"){g();return}e.objetivo==="predecir"&&m();return}c==="iniciar"&&(e.pantalla="objetivo",a(qe())),c==="volver"&&r(),(c==="volver-inicio"||c==="reiniciar")&&(i(),a(Dn())),c==="volver-laboratorio"&&(window.location.hash="/laboratorioKernel")}),t}function Dn(){return`
        ...
        <section class="rounded-3xl border border-blue-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    ${Fe("¿Cuándo utilizarla?",t.cuandoUsar)}

                    ${Fe("Supuestos",t.supuestos)}
                </div>
                ...
                ${t.posthoc?.length?Fe("Análisis posteriores",t.posthoc):""}

                ${t.alternativas?.length?Fe("Pruebas y procedimientos alternativos",t.alternativas):""}

                ${t.erroresFrecuentes?.length?Fe("Errores frecuentes",t.erroresFrecuentes,"advertencia"):""}

                ${Et("Ejemplo de investigación",t.ejemplo)}

                ${t.referencias?.length?Fe("Referencias recomendadas",t.referencias,"referencias"):""}
    ...
    `}function Bu(){const t=document.createElement("section");return t.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,t.innerHTML=`
...
14.5`,r(),va(n),a.classList.add("hidden");return}c==="limpiar"&&(e.reset(),d.value="",g.value="",r(),va(n),a.innerHTML="",a.classList.add("hidden"))}),t}function Vn(t,e){const n=t.trim();if(!n)throw new Error(`${e} no contiene datos.`);const a=n.split(/[\s;]+/).filter(Boolean),i=a.map(d=>Number(d.replace(",","."))),u=i.findIndex(d=>!Number.isFinite(d));if(u!==-1)throw new Error(`${e} contiene un valor no válido: "${a[u]}".`);if(i.length<2)throw new Error(`${e} debe contener al menos dos observaciones.`);return i}function Hn(t){return t.trim()?t.trim().split(/[\s;]+/).filter(Boolean).length:0}function Gn(t){return t===1?"1 valor":`${t} valores`}function np(t,e){t.textContent=e,t.classList.remove("hidden")}function va(t){t.textContent="",t.classList.add("hidden")}function z(t,e=4){return Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):"—"}function rp(t){return Number.isFinite(t)?t<.001?"< 0.001":z(t,4):"—"}function ip(t,e=.95){const n=1-e,a=t.valorP<n,i=n.toFixed(2),u=Math.round(e*100),d=a?`Se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %.`:`No se observa evidencia estadísticamente significativa de una diferencia entre los grupos al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %.`;return`
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    ${At("p",rp(t.valorP),"Valor bilateral")}
    ...
    `}function op(t){if(t.id==="mann-whitney")return`
    ...
    `}const Xt=Yt.jStat??Ga?.jStat;if(!Xt)throw new Error("No fue posible cargar el motor estadístico jStat.");function Wa(t){return Math.min(1,Math.max(0,t))}function ui(t){if(!Number.isFinite(t)||t<=0||t>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function sp(t){return typeof t=="string"&&t.trim()===""?Number.NaN:Number(typeof t=="string"?t.trim().replace(",","."):t)}function Kn(t,e){if(!Array.isArray(t))throw new TypeError(`${e} debe ser un arreglo de valores.`);const n=t.map(sp),a=n.findIndex(i=>!Number.isFinite(i));if(a!==-1)throw new TypeError(`${e} contiene un valor no numérico en la posición ${a+1}.`);if(n.length<2)throw new RangeError(`${e} debe contener al menos dos observaciones.`);return n}function pi(t,e){const n=Kn(t,"La medición 1"),a=Kn(e,"La medición 2");if(n.length!==a.length)throw new RangeError("Las dos mediciones deben contener el mismo número de observaciones y conservar el mismo orden de participantes o pares.");return{medicion1:n,medicion2:a}}function Ra(t){return t.reduce((e,n)=>e+n,0)/t.length}function lp(t){const e=[...t].sort((a,i)=>a-i),n=Math.floor(e.length/2);return e.length%2!==0?e[n]:(e[n-1]+e[n])/2}function cp(t,e){return t.length<2?0:t.reduce((a,i)=>a+(i-e)**2,0)/(t.length-1)}function Ke(t){const e=Ra(t),n=cp(t,e);return{n:t.length,media:e,mediana:lp(t),varianza:n,desviacionEstandar:Math.sqrt(n),minimo:Math.min(...t),maximo:Math.max(...t)}}function Jn(t,e){const n=Ra(t),a=Ra(e);let i=0,u=0,d=0;for(let m=0;m<t.length;m+=1){const l=t[m]-n,r=e[m]-a;i+=l*r,u+=l**2,d+=r**2}const g=Math.sqrt(u*d);return g===0?Number.NaN:i/g}function dp(t,e){return Wa(2*(1-Xt.studentt.cdf(Math.abs(t),e)))}function up(t,e,n,a){ui(a);const i=1-a,u=Xt.studentt.inv(1-i/2,n),d=u*e;return{nivel:a,valorCritico:u,margen:d,inferior:t-d,superior:t+d}}function mi(t,e){return t.map((n,a)=>n-e[a])}function pp(t,e,n={}){const{nivelConfianza:a=.95}=n;ui(a);const i=pi(t,e),u=mi(i.medicion1,i.medicion2),d=Ke(i.medicion1),g=Ke(i.medicion2),m=Ke(u),l=u.length,r=l-1,o=m.desviacionEstandar/Math.sqrt(l);if(o===0){if(m.media===0)return{id:"t-student-relacionadas",nombre:"t de Student para muestras relacionadas",metodo:"Todas las diferencias pareadas son iguales a cero",medicion1:d,medicion2:g,diferencias:{...m,valores:u},nParejas:l,diferenciaMedia:0,errorEstandar:0,estadistico:{simbolo:"t",valor:0},gradosLibertad:r,valorP:1,intervaloConfianza:{nivel:a,valorCritico:Number.NaN,margen:0,inferior:0,superior:0},tamanioEfecto:{dZ:0,gZ:0,correlacionPareada:Jn(i.medicion1,i.medicion2)}};throw new Error("Las diferencias pareadas son constantes y no permiten estimar el error estándar de la prueba t.")}const s=m.media/o,c=dp(s,r),p=m.media/m.desviacionEstandar,f=r>1?1-3/(4*r-1):1;return{id:"t-student-relacionadas",nombre:"t de Student para muestras relacionadas",metodo:"Prueba bilateral aplicada a la media de las diferencias pareadas",medicion1:d,medicion2:g,diferencias:{...m,valores:u},nParejas:l,diferenciaMedia:m.media,errorEstandar:o,estadistico:{simbolo:"t",valor:s},gradosLibertad:r,valorP:c,intervaloConfianza:up(m.media,o,r,a),tamanioEfecto:{dZ:p,gZ:f*p,correccionHedges:f,correlacionPareada:Jn(i.medicion1,i.medicion2)}}}function mp(t){const e=t.map((u,d)=>({indice:d,diferencia:u,absoluto:Math.abs(u),signo:Math.sign(u),rango:0})).sort((u,d)=>u.absoluto-d.absoluto);let n=0,a=0,i=0;for(;n<e.length;){let u=n+1;for(;u<e.length&&e[u].absoluto===e[n].absoluto;)u+=1;const d=u-n,g=(n+1+u)/2;for(let m=n;m<u;m+=1)e[m].rango=g;d>1&&(i+=1,a+=d**3-d),n=u}return{observaciones:e,correccionEmpates:a,cantidadGruposEmpatados:i}}function fp(t,e){const n=t*(t+1)/2,a=new Array(n+1).fill(0);a[0]=1;let i=0;for(let m=1;m<=t;m+=1){for(let l=i;l>=0;l-=1)a[l]>0&&(a[l+m]+=a[l]);i+=m}const u=Math.floor(e+1e-12),d=a.slice(0,u+1).reduce((m,l)=>m+l,0),g=2**t;return Wa(2*d/g)}function gp(t,e){const n=pi(t,e),a=mi(n.medicion1,n.medicion2),i=Ke(n.medicion1),u=Ke(n.medicion2),d=a.filter(C=>C!==0),g=a.length-d.length;if(d.length===0)return{id:"wilcoxon-relacionadas",nombre:"Prueba de rangos con signo de Wilcoxon",metodoValorP:"Todas las diferencias pareadas son iguales a cero",medicion1:i,medicion2:u,diferencias:{n:a.length,media:0,mediana:0,varianza:0,desviacionEstandar:0,minimo:0,maximo:0,valores:a},nParejas:a.length,nEfectivo:0,cantidadCeros:g,sumaRangosPositivos:0,sumaRangosNegativos:0,estadistico:{simbolo:"W",valor:0,wPositivo:0,wNegativo:0},estadisticoZ:0,valorP:1,correccionEmpates:0,cantidadGruposEmpatados:0,tamanioEfecto:{correlacionBiserialRangos:0,r:0}};const{observaciones:m,correccionEmpates:l,cantidadGruposEmpatados:r}=mp(d),o=m.filter(({signo:C})=>C>0).reduce((C,I)=>C+I.rango,0),s=m.filter(({signo:C})=>C<0).reduce((C,I)=>C+I.rango,0),c=d.length,p=c*(c+1)/2,f=Math.min(o,s),b=c*(c+1)/4,x=c*(c+1)*(2*c+1)/24-l/48;if(x<=0)throw new Error("No fue posible calcular la varianza del estadístico de Wilcoxon.");const w=Math.sqrt(x),h=o-b,v=h===0?0:Math.sign(h)*.5,y=(h-v)/w,E=l===0&&c<=25,k=E?fp(c,f):Wa(2*(1-Xt.normal.cdf(Math.abs(y),0,1))),A=(o-s)/p;return{id:"wilcoxon-relacionadas",nombre:"Prueba de rangos con signo de Wilcoxon",metodoValorP:E?"Valor p bilateral exacto; las diferencias iguales a cero se excluyen":"Aproximación normal bilateral con corrección por continuidad y empates; las diferencias iguales a cero se excluyen",medicion1:i,medicion2:u,diferencias:{...Ke(a),valores:a},nParejas:a.length,nEfectivo:c,cantidadCeros:g,sumaRangosPositivos:o,sumaRangosNegativos:s,estadistico:{simbolo:"W",valor:f,wPositivo:o,wNegativo:s},estadisticoZ:y,valorP:k,correccionEmpates:l,cantidadGruposEmpatados:r,tamanioEfecto:{correlacionBiserialRangos:A,r:y/Math.sqrt(c)}}}function bp({medicion1:t,medicion2:e,prueba:n,nivelConfianza:a=.95}){switch(n){case"student-pareada":return pp(t,e,{nivelConfianza:a});case"wilcoxon":return gp(t,e);default:throw new Error("La prueba solicitada no está disponible.")}}function hp(){const t=document.createElement("section");t.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,t.innerHTML=`
...
17`,l(),wa(n),a.classList.add("hidden");return}s==="limpiar"&&(e.reset(),i.value="",u.value="",l(),wa(n),a.innerHTML="",a.classList.add("hidden"))}),t}function xa(t,e){return`
    ...
    `}function Qn(t,e){const n=t.trim();if(!n)throw new Error(`${e} no contiene datos.`);const a=n.split(/[\s;]+/).filter(Boolean),i=a.map(d=>Number(d.replace(",","."))),u=i.findIndex(d=>!Number.isFinite(d));if(u!==-1)throw new Error(`${e} contiene un valor no válido: "${a[u]}".`);if(i.length<2)throw new Error(`${e} debe contener al menos dos observaciones.`);return i}function Yn(t){return t.trim()?t.trim().split(/[\s;]+/).filter(Boolean).length:0}function Zn(t){return t===1?"1 valor":`${t} valores`}function vp(t,e){t.textContent=e,t.classList.remove("hidden")}function wa(t){t.textContent="",t.classList.add("hidden")}function $(t,e=4){return Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):"—"}function xp(t){return Number.isFinite(t)?t<.001?"< 0.001":$(t,4):"—"}function wp(t,e=.95){const n=1-e,a=t.valorP<n,i=n.toFixed(2),u=Math.round(e*100),d=t.id==="t-student-relacionadas"?t.diferenciaMedia:t.diferencias.mediana,g=yp(d),m=a?`Se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %. ${g}`:`No se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${i}, correspondiente a un nivel de confianza del ${u} %. ${g}`;return`
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ${Ct(t.estadistico.simbolo,$(t.estadistico.valor),"Estadístico")}
                    ${Ct("p",xp(t.valorP),"Valor bilateral")}
                    ${Ct("n",t.nParejas,"Parejas originales")}
                    ${Ct("Δ",$(d),t.id==="t-student-relacionadas"?"Diferencia media":"Diferencia mediana")}
                </div>
    ...
    `}function yp(t){return Number.isFinite(t)?t>0?"La dirección estimada favorece valores mayores en la medición 1.":t<0?"La dirección estimada favorece valores mayores en la medición 2.":"La diferencia central estimada es igual a cero.":""}function Ct(t,e,n){return`
        <article class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
    ...
    `}function Xn(t,e){return`
        <article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <dl class="grid grid-cols-2 gap-4">
                ${R("Media",$(e.media))}
                ${R("Mediana",$(e.mediana))}
                ${R("Desviación estándar",$(e.desviacionEstandar))}
                ${R("Varianza",$(e.varianza))}
                ${R("Mínimo",$(e.minimo))}
                ${R("Máximo",$(e.maximo))}
            </dl>
        </article>
    `}function Ep(t){return`
        <article class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-6">
            ...
            <dl class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ${R("Media",$(t.media))}
                ${R("Mediana",$(t.mediana))}
                ${R("Desviación estándar",$(t.desviacionEstandar))}
                ${R("Varianza",$(t.varianza))}
                ${R("Mínimo",$(t.minimo))}
                ${R("Máximo",$(t.maximo))}
            </dl>
        </article>
    `}function kp(t){if(t.id==="wilcoxon-relacionadas")return`
            <article class="mt-6 rounded-2xl border border-fuchsia-200 bg-fuchsia-50 p-6">
                ...
                <dl class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ${R("Rangos positivos, W+",$(t.sumaRangosPositivos))}
                    ${R("Rangos negativos, W−",$(t.sumaRangosNegativos))}
                    ${R("Parejas no nulas",t.nEfectivo)}
                    ${R("Diferencias iguales a cero",t.cantidadCeros)}
                    ${R("z aproximado",$(t.estadisticoZ))}
                    ${R("Correlación biserial de rangos",$(t.tamanioEfecto.correlacionBiserialRangos))}
                    ${R("Correlación r",$(t.tamanioEfecto.r))}
        ...
        <article class="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-6">
            ...
            <dl class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ${R("Diferencia media",$(t.diferenciaMedia))}
                ${R("Error estándar",$(t.errorEstandar))}
                ${R("Grados de libertad",$(t.gradosLibertad))}
                ${R(`IC ${e.nivel*100} %: límite inferior`,$(e.inferior))}
                ${R(`IC ${e.nivel*100} %: límite superior`,$(e.superior))}
                ${R("d_z de Cohen",$(t.tamanioEfecto.dZ))}
                ${R("g_z corregida",$(t.tamanioEfecto.gZ))}
                ${R("Correlación entre mediciones",$(t.tamanioEfecto.correlacionPareada))}
            </dl>
        </article>
    ...
    `}const Le=Yt.jStat??Ga?.jStat;if(!Le)throw new Error("No fue posible cargar el motor estadístico jStat.");const ea=t=>Math.min(1,Math.max(0,t));function Ka(t){if(!Number.isFinite(t)||t<=0||t>=1)throw new RangeError("El nivel de confianza debe estar entre 0 y 1.")}function Ap(t){return typeof t=="string"?t.trim()===""?Number.NaN:Number(t.trim().replace(",",".")):Number(t)}const fi=t=>t.reduce((e,n)=>e+n,0)/t.length;function Cp(t){const e=[...t].sort((a,i)=>a-i),n=Math.floor(e.length/2);return e.length%2?e[n]:(e[n-1]+e[n])/2}function Ip(t,e=fi(t)){return t.reduce((n,a)=>n+(a-e)**2,0)/(t.length-1)}function Pp(t){const e=fi(t),n=Ip(t,e);return{n:t.length,media:e,mediana:Cp(t),varianza:n,desviacionEstandar:Math.sqrt(n),minimo:Math.min(...t),maximo:Math.max(...t)}}function _p(t,e){const n=Array.isArray(t),a=n?t:t?.valores;if(!Array.isArray(a))throw new TypeError(`El grupo ${e+1} debe contener un arreglo llamado valores.`);const i=a.map(Ap),u=i.findIndex(g=>!Number.isFinite(g));if(u!==-1)throw new TypeError(`El grupo ${e+1} contiene un valor no numérico en la posición ${u+1}.`);if(i.length<2)throw new RangeError(`El grupo ${e+1} debe contener al menos dos observaciones.`);return{nombre:(n?"":String(t?.nombre??"").trim())||`Grupo ${e+1}`,valores:i,...Pp(i)}}function Ja(t){if(!Array.isArray(t))throw new TypeError("Los grupos deben proporcionarse mediante un arreglo.");if(t.length<3)throw new RangeError("El análisis requiere al menos tres grupos independientes.");const e=t.map(_p),n=e.map(({nombre:a})=>a);if(new Set(n).size!==n.length)throw new Error("Cada grupo debe tener un nombre diferente.");return e}function ja(t){const e=t.reduce((a,i)=>a+i.n,0),n=t.reduce((a,i)=>a+i.valores.reduce((u,d)=>u+d,0),0);return{numeroGrupos:t.length,nTotal:e,mediaGeneral:n/e}}function gi(t,e,n){return t===1/0?0:ea(1-Le.centralF.cdf(t,e,n))}function Tp(t,e){return ea(1-Le.chisquare.cdf(t,e))}function bi(){if(!Le.tukey?.cdf||!Le.tukey?.inv)throw new Error("La distribución de Tukey no está disponible en la versión instalada de jStat.")}function hi(t,e,n){return bi(),t===1/0?0:ea(1-Le.tukey.cdf(t,e,n))}function vi(t,e,n){return bi(),Le.tukey.inv(t,e,n)}function Qa(t){const e=Math.abs(t);return e<.01?"Prácticamente nulo":e<.06?"Pequeño":e<.14?"Moderado":"Grande"}function Ya(t,e){const n=[];for(let a=0;a<t.length-1;a+=1)for(let i=a+1;i<t.length;i+=1)n.push(e(t[a],t[i],a,i));return n}function Lp(t,e,n,a){const i=1-a,u=t.length,d=vi(a,u,n);return{id:"tukey-kramer",nombre:"Comparaciones de Tukey–Kramer",metodo:"Rango studentizado con control del error familiar.",recomendado:!1,comparaciones:Ya(t,(g,m)=>{const l=g.media-m.media,r=Math.sqrt(e/2*(1/g.n+1/m.n)),o=r===0?l===0?0:1/0:Math.abs(l)/r,s=hi(o,u,n),c=d*r;return{grupo1:g.nombre,grupo2:m.nombre,diferenciaMedias:l,errorEstandar:r,estadisticoQ:o,gradosLibertad:n,valorP:s,valorPAjustado:s,intervaloConfianza:{nivel:a,inferior:l-c,superior:l+c,margen:c},significativo:s<i}})}}function Rp(t,e){const n=1-e,a=t.length;return{id:"games-howell",nombre:"Comparaciones de Games–Howell",metodo:"Comparaciones pareadas robustas ante varianzas y tamaños desiguales.",recomendado:!1,comparaciones:Ya(t,(i,u)=>{const d=i.media-u.media,g=i.varianza/i.n,m=u.varianza/u.n,l=g+m,r=Math.sqrt(l/2),o=l**2/(g**2/(i.n-1)+m**2/(u.n-1)),s=r===0?d===0?0:1/0:Math.abs(d)/r,c=hi(s,a,o),p=vi(e,a,o)*r;return{grupo1:i.nombre,grupo2:u.nombre,diferenciaMedias:d,errorEstandar:r,estadisticoQ:s,gradosLibertad:o,valorP:c,valorPAjustado:c,intervaloConfianza:{nivel:e,inferior:d-p,superior:d+p,margen:p},significativo:c<n}})}}function $p(t){const e=t.map(u=>({...u,rango:0})).sort((u,d)=>u.valor-d.valor);let n=0,a=0,i=0;for(;n<e.length;){let u=n+1;for(;u<e.length&&e[u].valor===e[n].valor;)u+=1;const d=u-n,g=(n+1+u)/2;for(let m=n;m<u;m+=1)e[m].rango=g;d>1&&(i+=1,a+=d**3-d),n=u}return{observaciones:e,sumaCorreccionEmpates:a,cantidadGruposEmpatados:i}}function Dp(t){const e=t.map((a,i)=>({...a,indiceOriginal:i})).sort((a,i)=>a.valorP-i.valorP);let n=0;return e.forEach((a,i)=>{const u=Math.min(1,a.valorP*(e.length-i));a.valorPAjustado=Math.max(n,u),n=a.valorPAjustado}),e.sort((a,i)=>a.indiceOriginal-i.indiceOriginal).map(({indiceOriginal:a,...i})=>i)}function Np(t,e,n,a,i){const u=1-i,d=n*(n+1)/12-a/(12*(n-1)),g=Ya(t,(m,l,r,o)=>{const s=e[r]/m.n,c=e[o]/l.n,p=s-c,f=Math.sqrt(d*(1/m.n+1/l.n)),b=f===0?0:p/f,x=ea(2*(1-Le.normal.cdf(Math.abs(b),0,1)));return{grupo1:m.nombre,grupo2:l.nombre,rangoMedio1:s,rangoMedio2:c,diferenciaRangos:p,errorEstandar:f,estadisticoZ:b,valorP:x,tamanioEfectoR:b/Math.sqrt(n)}});return{id:"dunn-holm",nombre:"Comparaciones de Dunn con ajuste de Holm",metodo:"Comparaciones de rangos con corrección secuencial de Holm.",recomendado:!1,comparaciones:Dp(g).map(m=>({...m,significativo:m.valorPAjustado<u}))}}function Op(t,e={}){const{nivelConfianza:n=.95}=e;Ka(n);const a=Ja(t),i=ja(a),u=a.reduce((v,y)=>v+y.n*(y.media-i.mediaGeneral)**2,0),d=a.reduce((v,y)=>v+y.valores.reduce((E,k)=>E+(k-y.media)**2,0),0),g=u+d,m=a.length-1,l=i.nTotal-a.length,r=u/m,o=d/l,s=o===0?r===0?0:1/0:r/o,c=gi(s,m,l),p=g===0?0:u/g,f=g+o===0?0:(u-m*o)/(g+o),b=Math.max(0,f),x=1-n,w=c<x,h=Lp(a,o,l,n);return h.recomendado=w,{id:"anova-un-factor",nombre:"ANOVA de un factor",metodo:"ANOVA clásico para tres o más grupos independientes con varianzas homogéneas.",grupos:a,...i,estadistico:{simbolo:"F",valor:s},gradosLibertad:{numerador:m,denominador:l},valorP:c,nivelConfianza:n,alfa:x,significativo:w,tablaAnova:{entreGrupos:{sumaCuadrados:u,gradosLibertad:m,cuadradoMedio:r},dentroGrupos:{sumaCuadrados:d,gradosLibertad:l,cuadradoMedio:o},total:{sumaCuadrados:g,gradosLibertad:i.nTotal-1}},tamanioEfecto:{etaCuadrado:p,omegaCuadrado:b,interpretacion:Qa(b)},postHoc:h}}function Sp(t,e={}){const{nivelConfianza:n=.95}=e;Ka(n);const a=Ja(t),i=ja(a),u=a.find(({varianza:y})=>y<=0);if(u)throw new Error(`El ANOVA de Welch requiere varianza positiva en cada grupo. Revise ${u.nombre}.`);const d=a.map(y=>({...y,peso:y.n/y.varianza})),g=d.reduce((y,E)=>y+E.peso,0),m=d.reduce((y,E)=>y+E.peso*E.media,0)/g,l=a.length,r=l-1,o=d.reduce((y,E)=>y+E.peso*(E.media-m)**2,0)/r,s=d.reduce((y,E)=>y+(1-E.peso/g)**2/(E.n-1),0),c=1+2*(l-2)/(l**2-1)*s,p=o/c,f=(l**2-1)/(3*s),b=gi(p,r,f),x=Math.max(0,r*(p-1)/(r*p+f+1)),w=1-n,h=b<w,v=Rp(a,n);return v.recomendado=h,{id:"anova-welch",nombre:"ANOVA de Welch",metodo:"ANOVA robusto para tres o más grupos independientes sin exigir igualdad de varianzas.",grupos:a,...i,mediaPonderada:m,sumaPesos:g,estadistico:{simbolo:"F_W",valor:p},gradosLibertad:{numerador:r,denominador:f},valorP:b,nivelConfianza:n,alfa:w,significativo:h,componentesWelch:{numeradorBase:o,terminoCorreccion:s,denominadorCorreccion:c},tamanioEfecto:{omegaCuadradoAproximado:x,interpretacion:Qa(x),nota:"Estimación aproximada basada en el estadístico F de Welch y sus grados de libertad."},postHoc:v}}function zp(t,e={}){const{nivelConfianza:n=.95}=e;Ka(n);const a=Ja(t),i=ja(a),u=a.flatMap((w,h)=>w.valores.map(v=>({valor:v,indiceGrupo:h}))),d=$p(u),g=new Array(a.length).fill(0);d.observaciones.forEach(({indiceGrupo:w,rango:h})=>{g[w]+=h});const m=12/(i.nTotal*(i.nTotal+1))*a.reduce((w,h,v)=>w+g[v]**2/h.n,0)-3*(i.nTotal+1),l=1-d.sumaCorreccionEmpates/(i.nTotal**3-i.nTotal),r=l<=0?0:m/l,o=a.length-1,s=Tp(r,o),c=Math.max(0,(r-a.length+1)/(i.nTotal-a.length)),p=1-n,f=s<p,b=a.map((w,h)=>({...w,sumaRangos:g[h],rangoMedio:g[h]/w.n})),x=Np(a,g,i.nTotal,d.sumaCorreccionEmpates,n);return x.recomendado=f,{id:"kruskal-wallis",nombre:"Prueba de Kruskal–Wallis",metodo:"Comparación no paramétrica de tres o más grupos independientes mediante rangos.",grupos:b,...i,estadistico:{simbolo:"H",valor:r,sinCorreccion:m},gradosLibertad:{valor:o},valorP:s,nivelConfianza:n,alfa:p,significativo:f,empates:{factorCorreccion:l,sumaCorreccion:d.sumaCorreccionEmpates,cantidadGruposEmpatados:d.cantidadGruposEmpatados},tamanioEfecto:{epsilonCuadrado:c,interpretacion:Qa(c)},postHoc:x}}function Mp({grupos:t,prueba:e,nivelConfianza:n=.95}){switch(e){case"anova-un-factor":case"anova":return Op(t,{nivelConfianza:n});case"anova-welch":case"welch":return Sp(t,{nivelConfianza:n});case"kruskal-wallis":return zp(t,{nivelConfianza:n});default:throw new Error("La prueba solicitada no está disponible.")}}function Up(){const t=document.createElement("section");t.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,t.innerHTML=`
...
74"
    ...
    `}function qp(t){return[...t.querySelectorAll("[data-grupo]")].map((e,n)=>{const a=e.querySelector("[data-nombre-grupo]").value.trim();if(!a)throw new Error(`El grupo ${n+1} debe tener un nombre.`);const i=e.querySelector("[data-valores-grupo]").value;return{nombre:a,valores:Fp(i,a)}})}function Fp(t,e){const n=t.trim();if(!n)throw new Error(`${e} no contiene datos.`);const a=n.split(/[\s;]+/).filter(Boolean),i=a.map(d=>Number(d.replace(",","."))),u=i.findIndex(d=>!Number.isFinite(d));if(u!==-1)throw new Error(`${e} contiene un valor no válido: "${a[u]}".`);if(i.length<2)throw new Error(`${e} debe contener al menos dos observaciones.`);return i}function Bp(t){return t.trim()?t.trim().split(/[\s;]+/).filter(Boolean).length:0}function xi(t){if(!t)return;const e=t.querySelector("[data-valores-grupo]"),n=t.querySelector("[data-contador-grupo]"),a=Bp(e.value);n.textContent=a===1?"1 valor":`${a} valores`}function Vp(t,e){e.innerHTML=`
        ${re(1)}
        ${re(2)}
        ${re(3)}
...
88`}];[...e.querySelectorAll("[data-grupo]")].forEach((a,i)=>{a.querySelector("[data-nombre-grupo]").value=n[i].nombre,a.querySelector("[data-valores-grupo]").value=n[i].valores,xi(a)}),t.elements.prueba.value||(t.elements.prueba.value="anova-un-factor")}function er(t,e){t.textContent=e,t.classList.remove("hidden")}function tt(t){t.textContent="",t.classList.add("hidden")}function ce(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function N(t,e=4){return t===1/0?"∞":Number.isFinite(t)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:e}).format(t):"—"}function wi(t){return Number.isFinite(t)?t<.001?"< 0.001":N(t,4):"—"}function Hp(t){const e=t.alfa.toFixed(2),n=Math.round(t.nivelConfianza*100),a=t.significativo?`Se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${e}, correspondiente a un nivel de confianza del ${n} %.`:`No se observa evidencia estadísticamente significativa de diferencias entre los grupos al nivel α = ${e}, correspondiente a un nivel de confianza del ${n} %.`;return`
    ...
    `}function Gp(t){const e=t.id==="kruskal-wallis";return`
    ...
    `}function Wp(t){if(t.id==="anova-un-factor"){const e=t.tablaAnova;return`
    ...
    `}function Kp(t){let e;return t.id==="anova-un-factor"?e=[["Eta cuadrado, η²",t.tamanioEfecto.etaCuadrado],["Omega cuadrado, ω²",t.tamanioEfecto.omegaCuadrado]]:t.id==="anova-welch"?e=[["Omega cuadrado aproximado",t.tamanioEfecto.omegaCuadradoAproximado]]:e=[["Épsilon cuadrado, ε²",t.tamanioEfecto.epsilonCuadrado]],`
        <article class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-6">
            <h3 class="text-xl font-black text-amber-950 mb-5">
                Tamaño del efecto
            </h3>
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[980px] text-sm">
                    ...
                    <tbody class="divide-y divide-fuchsia-100">
                        ${e.comparaciones.map(jp).join("")}
                    </tbody>
                </table>
            </div>
        </article>
    `:""}function jp(t){const e=t.diferenciaMedias??t.diferenciaRangos,n=t.estadisticoQ??t.estadisticoZ,a=t.valorPAjustado??t.valorP,i=t.intervaloConfianza?`${N(t.intervaloConfianza.inferior)} a ${N(t.intervaloConfianza.superior)}`:"—";return`
        <tr>
            <td class="px-5 py-4 font-bold text-slate-900">
    ...
    `}const Qp={home:{page:Bi,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:so,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:go,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:wo,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:Oo,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Fo,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:as,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:jo,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:ps,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:vs,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:yu,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Tu,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},comparacionGrupos:{page:Bu,layout:"default",title:"Comparación de grupos y mediciones | El Kernel"},calculadoraDosGrupos:{page:ap,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:hp,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"},calculadoraTresOMasGrupos:{page:Up,layout:"default",title:"Comparación de tres o más grupos independientes | El Kernel"}};let tr=document.referrer||"";function ta(t){window.location.hash=`/${t}`}function Yp(){const t=()=>{const e=window.location.hash.replace("#/","")||"home";Xp(e)};window.addEventListener("hashchange",t),t()}function Zp(t,e){const n=`${window.location.origin}${window.location.pathname}#/${t}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:e,page_location:n,page_referrer:tr}),tr=n}async function Xp(t){const e=document.querySelector("main"),n=Qp[t];if(!e)return;if(e.innerHTML="",!n){ta("home");return}bo(n.layout),document.title=n.title;const a=await n.page();e.appendChild(a),window.scrollTo({top:0,behavior:"auto"}),Zp(t,n.title)}function em(t,e){ar(t,ta),Yp();const n=window.matchMedia("(max-width: 768px)");let a=!1;function i(d){d.matches&&!a&&(Za(t),a=!0)}n.addEventListener("change",i),i(n),Za(t);const u=e.querySelector('[data-action ="open-menu"]');Ii(u,t),Pi(t)}const yi=document.querySelector("#header");yi.innerHTML=ki();const Ei=document.querySelector("#navBar");Ei.innerHTML=Ai();const tm=document.querySelector("#footer");tm.innerHTML=Ci();em(Ei,yi);
