(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();const ie=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Ae(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function Ee(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${ie}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function pe(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function je(e){pe(e,ee)}const ue=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Ie=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,ze=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,ne=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${ue}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${Ie}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function Fe(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=ne.length,r=1500;let n=0,c=null;function h(d){return(d%o+o)%o}function v(){i.innerHTML=ne[n].content}function p(d){n=h(n+d),v()}function E(){f(),c=setInterval(()=>p(1),r)}function f(){c&&(clearInterval(c),c=null)}function u(){E()}v(),E(),t.addEventListener("click",()=>{p(1),u()}),a.addEventListener("click",()=>{p(-1),u()})}function Te(){const e=`
        <section class="
    ...
    `,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return Fe(a.querySelector("#containerFather")),je(a.querySelector("#btnsGroup")),a}const Be="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function Ne(){try{const e=await fetch(Be,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const t=await e.json();if(!t.ok||!t.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(t.visitantes.total)||0,hoy:Number(t.visitantes.hoy)||0,ultimos7Dias:Number(t.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(t.visitantes.ultimos30Dias)||0,actualizadoEn:t.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function Y(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function qe(e){if(!e)return null;const t=new Date(e);return Number.isNaN(t.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(t)}async function Ue(e){const t=e.querySelector("#analytics-total"),a=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),r=e.querySelector("#analytics-actualizado");if(!t||!a||!i||!o||!r){console.warn("No se encontraron los elementos de Analytics en la portada.");return}r.textContent="Cargando estadísticas…";try{const n=await Ne();t.textContent=Y(n.total),a.textContent=Y(n.hoy),i.textContent=Y(n.ultimos7Dias),o.textContent=Y(n.ultimos30Dias);const c=qe(n.actualizadoEn);r.textContent=c?`Actualizado: ${c}`:"Estadísticas temporalmente no disponibles"}catch(n){console.error("Error al mostrar las estadísticas en la portada:",n),t.textContent="—",a.textContent="—",i.textContent="—",o.textContent="—",r.textContent="No fue posible cargar las estadísticas"}}function Re(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=Pe();const t=Te();return e.appendChild(t),Ue(e),e}function Oe(){return Re()}const Ge=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Ke(){return`
        <section 
            role="banner" 
    ...
    `}const We="data:image/png;base64,",Xe="data:image/png;base64,",_e="data:image/png;base64,",Ze="data:image/png;base64,",et="data:image/png;base64,",tt=[{icon:We,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:Xe,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:_e,title:"Objetivos",content:`
      ...
      </ul>`},{icon:Ze,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function it({icon:e,title:t,content:a}){return`
  ...
  `}function ot(){const e=document.createElement("section");return e.className=`
    ...
    `,e.innerHTML=`
        ...
        ${Ye()}
        ${at()}
    `,e}function st(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),r=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(n=>{n.classList.remove("max-h-[1000px]"),n.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(n=>{n.classList.remove("rotate-180")}),r||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function rt(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function nt(){const e=ot();return st(e),rt(e),e}function T(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function lt(e=[]){return!e||e.length===0?`
        ...
        <a href="${T(t.url)}" 
           ...
           title="${T(t.name)}">
            <i class="${T(t.icon)} text-xl"></i>
        </a>
    `).join("")}function ct(e){return e?String(e).split(",").map(a=>a.trim()).filter(Boolean).slice(0,4).map(a=>`
    ...
    `).join(""):""}function dt(e){const t=document.createElement("article");t.className=`
    ...
    `;const a=lt(e.redes||[]),i=ct(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return t.innerHTML=`
    ...
    `,t}const me=""+new URL("rad-B3ff1btG.png",import.meta.url).href,xe=""+new URL("mar-Cru0HERG.png",import.meta.url).href,K=[{img:X,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:Z,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:me,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:oe,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:xe,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:_,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:Q,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function pt(){let e=0,t=null,a=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,r=()=>{const u=o();return Math.max(K.length-u,0)},n=()=>{const u=r();e>u&&(e=0),e<0&&(e=u)},c=()=>{const u=r();e>=u?e=0:e++,f()},h=()=>{const u=r();e<=0?e=u:e--,f()},v=()=>{p(),K.length>o()&&(t=setInterval(c,4500))},p=()=>{t&&(clearInterval(t),t=null)},E=()=>{const u=o(),d=Math.max(K.length-u+1,1);return Array.from({length:d}).map((w,x)=>`
        ...
        `;const w=i.querySelector("#cards-wrapper");d.forEach(k=>{w.appendChild(dt(k))});const x=i.querySelector("#prev-btn"),y=i.querySelector("#next-btn");x&&(x.onclick=()=>{h(),v()}),y&&(y.onclick=()=>{c(),v()}),i.querySelectorAll("[data-dot-index]").forEach(k=>{k.onclick=()=>{e=parseInt(k.dataset.dotIndex),f(),v()}})};return i.addEventListener("mouseenter",p),i.addEventListener("mouseleave",v),document.addEventListener("visibilitychange",()=>{document.hidden?p():v()}),window.addEventListener("resize",()=>{clearTimeout(a),a=setTimeout(()=>{e=0,f(),v()},150)}),f(),v(),i}function ut(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-route]");if(!a)return;const i=window.location.hash.replace("#/","")||"equipment";a.dataset.route!==i&&ee(a.dataset.route)})}function be(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",t=document.createElement("nav"),a="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return t.className="w-full flex justify-center mb-6",t.innerHTML=`
    ...
    `,ut(t),t}function mt(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=document.createElement("div");t.className="mb-6",t.appendChild(be());const a=pt();return e.appendChild(t),e.appendChild(a),e}function xt(){return mt()}function bt(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function z(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ge(e){return e.formacion?.length||0}function fe(e){return e.experiencia?.length||0}function gt(e,t=!1){const a=ge(e),i=fe(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function ft(e){const t=e.formacion||[],a=e.experiencia||[],i=t.length?t.map(c=>`
    ...
    `}function N(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function St({id:e,title:t,date:a,image:i,imageAlt:o,excerpt:r,category:n="Noticia",imageFit:c="contain"}){const h=c==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${N(e)}"
            class="
        ...
        >
            ...
            <div class="p-4 space-y-3 flex flex-col flex-1">
                ...
                <button
                    type="button"
                    data-news-btn="${N(e)}"
                    aria-label="Ver detalles de la noticia ${N(t)}"
                    class="
    ...
    `}function Lt(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),t=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function Dt(e=[]){return[...e].sort((t,a)=>t.featured&&!a.featured?-1:!t.featured&&a.featured?1:0)}function $t(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const t=Dt(he),a=t.find(i=>i.featured)||t[0];return e.innerHTML=`
        ${Et(a)}
        ${Mt(t)}
        ${Lt()}
    `,e}function Pt({title:e,content:t={paragraphs:[],list:[]},articleURL:a}){const i=(t.paragraphs||[]).map(n=>`<p>${n}</p>`).join(""),o=(t.list||[]).length?`
    ...
    `}function jt(e){e&&e.addEventListener("click",t=>{const a=t.target.closest("[data-news-btn], [data-news-card]");if(!a||!e.contains(a))return;const i=a.dataset.newsBtn||a.dataset.newsCard,o=he.find(r=>String(r.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}It(o)})}function It(e){const t=document.querySelector("#newsModal");t&&t.remove();const a=document.createElement("div");a.innerHTML=Pt(e);const i=a.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",r)}function r(n){n.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(n=>{n.addEventListener("click",o)}),i.addEventListener("click",n=>{n.target===i&&o()}),document.addEventListener("keydown",r)}function zt(){const e=$t();return jt(e),e}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ve(e){return e?.name||e?.title||"Investigador"}function le(e){return e?.title||e?.tile||"Revista no especificada"}function we(e){return String(e?.DOI||e?.doi||"").trim()}function Ft(e){const t=we(e);return e?.url?e.url:t?t.startsWith("http")?t:`https://doi.org/${t}`:"#"}function Tt(e){return[...e?.publicaciones||[]].sort((t,a)=>{const i=Number(t.year||0),o=Number(a.year||0);return i!==o?o-i:String(t.contenido||"").localeCompare(String(a.contenido||""))})}function Bt(e,t=!1){const a=ve(e),i=e.publicaciones||[],o=i.length,r=i.map(c=>Number(c.year)).filter(Boolean),n=r.length?Math.max(...r):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${t?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function Nt(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const t=ve(e),a=Tt(e),i=a.length,o=a.map(p=>Number(p.year)).filter(Boolean),r=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",c=[...new Set(a.map(p=>p.q).filter(Boolean))],h=[...new Set(a.map(p=>le(p)).filter(Boolean))],v=a.map(p=>{const E=le(p),f=we(p),u=Ft(p);return`
    ...
    `}function qt(){let e=B[0]?.id||1,t=!1,a=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(d){return String(d?.DOI||d?.doi||"").trim().toLowerCase()}function r(d){return String(d?.journal||d?.title||d?.tile||"").trim()}function n(d){return String(d?.articleTitle||d?.contenido||"").trim()}function c(d){return String(d?.q||d?.quartile||"").trim().toUpperCase()}function h(d){const w=o(d);return w||[d?.year||"",r(d),n(d)].join("-").trim().toLowerCase()}function v(){const d=new Map;return B.forEach(w=>{(w.publicaciones||[]).forEach(x=>{const y=h(x);y&&!d.has(y)&&d.set(y,x)})}),Array.from(d.values())}function p(){const d=v(),w=d.map(L=>Number(L.year)).filter(Boolean),x=w.length?Math.max(...w):"—",y=w.length?Math.min(...w):"—",k=d.filter(L=>c(L)==="Q1").length;return{totalPublicaciones:d.length,investigadores:B.length,q1:k,primerYear:y,ultimoYear:x}}function E(){return B.find(d=>Number(d.id)===Number(e))||B[0]}const f=()=>{const d=E(),w=p(),x=window.innerWidth<768&&!t;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${B.map(k=>Bt(k,Number(k.id)===Number(e))).join("")}
                </aside>
    ...
    `).join("")}function Gt(e=[]){return e.map(t=>`
    ...
    `}function Vt(e){const t=e.proyectosAsociados&&e.proyectosAsociados.length>0,a=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function Ht(){const e=new Set(O.map(i=>i.categoria)),t=O.filter(i=>i.proyectosAsociados?.length>0).length,a=O.filter(i=>i.publicacionesClave?.length>0).length;return{total:O.length,categorias:e.size,conProyectos:t,conPublicaciones:a}}function Jt(){let e=O[0]?.id||1;const t=document.createElement("section");t.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=Rt(e),o=Ht();t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function ea(){let e=J[0]?.id||1;const t=document.createElement("section");t.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=Yt(e);t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,t.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),a()}})};return a(),t}function ta(){return ea()}function aa(){return`
    ...
    `}function oa(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${ia()}
    `,e}function sa(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",ra)}async function ra(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=na(i);if(o.length>0){ca(o);return}await da(t,i)}function na(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?la(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function la(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function ca(e){W(e[0],"error")}function W(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function da(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(W("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):W("Hubo un problema al enviar el mensaje.","error")}catch{W("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function pa(){const e=oa();return setTimeout(()=>{sa()},0),e}function ua(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
A00116736    20"
    ...
    `;const t=e.querySelector("#banner-final-input"),a=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),r=e.querySelector("#banner-final-preview"),n=e.querySelector("#banner-final-count"),c=e.querySelector("#banner-final-download");let h=[];function v(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function p(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function E(l){const m=String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return m.includes("	")?m.split("	").map(s=>s.trim()).filter(s=>s!==""):m.includes(";")?m.split(";").map(s=>s.trim()).filter(s=>s!==""):m.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function f(l){return Number.isInteger(l)?String(l):l.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function u(l){return String(l).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function d(l,m="success"){o.textContent=l,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),m==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(l){const m=l.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),s=[],g=[],b=new Set;return m.forEach((C,j)=>{const A=j+1,D=E(C);if(D.length!==2){g.push(`Línea ${A}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const S=v(D[0]),P=Number(p(D[1]));if(!/^A[0-9]{8}$/.test(S)){g.push(`Línea ${A}: la matrícula "${S}" no es válida. Debe tener el formato A00108671.`);return}if(b.has(S)){g.push(`Línea ${A}: la matrícula ${S} está repetida.`);return}if(!Number.isFinite(P)){g.push(`Línea ${A}: la calificación 4EF no es numérica.`);return}if(P<0||P>30){g.push(`Línea ${A}: 4EF debe estar entre 0 y 30.`);return}b.add(S),s.push({matricula:S,grade4EF:P})}),{records:s,errors:g}}function x(l){if(l.length===0){r.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
...
};`,o.disabled=!0}function f(x,y="success"){n.textContent=x,n.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),n.classList.add("border"),y==="error"?n.classList.add("border-red-200","bg-red-50","text-red-800"):n.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function u(x){const y=x.split(/\r?\n/).map(m=>m.trim()).filter(Boolean),k=[],L=[],l=new Set;return y.forEach((m,s)=>{const g=m.split(/[\t,; ]+/).map(D=>D.trim()).filter(Boolean),b=s+1,C=g[0],j=g.slice(1);if(!C){L.push(`Línea ${b}: falta la matrícula.`);return}if(!/^\d+$/.test(C)){L.push(`Línea ${b}: la matrícula "${C}" no es válida.`);return}if(l.has(C)){L.push(`Línea ${b}: la matrícula ${C} está repetida.`);return}if(j.length===0){L.push(`Línea ${b}: falta al menos una calificación.`);return}const A=j.map(D=>Number(D));if(A.some(D=>!Number.isFinite(D))){L.push(`Línea ${b}: existe una calificación no numérica.`);return}l.add(C),k.push({matricula:C,grades:A})}),{records:k,errors:L}}function d(x){return`var data_todo = {
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
        ...
        `}return c.addEventListener("click",()=>{w("xmera")}),h.addEventListener("click",()=>{w("banner")}),w("xmera"),e}function fa(){return ga()}function ha(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
        ...
        <section class="
            ...
            gap-6 mt-10
        ">
            ${ae("Aprender","Comprenda qué mide cada estadístico, cuándo debe utilizarse, cuáles son sus supuestos y cómo se interpreta correctamente.","libro","bg-sky-100","text-sky-700","border-sky-200")}

            ${ae("Decidir","Identifique la prueba adecuada según el objetivo, el tipo de variable, el número de grupos y el diseño de su investigación.","decision","bg-amber-100","text-amber-700","border-amber-200")}

            ${ae("Analizar","Introduzca sus datos, ejecute el análisis, interprete los resultados y genere reportes metodológicamente adecuados.","analisis","bg-emerald-100","text-emerald-700","border-emerald-200")}
        </section>
    ...
    `,e}function ae(e,t,a,i,o,r){return`
        <article class="
            h-full bg-white
            border border-slate-200
            rounded-3xl p-7
    ...
    `}function F(e,t="w-7 h-7"){const a=`
        class="${t}"
        viewBox="0 0 24 24"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
    ...
    `,i={analisis:`
        ...
        `};return i[e]||i.estadistica}const va={home:{page:Oe,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:nt,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:xt,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:vt,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:zt,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Ut,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:ta,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:Qt,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:pa,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:fa,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:ha,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"}};let de=document.referrer||"";function ee(e){window.location.hash=`/${e}`}function wa(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";ka(t)};window.addEventListener("hashchange",e),e()}function ya(e,t){const a=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:t,page_location:a,page_referrer:de}),de=a}function ka(e){const t=document.querySelector("main"),a=va[e];if(t){if(t.innerHTML="",!a){ee("home");return}bt(a.layout),document.title=a.title,t.appendChild(a.page()),window.scrollTo({top:0,behavior:"auto"}),ya(e,a.title)}}function Aa(e,t){pe(e,ee),wa();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(re(e),i=!0)}a.addEventListener("change",o),o(a),re(e);const r=t.querySelector('[data-action ="open-menu"]');Se(r,e),Me(e)}const ye=document.querySelector("#header");ye.innerHTML=Ae();const ke=document.querySelector("#navBar");ke.innerHTML=Ce();const Ca=document.querySelector("#footer");Ca.innerHTML=Ee();Aa(ke,ye);
