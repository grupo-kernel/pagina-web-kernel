...
>
    ...
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${Ra}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function ar(t,e){t.addEventListener("click",n=>{const a=n.target.closest(["[data-route]"]);a&&(n.preventDefault(),e(a.dataset.route))})}function $i(t){ar(t,ta)}const nr=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Di=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Ni=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,Za=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        </div>`}];function Oi(t){const e=t.querySelector("#arrowR"),n=t.querySelector("#arrowL"),a=t.querySelector("#contenedorSlide");if(!e||!n||!a)return;const i=Za.length,u=1500;let d=0,g=null;function m(p){return(p%i+i)%i}function l(){a.innerHTML=Za[d].content}function r(p){d=m(d+p),l()}function o(){s(),g=setInterval(()=>r(1),u)}function s(){g&&(clearInterval(g),g=null)}function c(){o()}l(),o(),e.addEventListener("click",()=>{r(1),c()}),n.addEventListener("click",()=>{r(-1),c()})}function Si(){const t=`
        <section class="
...
Gracias.`);return`
    ...
    `}function Uo(t){if(!t)return`
        ...
        `;const e=dr(t),n=zo(t),a=n.length,i=n.map(r=>Number(r.year)).filter(Boolean),u=i.length?Math.min(...i):"",d=i.length?Math.max(...i):"",g=[...new Set(n.map(r=>r.q).filter(Boolean))],m=[...new Set(n.map(r=>Xa(r)).filter(Boolean))],l=n.map(r=>{const o=Xa(r),s=ur(r),c=So(r);return`
...
if (!contenedor) {
  ...
  `;const n=e.querySelector("#kernel-login"),a=e.querySelector("#login-error"),i=e.querySelector("#correo"),u=e.querySelector("#password"),d=n.querySelector('button[type="submit"]');return n.addEventListener("submit",async g=>{g.preventDefault(),a.classList.add("hidden"),a.textContent="";const m=i.value.trim(),l=u.value;if(!m||!l){a.textContent="Introduzca el correo electrónico y la contraseña.",a.classList.remove("hidden");return}d.disabled=!0,d.textContent="Verificando...";try{await bu(m,l),t&&await t()}catch(r){console.error("Error de autenticación:",r);const o={"auth/invalid-email":"El correo electrónico no tiene un formato válido.","auth/invalid-credential":"El correo o la contraseña son incorrectos.","auth/user-not-found":"El correo no está autorizado.","auth/wrong-password":"El correo o la contraseña son incorrectos.","auth/user-disabled":"Este usuario está deshabilitado.","auth/too-many-requests":"Demasiados intentos. Espere unos minutos e inténtelo nuevamente.","auth/network-request-failed":"No fue posible conectarse con Firebase. Revise su conexión.","auth/unauthorized-domain":"El dominio de Grupo Kernel no está autorizado en Firebase."};a.textContent=o[r.code]||`No fue posible iniciar sesión. Error: ${r.code||"desconocido"}`,a.classList.remove("hidden")}finally{d.disabled=!1,d.textContent="Iniciar sesión"}}),e}function wu(){return new Promise(t=>{const e=vu(n=>{e(),t(n)})})}async function yu(){if(!await wu())return xu(()=>{window.dispatchEvent(new HashChangeEvent("hashchange"))});const e=document.createElement("section");return e.className=`
    ...
    `,t.addEventListener("click",e=>{const n=e.target.closest("[data-route], [data-action]");if(!n)return;if(n.dataset.action==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}const a=n.dataset.route;a&&(window.location.hash=`/${a}`)}),t}function Fn({etiqueta:t,titulo:e,descripcion:n,pruebas:a,ruta:i,textoBoton:u,clases:d}){return`
...
18"
        ...
        <section
            ...
            aria-live="polite"
        ></section>
    `;const e=t.querySelector("#formulario-dos-grupos"),n=t.querySelector("#mensaje-error"),a=t.querySelector("#resultados-dos-grupos"),i=["student","welch","mann-whitney"],u=sessionStorage.getItem("kernel-prueba-dos-grupos");i.includes(u)&&(e.elements.prueba.value=u),sessionStorage.removeItem("kernel-prueba-dos-grupos");const d=e.elements.grupo1,g=e.elements.grupo2,m=t.querySelector("#contador-grupo-1"),l=t.querySelector("#contador-grupo-2"),r=()=>{m.textContent=Gn(Hn(d.value)),l.textContent=Gn(Hn(g.value))};return d.addEventListener("input",r),g.addEventListener("input",r),e.addEventListener("submit",o=>{o.preventDefault(),ha(n);try{const s=e.elements.prueba.value;if(!s)throw new Error("Seleccione la prueba estadística que desea ejecutar.");const c=Vn(d.value,"El grupo 1"),p=Vn(g.value,"El grupo 2"),f=Number(e.elements.nivelConfianza.value),b=tp({grupo1:c,grupo2:p,prueba:s,nivelConfianza:f});a.innerHTML=ip(b,f),a.classList.remove("hidden"),a.scrollIntoView({behavior:"smooth",block:"start"})}catch(s){a.classList.add("hidden"),np(n,s instanceof Error?s.message:"No fue posible ejecutar el análisis.")}}),t.addEventListener("click",o=>{const s=o.target.closest("[data-action]");if(!s)return;const c=s.dataset.action;if(c==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}if(c==="cargar-ejemplo"){e.elements.prueba.value||(e.elements.prueba.value="welch"),d.value=`18
20
17.5
19
21
    ...
    `,t.innerHTML=`
        ...
        <section class="grid grid-cols-1 xl:grid-cols-[0.9fr_1.1fr] gap-7 mt-8">
            <aside class="rounded-3xl border border-slate-200 bg-white p-6 md:p-8 shadow-lg">
                ...
                <div class="space-y-5 text-slate-600 leading-relaxed">
                    ${va(1,"Pegue la primera medición en la columna izquierda y la segunda en la derecha.")}
                    ${va(2,"Cada fila debe corresponder al mismo participante, unidad o par emparejado.")}
                    ${va(3,"Las dos columnas deben contener exactamente la misma cantidad de observaciones.")}
                </div>
...
15
20
17`,l(),xa(n),a.classList.add("hidden");return}s==="limpiar"&&(e.reset(),i.value="",u.value="",l(),xa(n),a.innerHTML="",a.classList.add("hidden"))}),t}function va(t,e){return`
        <div class="flex items-start gap-4">
    ...
    `,t.innerHTML=`
        ...
        <section class="grid grid-cols-1 xl:grid-cols-[0.72fr_1.28fr] gap-7 mt-8">
            <aside class="rounded-3xl border border-slate-200 bg-white p-6 md:p-8 shadow-lg">
                ...
                <div class="space-y-5 text-slate-600 leading-relaxed">
                    ${wa("ANOVA de un factor","Variable cuantitativa, normalidad aproximada y varianzas homogéneas.")}
                    ${wa("ANOVA de Welch","Variable cuantitativa con varianzas desiguales o tamaños muestrales diferentes.")}
                    ${wa("Kruskal–Wallis","Datos ordinales, distribuciones no normales o presencia importante de valores atípicos.")}
                </div>
    ...
    `;const e=t.querySelector("#formulario-tres-grupos"),n=t.querySelector("#contenedor-grupos"),a=t.querySelector("#mensaje-error-tres-grupos"),i=t.querySelector("#resultados-tres-grupos");let u=4;const d=sessionStorage.getItem("kernel-prueba-tres-grupos");return["anova-un-factor","anova-welch","kruskal-wallis"].includes(d)&&(e.elements.prueba.value=d),sessionStorage.removeItem("kernel-prueba-tres-grupos"),e.addEventListener("submit",g=>{g.preventDefault(),tt(a);try{const m=e.elements.prueba.value;if(!m)throw new Error("Seleccione la prueba estadística que desea ejecutar.");const l=qp(n),r=Number(e.elements.nivelConfianza.value),o=Mp({grupos:l,prueba:m,nivelConfianza:r});i.innerHTML=Hp(o),i.classList.remove("hidden"),i.scrollIntoView({behavior:"smooth",block:"start"})}catch(m){i.classList.add("hidden"),er(a,m instanceof Error?m.message:"No fue posible ejecutar el análisis.")}}),t.addEventListener("input",g=>{g.target.matches("textarea[data-valores-grupo]")&&xi(g.target.closest("[data-grupo]"))}),t.addEventListener("click",g=>{const m=g.target.closest("[data-action]");if(!m)return;const l=m.dataset.action;if(l==="volver-comparacion"){window.location.hash="/comparacionGrupos";return}if(l==="agregar-grupo"){n.insertAdjacentHTML("beforeend",re(u)),u+=1,tt(a);return}if(l==="eliminar-grupo"){if(n.querySelectorAll("[data-grupo]").length<=3){er(a,"El análisis requiere al menos tres grupos.");return}m.closest("[data-grupo]")?.remove(),i.classList.add("hidden"),tt(a);return}if(l==="cargar-ejemplo"){Vp(e,n),u=4,tt(a),i.classList.add("hidden");return}l==="limpiar"&&(e.reset(),n.innerHTML=`
                ...
                ${re(2)}
                ${re(3)}
            `,u=4,i.innerHTML="",i.classList.add("hidden"),tt(a))}),t}function wa(t,e){return`
        <article class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full min-w-[650px] text-sm">
                        ...
                        <tbody class="divide-y divide-blue-100">
                            ${ya("Entre grupos",e.entreGrupos)}
                            ${ya("Dentro de grupos",e.dentroGrupos)}
                            ${ya("Total",e.total)}
                        </tbody>
                    </table>
                </div>
