(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();const Z=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function ve(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function re(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function Me(e){re(e,ee)}const ne=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Le=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,De=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,ie=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        </div>`}];function Pe(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=ie.length,r=1500;let n=0,d=null;function v(c){return(c%o+o)%o}function h(){i.innerHTML=ie[n].content}function p(c){n=v(n+c),h()}function E(){f(),d=setInterval(()=>p(1),r)}function f(){d&&(clearInterval(d),d=null)}function u(){E()}h(),E(),t.addEventListener("click",()=>{p(1),u()}),a.addEventListener("click",()=>{p(-1),u()})}function je(){const e=`
        <section class="
    ...
    `,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return Pe(a.querySelector("#containerFather")),Me(a.querySelector("#btnsGroup")),a}function $e(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=`${Se()}`;const t=je();return e.appendChild(t),e}function Ie(){return $e()}const ze=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Be(){return`
        <section 
            role="banner" 
  ...
  `}function Ye(){const e=document.createElement("section");return e.className=`
    ...
    `}function T(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ft({id:e,title:t,date:a,image:i,imageAlt:o,excerpt:r,category:n="Noticia",imageFit:d="contain"}){const v=d==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${T(e)}"
            class="
...
Gracias.`);return`
    ...
    `;const t=wt(me),a=t.find(i=>i.featured)||t[0];return e.innerHTML=`
        ...
        ${vt(t)}
        ${ht()}
    `,e}function kt({title:e,content:t={paragraphs:[],list:[]},articleURL:a}){const i=(t.paragraphs||[]).map(n=>`<p>${n}</p>`).join(""),o=(t.list||[]).length?`
    ...
    `}function At(e){e&&e.addEventListener("click",t=>{const a=t.target.closest("[data-news-btn], [data-news-card]");if(!a||!e.contains(a))return;const i=a.dataset.newsBtn||a.dataset.newsCard,o=me.find(r=>String(r.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}Ct(o)})}function Ct(e){const t=document.querySelector("#newsModal");t&&t.remove();const a=document.createElement("div");a.innerHTML=kt(e);const i=a.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",r)}function r(n){n.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(n=>{n.addEventListener("click",o)}),i.addEventListener("click",n=>{n.target===i&&o()}),document.addEventListener("keydown",r)}function Et(){const e=yt();return At(e),e}function P(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function xe(e){return e?.name||e?.title||"Investigador"}function oe(e){return e?.title||e?.tile||"Revista no especificada"}function be(e){return String(e?.DOI||e?.doi||"").trim()}function St(e){const t=be(e);return e?.url?e.url:t?t.startsWith("http")?t:`https://doi.org/${t}`:"#"}function Mt(e){return[...e?.publicaciones||[]].sort((t,a)=>{const i=Number(t.year||0),o=Number(a.year||0);return i!==o?o-i:String(t.contenido||"").localeCompare(String(a.contenido||""))})}function Lt(e,t=!1){const a=xe(e),i=e.publicaciones||[],o=i.length,r=i.map(d=>Number(d.year)).filter(Boolean),n=r.length?Math.max(...r):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${t?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function Dt(e){if(!e)return`
        ...
        `;const t=xe(e),a=Mt(e),i=a.length,o=a.map(p=>Number(p.year)).filter(Boolean),r=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",d=[...new Set(a.map(p=>p.q).filter(Boolean))],v=[...new Set(a.map(p=>oe(p)).filter(Boolean))],h=a.map(p=>{const E=oe(p),f=be(p),u=St(p);return`
    ...
    `}function Pt(){let e=F[0]?.id||1,t=!1,a=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(c){return String(c?.DOI||c?.doi||"").trim().toLowerCase()}function r(c){return String(c?.journal||c?.title||c?.tile||"").trim()}function n(c){return String(c?.articleTitle||c?.contenido||"").trim()}function d(c){return String(c?.q||c?.quartile||"").trim().toUpperCase()}function v(c){const w=o(c);return w||[c?.year||"",r(c),n(c)].join("-").trim().toLowerCase()}function h(){const c=new Map;return F.forEach(w=>{(w.publicaciones||[]).forEach(x=>{const y=v(x);y&&!c.has(y)&&c.set(y,x)})}),Array.from(c.values())}function p(){const c=h(),w=c.map(L=>Number(L.year)).filter(Boolean),x=w.length?Math.max(...w):"—",y=w.length?Math.min(...w):"—",k=c.filter(L=>d(L)==="Q1").length;return{totalPublicaciones:c.length,investigadores:F.length,q1:k,primerYear:y,ultimoYear:x}}function E(){return F.find(c=>Number(c.id)===Number(e))||F[0]}const f=()=>{const c=E(),w=p(),x=window.innerWidth<768&&!t;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${F.map(k=>Lt(k,Number(k.id)===Number(e))).join("")}
                </aside>
    ...
    `}function Ft(e){const t=e.proyectosAsociados&&e.proyectosAsociados.length>0,a=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function Ht(){let e=H[0]?.id||1;const t=document.createElement("section");t.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=qt(e);t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,t.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),a()}})};return a(),t}function Kt(){return Ht()}function Vt(){return`
...
`)}function k(l,m){const s=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),g=URL.createObjectURL(s),b=document.createElement("a");b.href=g,b.download=m,document.body.appendChild(b),b.click(),b.remove(),window.setTimeout(()=>{URL.revokeObjectURL(g)},1e3)}function L(){v=[],t.value="",x([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),t.focus()}return a.addEventListener("click",()=>{const l=t.value.trim();if(!l){v=[],x([]),d.disabled=!0,c("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:m,errors:s}=w(l);if(s.length>0){v=[],x([]),d.disabled=!0,c(s.join(" "),"error");return}v=m,x(m),d.disabled=!1,c(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",L),d.addEventListener("click",()=>{v.length!==0&&k(y(v),"Banner_APEC_Examen_Final_4EF.csv")}),e}function ra(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function w(x){const y=x==="xmera";h.classList.toggle("hidden",!y),p.classList.toggle("hidden",y),d.className=y?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",v.className=y?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const x=t.value.trim();if(!x){E(),f("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:y,errors:k}=u(x);if(k.length>0){E(),f(k.join(" "),"error");return}a.textContent=c(y),o.disabled=!1,f(`Código generado correctamente para ${y.length} estudiante${y.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a.textContent),f("El código fue copiado al portapapeles.")}catch(x){console.error("No fue posible copiar el código:",x),f("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),r.addEventListener("click",()=>{t.value="",E(),n.textContent="",n.classList.add("hidden"),t.focus()});try{const x=ra();if(x instanceof HTMLElement)p.appendChild(x);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(x){console.error("No fue posible cargar el módulo Banner:",x),p.innerHTML=`
        ...
        `}return d.addEventListener("click",()=>{w("xmera")}),v.addEventListener("click",()=>{w("banner")}),w("xmera"),e}function la(){return na()}const ca={home:{page:Ie,layout:"default"},quienesSomos:{page:Ze,layout:"full"},equipment:{page:st,layout:"default"},FormacionAcademica:{page:dt,layout:"default"},noticias:{page:Et,layout:"full"},publicaciones:{page:jt,layout:"default"},proyectos:{page:Kt,layout:"default"},lineas:{page:Ut,layout:"default"},contacto:{page:aa,layout:"default"},herramientas:{page:la,layout:"default"}};function ee(e){window.location.hash=`/${e}`}function da(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";pa(t)};window.addEventListener("hashchange",e),e()}function pa(e){const t=document.querySelector("main"),a=ca[e];t&&(t.innerHTML="",a&&(rt(a.layout),t.appendChild(a.page())))}function ua(e,t){re(e,ee),da();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(ae(e),i=!0)}a.addEventListener("change",o),o(a),ae(e);const r=t.querySelector('[data-action ="open-menu"]');ye(r,e),ke(e)}const ge=document.querySelector("#header");ge.innerHTML=ve();const fe=document.querySelector("#navBar");fe.innerHTML=he();const ma=document.querySelector("#footer");ma.innerHTML=we();ua(fe,ge);
