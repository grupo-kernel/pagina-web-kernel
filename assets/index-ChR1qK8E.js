(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const R=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Q(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function Y(){return`<div class="lg:hidden  border-b-zinc-500 border-b  pb-2.5  w-full  flex px-2.5  justify-between items-center  mb-7">
              <span class="text-4xl font-medium ">El Kernel</span>
                ...
                <ul class="flex w-full text-black flex-col lg:flex-row p-4 gap-4 xl:gap-9">
                  ...
                  <li data-action="open-subMenu" class="gap-1 text-nowrap lg:relative  2xl:text-3xl  hover:cursor-pointer 
                    ...
                    </ul>`}function K(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
        ...
        `}function j(e){e.querySelectorAll('[data-action ="open-subMenu"]').forEach(a=>{const i=a.querySelector("ul"),o=a.querySelector("i");let s=!i.classList.contains("hidden");a.addEventListener("click",r=>{r.preventDefault(),s?(o.classList.replace("bx-caret-up","bx-caret-down"),i.classList.replace("flex","hidden"),s=!1):(o.classList.replace("bx-caret-down","bx-caret-up"),i.classList.replace("hidden","flex"),s=!0)})})}function W(e,t){e.addEventListener("click",()=>{t.classList.replace("hidden","block"),document.body.style.overflow="hidden"})}function Z(e){e.querySelector('[data-action="close-navBar"]').addEventListener("click",()=>{e.classList.replace("block","hidden"),document.body.style.overflow="scroll"})}function X(){return`<div class =" flex justify-center 
            ...
            <!-- Fin tarjeta principal  -->  `}function $(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function _(e){$(e,I)}const U=""+new URL("apec-ConmXkrT.png",import.meta.url).href,ee=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,te=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,B=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${U}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${te}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function ae(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=B.length,s=1500;let r=0,c=null;function x(h){return(h%o+o)%o}function l(){i.innerHTML=B[r].content}function n(h){r=x(r+h),l()}function f(){m(),c=setInterval(()=>n(1),s)}function m(){c&&(clearInterval(c),c=null)}function u(){f()}l(),f(),t.addEventListener("click",()=>{n(1),u()}),a.addEventListener("click",()=>{n(-1),u()})}function ie(){const e=`
    <div class="absolute bottom-0 col-span-4
            ...
            </div>`,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return ae(a.querySelector("#containerFather")),_(a.querySelector("#btnsGroup")),a}function oe(){const e=document.createElement("section");e.classList.add("relative","w-full","flex","flex-col","m-auto","tabletBig:flex-row","md:mb-50","tabletBig:w-7xl","tabletBig:px-20","xl:mb-0","xl:pb-0","xl:w-full","xl:px-0","2xl:w-450","2xl:h-187.5"),e.innerHTML=`${X()}`;const t=document.createElement("div");return t.appendChild(ie()),e.appendChild(t.firstElementChild),e}function se(){return oe()}const ne=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function re(){return`
  ...
  `}function fe({icon:e,title:t,content:a}){return`
  ...
  `,e}function he(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),s=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(r=>{r.classList.remove("max-h-[1000px]"),r.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(r=>{r.classList.remove("rotate-180")}),s||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function ve(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function we(){const e=be();return he(e),ve(e),e}function ye(e){const t=document.createElement("div");t.className="flex bg-white border rounded-xl shadow-2xl border-black w-89.5 h-139 flex-col items-center text-center justify-between p-4 gap-4 transition-all hover:scale-[1.02]";const a=e.redes.map(i=>`
    ...
    `,t}const k=""+new URL("sep-BCMURSaM.png",import.meta.url).href,S=""+new URL("nat-CaDYa76I.png",import.meta.url).href,T=""+new URL("rad-B3ff1btG.png",import.meta.url).href,D=""+new URL("ant-D2J2W27b.png",import.meta.url).href,N=""+new URL("mar-Cru0HERG.png",import.meta.url).href,A=""+new URL("marc-D-jKwb4F.png",import.meta.url).href,C=""+new URL("jos-BToFZdIf.png",import.meta.url).href,E=[{img:k,title:"Miguel A. Miguel A. Leonardo Sepúlveda, Ph.D",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente.",afilaciones:" ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&amp;hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con enfoque en métodos numéricos avanzados. Asesor de tesis de posgrado y pregrado. Diseñador y rediseñador de programas curriculares universitarios. Investigador en métodos libres de Jacobiano, análisis numérico y formación de docentes."},{img:S,title:"Natanael Ureña Castillo, M.Sc",subtitle:"Optimización, entrenamiento de redes neuronales, formación docente",areas:"Métodos iterativos, optimización, redes neuronales, ciencias actuariales, matemática computacional, formación docente.",afilaciones:" ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Especialista en métodos iterativos, optimización y redes neuronales aplicadas a problemas complejos y riesgos. Docente universitario y asesor en proyectos de investigación matemática."},{img:T,title:"Randy Leonardo, M.Sc",subtitle:"Álgebra Lineal, Matrices combinadas, Educación Matemática",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa..",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador en álgebra y docencia, co-investigador de proyectos de matrices combinadas. Ponente en congresos nacionales."},{img:D,title:"Antmel Rodríguez Cabral, Ph.D",subtitle:"Especialista en dinámica compleja y dinámica real de métodos iterativos para sistemas no lineales",rec:"Recientemente defendió su tesis doctoral (Doctor en Matemática).",areas:" EDPs, sistemas no lineales, planos/dinámicas compleja y real, análisis complejo, educación matemática.",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Profesor universitario e investigador en métodos numéricos, EDPs y planos dinámicos; ponente en congresos internacionales."},{img:N,title:"Marino Brito Guillén, M.Sc",subtitle:"Gestión universitaria, Matemática Educativa, Educación",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente.",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Ex-vicerrector académico, profesor universitario y consultor educativo. Experto en desarrollo curricular y formación docente."},{img:A,title:"Marc-Kelly Jean Philippe Jean, Ph.D",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",areas:"Álgebra, matemática pura, educación matemática, recursos educativos.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-researchgate"},{name:"google",url:"https://scholar.google.com/citations?hl=es&amp;user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Profesor adjunto, asesor y conferencista en álgebra, con experiencia en investigación y divulgación científica internacional."},{img:C,title:"José Alberto Reyes Reyes, M.Sc",subtitle:"Métodos Iterativos, Educación Matemática",areas:"Matemática pura, métodos iterativos, análisis de estabilidad, innovación educativa.",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{mame:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Docente universitario y de postgrado. Investigador en métodos numéricos y asesor de tesis en análisis de estabilidad y convergencia."}];function Ae(){let e=0,t;const a=document.createElement("div");a.className="relative flex flex-col gap-7 w-full items-center";const i=()=>window.innerWidth>=1024?3:window.innerWidth>=768?2:1,o=()=>{const l=i();e+l>=E.length?e=0:e++,x()},s=()=>{const l=i();e<=0?e=E.length-l:e--,x()},r=()=>{c(),t=setInterval(o,3500)},c=()=>{t&&clearInterval(t)},x=()=>{const l=i();a.innerHTML=`
        ...
        `;const n=a.querySelector("#cards-wrapper");E.slice(e,e+l).forEach(m=>{n.appendChild(ye(m))}),a.querySelector("#prev-btn").onclick=()=>{s(),r()},a.querySelector("#next-btn").onclick=()=>{o(),r()}};return document.addEventListener("visibilitychange",()=>{document.hidden?c():r()}),window.addEventListener("resize",()=>{e=0,x()}),x(),r(),a}function Ce(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-route]");if(!a)return;const i=window.location.hash.replace("#/","")||"equipment";a.dataset.route!==i&&I(a.dataset.route)})}function q(){const e=window.location.hash.replace("#/","")||"equipment",t=document.createElement("div"),a="bg-sky-800 text-white border-b-sky-800",i="bg-transparent text-black hover:bg-gray-50";return t.innerHTML=`
    ...
    </nav>`,Ce(t.firstElementChild),t.firstElementChild}function Ee(){const e=document.createElement("section");e.classList.add("flex","flex-col","gap-5","m-auto","p-4","max-w-7xl","tabletBig:w-7xl","xl:w-full"),e.appendChild(q());const t=Ae();return e.appendChild(t),e}function Me(){return Ee()}function ke(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function Se(e,t=!1){return`
        <div data-id="${e.id}" 
    ...
    `}function De(e){const t=e.formacion.map(i=>`
        <div class="mb-4">
    ...
    `}function ze({id:e,title:t,date:a,image:i,excerpt:o}){return`
  ...
  `}function Ue(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl","xl:w-full"),e.innerHTML=`
    ...
    `,e}function Te({title:e,content:t,articleURL:a}){const i=t.paragraphs.map(r=>`<p>${r}<p>`).join(""),o=t.list.length?` 
    ...
    `}function Ke(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const t=G(e),a=Qe(e),i=a.length,o=a.map(n=>Number(n.year)).filter(Boolean),s=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",c=[...new Set(a.map(n=>n.q).filter(Boolean))],x=[...new Set(a.map(n=>P(n)).filter(Boolean))],l=a.map(n=>{const f=P(n),m=J(n),u=He(n);return`
    ...
    `}function We(){let e=v[0]?.id||1,t=!1,a=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(l){const n=String(l.DOI||l.doi||"").trim().toLowerCase();return n||`${l.year||""}-${l.title||l.tile||""}-${l.contenido||""}`.trim().toLowerCase()}function s(){const l=new Map;return v.forEach(n=>{(n.publicaciones||[]).forEach(f=>{const m=o(f);l.has(m)||l.set(m,f)})}),Array.from(l.values())}function r(){const l=s(),n=l.map(h=>Number(h.year)).filter(Boolean),f=n.length?Math.max(...n):"—",m=n.length?Math.min(...n):"—",u=l.filter(h=>h.q==="Q1").length;return{totalPublicaciones:l.length,investigadores:v.length,q1:u,primerYear:m,ultimoYear:f}}const c=()=>{const l=v.find(u=>u.id===e)||v[0],n=r(),f=window.innerWidth<768&&!t;i.innerHTML=`
    ...
    `).join("")}function _e(e=[]){return e.map(t=>`
    ...
    `).join("")}function et(e=[]){return e.map(t=>`
    ...
    `}function at(e){const t=e.proyectosAsociados&&e.proyectosAsociados.length>0,a=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function it(){const e=new Set(b.map(i=>i.categoria)),t=b.filter(i=>i.proyectosAsociados?.length>0).length,a=b.filter(i=>i.publicacionesClave?.length>0).length;return{total:b.length,categorias:e.size,conProyectos:t,conPublicaciones:a}}function ot(){let e=b[0]?.id||1;const t=document.createElement("section");t.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=Xe(e),o=it();t.innerHTML=`
            <div class="mb-8">
    ...
    `).join("")}function lt(e=[]){return e.map(t=>`
        <span class="inline-flex items-center bg-white/10 text-white border border-white/10 px-3 py-1 rounded-full text-xs font-semibold">
            ${d(t)}
        </span>
    `).join("")}function ct(e,t=!1){return`
        <button 
            type="button"
    ...
    `}function pt(){let e=w[0]?.id||1;const t=document.createElement("section");t.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=nt(e);t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,t.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),a()}})};return a(),t}function mt(){return pt()}function ut(){return`
    ...
    ${xt()}
    `,e}function ft(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",bt)}async function bt(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=ht(i);if(o.length>0){wt(o);return}await yt(t,i)}function ht(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?vt(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function vt(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function wt(e){y(e[0],"error")}function y(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function yt(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(y("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):y("Hubo un problema al enviar el mensaje.","error")}catch{y("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function At(){const e=gt();return setTimeout(()=>{ft()},0),e}const Ct={home:{page:se,layout:"default"},quienesSomos:{page:we,layout:"full"},equipment:{page:Me,layout:"default"},FormacionAcademica:{page:Ie,layout:"default"},noticias:{page:Ve,layout:"full"},publicaciones:{page:Ze,layout:"default"},proyectos:{page:mt,layout:"default"},lineas:{page:st,layout:"default"},contacto:{page:At,layout:"default"}};function I(e){window.location.hash=`/${e}`}function Et(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";Mt(t)};window.addEventListener("hashchange",e),e()}function Mt(e){const t=document.querySelector("main"),a=Ct[e];t&&(t.innerHTML="",a&&(ke(a.layout),t.appendChild(a.page())))}function kt(e,t){$(e,I),Et();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(j(e),i=!0)}a.addEventListener("change",o),o(a),j(e);const s=t.querySelector('[data-action ="open-menu"]');W(s,e),Z(e)}const V=document.querySelector("#header");V.innerHTML=Q();const H=document.querySelector("#navBar");H.innerHTML=Y();const St=document.querySelector("#footer");St.innerHTML=K();kt(H,V);
