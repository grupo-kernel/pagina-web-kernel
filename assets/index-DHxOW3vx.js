(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const ge=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Je(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return ra(t.querySelector("#containerFather")),ta(t.querySelector("#btnsGroup")),t}const na="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function la(){try{const e=await fetch(na,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function Z(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function ca(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function da(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const r=await la();a.textContent=Z(r.total),t.textContent=Z(r.hoy),i.textContent=Z(r.ultimos7Dias),o.textContent=Z(r.ultimos30Dias);const d=ca(r.actualizadoEn);n.textContent=d?`Actualizado: ${d}`:"Estadísticas temporalmente no disponibles"}catch(r){console.error("Error al mostrar las estadísticas en la portada:",r),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function pa(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=aa();const a=sa();return e.appendChild(a),da(e),e}function ua(){return pa()}const ma=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function xa(){return`
        <section 
            role="banner" 
  ...
  `}function Pa(){const e=document.createElement("section");return e.className=`
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ya({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:n,category:r="Noticia",imageFit:d="contain"}){const x=d==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
...
Gracias.`);return`
    ...
    `;const a=Za(Oe),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ...
        ${Xa(a)}
        ${_a()}
    `,e}function at({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(r=>`<p>${r}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function lt(e){if(!e)return`
        ...
        `;const a=Ue(e),t=st(e),i=t.length,o=t.map(l=>Number(l.year)).filter(Boolean),n=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",d=[...new Set(t.map(l=>l.q).filter(Boolean))],x=[...new Set(t.map(l=>Ce(l)).filter(Boolean))],v=t.map(l=>{const w=Ce(l),u=Ve(l),m=rt(l);return`
...
`)}function A(c,b){const s=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),h=URL.createObjectURL(s),f=document.createElement("a");f.href=h,f.download=b,document.body.appendChild(f),f.click(),f.remove(),window.setTimeout(()=>{URL.revokeObjectURL(h)},1e3)}function j(){x=[],a.value="",g([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){x=[],g([]),d.disabled=!0,p("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:b,errors:s}=y(c);if(s.length>0){x=[],g([]),d.disabled=!0,p(s.join(" "),"error");return}x=b,g(b),d.disabled=!1,p(`Los datos de ${b.length} estudiante${b.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",j),d.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Examen_Final_4EF.csv")}),e}function Tt(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
    ...
    `}const si={home:{page:ua,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:$a,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:qa,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Va,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:ot,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:dt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:Et,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:vt,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Rt,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Ot,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Ut,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Qt,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"}};let ze=document.referrer||"";function ce(e){window.location.hash=`/${e}`}function ni(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";ci(a)};window.addEventListener("hashchange",e),e()}function li(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:ze}),ze=t}function ci(e){const a=document.querySelector("main"),t=si[e];if(a){if(a.innerHTML="",!t){ce("home");return}Ta(t.layout),document.title=t.title,a.appendChild(t.page()),window.scrollTo({top:0,behavior:"auto"}),li(e,t.title)}}function di(e,a){Ie(e,ce),ni();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(ke(e),i=!0)}t.addEventListener("change",o),o(t),ke(e);const n=a.querySelector('[data-action ="open-menu"]');Ye(n,e),Xe(e)}const He=document.querySelector("#header");He.innerHTML=Je();const Ke=document.querySelector("#navBar");Ke.innerHTML=Qe();const pi=document.querySelector("#footer");pi.innerHTML=We();di(Ke,He);
