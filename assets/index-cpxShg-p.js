const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./authGuard-CEzcrBkK.js","./authService-CgfoSPdf.js","./firebase-BzP43VG7.js","./login-BtABpxCq.js","./LaboratorioKernel-CbCyRZ68.js","./AsistentePruebas-9ENxU2k9.js","./metadatosFichasMetodologicas-BbzfSE5K.js","./CalculadoraDosGrupos-DVDlpeQZ.js","./jstat-DiDocX-r.js","./exportacionesCalculadoras-Djvr1KOO.js","./CalculadoraDosMuestrasRelacionadas-CeBx-BcK.js","./estadisticaDosMuestrasRelacionadas-C0D8qKdR.js","./CalculadoraTresOMasGrupos-BT7ku7NP.js","./CalculadoraTresOMasMedicionesRelacionadas-WVj08Bzt.js","./CalculadoraRelacionVariables-BrRbbsUH.js","./CalculadoraAsociacionCategorica-BOYgPjyH.js","./CalculadoraEstadisticaDescriptiva-DOi80-AC.js","./CalculadoraFiabilidadCuestionarios-Ckn-Sztz.js","./CalculadoraEvaluacionEducativa-DkKivuyO.js","./CalculadoraTamanoMuestraPotencia-qBnka-G2.js","./BibliotecaMetodologica-BzzsJJUi.js","./CalculadoraRegresionCompleta-Fo1l_d_A.js","./CalculadoraRegresionLogistica-BXhZzQPR.js","./CalculadoraRegresionConteo-8HPwUe6H.js"])))=>i.map(i=>d[i]);
(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const Me=""+new URL("ElKernel-BvHOWfRq.webp",import.meta.url).href;function rt(){return`
        <div class="flex w-full items-center justify-between gap-4">
            <a href="#/home" class="flex min-w-0 items-center gap-3 rounded-xl focus:outline-none focus-visible:ring-4 focus-visible:ring-emerald-100" aria-label="Ir a la portada de El Kernel">
                <img class="h-12 w-12 shrink-0 rounded-xl object-contain md:h-14 md:w-14" src="${Me}" alt="Logo del Grupo de Investigación El Kernel" title="El Kernel" />
                <span class="min-w-0">
    ...
    `}function ga({id:e,etiqueta:a,icono:t,elementos:i}){return`
    ...
    `}function lt(){return`
        ...
        <ul class="relative z-[230] flex min-h-full w-full flex-col gap-1 p-3 text-black lg:min-h-0 lg:flex-row lg:items-center lg:justify-end lg:gap-0.5 lg:p-0 xl:gap-1">
            ${he("home","Portada","bx-home")}
            ${he("servicios","Servicios","bx-grid-alt")}
            ${he("laboratorioKernel","Laboratorio","bx-bar-chart-alt-2")}

            ${ga({id:"submenu-nuestro-trabajo",etiqueta:"Investigación",icono:"bx-briefcase-alt-2",elementos:[pe("lineas","Líneas de investigación","bx-git-branch"),pe("proyectos","Proyectos","bx-bulb"),pe("publicaciones","Publicaciones","bx-book-open"),pe("herramientas","Herramientas","bx-wrench")]})}

            ${ga({id:"submenu-nosotros",etiqueta:"Nosotros",icono:"bx-group",elementos:[pe("quienesSomos","Quiénes somos","bx-info-circle"),pe("equipment","Equipo","bx-group")]})}

            ${he("noticias","Noticias","bx-news","lg:hidden 2xl:block")}
            ${he("contacto","Contacto","bx-envelope","lg:hidden xl:block")}
            ${nt()}
        </ul>
    `}function ct(){const e=new Date().getFullYear();return`
            ...
            <div class="mx-auto grid max-w-[1600px] grid-cols-1 gap-9 px-5 py-10 md:px-8 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] lg:px-10">
                <section class="text-white" aria-labelledby="titulo-footer-kernel">
                    <div class="flex items-center gap-4">
                        <img class="h-16 w-16 rounded-2xl bg-white p-1.5 object-contain shadow-lg" src="${Me}" alt="Logo del Grupo de Investigación El Kernel" loading="lazy" />
                        <div>
    ...
    `});function L(e,a="text-2xl"){const t=ya[e]||ya["bx-grid-alt"];return`
        <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
            fill="none"
    ...
    `}const It=""+new URL("isfodosu-campus-Dxbx_r-n.webp",import.meta.url).href,Dt=""+new URL("uasd-campus-B6v1rNpv.webp",import.meta.url).href,Pt=""+new URL("unapec-campus-DqZO-eEo.webp",import.meta.url).href,Rt=5e3,Q=Object.freeze([Object.freeze({id:"isfodosu",sigla:"ISFODOSU",nombre:"Instituto Superior de Formación Docente Salomé Ureña",descripcion:"Formación docente, educación matemática e investigación educativa.",imagen:It,enlace:"https://www.isfodosu.edu.do/",alt:"Fachada del Instituto Superior de Formación Docente Salomé Ureña",ancho:1260,alto:790,posicion:"50% 46%"}),Object.freeze({id:"uasd",sigla:"UASD",nombre:"Universidad Autónoma de Santo Domingo",descripcion:"Ciencias básicas, optimización, matemática aplicada y colaboración interdisciplinaria.",imagen:Dt,enlace:"https://uasd.edu.do/",alt:"Edificio y estatua en el campus de la Universidad Autónoma de Santo Domingo",ancho:1758,alto:1284,posicion:"50% 42%"}),Object.freeze({id:"unapec",sigla:"UNAPEC",nombre:"Universidad APEC",descripcion:"Matemática aplicada, computación científica, docencia y proyectos de investigación.",imagen:Pt,enlace:"https://unapec.edu.do/",alt:"Entrada principal del campus de Universidad APEC",ancho:608,alto:342,posicion:"50% 50%"})]),we=Object.freeze({anterior:`
    ...
    `});function ne(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ot(e,a){const t=a===0;return`
        <button
            type="button"
            role="tab"
            id="pestana-institucion-${ne(e.id)}"
            aria-controls="panel-institucion-portada"
            aria-selected="${t}"
            aria-label="Mostrar ${ne(e.nombre)}"
            tabindex="${t?"0":"-1"}"
            ...
            <div class="flex min-h-full flex-col p-5 sm:p-6 lg:p-8">
                <div class="flex-1">
                    ...
                    <a
                        ...
                        aria-label="Visitar el sitio institucional de ${ne(e.sigla)}"
                ...
                <div class="mt-8 border-t border-slate-200 pt-5">
                    ...
                    <div class="mt-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        >
                            <span data-universidad-icono-pausa>${we.pausa}</span>
                            <span data-universidad-icono-reproducir class="hidden">${we.reproducir}</span>
    ...
    `;const t=[...a.querySelectorAll("[data-universidad-imagen-capa]")],i=a.querySelector("[data-universidad-sigla]"),o=a.querySelector("[data-universidad-nombre]"),n=a.querySelector("[data-universidad-descripcion]"),s=a.querySelector("[data-universidad-enlace]"),l=a.querySelector("[data-universidad-contador]"),d=a.querySelector("[data-universidad-estado]"),b=a.querySelector("[data-universidad-escenario]"),u=a.querySelector("[data-universidad-progreso]"),p=[...a.querySelectorAll("[data-universidad-control]")],f=a.querySelector("[data-action='universidad-anterior']"),y=a.querySelector("[data-action='universidad-siguiente']"),w=a.querySelector("[data-action='pausar-rotacion']"),A=a.querySelector("[data-universidad-icono-pausa]"),h=a.querySelector("[data-universidad-icono-reproducir]"),g=a.querySelector("[data-universidad-texto-rotacion]"),E=window.matchMedia("(prefers-reduced-motion: reduce)"),C=new AbortController,r={signal:C.signal};let m=0,c=0,x=0,v=null,k=null,I=null,M=!1,R=!1,z=!1,O=!1,Y=!1,B=!E.matches,G=typeof window.IntersectionObserver!="function";function ue(j){return(j%Q.length+Q.length)%Q.length}function ot(j){const S=t[c];if(S?.dataset.institucionId===j.id)return;const J=c===0?1:0,N=t[J],ve=++x;let ma=!1;function ba(){ma||ve!==x||!N.naturalWidth||(ma=!0,S.alt="",N.alt=j.alt,N.classList.remove("opacity-0"),N.classList.add("opacity-100"),S.classList.remove("opacity-100"),S.classList.add("opacity-0"),c=J)}N.onload=ba,N.onerror=()=>{ve===x&&N.removeAttribute("src")},N.alt="",N.width=j.ancho,N.height=j.alto,N.style.objectPosition=j.posicion,N.dataset.institucionId=j.id,N.src=j.imagen,N.complete&&N.naturalWidth&&window.requestAnimationFrame(ba)}function da(){k!==null&&window.clearTimeout(k),G&&(k=window.setTimeout(()=>{const j=Q[ue(m+1)],S=new Image;S.decoding="async",S.src=j.imagen,k=null},700))}function Qe(j=!1){const S=Q[m];ot(S),i.textContent=S.sigla,o.textContent=S.nombre,n.textContent=S.descripcion,s.href=S.enlace,s.setAttribute("aria-label",`Visitar el sitio institucional de ${S.sigla}`),l.textContent=`${String(m+1).padStart(2,"0")} / ${String(Q.length).padStart(2,"0")}`,b.setAttribute("aria-labelledby",`pestana-institucion-${S.id}`),u.style.width=`${(m+1)/Q.length*100}%`,p.forEach((J,N)=>{const ve=N===m;J.setAttribute("aria-selected",String(ve)),J.tabIndex=ve?0:-1}),j&&(d.textContent=`${S.sigla}: ${S.nombre}`),da()}function Z(){v!==null&&(window.clearInterval(v),v=null)}function st(){return B&&G&&!document.hidden&&!R&&!z&&!O&&a.isConnected}function H(){Z(),st()&&(v=window.setInterval(()=>{m=ue(m+1),Qe(!1)},Rt))}function Xe(){const j=!B;w.setAttribute("aria-pressed",String(j)),w.setAttribute("aria-label",j?"Reanudar la rotación automática":"Pausar la rotación automática"),A.classList.toggle("hidden",j),h.classList.toggle("hidden",!j),g.textContent=j?"Reanudar rotación":"Pausar rotación"}function ae(j,S=!0,J=!1){m=ue(j),Qe(S),J&&p[m]?.focus(),H()}f?.addEventListener("click",()=>ae(m-1),r),y?.addEventListener("click",()=>ae(m+1),r),w?.addEventListener("click",()=>{Y=!0,B=!B,Xe(),B?(d.textContent="Rotación automática reanudada.",H()):(d.textContent="Rotación automática pausada.",Z())},r),p.forEach(j=>{j.addEventListener("click",()=>ae(Number(j.dataset.indice)),r),j.addEventListener("keydown",S=>{S.key==="ArrowLeft"?(S.preventDefault(),ae(m-1,!0,!0)):S.key==="ArrowRight"?(S.preventDefault(),ae(m+1,!0,!0)):S.key==="Home"?(S.preventDefault(),ae(0,!0,!0)):S.key==="End"&&(S.preventDefault(),ae(Q.length-1,!0,!0))},r)}),a.addEventListener("mouseenter",()=>{R=!0,Z()},r),a.addEventListener("mouseleave",()=>{R=!1,H()},r),a.addEventListener("focusin",()=>{z=!0,Z()},r),a.addEventListener("focusout",j=>{z=a.contains(j.relatedTarget),z||H()},r),b?.addEventListener("touchstart",j=>{I=j.changedTouches[0]?.clientX??null,O=!0,Z()},{...r,passive:!0}),b?.addEventListener("touchend",j=>{const S=j.changedTouches[0]?.clientX??null;if(O=!1,I!==null&&S!==null){const J=S-I;Math.abs(J)>45?ae(m+(J<0?1:-1)):H()}I=null},{...r,passive:!0}),b?.addEventListener("touchcancel",()=>{I=null,O=!1,H()},r),document.addEventListener("visibilitychange",()=>{document.hidden?Z():H()},r),E.addEventListener("change",()=>{Y||(B=!E.matches,Xe()),B?H():Z()},r);const ua=typeof window.IntersectionObserver=="function"?new IntersectionObserver(j=>{G=j.some(S=>S.isIntersecting&&S.intersectionRatio>=.15),G?(da(),H()):Z()},{threshold:[0,.15,.5]}):null;ua?.observe(a);const pa=new MutationObserver(()=>{if(a.isConnected){M||(M=!0,H());return}M&&(Z(),k!==null&&window.clearTimeout(k),C.abort(),ua?.disconnect(),pa.disconnect())});return pa.observe(document.body,{childList:!0,subtree:!0}),Qe(!1),Xe(),a}function Le(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ze(e,a,t=""){return`
        <div class="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-center"${t?` title="${Le(t)}" aria-label="${Le(`${e} ${a}. ${t}.`)}"`:""}>
            <p class="text-2xl font-black text-white md:text-3xl">${Le(e)}</p>
            <p class="mt-1 text-xs font-semibold leading-tight text-slate-300">${Le(a)}</p>
        </div>
    `}function Tt({integrantes:e,servicios:a,lineas:t,publicaciones:i}){const o=document.createElement("section");return o.className="mx-4 overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-lg sm:mx-6 lg:mx-8 xl:mx-10",o.setAttribute("aria-labelledby","titulo-confianza-portada"),o.innerHTML=`
        ...
        <div class="grid grid-cols-1 border-t border-slate-200 xl:grid-cols-[minmax(0,1.45fr)_minmax(19rem,0.55fr)]">
            ...
            <aside class="bg-[#071820] p-5 text-white md:p-7" aria-label="Indicadores y principios de confianza">
                ...
                <div class="mt-4 grid grid-cols-2 gap-3">
                    ${ze(e,"Integrantes","Miembros nacionales e internacionales del Grupo El Kernel")}
                    ${ze(a,"Áreas de servicio")}
                    ${ze(t,"Líneas de investigación")}
                    ${ze(i,"Artículos científicos acumulados","Producción de los 9 integrantes a lo largo de sus trayectorias académicas")}
                </div>
    ...
    `,o.querySelector("[data-carrusel-institucional]")?.replaceWith(qt()),o}const Nt="kernel-services-filter",Ft=Object.freeze([Object.freeze({titulo:"Investigación y producción científica",descripcion:"Proyectos de I+D+i, tesis, publicación, edición y comunicación científica.",icono:"bx-book-open",categoria:"investigacion"}),Object.freeze({titulo:"Estadística y metodología",descripcion:"Diseño de estudios, muestreo, instrumentos, análisis e informes reproducibles.",icono:"bx-bar-chart-alt-2",categoria:"matematica-datos"}),Object.freeze({titulo:"Matemática computacional y optimización",descripcion:"Modelización, simulación, métodos numéricos, algoritmos y decisiones bajo restricciones.",icono:"bx-atom",categoria:"matematica-datos"}),Object.freeze({titulo:"Ciencia de datos, IA y software científico",descripcion:"Modelos predictivos, tableros, automatización, prototipos y transferencia tecnológica.",icono:"bx-grid-alt",categoria:"tecnologia-transferencia"}),Object.freeze({titulo:"Educación, posgrado y diseño curricular",descripcion:"Maestrías, programas académicos, sílabos, formación docente, evaluación y calidad.",icono:"bx-group",categoria:"educacion"}),Object.freeze({titulo:"Riesgo, finanzas y soluciones sectoriales",descripcion:"Actuaría, econometría, políticas públicas, logística, industria y apoyo a decisiones.",icono:"bx-trending-up",categoria:"riesgo-finanzas"})]),Ut=Object.freeze([1,7,12,15]);function fe(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Bt(e){const a=ia.find(t=>t.id===e.categoria);return`
        ...
        >
            ...
            <h3 class="mt-5 text-xl font-black leading-tight text-slate-950">${fe(e.titulo)}</h3>
            <p class="mt-3 flex-1 text-sm leading-relaxed text-slate-600 md:text-base">${fe(e.descripcion)}</p>
            <span class="mt-5 inline-flex items-center gap-2 text-sm font-black text-[#0f5b5d]">
                Explorar ${fe(a?.rango||"servicios")}
    ...
    `}function _t(e){return`
        <article class="flex h-full flex-col rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm md:p-6">
            ...
            <h3 class="mt-5 text-xl font-black leading-tight text-white">${fe(e.tituloCorto)}</h3>
            <p class="mt-3 flex-1 text-sm leading-relaxed text-slate-300">${fe(e.resumen)}</p>
    ...
    `}function Vt(){const e=document.createElement("section");e.id="servicios-portada",e.className="mx-4 overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-50 shadow-lg sm:mx-6 lg:mx-8 xl:mx-10",e.setAttribute("aria-labelledby","titulo-servicios-portada");const a=Ut.map(t=>le.find(i=>i.numero===t)).filter(Boolean);return e.innerHTML=`
    ...
    `,e.addEventListener("click",t=>{const i=t.target.closest("[data-resumen-filtro]");if(!(!i||!e.contains(i)))try{window.sessionStorage.setItem(Nt,i.dataset.resumenFiltro||"todos")}catch(o){console.warn("[Kernel] No fue posible conservar el filtro del catálogo.",o)}}),e}const Va=Object.freeze([Object.freeze({numero:"01",titulo:"Diagnóstico",descripcion:"Comprendemos la necesidad, el contexto, los usuarios, los datos y la decisión que debe apoyarse."}),Object.freeze({numero:"02",titulo:"Alcance y plan técnico",descripcion:"Definimos objetivos, productos, métodos, responsabilidades, riesgos, calendario y criterios de aceptación."}),Object.freeze({numero:"03",titulo:"Ejecución por fases",descripcion:"Desarrollamos el análisis, diseño, modelización, formación o solución con entregas parciales verificables."}),Object.freeze({numero:"04",titulo:"Validación",descripcion:"Aplicamos pruebas, revisión experta, sensibilidad, control de calidad y retroalimentación documentada."}),Object.freeze({numero:"05",titulo:"Entrega y transferencia",descripcion:"Entregamos productos, documentación, capacitación y una ruta de seguimiento o actualización."})]),Kt=Object.freeze([Object.freeze({tipo:"Universidad y posgrado",titulo:"Diseño integral de una maestría y sus programas de asignatura",problema:"Una institución necesita crear o rediseñar una oferta de posgrado con coherencia curricular y viabilidad.",intervencion:"Estudio de necesidad, benchmarking, perfil, competencias, malla, sílabos, reglamentos, indicadores y expediente técnico.",producto:"Propuesta curricular completa y plan de evaluación para aprobación institucional.",icono:"bx-book-open"}),Object.freeze({tipo:"Investigación aplicada",titulo:"Diseño metodológico y plan estadístico para un estudio",problema:"Un equipo requiere justificar muestra, instrumentos, variables y procedimientos de análisis.",intervencion:"Matriz de coherencia, muestreo, potencia, validación de instrumentos, plan analítico y criterios de reporte.",producto:"Protocolo reproducible, memoria de cálculo y orientaciones para interpretar resultados.",icono:"bx-bar-chart-alt-2"}),Object.freeze({tipo:"Empresa o institución pública",titulo:"Optimización de recursos y tablero de decisión",problema:"La organización necesita reducir costos, asignar recursos o comparar escenarios bajo restricciones.",intervencion:"Mapeo del proceso, formulación matemática, algoritmo, piloto, análisis de sensibilidad y validación con usuarios.",producto:"Modelo de decisión, prototipo computacional, tablero y plan de implementación.",icono:"bx-trending-up"})]);function ce(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Gt(e,a){return`
        <li class="relative flex gap-4 pb-7 last:pb-0">
            ...
            <div class="pt-0.5">
                <h3 class="text-lg font-black text-slate-950">${ce(e.titulo)}</h3>
                <p class="mt-1 text-sm leading-relaxed text-slate-600 md:text-base">${ce(e.descripcion)}</p>
            </div>
        </li>
    `}function Ht(e){return`
        <article class="flex h-full flex-col rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
            ...
            <p class="mt-5 text-xs font-black uppercase tracking-[0.16em] text-[#0f5b5d]">${ce(e.tipo)}</p>
            <h3 class="mt-2 text-xl font-black leading-tight text-slate-950">${ce(e.titulo)}</h3>
            <dl class="mt-5 space-y-4 text-sm leading-relaxed">
                <div>
                    <dt class="font-black text-slate-950">Necesidad</dt>
                    <dd class="mt-1 text-slate-600">${ce(e.problema)}</dd>
                </div>
                <div>
                    <dt class="font-black text-slate-950">Intervención posible</dt>
                    <dd class="mt-1 text-slate-600">${ce(e.intervencion)}</dd>
                </div>
                <div>
                    <dt class="font-black text-slate-950">Producto esperado</dt>
                    <dd class="mt-1 text-slate-600">${ce(e.producto)}</dd>
                </div>
            </dl>
        </article>
    `}function Jt(){const e=document.createElement("section");return e.className="mx-4 grid grid-cols-1 gap-6 sm:mx-6 lg:mx-8 xl:mx-10 2xl:grid-cols-[0.72fr_1.28fr]",e.setAttribute("aria-label","Proceso de trabajo y ejemplos de aplicación"),e.innerHTML=`
    ...
    `,e}function X(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Qt(e){const a=String(e?.DOI||e?.doi||"").trim().toLowerCase();return a||[e?.year||"",e?.title||e?.journal||e?.tile||"",e?.contenido||e?.articleTitle||""].join("-").trim().toLowerCase()}function Xt(){const e=new Set;return re.forEach(a=>{(a.publicaciones||[]).forEach(t=>{const i=Qt(t);i&&e.add(i)})}),e.size}function me(e,a,t){return`
    ...
    `}function ai(){const e=Xt(),a=document.createElement("section");return a.className="w-full space-y-10 bg-white pb-10 font-sans",a.innerHTML=`
            ...
            <div class="relative z-10 mx-auto grid min-h-[calc(100svh-5rem)] max-w-[1600px] grid-cols-1 gap-10 px-5 py-10 md:px-8 md:py-14 xl:grid-cols-[1.05fr_0.95fr] xl:items-center xl:px-12">
                <div>
                    <div class="flex items-center gap-4">
                        <div class="flex h-20 w-20 shrink-0 items-center justify-center rounded-3xl border border-white/15 bg-white p-2 shadow-xl md:h-24 md:w-24">
                            <img src="${Me}" alt="Logo del Grupo de Investigación El Kernel" class="h-full w-full object-contain" loading="eager" />
                        </div>
                        <div>
                ...
                <aside class="rounded-[2rem] border border-white/15 bg-white/5 p-5 shadow-2xl backdrop-blur-md md:p-7" aria-label="Capacidades principales del grupo">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-3 md:grid-cols-2">
                        ${me("Investigación y tesis","Formulación, metodología, análisis y producción científica.","bx-book-open")}
                        ${me("Estadística y datos","Diseño de estudios, instrumentos, modelos y tableros.","bx-bar-chart-alt-2")}
                        ${me("Matemática computacional","Modelización, métodos numéricos, simulación y optimización.","bx-atom")}
                        ${me("Educación y currículo","Maestrías, programas de asignatura, evaluación y formación docente.","bx-group")}
                        ${me("Software científico","Prototipos, calculadoras, automatización y herramientas reproducibles.","bx-grid-alt")}
                        ${me("Riesgo y decisiones","Actuaría, finanzas, políticas públicas y soluciones sectoriales.","bx-trending-up")}
                    </div>
        ...
        <section class="mx-4 overflow-hidden rounded-[2rem] bg-[#071820] px-6 py-10 text-white shadow-2xl sm:mx-6 md:px-10 md:py-12 lg:mx-8 xl:mx-10" aria-labelledby="titulo-laboratorio-portada">
            <div class="grid grid-cols-1 gap-8 xl:grid-cols-[0.78fr_1.22fr] xl:items-center">
                ...
                <div class="flex flex-wrap gap-3">${Zt()}</div>
            </div>
        </section>
        ...
        <section class="mx-4 grid grid-cols-1 gap-6 sm:mx-6 lg:mx-8 xl:mx-10 2xl:grid-cols-[1.1fr_0.9fr]" aria-label="Proyectos, equipo y producción científica">
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">${xe.slice(0,2).map(Yt).join("")}</div>
            </div>
    ...
    `,a.querySelector("[data-franja-institucional]")?.replaceWith(Tt({integrantes:ie.length,servicios:le.length,lineas:W.length,publicaciones:e})),a.querySelector("[data-resumen-servicios]")?.replaceWith(Vt()),a.querySelector("[data-proceso-aplicaciones]")?.replaceWith(Jt()),a}const ti="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function ii(){try{const e=await fetch(ti,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}const oi=["w-full","min-w-0","max-w-none","max-w-7xl","tabletBig:max-w-6xl","xl:max-w-7xl","2xl:max-w-500","3xl:max-w-none","m-auto","m-0","p-0","p-2","mt-0","mt-8","md:mt-12","pt-0"],si=["max-w-7xl","tabletBig:max-w-6xl","xl:max-w-7xl","2xl:max-w-500","3xl:max-w-none"];function Ka(e="default"){const a=document.getElementById("main");if(a){if(a.classList.remove(...oi),a.classList.add("w-full","min-w-0"),e==="full"){a.classList.add("max-w-none","m-0","p-0","mt-0","pt-0");return}a.classList.add(...si,"p-2","mt-8","md:mt-12"),e==="left"?a.classList.add("m-0"):a.classList.add("m-auto")}}const D=Object.freeze({integrantes:9,articulosAcumulados:572,articulosAcumuladosTexto:"572+",etiquetaArticulos:"Artículos científicos acumulados",descripcionArticulos:"Producción de los 9 integrantes a lo largo de sus trayectorias académicas",notaArticulos:"Cota mínima basada en artículos de revista declarados en perfiles institucionales y registros científicos verificados. La suma representa la producción individual acumulada; las coautorías compartidas pueden formar parte de más de una trayectoria.",participacionesProyectosAprobados:58,participacionesProyectosAprobadosTexto:"58",etiquetaProyectos:"Participaciones en proyectos aprobados",descripcionProyectos:"24 registros en el perfil de Alicia Cordero y 34 en el de Juan Ramón Torregrosa",proyectosDestacados:10,proyectosNoMostrados:48,propuestasPendientes:2,notaProyectos:"La suma de 58 corresponde a registros acumulados de ambos perfiles y puede incluir proyectos compartidos; no equivale necesariamente a 58 títulos únicos."});function Ie(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function ri(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}function ni(e){return String(e||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").trim().toLowerCase()}function li(e){[...e.querySelectorAll("p")].forEach(t=>{const i=ni(t.textContent),o=t.parentElement;if(!o)return;const n=[...o.querySelectorAll("p")].find(s=>s!==t&&/^[\d.,]+\+?$/.test((s.textContent||"").trim()));["integrantes","integrantes principales","investigadores"].includes(i)&&n&&(n.textContent=String(D.integrantes),o.setAttribute("title","Miembros nacionales e internacionales del Grupo El Kernel")),["publicaciones registradas","articulos cientificos acumulados"].includes(i)&&n&&(n.textContent=D.articulosAcumuladosTexto,t.textContent=D.etiquetaArticulos,o.setAttribute("title",D.descripcionArticulos),o.setAttribute("aria-label",`${D.articulosAcumuladosTexto} ${D.etiquetaArticulos}. ${D.descripcionArticulos}.`))})}async function ci(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const s=await ii();a.textContent=Ie(s.total),t.textContent=Ie(s.hoy),i.textContent=Ie(s.ultimos7Dias),o.textContent=Ie(s.ultimos30Dias);const l=ri(s.actualizadoEn);n.textContent=l?`Actualizado: ${l}`:"Estadísticas temporalmente no disponibles"}catch(s){console.error("Error al mostrar las estadísticas en la portada:",s),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function di(){Ka("full");const e=ai();return li(e),ci(e),e}function ui(){return di()}const pi=""+new URL("QuienesSomos-CIhVjMhZ.webp",import.meta.url).href;function mi(){return`
        <section 
            role="banner" 
                ...
                <div class="max-w-4xl text-white">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl">
                        <div class="bg-white/10 border border-white/20 backdrop-blur-sm rounded-2xl p-4">
                            <p class="text-3xl font-black text-white">${D.integrantes}</p>
                        ...
                        <div
                            ...
                            title="${D.descripcionArticulos}"
                        >
                            <p class="text-3xl font-black text-white">${D.articulosAcumuladosTexto}</p>
                            <p class="text-white/75 text-xs md:text-sm font-semibold">
                                ${D.etiquetaArticulos}
                            </p>
                        </div>
    ...
    `}const hi="data:image/png;base64,",yi="data:image/png;base64,",wi="data:image/png;base64,",ki="data:image/png;base64,",Ai="data:image/png;base64,",Ei=[{icon:hi,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:yi,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:wi,title:"Objetivos",content:`
      ...
      </ul>`},{icon:ki,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Si({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${Ai}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function $i(){const e=document.createElement("section");return e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12",e.innerHTML=`
    ...
    `).join("")}function Ii(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function Di(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=zi(e.redes||[]),i=Ii(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}function Pi(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const y=o();return Math.max(ie.length-y,0)},s=()=>{const y=n();e>y&&(e=0),e<0&&(e=y)},l=()=>{const y=n();e>=y?e=0:e++,f()},d=()=>{const y=n();e<=0?e=y:e--,f()},b=()=>{u(),ie.length>o()&&(a=setInterval(l,4500))},u=()=>{a&&(clearInterval(a),a=null)},p=()=>{const y=o(),w=Math.max(ie.length-y+1,1);return Array.from({length:w}).map((A,h)=>`
            <button
                type="button"
                data-dot-index="${h}"
        ...
        `).join("")},f=()=>{if(!ie||ie.length===0){i.innerHTML=`
        ...
        `;const A=i.querySelector("#cards-wrapper");w.forEach(E=>{A.appendChild(Di(E))});const h=i.querySelector("#prev-btn"),g=i.querySelector("#next-btn");h&&(h.onclick=()=>{d(),b()}),g&&(g.onclick=()=>{l(),b()}),i.querySelectorAll("[data-dot-index]").forEach(E=>{E.onclick=()=>{e=parseInt(E.dataset.dotIndex),f(),b()}})};return i.addEventListener("mouseenter",u),i.addEventListener("mouseleave",b),document.addEventListener("visibilitychange",()=>{document.hidden?u():b()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,f(),b()},150)}),f(),b(),i}function Ri(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&Je(t.dataset.route)})}function Ga(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Ri(a),a}function Oi(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";const a=document.createElement("div");a.className="mx-auto max-w-[1600px]",a.innerHTML=`
    ...
    `;const t=document.createElement("div");t.className="mt-8 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm",t.appendChild(Ga());const i=Pi();return i.className="w-full py-8 flex flex-col gap-8 items-center font-sans",a.appendChild(t),a.appendChild(i),e.appendChild(a),e}function qi(){return Oi()}function V(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ha(e){return e.formacion?.length||0}function Ja(e){return e.experiencia?.length||0}function Ti(e,a=!1){const t=Ha(e),i=Ja(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function Ni(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(l=>`
            ...
            <div class="relative z-10 flex items-center justify-between gap-4 border-b border-white/15 pb-4">
                <div class="flex min-w-0 items-center gap-3">
                    <span class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white p-1.5 shadow-md">
                        <img src="${Me}" alt="Logo del Grupo de Investigación El Kernel" class="h-full w-full object-contain" />
                    </span>
                    <div class="min-w-0">
    ...
    `}const wa=Object.freeze([Qa,Gi,Hi,Ji,Qi,Xi,Wi,Yi,Zi]),ao=Object.freeze([{nombre:"Miguel A. Leonardo Sepúlveda",tema:"Funciones peso y método Singh–Sharma de quinto orden"},{nombre:"Natanael Ureña Castillo",tema:"Algoritmos híbridos cuasi-Newton con correctores de alto orden"},{nombre:"Antmel Rodríguez Cabral",tema:"Familia generalizada de Traub y método óptimo de cuarto orden"}]);function to(e){return e?`
    ...
    `}function la({compacto:e=!1}={}){return`
    ...
    `}function oe(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function oo(e){if(e?.visualType==="mmehb-2026")return na();if(e?.visualType==="mescyt-cic-2026")return la();const a=e?.imageFit==="cover"?"object-cover":"object-contain";return e?.image?`
            <img
                src="${oe(e.image)}"
                ...
                loading="eager"
            />
        `:'<div class="flex h-full w-full items-center justify-center font-bold text-slate-400">Imagen no disponible</div>'}function so(e=null){return e?`
    ...
    `:""}function ee(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ro(e){return e==="mmehb-2026"?na({compacto:!0}):e==="mescyt-cic-2026"?la({compacto:!0}):null}function no({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:n,category:s="Noticia",imageFit:l="contain",visualType:d="image"}){const b=l==="cover"?"object-cover":"object-contain",u=ro(d),p=u?"h-[430px] md:h-[500px]":"h-64 md:h-72 2xl:h-96",f=u||(i?`
            <img
                src="${ee(i)}"
                alt="${ee(o||a)}"
    ...
    `}function co(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function uo(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function po(){const e=document.createElement("section");e.className="w-full bg-slate-100 font-sans";const a=new Set([Fe.id,Ue.id]),t=uo([Fe,Ue,...Xa.filter(o=>!a.has(o.id))]),i=t.find(o=>o.featured)||t[0];return e.innerHTML=`
        ...
        ${lo(t)}
        ${co()}
    `,e}function be(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function mo(e){return e==="mmehb-2026"?na():e==="mescyt-cic-2026"?la():""}function bo({title:e,date:a,category:t,visualType:i,content:o={paragraphs:[],list:[]},articleURL:n}){const s=(o.paragraphs||[]).map(b=>`<p>${be(b)}</p>`).join(""),l=(o.list||[]).length?`<ul class="space-y-3">${o.list.map(b=>`<li class="flex items-start gap-3"><span class="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-[#0b5963]"></span><span>${be(b)}</span></li>`).join("")}</ul>`:"",d=mo(i);return`
        <div role="dialog" aria-modal="true" aria-labelledby="titulo-modal-noticia" id="newsModal" class="fixed inset-0 z-[500] flex items-center justify-center bg-slate-950/75 p-3 backdrop-blur-sm md:p-6">
            <article class="flex max-h-[94vh] w-full max-w-6xl flex-col overflow-hidden rounded-[2rem] bg-white shadow-2xl">
                <header class="relative border-b border-slate-200 bg-[#071820] px-6 py-6 text-white md:px-9">
                    <div class="pr-12">
                        <div class="flex flex-wrap items-center gap-3 text-xs font-black uppercase tracking-widest text-cyan-200">
                            <span>${be(t||"Noticia")}</span>
                            <span aria-hidden="true">·</span>
                            <span>${be(a||"")}</span>
                        </div>
                        <h2 id="titulo-modal-noticia" class="mt-3 text-2xl font-black leading-tight md:text-4xl">${be(e)}</h2>
                    </div>
                ...
                <footer class="flex flex-col gap-3 border-t border-slate-200 bg-slate-50 px-5 py-5 sm:flex-row sm:justify-end md:px-9">
                    ${n?`<a href="${be(n)}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center rounded-xl bg-[#0b5963] px-5 py-3 font-black text-white transition hover:bg-[#063e46]">Consultar sitio oficial</a>`:""}
    ...
    `}const go=new Set([Fe.id,Ue.id]),xo=Object.freeze([Fe,Ue,...Xa.filter(e=>!go.has(e.id))]);let De=null;function fo(e){e&&e.addEventListener("click",a=>{const t=a.target.closest("[data-news-btn]");if(!t||!e.contains(t))return;const i=t.dataset.newsBtn||t.dataset.newsCard,o=xo.find(n=>String(n.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}vo(o,t)})}function vo(e,a){De?.({restaurarFoco:!1});const t=document.createElement("div");t.innerHTML=bo(e);const i=t.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}const o=document.body.style.overflow;document.body.appendChild(i),document.body.style.overflow="hidden";const n=a instanceof HTMLElement?a:document.activeElement;let s=!1;const l=({restaurarFoco:u=!0}={})=>{s||(s=!0,i.remove(),document.body.style.overflow=o,document.removeEventListener("keydown",b),window.removeEventListener("hashchange",d),De===l&&(De=null),u&&n instanceof HTMLElement&&n.isConnected&&n.focus())},d=()=>{l({restaurarFoco:!1})},b=u=>{if(u.key==="Escape"){u.preventDefault(),l();return}if(u.key!=="Tab")return;const p=Array.from(i.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')).filter(w=>w instanceof HTMLElement&&w.getAttribute("aria-hidden")!=="true");if(!p.length){u.preventDefault(),i.focus();return}const f=p[0],y=p[p.length-1];u.shiftKey&&document.activeElement===f?(u.preventDefault(),y.focus()):!u.shiftKey&&document.activeElement===y&&(u.preventDefault(),f.focus())};i.querySelectorAll("[data-close-modal]").forEach(u=>{u.addEventListener("click",l)}),i.addEventListener("click",u=>{u.target===i&&l()}),De=l,document.addEventListener("keydown",b),window.addEventListener("hashchange",d),i.querySelector("[data-close-modal]")?.focus()}function ho(){const e=po();return fo(e),e}const yo=Object.freeze([{patron:/^mathematics and computers in simulation$/i,editorial:"Elsevier B.V. (sello North-Holland)",issn:"0378-4754 · eISSN 1872-7166",modelo:"Híbrido; admite publicación en acceso abierto",descripcion:"Revista oficial de IMACS sobre modelización, simulación y computación científica"},{patron:/^numerical algorithms$/i,editorial:"Springer Nature",issn:"ISSN de la revista disponible en Springer Nature Link",modelo:"Modelo híbrido",descripcion:"Revista especializada en algoritmos numéricos y computación científica"},{patron:/^mediterranean journal of mathematics$/i,editorial:"Springer Nature",issn:"ISSN 1660-5446",modelo:"Modelo híbrido",descripcion:"Revista internacional de matemática pura y aplicada"},{patron:/^bulletin of the malaysian mathematical sciences society$/i,editorial:"Springer Nature",issn:"Información bibliográfica disponible en Springer Nature Link",modelo:"Modelo híbrido",descripcion:"Revista de la Malaysian Mathematical Sciences Society"},{patron:/^mathematische nachrichten$/i,editorial:"Wiley-VCH",issn:"ISSN 0025-584X · eISSN 1522-2616",modelo:"Publicación periódica de Wiley",descripcion:"Revista de amplio alcance en matemática pura y aplicada"},{patron:/^journal of computational methods in sciences and engineering$/i,editorial:"SAGE Publishing para el artículo registrado en 2025",issn:"Información editorial según la edición del artículo",modelo:"Revista de métodos computacionales en ciencias e ingeniería",descripcion:"La gestión editorial de la revista cambió en enero de 2026"},{patron:/^mathematics$/i,editorial:"MDPI",issn:"eISSN 2227-7390",modelo:"Acceso abierto · publicación semimensual",descripcion:"Revista internacional revisada por pares en ciencias matemáticas"},{patron:/^algorithms$/i,editorial:"MDPI",issn:"eISSN 1999-4893",modelo:"Acceso abierto · publicación mensual",descripcion:"Revista de algoritmos, matemática computacional y aplicaciones"},{patron:/^computation$/i,editorial:"MDPI",issn:"eISSN 2079-3197",modelo:"Acceso abierto · publicación mensual",descripcion:"Revista de ciencia e ingeniería computacional"}]);function ka(e=""){return yo.find(a=>a.patron.test(String(e).trim()))||{editorial:"Editorial no especificada en el registro interno",issn:"ISSN no registrado",modelo:"Consultar la página oficial de la revista",descripcion:"Publicación científica revisada por pares"}}function T(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Wa(e){return e?.name||e?.title||"Investigador"}function We(e){return e?.title||e?.tile||"Revista no especificada"}function Ya(e){return String(e?.DOI||e?.doi||"").trim()}function wo(e){const a=Ya(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function ko(e){return[...e?.publicaciones||[]].sort((a,t)=>Number(t.year||0)-Number(a.year||0)||String(a.contenido||"").localeCompare(String(t.contenido||"")))}function Ye(e,a,t=""){return`
        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-3 ${t}">
            <p class="text-[10px] font-black uppercase tracking-[0.16em] text-slate-500">${T(e)}</p>
            <p class="mt-1 text-sm font-bold leading-snug text-slate-800">${T(a)}</p>
        </div>
    `}function Ao(e,a=!1){const t=Wa(e),i=e.publicaciones||[],o=Math.max(...i.map(n=>Number(n.year||0)),0)||"";return`
        <button data-id="${e.id}" type="button"
            ...
            <div class="flex items-center gap-4">
                <img src="${e.img}" alt="${T(t)}" class="h-16 w-16 shrink-0 rounded-2xl border-2 object-cover ${a?"border-white/70":"border-slate-100"}">
                <div class="min-w-0 flex-1">
                    <h3 class="font-black leading-tight">${T(t)}</h3>
                    <p class="mt-1 text-xs font-bold ${a?"text-emerald-100":"text-slate-500"}">${i.length} publicación${i.length===1?"":"es"}${o?` · Última: ${o}`:""}</p>
                    ${e.area?`<p class="mt-2 line-clamp-2 text-xs leading-relaxed ${a?"text-white/75":"text-slate-500"}">${T(e.area)}</p>`:""}
                </div>
            </div>
        </button>
    `}function Eo(e){if(!e)return'<div class="flex h-full items-center justify-center text-white">No hay investigador seleccionado.</div>';const a=Wa(e),t=ko(e),i=t.map(d=>Number(d.year)).filter(Boolean),o=[...new Set(t.map(d=>d.q).filter(Boolean))],n=[...new Set(t.map(We).filter(Boolean))],s=[...new Set(t.map(d=>ka(We(d)).editorial))],l=t.map(d=>{const b=We(d),u=Ya(d),p=ka(b);return`
            <article class="mb-5 rounded-3xl border border-slate-200 bg-white p-5 text-slate-900 shadow-sm transition hover:-translate-y-0.5 hover:shadow-xl md:p-6">
                <div class="flex flex-col gap-4 border-b border-slate-100 pb-5 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        ...
                        <h3 class="mt-1 text-xl font-black leading-tight text-[#071820]">${T(b)}</h3>
                        <p class="mt-2 text-sm leading-relaxed text-slate-600">${T(p.descripcion)}</p>
                    </div>
                    <div class="flex shrink-0 gap-2">
                        <span class="rounded-full bg-[#071820] px-3 py-1.5 text-xs font-black text-white">${T(d.year)}</span>
                        <span class="rounded-full bg-emerald-100 px-3 py-1.5 text-xs font-black text-emerald-900">${T(d.q||"S/C")}</span>
                    </div>
                </div>

                <div class="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
                    ${Ye("Editorial",p.editorial)}
                    ${Ye("Identificación",p.issn)}
                    ${Ye("Modelo de publicación",p.modelo)}
                </div>

                <h4 class="mt-6 text-base font-black leading-snug text-slate-950 md:text-lg">${T(d.contenido)}</h4>
                <p class="mt-4 text-sm leading-relaxed text-slate-600"><span class="font-black text-[#0f5b5d]">Autores:</span> ${T(d.autores)}</p>
                ${u?`<p class="mt-3 break-all font-mono text-xs font-bold text-slate-500"><span class="font-sans font-black text-slate-700">DOI:</span> ${T(u)}</p>`:""}

                <div class="mt-5 flex flex-wrap gap-3 border-t border-slate-100 pt-4">
                    ${u?`<a href="${T(wo(d))}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-xl bg-[#0f5b5d] px-4 py-2 text-sm font-black text-white hover:bg-[#0a4648]">Abrir DOI <span aria-hidden="true">↗</span></a>`:'<span class="text-sm font-bold text-slate-400">DOI no disponible</span>'}
                    ${d.pdf?`<a href="${T(d.pdf)}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center rounded-xl border border-slate-300 px-4 py-2 text-sm font-black text-slate-700 hover:border-[#0f5b5d] hover:text-[#0f5b5d]">Descargar PDF</a>`:""}
                </div>
            </article>
        `}).join("");return`
        <div class="flex h-full flex-col text-white">
            <div class="mb-5 flex items-start justify-between gap-4 border-b border-white/10 pb-5">
                <div class="flex items-start gap-4">
                    <img src="${e.img}" alt="${T(a)}" class="hidden h-16 w-16 rounded-2xl border-2 border-emerald-300 object-cover shadow-lg sm:block">
                    <div>
                        <p class="text-xs font-black uppercase tracking-[0.18em] text-[#efc86f]">Producción científica por investigador</p>
                        <h2 id="titulo-detalle-publicaciones" class="mt-1 text-xl font-black md:text-2xl">${T(a)}</h2>
                        ${e.area?`<p class="mt-2 text-sm leading-relaxed text-slate-300">${T(e.area)}</p>`:""}
                    </div>
                </div>
            ...
            <section class="mb-5 rounded-2xl border border-white/10 bg-white/5 p-4" aria-label="Revistas registradas">
                ...
                <p class="mt-2 text-sm leading-relaxed text-slate-300">${n.map(T).join(" · ")||"—"}</p>
            </section>
    ...
    `}function Co(){let e=re[0]?.id||1,a=!1,t=null,i=null,o="",n=null,s=!1;const l=document.createElement("section");l.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";function d(r){return String(r?.DOI||r?.doi||"").trim().toLowerCase()}function b(r){return String(r?.journal||r?.title||r?.tile||"").trim()}function u(r){return String(r?.articleTitle||r?.contenido||"").trim()}function p(r){return String(r?.q||r?.quartile||"").trim().toUpperCase()}function f(r){return d(r)||[r?.year||"",b(r),u(r)].join("-").trim().toLowerCase()}function y(){const r=new Map;return re.forEach(m=>(m.publicaciones||[]).forEach(c=>{const x=f(c);x&&!r.has(x)&&r.set(x,c)})),[...r.values()]}function w(){const r=y(),m=r.map(c=>Number(c.year)).filter(Boolean);return{total:r.length,investigadores:D.integrantes,q1:r.filter(c=>p(c)==="Q1").length,periodo:m.length?`${Math.min(...m)}–${Math.max(...m)}`:"—"}}function A(){return re.find(r=>Number(r.id)===Number(e))||re[0]}const h=()=>{i?.abort(),i=null,s&&(document.body.style.overflow=o,o="",s=!1)},g=({restaurarFoco:r=!0,renderizar:m=!0}={})=>{const c=n;h(),a=!1,m&&(C(),r&&c!==null&&window.requestAnimationFrame(()=>{l.querySelector(`[data-id="${c}"]`)?.focus()}))},E=()=>{if(!a||window.innerWidth>=768)return;const r=l.querySelector("#detalle-container");if(!r)return;o=document.body.style.overflow,document.body.style.overflow="hidden",s=!0,i=new AbortController;const m={signal:i.signal},c=()=>[...r.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')].filter(x=>x instanceof HTMLElement&&x.getAttribute("aria-hidden")!=="true");document.addEventListener("keydown",x=>{if(x.key==="Escape"){x.preventDefault(),g();return}if(x.key!=="Tab")return;const v=c();if(!v.length){x.preventDefault();return}const k=v[0],I=v.at(-1);x.shiftKey&&document.activeElement===k?(x.preventDefault(),I.focus()):!x.shiftKey&&document.activeElement===I&&(x.preventDefault(),k.focus())},m),window.addEventListener("hashchange",()=>{g({restaurarFoco:!1,renderizar:!1})},m),r.addEventListener("click",x=>{x.target===r&&g()},m),r.querySelector("#close-modal")?.addEventListener("click",()=>g(),m),r.querySelector("#close-modal")?.focus()},C=()=>{h();const r=A(),m=w(),c=window.innerWidth<768&&!a,x=window.innerWidth<768&&a?'role="dialog" aria-modal="true" aria-labelledby="titulo-detalle-publicaciones"':"",v=[[D.articulosAcumuladosTexto,D.etiquetaArticulos],[m.investigadores,"Integrantes del grupo"],[m.total,"Registros únicos con DOI"],[m.periodo,"Periodo registrado"]];l.innerHTML=`
            <div class="mx-auto max-w-[1600px]">
                    ...
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
                        ...
                        <div>
                            <div class="grid grid-cols-2 gap-3">
                                ${v.map(([k,I])=>`<article class="rounded-2xl border border-white/10 bg-white/5 p-4"><p class="text-2xl font-black text-white md:text-3xl">${k}</p><p class="mt-1 text-xs font-bold uppercase tracking-wide text-emerald-200">${I}</p></article>`).join("")}
                            </div>
                            <p id="kernel-career-publications-note" class="mt-3 rounded-2xl border border-white/10 bg-white/5 p-3 text-xs leading-relaxed text-slate-300">
                                ${D.descripcionArticulos}. ${D.notaArticulos}
                            </p>
                        </div>
                    </div>
                </header>
                ...
                <div class="mt-8 grid min-h-[720px] grid-cols-1 gap-6 rounded-[2rem] border border-slate-200 bg-white p-4 shadow-xl md:grid-cols-[0.78fr_1.5fr] md:p-6">
                    <aside class="max-h-[430px] overflow-y-auto rounded-3xl border border-slate-200 bg-slate-50 p-4 custom-scrollbar md:max-h-none">
                        ...
                        <div class="mt-5 flex flex-col gap-4">${re.map(k=>Ao(k,Number(k.id)===Number(e))).join("")}</div>
                    </aside>
                    ...
                    <div id="detalle-container" ${x} class="fixed inset-0 z-[350] items-center justify-center bg-slate-950/80 p-4 md:relative md:inset-auto md:z-0 md:flex md:bg-transparent md:p-0 ${c?"hidden":"flex"}">
                        <div class="h-[88%] w-full max-w-lg rounded-[2rem] border border-white/10 bg-[#071820] p-5 shadow-2xl md:h-full md:max-w-none md:p-6">${Eo(r)}</div>
                    </div>
                </div>
            </div>
        `,l.querySelectorAll("[data-id]").forEach(k=>{k.onclick=()=>{e=Number(k.dataset.id),window.innerWidth<768&&(a=!0,n=k.dataset.id),C()}}),E()};return window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{window.innerWidth>=768&&(h(),a=!1),C()},120)}),C(),l}function So(){return Co()}function _(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function $o(e){return W.find(a=>a.id===e)||W[0]}function Ze(e=[]){return e.map(a=>`
        <li class="flex gap-3 text-sm md:text-base text-slate-600 leading-relaxed">
            <span class="mt-2 w-2 h-2 rounded-full bg-orange-500 shrink-0"></span>
            <span>${_(a)}</span>
        </li>
    `).join("")}function Mo(e=[]){return e.map(a=>`
    ...
    `).join("")}function jo(e=[]){return e.map(a=>`
    ...
    `).join("")}function Lo(e,a=!1){return`
        <button 
            ...
            <p class="text-sm leading-relaxed ${a?"text-white/90":"text-slate-500"}">
                ${_(e.desarrollo).slice(0,185)}${String(e.desarrollo).length>185?"...":""}
            </p>
        </button>
    `}function zo(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${_(e.categoria)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Prioridad</p>
                        <p class="text-slate-800 font-bold mt-1">${_(e.prioridad)}</p>
                    </div>
    ...
    `}function Io(){const e=new Set(W.map(i=>i.categoria)),a=W.filter(i=>i.proyectosAsociados?.length>0).length,t=W.filter(i=>i.publicacionesClave?.length>0).length;return{total:W.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function Do(){let e=W[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=$o(e),o=Io();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-linea-id]").forEach(n=>{n.onclick=()=>{e=parseInt(n.dataset.lineaId),t()}})};return t(),a}function Po(){return Do()}function F(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Aa(e=[]){return e.map(a=>`<li class="flex gap-3 text-sm leading-relaxed text-slate-600 md:text-base"><span class="mt-2 h-2 w-2 shrink-0 rounded-full bg-[#b37a2a]"></span><span>${F(a)}</span></li>`).join("")}function Ro(e=[]){return e.map(a=>`<span class="rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-black text-[#0f5b5d]">${F(a)}</span>`).join("")}function Oo(e,a){return`<button type="button" data-proyecto-id="${e.id}" class="w-full rounded-2xl border p-5 text-left transition ${a?"border-[#0f5b5d] bg-[#0f5b5d] text-white shadow-xl":"border-slate-200 bg-white text-slate-950 hover:-translate-y-0.5 hover:border-emerald-300 hover:shadow-lg"}">
        <div class="mb-3 flex flex-wrap gap-2"><span class="rounded-full bg-[#d5a54a] px-3 py-1 text-[11px] font-black uppercase text-[#06141a]">${F(e.estado)}</span><span class="rounded-full ${a?"bg-white/10 text-white":"bg-slate-100 text-slate-600"} px-3 py-1 text-[11px] font-black uppercase">${F(e.convocatoria)}</span></div>
        <h3 class="font-black leading-tight">${F(e.title)}</h3>
        <p class="mt-3 text-sm leading-relaxed ${a?"text-white/75":"text-slate-500"}">${F(e.enfoque)}</p>
        <p class="mt-4 text-xs font-bold ${a?"text-emerald-100":"text-slate-500"}">${F(e.institucion)} · ${F(e.duracion)}</p>
    </button>`}function qo(e){return`<article class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-xl">
        <header class="relative overflow-hidden bg-[#071820] px-6 py-8 text-white md:px-9 md:py-10">
            ...
            <div class="relative"><div class="flex flex-wrap gap-2"><span class="rounded-full bg-[#d5a54a] px-3 py-1 text-xs font-black uppercase text-[#06141a]">${F(e.estado)}</span><span class="rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs font-black uppercase">${F(e.convocatoria)}</span></div><h2 class="mt-5 max-w-4xl text-2xl font-black leading-tight md:text-4xl">${F(e.title)}</h2><p class="mt-4 max-w-4xl leading-relaxed text-slate-300">${F(e.contenido)}</p></div>
        </header>
        <div class="p-6 md:p-9">
            <section class="grid grid-cols-2 gap-3 md:grid-cols-4">${[["Institución",e.institucion],["Tipo",e.tipo],["Duración",e.duracion],["Estado",e.estado]].map(([a,t])=>`<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4"><p class="text-xs font-black uppercase tracking-wide text-[#805615]">${F(a)}</p><p class="mt-1 font-black text-slate-950">${F(t)}</p></div>`).join("")}</section>
            <section class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2"><div><h3 class="text-xl font-black text-[#071820]">Contexto y línea</h3><p class="mt-3 leading-relaxed text-slate-600">${F(e.contexto)}</p><p class="mt-4 rounded-2xl border-l-4 border-[#0f5b5d] bg-emerald-50 p-4 text-sm font-bold text-slate-700">${F(e.linea)}</p></div><div class="grid grid-cols-1 gap-6 sm:grid-cols-2"><div><h3 class="text-lg font-black text-[#071820]">Objetivos</h3><ul class="mt-3 space-y-3">${Aa(e.objetivos)}</ul></div><div><h3 class="text-lg font-black text-[#071820]">Resultados esperados</h3><ul class="mt-3 space-y-3">${Aa(e.resultados)}</ul></div></div></section>
            <section class="mt-8 rounded-3xl bg-[#071820] p-6 text-white"><p class="text-xs font-black uppercase tracking-[0.18em] text-[#efc86f]">Equipo vinculado</p><div class="mt-4 flex flex-wrap gap-2">${(e.equipo||[]).map(a=>`<span class="rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-bold">${F(a)}</span>`).join("")}</div></section>
            <div class="mt-7 flex flex-wrap gap-2">${Ro(e.etiquetas)}</div>
        </div>
    </article>`}function To(){let e=xe[0]?.id||1;const a=document.createElement("section");a.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";const t=()=>{const i=xe.find(o=>o.id===e)||xe[0];a.innerHTML=`<div class="mx-auto max-w-[1600px]">
            <header class="rounded-[2rem] bg-[#071820] px-6 py-10 text-white shadow-2xl md:px-10 md:py-12"><p class="text-xs font-black uppercase tracking-[0.2em] text-[#efc86f]">Investigación, innovación y transferencia</p><h1 class="mt-3 text-4xl font-black md:text-6xl">Proyectos y propuestas estratégicas</h1><p class="mt-5 max-w-4xl text-base leading-relaxed text-slate-300 md:text-lg">Organizamos cada iniciativa por estado, institución, duración, objetivos, resultados y equipo. Las propuestas sometidas se identifican como tales y no se presentan como proyectos financiados hasta recibir confirmación formal.</p><div class="mt-7 grid grid-cols-2 gap-3 md:max-w-2xl md:grid-cols-3"><div class="rounded-2xl bg-white/5 p-4"><p class="text-3xl font-black">${xe.length}</p><p class="text-xs font-bold text-emerald-200">Iniciativas registradas</p></div><div class="rounded-2xl bg-white/5 p-4"><p class="text-2xl font-black">FONDOCyT</p><p class="text-xs font-bold text-emerald-200">Convocatoria</p></div><div class="col-span-2 rounded-2xl bg-white/5 p-4 md:col-span-1"><p class="text-2xl font-black">Trazabilidad</p><p class="text-xs font-bold text-emerald-200">Estado verificable</p></div></div></header>
            <div class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[0.72fr_1.5fr]"><aside class="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-lg"><p class="text-xs font-black uppercase tracking-[0.18em] text-[#805615]">Portafolio</p><h2 class="mt-1 text-2xl font-black text-slate-950">Seleccione una iniciativa</h2><div class="mt-5 space-y-4">${xe.map(o=>Oo(o,o.id===e)).join("")}</div></aside><div>${qo(i)}</div></div>
        </div>`,a.querySelectorAll("[data-proyecto-id]").forEach(o=>o.addEventListener("click",()=>{e=Number(o.dataset.proyectoId),t()}))};return t(),a}function No(){return To()}function Fo(){return`
    ...
    `}function Bo(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Uo()}
    `,e}function _o(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Vo)}async function Vo(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=Ko(i);if(o.length>0){Ho(o);return}await Jo(a,i)}function Ko(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?Go(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function Go(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Ho(e){Re(e[0],"error")}function Re(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Jo(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(Re("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):Re("Hubo un problema al enviar el mensaje.","error")}catch{Re("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Qo(){const e=Bo();return setTimeout(()=>{_o()},0),e}function Xo(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
A00116736    13    7"
    ...
    `;const a=e.querySelector("#banner-primer-input"),t=e.querySelector("#banner-primer-process"),i=e.querySelector("#banner-primer-clear"),o=e.querySelector("#banner-primer-message"),n=e.querySelector("#banner-primer-preview"),s=e.querySelector("#banner-primer-count"),l=e.querySelector("#banner-primer-download-1ac"),d=e.querySelector("#banner-primer-download-2pp");let b=[];function u(c,x="success"){o.textContent=c,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),x==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function p(){o.textContent="",o.classList.add("hidden")}function f(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function y(c){return String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function w(c){const x=String(c).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return x.includes("	")?x.split("	").map(v=>v.trim()).filter(v=>v!==""):x.includes(";")?x.split(";").map(v=>v.trim()).filter(v=>v!==""):x.split(/\s+/).map(v=>v.trim()).filter(v=>v!=="")}function A(c){const x=c.split(/\r?\n/).map(M=>M.trim()).filter(Boolean),v=[],k=[],I=new Set;return x.forEach((M,R)=>{const z=R+1,O=w(M);if(O.length!==3){k.push(`Línea ${z}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const Y=f(O[0]),B=Number(y(O[1])),G=Number(y(O[2]));if(!/^A[0-9]{8}$/.test(Y)){k.push(`Línea ${z}: la matrícula "${Y}" no es válida. Debe tener el formato A00108671.`);return}if(I.has(Y)){k.push(`Línea ${z}: la matrícula ${Y} está repetida.`);return}if(!Number.isFinite(B)){k.push(`Línea ${z}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(G)){k.push(`Línea ${z}: la calificación 2PP no es numérica.`);return}if(B<0||B>15){k.push(`Línea ${z}: 1AC debe estar entre 0 y 15.`);return}if(G<0||G>20){k.push(`Línea ${z}: 2PP debe estar entre 0 y 20.`);return}const ue=B+G;if(ue>35){k.push(`Línea ${z}: la suma de 1AC y 2PP no puede superar 35 puntos.`);return}I.add(Y),v.push({matricula:Y,grade1AC:B,grade2PP:G,total:ue})}),{records:v,errors:k}}function h(c){return Number.isInteger(c)?String(c):c.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function g(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function E(c){if(c.length===0){n.innerHTML=`
            ...
            `,s.textContent="0 estudiantes";return}n.innerHTML=c.map((x,v)=>`
                ...
                `).join(""),s.textContent=`${c.length} estudiante${c.length===1?"":"s"}`}function C(c,x,v){return[["MATRICULA",v],...c.map(M=>[M.matricula,h(M[x])])].map(M=>M.join(";")).join(`\r
`)}function r(c,x){const k=new Blob(["\uFEFF"+c],{type:"text/csv;charset=utf-8;"}),I=URL.createObjectURL(k),M=document.createElement("a");M.href=I,M.download=x,document.body.appendChild(M),M.click(),M.remove(),window.setTimeout(()=>{URL.revokeObjectURL(I)},1e3)}function m(){b=[],a.value="",E([]),l.disabled=!0,d.disabled=!0,p(),a.focus()}return t.addEventListener("click",()=>{const c=a.value.trim();if(!c){b=[],E([]),l.disabled=!0,d.disabled=!0,u("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:x,errors:v}=A(c);if(v.length>0){b=[],E([]),l.disabled=!0,d.disabled=!0,u(v.join(" "),"error");return}b=x,E(b),l.disabled=!1,d.disabled=!1,u(`Los datos de ${x.length} estudiante${x.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",m),l.addEventListener("click",()=>{if(b.length===0)return;const c=C(b,"grade1AC","1AC");r(c,"Banner_APEC_Primer_Periodo_1AC.csv")}),d.addEventListener("click",()=>{if(b.length===0)return;const c=C(b,"grade2PP","2PP");r(c,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function Wo(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    25"
    ...
    `;const a=e.querySelector("#banner-segundo-input"),t=e.querySelector("#banner-segundo-process"),i=e.querySelector("#banner-segundo-clear"),o=e.querySelector("#banner-segundo-message"),n=e.querySelector("#banner-segundo-preview"),s=e.querySelector("#banner-segundo-count"),l=e.querySelector("#banner-segundo-download");let d=[];function b(r){return String(r).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function u(r){return String(r).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function p(r){const m=String(r).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return m.includes("	")?m.split("	").map(c=>c.trim()).filter(c=>c!==""):m.includes(";")?m.split(";").map(c=>c.trim()).filter(c=>c!==""):m.split(/\s+/).map(c=>c.trim()).filter(c=>c!=="")}function f(r){return Number.isInteger(r)?String(r):r.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function y(r){return String(r).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function w(r,m="success"){o.textContent=r,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),m==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function A(r){const m=r.split(/\r?\n/).map(k=>k.trim()).filter(Boolean),c=[],x=[],v=new Set;return m.forEach((k,I)=>{const M=I+1,R=p(k);if(R.length!==2){x.push(`Línea ${M}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const z=b(R[0]),O=Number(u(R[1]));if(!/^A[0-9]{8}$/.test(z)){x.push(`Línea ${M}: la matrícula "${z}" no es válida. Debe tener el formato A00108671.`);return}if(v.has(z)){x.push(`Línea ${M}: la matrícula ${z} está repetida.`);return}if(!Number.isFinite(O)){x.push(`Línea ${M}: la calificación 3SP no es numérica.`);return}if(O<0||O>35){x.push(`Línea ${M}: 3SP debe estar entre 0 y 35.`);return}v.add(z),c.push({matricula:z,grade3SP:O})}),{records:c,errors:x}}function h(r){if(r.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,s.textContent="0 estudiantes";return}n.innerHTML=r.map((m,c)=>`
                ...
                `).join(""),s.textContent=`${r.length} estudiante${r.length===1?"":"s"}`}function g(r){return[["MATRICULA","3SP"],...r.map(c=>[c.matricula,f(c.grade3SP)])].map(c=>c.join(";")).join(`\r
`)}function E(r,m){const c=new Blob(["\uFEFF"+r],{type:"text/csv;charset=utf-8;"}),x=URL.createObjectURL(c),v=document.createElement("a");v.href=x,v.download=m,document.body.appendChild(v),v.click(),v.remove(),window.setTimeout(()=>{URL.revokeObjectURL(x)},1e3)}function C(){d=[],a.value="",h([]),l.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const r=a.value.trim();if(!r){d=[],h([]),l.disabled=!0,w("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:m,errors:c}=A(r);if(c.length>0){d=[],h([]),l.disabled=!0,w(c.join(" "),"error");return}d=m,h(m),l.disabled=!1,w(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",C),l.addEventListener("click",()=>{d.length!==0&&E(g(d),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function Yo(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    20"
    ...
    `;const a=e.querySelector("#banner-final-input"),t=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),n=e.querySelector("#banner-final-preview"),s=e.querySelector("#banner-final-count"),l=e.querySelector("#banner-final-download");let d=[];function b(r){return String(r).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function u(r){return String(r).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function p(r){const m=String(r).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return m.includes("	")?m.split("	").map(c=>c.trim()).filter(c=>c!==""):m.includes(";")?m.split(";").map(c=>c.trim()).filter(c=>c!==""):m.split(/\s+/).map(c=>c.trim()).filter(c=>c!=="")}function f(r){return Number.isInteger(r)?String(r):r.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function y(r){return String(r).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function w(r,m="success"){o.textContent=r,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),m==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function A(r){const m=r.split(/\r?\n/).map(k=>k.trim()).filter(Boolean),c=[],x=[],v=new Set;return m.forEach((k,I)=>{const M=I+1,R=p(k);if(R.length!==2){x.push(`Línea ${M}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const z=b(R[0]),O=Number(u(R[1]));if(!/^A[0-9]{8}$/.test(z)){x.push(`Línea ${M}: la matrícula "${z}" no es válida. Debe tener el formato A00108671.`);return}if(v.has(z)){x.push(`Línea ${M}: la matrícula ${z} está repetida.`);return}if(!Number.isFinite(O)){x.push(`Línea ${M}: la calificación 4EF no es numérica.`);return}if(O<0||O>30){x.push(`Línea ${M}: 4EF debe estar entre 0 y 30.`);return}v.add(z),c.push({matricula:z,grade4EF:O})}),{records:c,errors:x}}function h(r){if(r.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,s.textContent="0 estudiantes";return}n.innerHTML=r.map((m,c)=>`
                ...
                `).join(""),s.textContent=`${r.length} estudiante${r.length===1?"":"s"}`}function g(r){return[["MATRICULA","4EF"],...r.map(c=>[c.matricula,f(c.grade4EF)])].map(c=>c.join(";")).join(`\r
`)}function E(r,m){const c=new Blob(["\uFEFF"+r],{type:"text/csv;charset=utf-8;"}),x=URL.createObjectURL(c),v=document.createElement("a");v.href=x,v.download=m,document.body.appendChild(v),v.click(),v.remove(),window.setTimeout(()=>{URL.revokeObjectURL(x)},1e3)}function C(){d=[],a.value="",h([]),l.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const r=a.value.trim();if(!r){d=[],h([]),l.disabled=!0,w("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:m,errors:c}=A(r);if(c.length>0){d=[],h([]),l.disabled=!0,w(c.join(" "),"error");return}d=m,h(m),l.disabled=!1,w(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",C),l.addEventListener("click",()=>{d.length!==0&&E(g(d),"Banner_APEC_Examen_Final_4EF.csv")}),e}function Zo(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),n=e.querySelector("#open-segundo-periodo"),s=e.querySelector("#open-calificacion-final"),l=e.querySelector("#banner-back");function d(){a.classList.add("hidden"),t.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}function b(f){console.error("No fue posible abrir la herramienta de Banner:",f),i.innerHTML=`
        ...
        `,d()}function u(f){i.innerHTML="";try{if(typeof f!="function")throw new TypeError("El componente seleccionado no es una función válida.");const y=f();if(!(y instanceof HTMLElement))throw new TypeError("El componente seleccionado no devolvió un elemento HTML válido.");i.appendChild(y),d()}catch(y){b(y)}}function p(){i.replaceChildren(),t.classList.add("hidden"),a.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}return o.addEventListener("click",()=>{u(Xo)}),n.addEventListener("click",()=>{u(Wo)}),s.addEventListener("click",()=>{u(Yo)}),l.addEventListener("click",p),e}function es(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
...
};`,o.disabled=!0}function f(h,g="success"){s.textContent=h,s.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),s.classList.add("border"),g==="error"?s.classList.add("border-red-200","bg-red-50","text-red-800"):s.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(h){const g=h.split(/\r?\n/).map(m=>m.trim()).filter(Boolean),E=[],C=[],r=new Set;return g.forEach((m,c)=>{const x=m.split(/[\t,; ]+/).map(R=>R.trim()).filter(Boolean),v=c+1,k=x[0],I=x.slice(1);if(!k){C.push(`Línea ${v}: falta la matrícula.`);return}if(!/^\d+$/.test(k)){C.push(`Línea ${v}: la matrícula "${k}" no es válida.`);return}if(r.has(k)){C.push(`Línea ${v}: la matrícula ${k} está repetida.`);return}if(I.length===0){C.push(`Línea ${v}: falta al menos una calificación.`);return}const M=I.map(R=>Number(R));if(M.some(R=>!Number.isFinite(R))){C.push(`Línea ${v}: existe una calificación no numérica.`);return}r.add(k),E.push({matricula:k,grades:M})}),{records:E,errors:C}}function w(h){return`var data_todo = {
${h.map(({matricula:E,grades:C})=>`  "${E}":[${C.join(",")}]`).join(`,
`)}
};
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function A(h){const g=h==="xmera";b.classList.toggle("hidden",!g),u.classList.toggle("hidden",g),l.className=g?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",d.className=g?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const h=a.value.trim();if(!h){p(),f("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:g,errors:E}=y(h);if(E.length>0){p(),f(E.join(" "),"error");return}t.textContent=w(g),o.disabled=!1,f(`Código generado correctamente para ${g.length} estudiante${g.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),f("El código fue copiado al portapapeles.")}catch(h){console.error("No fue posible copiar el código:",h),f("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),n.addEventListener("click",()=>{a.value="",p(),s.textContent="",s.classList.add("hidden"),a.focus()});try{const h=Zo();if(h instanceof HTMLElement)u.appendChild(h);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(h){console.error("No fue posible cargar el módulo Banner:",h),u.innerHTML=`
        ...
        `}return l.addEventListener("click",()=>{A("xmera")}),d.addEventListener("click",()=>{A("banner")}),A("xmera"),e}function as(){return es()}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Za(e){return String(e??"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim()}function ts(e,a=!1){return`
        <button
            type="button"
    ...
    `}function is(e){const a=Za([e.numero,e.titulo,e.tituloCorto,e.resumen,e.descripcion,e.categoriaNombre,...e.subservicios||[],e.entregables].join(" "));return`
        <article
            data-servicio-card
    ...
    `}function ds(e){const a=encodeURIComponent(`Solicitud de servicio: ${e.titulo}`);return`
    ...
    `}function us(){const e=document.createElement("section");e.id="catalogo-servicios",e.className="relative overflow-hidden rounded-[2rem] border border-sky-100 bg-gradient-to-br from-slate-50 via-white to-sky-50 px-5 py-9 shadow-lg md:px-8 md:py-12 xl:px-10",e.setAttribute("aria-labelledby","titulo-catalogo-servicios"),e.innerHTML=`
        ...
        <div class="relative z-10 space-y-10">
            <header class="grid grid-cols-1 gap-7 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
                <div>
                    ...
                    <p class="mt-4 text-sm font-bold text-slate-500 md:text-base">${$(ye.subtitulo)}</p>
                ...
                <aside class="rounded-3xl border border-slate-800 bg-slate-950 p-6 text-white shadow-xl">
                    ...
                    <p class="mt-3 text-sm leading-relaxed text-slate-300">${$(ye.notaAlcance)}</p>
            ...
            <section class="grid grid-cols-2 gap-3 md:grid-cols-4" aria-label="Resumen del catálogo">
                ${[[le.length,"áreas de servicio"],[ia.length-1,"bloques temáticos"],[ha.length,"paquetes sugeridos"],[va.length,"etapas de trabajo"]].map(([u,p])=>`
        ...
        ></dialog>
    `;const a=[...e.querySelectorAll("[data-servicio-card]")],t=[...e.querySelectorAll("[data-filtro-servicio]")],i=e.querySelector("[data-buscador-servicios]"),o=e.querySelector("[data-contador-servicios]"),n=e.querySelector("[data-vacio-servicios]"),s=e.querySelector("[data-dialogo-servicio]");let l="todos",d=null;function b(){const u=Za(i?.value);let p=0;a.forEach(f=>{const y=l==="todos"||f.dataset.categoria===l,w=!u||String(f.dataset.busqueda||"").includes(u),A=y&&w;f.classList.toggle("hidden",!A),A&&(p+=1)}),o&&(o.textContent=`${p} servicio${p===1?"":"s"} disponible${p===1?"":"s"}`),n?.classList.toggle("hidden",p!==0)}return t.forEach(u=>{u.addEventListener("click",()=>{l=u.dataset.filtroServicio||"todos",t.forEach(p=>{const f=p===u;p.setAttribute("aria-pressed",String(f)),p.classList.toggle("border-sky-700",f),p.classList.toggle("bg-sky-700",f),p.classList.toggle("text-white",f),p.classList.toggle("shadow-md",f),p.classList.toggle("border-slate-300",!f),p.classList.toggle("bg-white",!f),p.classList.toggle("text-slate-700",!f)}),b()})}),i?.addEventListener("input",b),e.addEventListener("click",u=>{const p=u.target.closest("[data-servicio-detalle]");if(!p||!e.contains(p))return;const f=le.find(y=>y.id===p.dataset.servicioDetalle);!f||!s||(d=p,s.innerHTML=ds(f),typeof s.showModal=="function"?s.showModal():s.setAttribute("open",""),s.querySelector("[data-cerrar-dialogo-servicio]")?.focus())}),s?.addEventListener("click",u=>{(u.target===s||u.target.closest("[data-cerrar-dialogo-servicio]"))&&(s.close?.(),s.removeAttribute("open"))}),s?.addEventListener("close",()=>{d?.focus(),d=null}),e}const Ea="kernel-services-filter",ps="kernel-service-interest";function ms(e){let a=null;try{a=window.sessionStorage.getItem(Ea),window.sessionStorage.removeItem(Ea)}catch(i){console.warn("[Kernel] No fue posible recuperar el filtro del catálogo.",i)}if(!a||a==="todos")return;const t=e.querySelector(`[data-filtro-servicio="${CSS.escape(a)}"]`);window.requestAnimationFrame(()=>t?.click())}function bs(e){if(e)try{window.sessionStorage.setItem(ps,e)}catch(a){console.warn("[Kernel] No fue posible conservar el servicio de interés.",a)}}function gs(e){e.querySelectorAll('a[href="#/contacto"]').forEach(t=>{t.href="#/diagnosticoServicios",t.textContent="Solicitar diagnóstico"});let a=null;e.addEventListener("click",t=>{const i=t.target.closest("[data-servicio-detalle]");if(i&&e.contains(i)){a=i.dataset.servicioDetalle||null;return}const o=t.target.closest('a[href="#/contacto"], a[href="#/diagnosticoServicios"]');!o||!e.contains(o)||(t.preventDefault(),bs(a),window.location.hash="/diagnosticoServicios")})}function xs(){const e=document.createElement("section");e.className="w-full bg-slate-100 px-3 py-6 font-sans sm:px-5 md:py-9 lg:px-8";const a=document.createElement("div");a.className="mx-auto max-w-[1680px]";const t=us();return t.classList.remove("rounded-[2rem]"),t.classList.add("rounded-3xl"),gs(t),a.appendChild(t),e.appendChild(a),ms(t),e}const Ca="mleonardos@unapec.edu.do",Sa="kernel-service-interest";function Be(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function fs(){return le.map(e=>`
        <option value="${Be(e.id)}">${String(e.numero).padStart(2,"0")} · ${Be(e.tituloCorto)}</option>
    `).join("")}function vs(){return _a.map(e=>`
        <option value="${Be(e)}">${Be(e)}</option>
    `).join("")}function ke({id:e,etiqueta:a,tipo:t="text",requerido:i=!1,placeholder:o="",autocomplete:n="off"}){return`
    ...
    `}function hs(e){if(e)try{const a=window.sessionStorage.getItem(Sa);window.sessionStorage.removeItem(Sa),a&&[...e.options].some(t=>t.value===a)&&(e.value=a)}catch(a){console.warn("[Kernel] No fue posible recuperar el servicio de interés.",a)}}function U(e,a){return String(new FormData(e).get(a)||"").trim()}function et(e){return le.find(a=>a.id===e)?.titulo||"No especificado"}function $a(e){const a={nombre:U(e,"nombre"),organizacion:U(e,"organizacion"),cargo:U(e,"cargo"),correo:U(e,"correo"),telefono:U(e,"telefono"),sector:U(e,"sector"),servicio:et(U(e,"servicio")),necesidad:U(e,"necesidad"),datos:U(e,"datos"),plazo:U(e,"plazo"),presupuesto:U(e,"presupuesto"),producto:U(e,"producto"),modalidad:U(e,"modalidad")};return["SOLICITUD DE DIAGNÓSTICO INICIAL — GRUPO EL KERNEL","",`Nombre: ${a.nombre}`,`Organización: ${a.organizacion||"No indicada"}`,`Cargo o función: ${a.cargo||"No indicado"}`,`Correo: ${a.correo}`,`Teléfono: ${a.telefono||"No indicado"}`,`Sector: ${a.sector||"No especificado"}`,`Servicio de interés: ${a.servicio}`,`Modalidad preferida: ${a.modalidad||"No especificada"}`,`Plazo esperado: ${a.plazo||"No especificado"}`,`Presupuesto estimado: ${a.presupuesto||"No especificado"}`,"","Problema o necesidad:",a.necesidad,"","Datos, documentos o recursos disponibles:",a.datos||"No especificados","","Producto o resultado esperado:",a.producto||"No especificado","","Nota: adjuntaré al correo generado los términos de referencia o documentos pertinentes, si aplica."].join(`
`)}async function ys(e){if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(e);return}const a=document.createElement("textarea");a.value=e,a.setAttribute("readonly",""),a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove()}function ws(){const e=document.createElement("section");e.className="w-full bg-slate-100 px-3 py-6 font-sans sm:px-5 md:py-10 lg:px-8",e.innerHTML=`
            ...
            <div class="grid grid-cols-1 gap-8 p-5 md:p-8 xl:grid-cols-[1.25fr_0.75fr] xl:p-10">
                <form data-formulario-diagnostico class="space-y-7" novalidate>
                    <section aria-labelledby="titulo-identificacion-diagnostico">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ${ke({id:"nombre",etiqueta:"Nombre completo",requerido:!0,placeholder:"Nombre y apellidos",autocomplete:"name"})}
                            ${ke({id:"correo",etiqueta:"Correo electrónico",tipo:"email",requerido:!0,placeholder:"nombre@institucion.edu",autocomplete:"email"})}
                            ${ke({id:"organizacion",etiqueta:"Organización o institución",placeholder:"Universidad, empresa, organismo...",autocomplete:"organization"})}
                            ${ke({id:"cargo",etiqueta:"Cargo o función",placeholder:"Director, docente, investigador...",autocomplete:"organization-title"})}
                            ${ke({id:"telefono",etiqueta:"Teléfono",tipo:"tel",placeholder:"+1 809 ...",autocomplete:"tel"})}
                ...
                <aside class="space-y-5">
                    ...
                    <section class="rounded-3xl bg-[#071820] p-6 text-white">
                        ...
                        <h2 class="mt-2 text-2xl font-black">${Ca}</h2>
    ...
    `;const a=e.querySelector("[data-formulario-diagnostico]"),t=e.querySelector("[data-estado-diagnostico]"),i=e.querySelector("#servicio");return hs(i),a?.addEventListener("submit",o=>{if(o.preventDefault(),!a.checkValidity()){a.reportValidity(),t&&(t.textContent="Complete los campos obligatorios antes de continuar.");return}const n=$a(a),s=encodeURIComponent(`Solicitud de diagnóstico: ${et(U(a,"servicio"))}`),l=encodeURIComponent(n);t&&(t.textContent="Abriendo su aplicación de correo. Adjunte los documentos pertinentes antes de enviar."),window.location.href=`mailto:${Ca}?subject=${s}&body=${l}`}),e.querySelector("[data-copiar-diagnostico]")?.addEventListener("click",async()=>{if(!a?.checkValidity()){a?.reportValidity(),t&&(t.textContent="Complete los campos obligatorios para copiar un resumen útil.");return}try{await ys($a(a)),t&&(t.textContent="Resumen copiado. Puede pegarlo en un correo o documento.")}catch(o){console.error("[Kernel] No fue posible copiar el diagnóstico.",o),t&&(t.textContent="No fue posible copiar automáticamente. Utilice el botón para preparar el correo.")}}),e}const ks=450,Ce="kernel:recuperacion-modulo";let ge=0,Pe=null;function at(e){return new Promise(a=>{window.setTimeout(a,e)})}function ca(e){const a=String(e?.message||e||"");return/chunkloaderror|failed to fetch dynamically imported module|importing a module script failed|error loading dynamically imported module|networkerror.*module|load failed.*module/i.test(a)}function As(e){return["kernel/auth-timeout","auth/network-request-failed"].includes(e?.code)}async function oa(e){let a;for(let t=0;t<2;t+=1)try{return await e()}catch(i){if(a=i,t>0||!ca(i))throw i;await at(ks)}throw a}function q(e,a,t){return async()=>{const o=(await oa(e))[a];if(typeof o!="function")throw new Error(t);return o()}}function Es(){return Pe||(Pe=Promise.all([oa(()=>P(()=>import("./authGuard-CEzcrBkK.js"),__vite__mapDeps([0,1,2]),import.meta.url)),oa(()=>P(()=>import("./login-BtABpxCq.js"),__vite__mapDeps([3,1,2]),import.meta.url))]).then(([e,a])=>({esperarAutenticacion:e.esperarAutenticacion,crearLogin:a.crearLogin})).catch(e=>{throw Pe=null,e})),Pe}const Cs=q(()=>P(()=>import("./LaboratorioKernel-CbCyRZ68.js"),__vite__mapDeps([4,1,2]),import.meta.url),"LaboratorioKernel","El Laboratorio Inteligente no está disponible."),Ss=q(()=>P(()=>import("./AsistentePruebas-9ENxU2k9.js"),__vite__mapDeps([5,6]),import.meta.url),"AsistentePruebas","El asistente metodológico no está disponible."),$s=q(()=>P(()=>import("./ComparacionGrupos-BqmYk_OJ.js"),[],import.meta.url),"ComparacionGrupos","El módulo de comparación de grupos no está disponible."),Ms=q(()=>P(()=>import("./CalculadoraDosGrupos-DVDlpeQZ.js"),__vite__mapDeps([7,8,9]),import.meta.url),"CalculadoraDosGrupos","La calculadora de dos grupos no está disponible."),js=q(()=>P(()=>import("./CalculadoraDosMuestrasRelacionadas-CeBx-BcK.js"),__vite__mapDeps([10,11,8,9]),import.meta.url),"CalculadoraDosMuestrasRelacionadas","La calculadora de muestras relacionadas no está disponible."),Ls=q(()=>P(()=>import("./CalculadoraTresOMasGrupos-BT7ku7NP.js"),__vite__mapDeps([12,8,9]),import.meta.url),"CalculadoraTresOMasGrupos","La calculadora de tres o más grupos no está disponible."),zs=q(()=>P(()=>import("./CalculadoraTresOMasMedicionesRelacionadas-WVj08Bzt.js"),__vite__mapDeps([13,8,11,9]),import.meta.url),"CalculadoraTresOMasMedicionesRelacionadas","La calculadora de mediciones relacionadas no está disponible."),Is=q(()=>P(()=>import("./CorrelacionAsociacion-BJOAMDeR.js"),[],import.meta.url),"CorrelacionAsociacion","El módulo de correlación y asociación no está disponible."),Ds=q(()=>P(()=>import("./CalculadoraRelacionVariables-BrRbbsUH.js"),__vite__mapDeps([14,8,9]),import.meta.url),"CalculadoraRelacionVariables","La calculadora de relación entre variables no está disponible."),Ps=q(()=>P(()=>import("./CalculadoraAsociacionCategorica-BOYgPjyH.js"),__vite__mapDeps([15,8,9]),import.meta.url),"CalculadoraAsociacionCategorica","La calculadora de asociación categórica no está disponible."),Rs=q(()=>P(()=>import("./CalculadoraEstadisticaDescriptiva-DOi80-AC.js"),__vite__mapDeps([16,9]),import.meta.url),"CalculadoraEstadisticaDescriptiva","La calculadora de estadística descriptiva no está disponible."),Os=q(()=>P(()=>import("./CalculadoraFiabilidadCuestionarios-Ckn-Sztz.js"),__vite__mapDeps([17,9]),import.meta.url),"CalculadoraFiabilidadCuestionarios","La calculadora de cuestionarios y fiabilidad no está disponible."),qs=q(()=>P(()=>import("./CalculadoraEvaluacionEducativa-DkKivuyO.js"),__vite__mapDeps([18,9]),import.meta.url),"CalculadoraEvaluacionEducativa","La calculadora de evaluación educativa no está disponible."),Ts=q(()=>P(()=>import("./CalculadoraTamanoMuestraPotencia-qBnka-G2.js"),__vite__mapDeps([19,9]),import.meta.url),"CalculadoraTamanoMuestraPotencia","La calculadora de tamaño de muestra y potencia no está disponible."),Ns=q(()=>P(()=>import("./BibliotecaMetodologica-BzzsJJUi.js"),__vite__mapDeps([20,6]),import.meta.url),"BibliotecaMetodologica","La Biblioteca metodológica no está disponible."),Fs=q(()=>P(()=>import("./RegresionModelos-q4rY9Zve.js"),[],import.meta.url),"RegresionModelos","El área de modelos de regresión no está disponible."),Us=q(()=>P(()=>import("./CalculadoraRegresionCompleta-Fo1l_d_A.js"),__vite__mapDeps([21,9]),import.meta.url),"CalculadoraRegresionCompleta","La calculadora de regresión lineal no está disponible."),Bs=q(()=>P(()=>import("./CalculadoraRegresionLogistica-BXhZzQPR.js"),__vite__mapDeps([22,9]),import.meta.url),"CalculadoraRegresionLogistica","La calculadora de regresión logística no está disponible."),_s=q(()=>P(()=>import("./CalculadoraRegresionConteo-8HPwUe6H.js"),__vite__mapDeps([23,9]),import.meta.url),"CalculadoraRegresionConteo","La calculadora de regresión de conteo no está disponible."),Vs={home:{page:ui,layout:"full",title:"Portada | El Kernel"},servicios:{page:xs,layout:"full",title:"Servicios profesionales y académicos | El Kernel"},diagnosticoServicios:{page:ws,layout:"full",title:"Solicitar diagnóstico | El Kernel"},quienesSomos:{page:Li,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:qi,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Ui,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:ho,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:So,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:No,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:Po,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Qo,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:as,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Cs,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Ss,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},comparacionGrupos:{page:$s,layout:"default",title:"Comparación de grupos y mediciones | El Kernel"},calculadoraDosGrupos:{page:Ms,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:js,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"},calculadoraTresOMasGrupos:{page:Ls,layout:"default",title:"Comparación de tres o más grupos independientes | El Kernel"},calculadoraTresOMasMedicionesRelacionadas:{page:zs,layout:"default",title:"Comparación de tres o más mediciones relacionadas | El Kernel"},correlacionAsociacion:{page:Is,layout:"default",title:"Correlación y asociación | El Kernel"},calculadoraRelacionVariables:{page:Ds,layout:"default",title:"Relación entre variables | El Kernel"},calculadoraAsociacionCategorica:{page:Ps,layout:"default",title:"Asociación entre variables categóricas | El Kernel"},calculadoraEstadisticaDescriptiva:{page:Rs,layout:"default",title:"Estadística descriptiva | El Kernel"},calculadoraFiabilidadCuestionarios:{page:Os,layout:"default",title:"Cuestionarios y fiabilidad | El Kernel"},calculadoraEvaluacionEducativa:{page:qs,layout:"default",title:"Evaluación educativa | El Kernel"},calculadoraTamanoMuestraPotencia:{page:Ts,layout:"default",title:"Tamaño de muestra y potencia | El Kernel"},bibliotecaMetodologica:{page:Ns,layout:"default",title:"Biblioteca metodológica | El Kernel"},regresionModelos:{page:Fs,layout:"default",title:"Modelos de regresión | El Kernel"},calculadoraRegresion:{page:Us,layout:"default",title:"Regresión lineal y múltiple | El Kernel"},calculadoraRegresionLogistica:{page:Bs,layout:"default",title:"Regresión logística binaria | El Kernel"},calculadoraRegresionConteo:{page:_s,layout:"default",title:"Regresión de Poisson y binomial negativa | El Kernel"}},Ks=new Set(["laboratorioKernel","asistentePruebas","comparacionGrupos","calculadoraDosGrupos","calculadoraDosMuestrasRelacionadas","calculadoraTresOMasGrupos","calculadoraTresOMasMedicionesRelacionadas","correlacionAsociacion","calculadoraRelacionVariables","calculadoraAsociacionCategorica","calculadoraEstadisticaDescriptiva","calculadoraFiabilidadCuestionarios","calculadoraEvaluacionEducativa","calculadoraTamanoMuestraPotencia","bibliotecaMetodologica","regresionModelos","calculadoraRegresion","calculadoraRegresionLogistica","calculadoraRegresionConteo"]);let Ma=document.referrer||"";function Je(e){window.location.hash=`/${e}`}function tt(){return window.location.hash.replace("#/","")||"home"}function Gs(){const e=()=>{_e(tt())};window.addEventListener("hashchange",e),e()}function Hs(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:Ma}),Ma=t}function Js(e){return document.title="Acceso al Laboratorio | El Kernel",e(()=>{_e(tt())})}function Qs(){const e=document.createElement("section");return e.className="w-full max-w-4xl mx-auto px-4 py-16 md:px-8 font-sans",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.innerHTML=`
        ...
        </div>`,e}function Xs(e){return e?.code==="kernel/auth-timeout"?"La verificación de la sesión tardó más de lo esperado. Compruebe su conexión e inténtelo nuevamente.":ca(e)?"No fue posible descargar esta sección. Puede tratarse de una interrupción temporal de la conexión.":"Ocurrió un problema inesperado al preparar esta sección."}function Ws(e,a){const t=document.createElement("section");t.className="w-full max-w-4xl mx-auto px-4 py-12 md:px-8 font-sans",t.setAttribute("role","alert"),t.setAttribute("aria-live","assertive"),t.innerHTML=`
        ...
        </div>`;const i=t.querySelector("[data-mensaje-error-ruta]");return i&&(i.textContent=Xs(e)),t.querySelector("[data-action='reintentar-ruta']")?.addEventListener("click",a),t.querySelector("[data-action='volver-portada']")?.addEventListener("click",()=>Je("home")),t}function Ys(e,a){if(!ca(a))return!1;try{const t=JSON.parse(window.sessionStorage.getItem(Ce)||"null"),i=Date.now();return t?.route===e&&Number.isFinite(t?.timestamp)&&i-t.timestamp<12e4?!1:(window.sessionStorage.setItem(Ce,JSON.stringify({route:e,timestamp:i})),window.location.reload(),!0)}catch{return!1}}function Zs(e){try{JSON.parse(window.sessionStorage.getItem(Ce)||"null")?.route===e&&window.sessionStorage.removeItem(Ce)}catch{try{window.sessionStorage.removeItem(Ce)}catch{}}}function ja(e){const a=e.querySelector("h1");a&&(a.setAttribute("tabindex","-1"),a.focus({preventScroll:!0}))}async function er(e,a){if(!Ks.has(e))return a.page();const{esperarAutenticacion:t,crearLogin:i}=await Es();return await t()?a.page():Js(i)}async function _e(e,a={}){const{intentoAutenticacion:t=0}=a,i=document.querySelector("main"),o=Vs[e];if(!i)return;if(!o){Je("home");return}const n=++ge;Ka(o.layout),document.title=o.title,i.setAttribute("aria-busy","true"),i.replaceChildren(Qs());try{const s=await er(e,o);if(n!==ge)return;if(!(s instanceof Element))throw new Error("La sección no devolvió un componente válido.");i.replaceChildren(s),i.setAttribute("aria-busy","false"),window.scrollTo({top:0,behavior:"auto"}),window.requestAnimationFrame(()=>{n===ge&&ja(i)}),Zs(e),Hs(e,document.title)}catch(s){if(n!==ge)return;if(console.error(`[Kernel] Error al cargar la ruta ${e}.`,s),As(s)&&t<1)return await at(650),n===ge?_e(e,{intentoAutenticacion:t+1}):void 0;if(Ys(e,s))return;i.setAttribute("aria-busy","false"),i.replaceChildren(Ws(s,()=>_e(e))),window.requestAnimationFrame(()=>{n===ge&&ja(i)})}}function ar(e,a){e&&e.addEventListener("click",t=>{const i=t.target.closest("[data-route]");!i||!e.contains(i)||(t.preventDefault(),a(i.dataset.route),de(e))})}function tr(e){return/^(?:laboratorioKernel|asistentePruebas|comparacionGrupos|calculadora|correlacionAsociacion|bibliotecaMetodologica|regresionModelos)/.test(e)?"laboratorioKernel":e}function La(e){const a=window.location.hash.replace("#/","")||"home",t=tr(a);e.querySelectorAll("[data-route]").forEach(i=>{i.dataset.route===t?i.setAttribute("aria-current","page"):i.removeAttribute("aria-current")})}function ir(e,a){if(!e||!a)return;ar(e,Je),dt(e);const t=a.querySelector('[data-action="open-menu"]');t&&ht(t,e),yt(e),La(e),window.addEventListener("hashchange",()=>La(e)),Gs()}function or(e){const a=String(e??"").replace(/\u00a0/g,"").replace(/\s/g,"").replace(/[^0-9+\-.,eE]/g,"");if(!a)return null;const t=a.lastIndexOf(","),i=a.lastIndexOf(".");let o=a;t>=0&&i>=0?o=i>t?a.replace(/,/g,""):a.replace(/\./g,"").replace(",","."):t>=0&&(o=a.length-t-1===3&&t>0?a.replace(/,/g,""):a.replace(",","."));const n=Number(o);return Number.isFinite(n)?n:null}function sr(e){const a=e.querySelector("table");if(!a)return null;const i=[...a.querySelectorAll("thead th")].map(n=>n.textContent.trim().toLowerCase()).some(n=>n.includes("marca")),o=[...a.querySelectorAll("tbody tr")].map(n=>{const s=[...n.children],l=Number(s[i?2:1]?.textContent.trim()),d=Number(s[i?4:3]?.textContent.trim());return{etiqueta:s[0]?.textContent.trim()||"",valor:or(s[i?1:0]?.textContent),frecuencia:Number.isFinite(l)?l:0,acumulada:Number.isFinite(d)?d:0}}).filter(n=>n.etiqueta&&n.frecuencia>=0);return{agrupados:i,filas:o}}function it(e){return Number.isFinite(Number(e))?Number(e).toLocaleString("es-DO",{maximumFractionDigits:3}):"—"}function za(e,a){let t=0;for(const i of e)if(t+=i.frecuencia,a<t)return i.valor;return e.at(-1)?.valor??null}function ea(e,a){const t=e.reduce((d,b)=>d+b.frecuencia,0);if(!t)return null;if(a<=0)return e[0].valor;if(a>=1)return e.at(-1).valor;const i=(t-1)*a,o=Math.floor(i),n=Math.ceil(i),s=za(e,o),l=za(e,n);return o===n?s:s*(n-i)+l*(i-o)}function Ae(e,a,t){return`
        <text
            x="${e}"
            y="${a}"
            text-anchor="middle"
        ...
        >${it(t)}</text>
    `}function rr(e,a){if(!e||e.dataset.cajaDescriptivaSegura==="true"||a.agrupados)return;e.dataset.cajaDescriptivaSegura="true";const t=a.filas.filter(r=>r.valor!==null&&r.frecuencia>0).sort((r,m)=>r.valor-m.valor);if(t.reduce((r,m)=>r+m.frecuencia,0)<2)return;const o=t[0].valor,n=t.at(-1).valor,s=ea(t,.25),l=ea(t,.5),d=ea(t,.75),b=d-s,u=s-1.5*b,p=d+1.5*b,f=t.filter(r=>r.valor>=u&&r.valor<=p),y=t.filter(r=>r.valor<u||r.valor>p),w=f[0]?.valor??o,A=f.at(-1)?.valor??n,h=Math.max(n-o,1),g=r=>40+(r-o)/h*520,E=e.querySelector("svg");if(!E)return;E.setAttribute("aria-label","Diagrama de caja con cuartiles, mediana, bigotes y valores atípicos potenciales"),E.innerHTML=`
        ...
        ${y.map((r,m)=>`
            <circle
                ...
                class="text-red-600"
            >
                <title>Valor atípico potencial: ${it(r.valor)}${r.frecuencia>1?` (${r.frecuencia} observaciones)`:""}</title>
            </circle>
        `).join("")}
        ${Ae(g(w),140,w)}
        ${Ae(g(s),30,s)}
        ...
        ${Ae(g(d),30,d)}
        ${Ae(g(A),140,A)}
    `;const C=e.querySelector("h3 + p");C&&(C.textContent="Los bigotes terminan en los valores extremos no atípicos. Los puntos rojos representan valores atípicos potenciales según el criterio de Tukey.")}function nr(){const e=document.createElement("section");return e.dataset.encabezadoGraficosSeguro="true",e.className="mt-10",e.innerHTML=`
    ...
    `,e}function lr(e){const a=document.createElement("article");a.dataset.graficoExportable="true",a.dataset.graficoId="histograma",a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const t=Math.max(...e.map(i=>i.frecuencia),1);return a.innerHTML=`
    ...
    `,a}function cr(e){const a=document.createElement("article");a.dataset.graficoExportable="true",a.dataset.graficoId="ojiva-frecuencia-acumulada",a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const t=600,i=250,o=48,n=24,s=24,l=48,d=Math.max(...e.map(p=>p.acumulada),1),b=Math.max(e.length-1,1),u=e.map((p,f)=>({...p,x:o+f/b*(t-o-n),y:s+(1-p.acumulada/d)*(i-s-l)}));return a.innerHTML=`
    ...
    `,a}function dr(e){const a=[...e.querySelectorAll("article")],t=a.find(s=>s.querySelector("h3")?.textContent.includes("Distribución de frecuencias")),i=a.find(s=>s.querySelector("h3")?.textContent.includes("Diagrama de caja"));if(!t||!i)return;const o=t.parentElement,n=sr(e);if(!(!o||!n?.filas.length)&&(e.querySelector("[data-encabezado-graficos-seguro='true']")||(o.before(nr()),o.classList.remove("mt-8")),rr(i,n),!e.querySelector("[data-graficos-descriptivos-seguros='true']"))){const s=document.createElement("div");s.dataset.graficosDescriptivosSeguros="true",s.className="grid grid-cols-1 xl:grid-cols-2 gap-7 mt-7",s.append(lr(n.filas),cr(n.filas)),o.after(s)}}function ur(){let e=!1;const a=()=>{e=!1;const o=document.querySelector("#resultados-estadistica-descriptiva");o&&!o.classList.contains("hidden")&&dr(o)},t=()=>{e||(e=!0,window.requestAnimationFrame(a))};new MutationObserver(t).observe(document.body,{childList:!0,subtree:!0}),t()}const pr=["#formulario-estadistica-descriptiva","#formulario-regresion","#formulario-regresion-conteo","#form-tamano","[id*='calculadora'] form","section form"].join(",");function mr(){return document.querySelector("main h1, #app h1, h1")?.textContent?.trim()?.toLowerCase()||""}function br(){return mr().includes("laboratorio inteligente de investigación")}function gr(){const e=document.querySelector("main h1, #app h1, h1"),a=document.querySelector("[data-action='volver-laboratorio'], [data-action='volver-modelos'], [data-action='volver-regresion'], [data-action='volver']"),t=document.querySelector(pr);return!!(e&&a&&t)}function xr(){const e=document.createElement("section");return e.dataset.creditosCalculadoras="true",e.className=["w-full max-w-7xl mx-auto","px-4 pb-10 md:px-8","font-sans"].join(" "),e.innerHTML=`
    ...
    `,a.querySelector("button")?.addEventListener("click",l=>{const d=l.currentTarget,b=d.dataset.almacenamientoRegresion;b&&sessionStorage.setItem(b,d.dataset.tipoRegresion||""),window.location.hash=`/${d.dataset.routeRegresion}`}),a}function Da(){const e=hr();if(!e)return;const a=e.encabezado.closest("section");if(!a||a.querySelector("[data-ejecutar-modelo-regresion='true']")||a.querySelector("[data-action='ejecutar-prueba']"))return;(a.querySelector("header + div")||a).appendChild(yr(e.modelo))}function Pa(){const a=document.querySelector("#formulario-regresion")?.elements?.tipoModelo;if(!a)return;const t=sessionStorage.getItem("kernel-tipo-modelo-regresion");t!=="simple"&&t!=="multiple"||(a.value=t,a.dispatchEvent(new Event("change",{bubbles:!0})),sessionStorage.removeItem("kernel-tipo-modelo-regresion"))}function wr(){new MutationObserver(()=>{Da(),Pa()}).observe(document.body,{childList:!0,subtree:!0}),Da(),Pa()}let Oe=null;function Ee({restaurarFoco:e=!0}={}){if(Oe){const a=Oe;Oe=null,a(e);return}document.querySelector("[data-selector-instrumento='true']")?.remove()}function kr(){Ee({restaurarFoco:!1});const e=document.activeElement,a=document.body.style.overflow,t=document.createElement("div");t.dataset.selectorInstrumento="true",t.className=`
        fixed inset-0 z-[500]
    ...
    `;const i=()=>[...t.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')].filter(s=>s.getAttribute("aria-hidden")!=="true"),o=s=>{if(s.key==="Escape"){s.preventDefault(),Ee();return}if(s.key!=="Tab")return;const l=i();if(!l.length){s.preventDefault();return}const d=l[0],b=l.at(-1);s.shiftKey&&document.activeElement===d?(s.preventDefault(),b.focus()):!s.shiftKey&&document.activeElement===b&&(s.preventDefault(),d.focus())},n=()=>{Ee({restaurarFoco:!1})};Oe=s=>{document.removeEventListener("keydown",o),window.removeEventListener("hashchange",n),t.remove(),document.body.style.overflow=a,s&&e instanceof HTMLElement&&e.isConnected&&e.focus()},t.addEventListener("click",s=>{const l=s.target.closest("[data-route-instrumento]")?.dataset.routeInstrumento;if(l){Ee({restaurarFoco:!1}),window.location.hash=`/${l}`;return}(s.target===t||s.target.closest("[data-action='cerrar-selector-instrumento']"))&&Ee()}),document.body.appendChild(t),document.body.style.overflow="hidden",document.addEventListener("keydown",o),window.addEventListener("hashchange",n),t.querySelector("[data-route-instrumento]")?.focus()}function Ar(e){e.target.closest("#asistente-pruebas [data-value='instrumento']")&&(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),kr())}function Er(){document.addEventListener("click",Ar,!0)}function je(e,a){try{a()}catch(t){console.error(`[Kernel] No fue posible iniciar ${e}.`,t)}}function Cr(e){if(!e)return;const a=e.parentElement,t=a?.parentElement,i=document.querySelector("#main");t?.classList.add("relative","z-[200]","overflow-visible"),a?.classList.add("overflow-visible"),e.classList.remove("lg:z-auto","lg:z-[210]"),e.classList.add("overflow-visible","lg:z-[220]"),i?.classList.add("relative","z-0")}const Ve=document.querySelector("#header"),Se=document.querySelector("#navBar"),Ra=document.querySelector("#footer");Ve&&(Ve.innerHTML=rt());Se&&(Se.innerHTML=lt(),Cr(Se));Ra&&(Ra.innerHTML=ct());je("la navegación",()=>{Se&&Ve&&ir(Se,Ve)});je("los gráficos de estadística descriptiva",ur);je("los créditos de las calculadoras",fr);je("la integración de regresión con el asistente",wr);je("cuestionarios y fiabilidad en el asistente",Er);export{At as M,P as _,L as i};
