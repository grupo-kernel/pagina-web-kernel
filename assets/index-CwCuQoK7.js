...
>
    ...
    `}function Ni(e,a){e.addEventListener("click",r=>{const t=r.target.closest(["[data-route]"]);t&&(r.preventDefault(),a(t.dataset.route))})}function Is(e){Ni(e,Wt)}const Si=""+new URL("apec-ConmXkrT.png",import.meta.url).href,Ps=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Ls=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,mn=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${Si}" alt="UNAPEC" title="UNAPEC" 
    ...
    `,a=document.createElement("div");a.innerHTML=e;const r=a.firstElementChild;return Ts(r.querySelector("#containerFather")),Is(r.querySelector("#btnsGroup")),r}const _s="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function Ds(){try{const e=await fetch(_s,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function Ga(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function Ns(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function Ss(e){const a=e.querySelector("#analytics-total"),r=e.querySelector("#analytics-hoy"),t=e.querySelector("#analytics-semana"),n=e.querySelector("#analytics-mes"),d=e.querySelector("#analytics-actualizado");if(!a||!r||!t||!n||!d){console.warn("No se encontraron los elementos de Analytics en la portada.");return}d.textContent="Cargando estadísticas…";try{const l=await Ds();a.textContent=Ga(l.total),r.textContent=Ga(l.hoy),t.textContent=Ga(l.ultimos7Dias),n.textContent=Ga(l.ultimos30Dias);const p=Ns(l.actualizadoEn);d.textContent=p?`Actualizado: ${p}`:"Estadísticas temporalmente no disponibles"}catch(l){console.error("Error al mostrar las estadísticas en la portada:",l),a.textContent="—",r.textContent="—",t.textContent="—",n.textContent="—",d.textContent="No fue posible cargar las estadísticas"}}function Ms(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=$s();const a=Rs();return e.appendChild(a),Ss(e),e}function zs(){return Ms()}const Os=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function qs(){return`
        <section 
            role="banner" 
...
Gracias.`);return`
    ...
    `;const a=Cl(Ui),r=a.find(t=>t.featured)||a[0];return e.innerHTML=`
        ...
        ${kl(a)}
        ${El()}
    `,e}function $l({title:e,content:a={paragraphs:[],list:[]},articleURL:r}){const t=(a.paragraphs||[]).map(l=>`<p>${l}</p>`).join(""),n=(a.list||[]).length?`
    ...
    `}function Il(e){e&&e.addEventListener("click",a=>{const r=a.target.closest("[data-news-btn], [data-news-card]");if(!r||!e.contains(r))return;const t=r.dataset.newsBtn||r.dataset.newsCard,n=Ui.find(d=>String(d.id)===String(t));if(!n){console.warn("No se encontró la noticia con id:",t);return}Pl(n)})}function Pl(e){const a=document.querySelector("#newsModal");a&&a.remove();const r=document.createElement("div");r.innerHTML=$l(e);const t=r.firstElementChild;if(!t){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(t),document.body.style.overflow="hidden";function n(){t.remove(),document.body.style.overflow="",document.removeEventListener("keydown",d)}function d(l){l.key==="Escape"&&n()}t.querySelectorAll("[data-close-modal]").forEach(l=>{l.addEventListener("click",n)}),t.addEventListener("click",l=>{l.target===t&&n()}),document.addEventListener("keydown",d)}function Ll(){const e=Al();return Il(e),e}function W(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Vi(e){return e?.name||e?.title||"Investigador"}function fn(e){return e?.title||e?.tile||"Revista no especificada"}function Bi(e){return String(e?.DOI||e?.doi||"").trim()}function Tl(e){const a=Bi(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function Rl(e){return[...e?.publicaciones||[]].sort((a,r)=>{const t=Number(a.year||0),n=Number(r.year||0);return t!==n?n-t:String(a.contenido||"").localeCompare(String(r.contenido||""))})}function _l(e,a=!1){const r=Vi(e),t=e.publicaciones||[],n=t.length,d=t.map(p=>Number(p.year)).filter(Boolean),l=d.length?Math.max(...d):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${a?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function Nl(){let e=me[0]?.id||1,a=!1,r=null;const t=document.createElement("section");t.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function n(f){return String(f?.DOI||f?.doi||"").trim().toLowerCase()}function d(f){return String(f?.journal||f?.title||f?.tile||"").trim()}function l(f){return String(f?.articleTitle||f?.contenido||"").trim()}function p(f){return String(f?.q||f?.quartile||"").trim().toUpperCase()}function m(f){const b=n(f);return b||[f?.year||"",d(f),l(f)].join("-").trim().toLowerCase()}function s(){const f=new Map;return me.forEach(b=>{(b.publicaciones||[]).forEach(g=>{const v=m(g);v&&!f.has(v)&&f.set(v,g)})}),Array.from(f.values())}function i(){const f=s(),b=f.map(h=>Number(h.year)).filter(Boolean),g=b.length?Math.max(...b):"—",v=b.length?Math.min(...b):"—",y=f.filter(h=>p(h)==="Q1").length;return{totalPublicaciones:f.length,investigadores:me.length,q1:y,primerYear:v,ultimoYear:g}}function o(){return me.find(f=>Number(f.id)===Number(e))||me[0]}const c=()=>{const f=o(),b=i(),g=window.innerWidth<768&&!a;t.innerHTML=`
...
A00116736    25"
    ...
    `;const a=e.querySelector("#banner-segundo-input"),r=e.querySelector("#banner-segundo-process"),t=e.querySelector("#banner-segundo-clear"),n=e.querySelector("#banner-segundo-message"),d=e.querySelector("#banner-segundo-preview"),l=e.querySelector("#banner-segundo-count"),p=e.querySelector("#banner-segundo-download");let m=[];function s(x){return String(x).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function i(x){return String(x).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function o(x){const w=String(x).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return w.includes("	")?w.split("	").map(k=>k.trim()).filter(k=>k!==""):w.includes(";")?w.split(";").map(k=>k.trim()).filter(k=>k!==""):w.split(/\s+/).map(k=>k.trim()).filter(k=>k!=="")}function c(x){return Number.isInteger(x)?String(x):x.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function u(x){return String(x).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function f(x,w="success"){n.textContent=x,n.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),w==="error"?n.classList.add("border-red-200","bg-red-50","text-red-800"):n.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function b(x){const w=x.split(/\r?\n/).map(A=>A.trim()).filter(Boolean),k=[],E=[],C=new Set;return w.forEach((A,$)=>{const I=$+1,R=o(A);if(R.length!==2){E.push(`Línea ${I}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const T=s(R[0]),_=Number(i(R[1]));if(!/^A[0-9]{8}$/.test(T)){E.push(`Línea ${I}: la matrícula "${T}" no es válida. Debe tener el formato A00108671.`);return}if(C.has(T)){E.push(`Línea ${I}: la matrícula ${T} está repetida.`);return}if(!Number.isFinite(_)){E.push(`Línea ${I}: la calificación 3SP no es numérica.`);return}if(_<0||_>35){E.push(`Línea ${I}: 3SP debe estar entre 0 y 35.`);return}C.add(T),k.push({matricula:T,grade3SP:_})}),{records:k,errors:E}}function g(x){if(x.length===0){d.innerHTML=`
            ...
            `,l.textContent="0 estudiantes";return}d.innerHTML=x.map((w,k)=>`
                    <tr class="border-b border-slate-100 last:border-b-0">
                        <td class="px-4 py-3 text-slate-500">
                            ${k+1}
                        </td>
...
A00116736    20"
    ...
    `;const a=e.querySelector("#banner-final-input"),r=e.querySelector("#banner-final-process"),t=e.querySelector("#banner-final-clear"),n=e.querySelector("#banner-final-message"),d=e.querySelector("#banner-final-preview"),l=e.querySelector("#banner-final-count"),p=e.querySelector("#banner-final-download");let m=[];function s(x){return String(x).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function i(x){return String(x).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function o(x){const w=String(x).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return w.includes("	")?w.split("	").map(k=>k.trim()).filter(k=>k!==""):w.includes(";")?w.split(";").map(k=>k.trim()).filter(k=>k!==""):w.split(/\s+/).map(k=>k.trim()).filter(k=>k!=="")}function c(x){return Number.isInteger(x)?String(x):x.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function u(x){return String(x).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function f(x,w="success"){n.textContent=x,n.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),w==="error"?n.classList.add("border-red-200","bg-red-50","text-red-800"):n.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function b(x){const w=x.split(/\r?\n/).map(A=>A.trim()).filter(Boolean),k=[],E=[],C=new Set;return w.forEach((A,$)=>{const I=$+1,R=o(A);if(R.length!==2){E.push(`Línea ${I}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const T=s(R[0]),_=Number(i(R[1]));if(!/^A[0-9]{8}$/.test(T)){E.push(`Línea ${I}: la matrícula "${T}" no es válida. Debe tener el formato A00108671.`);return}if(C.has(T)){E.push(`Línea ${I}: la matrícula ${T} está repetida.`);return}if(!Number.isFinite(_)){E.push(`Línea ${I}: la calificación 4EF no es numérica.`);return}if(_<0||_>30){E.push(`Línea ${I}: 4EF debe estar entre 0 y 30.`);return}C.add(T),k.push({matricula:T,grade4EF:_})}),{records:k,errors:E}}function g(x){if(x.length===0){d.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,l.textContent="0 estudiantes";return}d.innerHTML=x.map((w,k)=>`
                ...
                `).join(""),l.textContent=`${x.length} estudiante${x.length===1?"":"s"}`}function v(x){return[["MATRICULA","4EF"],...x.map(k=>[k.matricula,c(k.grade4EF)])].map(k=>k.join(";")).join(`\r
`)}function y(x,w){const k=new Blob(["\uFEFF"+x],{type:"text/csv;charset=utf-8;"}),E=URL.createObjectURL(k),C=document.createElement("a");C.href=E,C.download=w,document.body.appendChild(C),C.click(),C.remove(),window.setTimeout(()=>{URL.revokeObjectURL(E)},1e3)}function h(){m=[],a.value="",g([]),p.disabled=!0,n.textContent="",n.classList.add("hidden"),a.focus()}return r.addEventListener("click",()=>{const x=a.value.trim();if(!x){m=[],g([]),p.disabled=!0,f("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:w,errors:k}=b(x);if(k.length>0){m=[],g([]),p.disabled=!0,f(k.join(" "),"error");return}m=w,g(w),p.disabled=!1,f(`Los datos de ${w.length} estudiante${w.length===1?"":"s"} fueron validados correctamente.`)}),t.addEventListener("click",h),p.addEventListener("click",()=>{m.length!==0&&y(v(m),"Banner_APEC_Examen_Final_4EF.csv")}),e}function dc(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
...
17`,s(),ur(r),t.classList.add("hidden");return}c==="limpiar"&&(a.reset(),n.value="",d.value="",s(),ur(r),t.innerHTML="",t.classList.add("hidden"))}),e}function dr(e,a){return`
    ...
    `}function di(e,a){const r=e.trim();if(!r)throw new Error(`${a} no contiene datos.`);const t=r.split(/[\s;]+/).filter(Boolean),n=t.map(l=>Number(l.replace(",","."))),d=n.findIndex(l=>!Number.isFinite(l));if(d!==-1)throw new Error(`${a} contiene un valor no válido: "${t[d]}".`);if(n.length<2)throw new Error(`${a} debe contener al menos dos observaciones.`);return n}function ui(e){return e.trim()?e.trim().split(/[\s;]+/).filter(Boolean).length:0}function pi(e){return e===1?"1 valor":`${e} valores`}function ff(e,a){e.textContent=a,e.classList.remove("hidden")}function ur(e){e.textContent="",e.classList.add("hidden")}function S(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):"—"}function bf(e){return Number.isFinite(e)?e<.001?"< 0.001":S(e,4):"—"}function gf(e,a=.95){const r=1-a,t=e.valorP<r,n=r.toFixed(2),d=Math.round(a*100),l=e.id==="t-student-relacionadas"?e.diferenciaMedia:e.diferencias.mediana,p=hf(l),m=t?`Se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${n}, correspondiente a un nivel de confianza del ${d} %. ${p}`:`No se observa evidencia estadísticamente significativa de una diferencia entre las dos mediciones al nivel α = ${n}, correspondiente a un nivel de confianza del ${d} %. ${p}`;return`
        <section class="rounded-3xl border border-violet-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    ${et(e.estadistico.simbolo,S(e.estadistico.valor),"Estadístico")}
                    ${et("p",bf(e.valorP),"Valor bilateral")}
                    ${et("n",e.nParejas,"Parejas originales")}
                    ${et("Δ",S(l),e.id==="t-student-relacionadas"?"Diferencia media":"Diferencia mediana")}
                </div>
    ...
    `}function vf(e){if(e.id==="wilcoxon-relacionadas")return`
            <article class="mt-6 rounded-2xl border border-fuchsia-200 bg-fuchsia-50 p-6">
                ...
                <dl class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ${N("Rangos positivos, W+",S(e.sumaRangosPositivos))}
                    ${N("Rangos negativos, W−",S(e.sumaRangosNegativos))}
                    ${N("Parejas no nulas",e.nEfectivo)}
                    ${N("Diferencias iguales a cero",e.cantidadCeros)}
                    ${N("z aproximado",S(e.estadisticoZ))}
                    ${N("Correlación biserial de rangos",S(e.tamanioEfecto.correlacionBiserialRangos))}
                    ${N("Correlación r",S(e.tamanioEfecto.r))}
        ...
        <article class="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-6">
            ...
            <dl class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ${N("Diferencia media",S(e.diferenciaMedia))}
                ${N("Error estándar",S(e.errorEstandar))}
                ${N("Grados de libertad",S(e.gradosLibertad))}
                ${N(`IC ${a.nivel*100} %: límite inferior`,S(a.inferior))}
                ${N(`IC ${a.nivel*100} %: límite superior`,S(a.superior))}
                ${N("d_z de Cohen",S(e.tamanioEfecto.dZ))}
                ${N("g_z corregida",S(e.tamanioEfecto.gZ))}
                ${N("Correlación entre mediciones",S(e.tamanioEfecto.correlacionPareada))}
            </dl>
        </article>
    ...
    `}function Bf(e){let a;return e.id==="anova-un-factor"?a=[["Eta cuadrado, η²",e.tamanioEfecto.etaCuadrado],["Omega cuadrado, ω²",e.tamanioEfecto.omegaCuadrado]]:e.id==="anova-welch"?a=[["Omega cuadrado aproximado",e.tamanioEfecto.omegaCuadradoAproximado]]:a=[["Épsilon cuadrado, ε²",e.tamanioEfecto.epsilonCuadrado]],`
        <article class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-6">
            ...
            <dl class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                ${de("Magnitud orientativa",xe(e.tamanioEfecto.interpretacion))}
            </dl>
...
20`];[...a.querySelectorAll("[data-medicion]")].forEach((d,l)=>{d.querySelector('[data-campo="nombre"]').value=r[l],d.querySelector('[data-campo="valores"]').value=t[l],ls(d)})}function ls(e){const a=e.querySelector('[data-campo="valores"]'),r=e.querySelector("[data-contador]"),t=a.value.trim()?a.value.trim().split(/[\s;]+/).filter(Boolean).length:0;r.textContent=t===1?"1 valor":`${t} valores`}document.addEventListener("input",e=>{const a=e.target.closest('#formulario-mediciones-relacionadas [data-campo="valores"]');if(!a)return;const r=a.closest("[data-medicion]");r&&ls(r)});function hi(e,a){e.textContent=a,e.classList.remove("hidden")}function gr(e){e.textContent="",e.classList.add("hidden")}function fe(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):e===1/0?"∞":"—"}function Et(e){return Number.isFinite(e)?e<.001?"< 0.001":fe(e,4):"—"}function pb(e){const a=e.id==="anova-medidas-repetidas",r=a?e.esfericidad.greenhouseGeisser.valorP:e.valorP,t=r<e.alfa,n=Math.round(e.nivelConfianza*100),d=a?"Greenhouse–Geisser":"sin corrección adicional",l=t?`Se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${e.alfa.toFixed(2)}. Para la decisión principal se utilizó ${d}.`:`No se observa evidencia estadísticamente significativa de diferencias entre las mediciones al nivel α = ${e.alfa.toFixed(2)}. Para la decisión principal se utilizó ${d}.`;return`
    ...
    `,e.innerHTML=`
        ...
        <section class="grid grid-cols-1 lg:grid-cols-2 gap-7 mt-8">
            ${xi({etiqueta:"Disponible",titulo:"Relación entre variables",descripcion:"Analice la intensidad, dirección y significación de la relación entre dos variables mediante Pearson, Spearman, Kendall o correlación punto-biserial.",elementos:["Correlación de Pearson","Rho de Spearman","Tau-b de Kendall","Correlación punto-biserial"],ruta:"calculadoraRelacionVariables",textoBoton:"Abrir calculadora de correlación",clases:{borde:"border-violet-200",fondo:"bg-violet-50",texto:"text-violet-700",boton:"bg-violet-700 hover:bg-violet-800"}})}

            ${xi({etiqueta:"Disponible",titulo:"Asociación entre variables categóricas",descripcion:"Analice tablas de contingencia mediante chi-cuadrado, pruebas exactas, residuos ajustados, Phi, V de Cramer y odds ratio.",elementos:["Chi-cuadrado de independencia","Fisher y Fisher–Freeman–Halton","Residuos ajustados","Phi, V de Cramer y odds ratio"],ruta:"calculadoraAsociacionCategorica",textoBoton:"Abrir calculadora de asociación",clases:{borde:"border-indigo-200",fondo:"bg-indigo-50",texto:"text-indigo-700",boton:"bg-indigo-700 hover:bg-indigo-800"}})}
        </section>
    ...
    `,e.addEventListener("click",a=>{const r=a.target.closest("[data-route], [data-action]");if(!r)return;if(r.dataset.action==="volver-laboratorio"){window.location.hash="/laboratorioKernel";return}const t=r.dataset.route;t&&(window.location.hash=`/${t}`)}),e}function xi({etiqueta:e,titulo:a,descripcion:r,elementos:t,ruta:n,textoBoton:d,deshabilitada:l=!1,clases:p}){return`
...
3`}function Z(e,a=4){return Number.isFinite(e)?new Intl.NumberFormat("es-DO",{minimumFractionDigits:0,maximumFractionDigits:a}).format(e):e===1/0?"∞":e===-1/0?"−∞":"—"}function Rb(e){return Number.isFinite(e)?e<.001?"< 0.001":Z(e,4):"—"}function ee(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function _b(e){const a=Math.round(e.nivelConfianza*100),r=e.significativo,t=r?`Se observa una relación estadísticamente significativa al nivel α = ${e.alfa.toFixed(2)}.`:`No se observa una relación estadísticamente significativa al nivel α = ${e.alfa.toFixed(2)}.`;return`
    ...
    `}function Sb(e){if(e.id==="punto-biserial"){const a=e.grupos.categoriaCero,r=e.grupos.categoriaUno;return`
            <article class="mt-6 rounded-2xl border border-slate-200 bg-white overflow-hidden">
                <header class="bg-slate-50 border-b border-slate-200 px-6 py-4">
                    <h3 class="text-xl font-black text-slate-900">
    ...
    `}function Mb(e){return e.id==="pearson"?`
...
40, 50, 3`};a.querySelector("textarea").value=r[e]}function Lg(e){const a=e.resumen;return`
    ...
    `}function Sg(e){const a=e.tipoDatos==="intervalos";return`
    ...
    `,e}function Ia(e,a,r){const t=Number.isInteger(r)?String(r):Number(r).toFixed(3);return`
        <text
            x="${e}"
            y="${a}"
            text-anchor="middle"
        ...
        >${t}</text>
    `}function Wg(e,a){if(!e||a.agrupados||a.datos.length<2)return;const r=a.datos,t=r[0],n=r.at(-1),d=Cr(r,.25),l=Cr(r,.5),p=Cr(r,.75),m=p-d,s=d-1.5*m,i=p+1.5*m,o=r.filter(C=>C>=s&&C<=i),c=r.filter(C=>C<s||C>i),u=o[0],f=o.at(-1),b=Math.max(n-t,1),g=C=>40+(C-t)/b*520,v=g(u),y=g(d),h=g(l),x=g(p),w=g(f),k=e.querySelector("svg");if(!k)return;k.setAttribute("aria-label","Diagrama de caja con cuartiles, mediana, bigotes y valores atípicos"),k.innerHTML=`
        <line x1="${v}" y1="80" x2="${y}" y2="80" stroke="currentColor" stroke-width="3" class="text-slate-500" />
        <line x1="${x}" y1="80" x2="${w}" y2="80" stroke="currentColor" stroke-width="3" class="text-slate-500" />
        <line x1="${v}" y1="58" x2="${v}" y2="102" stroke="currentColor" stroke-width="3" class="text-slate-500" />
        <line x1="${w}" y1="58" x2="${w}" y2="102" stroke="currentColor" stroke-width="3" class="text-slate-500" />
        <rect x="${y}" y="45" width="${Math.max(x-y,2)}" height="70" rx="8" fill="currentColor" class="text-sky-200" stroke="currentColor" stroke-width="3" />
    ...
    `,a}function Jg(e){const a=document.createElement("article");a.dataset.graficoAdicional="ojiva",a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const r=Math.max(...e.map(f=>f.acumulada),1),t=600,n=250,d=48,l=24,p=24,m=48,s=t-d-l,i=n-p-m,o=Math.max(e.length-1,1),c=e.map((f,b)=>({...f,x:d+b/o*s,y:p+(1-f.acumulada/r)*i})),u=c.map(f=>`${f.x},${f.y}`).join(" ");return a.innerHTML=`
        <h3 class="text-2xl font-black text-slate-900 mb-2">
        ...
        <div class="overflow-x-auto">
            ...
            >
                <line x1="${d}" y1="${p}" x2="${d}" y2="${n-m}" stroke="currentColor" stroke-width="2" class="text-slate-400" />
                <line x1="${d}" y1="${n-m}" x2="${t-l}" y2="${n-m}" stroke="currentColor" stroke-width="2" class="text-slate-400" />
    ...
    `,a}function Yg(e,a,r){if(!a||!r.length||e.querySelector("[data-graficos-adicionales='true']"))return;const t=document.createElement("div");t.dataset.graficosAdicionales="true",t.className="grid grid-cols-1 xl:grid-cols-2 gap-7 mt-7",t.append(Kg(r),Jg(r)),a.after(t)}function Qg(e){const a=[...e.querySelectorAll("article")],r=a.find(l=>l.querySelector("h3")?.textContent.includes("Distribución de frecuencias")),t=a.find(l=>l.querySelector("h3")?.textContent.includes("Diagrama de caja"));if(!r||!t)return;const n=r.parentElement;n&&!e.querySelector("[data-encabezado-graficos='true']")&&(n.before(jg()),n.classList.remove("mt-8"));const d=Hg(e);d&&Wg(t,d),Yg(e,n,Gg(e))}function Xg(){const e=()=>{const r=document.querySelector("#resultados-estadistica-descriptiva");r&&!r.classList.contains("hidden")&&Qg(r)};new MutationObserver(e).observe(document.body,{childList:!0,subtree:!0}),e()}function Zg(e,a){return`${e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")||`grafico-${a+1}`}.svg`}function e0(e,a,r){const t=e.cloneNode(!0);t.getAttribute("xmlns")||t.setAttribute("xmlns","http://www.w3.org/2000/svg");const d=new XMLSerializer().serializeToString(t),l=new Blob([d],{type:"image/svg+xml;charset=utf-8"}),p=URL.createObjectURL(l),m=document.createElement("a");m.href=p,m.download=Zg(a,r),document.body.appendChild(m),m.click(),m.remove(),setTimeout(()=>URL.revokeObjectURL(p),1e3)}function a0(e,a,r){if(e.querySelector("[data-descargar-svg]"))return;const t=e.querySelector("h3")?.textContent.trim()||`Gráfico ${r+1}`,n=document.createElement("button");n.type="button",n.dataset.descargarSvg="true",n.className=`
    ...
    `,n.innerHTML=`
        <span aria-hidden="true">↓</span>
        Descargar SVG
    `,n.setAttribute("aria-label",`Descargar ${t} en formato SVG`),n.addEventListener("click",()=>{e0(a,t,r)}),e.appendChild(n)}function t0(e){const a=window.open("","_blank");if(!a){window.print();return}const r=`
        <style>
    ...
    `),a.document.close(),a.addEventListener("load",()=>{a.focus(),a.print()})}function r0(e){if(e.querySelector("[data-herramientas-exportacion='true']"))return;const a=document.createElement("section");a.dataset.herramientasExportacion="true",a.className=`
    ...
    `,a.querySelector("[data-imprimir-informe]")?.addEventListener("click",()=>{t0(e)}),e.prepend(a)}function n0(e){r0(e),[...e.querySelectorAll("article")].forEach((r,t)=>{const n=r.querySelector("svg");n&&a0(r,n,t)})}function i0(){const e=()=>{const r=document.querySelector("#resultados-estadistica-descriptiva");r&&!r.classList.contains("hidden")&&n0(r)};new MutationObserver(e).observe(document.body,{childList:!0,subtree:!0}),e()}const gs=document.querySelector("#header");gs.innerHTML=xs();const hs=document.querySelector("#navBar");hs.innerHTML=vs();const o0=document.querySelector("#footer");o0.innerHTML=ys();Vg(hs,gs);Xg();i0();
