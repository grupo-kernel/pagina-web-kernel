const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./authGuard-CEzcrBkK.js","./authService-CgfoSPdf.js","./firebase-BzP43VG7.js","./login-BtABpxCq.js","./LaboratorioKernel-CWzzarC3.js","./AsistentePruebas-9ENxU2k9.js","./metadatosFichasMetodologicas-BbzfSE5K.js","./CalculadoraDosGrupos-S0N0nc3h.js","./jstat-DiDocX-r.js","./exportacionesCalculadoras-Bp6ww2rq.js","./CalculadoraDosMuestrasRelacionadas-owoY7atD.js","./estadisticaDosMuestrasRelacionadas-C0D8qKdR.js","./CalculadoraTresOMasGrupos-330OkVFd.js","./CalculadoraTresOMasMedicionesRelacionadas-DSeSW_yD.js","./CalculadoraRelacionVariables-BUOMLhVJ.js","./CalculadoraAsociacionCategorica-sub_5Ash.js","./CalculadoraEstadisticaDescriptiva-Brear1EC.js","./CalculadoraFiabilidadCuestionarios-CtL9FOau.js","./CalculadoraEvaluacionEducativa-CHnW9Z3A.js","./CalculadoraTamanoMuestraPotencia-Et-xcV35.js","./BibliotecaMetodologica-BzzsJJUi.js","./CalculadoraRegresionCompleta-D6ZWa5Fb.js","./CalculadoraRegresionLogistica-DVo-UIng.js","./CalculadoraRegresionConteo-C6mup4hf.js"])))=>i.map(i=>d[i]);
(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const Me=""+new URL("ElKernel-BvHOWfRq.webp",import.meta.url).href;function rt(){return`
    ...
    `,a.querySelector("[data-franja-institucional]")?.replaceWith(Tt({integrantes:ie.length,servicios:le.length,lineas:W.length,publicaciones:e})),a.querySelector("[data-resumen-servicios]")?.replaceWith(Vt()),a.querySelector("[data-proceso-aplicaciones]")?.replaceWith(Jt()),a}const ti="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function ii(){try{const e=await fetch(ti,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}const oi=["w-full","min-w-0","max-w-none","max-w-7xl","tabletBig:max-w-6xl","xl:max-w-7xl","2xl:max-w-500","3xl:max-w-none","m-auto","m-0","p-0","p-2","mt-0","mt-8","md:mt-12","pt-0"],si=["max-w-7xl","tabletBig:max-w-6xl","xl:max-w-7xl","2xl:max-w-500","3xl:max-w-none"];function Ka(e="default"){const a=document.getElementById("main");if(a){if(a.classList.remove(...oi),a.classList.add("w-full","min-w-0"),e==="full"){a.classList.add("max-w-none","m-0","p-0","mt-0","pt-0");return}a.classList.add(...si,"p-2","mt-8","md:mt-12"),e==="left"?a.classList.add("m-0"):a.classList.add("m-auto")}}function Ie(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function ri(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function ni(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const s=await ii();a.textContent=Ie(s.total),t.textContent=Ie(s.hoy),i.textContent=Ie(s.ultimos7Dias),o.textContent=Ie(s.ultimos30Dias);const l=ri(s.actualizadoEn);n.textContent=l?`Actualizado: ${l}`:"Estadísticas temporalmente no disponibles"}catch(s){console.error("Error al mostrar las estadísticas en la portada:",s),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function li(){Ka("full");const e=ai();return ni(e),e}function ci(){return li()}const di=""+new URL("QuienesSomos-CIhVjMhZ.webp",import.meta.url).href,U=Object.freeze({integrantes:9,articulosAcumulados:572,articulosAcumuladosTexto:"572+",etiquetaArticulos:"Artículos científicos acumulados",descripcionArticulos:"Producción de los 9 integrantes a lo largo de sus trayectorias académicas",notaArticulos:"Cota mínima basada en artículos de revista declarados en perfiles institucionales y registros científicos verificados. La suma representa la producción individual acumulada; las coautorías compartidas pueden formar parte de más de una trayectoria."});function ui(){return`
        <section 
            role="banner" 
                ...
                <div class="max-w-4xl text-white">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl">
                        <div class="bg-white/10 border border-white/20 backdrop-blur-sm rounded-2xl p-4">
                            <p class="text-3xl font-black text-white">${U.integrantes}</p>
                        ...
                        <div
                            ...
                            title="${U.descripcionArticulos}"
                        >
                            <p class="text-3xl font-black text-white">${U.articulosAcumuladosTexto}</p>
                            <p class="text-white/75 text-xs md:text-sm font-semibold">
                                ${U.etiquetaArticulos}
                            </p>
                        </div>
    ...
    `}const fi="data:image/png;base64,",vi="data:image/png;base64,",hi="data:image/png;base64,",yi="data:image/png;base64,",wi="data:image/png;base64,",ki=[{icon:fi,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:vi,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:hi,title:"Objetivos",content:`
      ...
      </ul>`},{icon:yi,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function Ei({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${wi}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function Ci(){const e=document.createElement("section");return e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12",e.innerHTML=`
    ...
    `).join("")}function Li(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function zi(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=ji(e.redes||[]),i=Li(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}function Ii(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const y=o();return Math.max(ie.length-y,0)},s=()=>{const y=n();e>y&&(e=0),e<0&&(e=y)},l=()=>{const y=n();e>=y?e=0:e++,f()},d=()=>{const y=n();e<=0?e=y:e--,f()},b=()=>{u(),ie.length>o()&&(a=setInterval(l,4500))},u=()=>{a&&(clearInterval(a),a=null)},p=()=>{const y=o(),w=Math.max(ie.length-y+1,1);return Array.from({length:w}).map((A,h)=>`
        ...
        `;const A=i.querySelector("#cards-wrapper");w.forEach(E=>{A.appendChild(zi(E))});const h=i.querySelector("#prev-btn"),g=i.querySelector("#next-btn");h&&(h.onclick=()=>{d(),b()}),g&&(g.onclick=()=>{l(),b()}),i.querySelectorAll("[data-dot-index]").forEach(E=>{E.onclick=()=>{e=parseInt(E.dataset.dotIndex),f(),b()}})};return i.addEventListener("mouseenter",u),i.addEventListener("mouseleave",b),document.addEventListener("visibilitychange",()=>{document.hidden?u():b()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,f(),b()},150)}),f(),b(),i}function Di(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&Je(t.dataset.route)})}function Ga(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Di(a),a}function Pi(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";const a=document.createElement("div");a.className="mx-auto max-w-[1600px]",a.innerHTML=`
    ...
    `;const t=document.createElement("div");t.className="mt-8 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm",t.appendChild(Ga());const i=Ii();return i.className="w-full py-8 flex flex-col gap-8 items-center font-sans",a.appendChild(t),a.appendChild(i),e.appendChild(a),e}function Ri(){return Pi()}function V(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ha(e){return e.formacion?.length||0}function Ja(e){return e.experiencia?.length||0}function Oi(e,a=!1){const t=Ha(e),i=Ja(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function qi(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(l=>`
    ...
    `}const wa=Object.freeze([Qa,Vi,Ki,Gi,Hi,Ji,Qi,Xi,Wi]),Zi=Object.freeze([{nombre:"Miguel A. Leonardo Sepúlveda",tema:"Funciones peso y método Singh–Sharma de quinto orden"},{nombre:"Natanael Ureña Castillo",tema:"Algoritmos híbridos cuasi-Newton con correctores de alto orden"},{nombre:"Antmel Rodríguez Cabral",tema:"Familia generalizada de Traub y método óptimo de cuarto orden"}]);function eo(e){return e?`
    ...
    `}function oe(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function to(e){if(e?.visualType==="mmehb-2026")return na();if(e?.visualType==="mescyt-cic-2026")return la();const a=e?.imageFit==="cover"?"object-cover":"object-contain";return e?.image?`
            <img
                src="${oe(e.image)}"
                ...
                loading="eager"
            />
        `:'<div class="flex h-full w-full items-center justify-center font-bold text-slate-400">Imagen no disponible</div>'}function io(e=null){return e?`
    ...
    `:""}function ee(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function oo(e){return e==="mmehb-2026"?na({compacto:!0}):e==="mescyt-cic-2026"?la({compacto:!0}):null}function so({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:n,category:s="Noticia",imageFit:l="contain",visualType:d="image"}){const b=l==="cover"?"object-cover":"object-contain",u=oo(d),p=u?"h-[430px] md:h-[500px]":"h-64 md:h-72 2xl:h-96",f=u||(i?`
            <img
                src="${ee(i)}"
                alt="${ee(o||a)}"
    ...
    `}function no(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function lo(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function co(){const e=document.createElement("section");e.className="w-full bg-slate-100 font-sans";const a=new Set([Fe.id,Ue.id]),t=lo([Fe,Ue,...Xa.filter(o=>!a.has(o.id))]),i=t.find(o=>o.featured)||t[0];return e.innerHTML=`
        ...
        ${ro(t)}
        ${no()}
    `,e}function be(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function uo(e){return e==="mmehb-2026"?na():e==="mescyt-cic-2026"?la():""}function po({title:e,date:a,category:t,visualType:i,content:o={paragraphs:[],list:[]},articleURL:n}){const s=(o.paragraphs||[]).map(b=>`<p>${be(b)}</p>`).join(""),l=(o.list||[]).length?`<ul class="space-y-3">${o.list.map(b=>`<li class="flex items-start gap-3"><span class="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-[#0b5963]"></span><span>${be(b)}</span></li>`).join("")}</ul>`:"",d=uo(i);return`
    ...
    `}function wo(e,a=!1){const t=Wa(e),i=e.publicaciones||[],o=Math.max(...i.map(n=>Number(n.year||0)),0)||"";return`
    ...
    `}function ko(e){if(!e)return'<div class="flex h-full items-center justify-center text-white">No hay investigador seleccionado.</div>';const a=Wa(e),t=yo(e),i=t.map(d=>Number(d.year)).filter(Boolean),o=[...new Set(t.map(d=>d.q).filter(Boolean))],n=[...new Set(t.map(We).filter(Boolean))],s=[...new Set(t.map(d=>ka(We(d)).editorial))],l=t.map(d=>{const b=We(d),u=Ya(d),p=ka(b);return`
            <article class="mb-5 rounded-3xl border border-slate-200 bg-white p-5 text-slate-900 shadow-sm transition hover:-translate-y-0.5 hover:shadow-xl md:p-6">
                ...
                <div class="mt-5 flex flex-wrap gap-3 border-t border-slate-100 pt-4">
                    ${u?`<a href="${q(ho(d))}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-xl bg-[#0f5b5d] px-4 py-2 text-sm font-black text-white hover:bg-[#0a4648]">Abrir DOI <span aria-hidden="true">↗</span></a>`:'<span class="text-sm font-bold text-slate-400">DOI no disponible</span>'}
            ...
            <div class="mx-auto max-w-[1600px]">
                    ...
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
                        ...
                        <div>
                            ...
                            <p class="mt-3 rounded-2xl border border-white/10 bg-white/5 p-3 text-xs leading-relaxed text-slate-300">
                                ${U.descripcionArticulos}. ${U.notaArticulos}
                            </p>
                        </div>
                    </div>
                </header>
                ...
                <div class="mt-8 grid min-h-[720px] grid-cols-1 gap-6 rounded-[2rem] border border-slate-200 bg-white p-4 shadow-xl md:grid-cols-[0.78fr_1.5fr] md:p-6">
                    <aside class="max-h-[430px] overflow-y-auto rounded-3xl border border-slate-200 bg-slate-50 p-4 custom-scrollbar md:max-h-none">
                        ...
                        <div class="mt-5 flex flex-col gap-4">${re.map(k=>wo(k,Number(k.id)===Number(e))).join("")}</div>
                    </aside>
                    ...
                    <div id="detalle-container" ${x} class="fixed inset-0 z-[350] items-center justify-center bg-slate-950/80 p-4 md:relative md:inset-auto md:z-0 md:flex md:bg-transparent md:p-0 ${c?"hidden":"flex"}">
                        <div class="h-[88%] w-full max-w-lg rounded-[2rem] border border-white/10 bg-[#071820] p-5 shadow-2xl md:h-full md:max-w-none md:p-6">${ko(r)}</div>
                    </div>
                </div>
            </div>
        `,l.querySelectorAll("[data-id]").forEach(k=>{k.onclick=()=>{e=Number(k.dataset.id),window.innerWidth<768&&(a=!0,n=k.dataset.id),C()}}),E()};return window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{window.innerWidth>=768&&(h(),a=!1),C()},120)}),C(),l}function Eo(){return Ao()}function _(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Co(e){return W.find(a=>a.id===e)||W[0]}function Ze(e=[]){return e.map(a=>`
    ...
    `).join("")}function $o(e=[]){return e.map(a=>`
    ...
    `}function jo(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function Lo(){const e=new Set(W.map(i=>i.categoria)),a=W.filter(i=>i.proyectosAsociados?.length>0).length,t=W.filter(i=>i.publicacionesClave?.length>0).length;return{total:W.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function zo(){let e=W[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Co(e),o=Lo();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-linea-id]").forEach(n=>{n.onclick=()=>{e=parseInt(n.dataset.lineaId),t()}})};return t(),a}function Io(){return zo()}function N(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Aa(e=[]){return e.map(a=>`<li class="flex gap-3 text-sm leading-relaxed text-slate-600 md:text-base"><span class="mt-2 h-2 w-2 shrink-0 rounded-full bg-[#b37a2a]"></span><span>${N(a)}</span></li>`).join("")}function Do(e=[]){return e.map(a=>`<span class="rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-black text-[#0f5b5d]">${N(a)}</span>`).join("")}function Po(e,a){return`<button type="button" data-proyecto-id="${e.id}" class="w-full rounded-2xl border p-5 text-left transition ${a?"border-[#0f5b5d] bg-[#0f5b5d] text-white shadow-xl":"border-slate-200 bg-white text-slate-950 hover:-translate-y-0.5 hover:border-emerald-300 hover:shadow-lg"}">
    ...
    </button>`}function Ro(e){return`<article class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-xl">
        ...
        <div class="p-6 md:p-9">
            ...
            <div class="mt-7 flex flex-wrap gap-2">${Do(e.etiquetas)}</div>
        </div>
    </article>`}function Oo(){let e=xe[0]?.id||1;const a=document.createElement("section");a.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12";const t=()=>{const i=xe.find(o=>o.id===e)||xe[0];a.innerHTML=`<div class="mx-auto max-w-[1600px]">
            ...
            <div class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[0.72fr_1.5fr]"><aside class="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-lg"><p class="text-xs font-black uppercase tracking-[0.18em] text-[#805615]">Portafolio</p><h2 class="mt-1 text-2xl font-black text-slate-950">Seleccione una iniciativa</h2><div class="mt-5 space-y-4">${xe.map(o=>Po(o,o.id===e)).join("")}</div></aside><div>${Ro(i)}</div></div>
        </div>`,a.querySelectorAll("[data-proyecto-id]").forEach(o=>o.addEventListener("click",()=>{e=Number(o.dataset.proyectoId),t()}))};return t(),a}function qo(){return Oo()}function To(){return`
    ...
    `}function Fo(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${No()}
    `,e}function Uo(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Bo)}async function Bo(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=_o(i);if(o.length>0){Ko(o);return}await Go(a,i)}function _o(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?Vo(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function Vo(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Ko(e){Re(e[0],"error")}function Re(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Go(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(Re("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):Re("Hubo un problema al enviar el mensaje.","error")}catch{Re("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function Ho(){const e=Fo();return setTimeout(()=>{Uo()},0),e}function Jo(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
};`,o.disabled=!0}function f(h,g="success"){s.textContent=h,s.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),s.classList.add("border"),g==="error"?s.classList.add("border-red-200","bg-red-50","text-red-800"):s.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function y(h){const g=h.split(/\r?\n/).map(m=>m.trim()).filter(Boolean),E=[],C=[],r=new Set;return g.forEach((m,c)=>{const x=m.split(/[\t,; ]+/).map(P=>P.trim()).filter(Boolean),v=c+1,k=x[0],I=x.slice(1);if(!k){C.push(`Línea ${v}: falta la matrícula.`);return}if(!/^\d+$/.test(k)){C.push(`Línea ${v}: la matrícula "${k}" no es válida.`);return}if(r.has(k)){C.push(`Línea ${v}: la matrícula ${k} está repetida.`);return}if(I.length===0){C.push(`Línea ${v}: falta al menos una calificación.`);return}const M=I.map(P=>Number(P));if(M.some(P=>!Number.isFinite(P))){C.push(`Línea ${v}: existe una calificación no numérica.`);return}r.add(k),E.push({matricula:k,grades:M})}),{records:E,errors:C}}function w(h){return`var data_todo = {
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
        ...
        `}return l.addEventListener("click",()=>{A("xmera")}),d.addEventListener("click",()=>{A("banner")}),A("xmera"),e}function Zo(){return Yo()}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Za(e){return String(e??"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim()}function es(e,a=!1){return`
        <button
            type="button"
    ...
    `}function as(e){const a=Za([e.numero,e.titulo,e.tituloCorto,e.resumen,e.descripcion,e.categoriaNombre,...e.subservicios||[],e.entregables].join(" "));return`
        <article
            data-servicio-card
    ...
    `}function ls(e){const a=encodeURIComponent(`Solicitud de servicio: ${e.titulo}`);return`
    ...
    `}function fs(e){if(e)try{const a=window.sessionStorage.getItem(Sa);window.sessionStorage.removeItem(Sa),a&&[...e.options].some(t=>t.value===a)&&(e.value=a)}catch(a){console.warn("[Kernel] No fue posible recuperar el servicio de interés.",a)}}function F(e,a){return String(new FormData(e).get(a)||"").trim()}function et(e){return le.find(a=>a.id===e)?.titulo||"No especificado"}function $a(e){const a={nombre:F(e,"nombre"),organizacion:F(e,"organizacion"),cargo:F(e,"cargo"),correo:F(e,"correo"),telefono:F(e,"telefono"),sector:F(e,"sector"),servicio:et(F(e,"servicio")),necesidad:F(e,"necesidad"),datos:F(e,"datos"),plazo:F(e,"plazo"),presupuesto:F(e,"presupuesto"),producto:F(e,"producto"),modalidad:F(e,"modalidad")};return["SOLICITUD DE DIAGNÓSTICO INICIAL — GRUPO EL KERNEL","",`Nombre: ${a.nombre}`,`Organización: ${a.organizacion||"No indicada"}`,`Cargo o función: ${a.cargo||"No indicado"}`,`Correo: ${a.correo}`,`Teléfono: ${a.telefono||"No indicado"}`,`Sector: ${a.sector||"No especificado"}`,`Servicio de interés: ${a.servicio}`,`Modalidad preferida: ${a.modalidad||"No especificada"}`,`Plazo esperado: ${a.plazo||"No especificado"}`,`Presupuesto estimado: ${a.presupuesto||"No especificado"}`,"","Problema o necesidad:",a.necesidad,"","Datos, documentos o recursos disponibles:",a.datos||"No especificados","","Producto o resultado esperado:",a.producto||"No especificado","","Nota: adjuntaré al correo generado los términos de referencia o documentos pertinentes, si aplica."].join(`
`)}async function vs(e){if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(e);return}const a=document.createElement("textarea");a.value=e,a.setAttribute("readonly",""),a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove()}function hs(){const e=document.createElement("section");e.className="w-full bg-slate-100 px-3 py-6 font-sans sm:px-5 md:py-10 lg:px-8",e.innerHTML=`
    ...
    `;const a=e.querySelector("[data-formulario-diagnostico]"),t=e.querySelector("[data-estado-diagnostico]"),i=e.querySelector("#servicio");return fs(i),a?.addEventListener("submit",o=>{if(o.preventDefault(),!a.checkValidity()){a.reportValidity(),t&&(t.textContent="Complete los campos obligatorios antes de continuar.");return}const n=$a(a),s=encodeURIComponent(`Solicitud de diagnóstico: ${et(F(a,"servicio"))}`),l=encodeURIComponent(n);t&&(t.textContent="Abriendo su aplicación de correo. Adjunte los documentos pertinentes antes de enviar."),window.location.href=`mailto:${Ca}?subject=${s}&body=${l}`}),e.querySelector("[data-copiar-diagnostico]")?.addEventListener("click",async()=>{if(!a?.checkValidity()){a?.reportValidity(),t&&(t.textContent="Complete los campos obligatorios para copiar un resumen útil.");return}try{await vs($a(a)),t&&(t.textContent="Resumen copiado. Puede pegarlo en un correo o documento.")}catch(o){console.error("[Kernel] No fue posible copiar el diagnóstico.",o),t&&(t.textContent="No fue posible copiar automáticamente. Utilice el botón para preparar el correo.")}}),e}const ys=450,Ce="kernel:recuperacion-modulo";let ge=0,Pe=null;function at(e){return new Promise(a=>{window.setTimeout(a,e)})}function ca(e){const a=String(e?.message||e||"");return/chunkloaderror|failed to fetch dynamically imported module|importing a module script failed|error loading dynamically imported module|networkerror.*module|load failed.*module/i.test(a)}function ws(e){return["kernel/auth-timeout","auth/network-request-failed"].includes(e?.code)}async function oa(e){let a;for(let t=0;t<2;t+=1)try{return await e()}catch(i){if(a=i,t>0||!ca(i))throw i;await at(ys)}throw a}function O(e,a,t){return async()=>{const o=(await oa(e))[a];if(typeof o!="function")throw new Error(t);return o()}}function ks(){return Pe||(Pe=Promise.all([oa(()=>D(()=>import("./authGuard-CEzcrBkK.js"),__vite__mapDeps([0,1,2]),import.meta.url)),oa(()=>D(()=>import("./login-BtABpxCq.js"),__vite__mapDeps([3,1,2]),import.meta.url))]).then(([e,a])=>({esperarAutenticacion:e.esperarAutenticacion,crearLogin:a.crearLogin})).catch(e=>{throw Pe=null,e})),Pe}const As=O(()=>D(()=>import("./LaboratorioKernel-CWzzarC3.js"),__vite__mapDeps([4,1,2]),import.meta.url),"LaboratorioKernel","El Laboratorio Inteligente no está disponible."),Es=O(()=>D(()=>import("./AsistentePruebas-9ENxU2k9.js"),__vite__mapDeps([5,6]),import.meta.url),"AsistentePruebas","El asistente metodológico no está disponible."),Cs=O(()=>D(()=>import("./ComparacionGrupos-BqmYk_OJ.js"),[],import.meta.url),"ComparacionGrupos","El módulo de comparación de grupos no está disponible."),Ss=O(()=>D(()=>import("./CalculadoraDosGrupos-S0N0nc3h.js"),__vite__mapDeps([7,8,9]),import.meta.url),"CalculadoraDosGrupos","La calculadora de dos grupos no está disponible."),$s=O(()=>D(()=>import("./CalculadoraDosMuestrasRelacionadas-owoY7atD.js"),__vite__mapDeps([10,11,8,9]),import.meta.url),"CalculadoraDosMuestrasRelacionadas","La calculadora de muestras relacionadas no está disponible."),Ms=O(()=>D(()=>import("./CalculadoraTresOMasGrupos-330OkVFd.js"),__vite__mapDeps([12,8,9]),import.meta.url),"CalculadoraTresOMasGrupos","La calculadora de tres o más grupos no está disponible."),js=O(()=>D(()=>import("./CalculadoraTresOMasMedicionesRelacionadas-DSeSW_yD.js"),__vite__mapDeps([13,8,11,9]),import.meta.url),"CalculadoraTresOMasMedicionesRelacionadas","La calculadora de mediciones relacionadas no está disponible."),Ls=O(()=>D(()=>import("./CorrelacionAsociacion-BJOAMDeR.js"),[],import.meta.url),"CorrelacionAsociacion","El módulo de correlación y asociación no está disponible."),zs=O(()=>D(()=>import("./CalculadoraRelacionVariables-BUOMLhVJ.js"),__vite__mapDeps([14,8,9]),import.meta.url),"CalculadoraRelacionVariables","La calculadora de relación entre variables no está disponible."),Is=O(()=>D(()=>import("./CalculadoraAsociacionCategorica-sub_5Ash.js"),__vite__mapDeps([15,8,9]),import.meta.url),"CalculadoraAsociacionCategorica","La calculadora de asociación categórica no está disponible."),Ds=O(()=>D(()=>import("./CalculadoraEstadisticaDescriptiva-Brear1EC.js"),__vite__mapDeps([16,9]),import.meta.url),"CalculadoraEstadisticaDescriptiva","La calculadora de estadística descriptiva no está disponible."),Ps=O(()=>D(()=>import("./CalculadoraFiabilidadCuestionarios-CtL9FOau.js"),__vite__mapDeps([17,9]),import.meta.url),"CalculadoraFiabilidadCuestionarios","La calculadora de cuestionarios y fiabilidad no está disponible."),Rs=O(()=>D(()=>import("./CalculadoraEvaluacionEducativa-CHnW9Z3A.js"),__vite__mapDeps([18,9]),import.meta.url),"CalculadoraEvaluacionEducativa","La calculadora de evaluación educativa no está disponible."),Os=O(()=>D(()=>import("./CalculadoraTamanoMuestraPotencia-Et-xcV35.js"),__vite__mapDeps([19,9]),import.meta.url),"CalculadoraTamanoMuestraPotencia","La calculadora de tamaño de muestra y potencia no está disponible."),qs=O(()=>D(()=>import("./BibliotecaMetodologica-BzzsJJUi.js"),__vite__mapDeps([20,6]),import.meta.url),"BibliotecaMetodologica","La Biblioteca metodológica no está disponible."),Ts=O(()=>D(()=>import("./RegresionModelos-q4rY9Zve.js"),[],import.meta.url),"RegresionModelos","El área de modelos de regresión no está disponible."),Ns=O(()=>D(()=>import("./CalculadoraRegresionCompleta-D6ZWa5Fb.js"),__vite__mapDeps([21,9]),import.meta.url),"CalculadoraRegresionCompleta","La calculadora de regresión lineal no está disponible."),Fs=O(()=>D(()=>import("./CalculadoraRegresionLogistica-DVo-UIng.js"),__vite__mapDeps([22,9]),import.meta.url),"CalculadoraRegresionLogistica","La calculadora de regresión logística no está disponible."),Us=O(()=>D(()=>import("./CalculadoraRegresionConteo-C6mup4hf.js"),__vite__mapDeps([23,9]),import.meta.url),"CalculadoraRegresionConteo","La calculadora de regresión de conteo no está disponible."),Bs={home:{page:ci,layout:"full",title:"Portada | El Kernel"},servicios:{page:bs,layout:"full",title:"Servicios profesionales y académicos | El Kernel"},diagnosticoServicios:{page:hs,layout:"full",title:"Solicitar diagnóstico | El Kernel"},quienesSomos:{page:Mi,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Ri,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Ni,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:fo,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:Eo,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:qo,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:Io,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:Ho,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Zo,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:As,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Es,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"},comparacionGrupos:{page:Cs,layout:"default",title:"Comparación de grupos y mediciones | El Kernel"},calculadoraDosGrupos:{page:Ss,layout:"default",title:"Comparación de dos grupos | El Kernel"},calculadoraDosMuestrasRelacionadas:{page:$s,layout:"default",title:"Comparación de dos mediciones relacionadas | El Kernel"},calculadoraTresOMasGrupos:{page:Ms,layout:"default",title:"Comparación de tres o más grupos independientes | El Kernel"},calculadoraTresOMasMedicionesRelacionadas:{page:js,layout:"default",title:"Comparación de tres o más mediciones relacionadas | El Kernel"},correlacionAsociacion:{page:Ls,layout:"default",title:"Correlación y asociación | El Kernel"},calculadoraRelacionVariables:{page:zs,layout:"default",title:"Relación entre variables | El Kernel"},calculadoraAsociacionCategorica:{page:Is,layout:"default",title:"Asociación entre variables categóricas | El Kernel"},calculadoraEstadisticaDescriptiva:{page:Ds,layout:"default",title:"Estadística descriptiva | El Kernel"},calculadoraFiabilidadCuestionarios:{page:Ps,layout:"default",title:"Cuestionarios y fiabilidad | El Kernel"},calculadoraEvaluacionEducativa:{page:Rs,layout:"default",title:"Evaluación educativa | El Kernel"},calculadoraTamanoMuestraPotencia:{page:Os,layout:"default",title:"Tamaño de muestra y potencia | El Kernel"},bibliotecaMetodologica:{page:qs,layout:"default",title:"Biblioteca metodológica | El Kernel"},regresionModelos:{page:Ts,layout:"default",title:"Modelos de regresión | El Kernel"},calculadoraRegresion:{page:Ns,layout:"default",title:"Regresión lineal y múltiple | El Kernel"},calculadoraRegresionLogistica:{page:Fs,layout:"default",title:"Regresión logística binaria | El Kernel"},calculadoraRegresionConteo:{page:Us,layout:"default",title:"Regresión de Poisson y binomial negativa | El Kernel"}},_s=new Set(["laboratorioKernel","asistentePruebas","comparacionGrupos","calculadoraDosGrupos","calculadoraDosMuestrasRelacionadas","calculadoraTresOMasGrupos","calculadoraTresOMasMedicionesRelacionadas","correlacionAsociacion","calculadoraRelacionVariables","calculadoraAsociacionCategorica","calculadoraEstadisticaDescriptiva","calculadoraFiabilidadCuestionarios","calculadoraEvaluacionEducativa","calculadoraTamanoMuestraPotencia","bibliotecaMetodologica","regresionModelos","calculadoraRegresion","calculadoraRegresionLogistica","calculadoraRegresionConteo"]);let Ma=document.referrer||"";function Je(e){window.location.hash=`/${e}`}function tt(){return window.location.hash.replace("#/","")||"home"}function Vs(){const e=()=>{_e(tt())};window.addEventListener("hashchange",e),e()}function Ks(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:Ma}),Ma=t}function Gs(e){return document.title="Acceso al Laboratorio | El Kernel",e(()=>{_e(tt())})}function Hs(){const e=document.createElement("section");return e.className="w-full max-w-4xl mx-auto px-4 py-16 md:px-8 font-sans",e.setAttribute("role","status"),e.setAttribute("aria-live","polite"),e.innerHTML=`
        ...
        </div>`,e}function Js(e){return e?.code==="kernel/auth-timeout"?"La verificación de la sesión tardó más de lo esperado. Compruebe su conexión e inténtelo nuevamente.":ca(e)?"No fue posible descargar esta sección. Puede tratarse de una interrupción temporal de la conexión.":"Ocurrió un problema inesperado al preparar esta sección."}function Qs(e,a){const t=document.createElement("section");t.className="w-full max-w-4xl mx-auto px-4 py-12 md:px-8 font-sans",t.setAttribute("role","alert"),t.setAttribute("aria-live","assertive"),t.innerHTML=`
        ...
        </div>`;const i=t.querySelector("[data-mensaje-error-ruta]");return i&&(i.textContent=Js(e)),t.querySelector("[data-action='reintentar-ruta']")?.addEventListener("click",a),t.querySelector("[data-action='volver-portada']")?.addEventListener("click",()=>Je("home")),t}function Xs(e,a){if(!ca(a))return!1;try{const t=JSON.parse(window.sessionStorage.getItem(Ce)||"null"),i=Date.now();return t?.route===e&&Number.isFinite(t?.timestamp)&&i-t.timestamp<12e4?!1:(window.sessionStorage.setItem(Ce,JSON.stringify({route:e,timestamp:i})),window.location.reload(),!0)}catch{return!1}}function Ws(e){try{JSON.parse(window.sessionStorage.getItem(Ce)||"null")?.route===e&&window.sessionStorage.removeItem(Ce)}catch{try{window.sessionStorage.removeItem(Ce)}catch{}}}function ja(e){const a=e.querySelector("h1");a&&(a.setAttribute("tabindex","-1"),a.focus({preventScroll:!0}))}async function Ys(e,a){if(!_s.has(e))return a.page();const{esperarAutenticacion:t,crearLogin:i}=await ks();return await t()?a.page():Gs(i)}async function _e(e,a={}){const{intentoAutenticacion:t=0}=a,i=document.querySelector("main"),o=Bs[e];if(!i)return;if(!o){Je("home");return}const n=++ge;Ka(o.layout),document.title=o.title,i.setAttribute("aria-busy","true"),i.replaceChildren(Hs());try{const s=await Ys(e,o);if(n!==ge)return;if(!(s instanceof Element))throw new Error("La sección no devolvió un componente válido.");i.replaceChildren(s),i.setAttribute("aria-busy","false"),window.scrollTo({top:0,behavior:"auto"}),window.requestAnimationFrame(()=>{n===ge&&ja(i)}),Ws(e),Ks(e,document.title)}catch(s){if(n!==ge)return;if(console.error(`[Kernel] Error al cargar la ruta ${e}.`,s),ws(s)&&t<1)return await at(650),n===ge?_e(e,{intentoAutenticacion:t+1}):void 0;if(Xs(e,s))return;i.setAttribute("aria-busy","false"),i.replaceChildren(Qs(s,()=>_e(e))),window.requestAnimationFrame(()=>{n===ge&&ja(i)})}}function Zs(e,a){e&&e.addEventListener("click",t=>{const i=t.target.closest("[data-route]");!i||!e.contains(i)||(t.preventDefault(),a(i.dataset.route),de(e))})}function er(e){return/^(?:laboratorioKernel|asistentePruebas|comparacionGrupos|calculadora|correlacionAsociacion|bibliotecaMetodologica|regresionModelos)/.test(e)?"laboratorioKernel":e}function La(e){const a=window.location.hash.replace("#/","")||"home",t=er(a);e.querySelectorAll("[data-route]").forEach(i=>{i.dataset.route===t?i.setAttribute("aria-current","page"):i.removeAttribute("aria-current")})}function ar(e,a){if(!e||!a)return;Zs(e,Je),dt(e);const t=a.querySelector('[data-action="open-menu"]');t&&ht(t,e),yt(e),La(e),window.addEventListener("hashchange",()=>La(e)),Vs()}function tr(e){const a=String(e??"").replace(/\u00a0/g,"").replace(/\s/g,"").replace(/[^0-9+\-.,eE]/g,"");if(!a)return null;const t=a.lastIndexOf(","),i=a.lastIndexOf(".");let o=a;t>=0&&i>=0?o=i>t?a.replace(/,/g,""):a.replace(/\./g,"").replace(",","."):t>=0&&(o=a.length-t-1===3&&t>0?a.replace(/,/g,""):a.replace(",","."));const n=Number(o);return Number.isFinite(n)?n:null}function ir(e){const a=e.querySelector("table");if(!a)return null;const i=[...a.querySelectorAll("thead th")].map(n=>n.textContent.trim().toLowerCase()).some(n=>n.includes("marca")),o=[...a.querySelectorAll("tbody tr")].map(n=>{const s=[...n.children],l=Number(s[i?2:1]?.textContent.trim()),d=Number(s[i?4:3]?.textContent.trim());return{etiqueta:s[0]?.textContent.trim()||"",valor:tr(s[i?1:0]?.textContent),frecuencia:Number.isFinite(l)?l:0,acumulada:Number.isFinite(d)?d:0}}).filter(n=>n.etiqueta&&n.frecuencia>=0);return{agrupados:i,filas:o}}function it(e){return Number.isFinite(Number(e))?Number(e).toLocaleString("es-DO",{maximumFractionDigits:3}):"—"}function za(e,a){let t=0;for(const i of e)if(t+=i.frecuencia,a<t)return i.valor;return e.at(-1)?.valor??null}function ea(e,a){const t=e.reduce((d,b)=>d+b.frecuencia,0);if(!t)return null;if(a<=0)return e[0].valor;if(a>=1)return e.at(-1).valor;const i=(t-1)*a,o=Math.floor(i),n=Math.ceil(i),s=za(e,o),l=za(e,n);return o===n?s:s*(n-i)+l*(i-o)}function Ae(e,a,t){return`
        <text
            x="${e}"
            y="${a}"
            text-anchor="middle"
    ...
    `}function or(e,a){if(!e||e.dataset.cajaDescriptivaSegura==="true"||a.agrupados)return;e.dataset.cajaDescriptivaSegura="true";const t=a.filas.filter(r=>r.valor!==null&&r.frecuencia>0).sort((r,m)=>r.valor-m.valor);if(t.reduce((r,m)=>r+m.frecuencia,0)<2)return;const o=t[0].valor,n=t.at(-1).valor,s=ea(t,.25),l=ea(t,.5),d=ea(t,.75),b=d-s,u=s-1.5*b,p=d+1.5*b,f=t.filter(r=>r.valor>=u&&r.valor<=p),y=t.filter(r=>r.valor<u||r.valor>p),w=f[0]?.valor??o,A=f.at(-1)?.valor??n,h=Math.max(n-o,1),g=r=>40+(r-o)/h*520,E=e.querySelector("svg");if(!E)return;E.setAttribute("aria-label","Diagrama de caja con cuartiles, mediana, bigotes y valores atípicos potenciales"),E.innerHTML=`
        ...
        ${Ae(g(d),30,d)}
        ${Ae(g(A),140,A)}
    `;const C=e.querySelector("h3 + p");C&&(C.textContent="Los bigotes terminan en los valores extremos no atípicos. Los puntos rojos representan valores atípicos potenciales según el criterio de Tukey.")}function sr(){const e=document.createElement("section");return e.dataset.encabezadoGraficosSeguro="true",e.className="mt-10",e.innerHTML=`
    ...
    `,e}function rr(e){const a=document.createElement("article");a.dataset.graficoExportable="true",a.dataset.graficoId="histograma",a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const t=Math.max(...e.map(i=>i.frecuencia),1);return a.innerHTML=`
    ...
    `,a}function lr(e){const a=[...e.querySelectorAll("article")],t=a.find(s=>s.querySelector("h3")?.textContent.includes("Distribución de frecuencias")),i=a.find(s=>s.querySelector("h3")?.textContent.includes("Diagrama de caja"));if(!t||!i)return;const o=t.parentElement,n=ir(e);if(!(!o||!n?.filas.length)&&(e.querySelector("[data-encabezado-graficos-seguro='true']")||(o.before(sr()),o.classList.remove("mt-8")),or(i,n),!e.querySelector("[data-graficos-descriptivos-seguros='true']"))){const s=document.createElement("div");s.dataset.graficosDescriptivosSeguros="true",s.className="grid grid-cols-1 xl:grid-cols-2 gap-7 mt-7",s.append(rr(n.filas),nr(n.filas)),o.after(s)}}function cr(){let e=!1;const a=()=>{e=!1;const o=document.querySelector("#resultados-estadistica-descriptiva");o&&!o.classList.contains("hidden")&&lr(o)},t=()=>{e||(e=!0,window.requestAnimationFrame(a))};new MutationObserver(t).observe(document.body,{childList:!0,subtree:!0}),t()}const dr=["#formulario-estadistica-descriptiva","#formulario-regresion","#formulario-regresion-conteo","#form-tamano","[id*='calculadora'] form","section form"].join(",");function ur(){return document.querySelector("main h1, #app h1, h1")?.textContent?.trim()?.toLowerCase()||""}function pr(){return ur().includes("laboratorio inteligente de investigación")}function mr(){const e=document.querySelector("main h1, #app h1, h1"),a=document.querySelector("[data-action='volver-laboratorio'], [data-action='volver-modelos'], [data-action='volver-regresion'], [data-action='volver']"),t=document.querySelector(dr);return!!(e&&a&&t)}function br(){const e=document.createElement("section");return e.dataset.creditosCalculadoras="true",e.className=["w-full max-w-7xl mx-auto","px-4 pb-10 md:px-8","font-sans"].join(" "),e.innerHTML=`
    ...
    `,a.querySelector("button")?.addEventListener("click",l=>{const d=l.currentTarget,b=d.dataset.almacenamientoRegresion;b&&sessionStorage.setItem(b,d.dataset.tipoRegresion||""),window.location.hash=`/${d.dataset.routeRegresion}`}),a}function Da(){const e=fr();if(!e)return;const a=e.encabezado.closest("section");if(!a||a.querySelector("[data-ejecutar-modelo-regresion='true']")||a.querySelector("[data-action='ejecutar-prueba']"))return;(a.querySelector("header + div")||a).appendChild(vr(e.modelo))}function Pa(){const a=document.querySelector("#formulario-regresion")?.elements?.tipoModelo;if(!a)return;const t=sessionStorage.getItem("kernel-tipo-modelo-regresion");t!=="simple"&&t!=="multiple"||(a.value=t,a.dispatchEvent(new Event("change",{bubbles:!0})),sessionStorage.removeItem("kernel-tipo-modelo-regresion"))}function hr(){new MutationObserver(()=>{Da(),Pa()}).observe(document.body,{childList:!0,subtree:!0}),Da(),Pa()}let Oe=null;function Ee({restaurarFoco:e=!0}={}){if(Oe){const a=Oe;Oe=null,a(e);return}document.querySelector("[data-selector-instrumento='true']")?.remove()}function yr(){Ee({restaurarFoco:!1});const e=document.activeElement,a=document.body.style.overflow,t=document.createElement("div");t.dataset.selectorInstrumento="true",t.className=`
        fixed inset-0 z-[500]
