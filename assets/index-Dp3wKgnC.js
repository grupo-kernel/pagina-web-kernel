...
(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const Me=""+new URL("ElKernel-BvHOWfRq.webp",import.meta.url).href;function st(){return`
    ...
    `});function j(e,a="text-2xl"){const t=va[e]||va["bx-grid-alt"];return`
        <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
            fill="none"
    ...
    `;const t=[...a.querySelectorAll("[data-universidad-imagen-capa]")],i=a.querySelector("[data-universidad-sigla]"),o=a.querySelector("[data-universidad-nombre]"),n=a.querySelector("[data-universidad-descripcion]"),s=a.querySelector("[data-universidad-enlace]"),l=a.querySelector("[data-universidad-contador]"),d=a.querySelector("[data-universidad-estado]"),b=a.querySelector("[data-universidad-escenario]"),u=a.querySelector("[data-universidad-progreso]"),p=[...a.querySelectorAll("[data-universidad-control]")],v=a.querySelector("[data-action='universidad-anterior']"),y=a.querySelector("[data-action='universidad-siguiente']"),w=a.querySelector("[data-action='pausar-rotacion']"),k=a.querySelector("[data-universidad-icono-pausa]"),h=a.querySelector("[data-universidad-icono-reproducir]"),g=a.querySelector("[data-universidad-texto-rotacion]"),A=window.matchMedia("(prefers-reduced-motion: reduce)"),C=new AbortController,r={signal:C.signal};let m=0,c=0,x=0,f=null,E=null,I=null,M=!1,P=!1,z=!1,R=!1,Y=!1,U=!A.matches,G=typeof window.IntersectionObserver!="function";function de(L){return(L%J.length+J.length)%J.length}function it(L){const S=t[c];if(S?.dataset.institucionId===L.id)return;const H=c===0?1:0,T=t[H],ve=++x;let ua=!1;function pa(){ua||ve!==x||!T.naturalWidth||(ua=!0,S.alt="",T.alt=L.alt,T.classList.remove("opacity-0"),T.classList.add("opacity-100"),S.classList.remove("opacity-100"),S.classList.add("opacity-0"),c=H)}T.onload=pa,T.onerror=()=>{ve===x&&T.removeAttribute("src")},T.alt="",T.width=L.ancho,T.height=L.alto,T.style.objectPosition=L.posicion,T.dataset.institucionId=L.id,T.src=L.imagen,T.complete&&T.naturalWidth&&window.requestAnimationFrame(pa)}function la(){E!==null&&window.clearTimeout(E),G&&(E=window.setTimeout(()=>{const L=J[de(m+1)],S=new Image;S.decoding="async",S.src=L.imagen,E=null},700))}function He(L=!1){const S=J[m];it(S),i.textContent=S.sigla,o.textContent=S.nombre,n.textContent=S.descripcion,s.href=S.enlace,s.setAttribute("aria-label",`Visitar el sitio institucional de ${S.sigla}`),l.textContent=`${String(m+1).padStart(2,"0")} / ${String(J.length).padStart(2,"0")}`,b.setAttribute("aria-labelledby",`pestana-institucion-${S.id}`),u.style.width=`${(m+1)/J.length*100}%`,p.forEach((H,T)=>{const ve=T===m;H.setAttribute("aria-selected",String(ve)),H.tabIndex=ve?0:-1}),L&&(d.textContent=`${S.sigla}: ${S.nombre}`),la()}function Z(){f!==null&&(window.clearInterval(f),f=null)}function ot(){return U&&G&&!document.hidden&&!P&&!z&&!R&&a.isConnected}function K(){Z(),ot()&&(f=window.setInterval(()=>{m=de(m+1),He(!1)},Pt))}function Je(){const L=!U;w.setAttribute("aria-pressed",String(L)),w.setAttribute("aria-label",L?"Reanudar la rotación automática":"Pausar la rotación automática"),k.classList.toggle("hidden",L),h.classList.toggle("hidden",!L),g.textContent=L?"Reanudar rotación":"Pausar rotación"}function ae(L,S=!0,H=!1){m=de(L),He(S),H&&p[m]?.focus(),K()}v?.addEventListener("click",()=>ae(m-1),r),y?.addEventListener("click",()=>ae(m+1),r),w?.addEventListener("click",()=>{Y=!0,U=!U,Je(),U?(d.textContent="Rotación automática reanudada.",K()):(d.textContent="Rotación automática pausada.",Z())},r),p.forEach(L=>{L.addEventListener("click",()=>ae(Number(L.dataset.indice)),r),L.addEventListener("keydown",S=>{S.key==="ArrowLeft"?(S.preventDefault(),ae(m-1,!0,!0)):S.key==="ArrowRight"?(S.preventDefault(),ae(m+1,!0,!0)):S.key==="Home"?(S.preventDefault(),ae(0,!0,!0)):S.key==="End"&&(S.preventDefault(),ae(J.length-1,!0,!0))},r)}),a.addEventListener("mouseenter",()=>{P=!0,Z()},r),a.addEventListener("mouseleave",()=>{P=!1,K()},r),a.addEventListener("focusin",()=>{z=!0,Z()},r),a.addEventListener("focusout",L=>{z=a.contains(L.relatedTarget),z||K()},r),b?.addEventListener("touchstart",L=>{I=L.changedTouches[0]?.clientX??null,R=!0,Z()},{...r,passive:!0}),b?.addEventListener("touchend",L=>{const S=L.changedTouches[0]?.clientX??null;if(R=!1,I!==null&&S!==null){const H=S-I;Math.abs(H)>45?ae(m+(H<0?1:-1)):K()}I=null},{...r,passive:!0}),b?.addEventListener("touchcancel",()=>{I=null,R=!1,K()},r),document.addEventListener("visibilitychange",()=>{document.hidden?Z():K()},r),A.addEventListener("change",()=>{Y||(U=!A.matches,Je()),U?K():Z()},r);const ca=typeof window.IntersectionObserver=="function"?new IntersectionObserver(L=>{G=L.some(S=>S.isIntersecting&&S.intersectionRatio>=.15),G?(la(),K()):Z()},{threshold:[0,.15,.5]}):null;ca?.observe(a);const da=new MutationObserver(()=>{if(a.isConnected){M||(M=!0,K());return}M&&(Z(),E!==null&&window.clearTimeout(E),C.abort(),ca?.disconnect(),da.disconnect())});return da.observe(document.body,{childList:!0,subtree:!0}),He(!1),Je(),a}function ha(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Le(e,a){return`
        ...
        <div class="grid grid-cols-1 border-t border-slate-200 xl:grid-cols-[minmax(0,1.45fr)_minmax(19rem,0.55fr)]">
            ...
            <aside class="bg-[#071820] p-5 text-white md:p-7" aria-label="Indicadores y principios de confianza">
                ...
                <div class="mt-4 grid grid-cols-2 gap-3">
                    ...
                    ${Le(i,"Publicaciones registradas")}
                </div>
    ...
    `}function Yt(){return kt.map(e=>`
        <span class="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-2 text-xs font-bold text-slate-100">
            <span class="text-[#efc86f]">${j(e.icono,"text-base")}</span>
            ${X(e.titulo)}
        </span>
    ...
    `}function ei(){const e=Qt(),a=document.createElement("section");return a.className="w-full space-y-10 bg-white pb-10 font-sans",a.innerHTML=`
        ...
        <section class="mx-4 sm:mx-6 lg:mx-8 xl:mx-10" aria-labelledby="titulo-lineas-portada">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                ...
                <a href="#/lineas" class="inline-flex items-center gap-2 font-black text-[#0f5b5d] hover:text-[#083f40]">Explorar las nueve líneas ${j("bx-right-arrow-alt","text-xl")}</a>
            </div>
        ...
        <section class="mx-4 grid grid-cols-1 gap-6 sm:mx-6 lg:mx-8 xl:mx-10 2xl:grid-cols-[1.1fr_0.9fr]" aria-label="Proyectos, equipo y producción científica">
            <div>
                <div class="mb-6 flex items-end justify-between gap-4">
                    ...
                    <a href="#/proyectos" class="hidden font-black text-[#0f5b5d] hover:text-[#083f40] sm:inline-flex sm:items-center sm:gap-2">Ver proyectos ${j("bx-right-arrow-alt","text-xl")}</a>
                </div>
            ...
            <aside class="rounded-[2rem] border border-slate-200 bg-slate-50 p-6 shadow-sm md:p-8">
                ...
                <div class="mt-6 flex flex-col gap-3 sm:flex-row">
                    <a href="#/equipment" class="inline-flex items-center justify-center gap-2 rounded-xl bg-[#0f5b5d] px-5 py-3.5 font-black text-white hover:bg-[#0a4648]">Conocer al equipo ${j("bx-right-arrow-alt","text-xl")}</a>
        ...
        <section class="mx-4 overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#0f5b5d] to-[#071820] px-6 py-10 text-white shadow-2xl sm:mx-6 md:px-10 md:py-12 lg:mx-8 xl:mx-10" aria-labelledby="titulo-cta-portada">
            <div class="grid grid-cols-1 gap-7 lg:grid-cols-[1fr_auto] lg:items-center">
                ...
                <div class="flex flex-col gap-3 sm:flex-row lg:flex-col">
                    <a href="#/diagnosticoServicios" class="inline-flex items-center justify-center gap-2 rounded-xl bg-[#d5a54a] px-6 py-4 font-black text-[#071820] shadow-lg hover:bg-[#efc86f]">Solicitar diagnóstico ${j("bx-right-arrow-alt","text-xl")}</a>
    ...
    `,a.querySelector("[data-franja-institucional]")?.replaceWith(qt({integrantes:ie.length,servicios:ne.length,lineas:W.length,publicaciones:e})),a.querySelector("[data-resumen-servicios]")?.replaceWith(_t()),a.querySelector("[data-proceso-aplicaciones]")?.replaceWith(Ht()),a}const ai="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function ti(){try{const e=await fetch(ai,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}const ii=["w-full","min-w-0","max-w-none","max-w-7xl","tabletBig:max-w-6xl","xl:max-w-7xl","2xl:max-w-500","3xl:max-w-none","m-auto","m-0","p-0","p-2","mt-0","mt-8","md:mt-12","pt-0"],oi=["max-w-7xl","tabletBig:max-w-6xl","xl:max-w-7xl","2xl:max-w-500","3xl:max-w-none"];function Va(e="default"){const a=document.getElementById("main");if(a){if(a.classList.remove(...ii),a.classList.add("w-full","min-w-0"),e==="full"){a.classList.add("max-w-none","m-0","p-0","mt-0","pt-0");return}a.classList.add(...oi,"p-2","mt-8","md:mt-12"),e==="left"?a.classList.add("m-0"):a.classList.add("m-auto")}}function je(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function si(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function ri(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const s=await ti();a.textContent=je(s.total),t.textContent=je(s.hoy),i.textContent=je(s.ultimos7Dias),o.textContent=je(s.ultimos30Dias);const l=si(s.actualizadoEn);n.textContent=l?`Actualizado: ${l}`:"Estadísticas temporalmente no disponibles"}catch(s){console.error("Error al mostrar las estadísticas en la portada:",s),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function ni(){Va("full");const e=ei();return ri(e),e}function li(){return ni()}const ci=""+new URL("QuienesSomos-CIhVjMhZ.webp",import.meta.url).href;function di(){return`
        <section 
            role="banner" 
  ...
  `}function Ei(){const e=document.createElement("section");return e.className="w-full bg-slate-100 px-4 py-8 font-sans md:px-8 md:py-12",e.innerHTML=`
    ...
    `;const t=Mi(e.redes||[]),i=Li(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
    ...
    `,a}function zi(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const y=o();return Math.max(ie.length-y,0)},s=()=>{const y=n();e>y&&(e=0),e<0&&(e=y)},l=()=>{const y=n();e>=y?e=0:e++,v()},d=()=>{const y=n();e<=0?e=y:e--,v()},b=()=>{u(),ie.length>o()&&(a=setInterval(l,4500))},u=()=>{a&&(clearInterval(a),a=null)},p=()=>{const y=o(),w=Math.max(ie.length-y+1,1);return Array.from({length:w}).map((k,h)=>`
        ...
        `;const k=i.querySelector("#cards-wrapper");w.forEach(A=>{k.appendChild(ji(A))});const h=i.querySelector("#prev-btn"),g=i.querySelector("#next-btn");h&&(h.onclick=()=>{d(),b()}),g&&(g.onclick=()=>{l(),b()}),i.querySelectorAll("[data-dot-index]").forEach(A=>{A.onclick=()=>{e=parseInt(A.dataset.dotIndex),v(),b()}})};return i.addEventListener("mouseenter",u),i.addEventListener("mouseleave",b),document.addEventListener("visibilitychange",()=>{document.hidden?u():b()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,v(),b()},150)}),v(),b(),i}function Ii(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&Ke(t.dataset.route)})}function Ga(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `;const t=document.createElement("div");t.className="mt-8 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm",t.appendChild(Ga());const i=zi();return i.className="w-full py-8 flex flex-col gap-8 items-center font-sans",a.appendChild(t),a.appendChild(i),e.appendChild(a),e}function Pi(){return Di()}function _(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ka(e){return e.formacion?.length||0}function Ha(e){return e.experiencia?.length||0}function Ri(e,a=!1){const t=Ka(e),i=Ha(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
...
Gracias.`);return`
    ...
    `}function Lo(){const e=new Set(W.map(i=>i.categoria)),a=W.filter(i=>i.proyectosAsociados?.length>0).length,t=W.filter(i=>i.publicacionesClave?.length>0).length;return{total:W.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function jo(){let e=W[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=Eo(e),o=Lo();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function ts(e){return`
        <article class="min-w-[280px] flex-1 rounded-3xl border border-amber-200 bg-amber-50 p-5 shadow-sm md:min-w-[330px]">
            <div class="flex items-center justify-between gap-3">
                ...
                ${j("bx-grid-alt","text-2xl text-amber-800")}
            </div>
                        ...
                        <ul class="mt-5 grid grid-cols-1 gap-3 md:grid-cols-2">
                            ${Ba.map(u=>`
                                <li class="flex items-start gap-3 rounded-2xl bg-slate-50 p-4 text-sm leading-relaxed text-slate-700">
                                    <span class="mt-0.5 text-sky-700">${j("bx-check-shield","text-lg")}</span>
                                    <span>${$(u)}</span>
                                </li>
                            `).join("")}
                        </ul>
...
`)}async function fs(e){if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(e);return}const a=document.createElement("textarea");a.value=e,a.setAttribute("readonly",""),a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove()}function vs(){const e=document.createElement("section");e.className="w-full bg-slate-100 px-3 py-6 font-sans sm:px-5 md:py-10 lg:px-8",e.innerHTML=`
                ...
                <form data-formulario-diagnostico class="space-y-7" novalidate>
                    <section aria-labelledby="titulo-identificacion-diagnostico">
                        <div class="mb-5 flex items-center gap-3">
                            <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-50 text-[#0f5b5d] ring-1 ring-emerald-200">${j("bx-group","text-xl")}</span>
                            <div>
                    ...
                    <section aria-labelledby="titulo-necesidad-diagnostico">
                        <div class="mb-5 flex items-center gap-3">
                            <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-50 text-[#9a671d] ring-1 ring-amber-200">${j("bx-check-shield","text-xl")}</span>
                            <div>
    ...
    `,e}function sr(e){const a=document.createElement("article");a.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-md overflow-hidden";const t=Math.max(...e.map(i=>i.frecuencia),1);return a.innerHTML=`
    ...
    `,o.innerHTML=`
        <span aria-hidden="true">↓</span>
        Descargar SVG
    `,o.setAttribute("aria-label",`Descargar ${i} en formato SVG`),o.addEventListener("click",()=>{dr(a,i,t)}),e.appendChild(o)}function pr(e){const a=window.open("","_blank");if(!a){window.print();return}const t=`
        <style>
    ...
    `),a.document.close(),a.addEventListener("load",()=>{a.focus(),a.print()})}function mr(e){if(e.querySelector("[data-herramientas-exportacion='true']"))return;const a=document.createElement("section");a.dataset.herramientasExportacion="true",a.className=`
    ...
    `,a.querySelector("[data-imprimir-informe]")?.addEventListener("click",()=>{pr(e)}),e.prepend(a)}function br(e){mr(e),[...e.querySelectorAll("article")].forEach((t,i)=>{const o=t.querySelector("svg");o&&ur(t,o,i)})}function gr(){const e=()=>{const t=document.querySelector("#resultados-estadistica-descriptiva");t&&!t.classList.contains("hidden")&&br(t)};new MutationObserver(e).observe(document.body,{childList:!0,subtree:!0}),e()}const xr=["#formulario-estadistica-descriptiva","#formulario-regresion","#formulario-regresion-conteo","#form-tamano","[id*='calculadora'] form","section form"].join(",");function fr(){return document.querySelector("main h1, #app h1, h1")?.textContent?.trim()?.toLowerCase()||""}function vr(){return fr().includes("laboratorio inteligente de investigación")}function hr(){const e=document.querySelector("main h1, #app h1, h1"),a=document.querySelector("[data-action='volver-laboratorio'], [data-action='volver-modelos'], [data-action='volver-regresion'], [data-action='volver']"),t=document.querySelector(xr);return!!(e&&a&&t)}function yr(){const e=document.createElement("section");return e.dataset.creditosCalculadoras="true",e.className=["w-full max-w-7xl mx-auto","px-4 pb-10 md:px-8","font-sans"].join(" "),e.innerHTML=`
    ...
    `,a.querySelector("button")?.addEventListener("click",l=>{const d=l.currentTarget,b=d.dataset.almacenamientoRegresion;b&&sessionStorage.setItem(b,d.dataset.tipoRegresion||""),window.location.hash=`/${d.dataset.routeRegresion}`}),a}function Ia(){const e=Ar();if(!e)return;const a=e.encabezado.closest("section");if(!a||a.querySelector("[data-ejecutar-modelo-regresion='true']")||a.querySelector("[data-action='ejecutar-prueba']"))return;(a.querySelector("header + div")||a).appendChild(Er(e.modelo))}function Da(){const a=document.querySelector("#formulario-regresion")?.elements?.tipoModelo;if(!a)return;const t=sessionStorage.getItem("kernel-tipo-modelo-regresion");t!=="simple"&&t!=="multiple"||(a.value=t,a.dispatchEvent(new Event("change",{bubbles:!0})),sessionStorage.removeItem("kernel-tipo-modelo-regresion"))}function Cr(){new MutationObserver(()=>{Ia(),Da()}).observe(document.body,{childList:!0,subtree:!0}),Ia(),Da()}let Pe=null;function Ee({restaurarFoco:e=!0}={}){if(Pe){const a=Pe;Pe=null,a(e);return}document.querySelector("[data-selector-instrumento='true']")?.remove()}function Sr(){Ee({restaurarFoco:!1});const e=document.activeElement,a=document.body.style.overflow,t=document.createElement("div");t.dataset.selectorInstrumento="true",t.className=`
        fixed inset-0 z-[500]
