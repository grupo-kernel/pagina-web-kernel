(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();const _=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function he(){return`<div class="flex items-center px-2.5   w-full  ">
        ...
        </div>`}function we(){return`<div class="lg:hidden border-b-zinc-500 border-b pb-2.5 w-full flex px-2.5 justify-between items-center mb-7">
        ...
        </ul>`}function ye(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${_}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function ne(e,t){e.addEventListener("click",a=>{const i=a.target.closest(["[data-route]"]);i&&(a.preventDefault(),t(i.dataset.route))})}function Le(e){ne(e,X)}const le=""+new URL("apec-ConmXkrT.png",import.meta.url).href,De=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,Pe=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,ie=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        ...
        <img src="${Pe}" alt="UASD" title="UASD" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function je(e){const t=e.querySelector("#arrowR"),a=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!t||!a||!i)return;const o=ie.length,r=1500;let n=0,d=null;function v(c){return(c%o+o)%o}function h(){i.innerHTML=ie[n].content}function p(c){n=v(n+c),h()}function E(){f(),d=setInterval(()=>p(1),r)}function f(){d&&(clearInterval(d),d=null)}function u(){E()}h(),E(),t.addEventListener("click",()=>{p(1),u()}),a.addEventListener("click",()=>{p(-1),u()})}function $e(){const e=`
        <section class="
    ...
    `,t=document.createElement("div");t.innerHTML=e;const a=t.firstElementChild;return je(a.querySelector("#containerFather")),Le(a.querySelector("#btnsGroup")),a}function Ie(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=`${Me()}`;const t=$e();return e.appendChild(t),e}function ze(){return Ie()}const Be=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function Fe(){return`
        <section 
            role="banner" 
  ...
  `}function Ye({icon:e,title:t,content:a}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${He}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function We(){const e=document.createElement("section");return e.className=`
    ...
    `,e.innerHTML=`
        ...
        ${Re()}
        ${Qe()}
    `,e}function Xe(e){e.querySelectorAll("[data-accordion-header]").forEach(a=>{a.addEventListener("click",()=>{const i=a.nextElementSibling,o=a.querySelector("[data-accordion-icon]"),r=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(n=>{n.classList.remove("max-h-[1000px]"),n.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(n=>{n.classList.remove("rotate-180")}),r||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function Ze(e){const t=e.querySelector("[data-description-text]"),a=e.querySelector("[data-description-btn]");if(!t||!a)return;let i=!1;a.addEventListener("click",()=>{i=!i,t.classList.toggle("line-clamp-4",!i),a.textContent=i?"Leer menos":"Leer más"})}function _e(){const e=We();return Xe(e),Ze(e),e}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function et(e=[]){return!e||e.length===0?`
        ...
        <a href="${B(t.url)}" 
           ...
           title="${B(t.name)}">
            <i class="${B(t.icon)} text-xl"></i>
        </a>
    `).join("")}function tt(e){return e?String(e).split(",").map(a=>a.trim()).filter(Boolean).slice(0,4).map(a=>`
    ...
    `).join(""):""}function at(e){const t=document.createElement("article");t.className=`
    ...
    `;const a=et(e.redes||[]),i=tt(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return t.innerHTML=`
        ...
        <div class="w-full flex flex-col gap-4 text-left flex-1">
                ...
                <div class="flex flex-wrap gap-2">
                    ${i||`
                                <p class="text-sm text-slate-500 leading-relaxed">
                                    ${B(e.areas||"Área no especificada")}
                                </p>
                              `}
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-sm text-slate-600 leading-relaxed">
                    ${B(e.afilaciones||e.afiliaciones||"No especificadas")}
                </p>
            </div>
    ...
    `,t}const ce=""+new URL("rad-B3ff1btG.png",import.meta.url).href,de=""+new URL("mar-Cru0HERG.png",import.meta.url).href,O=[{img:Q,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:W,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:ce,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:ee,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:de,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:Y,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:H,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function it(){let e=0,t=null,a=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,r=()=>{const u=o();return Math.max(O.length-u,0)},n=()=>{const u=r();e>u&&(e=0),e<0&&(e=u)},d=()=>{const u=r();e>=u?e=0:e++,f()},v=()=>{const u=r();e<=0?e=u:e--,f()},h=()=>{p(),O.length>o()&&(t=setInterval(d,4500))},p=()=>{t&&(clearInterval(t),t=null)},E=()=>{const u=o(),c=Math.max(O.length-u+1,1);return Array.from({length:c}).map((w,x)=>`
        ...
        `;const w=i.querySelector("#cards-wrapper");c.forEach(k=>{w.appendChild(at(k))});const x=i.querySelector("#prev-btn"),y=i.querySelector("#next-btn");x&&(x.onclick=()=>{v(),h()}),y&&(y.onclick=()=>{d(),h()}),i.querySelectorAll("[data-dot-index]").forEach(k=>{k.onclick=()=>{e=parseInt(k.dataset.dotIndex),f(),h()}})};return i.addEventListener("mouseenter",p),i.addEventListener("mouseleave",h),document.addEventListener("visibilitychange",()=>{document.hidden?p():h()}),window.addEventListener("resize",()=>{clearTimeout(a),a=setTimeout(()=>{e=0,f(),h()},150)}),f(),h(),i}function ot(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-route]");if(!a)return;const i=window.location.hash.replace("#/","")||"equipment";a.dataset.route!==i&&X(a.dataset.route)})}function pe(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",t=document.createElement("nav"),a="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return t.className="w-full flex justify-center mb-6",t.innerHTML=`
    ...
    `,ot(t),t}function st(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=document.createElement("div");t.className="mb-6",t.appendChild(pe());const a=it();return e.appendChild(t),e.appendChild(a),e}function rt(){return st()}function nt(e="default"){const t=document.getElementById("main");t.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(t.classList.add("mt-0","pt-0"),t.classList.remove("max-w-7xl")):e=="left"?(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.remove("m-auto")):(t.classList.add("p-2","mt-8","md:mt-12"),t.classList.add("m-auto"))}function z(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function ue(e){return e.formacion?.length||0}function me(e){return e.experiencia?.length||0}function lt(e,t=!1){const a=ue(e),i=me(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function ct(e){const t=e.formacion||[],a=e.experiencia||[],i=t.length?t.map(d=>`
    ...
    `}function T(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function vt({id:e,title:t,date:a,image:i,imageAlt:o,excerpt:r,category:n="Noticia",imageFit:d="contain"}){const v=d==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${T(e)}"
            class="
    ...
    `}function wt(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),t=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function yt(e=[]){return[...e].sort((t,a)=>t.featured&&!a.featured?-1:!t.featured&&a.featured?1:0)}function kt(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const t=yt(xe),a=t.find(i=>i.featured)||t[0];return e.innerHTML=`
        ${ft(a)}
        ${ht(t)}
        ${wt()}
    `,e}function At({title:e,content:t={paragraphs:[],list:[]},articleURL:a}){const i=(t.paragraphs||[]).map(n=>`<p>${n}</p>`).join(""),o=(t.list||[]).length?`
    ...
    `}function Ct(e){e&&e.addEventListener("click",t=>{const a=t.target.closest("[data-news-btn], [data-news-card]");if(!a||!e.contains(a))return;const i=a.dataset.newsBtn||a.dataset.newsCard,o=xe.find(r=>String(r.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}Et(o)})}function Et(e){const t=document.querySelector("#newsModal");t&&t.remove();const a=document.createElement("div");a.innerHTML=At(e);const i=a.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",r)}function r(n){n.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(n=>{n.addEventListener("click",o)}),i.addEventListener("click",n=>{n.target===i&&o()}),document.addEventListener("keydown",r)}function St(){const e=kt();return Ct(e),e}function P(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function be(e){return e?.name||e?.title||"Investigador"}function oe(e){return e?.title||e?.tile||"Revista no especificada"}function ge(e){return String(e?.DOI||e?.doi||"").trim()}function Mt(e){const t=ge(e);return e?.url?e.url:t?t.startsWith("http")?t:`https://doi.org/${t}`:"#"}function Lt(e){return[...e?.publicaciones||[]].sort((t,a)=>{const i=Number(t.year||0),o=Number(a.year||0);return i!==o?o-i:String(t.contenido||"").localeCompare(String(a.contenido||""))})}function Dt(e,t=!1){const a=be(e),i=e.publicaciones||[],o=i.length,r=i.map(d=>Number(d.year)).filter(Boolean),n=r.length?Math.max(...r):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${t?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function Pt(e){if(!e)return`
        ...
        `;const t=be(e),a=Lt(e),i=a.length,o=a.map(p=>Number(p.year)).filter(Boolean),r=o.length?Math.min(...o):"",n=o.length?Math.max(...o):"",d=[...new Set(a.map(p=>p.q).filter(Boolean))],v=[...new Set(a.map(p=>oe(p)).filter(Boolean))],h=a.map(p=>{const E=oe(p),f=ge(p),u=Mt(p);return`
    ...
    `}function jt(){let e=F[0]?.id||1,t=!1,a=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(c){return String(c?.DOI||c?.doi||"").trim().toLowerCase()}function r(c){return String(c?.journal||c?.title||c?.tile||"").trim()}function n(c){return String(c?.articleTitle||c?.contenido||"").trim()}function d(c){return String(c?.q||c?.quartile||"").trim().toUpperCase()}function v(c){const w=o(c);return w||[c?.year||"",r(c),n(c)].join("-").trim().toLowerCase()}function h(){const c=new Map;return F.forEach(w=>{(w.publicaciones||[]).forEach(x=>{const y=v(x);y&&!c.has(y)&&c.set(y,x)})}),Array.from(c.values())}function p(){const c=h(),w=c.map(L=>Number(L.year)).filter(Boolean),x=w.length?Math.max(...w):"—",y=w.length?Math.min(...w):"—",k=c.filter(L=>d(L)==="Q1").length;return{totalPublicaciones:c.length,investigadores:F.length,q1:k,primerYear:y,ultimoYear:x}}function E(){return F.find(c=>Number(c.id)===Number(e))||F[0]}const f=()=>{const c=E(),w=p(),x=window.innerWidth<768&&!t;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${F.map(k=>Dt(k,Number(k.id)===Number(e))).join("")}
                </aside>
    ...
    `).join("")}function Bt(e=[]){return e.map(t=>`
    ...
    `}function Tt(e){const t=e.proyectosAsociados&&e.proyectosAsociados.length>0,a=e.publicacionesClave&&e.publicacionesClave.length>0;return`
    ...
    `}function Nt(){const e=new Set(U.map(i=>i.categoria)),t=U.filter(i=>i.proyectosAsociados?.length>0).length,a=U.filter(i=>i.publicacionesClave?.length>0).length;return{total:U.length,categorias:e.size,conProyectos:t,conPublicaciones:a}}function qt(){let e=U[0]?.id||1;const t=document.createElement("section");t.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=It(e),o=Nt();t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function Ht(){let e=J[0]?.id||1;const t=document.createElement("section");t.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=()=>{const i=Rt(e);t.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,t.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),a()}})};return a(),t}function Vt(){return Ht()}function Qt(){return`
    ...
    `}function Wt(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Yt()}
    `,e}function Xt(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",Zt)}async function Zt(e){e.preventDefault();const t=e.target,a=new FormData(t),i=Object.fromEntries(a.entries()),o=_t(i);if(o.length>0){ta(o);return}await aa(t,i)}function _t(e){const t=[];return e.nombre?.trim()||t.push("El nombre es obligatorio."),e.asunto?.trim()||t.push("El asunto es obligatorio."),e.mensaje?.trim()||t.push("El mensaje es obligatorio."),e.correo?.trim()?ea(e.correo)||t.push("El formato del correo no es válido."):t.push("El correo es obligatorio."),t}function ea(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function ta(e){V(e[0],"error")}function V(e,t="success"){const a=document.querySelector(".custom-toast");a&&a.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,t==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function aa(e,t){const a=document.getElementById("submitBtn");a.disabled=!0,a.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(t)})).ok?(V("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):V("Hubo un problema al enviar el mensaje.","error")}catch{V("Error de conexión. Intenta nuevamente.","error")}a.disabled=!1,a.textContent="Enviar"}function ia(){const e=Wt();return setTimeout(()=>{Xt()},0),e}function oa(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
`)}function k(l,m){const s=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),g=URL.createObjectURL(s),b=document.createElement("a");b.href=g,b.download=m,document.body.appendChild(b),b.click(),b.remove(),window.setTimeout(()=>{URL.revokeObjectURL(g)},1e3)}function L(){v=[],t.value="",x([]),d.disabled=!0,o.textContent="",o.classList.add("hidden"),t.focus()}return a.addEventListener("click",()=>{const l=t.value.trim();if(!l){v=[],x([]),d.disabled=!0,c("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:m,errors:s}=w(l);if(s.length>0){v=[],x([]),d.disabled=!0,c(s.join(" "),"error");return}v=m,x(m),d.disabled=!1,c(`Los datos de ${m.length} estudiante${m.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",L),d.addEventListener("click",()=>{v.length!==0&&k(y(v),"Banner_APEC_Examen_Final_4EF.csv")}),e}function na(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function w(x){const y=x==="xmera";h.classList.toggle("hidden",!y),p.classList.toggle("hidden",y),d.className=y?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",v.className=y?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const x=t.value.trim();if(!x){E(),f("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:y,errors:k}=u(x);if(k.length>0){E(),f(k.join(" "),"error");return}a.textContent=c(y),o.disabled=!1,f(`Código generado correctamente para ${y.length} estudiante${y.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(a.textContent),f("El código fue copiado al portapapeles.")}catch(x){console.error("No fue posible copiar el código:",x),f("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),r.addEventListener("click",()=>{t.value="",E(),n.textContent="",n.classList.add("hidden"),t.focus()});try{const x=na();if(x instanceof HTMLElement)p.appendChild(x);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(x){console.error("No fue posible cargar el módulo Banner:",x),p.innerHTML=`
        ...
        `}return d.addEventListener("click",()=>{w("xmera")}),v.addEventListener("click",()=>{w("banner")}),w("xmera"),e}function ca(){return la()}const da={home:{page:ze,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:_e,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:rt,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:pt,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:St,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:$t,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:Vt,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:Ut,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:ia,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:ca,layout:"default",title:"Herramientas | El Kernel"}};let re=document.referrer||"";function X(e){window.location.hash=`/${e}`}function pa(){const e=()=>{const t=window.location.hash.replace("#/","")||"home";ma(t)};window.addEventListener("hashchange",e),e()}function ua(e,t){const a=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:t,page_location:a,page_referrer:re}),re=a}function ma(e){const t=document.querySelector("main"),a=da[e];if(t){if(t.innerHTML="",!a){X("home");return}nt(a.layout),document.title=a.title,t.appendChild(a.page()),window.scrollTo({top:0,behavior:"auto"}),ua(e,a.title)}}function xa(e,t){ne(e,X),pa();const a=window.matchMedia("(max-width: 768px)");let i=!1;function o(n){n.matches&&!i&&(ae(e),i=!0)}a.addEventListener("change",o),o(a),ae(e);const r=t.querySelector('[data-action ="open-menu"]');ke(r,e),Ae(e)}const fe=document.querySelector("#header");fe.innerHTML=he();const ve=document.querySelector("#navBar");ve.innerHTML=we();const ba=document.querySelector("#footer");ba.innerHTML=ye();xa(ve,fe);
