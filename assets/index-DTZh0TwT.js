(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();const ye=""+new URL("ElKernel-Cuaiz0QC.png",import.meta.url).href;function Ye(){return`<div class="flex items-center px-2.5   w-full  ">
    ...
    `}function _e(){return`<div class="max-w-7xl mx-auto p-3 md:flex md:flex-row md:items-center md:justify-between">
    <div class=" flex items-center gap-4  text-white "> 
                    <div>
                    <img class="object-fill  rounded-full " width="87px" heigth="87px" src="${ye}" alt="Grupo de investigacion dominicano" _blank title="El kernel">
                    </div>
    ...
    `}function Fe(e,a){e.addEventListener("click",t=>{const i=t.target.closest(["[data-route]"]);i&&(t.preventDefault(),a(i.dataset.route))})}function ra(e){Fe(e,ue)}const qe=""+new URL("apec-ConmXkrT.png",import.meta.url).href,sa=""+new URL("isfodosu-C3sCRZT7.png",import.meta.url).href,na=""+new URL("uasd-D9oiqsNN.png",import.meta.url).href,Ce=[{content:`<div class="relative flex flex-col justify-center items-center w-full h-full">
        <img src="${qe}" alt="UNAPEC" title="UNAPEC" 
        ...
        <img src="${sa}" alt="ISFODOSU" title="ISFODOSU" 
        class="w-70.5 h-32.5 md:w-142.5 md:h-38.5  rounded-3xl object-cover lg:w-137.75 lg:h-64.5   ">
        ...
        </div>`}];function la(e){const a=e.querySelector("#arrowR"),t=e.querySelector("#arrowL"),i=e.querySelector("#contenedorSlide");if(!a||!t||!i)return;const o=Ce.length,n=1500;let r=0,c=null;function x(u){return(u%o+o)%o}function h(){i.innerHTML=Ce[r].content}function b(u){r=x(r+u),h()}function p(){m(),c=setInterval(()=>b(1),n)}function m(){c&&(clearInterval(c),c=null)}function d(){p()}h(),p(),a.addEventListener("click",()=>{b(1),d()}),t.addEventListener("click",()=>{b(-1),d()})}function ca(){const e=`
        <section class="
    ...
    `,a=document.createElement("div");a.innerHTML=e;const t=a.firstElementChild;return la(t.querySelector("#containerFather")),ra(t.querySelector("#btnsGroup")),t}const da="https://script.google.com/macros/s/AKfycbwYOIXuZWC1HiU2_iTsk8ytuHa1NDtFGbjQsO_37SmtbKWUsdS4RUQOOEU7GHz0E4wU7Q/exec";async function pa(){try{const e=await fetch(da,{method:"GET",cache:"no-store"});if(!e.ok)throw new Error(`La API de Analytics respondió con estado ${e.status}`);const a=await e.json();if(!a.ok||!a.visitantes)throw new Error("La respuesta de Analytics no tiene el formato esperado");return{total:Number(a.visitantes.total)||0,hoy:Number(a.visitantes.hoy)||0,ultimos7Dias:Number(a.visitantes.ultimos7Dias)||0,ultimos30Dias:Number(a.visitantes.ultimos30Dias)||0,actualizadoEn:a.actualizadoEn||null}}catch(e){return console.error("No fue posible obtener las estadísticas de Analytics:",e),{total:0,hoy:0,ultimos7Dias:0,ultimos30Dias:0,actualizadoEn:null}}}function Z(e){return new Intl.NumberFormat("es-DO").format(Number(e)||0)}function ua(e){if(!e)return null;const a=new Date(e);return Number.isNaN(a.getTime())?null:new Intl.DateTimeFormat("es-DO",{dateStyle:"medium",timeStyle:"short"}).format(a)}async function ma(e){const a=e.querySelector("#analytics-total"),t=e.querySelector("#analytics-hoy"),i=e.querySelector("#analytics-semana"),o=e.querySelector("#analytics-mes"),n=e.querySelector("#analytics-actualizado");if(!a||!t||!i||!o||!n){console.warn("No se encontraron los elementos de Analytics en la portada.");return}n.textContent="Cargando estadísticas…";try{const r=await pa();a.textContent=Z(r.total),t.textContent=Z(r.hoy),i.textContent=Z(r.ultimos7Dias),o.textContent=Z(r.ultimos30Dias);const c=ua(r.actualizadoEn);n.textContent=c?`Actualizado: ${c}`:"Estadísticas temporalmente no disponibles"}catch(r){console.error("Error al mostrar las estadísticas en la portada:",r),a.textContent="—",t.textContent="—",i.textContent="—",o.textContent="—",n.textContent="No fue posible cargar las estadísticas"}}function ba(){const e=document.createElement("section");e.className=`
        ...
        xl:px-0
        2xl:max-w-[1800px]
    `,e.innerHTML=oa();const a=ca();return e.appendChild(a),ma(e),e}function xa(){return ba()}const ga=""+new URL("QuienesSomos-DS8enKgt.png",import.meta.url).href;function fa(){return`
        <section 
            role="banner" 
    ...
    `}const Aa="data:image/png;base64,",Ca="data:image/png;base64,",Ea="data:image/png;base64,",Sa="data:image/png;base64,",Ma="data:image/png;base64,",Pa=[{icon:Aa,title:"Misión",content:"Promover la generación y aplicación de conocimiento matemático mediante el desarrollo de investigaciones rigurosas, la formación de recursos humanos altamente capacitados y la implementación de soluciones innovadoras para problemas complejos en ámbitos académicos, científicos y tecnológicos, con un fuerte enfoque en el impacto educativo."},{icon:Ca,title:"Visión",content:"Ser un referente nacional e internacional en investigación matemática, matemática pura y aplicada, con especial énfasis en Métodos iterativos, Optimización, Álgebra abstracta, Análisis matricial y Educación Matemática. Distinguirnos por la excelencia científica, la colaboración interdisciplinaria y el compromiso con el mejoramiento de la enseñanza y el aprendizaje de las matemáticas."},{icon:Ea,title:"Objetivos",content:`
      ...
      </ul>`},{icon:Sa,title:"Valores",content:`
      <div class="space-y-1">
  ...
  `}function La({icon:e,title:a,content:t}){return`
    <div class="accordion-item rounded-lg overflow-hidden border border-gray-700  flex flex-col transition-all duration-300" style="background-color: #232C32;">
      ...
      <button type="button" data-accordion-header
        ...
        <img src="${Ma}" class="chevron-icon w-8 h-8 transition-transform duration-300 pointer-events-none" data-accordion-icon />
      </button>
  ...
  `}function $a(){const e=document.createElement("section");return e.className=`
    ...
    `,e}function Da(e){e.querySelectorAll("[data-accordion-header]").forEach(t=>{t.addEventListener("click",()=>{const i=t.nextElementSibling,o=t.querySelector("[data-accordion-icon]"),n=i.classList.contains("max-h-[1000px]");e.querySelectorAll("[data-accordion-content]").forEach(r=>{r.classList.remove("max-h-[1000px]"),r.classList.add("max-h-0")}),e.querySelectorAll("[data-accordion-icon]").forEach(r=>{r.classList.remove("rotate-180")}),n||(i.classList.remove("max-h-0"),i.classList.add("max-h-[1000px]"),o.classList.add("rotate-180"))})})}function za(e){const a=e.querySelector("[data-description-text]"),t=e.querySelector("[data-description-btn]");if(!a||!t)return;let i=!1;t.addEventListener("click",()=>{i=!i,a.classList.toggle("line-clamp-4",!i),t.textContent=i?"Leer menos":"Leer más"})}function Ia(){const e=$a();return Da(e),za(e),e}function q(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ra(e=[]){return!e||e.length===0?`
        ...
        <a href="${q(a.url)}" 
           ...
           title="${q(a.name)}">
            <i class="${q(a.icon)} text-xl"></i>
        </a>
    `).join("")}function Na(e){return e?String(e).split(",").map(t=>t.trim()).filter(Boolean).slice(0,4).map(t=>`
    ...
    `).join(""):""}function Fa(e){const a=document.createElement("article");a.className=`
    ...
    `;const t=Ra(e.redes||[]),i=Na(e.areas),o=e.estado||e.grado||e.subtitle||"Investigador";return a.innerHTML=`
        ...
        <div class="w-full flex flex-col gap-4 text-left flex-1">
                ...
                <div class="flex flex-wrap gap-2">
                    ${i||`
                                <p class="text-sm text-slate-500 leading-relaxed">
                                    ${q(e.areas||"Área no especificada")}
                                </p>
                              `}
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-sm text-slate-600 leading-relaxed">
                    ${q(e.afilaciones||e.afiliaciones||"No especificadas")}
                </p>
            </div>
    ...
    `,a}const Te=""+new URL("rad-B3ff1btG.png",import.meta.url).href,Be=""+new URL("mar-Cru0HERG.png",import.meta.url).href,K=[{img:se,title:"Miguel A. Leonardo Sepúlveda, Ph.D.",subtitle:"Investigador en Métodos Numéricos, EDPs y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos de alto orden, métodos libres de Jacobiano, EDPs no lineales, optimización, diseño curricular, educación matemática, formación docente",afilaciones:"ITLA, ISFODOSU, UNAPEC",redes:[{name:"email",url:"mailto:miguel.leonardo@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4199-6484",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Miguel-Leonardo-Sepulveda",icon:"fa-brands fa-researchgate"},{name:"google scholar",url:"https://scholar.google.com/citations?user=abVngPAAAAAJ&hl=es",icon:"fa-brands fa-google"}],description:"Doctor en Matemática con líneas de investigación en análisis numérico, métodos iterativos de alto orden, métodos libres de Jacobiano y resolución de sistemas no lineales y EDPs no lineales. Docente universitario, asesor de tesis y diseñador curricular de programas académicos."},{img:le,title:"Natanael Ureña Castillo, M.Sc.",subtitle:"Optimización numérica, métodos híbridos y ciencias actuariales",estado:"Próxima defensa doctoral",grado:"Candidato doctoral",areas:"Métodos iterativos, optimización numérica, métodos híbridos, redes neuronales, ciencias actuariales, matemática computacional, modelización financiera",afilaciones:"ISFODOSU, ITLA, INTEC",redes:[{name:"email",url:"mailto:natanael.urena@isfodosu.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9186-1778",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Natanael-Urena-Castillox",icon:"fa-brands fa-researchgate"}],description:"Investigador en optimización numérica, métodos híbridos cuasi-Newton, estabilidad algorítmica y aplicaciones computacionales. Actualmente se encuentra en la etapa final de su doctorado y estará defendiendo su tesis doctoral en las próximas semanas."},{img:Te,title:"Randy Leonardo, M.Sc.",subtitle:"Álgebra Lineal, Matrices Combinadas y Educación Matemática",estado:"Investigador",grado:"M.Sc.",areas:"Álgebra lineal, matriz combinada, formación docente, innovación educativa, matemática superior",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:rleonardo36@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0002-9493-7165",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Randy-Leonardo",icon:"fa-brands fa-researchgate"}],description:"Investigador y docente universitario en áreas vinculadas al álgebra lineal, matrices combinadas y formación matemática. Ha participado como ponente en congresos y seminarios nacionales."},{img:we,title:"Antmel Rodríguez Cabral, Ph.D.",subtitle:"Métodos Iterativos, Sistemas no Lineales y Dinámica Discreta",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Métodos iterativos, sistemas no lineales, métodos libres de Jacobiano, dinámica compleja, dinámica real, análisis numérico, educación matemática",afilaciones:"UASD, ISFODOSU",redes:[{name:"email",url:"mailto:arodriguez05@uasd.edu.do",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-4502-0307",icon:"fa-brands fa-orcid"},{name:"researchgate",url:"https://www.researchgate.net/profile/Antmel-Rodriguez-Cabral",icon:"fa-brands fa-researchgate"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos para sistemas no lineales, estabilidad de parámetros autoacelerados y dinámica discreta."},{img:Be,title:"Marino Brito Guillén, M.Sc.",subtitle:"Gestión Universitaria, Matemática Educativa y Formación Docente",estado:"Académico",grado:"M.Sc.",areas:"Educación matemática, gestión universitaria, álgebra, cálculo, formación docente, desarrollo curricular",afilaciones:"ISFODOSU",redes:[{name:"email",url:"mailto:marinobg@gmail.com",icon:"bx bx-envelope"}],description:"Académico con amplia trayectoria en gestión universitaria, formación docente, desarrollo curricular y enseñanza de la matemática. Ha contribuido al fortalecimiento de procesos educativos e institucionales."},{img:ne,title:"Marc-Kelly Jean Philippe Jean, Ph.D.",subtitle:"Álgebra Abstracta, Grupos Finitos y Caracteres",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Teoría de grupos, álgebra, matemática pura, caracteres, clases p-regulares, grafos asociados, educación matemática",afilaciones:"UASD",redes:[{name:"email",url:"mailto:marckelly21@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0003-2278-5315",icon:"fa-brands fa-orcid"},{name:"linkedin",url:"https://www.linkedin.com/in/marc-kelly-jean-philippe-b6845073/",icon:"fa-brands fa-linkedin"},{name:"google scholar",url:"https://scholar.google.com/citations?hl=es&user=KDxk4vYAAAAJ",icon:"fa-brands fa-google"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Su línea de investigación se centra en teoría de grupos, caracteres, clases p-regulares y grafos asociados."},{img:_,title:"José Alberto Reyes Reyes, Ph.D.",subtitle:"Métodos Iterativos, Estabilidad y Educación Matemática",estado:"Doctor en Matemática",grado:"Ph.D.",areas:"Matemática pura, métodos iterativos, métodos libres de derivadas, análisis de estabilidad, convergencia local, innovación educativa",afilaciones:"UASD",redes:[{name:"email",url:"mailto:Josereyes0187@gmail.com",icon:"bx bx-envelope"},{name:"orcid",url:"https://orcid.org/0000-0001-9397-7571",icon:"fa-brands fa-orcid"}],description:"Doctor en Matemática. Defendió exitosamente su tesis doctoral en 2025, obteniendo la calificación más alta otorgada por el jurado evaluador. Investiga métodos iterativos, estabilidad, convergencia local y esquemas numéricos libres de derivadas."}];function qa(){let e=0,a=null,t=null;const i=document.createElement("section");i.className="w-full max-w-7xl mx-auto px-4 py-10 flex flex-col gap-8 items-center font-sans";const o=()=>window.innerWidth>=1280?3:window.innerWidth>=768?2:1,n=()=>{const d=o();return Math.max(K.length-d,0)},r=()=>{const d=n();e>d&&(e=0),e<0&&(e=d)},c=()=>{const d=n();e>=d?e=0:e++,m()},x=()=>{const d=n();e<=0?e=d:e--,m()},h=()=>{b(),K.length>o()&&(a=setInterval(c,4500))},b=()=>{a&&(clearInterval(a),a=null)},p=()=>{const d=o(),u=Math.max(K.length-d+1,1);return Array.from({length:u}).map((w,g)=>`
        ...
        `).join("")},m=()=>{if(!K||K.length===0){i.innerHTML=`
            ...
            `;return}r();const d=o(),u=K.slice(e,e+d);i.innerHTML=`
        ...
        `;const w=i.querySelector("#cards-wrapper");u.forEach(A=>{w.appendChild(Fa(A))});const g=i.querySelector("#prev-btn"),k=i.querySelector("#next-btn");g&&(g.onclick=()=>{x(),h()}),k&&(k.onclick=()=>{c(),h()}),i.querySelectorAll("[data-dot-index]").forEach(A=>{A.onclick=()=>{e=parseInt(A.dataset.dotIndex),m(),h()}})};return i.addEventListener("mouseenter",b),i.addEventListener("mouseleave",h),document.addEventListener("visibilitychange",()=>{document.hidden?b():h()}),window.addEventListener("resize",()=>{clearTimeout(t),t=setTimeout(()=>{e=0,m(),h()},150)}),m(),h(),i}function Ta(e){e.addEventListener("click",a=>{const t=a.target.closest("[data-route]");if(!t)return;const i=window.location.hash.replace("#/","")||"equipment";t.dataset.route!==i&&ue(t.dataset.route)})}function Oe(){const e=window.location.hash.replace(/^#\/?/,"")||"equipment",a=document.createElement("nav"),t="bg-sky-800 text-white border-sky-800 shadow-md",i="bg-white text-slate-700 border-slate-200 hover:bg-sky-50 hover:text-sky-800 hover:border-sky-200";return a.className="w-full flex justify-center mb-6",a.innerHTML=`
    ...
    `,Ta(a),a}function Ba(){const e=document.createElement("section");e.id="equipo-investigacion",e.className="w-full max-w-7xl mx-auto px-4 py-8 mb-20 font-sans tabletBig:px-20 xl:px-0";const a=document.createElement("div");a.className="mb-6",a.appendChild(Oe());const t=qa();return e.appendChild(a),e.appendChild(t),e}function Oa(){return Ba()}function Ua(e="default"){const a=document.getElementById("main");a.classList.remove("p-2","mt-8","md:mt-12"),e=="full"?(a.classList.add("mt-0","pt-0"),a.classList.remove("max-w-7xl")):e=="left"?(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.remove("m-auto")):(a.classList.add("p-2","mt-8","md:mt-12"),a.classList.add("m-auto"))}function N(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Ue(e){return e.formacion?.length||0}function Ve(e){return e.experiencia?.length||0}function Va(e,a=!1){const t=Ue(e),i=Ve(e);return`
        <button 
            type="button"
            data-id="${e.id}" 
    ...
    `}function Ga(e){const a=e.formacion||[],t=e.experiencia||[],i=a.length?a.map(c=>`
                        ...
                        ">
                            ...
                            ">
                                ...
                                <div class="flex flex-wrap items-center gap-3 mb-5">
                                    ...
                                    ">
                                        ${V(e.category||"Noticia destacada")}
                                    </span>
    ...
    `}function B(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function Za({id:e,title:a,date:t,image:i,imageAlt:o,excerpt:n,category:r="Noticia",imageFit:c="contain"}){const x=c==="cover"?"object-cover":"object-contain";return`
        <article
            data-news-card="${B(e)}"
            class="
    ...
    `}function at(){const e=encodeURIComponent("Propuesta de noticia para El Kernel"),a=encodeURIComponent(`Saludos,
...
Gracias.`);return`
    ...
    `}function tt(e=[]){return[...e].sort((a,t)=>a.featured&&!t.featured?-1:!a.featured&&t.featured?1:0)}function it(){const e=document.createElement("section");e.className=`
        w-full
        tabletBig:w-7xl
        xl:w-full
    `;const a=tt(Ge),t=a.find(i=>i.featured)||a[0];return e.innerHTML=`
        ${_a(t)}
        ${et(a)}
        ${at()}
    `,e}function ot({title:e,content:a={paragraphs:[],list:[]},articleURL:t}){const i=(a.paragraphs||[]).map(r=>`<p>${r}</p>`).join(""),o=(a.list||[]).length?`
    ...
    `}function rt(e){e&&e.addEventListener("click",a=>{const t=a.target.closest("[data-news-btn], [data-news-card]");if(!t||!e.contains(t))return;const i=t.dataset.newsBtn||t.dataset.newsCard,o=Ge.find(n=>String(n.id)===String(i));if(!o){console.warn("No se encontró la noticia con id:",i);return}st(o)})}function st(e){const a=document.querySelector("#newsModal");a&&a.remove();const t=document.createElement("div");t.innerHTML=ot(e);const i=t.firstElementChild;if(!i){console.warn("No se pudo crear el modal de noticia.");return}document.body.appendChild(i),document.body.style.overflow="hidden";function o(){i.remove(),document.body.style.overflow="",document.removeEventListener("keydown",n)}function n(r){r.key==="Escape"&&o()}i.querySelectorAll("[data-close-modal]").forEach(r=>{r.addEventListener("click",o)}),i.addEventListener("click",r=>{r.target===i&&o()}),document.addEventListener("keydown",n)}function nt(){const e=it();return rt(e),e}function $(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function He(e){return e?.name||e?.title||"Investigador"}function Ee(e){return e?.title||e?.tile||"Revista no especificada"}function Ke(e){return String(e?.DOI||e?.doi||"").trim()}function lt(e){const a=Ke(e);return e?.url?e.url:a?a.startsWith("http")?a:`https://doi.org/${a}`:"#"}function ct(e){return[...e?.publicaciones||[]].sort((a,t)=>{const i=Number(a.year||0),o=Number(t.year||0);return i!==o?o-i:String(a.contenido||"").localeCompare(String(t.contenido||""))})}function dt(e,a=!1){const t=He(e),i=e.publicaciones||[],o=i.length,n=i.map(c=>Number(c.year)).filter(Boolean),r=n.length?Math.max(...n):"";return`
        <button data-id="${e.id}"
            type="button"
            class="group w-full text-left flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all duration-300 border-2
            ${a?"bg-sky-500 text-white shadow-xl border-sky-400 scale-[1.02]":"bg-white hover:bg-sky-50 hover:shadow-md border-gray-100 text-gray-900"}">
    ...
    `}function pt(e){if(!e)return`
            <div class="flex h-full items-center justify-center text-white">
                No hay investigador seleccionado.
            </div>
        `;const a=He(e),t=ct(e),i=t.length,o=t.map(b=>Number(b.year)).filter(Boolean),n=o.length?Math.min(...o):"",r=o.length?Math.max(...o):"",c=[...new Set(t.map(b=>b.q).filter(Boolean))],x=[...new Set(t.map(b=>Ee(b)).filter(Boolean))],h=t.map(b=>{const p=Ee(b),m=Ke(b),d=lt(b);return`
    ...
    `}function ut(){let e=T[0]?.id||1,a=!1,t=null;const i=document.createElement("section");i.className="publicaciones-shell w-full max-w-7xl mx-auto px-4 py-8 rounded-3xl";function o(u){return String(u?.DOI||u?.doi||"").trim().toLowerCase()}function n(u){return String(u?.journal||u?.title||u?.tile||"").trim()}function r(u){return String(u?.articleTitle||u?.contenido||"").trim()}function c(u){return String(u?.q||u?.quartile||"").trim().toUpperCase()}function x(u){const w=o(u);return w||[u?.year||"",n(u),r(u)].join("-").trim().toLowerCase()}function h(){const u=new Map;return T.forEach(w=>{(w.publicaciones||[]).forEach(g=>{const k=x(g);k&&!u.has(k)&&u.set(k,g)})}),Array.from(u.values())}function b(){const u=h(),w=u.map(j=>Number(j.year)).filter(Boolean),g=w.length?Math.max(...w):"—",k=w.length?Math.min(...w):"—",A=u.filter(j=>c(j)==="Q1").length;return{totalPublicaciones:u.length,investigadores:T.length,q1:A,primerYear:k,ultimoYear:g}}function p(){return T.find(u=>Number(u.id)===Number(e))||T[0]}const m=()=>{const u=p(),w=b(),g=window.innerWidth<768&&!a;i.innerHTML=`
            ...
            <div class="relative flex flex-col md:shadow-2xl md:rounded-3xl md:flex-row gap-6 w-full mx-auto p-4 md:p-6 min-h-[650px] md:min-h-[720px] bg-white/70 border border-white/70 backdrop-blur-sm">
                ...
                <aside id="profesores-list"
                    ...
                    ${T.map(A=>dt(A,Number(A.id)===Number(e))).join("")}
                </aside>
    ...
    `).join("")}function ft(e,a=!1){return`
        <button 
            ...
            <p class="text-sm leading-relaxed ${a?"text-white/90":"text-slate-500"}">
                ${R(e.desarrollo).slice(0,185)}${String(e.desarrollo).length>185?"...":""}
            </p>
        </button>
    `}function vt(e){const a=e.proyectosAsociados&&e.proyectosAsociados.length>0,t=e.publicacionesClave&&e.publicacionesClave.length>0;return`
            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        ...
                        <p class="text-slate-800 font-bold mt-1">${R(e.categoria)}</p>
                    </div>

                    <div class="bg-[#96B4E1]/20 border border-[#96B4E1]/40 rounded-2xl p-4">
                        <p class="text-xs font-black text-[#5580C1] uppercase tracking-wide">Prioridad</p>
                        <p class="text-slate-800 font-bold mt-1">${R(e.prioridad)}</p>
                    </div>
    ...
    `}function ht(){const e=new Set(G.map(i=>i.categoria)),a=G.filter(i=>i.proyectosAsociados?.length>0).length,t=G.filter(i=>i.publicacionesClave?.length>0).length;return{total:G.length,categorias:e.size,conProyectos:a,conPublicaciones:t}}function yt(){let e=G[0]?.id||1;const a=document.createElement("section");a.className="lineas-shell w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=bt(e),o=ht();a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
    ...
    `}function Mt(){let e=X[0]?.id||1;const a=document.createElement("section");a.className="w-full max-w-7xl mx-auto px-4 py-10 mb-20 font-sans tabletBig:px-20 xl:px-0";const t=()=>{const i=kt(e);a.innerHTML=`
            <div class="mb-8">
                <p class="text-[#5580C1] font-black uppercase tracking-wide text-sm mb-2">
                    Grupo de Investigación Kernel
                </p>
        ...
        `,a.querySelectorAll("[data-proyecto-id]").forEach(o=>{o.onclick=()=>{e=parseInt(o.dataset.proyectoId),t()}})};return t(),a}function Pt(){return Mt()}function jt(){return`
    ...
    `}function $t(){const e=document.createElement("section");return e.classList.add("w-full","tabletBig:w-7xl"),e.innerHTML=`
    ${Lt()}
    `,e}function Dt(){const e=document.getElementById("contactForm");e&&e.addEventListener("submit",zt)}async function zt(e){e.preventDefault();const a=e.target,t=new FormData(a),i=Object.fromEntries(t.entries()),o=It(i);if(o.length>0){Nt(o);return}await Ft(a,i)}function It(e){const a=[];return e.nombre?.trim()||a.push("El nombre es obligatorio."),e.asunto?.trim()||a.push("El asunto es obligatorio."),e.mensaje?.trim()||a.push("El mensaje es obligatorio."),e.correo?.trim()?Rt(e.correo)||a.push("El formato del correo no es válido."):a.push("El correo es obligatorio."),a}function Rt(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function Nt(e){re(e[0],"error")}function re(e,a="success"){const t=document.querySelector(".custom-toast");t&&t.remove();const i=document.createElement("div");i.className=`
        custom-toast fixed top-6 right-6 z-50
        px-6 py-3 rounded-lg shadow-xl text-white font-medium 
        transform transition-all duration-300 translate-x-full opacity-0
    `,a==="success"?i.classList.add("bg-green-600"):i.classList.add("bg-red-600"),i.textContent=e,document.body.appendChild(i),setTimeout(()=>{i.classList.remove("translate-x-full","opacity-0")},50),setTimeout(()=>{i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),300)},3e3)}async function Ft(e,a){const t=document.getElementById("submitBtn");t.disabled=!0,t.textContent="Enviando...";try{(await fetch("https://formspree.io/f/xqabgepe",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify(a)})).ok?(re("¡Gracias! Tu mensaje ha sido enviado correctamente.","success"),e.reset()):re("Hubo un problema al enviar el mensaje.","error")}catch{re("Error de conexión. Intenta nuevamente.","error")}t.disabled=!1,t.textContent="Enviar"}function qt(){const e=$t();return setTimeout(()=>{Dt()},0),e}function Tt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
...
A00116736    13    7"
    ...
    `;const a=e.querySelector("#banner-primer-input"),t=e.querySelector("#banner-primer-process"),i=e.querySelector("#banner-primer-clear"),o=e.querySelector("#banner-primer-message"),n=e.querySelector("#banner-primer-preview"),r=e.querySelector("#banner-primer-count"),c=e.querySelector("#banner-primer-download-1ac"),x=e.querySelector("#banner-primer-download-2pp");let h=[];function b(s,y="success"){o.textContent=s,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),y==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function p(){o.textContent="",o.classList.add("hidden")}function m(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function d(s){return String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function u(s){const y=String(s).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return y.includes("	")?y.split("	").map(v=>v.trim()).filter(v=>v!==""):y.includes(";")?y.split(";").map(v=>v.trim()).filter(v=>v!==""):y.split(/\s+/).map(v=>v.trim()).filter(v=>v!=="")}function w(s){const y=s.split(/\r?\n/).map(C=>C.trim()).filter(Boolean),v=[],E=[],I=new Set;return y.forEach((C,L)=>{const M=L+1,z=u(C);if(z.length!==3){E.push(`Línea ${M}: deben existir exactamente tres columnas: matrícula, 1AC y 2PP.`);return}const H=m(z[0]),W=Number(d(z[1])),Y=Number(d(z[2]));if(!/^A[0-9]{8}$/.test(H)){E.push(`Línea ${M}: la matrícula "${H}" no es válida. Debe tener el formato A00108671.`);return}if(I.has(H)){E.push(`Línea ${M}: la matrícula ${H} está repetida.`);return}if(!Number.isFinite(W)){E.push(`Línea ${M}: la calificación 1AC no es numérica.`);return}if(!Number.isFinite(Y)){E.push(`Línea ${M}: la calificación 2PP no es numérica.`);return}if(W<0||W>15){E.push(`Línea ${M}: 1AC debe estar entre 0 y 15.`);return}if(Y<0||Y>20){E.push(`Línea ${M}: 2PP debe estar entre 0 y 20.`);return}const ke=W+Y;if(ke>35){E.push(`Línea ${M}: la suma de 1AC y 2PP no puede superar 35 puntos.`);return}I.add(H),v.push({matricula:H,grade1AC:W,grade2PP:Y,total:ke})}),{records:v,errors:E}}function g(s){return Number.isInteger(s)?String(s):s.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function k(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function A(s){if(s.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="5"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=s.map((y,v)=>`
                ...
                `).join(""),r.textContent=`${s.length} estudiante${s.length===1?"":"s"}`}function j(s,y,v){return[["MATRICULA",v],...s.map(C=>[C.matricula,g(C[y])])].map(C=>C.join(";")).join(`\r
`)}function l(s,y){const E=new Blob(["\uFEFF"+s],{type:"text/csv;charset=utf-8;"}),I=URL.createObjectURL(E),C=document.createElement("a");C.href=I,C.download=y,document.body.appendChild(C),C.click(),C.remove(),window.setTimeout(()=>{URL.revokeObjectURL(I)},1e3)}function f(){h=[],a.value="",A([]),c.disabled=!0,x.disabled=!0,p(),a.focus()}return t.addEventListener("click",()=>{const s=a.value.trim();if(!s){h=[],A([]),c.disabled=!0,x.disabled=!0,b("Debes pegar al menos una fila con matrícula, 1AC y 2PP.","error");return}const{records:y,errors:v}=w(s);if(v.length>0){h=[],A([]),c.disabled=!0,x.disabled=!0,b(v.join(" "),"error");return}h=y,A(h),c.disabled=!1,x.disabled=!1,b(`Los datos de ${y.length} estudiante${y.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",f),c.addEventListener("click",()=>{if(h.length===0)return;const s=j(h,"grade1AC","1AC");l(s,"Banner_APEC_Primer_Periodo_1AC.csv")}),x.addEventListener("click",()=>{if(h.length===0)return;const s=j(h,"grade2PP","2PP");l(s,"Banner_APEC_Primer_Periodo_2PP.csv")}),e}function Bt(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    25"
    ...
    `;const a=e.querySelector("#banner-segundo-input"),t=e.querySelector("#banner-segundo-process"),i=e.querySelector("#banner-segundo-clear"),o=e.querySelector("#banner-segundo-message"),n=e.querySelector("#banner-segundo-preview"),r=e.querySelector("#banner-segundo-count"),c=e.querySelector("#banner-segundo-download");let x=[];function h(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function b(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function p(l){const f=String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return f.includes("	")?f.split("	").map(s=>s.trim()).filter(s=>s!==""):f.includes(";")?f.split(";").map(s=>s.trim()).filter(s=>s!==""):f.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function m(l){return Number.isInteger(l)?String(l):l.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function d(l){return String(l).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function u(l,f="success"){o.textContent=l,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),f==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(l){const f=l.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),s=[],y=[],v=new Set;return f.forEach((E,I)=>{const C=I+1,L=p(E);if(L.length!==2){y.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 3SP.`);return}const M=h(L[0]),z=Number(b(L[1]));if(!/^A[0-9]{8}$/.test(M)){y.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(v.has(M)){y.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(z)){y.push(`Línea ${C}: la calificación 3SP no es numérica.`);return}if(z<0||z>35){y.push(`Línea ${C}: 3SP debe estar entre 0 y 35.`);return}v.add(M),s.push({matricula:M,grade3SP:z})}),{records:s,errors:y}}function g(l){if(l.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=l.map((f,s)=>`
                    <tr class="border-b border-slate-100 last:border-b-0">
                        <td class="px-4 py-3 text-slate-500">
                            ${s+1}
                        </td>
                ...
                `).join(""),r.textContent=`${l.length} estudiante${l.length===1?"":"s"}`}function k(l){return[["MATRICULA","3SP"],...l.map(s=>[s.matricula,m(s.grade3SP)])].map(s=>s.join(";")).join(`\r
`)}function A(l,f){const s=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),y=URL.createObjectURL(s),v=document.createElement("a");v.href=y,v.download=f,document.body.appendChild(v),v.click(),v.remove(),window.setTimeout(()=>{URL.revokeObjectURL(y)},1e3)}function j(){x=[],a.value="",g([]),c.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const l=a.value.trim();if(!l){x=[],g([]),c.disabled=!0,u("Debes pegar al menos una fila con matrícula y 3SP.","error");return}const{records:f,errors:s}=w(l);if(s.length>0){x=[],g([]),c.disabled=!0,u(s.join(" "),"error");return}x=f,g(f),c.disabled=!1,u(`Los datos de ${f.length} estudiante${f.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",j),c.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Segundo_Periodo_3SP.csv")}),e}function Ot(){const e=document.createElement("section");e.className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl md:p-8",e.innerHTML=`
        <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
...
A00116736    20"
    ...
    `;const a=e.querySelector("#banner-final-input"),t=e.querySelector("#banner-final-process"),i=e.querySelector("#banner-final-clear"),o=e.querySelector("#banner-final-message"),n=e.querySelector("#banner-final-preview"),r=e.querySelector("#banner-final-count"),c=e.querySelector("#banner-final-download");let x=[];function h(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(/\s+/g,"").trim().toUpperCase()}function b(l){return String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").replace(/\u00A0/g,"").replace(",",".").trim()}function p(l){const f=String(l).normalize("NFKC").replace(/[\u200B-\u200D\u2060\uFEFF]/g,"").trim();return f.includes("	")?f.split("	").map(s=>s.trim()).filter(s=>s!==""):f.includes(";")?f.split(";").map(s=>s.trim()).filter(s=>s!==""):f.split(/\s+/).map(s=>s.trim()).filter(s=>s!=="")}function m(l){return Number.isInteger(l)?String(l):l.toFixed(2).replace(/0+$/,"").replace(/\.$/,"")}function d(l){return String(l).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function u(l,f="success"){o.textContent=l,o.classList.remove("hidden","border-red-200","bg-red-50","text-red-800","border-emerald-200","bg-emerald-50","text-emerald-800"),f==="error"?o.classList.add("border-red-200","bg-red-50","text-red-800"):o.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function w(l){const f=l.split(/\r?\n/).map(E=>E.trim()).filter(Boolean),s=[],y=[],v=new Set;return f.forEach((E,I)=>{const C=I+1,L=p(E);if(L.length!==2){y.push(`Línea ${C}: deben existir exactamente dos columnas: matrícula y 4EF.`);return}const M=h(L[0]),z=Number(b(L[1]));if(!/^A[0-9]{8}$/.test(M)){y.push(`Línea ${C}: la matrícula "${M}" no es válida. Debe tener el formato A00108671.`);return}if(v.has(M)){y.push(`Línea ${C}: la matrícula ${M} está repetida.`);return}if(!Number.isFinite(z)){y.push(`Línea ${C}: la calificación 4EF no es numérica.`);return}if(z<0||z>30){y.push(`Línea ${C}: 4EF debe estar entre 0 y 30.`);return}v.add(M),s.push({matricula:M,grade4EF:z})}),{records:s,errors:y}}function g(l){if(l.length===0){n.innerHTML=`
                <tr>
                    <td
                        colspan="3"
                        class="px-4 py-10 text-center text-slate-400"
            ...
            `,r.textContent="0 estudiantes";return}n.innerHTML=l.map((f,s)=>`
                ...
                `).join(""),r.textContent=`${l.length} estudiante${l.length===1?"":"s"}`}function k(l){return[["MATRICULA","4EF"],...l.map(s=>[s.matricula,m(s.grade4EF)])].map(s=>s.join(";")).join(`\r
`)}function A(l,f){const s=new Blob(["\uFEFF"+l],{type:"text/csv;charset=utf-8;"}),y=URL.createObjectURL(s),v=document.createElement("a");v.href=y,v.download=f,document.body.appendChild(v),v.click(),v.remove(),window.setTimeout(()=>{URL.revokeObjectURL(y)},1e3)}function j(){x=[],a.value="",g([]),c.disabled=!0,o.textContent="",o.classList.add("hidden"),a.focus()}return t.addEventListener("click",()=>{const l=a.value.trim();if(!l){x=[],g([]),c.disabled=!0,u("Debes pegar al menos una fila con matrícula y 4EF.","error");return}const{records:f,errors:s}=w(l);if(s.length>0){x=[],g([]),c.disabled=!0,u(s.join(" "),"error");return}x=f,g(f),c.disabled=!1,u(`Los datos de ${f.length} estudiante${f.length===1?"":"s"} fueron validados correctamente.`)}),i.addEventListener("click",j),c.addEventListener("click",()=>{x.length!==0&&A(k(x),"Banner_APEC_Examen_Final_4EF.csv")}),e}function Ut(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10",e.innerHTML=`
        <div id="banner-menu">
    ...
    `;const a=e.querySelector("#banner-menu"),t=e.querySelector("#banner-tool-view"),i=e.querySelector("#banner-tool-content"),o=e.querySelector("#open-primer-periodo"),n=e.querySelector("#open-segundo-periodo"),r=e.querySelector("#open-calificacion-final"),c=e.querySelector("#banner-back");function x(){a.classList.add("hidden"),t.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}function h(m){console.error("No fue posible abrir la herramienta de Banner:",m),i.innerHTML=`
            <div
        ...
        `,x()}function b(m){i.innerHTML="";try{if(typeof m!="function")throw new TypeError("El componente seleccionado no es una función válida.");const d=m();if(!(d instanceof HTMLElement))throw new TypeError("El componente seleccionado no devolvió un elemento HTML válido.");i.appendChild(d),x()}catch(d){h(d)}}function p(){i.replaceChildren(),t.classList.add("hidden"),a.classList.remove("hidden"),window.requestAnimationFrame(()=>{e.scrollIntoView({behavior:"smooth",block:"start"})})}return o.addEventListener("click",()=>{b(Tt)}),n.addEventListener("click",()=>{b(Bt)}),r.addEventListener("click",()=>{b(Ot)}),c.addEventListener("click",p),e}function Vt(){const e=document.createElement("section");e.className="w-full max-w-7xl mx-auto px-4 py-8",e.innerHTML=`
        <div class="mb-8 text-center">
...
20252000     0"
    ...
    `;const a=e.querySelector("#xmera-input"),t=e.querySelector("#xmera-output"),i=e.querySelector("#xmera-generate"),o=e.querySelector("#xmera-copy"),n=e.querySelector("#xmera-clear"),r=e.querySelector("#xmera-message"),c=e.querySelector("#tab-xmera"),x=e.querySelector("#tab-banner"),h=e.querySelector("#panel-xmera"),b=e.querySelector("#panel-banner");function p(){t.textContent=`var data_todo = {
};`,o.disabled=!0}function m(g,k="success"){r.textContent=g,r.classList.remove("hidden","border","border-emerald-200","bg-emerald-50","text-emerald-800","border-red-200","bg-red-50","text-red-800"),r.classList.add("border"),k==="error"?r.classList.add("border-red-200","bg-red-50","text-red-800"):r.classList.add("border-emerald-200","bg-emerald-50","text-emerald-800")}function d(g){const k=g.split(/\r?\n/).map(f=>f.trim()).filter(Boolean),A=[],j=[],l=new Set;return k.forEach((f,s)=>{const y=f.split(/[\t,; ]+/).map(L=>L.trim()).filter(Boolean),v=s+1,E=y[0],I=y.slice(1);if(!E){j.push(`Línea ${v}: falta la matrícula.`);return}if(!/^\d+$/.test(E)){j.push(`Línea ${v}: la matrícula "${E}" no es válida.`);return}if(l.has(E)){j.push(`Línea ${v}: la matrícula ${E} está repetida.`);return}if(I.length===0){j.push(`Línea ${v}: falta al menos una calificación.`);return}const C=I.map(L=>Number(L));if(C.some(L=>!Number.isFinite(L))){j.push(`Línea ${v}: existe una calificación no numérica.`);return}l.add(E),A.push({matricula:E,grades:C})}),{records:A,errors:j}}function u(g){return`var data_todo = {
${g.map(({matricula:A,grades:j})=>`  "${A}":[${j.join(",")}]`).join(`,
`)}
};
...
if (!contenedor) {
  ...
  console.log("Proceso de asignación finalizado.");
}`}function w(g){const k=g==="xmera";h.classList.toggle("hidden",!k),b.classList.toggle("hidden",k),c.className=k?"rounded-xl bg-sky-600 px-6 py-3 font-black text-white shadow-md transition":"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100",x.className=k?"rounded-xl border border-slate-300 bg-white px-6 py-3 font-black text-slate-700 transition hover:bg-slate-100":"rounded-xl bg-[#5580C1] px-6 py-3 font-black text-white shadow-md transition"}i.addEventListener("click",()=>{const g=a.value.trim();if(!g){p(),m("Debes introducir al menos una matrícula con sus calificaciones.","error");return}const{records:k,errors:A}=d(g);if(A.length>0){p(),m(A.join(" "),"error");return}t.textContent=u(k),o.disabled=!1,m(`Código generado correctamente para ${k.length} estudiante${k.length===1?"":"s"}.`)}),o.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(t.textContent),m("El código fue copiado al portapapeles.")}catch(g){console.error("No fue posible copiar el código:",g),m("No fue posible copiar automáticamente. Selecciona el código y cópialo manualmente.","error")}}),n.addEventListener("click",()=>{a.value="",p(),r.textContent="",r.classList.add("hidden"),a.focus()});try{const g=Ut();if(g instanceof HTMLElement)b.appendChild(g);else throw new Error("bannerComponent() no devolvió un elemento HTML válido.")}catch(g){console.error("No fue posible cargar el módulo Banner:",g),b.innerHTML=`
        ...
        `}return c.addEventListener("click",()=>{w("xmera")}),x.addEventListener("click",()=>{w("banner")}),w("xmera"),e}function Gt(){return Vt()}function Ht(){const e=document.createElement("section");return e.className=`
        w-full max-w-7xl mx-auto
        px-4 py-10 md:px-8
        font-sans
    `,e.innerHTML=`
        ...
        <section class="
            ...
            gap-6 mt-10
        ">
            ${be("Aprender","Comprenda qué mide cada estadístico, cuándo debe utilizarse, cuáles son sus supuestos y cómo se interpreta correctamente.","libro","bg-sky-100","text-sky-700","border-sky-200")}

            ${be("Decidir","Identifique la prueba adecuada según el objetivo, el tipo de variable, el número de grupos y el diseño de su investigación.","decision","bg-amber-100","text-amber-700","border-amber-200")}

            ${be("Analizar","Introduzca sus datos, ejecute el análisis, interprete los resultados y genere reportes metodológicamente adecuados.","analisis","bg-emerald-100","text-emerald-700","border-emerald-200")}
        </section>
    ...
    `,e}function be(e,a,t,i,o,n){return`
        <article class="
            h-full bg-white
            border border-slate-200
            rounded-3xl p-7
    ...
    `}function O(e,a,t,i,o,n,r=""){return`
        <article class="
    ...
    `}function F(e,a="w-7 h-7"){const t=`
        class="${a}"
        viewBox="0 0 24 24"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
    ...
    `;const t=e.querySelector("#asistente-pruebas"),i=p=>{t.innerHTML=p,window.scrollTo({top:0,behavior:"auto"})},o=()=>{Object.assign(a,{pantalla:"inicio",objetivo:"",tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:"",tipoResultado:"",numeroPredictores:"",sobredispersion:""})},n=()=>{a.pantalla="resultado-comparacion",i(ei(a))},r=()=>{a.pantalla="resultado-relacion",i(ai(a))},c=()=>{a.pantalla="resultado-asociacion",i(ti(a))},x=()=>{a.pantalla="resultado-prediccion",i(ii(a))},h=p=>{if(a.pantalla==="objetivo"){if(Object.assign(a,{objetivo:p,tipoVariable:"",numeroGrupos:"",relacion:"",normalidad:"",varianzas:"",tipoRelacion:"",linealidad:"",empates:"",tipoAsociacion:"",frecuenciasEsperadas:"",tipoResultado:"",numeroPredictores:"",sobredispersion:""}),p==="comparar"){a.pantalla="tipo-variable",i(Pe());return}if(p==="relacionar"){a.pantalla="tipo-relacion",i(te());return}if(p==="asociar"){a.pantalla="tipo-asociacion",i(Le());return}if(p==="predecir"){a.pantalla="tipo-resultado",i($e());return}i(ni(p)),a.pantalla="desarrollo";return}if(a.pantalla==="tipo-variable"){Object.assign(a,{tipoVariable:p,numeroGrupos:"",relacion:"",normalidad:"",varianzas:""}),a.pantalla="numero-grupos",i(ee());return}if(a.pantalla==="numero-grupos"){if(Object.assign(a,{numeroGrupos:p,relacion:"",normalidad:"",varianzas:""}),p==="uno"){if(a.relacion="una-muestra",a.tipoVariable==="categorica"){n();return}a.pantalla="normalidad",i(ae());return}a.pantalla="relacion-muestras",i(xe(a));return}if(a.pantalla==="relacion-muestras"){if(Object.assign(a,{relacion:p,normalidad:"",varianzas:""}),a.tipoVariable==="categorica"){n();return}a.pantalla="normalidad",i(ae());return}if(a.pantalla==="normalidad"){if(a.normalidad=p,a.varianzas="",a.tipoVariable==="cuantitativa"&&p==="si"&&a.relacion==="independientes"&&a.numeroGrupos!=="uno"){a.pantalla="varianzas",i(je());return}n();return}if(a.pantalla==="varianzas"){a.varianzas=p,n();return}if(a.pantalla==="tipo-relacion"){if(Object.assign(a,{tipoRelacion:p,normalidad:"",linealidad:"",empates:""}),p==="dicotomica-cuantitativa"){r();return}if(p==="ordinales"){a.pantalla="empates",i(Re());return}a.pantalla="normalidad-relacion",i(fe());return}if(a.pantalla==="normalidad-relacion"){if(a.normalidad=p,a.linealidad="",p!=="si"){r();return}a.pantalla="linealidad",i(Ie());return}if(a.pantalla==="linealidad"){a.linealidad=p,r();return}if(a.pantalla==="empates"){a.empates=p,r();return}if(a.pantalla==="tipo-asociacion"){Object.assign(a,{tipoAsociacion:p,frecuenciasEsperadas:""}),a.pantalla="frecuencias-esperadas",i(ze());return}if(a.pantalla==="frecuencias-esperadas"){a.frecuenciasEsperadas=p,c();return}if(a.pantalla==="tipo-resultado"){Object.assign(a,{tipoResultado:p,numeroPredictores:"",sobredispersion:""}),a.pantalla="numero-predictores",i(ge());return}if(a.pantalla==="numero-predictores"){if(a.numeroPredictores=p,a.sobredispersion="",a.tipoResultado==="conteo"){a.pantalla="sobredispersion",i(De());return}x();return}if(a.pantalla==="sobredispersion"){a.sobredispersion=p,x();return}},b=()=>{const m={"tipo-variable":()=>["objetivo",J()],"numero-grupos":()=>["tipo-variable",Pe()],"relacion-muestras":()=>["numero-grupos",ee()],normalidad:()=>a.numeroGrupos==="uno"?["numero-grupos",ee()]:["relacion-muestras",xe(a)],varianzas:()=>["normalidad",ae()],"tipo-relacion":()=>["objetivo",J()],"normalidad-relacion":()=>["tipo-relacion",te()],linealidad:()=>["normalidad-relacion",fe()],empates:()=>["tipo-relacion",te()],"tipo-asociacion":()=>["objetivo",J()],"tipo-resultado":()=>["objetivo",J()],"numero-predictores":()=>["tipo-resultado",$e()],sobredispersion:()=>["numero-predictores",ge()],"resultado-prediccion":()=>a.tipoResultado==="conteo"?["sobredispersion",De()]:["numero-predictores",ge()],"frecuencias-esperadas":()=>["tipo-asociacion",Le()],"resultado-asociacion":()=>["frecuencias-esperadas",ze()],"resultado-comparacion":()=>a.varianzas?["varianzas",je()]:a.tipoVariable==="categorica"?a.numeroGrupos==="uno"?["numero-grupos",ee()]:["relacion-muestras",xe(a)]:["normalidad",ae()],"resultado-relacion":()=>a.tipoRelacion==="ordinales"?["empates",Re()]:a.tipoRelacion==="dicotomica-cuantitativa"?["tipo-relacion",te()]:a.linealidad?["linealidad",Ie()]:["normalidad-relacion",fe()]}[a.pantalla];if(!m){a.pantalla="objetivo",i(J());return}const[d,u]=m();a.pantalla=d,i(u)};return t.addEventListener("click",p=>{const m=p.target.closest("[data-action], [data-value]");if(!m)return;const d=m.dataset.action,u=m.dataset.value;if(u){h(u);return}if(d==="ver-ficha"){const w=m.dataset.fichaId,g=Je(w);if(!g)return;a.pantallaAnterior=a.pantalla,a.fichaActual=w,a.pantalla="ficha-metodologica",i(oi(g,w));return}if(d==="volver-resultado"){if(a.objetivo==="comparar"){n();return}if(a.objetivo==="relacionar"){r();return}if(a.objetivo==="asociar"){c();return}a.objetivo==="predecir"&&x();return}d==="iniciar"&&(a.pantalla="objetivo",i(J())),d==="volver"&&b(),(d==="volver-inicio"||d==="reiniciar")&&(o(),i(Me())),d==="volver-laboratorio"&&(window.location.hash="/laboratorioKernel")}),e}function Me(){return`
        <section class="relative overflow-hidden rounded-3xl bg-slate-950 text-white px-6 py-12 md:px-12 md:py-16 shadow-2xl">
            ...
            <div class="relative z-10 max-w-4xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10 max-w-4xl">
                    ${oe("1","Describa su investigación","Indique qué desea comparar, relacionar, asociar o predecir.")}

                    ${oe("2","Identifique sus variables","Seleccione el tipo de variable y la estructura de sus datos.")}

                    ${oe("3","Responda sobre el diseño","Informe el número de grupos y los supuestos relevantes.")}

                    ${oe("4","Obtenga una recomendación","Reciba la prueba sugerida, su justificación y el tamaño del efecto.")}
                </div>
        ...
        <section class="rounded-3xl border border-emerald-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    ${ve("Tamaño del efecto",e.efecto)}

                    ${ve("Reporte recomendado","Informe el estadístico, el valor p, el intervalo de confianza y el tamaño del efecto. Incluya gráficos y una interpretación sustantiva.")}
    ...
    `}function oi(e,a){return`
        <section class="rounded-3xl border border-blue-200 bg-white shadow-xl overflow-hidden">
            ...
            <div class="px-6 py-8 md:px-10 md:py-10">
                ${ie("¿Qué es?",e.definicion)}

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    ${Q("¿Cuándo utilizarla?",e.cuandoUsar)}

                    ${Q("Supuestos",e.supuestos)}
                </div>

                ${ri(e.hipotesis)}

                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    ${ie("Estadístico de prueba",e.estadistico)}

                    ${ie("Tamaño del efecto",e.efecto)}
                </div>

                ${si(e.reporteAPA)}

                ${e.posthoc?.length?Q("Análisis posteriores",e.posthoc):""}

                ${e.alternativas?.length?Q("Pruebas y procedimientos alternativos",e.alternativas):""}

                ${e.erroresFrecuentes?.length?Q("Errores frecuentes",e.erroresFrecuentes,"advertencia"):""}

                ${ie("Ejemplo de investigación",e.ejemplo)}

                ${e.referencias?.length?Q("Referencias recomendadas",e.referencias,"referencias"):""}
    ...
    `:""}function Q(e,a=[],t="normal"){if(!a.length)return"";const i=t==="advertencia"?"border-amber-200 bg-amber-50":t==="referencias"?"border-sky-200 bg-sky-50":"border-slate-200 bg-white",o=t==="advertencia"?"text-amber-950":t==="referencias"?"text-sky-950":"text-slate-900",n=t==="advertencia"?"text-amber-900":t==="referencias"?"text-sky-900":"text-slate-600";return`
        <article class="rounded-2xl border ${i} p-6 shadow-sm mt-6">
            ...
            <ul class="space-y-3">
                ${a.map(r=>`
                            <li class="flex items-start gap-3 ${n} leading-relaxed">
                                <span
    ...
    `}const ci={home:{page:xa,layout:"default",title:"Portada | El Kernel"},quienesSomos:{page:Ia,layout:"full",title:"Quiénes somos | El Kernel"},equipment:{page:Oa,layout:"default",title:"Equipo de investigación | El Kernel"},FormacionAcademica:{page:Ka,layout:"default",title:"Formación académica | El Kernel"},noticias:{page:nt,layout:"full",title:"Noticias | El Kernel"},publicaciones:{page:mt,layout:"default",title:"Publicaciones | El Kernel"},proyectos:{page:Pt,layout:"default",title:"Proyectos | El Kernel"},lineas:{page:wt,layout:"default",title:"Líneas de investigación | El Kernel"},contacto:{page:qt,layout:"default",title:"Contacto | El Kernel"},herramientas:{page:Gt,layout:"default",title:"Herramientas | El Kernel"},laboratorioKernel:{page:Ht,layout:"default",title:"Laboratorio Inteligente de Investigación | El Kernel"},asistentePruebas:{page:Xt,layout:"default",title:"¿Qué prueba debo utilizar? | El Kernel"}};let Ne=document.referrer||"";function ue(e){window.location.hash=`/${e}`}function di(){const e=()=>{const a=window.location.hash.replace("#/","")||"home";ui(a)};window.addEventListener("hashchange",e),e()}function pi(e,a){const t=`${window.location.origin}${window.location.pathname}#/${e}`;typeof window.gtag=="function"&&window.gtag("event","page_view",{page_title:a,page_location:t,page_referrer:Ne}),Ne=t}function ui(e){const a=document.querySelector("main"),t=ci[e];if(a){if(a.innerHTML="",!t){ue("home");return}Ua(t.layout),document.title=t.title,a.appendChild(t.page()),window.scrollTo({top:0,behavior:"auto"}),pi(e,t.title)}}function mi(e,a){Fe(e,ue),di();const t=window.matchMedia("(max-width: 768px)");let i=!1;function o(r){r.matches&&!i&&(Ae(e),i=!0)}t.addEventListener("change",o),o(t),Ae(e);const n=a.querySelector('[data-action ="open-menu"]');Ze(n,e),ea(e)}const Qe=document.querySelector("#header");Qe.innerHTML=Ye();const We=document.querySelector("#navBar");We.innerHTML=Xe();const bi=document.querySelector("#footer");bi.innerHTML=_e();mi(We,Qe);
